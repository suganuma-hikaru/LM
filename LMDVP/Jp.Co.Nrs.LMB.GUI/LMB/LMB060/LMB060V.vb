...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMB060F, ByVal v As LMBControlV)
...
#Region "Method"
    ...
    Friend Function IsInputCheck(Optional ByVal mode As String = LMB060C.MODE_DEFAULT) As Boolean
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsAuthorityChk(ByVal eventShubetsu As LMB060C.EventShubetsu) As Boolean
        ...
        Select Case eventShubetsu
            ...
            Case LMB060C.EventShubetsu.MASTEROPEN          'マスタ参照
            ...
            Case LMB060C.EventShubetsu.PRINT        '印刷
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMB060C.EventShubetsu.TOJIRU           '閉じる
                'すべての権限許可
                kengenFlg = True
...
#Region "フォーカス位置チェック"
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsFocusChk(ByVal objNm As String, ByVal actionType As LMB060C.EventShubetsu) As Boolean
        ...
        With Me._Frm
            ...
            If (ctl1 Is Nothing = True OrElse ctl1.ReadOnly = True) _
                ...
                Select Case actionType
                    ...
                    Case LMB060C.EventShubetsu.MASTEROPEN

                        Return Me._LMBconV.SetFocusErrMessage()


                    Case LMB060C.EventShubetsu.ENTER
