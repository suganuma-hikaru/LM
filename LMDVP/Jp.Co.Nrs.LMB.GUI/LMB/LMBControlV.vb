...
#Region "Constructor"
    ...
    '''' <param name="handlerClass">このクラスを生成したハンドラクラス</param>
    '''' <remarks>フォームラスとハンドラクラスをこのクラスに紐付けます。編集不可</remarks>
    'Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMFormSxga)
    ...
    '''' <param name="handlerClass">このクラスを生成したハンドラクラス</param>
    '''' <remarks>フォームラスとハンドラクラスをこのクラスに紐付けます。編集不可</remarks>
    'Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMFormPopL8B)
...
#Region "キャッシュから値取得"
    ...
    ''' </summary>
    ''' <param name="tariffCd">支払タリフコード</param>
    ''' <param name="tariffCdEda">支払タリフコード枝番</param>
    ''' <param name="startDate">適用開始日</param>
    ''' <returns>データロウ配列</returns>
    ''' <remarks></remarks>
    Friend Function SelectShiharaiTariffListDataRow(ByVal tariffCd As String _
        ...
        'キャッシュテーブルからデータ抽出
        Return MyBase.GetLMCachedDataTable(LMConst.CacheTBL.SHIHARAI_TARIFF).Select(Me.SelectShiharaiTariffString(tariffCd, tariffCdEda, startDate))
        'Return MyBase.GetLMCachedDataTable(LMConst.CacheTBL.SHIHARAI_TARIFF_GRP).Select(Me.SelectShiharaiTariffString(tariffCd, tariffCdEda, startDate))
    ...
    ''' </summary>
    ''' <param name="brCd">営業所コード</param>
    ''' <param name="tariffCd">支払横持ちタリフコード</param>
    ''' <returns>データロウ配列</returns>
    ''' <remarks></remarks>
    ...
    Private Function SelectShiharaiYokoTariffString(ByVal brCd As String, ByVal tariffCd As String) As String
        ...
        ''削除フラグ
        'SelectShiharaiYokoTariffString = String.Concat(SelectShiharaiYokoTariffString, " SYS_DEL_FLG = '0' ")

        ''営業所コード
        'SelectShiharaiYokoTariffString = String.Concat(SelectShiharaiYokoTariffString, " AND ", "NRS_BR_CD = ", " '", brCd, "' ")
    ...
    '要望番号1302:(支払運賃に伴う修正) 2012/08/15 本明 Start
    ''' <summary>
    ''' 支払タリフセットマスタ(キャッシュテーブル)からデータを抽出する条件を取得
    ''' </summary>
    ''' <param name="brCd">営業所コード</param>
    ''' <param name="custLCd">荷主(大)コード</param>
    ''' <param name="custMCd">荷主(中)コード</param>
    ''' <param name="setCd">セットマスタコード</param>
    ''' <param name="tehaiKbn">タリフ分類区分</param>
    ''' <param name="tariffCd1">支払タリフコード（屯キロ建）</param>
    ''' <param name="tariffCd2">支払タリフコード（車建）</param>
    ''' <param name="yokoCd">横持ちタリフコード</param>
    ''' <returns>データロウ配列</returns>
    ''' <remarks></remarks>
    Friend Function SelectShiharaiTariffSetListDataRow(ByVal brCd As String _
                                               , ByVal custLCd As String _
                                               , ByVal custMCd As String _
                                               , ByVal setCd As String _
                                               , Optional ByVal tehaiKbn As String = "" _
        ...
        'キャッシュテーブルからデータ抽出
        Return MyBase.GetLMCachedDataTable(LMConst.CacheTBL.SHIHARAI_TARIFF_GRP).Select(Me.SelectShiharaiTariffSetString(brCd, custLCd, custMCd, setCd, tehaiKbn, tariffCd1, tariffCd2, yokoCd))
    ...
    ''' <returns>データロウ配列</returns>
    ''' <remarks></remarks>
    Private Function SelectShiharaiTariffSetString(ByVal brCd As String _
                                           , ByVal custLCd As String _
                                           , ByVal custMCd As String _
                                           , ByVal setCd As String _
                                           , ByVal tehaiKbn As String _
        ...
        SelectShiharaiTariffSetString = String.Empty

        '営業所コード
        SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " NRS_BR_CD = ", " '", brCd, "' ")

        '荷主(大)コード
        SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "CUST_CD_L = ", " '", custLCd, "' ")

        '荷主(中)コード
        SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "CUST_CD_M = ", " '", custMCd, "' ")

        'セットマスタコード
        If String.IsNullOrEmpty(setCd) = False Then

            SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "SET_MST_CD = ", " '", setCd, "' ")
        ...
        If String.IsNullOrEmpty(tehaiKbn) = False Then
            ...
            SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "TARIFF_BUNRUI_KB = ", " '", tehaiKbn, "' ")
        ...
        If String.IsNullOrEmpty(tariffCd1) = False Then
            ...
            SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "SHIHARAI_TARIFF_CD1 = ", " '", tariffCd1, "' ")
        ...
        If String.IsNullOrEmpty(tariffCd2) = False Then
            ...
            SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "SHIHARAI_TARIFF_CD2 = ", " '", tariffCd2, "' ")
        ...
        If String.IsNullOrEmpty(yokoCd) = False Then
            ...
            SelectShiharaiTariffSetString = String.Concat(SelectShiharaiTariffSetString, " AND ", "YOKO_TARIFF_CD = ", " '", yokoCd, "' ")

        End If

        Return SelectShiharaiTariffSetString
    ...
    ''' <summary>
    ''' 棟・室マスタ(棟・室・ゾーンキャッシュテーブル)からデータを抽出する条件を取得
    ''' </summary>
    ''' <param name="brCd">営業所コード</param>
    ''' <param name="whCd">倉庫コード</param>
    ''' <param name="touNo">棟コード</param>
    ...
    ''' <returns>データロウ配列</returns>
    ''' <remarks></remarks>
    Friend Function SelectCustDetailsListDataRow(ByVal nrsbrCd As String, ByVal custCd As String) As DataRow()

        'キャッシュテーブルからデータ抽出
        Return MyBase.GetLMCachedDataTable(LMConst.CacheTBL.CUST_DETAILS).Select(Me.SelectCustDetailsString(nrsbrCd, custCd))
    ...
    ''' <returns>検索条件</returns>
    ''' <remarks></remarks>
    Private Function SelectCustDetailsString(ByVal nrsbrCd As String, ByVal custCd As String) As String

        SelectCustDetailsString = String.Empty

        '営業所コード
        '20160728 tsunehira add
        SelectCustDetailsString = String.Concat(SelectCustDetailsString, "NRS_BR_CD = ", " '", nrsbrCd, "' ")

        '荷主コード
        SelectCustDetailsString = String.Concat(SelectCustDetailsString, " AND ", "CUST_CD = ", " '", custCd, "' ")
