...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMB030H)
...
#Region "Method"
    ...
    '========================  ↓↓↓その他のイベント ↓↓↓========================
    Private Sub LMB030F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        'KeyDownのイベントへ
...
#End Region 'Method
    ...
    Private Sub cmbEigyo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbEigyo.Load
