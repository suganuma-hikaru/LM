...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMB010H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMB010F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMB010F_KeyDown(Me, e)
    End Sub
    ...
    Private Sub btnJikkou_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnJikkou.Click
        ...
        Call Me._Handler.ActionControl(LMB010C.EventShubetsu.JIKKOU, Me)
    ...
    Private Sub cmbPrint_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbPrint.SelectedValueChanged

        Call Me._Handler.cmbPrint_SelectedValueChanged(Me, e)
