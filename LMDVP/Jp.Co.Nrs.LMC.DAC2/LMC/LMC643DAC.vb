...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMC643DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMC643DAC.SQL_FROM)       'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMC643DAC.SQL_WHERE)
        ...
        MyBase.Logger.WriteSQLLog("LMC643DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectTouNo(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMC643DAC.SQL_SELECT_TouNo)      'SQL構築(帳票種別用Select句)
        Call Me.SetConditionMasterSQL()                   '条件設定
    ...
    Private Function SelectMCustDetailsData(ByVal ds As DataSet, ByVal SyoriKBN As String) As DataSet
        ...
        Select Case SyoriKBN
            Case "0"
                '荷姿並び順
                Me._StrSql.Append(LMC643DAC.SQL_SELECT_MCUST_DETAILS)      'SQL構築(荷主明細マスタ設定値Select句)
                Call Me.setIndataParameter(Me._Row)                        '条件設定
            Case "1"
                'FREE_C03項目使用有無
                Me._StrSql.Append(LMC643DAC.SQL_SELECT_MCUST_DETAILS_FREE) 'SQL構築(荷主明細マスタ設定値Select句)
                Call Me.setIndataParameter(Me._Row)                        '条件設定
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Select Case rptTbl.Rows(0).Item("RPT_ID").ToString()
            ...
            Case Else
                ...
                If FreeC03_Umu = "01" Then
                    'FREE_C03使用(サクラ)
                    Me._StrSql.Append(LMC643DAC.SQL_SELECT_DATA)        'SQL構築(データ抽出用SELECT句)
                    Me._StrSql.Append(LMC643DAC.SQL_SELECT_ADD_SAGYO)
                    Me._StrSql.Append(LMC643DAC.SQL_FROM)               'SQL構築(データ抽出用FROM句)
                    Me._StrSql.Append(LMC643DAC.SQL_FROM_ADD_SAGYO)
                    Me._StrSql.Append(LMC643DAC.SQL_WHERE)

                    Call Me.SetConditionMasterSQL()                     'SQL構築(条件設定)
                    Me._StrSql.Append(LMC643DAC.SQL_GROUP_BY)           'SQL構築(データ抽出用GROUP BY句)
                Else
                    'FREE_C03未使用(通常)
                    Me._StrSql.Append(LMC643DAC.SQL_SELECT_DATA_FREE)   'SQL構築(データ抽出用SELECT句)
                    Me._StrSql.Append(LMC643DAC.SQL_SELECT_ADD_SAGYO)
                    Me._StrSql.Append(LMC643DAC.SQL_FROM_FREE)          'SQL構築(データ抽出用FROM句)
                    Me._StrSql.Append(LMC643DAC.SQL_FROM_ADD_SAGYO)
                    Me._StrSql.Append(LMC643DAC.SQL_WHERE)
                    Call Me.SetConditionMasterSQL()                     'SQL構築(条件設定)
                    Me._StrSql.Append(LMC643DAC.SQL_GROUP_BY_FREE)      'SQL構築(データ抽出用GROUP BY句)
                    Me._StrSql.Append(LMC643DAC.SQL_GROUP_BY_FREE_ADD)      'SQL構築(データ抽出用GROUP BY句)
                End If

                '荷姿並び替え
                If String.IsNullOrEmpty(setNaiyo) = True Then
                    Me._StrSql.Append(LMC643DAC.SQL_ORDER_BY1)         'SQL構築(データ抽出用ORDER BY句)
                Else
                    Me._StrSql.Append(LMC643DAC.SQL_ORDER_BY1)         'SQL構築(データ抽出用ORDER BY句)
                    Me._StrSql.Append(",MAIN.$SET_NAIYO$")
                End If

                Me._StrSql.Append(LMC643DAC.SQL_ORDER_BY2)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMC643DAC", "SelectPrintData", cmd)
