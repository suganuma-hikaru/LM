...
#Region "帳票種別取得用・荷札"
    ...
    ''' <remarks></remarks>
#If False Then
    Private Const SQL_SELECT_MPrt_Tag As String = "SELECT DISTINCT                                                                                  " & vbNewLine _
                                                    & " OUTKAL.NRS_BR_CD                                           AS NRS_BR_CD                     " & vbNewLine _
                                                    & ",'10'                                                       AS PTN_ID                        " & vbNewLine _
                                                    & ",MR.PTN_CD			                                       AS PTN_CD                        " & vbNewLine _
                                                    & ",MR.RPT_ID			                                       AS RPT_ID                        " & vbNewLine
#Else
    Private Const SQL_SELECT_MPrt_Tag As String = "SELECT DISTINCT                                                             " & vbNewLine _
                                                    & " OUTKAL.NRS_BR_CD                                         AS NRS_BR_CD  " & vbNewLine _
                                                    & ",'10'                                                     AS PTN_ID     " & vbNewLine _
...
#End If
    ...
    'ADD 2017/03/01
    Private Const SQL_SELECT_MPrt_TagUnso As String = "SELECT DISTINCT                                                             " & vbNewLine _
...
#Region "SELECT句"
    ...
    Private Const SQL_SELECT_MEITETU As String = " SELECT                                                                                    " & vbNewLine _
                                                       ...
                                                       & " ,MCD.SET_NAIYO											           AS ZIP_PATTERN      " & vbNewLine
...
#Region "大阪"
    ...
    Private Const SQL_SELECT_MEITETU_OSAKA As String = " SELECT                                                                                      " & vbNewLine _
                                                       ...
                                                       & "  ,CONVERT(varchar,CONVERT(int,SUBSTRING(OUTKAL.ARR_PLAN_DATE,5,2))) +                     " & vbNewLine _
                                                       & "    '月' +                                                                                 " & vbNewLine _
                                                       & "   CONVERT(varchar,CONVERT(int,SUBSTRING(OUTKAL.ARR_PLAN_DATE,7,2))) +                     " & vbNewLine _
                                                       & "    '日'                                                               AS ARR_PLAN_DATE    " & vbNewLine _
...
#Region "横浜"
    ...
    Private Const SQL_SELECT_MEITETU_YOKOHAMA As String = " SELECT                                                                                 " & vbNewLine _
                                                       ...
                                                       & "  END                                                                 AS NIUKENIN_TEL    " & vbNewLine _
                                                       & " ,SUBSTRING(OUTKAL.ARR_PLAN_DATE,5,2) +                                                  " & vbNewLine _
                                                       & "  '月' +                                                                                 " & vbNewLine _
                                                       & "  SUBSTRING(OUTKAL.ARR_PLAN_DATE,7,2) +                                                  " & vbNewLine _
                                                       & "  '日'                                                                AS ARR_PLAN_DATE   " & vbNewLine _
                                                       & " ,DEST3.DEST_NM                                                       AS SHIP_NM_L       " & vbNewLine _
                                                       & " ,CUST.DENPYO_NM                                                      AS DENPYO_NM       " & vbNewLine _
                                                       & " ,CASE WHEN OKURIJOCSV.NRS_BR_CD IS NOT NULL                                             " & vbNewLine _
...
#Region "From句・Where句"
    ...
    Private Const SQL_SELECT_MEITETU_FROM As String = "  FROM                                                                 " & vbNewLine _
                                                        ...
                                                        & "                                                                   " & vbNewLine _
                                                        & " LEFT JOIN LM_MST..M_NRS_BR NRSBR                                  " & vbNewLine _
                                                        ...
                                                        & "   ON DEST2.NRS_BR_CD       = DEST.NRS_BR_CD                       " & vbNewLine _
                                                        & "  AND DEST2.CUST_CD_L       = DEST.CUST_CD_L                       " & vbNewLine _
                                                        & "  AND DEST2.DEST_CD         = DEST.CUST_DEST_CD                    " & vbNewLine _
                                                        & "                                                                   " & vbNewLine _
                                                        & " LEFT JOIN LM_MST..M_DEST DEST3                                    " & vbNewLine _
                                                        & "   ON DEST3.NRS_BR_CD       = OUTKAL.NRS_BR_CD                     " & vbNewLine _
                                                        & "  AND DEST3.CUST_CD_L       = OUTKAL.CUST_CD_L                     " & vbNewLine _
                                                        & "  AND DEST3.DEST_CD         = OUTKAL.SHIP_CD_L                     " & vbNewLine _
                                                        & "                                                                   " & vbNewLine _
                                                        ...
                                                        & "  AND OKURIJOCSV.OKURIJO_TP = '01'                                 " & vbNewLine _
                                                        & "  AND OKURIJOCSV.FREE_C11   = UNSOL.UNSO_BR_CD                     " & vbNewLine _
                                                        & "                                                                   " & vbNewLine _
                                                        ...
                                                        & "  AND OKURIJOCSVX.OKURIJO_TP= '01'                                 " & vbNewLine _
                                                        & "                                                                   " & vbNewLine _
                                                        & " LEFT JOIN LM_MST..M_CUST CUST                                     " & vbNewLine _
                                                        & "   ON CUST.NRS_BR_CD        = OUTKAL.NRS_BR_CD                     " & vbNewLine _
                                                        & "  AND CUST.CUST_CD_L        = OUTKAL.CUST_CD_L                     " & vbNewLine _
                                                        ...
                                                        & "                                                                   " & vbNewLine _
                                                        & "LEFT OUTER JOIN LM_MST..Z_KBN ZKBN                                 " & vbNewLine _
                                                        ...
                                                        & " AND MUCR_ALL.PTN_ID        = '10'                                 " & vbNewLine _
                                                        ...
                                                        & " AND MUCR_CUST.PTN_ID       = '10'                                 " & vbNewLine _
    ...
    'ADD 2017/03/01 運送より
    Private Const SQL_SELECT_MEITETU_FROM_UNSO As String = "  FROM                                                                 " & vbNewLine _
                                                         & " $LM_TRN$..F_UNSO_L UNSOL                                         " & vbNewLine _
                                                         & " LEFT JOIN $LM_MST$..M_NRS_BR NRSBR                               " & vbNewLine _
                                                         & "   ON NRSBR.NRS_BR_CD       =  UNSOL.NRS_BR_CD                    " & vbNewLine _
                                                         & " LEFT JOIN $LM_MST$..M_DEST DEST                                  " & vbNewLine _
                                                         & "   ON DEST.NRS_BR_CD        =  UNSOL.NRS_BR_CD                    " & vbNewLine _
                                                         & "  AND DEST.CUST_CD_L        =  UNSOL.CUST_CD_L                    " & vbNewLine _
                                                         & "  AND DEST.DEST_CD          =  UNSOL.DEST_CD                      " & vbNewLine _
                                                         & " LEFT JOIN $LM_MST$..M_DEST DEST2                                 " & vbNewLine _
                                                         & "   ON DEST2.NRS_BR_CD       = DEST.NRS_BR_CD                      " & vbNewLine _
                                                         & "  AND DEST2.CUST_CD_L       = DEST.CUST_CD_L                      " & vbNewLine _
                                                         & "  AND DEST2.DEST_CD         = DEST.CUST_DEST_CD                   " & vbNewLine _
                                                         ...
                                                         & "  AND OKURIJOCSVX.OKURIJO_TP= '01'                                " & vbNewLine _
                                                         & " LEFT JOIN $LM_MST$..M_CUST CUST                                  " & vbNewLine _
                                                         & "  ON CUST.NRS_BR_CD        =  UNSOL.NRS_BR_CD                     " & vbNewLine _
                                                         & "  AND CUST.CUST_CD_L        =  UNSOL.CUST_CD_L                    " & vbNewLine _
                                                         & "  AND CUST.CUST_CD_M        =  UNSOL.CUST_CD_M                    " & vbNewLine _
                                                         & "  AND CUST.CUST_CD_S        = '00'                                " & vbNewLine _
                                                         & "  AND CUST.CUST_CD_SS       = '00'                                " & vbNewLine _
                                                         & "--荷主によって取扱店が違う場合に使用                              " & vbNewLine _
                                                         & " LEFT OUTER JOIN $LM_MST$..M_CUST_DETAILS MCD                     " & vbNewLine _
...
#Region "GROUP BY"
    ...
    Private Const SQL_SELECT_MEITETU_GROUPBY As String = " GROUP BY                                                                            " & vbNewLine _
                                                       ...
                                                       & " ,OKURIJOCSVX.FREE_C10                                                                   " & vbNewLine
...
#Region "名鉄荷札作成"
    ...
    Private Const SQL_UPDATE_MEITETU As String = "UPDATE $LM_TRN$..C_OUTKA_L SET                  " & vbNewLine _
...
#Region "出力対象帳票パターン取得処理"
    ...
    Private Function SelectMPrt_Tag(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        'Dim inTbl As DataTable = ds.Tables("LMC789IN")
        Dim inTbl As DataTable = ds.Tables("LMC789OUT")
...
#If False Then
        Select Case Me._Row.Item("NRS_BR_CD").ToString()
            Case "20"
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MPrt_Tag)
                Me._StrSql.Append(LMC789DAC.SQL_FROM_MEITETU_OSAKA)             'SQL構築(帳票種別用From句)
            Case "10", "30", "40", "50"
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MPrt_Tag)                 'SQL構築(帳票種別用Select句)  
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM)             'SQL構築(帳票種別用From句)
        End Select
#End If
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MPrt_Tag)                 'SQL構築(帳票種別用Select句)  
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM)             'SQL構築(帳票種別用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMC789DAC", "SelectMPrt_Tag", cmd)
    ...
    Private Function SelectMPrt_TagUnso(ByVal ds As DataSet) As DataSet
        ...
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MPrt_TagUnso)                 'SQL構築(帳票種別用Select句)  
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM_UNSO)            'SQL構築(帳票種別用From句)
...
#If False Then
        ...
        Select Case Me._Row.Item("NRS_BR_CD").ToString()
            Case "20"
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_OSAKA)
                Me._StrSql.Append(LMC789DAC.SQL_FROM_MEITETU_OSAKA)
                Me._StrSql.Append(LMC789DAC.SQL_GROUPBY_MEITETU_OSAKA)
            Case "30"
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_GUNMA)
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM)
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_GROUPBY)
            Case "10", "40", "60"
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_YOKOHAMA)
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM)
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_GROUPBY)
            Case "50"
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_SAITAMA)
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM)
                Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_GROUPBY)
        End Select
#Else
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU)
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_FROM)
        Me._StrSql.Append(LMC789DAC.SQL_SELECT_MEITETU_GROUPBY)
#End If
        ...
        MyBase.Logger.WriteSQLLog("LMC789DAC", "SelectMeitetuTag", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMC789OUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMC789OUT").Rows.Count())
        reader.Close()
...
#Region "名鉄郵便番号"
    ...
    Private Function SelectMeitetuZip(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMC789DAC.SQL_MEITETU_ZIP)

        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me._Row("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ZIP_NO", Me._Row("NIUKENIN_ZIP"), DBDataType.CHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMC789DAC", "SelectMeitetuZip", cmd)
...
#End Region
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function UpdateMeitetuLabelTag(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Me._Row = ds.Tables("LMC789OUT").Rows(0)
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMC789DAC.SQL_UPDATE_MEITETU, Me._Row.Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMC789DAC", "UpdateMeitetuTag", cmd)
