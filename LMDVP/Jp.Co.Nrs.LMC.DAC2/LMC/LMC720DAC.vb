...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                          " & vbNewLine _
                                            ...
                                            & "      --2012/11/13届け先電話番号追加開始                         " & vbNewLine _
                                            & "      , OUTKA_L.DEST_TEL            AS DEST_TEL                  " & vbNewLine _
                                            & "      --2012/11/13届け先電話番号追加終了                         " & vbNewLine _
                                            & "      , OUTKA_M.OUTKA_TTL_NB        AS ALCTD_NB                  " & vbNewLine _
    ...
    Private Const SQL_FROM As String = " --出荷(大)                                                        " & vbNewLine _
                                     ...
                                     & "          -- AND M_DEST.AD_3 Like '%JAL%' --2012/11/13条件解除     " & vbNewLine _
                                     & "       --荷主Ｍ                                                    " & vbNewLine _
                                     ...
                                     & "             AND MCR1.PTN_ID    = 'AP'                             " & vbNewLine _
                                     ...
                                     & "             AND MCR2.PTN_ID = 'AP'                                " & vbNewLine _
                                     & "       --帳票パターン取得                                          " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMC720IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMC720DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMC720DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                  '条件設定
        'Call Me.SetConditionMasterPatternSQL()            '条件設定：2012/11/13帳票パターン追加用
        'スキーマ名設定
        ...
        MyBase.Logger.WriteSQLLog("LMC720DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMC720DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMC720DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMC720DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMC720DAC", "SelectPrintData", cmd)
        ...
        'START-2012/11/12届け先電話番号追加開始▼▼▼
        map.Add("DEST_TEL", "DEST_TEL")
        '▲▲▲2012/11/12届け先電話番号追加終了-TOEND
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMC720OUT")
    ...
    'START-2012/11/13帳票パターン用WHERE句追加▼▼▼
    ...
    End Sub
    '▲▲▲2012/11/13帳票パターン用WHERE句追加-TOEND
