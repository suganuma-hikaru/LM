...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_MEITETU_CSV As String = " SELECT                                                                                      " & vbNewLine _
                                                       ...
                                                       & "-- ,OUTKAL.ARR_PLAN_DATE AS HAISOBI                                                        " & vbNewLine _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_MEITETU_CSV_GUNMA As String = " SELECT                                                                                      " & vbNewLine _
                                                       & "  OUTKAL.NRS_BR_CD AS NRS_BR_CD                                                          " & vbNewLine _
                                                       & " ,OUTKAL.OUTKA_NO_L AS DENPYO_NO                                                         " & vbNewLine _
                                                       & " ,SUBSTRING(OUTKAL.OUTKA_PLAN_DATE,1,4) +                                                " & vbNewLine _
                                                       & "  '/' +                                                                                  " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMeitetuCsv(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMC800IN")
        ...
        'SQL作成
        If Me._Row.Item("NRS_BR_CD").ToString() = "30" Then
            Me._StrSql.Append(LMC800DAC.SQL_SELECT_MEITETU_CSV_GUNMA)
        Else
            Me._StrSql.Append(LMC800DAC.SQL_SELECT_MEITETU_CSV)
        End If
        'Me._StrSql.Append(LMC800DAC.SQL_SELECT_MEITETU_CSV)
        Me._StrSql.Append(LMC800DAC.SQL_SELECT_MEITETU_CSV_FROM)
        Me._StrSql.Append(LMC800DAC.SQL_SELECT_MEITETU_CSV_GROUPBY)
        ...
        MyBase.Logger.WriteSQLLog("LMC800DAC", "SelectMeitetuCsv", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMC800OUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMC800OUT").Rows.Count())
        reader.Close()
    ...
    Private Function UpdateMeitetuCsv(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Me._Row = ds.Tables("LMC800OUT").Rows(0)
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMC800DAC.SQL_UPDATE_MEITETU_CSV, Me._Row.Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMC800DAC", "UpdateMeitetuCsv", cmd)
