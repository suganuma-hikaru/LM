...
#Region "検索処理 SQL"
    ...
    Private Const SQL_FROM As String = "--出荷L                                                                      " & vbNewLine _
                                     ...
                                     & "ON MUSER.USER_CD = OUTL.SYS_UPD_USER                                         " & vbNewLine _
                                     ...
                                     & "AND MCR1.PTN_ID = '16'                                                       " & vbNewLine _
                                     ...
                                     & "AND MCR2.PTN_ID = '16'                                                       " & vbNewLine _
                                     & "--帳票パターン取得                                                           " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMC600IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMC600DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMC600DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMC600DAC.SQL_WHERE)
        ...
        MyBase.Logger.WriteSQLLog("LMC600DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMC600DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMC600DAC.SQL_SELECT_ADD_SAGYO)
        Me._StrSql.Append(LMC600DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMC600DAC.SQL_FROM_ADD_SAGYO)
        Me._StrSql.Append(LMC600DAC.SQL_WHERE)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMC600DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMC600DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMC600OUT")
