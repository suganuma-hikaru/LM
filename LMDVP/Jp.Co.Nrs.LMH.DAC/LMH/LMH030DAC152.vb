...
'  EDI荷主ID　　　　:  152　　　 : メルクエレクトロニクス(2023/01/11(REV.5582)のセミEDI標準仕様000からコピー)
'  作  成  者       :  
' ==========================================================================
Imports System.Text
...
#Region "EDI出荷受信テーブル(明細) INSERT SQL"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "" _
        ...
        & "    , PRTFLG                      " & vbNewLine _
        & "    , DLVY_NUM                    " & vbNewLine _
        & "    , SLS_ORD                     " & vbNewLine _
        & "    , SHIP_NO                     " & vbNewLine _
        & "    , DLVY_TYPE                   " & vbNewLine _
        & "    , ROUTE                       " & vbNewLine _
        & "    , PGI_DT                      " & vbNewLine _
        & "    , RDD                         " & vbNewLine _
        & "    , ITEM_NR_DLVY                " & vbNewLine _
        & "    , SHIPTO_NO                   " & vbNewLine _
        & "    , SHIPTO_N1                   " & vbNewLine _
        & "    , SHIPTO_N2                   " & vbNewLine _
        & "    , DEST_ZIP                    " & vbNewLine _
        & "    , DEST_AD_1                   " & vbNewLine _
        & "    , DEST_AD_2                   " & vbNewLine _
        & "    , DEST_AD_3                   " & vbNewLine _
        & "    , DEST_TEL                    " & vbNewLine _
        & "    , SHIP_NOTE                   " & vbNewLine _
        & "    , COA                         " & vbNewLine _
        & "    , REMARKS2                    " & vbNewLine _
        & "    , GOODS_CD_CUST               " & vbNewLine _
        & "    , GOODS_NM                    " & vbNewLine _
        & "    , LOT_NO                      " & vbNewLine _
        & "    , QTY_STRING                  " & vbNewLine _
        & "    , QTY_UT                      " & vbNewLine _
        & "    , PO_NUMBERIN_SO              " & vbNewLine _
        & "    , CUST_MATERIAL               " & vbNewLine _
        & "    , TODAYS_DT                   " & vbNewLine _
        & "    , SALES_TEXT                  " & vbNewLine _
        & "    , SLOC_TEXT                   " & vbNewLine _
        & "    , DESCRIPTION                 " & vbNewLine _
        & "    , CUST_MAT_TEXT               " & vbNewLine _
        & "    , BIN_NR                      " & vbNewLine _
        & "    , SLOC_CD                     " & vbNewLine _
        & "    , PO_DATE                     " & vbNewLine _
        & "    , TRANSGRP                    " & vbNewLine _
        & "    , QTY_NUM                     " & vbNewLine _
        & "    , SOLDTO                      " & vbNewLine _
        & "    , SOLDTO_NM                   " & vbNewLine _
        & "    , CUST_CLASS                  " & vbNewLine _
        & "    , PROFIT_CTR                  " & vbNewLine _
        & "    , CREATEN_DT                  " & vbNewLine _
        & "    , VOL                         " & vbNewLine _
        & "    , VOL_UT                      " & vbNewLine _
        & "    , INT_MEMO                    " & vbNewLine _
        & "    , PRD_ATTR_1                  " & vbNewLine _
        & "    , TEMPRTURE                   " & vbNewLine _
        & "    , SRC_STR_TYPE                " & vbNewLine _
        & "    , ORG_BIN                     " & vbNewLine _
        & "    , LEGAL_REQMT                 " & vbNewLine _
        & "    , STRGE_CONDTN                " & vbNewLine _
        & "    , DESCRPTN                    " & vbNewLine _
        & "    , SHIP_PT                     " & vbNewLine _
        & "    , WARE                        " & vbNewLine _
        & "    , WAREHOUSE                   " & vbNewLine _
        & "    , PACKING_INSTRUCTIONS        " & vbNewLine _
        & "    , INVOICE_REQUIREMENTS        " & vbNewLine _
        & "    , ITEM_NOTE_JPCUT             " & vbNewLine _
...
#Region "H_OUTKAEDI_L(取込削除時)"
    ...
    Private Const SQL_UPDATE_DEL_OUTKAIEDI_L As String _
                        ...
                        & " AND   CUST_ORD_NO   = @CUST_ORD_NO          " & vbNewLine
...
#Region "H_OUTKAEDI_M(取込削除)"
    ...
    Private Const SQL_UPDATE_DEL_OUTKAIEDI_M As String _
                        ...
                        & "AND   HOL.CUST_ORD_NO = @CUST_ORD_NO         " & vbNewLine
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得"
    ...
    Private Function GetOutkaCntAndNoL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_SELECT_OUTKA_NO_L_AND_CNT)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_MERC")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "GetOutkaCntAndNoL", cmd)
...
#Region "EDI出荷受信テーブル(明細) 件数取得"
    ...
    Private Function GetOutkaEdiDtlCnt(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_SELECT_COUNT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "GetOutkaEdiDtlCnt", cmd)
...
#Region "商品マスタ"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC152.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC152.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectDataMgoods", cmd)
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC152.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC152.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectDataMdestOutkaToroku", cmd)
    ...
    Private Function SelectLikeDataMdest(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectDataMdest", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectDataZkbn", cmd)
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals(LMConst.FLG.ON) = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC152.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC152.SQL_WHERE_CANCER_DATA_DTL)

            'オーダー番号＋オーダー番号明細チェックの場合
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("3") = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC152.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC152.SQL_WHERE_CANCER_DATA_DTL_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("4") = True Then
            ...
            Me._StrSql.Append(LMH030DAC152.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC152.SQL_WHERE_CANCER_DATA_DTL_ONLY_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("5") = True Then
            ...
            Me._StrSql.Append(LMH030DAC152.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC152.SQL_WHERE_CANCER_DATA_DTL_M_FREE_C25)
            '2015.04.28 Ｍ・Ｒ・Ｃデュポン対応 M_FREE_C25_NOの(オーダー番号明細のみ)チェックの場合 追加END
        Else
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC152.SQL_SELECT_CANCER_DATA)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC152.SQL_WHERE_CANCER_DATA)
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    Private Function SelectCompareData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_ARB") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC152.SQL_SELECT_COMPARE_CHECK_ARB, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_MRC") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC152.SQL_SELECT_COMPARE_CHECK_MRC, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC152.SQL_WHERE_M_CUST_DETAILS_ALL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectMstCustAll", cmd)
...
#Region "H_OUTKAEDI_L"
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC152.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC152.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC152.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC152.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertOutkaEdiM", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC152.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC152.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateOutkaLData", cmd)
    ...
    Private Function UpdateOutkaLDataWithBuyerOrdNo(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録(まとめ時)
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC152.SQL_UPDATE_OUTKAL_MATOME_WITH_BUYER_ORD_NO
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC152.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC152.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC152", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC152.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertMDestData", cmd)
...
#Region "SQL パラメータ設定 セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得 用"
    ...
    Private Sub SetSqlParamGetOutkaCntAndNoL(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", dt.Rows(0).Item("DLVY_NUM"), DBDataType.CHAR))
    End Sub
...
#Region "EDI出荷(大・中共通)の削除UPDATE文(セミEDI用)"
    ...
    Private Sub SetUpdateDelOutkaEdiParameter(ByVal drOutkaEdiRcvIn As DataRow, ByVal prmList As ArrayList)
        ...
        prmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me.NullConvertString(drOutkaEdiRcvIn.Item("DLVY_NUM")), DBDataType.VARCHAR))
    End Sub
...
#Region "EDI出荷受信テーブル(明細) 物理削除"
    ...
    Private Function DeleteOutkaEdiDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_DELETE_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "DeleteOutkaEdiDtl", cmd)
...
#Region "EDI出荷受信テーブル(明細) 新規登録"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC152.SQL_INSERT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC152", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(明細) 新規登録 用"
    ...
    Private Sub SetSqlParamInsertOutkaEdiRcvDtl(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            ' EDI受信（DTL）荷主個別項目
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DLVY_NUM", Me.NullConvertString(.Item("DLVY_NUM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SLS_ORD", Me.NullConvertString(.Item("SLS_ORD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_NO", Me.NullConvertString(.Item("SHIP_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DLVY_TYPE", Me.NullConvertString(.Item("DLVY_TYPE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ROUTE", Me.NullConvertString(.Item("ROUTE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PGI_DT", Me.NullConvertString(.Item("PGI_DT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RDD", Me.NullConvertString(.Item("RDD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ITEM_NR_DLVY", Me.NullConvertString(.Item("ITEM_NR_DLVY")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIPTO_NO", Me.NullConvertString(.Item("SHIPTO_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIPTO_N1", Me.NullConvertString(.Item("SHIPTO_N1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIPTO_N2", Me.NullConvertString(.Item("SHIPTO_N2")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_NOTE", Me.NullConvertString(.Item("SHIP_NOTE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@COA", Me.NullConvertString(.Item("COA")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REMARKS2", Me.NullConvertString(.Item("REMARKS2")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@QTY_STRING", Me.NullConvertString(.Item("QTY_STRING")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@QTY_UT", Me.NullConvertString(.Item("QTY_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PO_NUMBERIN_SO", Me.NullConvertString(.Item("PO_NUMBERIN_SO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_MATERIAL", Me.NullConvertString(.Item("CUST_MATERIAL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TODAYS_DT", Me.NullConvertString(.Item("TODAYS_DT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SALES_TEXT", Me.NullConvertString(.Item("SALES_TEXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SLOC_TEXT", Me.NullConvertString(.Item("SLOC_TEXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DESCRIPTION", Me.NullConvertString(.Item("DESCRIPTION")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_MAT_TEXT", Me.NullConvertString(.Item("CUST_MAT_TEXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BIN_NR", Me.NullConvertString(.Item("BIN_NR")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SLOC_CD", Me.NullConvertString(.Item("SLOC_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PO_DATE", Me.NullConvertString(.Item("PO_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TRANSGRP", Me.NullConvertString(.Item("TRANSGRP")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@QTY_NUM", Me.NullConvertString(.Item("QTY_NUM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SOLDTO", Me.NullConvertString(.Item("SOLDTO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SOLDTO_NM", Me.NullConvertString(.Item("SOLDTO_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CLASS", Me.NullConvertString(.Item("CUST_CLASS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PROFIT_CTR", Me.NullConvertString(.Item("PROFIT_CTR")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CREATEN_DT", Me.NullConvertString(.Item("CREATEN_DT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@VOL", Me.NullConvertString(.Item("VOL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@VOL_UT", Me.NullConvertString(.Item("VOL_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INT_MEMO", Me.NullConvertString(.Item("INT_MEMO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PRD_ATTR_1", Me.NullConvertString(.Item("PRD_ATTR_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TEMPRTURE", Me.NullConvertString(.Item("TEMPRTURE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SRC_STR_TYPE", Me.NullConvertString(.Item("SRC_STR_TYPE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORG_BIN", Me.NullConvertString(.Item("ORG_BIN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LEGAL_REQMT", Me.NullConvertString(.Item("LEGAL_REQMT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@STRGE_CONDTN", Me.NullConvertString(.Item("STRGE_CONDTN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DESCRPTN", Me.NullConvertString(.Item("DESCRPTN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_PT", Me.NullConvertString(.Item("SHIP_PT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WARE", Me.NullConvertString(.Item("WARE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WAREHOUSE", Me.NullConvertString(.Item("WAREHOUSE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PACKING_INSTRUCTIONS", Me.NullConvertString(.Item("PACKING_INSTRUCTIONS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INVOICE_REQUIREMENTS", Me.NullConvertString(.Item("INVOICE_REQUIREMENTS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ITEM_NOTE_JPCUT", Me.NullConvertString(.Item("ITEM_NOTE_JPCUT")), DBDataType.NVARCHAR))
