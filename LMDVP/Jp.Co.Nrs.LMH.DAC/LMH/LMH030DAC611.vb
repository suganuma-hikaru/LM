...
#End Region
    ...
    '2012.11.21 要望番号1513 修正START オーダーチェックは出荷日まで条件に入れる
#Region "SELECT_C_OUTKA_L"
    Private Const SQL_SELECT_C_OUTKA_L_NIK As String = " SELECT                                   " & vbNewLine _
...
#End Region
    '2012.11.21 要望番号1513 修正END オーダーチェックは出荷日まで条件に入れる

#Region "M_SEHIN_NIK(日医工製品マスタ)"

    ''' <summary>
    ''' M_SEHIN_NIK(日医工製品マスタ)
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_SELECT_M_SEHIN_NIK As String = " SELECT                              " & vbNewLine _
                                 & " COUNT(*)                               AS MST_CNT     " & vbNewLine _
                                 & " FROM                                                  " & vbNewLine _
                                 & " $LM_TRN$..M_SEHIN_NIK                  M_SEHIN_NIK    " & vbNewLine _
                                 & " WHERE                                                 " & vbNewLine _
                                 & " M_SEHIN_NIK.NRS_BR_CD   = @NRS_BR_CD                  " & vbNewLine _
                                 & " AND                                                   " & vbNewLine _
                                 & " M_SEHIN_NIK.GOODS_CD_NIK  = @GOODS_CD_NIK             " & vbNewLine _
                                 & " AND                                                   " & vbNewLine _
                                 & " M_SEHIN_NIK.M_GOODS_UPD_FLG  = '00'                   " & vbNewLine
...
#Region "H_OUTKAEDI_DTL_RAPI"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_RAPI）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_RAPI SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "M_DEST INSERT(日医工は自動追加を行う為使用予定)"

    ''' <summary>
    ''' 届先マスタINSERT文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_NIK As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#Region "M_DEST UPDATE(届先項目差異有りの場合)(日医工は自動更新を行う為使用予定)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_NIK As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "実績作成処理 データ抽出用SQL"
    ...
    Private Const SQL_SELECT_SEND_DATA As String = "SELECT                                              " & vbNewLine _
                                          & "   '0' AS DEL_KB                                           " & vbNewLine _
                                          & "  ,DTL_RAP.CRT_DATE                                        " & vbNewLine _
                                          & "  ,DTL_RAP.FILE_NAME                                       " & vbNewLine _
                                          & "  ,DTL_RAP.REC_NO                                          " & vbNewLine _
                                          & "  ,DTL_RAP.GYO_NO AS GYO                                   " & vbNewLine _
                                          ...
                                          & "  ,OUT_L.CUST_CD_L                                         " & vbNewLine _
                                          & "  ,OUT_L.CUST_CD_M                                         " & vbNewLine _
                                          & "  ,'SJ' AS FILE_KBN                                        " & vbNewLine _
                                          & "  ,DTL_RAP.TORIHIKI_KBN                                    " & vbNewLine _
                                          & "  ,DTL_RAP.CANCEL_KBN                                      " & vbNewLine _
                                          & "  ,DTL_RAP.OUTKA_WH_CD                                     " & vbNewLine _
                                          & "  ,OUT_L.OUTKA_PLAN_DATE                                   " & vbNewLine _
                                          & "  ,DTL_RAP.DENP_KBN                                        " & vbNewLine _
                                          & "  ,DTL_RAP.DENP_NO                                         " & vbNewLine _
                                          & "  ,DTL_RAP.SUPPLIER_REF_NO                                 " & vbNewLine _
                                          & "  ,DTL_RAP.P_O_NO                                          " & vbNewLine _
                                          & "  ,DTL_RAP.SAGYO                                           " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_CD                                         " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_NM1                                        " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_NM2                                        " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_ADD1                                       " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_ADD2                                       " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_ADD3                                       " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_ADD4                                       " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_ADD5                                       " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_ZIP                                        " & vbNewLine _
                                          & "  ,DTL_RAP.DEST_TEL                                        " & vbNewLine _
                                          & "  ,CASE WHEN DTL_RAP.DENP_KBN IN ('003', '004')            " & vbNewLine _
                                          & "    THEN OUT_L.OUTKA_PLAN_DATE                             " & vbNewLine _
                                          & "    ELSE ''                                                " & vbNewLine _
                                          & "   END AS ARR_PLAN_DATE                                    " & vbNewLine _
                                          & "  ,DTL_RAP.ARR_PLAN_TIME                                   " & vbNewLine _
                                          & "  ,CASE WHEN DTL_RAP.DENP_KBN IN ('003', '004')            " & vbNewLine _
                                          & "    THEN ''                                                " & vbNewLine _
                                          & "    ELSE ISNULL(KBN_R023.KBN_NM1, '')                      " & vbNewLine _
                                          & "   END AS TRANS_WAY                                        " & vbNewLine _
                                          & "  ,CASE WHEN DTL_RAP.DENP_KBN IN ('003', '004')            " & vbNewLine _
                                          & "    THEN ''                                                " & vbNewLine _
                                          & "    ELSE UNS_L.UNSO_CD                                     " & vbNewLine _
                                          & "   END AS ROUTE_CD                                         " & vbNewLine _
                                          & "  ,DTL_RAP.CAR_NO                                          " & vbNewLine _
                                          & "  ,DTL_RAP.B_L_NO                                          " & vbNewLine _
                                          & "  ,ISNULL(EXP_L.CONTAINER_NM, '') AS CONTAINER_NO          " & vbNewLine _
                                          & "  ,DTL_RAP.SUPPLIER_GOODS_CD                               " & vbNewLine _
                                          & "  ,DTL_RAP.RAPIDUS_GOODS_CD                                " & vbNewLine _
                                          & "  ,DTL_RAP.GOODS_MEI                                       " & vbNewLine _
                                          & "  ,ROUND(                                                  " & vbNewLine _
                                          & "   CASE                                                    " & vbNewLine _
                                          & "    WHEN GOODS.GOODS_CD_NRS IS NULL                        " & vbNewLine _
                                          & "        THEN DTL_RAP.CASE_NB                               " & vbNewLine _
                                          & "        ELSE                                               " & vbNewLine _
                                          & "            CASE WHEN GOODS.PKG_NB = 1                     " & vbNewLine _
                                          & "                THEN OUT_S.ALCTD_NB                        " & vbNewLine _
                                          & "                ELSE FLOOR(OUT_S.ALCTD_NB / GOODS.PKG_NB)  " & vbNewLine _
                                          & "            END                                            " & vbNewLine _
                                          & "   END                                                     " & vbNewLine _
                                          ...
                                          & "   CASE                                                    " & vbNewLine _
                                          & "    WHEN GOODS.GOODS_CD_NRS IS NULL                        " & vbNewLine _
                                          & "        THEN DTL_RAP.BARA_QT                               " & vbNewLine _
                                          & "        ELSE                                               " & vbNewLine _
                                          & "            CASE WHEN GOODS.PKG_NB = 1                     " & vbNewLine _
                                          & "                THEN OUT_S.ALCTD_NB * (DTL_RAP.BARA_QT / DTL_RAP.CASE_NB) " & vbNewLine _
                                          & "                ELSE OUT_S.ALCTD_NB                        " & vbNewLine _
                                          & "            END                                            " & vbNewLine _
                                          & "   END                                                     " & vbNewLine _
                                          ...
                                          & "   CASE                                                    " & vbNewLine _
                                          & "    WHEN GOODS.GOODS_CD_NRS IS NULL                        " & vbNewLine _
                                          & "        THEN DTL_RAP.JYURYO                                " & vbNewLine _
                                          & "        ELSE                                               " & vbNewLine _
                                          & "            CASE WHEN GOODS.PKG_NB = 1                     " & vbNewLine _
                                          & "                THEN OUT_S.ALCTD_NB * (DTL_RAP.JYURYO / DTL_RAP.CASE_NB) " & vbNewLine _
                                          & "                ELSE OUT_S.ALCTD_NB * (DTL_RAP.JYURYO / DTL_RAP.BARA_QT) " & vbNewLine _
                                          & "            END                                            " & vbNewLine _
                                          & "   END                                                     " & vbNewLine _
                                          & "   , 3) AS JYURYO                                          " & vbNewLine _
                                          & "  ,ROUND(                                                  " & vbNewLine _
                                          & "       (DTL_RAP.YOSEKI / DTL_RAP.BARA_QT) *                " & vbNewLine _
                                          ...
                                          & "  ,DTL_RAP.TANI                                            " & vbNewLine _
                                          & "  ,DTL_RAP.NISUGATA                                        " & vbNewLine _
                                          & "  ,DTL_RAP.SUPPLIER_LOT_NO                                 " & vbNewLine _
                                          & "  ,DTL_RAP.PLT_CNT                                         " & vbNewLine _
                                          & "  ,DTL_RAP.YUKO_KIGEN                                      " & vbNewLine _
                                          & "  ,DTL_RAP.SEIZO_DATE                                      " & vbNewLine _
                                          & "  ,DTL_RAP.DTL_REMARK                                      " & vbNewLine _
                                          & "  ,CASE RTRIM(ISNULL(ZAI_T.GOODS_COND_KB_3, ''))           " & vbNewLine _
                                          & "     WHEN '' THEN 'N'                                      " & vbNewLine _
                                          & "     ELSE ZAI_T.GOODS_COND_KB_3                            " & vbNewLine _
                                          & "     END AS DAMAGE_HOLD                                    " & vbNewLine _
                                          & "  ,DTL_RAP.CARGO_ID                                        " & vbNewLine _
                                          & "  ,'' AS RECORD_STATUS                                     " & vbNewLine _
                                          & "  ,'2' AS JISSEKI_SHORI_FLG                                " & vbNewLine _
                                          & "FROM                                                       " & vbNewLine _
                                          & "  $LM_TRN$..H_OUTKAEDI_M AS EDI_M                          " & vbNewLine _
                                          & "  INNER JOIN                                               " & vbNewLine _
                                          & "    $LM_TRN$..C_OUTKA_M AS OUT_M                           " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          OUT_M.SYS_DEL_FLG = '0'                          " & vbNewLine _
                                          ...
                                          & "  INNER JOIN                                               " & vbNewLine _
                                          & "    $LM_TRN$..C_OUTKA_L AS OUT_L                           " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          OUT_L.SYS_DEL_FLG = '0'                          " & vbNewLine _
                                          & "      AND OUT_L.NRS_BR_CD = OUT_M.NRS_BR_CD                " & vbNewLine _
                                          & "      AND OUT_L.OUTKA_NO_L = OUT_M.OUTKA_NO_L              " & vbNewLine _
                                          & "  INNER JOIN                                               " & vbNewLine _
                                          & "    $LM_TRN$..C_OUTKA_S AS OUT_S                           " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          OUT_S.SYS_DEL_FLG = '0'                          " & vbNewLine _
                                          & "      AND OUT_S.NRS_BR_CD = OUT_M.NRS_BR_CD                " & vbNewLine _
                                          & "      AND OUT_S.OUTKA_NO_L = OUT_M.OUTKA_NO_L              " & vbNewLine _
                                          & "      AND OUT_S.OUTKA_NO_M = OUT_M.OUTKA_NO_M              " & vbNewLine _
                                          & "      AND OUT_S.OUTKA_NO_S = ISNULL((                      " & vbNewLine _
                                          & "                SELECT TOP 1                               " & vbNewLine _
                                          & "                    C_OUTKA_S.OUTKA_NO_S                   " & vbNewLine _
                                          & "                FROM                                       " & vbNewLine _
                                          & "                    $LM_TRN$..C_OUTKA_S                    " & vbNewLine _
                                          & "                WHERE                                      " & vbNewLine _
                                          & "                    C_OUTKA_S.NRS_BR_CD = OUT_M.NRS_BR_CD  " & vbNewLine _
                                          & "                AND C_OUTKA_S.OUTKA_NO_L = OUT_M.OUTKA_NO_L" & vbNewLine _
                                          & "                AND C_OUTKA_S.OUTKA_NO_M = OUT_M.OUTKA_NO_M" & vbNewLine _
                                          ...
                                          & "            ), '')                                         " & vbNewLine _
                                          & "  LEFT JOIN                                                " & vbNewLine _
                                          & "    $LM_TRN$..D_ZAI_TRS AS ZAI_T                           " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          ZAI_T.NRS_BR_CD = OUT_S.NRS_BR_CD                " & vbNewLine _
                                          & "      AND ZAI_T.ZAI_REC_NO = OUT_S.ZAI_REC_NO              " & vbNewLine _
                                          & "  INNER JOIN                                               " & vbNewLine _
                                          & "    $LM_TRN$..H_OUTKAEDI_DTL_RAPI AS DTL_RAP               " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          DTL_RAP.DEL_KB <> '1'                            " & vbNewLine _
                                          & "      AND DTL_RAP.NRS_BR_CD = EDI_M.NRS_BR_CD              " & vbNewLine _
                                          & "      AND DTL_RAP.EDI_CTL_NO = EDI_M.EDI_CTL_NO            " & vbNewLine _
                                          & "      AND DTL_RAP.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU    " & vbNewLine _
                                          & "      AND DTL_RAP.JISSEKI_SHORI_FLG = '1'                  " & vbNewLine _
                                          & "  LEFT JOIN                                                " & vbNewLine _
                                          & "    $LM_TRN$..C_EXPORT_L AS EXP_L                          " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          EXP_L.SYS_DEL_FLG = '0'                          " & vbNewLine _
                                          & "      AND EXP_L.NRS_BR_CD = OUT_L.NRS_BR_CD                " & vbNewLine _
                                          & "      AND EXP_L.OUTKA_NO_L = OUT_L.OUTKA_NO_L              " & vbNewLine _
                                          & "  LEFT JOIN                                                " & vbNewLine _
                                          & "    $LM_MST$..M_GOODS AS GOODS                             " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          GOODS.NRS_BR_CD = OUT_M.NRS_BR_CD                " & vbNewLine _
                                          & "      AND GOODS.GOODS_CD_NRS = OUT_M.GOODS_CD_NRS          " & vbNewLine _
                                          & "      AND GOODS.SYS_DEL_FLG = '0'                          " & vbNewLine _
                                          & "  LEFT JOIN                                                " & vbNewLine _
                                          & "    $LM_TRN$..F_UNSO_L AS UNS_L                            " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          UNS_L.UNSO_NO_L = ISNULL((                       " & vbNewLine _
                                          & "                SELECT TOP 1                               " & vbNewLine _
                                          & "                    F_UNSO_L.UNSO_NO_L                     " & vbNewLine _
                                          & "                FROM                                       " & vbNewLine _
                                          & "                    $LM_TRN$..F_UNSO_L                     " & vbNewLine _
                                          & "                WHERE                                      " & vbNewLine _
                                          & "                    F_UNSO_L.NRS_BR_CD = OUT_L.NRS_BR_CD   " & vbNewLine _
                                          & "                AND F_UNSO_L.INOUTKA_NO_L = OUT_L.OUTKA_NO_L " & vbNewLine _
                                          & "                AND F_UNSO_L.SYS_DEL_FLG = '0'             " & vbNewLine _
                                          & "                ORDER BY                                   " & vbNewLine _
                                          & "                    F_UNSO_L.UNSO_NO_L                     " & vbNewLine _
                                          & "            ), '')                                         " & vbNewLine _
                                          & "      AND UNS_L.SYS_DEL_FLG = '0'                          " & vbNewLine _
                                          & "  LEFT JOIN                                                " & vbNewLine _
                                          & "    $LM_MST$..Z_KBN KBN_R023                               " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          KBN_R023.KBN_GROUP_CD = 'R023'                   " & vbNewLine _
                                          & "      AND KBN_R023.KBN_CD = UNS_L.UNSO_CD                  " & vbNewLine _
                                          & "      AND KBN_R023.SYS_DEL_FLG = '0'                       " & vbNewLine _
                                          & "WHERE                                                      " & vbNewLine _
                                          & "      EDI_M.DEL_KB <> '1'                                  " & vbNewLine _
...
#Region "H_SENDOUTEDI"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI As String = "INSERT INTO       " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_RAPI      " & vbNewLine _
                                         & "(                                " & vbNewLine _
                                         & " DEL_KB                          " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_RAPI"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_RAPI SET        " & vbNewLine _
...
#Region "実績作成処理 同一まとめ番号データ取得用SQL"
    ...
    ''' 同一まとめ番号データ取得用SQL
    ''' </summary>
    ''' <remarks>日医工は現状まとめ処理はないが、切り替えた時の為に記載</remarks>
    Private Const SQL_SELECT_DATA_MATOME As String = " SELECT                                                              " & vbNewLine _
                                            ...
                                            & "--,H_OUTKAEDI_DTL_NIK.SYS_UPD_DATE                    AS RCV_SYS_UPD_DATE     " & vbNewLine _
                                            & "--,H_OUTKAEDI_DTL_NIK.SYS_UPD_TIME                    AS RCV_SYS_UPD_TIME     " & vbNewLine _
                                            ...
                                            & "-- LEFT JOIN                                                                  " & vbNewLine _
                                            & "-- $LM_TRN$..H_OUTKAEDI_DTL_NIK                                               " & vbNewLine _
                                            & "-- ON                                                                         " & vbNewLine _
                                            & "-- H_OUTKAEDI_L.NRS_BR_CD =H_OUTKAEDI_DTL_NIK.NRS_BR_CD                       " & vbNewLine _
                                            & "-- AND                                                                        " & vbNewLine _
                                            & "-- H_OUTKAEDI_L.EDI_CTL_NO =H_OUTKAEDI_DTL_NIK.EDI_CTL_NO                     " & vbNewLine _
                                            & " INNER JOIN                                                                 " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataNikMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC611.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectDataNikMdest", cmd)
...
#Region "M_GOODS"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataSeihinNik(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.SQL_SELECT_M_SEHIN_NIK)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetSeihinNikParameter(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectDataSeihinNik", cmd)
...
#End Region
    ...
    '2012.11.21 要望番号1513 追加START
#Region "出荷(大)データ(オーダー番号チェック用)日医工専用"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>オーダー番号重複チェック(日医工は出荷予定日まで条件に入れる)</remarks>
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.SQL_SELECT_C_OUTKA_L_NIK)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterNik(dt)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectDataOrderCheckNik", cmd)
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    Private Function SelectEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.SQL_SELECT_SEND_DATA)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectEdiSend", cmd)
        ...
        map.Add("DEST_ADD1", "DEST_ADD1")
        map.Add("DEST_ADD2", "DEST_ADD2")
        map.Add("DEST_ADD3", "DEST_ADD3")
        map.Add("DEST_ADD4", "DEST_ADD4")
        map.Add("DEST_ADD5", "DEST_ADD5")
        map.Add("DEST_ZIP", "DEST_ZIP")
        map.Add("DEST_TEL", "DEST_TEL")
        map.Add("ARR_PLAN_DATE", "ARR_PLAN_DATE")
        map.Add("ARR_PLAN_TIME", "ARR_PLAN_TIME")
        map.Add("TRANS_WAY", "TRANS_WAY")
        map.Add("ROUTE_CD", "ROUTE_CD")
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_RAPI")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_RAPI").Rows.Count())
        reader.Close()
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectMatome", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC611.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC611.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC611.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC611.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC611.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC611.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC611.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC611.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC611.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC611.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '日医工　修正箇所START　仕掛中
#Region "M_DEST(日医工は自動更新を行う為、使用予定)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_NIK"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    Private Function InsertEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_RAPI")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_H_SENDOUTEDI _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_RAPI").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertEdiSendData", cmd)
...
#End Region
    ...
    '日医工　修正箇所START　仕掛中
#Region "M_DEST(日医工は自動追加を行う為、使用予定)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC611.SQL_INSERT_M_DEST_NIK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "InsertMDestData", cmd)
...
#End Region
    ...
    '日医工　修正箇所START　仕掛中
#Region "届先マスタ自動追加用パラメータ設定(日医工専用)"
...
#End Region
    ...
    '2012.11.21 要望番号1513 追加START
#Region "出荷(大)パラメータ設定(オーダー番号チェック用)日医工専用"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterNik(ByVal dt As DataTable)
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(.Item("CUST_CD_L")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(.Item("CUST_CD_M")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FILE_KBN", Me.NullConvertString(.Item("FILE_KBN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKI_KBN", Me.NullConvertString(.Item("TORIHIKI_KBN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CANCEL_KBN", Me.NullConvertString(.Item("CANCEL_KBN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_WH_CD", Me.NullConvertString(.Item("OUTKA_WH_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_DATE", Me.NullConvertString(.Item("OUTKA_PLAN_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENP_KBN", Me.NullConvertString(.Item("DENP_KBN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENP_NO", Me.NullConvertString(.Item("DENP_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SUPPLIER_REF_NO", Me.NullConvertString(.Item("SUPPLIER_REF_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@P_O_NO", Me.NullConvertString(.Item("P_O_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAGYO", Me.NullConvertString(.Item("SAGYO")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@DEST_ADD1", Me.NullConvertString(.Item("DEST_ADD1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_ADD2", Me.NullConvertString(.Item("DEST_ADD2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_ADD3", Me.NullConvertString(.Item("DEST_ADD3")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_ADD4", Me.NullConvertString(.Item("DEST_ADD4")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_ADD5", Me.NullConvertString(.Item("DEST_ADD5")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_DATE", Me.NullConvertString(.Item("ARR_PLAN_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_TIME", Me.NullConvertString(.Item("ARR_PLAN_TIME")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TRANS_WAY", Me.NullConvertString(.Item("TRANS_WAY")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ROUTE_CD", Me.NullConvertString(.Item("ROUTE_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CAR_NO", Me.NullConvertString(.Item("CAR_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@B_L_NO", Me.NullConvertString(.Item("B_L_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CONTAINER_NO", Me.NullConvertString(.Item("CONTAINER_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SUPPLIER_GOODS_CD", Me.NullConvertString(.Item("SUPPLIER_GOODS_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@RAPIDUS_GOODS_CD", Me.NullConvertString(.Item("RAPIDUS_GOODS_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_MEI", Me.NullConvertString(.Item("GOODS_MEI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CASE_NB", Me.NullConvertString(.Item("CASE_NB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@BARA_QT", Me.NullConvertString(.Item("BARA_QT")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JYURYO", Me.NullConvertString(.Item("JYURYO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOSEKI", Me.NullConvertString(.Item("YOSEKI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TANI", Me.NullConvertString(.Item("TANI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NISUGATA", Me.NullConvertString(.Item("NISUGATA")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SUPPLIER_LOT_NO", Me.NullConvertString(.Item("SUPPLIER_LOT_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@PLT_CNT", Me.NullConvertString(.Item("PLT_CNT")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YUKO_KIGEN", Me.NullConvertString(.Item("YUKO_KIGEN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIZO_DATE", Me.NullConvertString(.Item("SEIZO_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DTL_REMARK", Me.NullConvertString(.Item("DTL_REMARK")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DAMAGE_HOLD", Me.NullConvertString(.Item("DAMAGE_HOLD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CARGO_ID", Me.NullConvertString(.Item("CARGO_ID")), DBDataType.CHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC611.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC611", "SelectDataMdestOutkaToroku", cmd)
