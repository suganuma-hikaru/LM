...
#Region "H_INOUTKAEDI_DTL_DOW"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_INOUTKAEDI_DTL_DOW）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_DTL_DOW SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_INOUTKAEDI_HED_DOW"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_INOUTKAEDI_HED_DOW）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_HED_DOW SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#End Region
    ...
    '#Region "M_DEST INSERT(ダウケミは自動追加がない為使用しない)"
    ...
    '#Region "M_DEST UPDATE(届先項目差異有りの場合)(ダウケミは自動更新がない為使用しない)"
    '    ''' <summary>
    '    ''' 届先マスタUPDATE文（M_DEST）
    '    ''' </summary>
    '    ''' <remarks></remarks>
...
#Region "H_SENDINOUTEDI_DOW SELECT句"

    Private Const SQL_SELECT_DOW_SEND_DATA As String = "SELECT                                                      " & vbNewLine _
                                          & " '0'                                          AS DEL_KB	            " & vbNewLine _
                                          ...
                                          & ",MAX(OUT_S.OUTKA_NO_S)                        AS EDI_CTL_NO_EDA        " & vbNewLine _
                                          ...
                                          & ",MAX(OUT_S.OUTKA_NO_S)                        AS OUTKA_CTL_NO_SHO      " & vbNewLine _
                                          & ",'00000'                                      AS S0_MSYM_KEY           " & vbNewLine _
                                          & ",'THR'                                        AS S1_MTRANS_HEAD        " & vbNewLine _
                                          & ",HED_DOW.H1_HPAR_NO                           AS S1_MPART_CD           " & vbNewLine _
                                          & ",''                                           AS S1_MFILLER1           " & vbNewLine _
                                          & ",'40'                                         AS S1_MCLIENT_CD1        " & vbNewLine _
                                          & ",HED_DOW.H1_HCOM_CODE1                        AS S1_MCOMPANY_CD1       " & vbNewLine _
                                          & ",''                                           AS S1_MFILLER2           " & vbNewLine _
                                          & ",HED_DOW.H3_HFILE_VERSION                     AS S1_MPRO_VERSION       " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          ...
                                          & ",HED_DOW.H1_HPAR_NO                           AS S2_MVAN_NO            " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'R' THEN 'YGMV'                                                  " & vbNewLine _
                                          & " WHEN 'W' THEN 'YWSW'                                                  " & vbNewLine _
                                          & " WHEN 'G' THEN 'YWSA'                                                  " & vbNewLine _
                                          ...
                                          & ",HED_DOW.H1_HREQ_FLAG                         AS S2_MREQ_FLAG          " & vbNewLine _
                                          & ",''                                           AS S2_MSYS_DATE          " & vbNewLine _
                                          & ",''                                           AS S2_MSYS_TIME          " & vbNewLine _
                                          & ",'40'                                         AS S2_MCLIENT_CD2        " & vbNewLine _
                                          & ",HED_DOW.H1_HCOM_CODE1                        AS S2_MCOMPANY_CD2       " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'R' THEN HED_DOW.H1_HSEL_PLANT_CD                                " & vbNewLine _
                                          & " ELSE HED_DOW.H1_HDEL_PLANT_CD1                                        " & vbNewLine _
                                          & " END                                          AS S2_MDEL_PLANT_CD      " & vbNewLine _
                                          & ",HED_DOW.H1_HDEL_NO1                          AS S2_MDEL_NOTE_NO       " & vbNewLine _
                                          & ",HED_DOW.H1_HSHIP_NO1                         AS S2_MSHIPMENT_NO       " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'G' THEN HED_DOW.H2_HSHIP_DATE                                   " & vbNewLine _
                                          & " WHEN 'B' THEN HED_DOW.H2_HSHIP_DATE                                   " & vbNewLine _
                                          & " ELSE ''                                                               " & vbNewLine _
                                          & " END                                          AS S2_MSHIP_DATE         " & vbNewLine _
                                          & ",''                                           AS S2_MRECE_DATE         " & vbNewLine _
                                          & ",HED_DOW.H3_HCARR_CD                          AS S2_MCARR_BP_CD        " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'W' THEN HED_DOW.H3_HDAIKAN                                      " & vbNewLine _
                                          & " WHEN 'B' THEN HED_DOW.H3_HDAIKAN                                      " & vbNewLine _
                                          & " ELSE ''                                                               " & vbNewLine _
                                          & " END                                          AS S2_MDAIKAN1           " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'G' THEN HED_DOW.H5_HSOLD_CD                                     " & vbNewLine _
                                          & " WHEN 'B' THEN HED_DOW.H5_HSOLD_CD                                     " & vbNewLine _
                                          & " ELSE ''                                                               " & vbNewLine _
                                          & " END                                          AS S2_MSOLD_BP_CD        " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'G' THEN HED_DOW.H5_HCUST_NO                                     " & vbNewLine _
                                          & " WHEN 'B' THEN HED_DOW.H5_HCUST_NO                                     " & vbNewLine _
                                          & " ELSE ''                                                               " & vbNewLine _
                                          & " END                                          AS S2_MCUST_ORD_NO       " & vbNewLine _
                                          & ",HED_DOW.H4_HCON_NM_KAN                       AS S2_MCON_NM_KAN        " & vbNewLine _
                                          & ",HED_DOW.H4_HCON_ADD_KAN                      AS S2_MCON_ADDRESS_KAN   " & vbNewLine _
                                          & ",''                                           AS S2_MFILLER4           " & vbNewLine _
                                          & ",'M'                                          AS S3_MREC_TYP3          " & vbNewLine _
                                          & ",DTL_DOW.M1_IDEL_ITEM_NO                      AS S3_MITEM_NO           " & vbNewLine _
                                          & ",DTL_DOW.M1_IMATERIAL_CD                      AS S3_MMATERIAL_CD       " & vbNewLine _
                                          & ",DTL_DOW.M1_ISTO_LOC                          AS S3_MSTLOC_NO          " & vbNewLine _
                                          & ",DTL_DOW.M1_ILOT_NO                           AS S3_MLOT_NO            " & vbNewLine _
                                          & ",DTL_DOW.M1_ISKU_QTY                          AS S3_MORG_ORD_QTY       " & vbNewLine _
                                          & ",DTL_DOW.M1_ISKU_QTY_UNIT                     AS S3_MORG_ORD_UNIT      " & vbNewLine _
                                          & ",SUM(                                                                  " & vbNewLine _
                                          & "  CASE M_GOODS.NB_UT                                                   " & vbNewLine _
                                          & "  WHEN 'CN' THEN ISNULL(OUT_S.ALCTD_QT,0)                              " & vbNewLine _
                                          & "  ELSE ISNULL(OUT_S.ALCTD_NB,0)                                        " & vbNewLine _
                                          & " END                                                                   " & vbNewLine _
                                          & ")                                             AS S3_MGOOD_QTY          " & vbNewLine _
                                          & ",DTL_DOW.M1_IQTY_UNIT                         AS S3_MGOOD_UNIT         " & vbNewLine _
                                          & ",0                                            AS S3_MDAIKAN_QTY        " & vbNewLine _
                                          & ",''                                           AS S3_MDAIKAN_UNIT       " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'R' THEN DTL_DOW.M1_IPO_NO                                       " & vbNewLine _
                                          & " ELSE ''                                                               " & vbNewLine _
                                          & " END                                          AS S3_MDOW_YOKO_NO       " & vbNewLine _
                                          & ",CASE RTRIM(HED_DOW.H1_HREQ_FLAG)                                      " & vbNewLine _
                                          & " WHEN 'R' THEN DTL_DOW.M1_IPO_ITEM_NO                                  " & vbNewLine _
                                          & " ELSE ''                                                               " & vbNewLine _
                                          ...
                                          & ",DTL_DOW.M1_IMATERIAL_NM1                     AS S0_MMATERIAL_NAME1    " & vbNewLine _
                                          & ",DTL_DOW.M1_IMATERIAL_NM2                     AS S0_MMATERIAL_NAME2    " & vbNewLine _
                                          & ",HED_DOW.H1_HORD_STATUS                       AS S0_MSTATUS            " & vbNewLine _
                                          & ",'*'                                          AS S0_MFLAG              " & vbNewLine _
                                          & ",'2'                                          AS JISSEKI_SHORI_FLG     " & vbNewLine

#End Region

#Region "H_SENDINOUTEDI_DOW FROM句"

    Private Const SQL_FROM_DOW_SEND_DATA As String = "FROM                                                          " & vbNewLine _
                                          & "$LM_TRN$..H_OUTKAEDI_M EDI_M                                           " & vbNewLine _
                                          & "INNER JOIN $LM_TRN$..C_OUTKA_M OUT_M                                   " & vbNewLine _
                                          ...
                                          & " INNER JOIN $LM_TRN$..C_OUTKA_L OUT_L                                  " & vbNewLine _
                                          ...
                                          & "INNER JOIN $LM_TRN$..C_OUTKA_S OUT_S                                   " & vbNewLine _
                                          & " ON  OUT_S.SYS_DEL_FLG <> '1'                                          " & vbNewLine _
                                          ...
                                          & "INNER JOIN $LM_TRN$..H_INOUTKAEDI_HED_DOW HED_DOW                      " & vbNewLine _
                                          & " ON  HED_DOW.DEL_KB <> '1'                                             " & vbNewLine _
                                          & " AND HED_DOW.NRS_BR_CD = EDI_M.NRS_BR_CD                               " & vbNewLine _
                                          & " AND HED_DOW.INOUT_KB = '0'                                            " & vbNewLine _
                                          & " AND HED_DOW.EDI_CTL_NO = EDI_M.EDI_CTL_NO                             " & vbNewLine _
                                          & "INNER JOIN $LM_TRN$..H_INOUTKAEDI_DTL_DOW DTL_DOW                      " & vbNewLine _
                                          & " ON  DTL_DOW.DEL_KB <> '1'                                             " & vbNewLine _
                                          & " AND DTL_DOW.NRS_BR_CD = EDI_M.NRS_BR_CD                               " & vbNewLine _
                                          & " AND DTL_DOW.INOUT_KB = '0'                                            " & vbNewLine _
                                          & " AND DTL_DOW.EDI_CTL_NO = EDI_M.EDI_CTL_NO                             " & vbNewLine _
                                          & " AND DTL_DOW.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU                     " & vbNewLine _
                                          & " AND DTL_DOW.JISSEKI_SHORI_FLG = '1'                                   " & vbNewLine _
                                          ...
                                          & " ,OUT_M.OUTKA_NO_M                                                     " & vbNewLine _
                                          & " ,HED_DOW.H1_HPAR_NO                                                   " & vbNewLine _
                                          & " ,HED_DOW.H1_HCOM_CODE1                                                " & vbNewLine _
                                          & " ,HED_DOW.H3_HFILE_VERSION                                             " & vbNewLine _
                                          & " ,HED_DOW.H1_HREQ_FLAG                                                 " & vbNewLine _
                                          & " ,HED_DOW.H1_HSEL_PLANT_CD                                             " & vbNewLine _
                                          & " ,HED_DOW.H1_HDEL_PLANT_CD1                                            " & vbNewLine _
                                          & " ,HED_DOW.H1_HDEL_NO1                                                  " & vbNewLine _
                                          & " ,HED_DOW.H1_HSHIP_NO1                                                 " & vbNewLine _
                                          & " ,HED_DOW.H2_HSHIP_DATE                                                " & vbNewLine _
                                          & " ,HED_DOW.H3_HCARR_CD                                                  " & vbNewLine _
                                          & " ,HED_DOW.H3_HDAIKAN                                                   " & vbNewLine _
                                          & " ,HED_DOW.H5_HSOLD_CD                                                  " & vbNewLine _
                                          & " ,HED_DOW.H5_HCUST_NO                                                  " & vbNewLine _
                                          & " ,HED_DOW.H4_HCON_NM_KAN                                               " & vbNewLine _
                                          & " ,HED_DOW.H4_HCON_ADD_KAN                                              " & vbNewLine _
                                          & " ,DTL_DOW.M1_IDEL_ITEM_NO                                              " & vbNewLine _
                                          & " ,DTL_DOW.M1_IMATERIAL_CD                                              " & vbNewLine _
                                          & " ,DTL_DOW.M1_ISTO_LOC                                                  " & vbNewLine _
                                          & " ,DTL_DOW.M1_ILOT_NO                                                   " & vbNewLine _
                                          & " ,DTL_DOW.M1_ISKU_QTY                                                  " & vbNewLine _
                                          & " ,DTL_DOW.M1_ISKU_QTY_UNIT                                             " & vbNewLine _
                                          & " ,DTL_DOW.M1_IQTY_UNIT                                                 " & vbNewLine _
                                          & " ,DTL_DOW.M1_IPO_NO                                                    " & vbNewLine _
                                          & " ,DTL_DOW.M1_IPO_ITEM_NO                                               " & vbNewLine _
                                          & " ,DTL_DOW.M1_IMATERIAL_NM1                                             " & vbNewLine _
                                          & " ,DTL_DOW.M1_IMATERIAL_NM2                                             " & vbNewLine _
                                          & " ,HED_DOW.H1_HORD_STATUS                                               " & vbNewLine
...
#Region "H_SENDINOUTEDI_DOW"

    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDINOUTEDI_DOW）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDINOUTEDI_DOW As String = "INSERT INTO     " & vbNewLine _
...
#Region "H_INOUTKAEDI_HED_DOW"
    ''' <summary>
    ''' ダウケミEDI受信HEDのUPDATE文（H_INOUTKAEDI_HED_DOW）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_HED_DOW SET   " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "H_INOUTKAEDI_DTL_DOW"
    ...
    ''' <summary>
    ''' ダウケミEDI受信DTLのUPDATE文（H_INOUTKAEDI_DTL_DOW）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_DTL_DOW SET       " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC202.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC202.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC202.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC202.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC202", "SelectDataNcgoMdest", cmd)
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>ダウケミEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectDowEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC202.SQL_SELECT_DOW_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC202.SQL_FROM_DOW_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                   '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "SelectDowEdiSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDINOUTEDI_DOW")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDINOUTEDI_DOW").Rows.Count())
        reader.Close()
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC202.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "SelectMatome", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC202.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC202.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC202.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC202.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC202.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC202.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC202.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC202.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC202.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC202.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC202.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC202.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ダウケミは自動更新がないため使用しない)"
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertUnchinData", cmd)
...
#Region "H_SENDINOUTEDI_DOW"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDIダウケミ実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertDowEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDINOUTEDI_DOW")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_H_SENDINOUTEDI_DOW _
                                                                       , ds.Tables("LMH030_H_SENDINOUTEDI_DOW").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertSakuraEdiSendData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ダウケミは自動追加がない為、使用しない)"
    ...
    '        'SQL文のコンパイル
    '        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC202.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC202", "InsertMDestData", cmd)
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC202.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC202", "SelectDataMdestOutkaToroku", cmd)
