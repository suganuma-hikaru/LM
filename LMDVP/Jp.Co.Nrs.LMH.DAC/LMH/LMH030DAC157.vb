...
#Region "H_OUTKAEDI_DTL_SGM"

    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_SGM）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_SGM SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得"
    ...
    Private Function GetOutkaCntAndNoL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_SELECT_OUTKA_NO_L_AND_CNT)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_SGM")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "GetOutkaCntAndNoL", cmd)
...
#Region "EDI出荷(大)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_UPDATE_DEL_OUTKAIEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateDelOutkaEdiL", cmd)
...
#Region "EDI出荷(中)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_UPDATE_DEL_OUTKAIEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateDelOutkaEdiM", cmd)
...
#Region "EDI出荷受信テーブル(明細) 件数取得"
    ...
    Private Function GetOutkaEdiCnt(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_SELECT_COUNT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "GetOutkaEdiCnt", cmd)
...
#Region "EDI出荷受信テーブル(明細) 物理削除"
    ...
    Private Function DeleteOutkaEdi(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_DELETE_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "DeleteOutkaEdi", cmd)
...
#Region "EDI出荷受信テーブル(明細) 新規登録"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_INSERT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "商品マスタ 件数取得"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        ' SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC157.SQL_WHERE1_M_GOODS)

        ' SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC157.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "SelectMstGoods", cmd)
...
#Region "EDI出荷(中)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_INSERT_OUTKAEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertOutkaEdiM", cmd)
...
#Region "EDI出荷(大)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_INSERT_OUTKAEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertOutkaEdiL", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC157.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "SelectDataZkbn", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC157.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC157.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_OUTKA_M _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC157.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "InsertMDestData", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC157.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(String.Concat(setSql, LMH030DAC157.SQL_COM_UPDATE_CONDITION) _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC157.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                'setSql = LMH030DAC157.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC157.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateOutkaEdiMData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC157.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC157.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC157.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC157", "UpdateMDestData", cmd)
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(明細) 新規登録 用"
    ...
    Private Sub SetSqlParamInsertOutkaEdiRcvDtl(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_SAKI_CD", Me.NullConvertString(.Item("OUTKA_SAKI_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_NM", Me.NullConvertString(.Item("DEST_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_AD", Me.NullConvertString(.Item("DEST_AD")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JFC", Me.NullConvertString(.Item("JFC")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PDC", Me.NullConvertString(.Item("PDC")), DBDataType.NVARCHAR))
