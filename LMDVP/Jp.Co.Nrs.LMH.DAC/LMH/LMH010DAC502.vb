...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND As String = "SELECT                                                                  " & vbNewLine _
                                              ...
                                              & " INNER JOIN $LM_TRN$..H_INOUTKAEDI_HED_SMK  HED                       " & vbNewLine _
                                              ...
                                              & " INNER JOIN $LM_TRN$..H_INOUTKAEDI_DTL_SMK  DTL                       " & vbNewLine _
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INOUTKAEDI_DTL_SMK                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    '''' <remarks></remarks>
    '''' 
    'Private Const SQL_UPDATE_RCV_DTL_SMK As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_DTL_SMK SET     " & vbNewLine _
    '                                          & "JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG            " & vbNewLine _
    '                                          & ",JISSEKI_USER      = @JISSEKI_USER                 " & vbNewLine _
    '                                          & ",JISSEKI_DATE      = @JISSEKI_DATE                 " & vbNewLine _
    '                                          & ",JISSEKI_TIME      = @JISSEKI_TIME                 " & vbNewLine _
    ...
    Private Const SQL_UPDATE_RCV_DTL_SMK As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_DTL_SMK SET                       " & vbNewLine _
                                              ...
                                              & "  AND H_INOUTKAEDI_DTL_SMK.NRS_BR_CD = H_INKAEDI_M.NRS_BR_CD         " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.EDI_CTL_NO = H_INKAEDI_M.EDI_CTL_NO       " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.EDI_CTL_NO_CHU = H_INKAEDI_M.EDI_CTL_NO_CHU  " & vbNewLine _
                                              & "  AND H_INKAEDI_M.JISSEKI_FLAG = '0'                                  " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..B_INKA_L                                        " & vbNewLine _
                                              & "  ON  B_INKA_L.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.NRS_BR_CD = B_INKA_L.NRS_BR_CD             " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.INKA_CTL_NO_L = B_INKA_L.INKA_NO_L         " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..B_INKA_M                                        " & vbNewLine _
                                              & "  ON  B_INKA_M.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.NRS_BR_CD = B_INKA_M.NRS_BR_CD             " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.INKA_CTL_NO_L = B_INKA_M.INKA_NO_L         " & vbNewLine _
                                              & "  AND H_INOUTKAEDI_DTL_SMK.INKA_CTL_NO_M = B_INKA_M.INKA_NO_M         " & vbNewLine _
                                              ...
                                              & "AND H_INOUTKAEDI_DTL_SMK.SYS_DEL_FLG         <> '1'                   " & vbNewLine _
                                              & "AND H_INOUTKAEDI_DTL_SMK.INOUT_KB         = '1'     		       " & vbNewLine
...
#Region "H_INKAEDI_L(セミEDI：取込削除時)"
    ...
    Private Const SQL_UPDATE_DEL_INKAIEDI_L As String _
                        = " UPDATE $LM_TRN$..H_INKAEDI_L  SET          " & vbNewLine _
...
#Region "H_INKAEDI_M(セミEDI：取込削除時)"
    ...
    Private Const SQL_UPDATE_DEL_INKAIEDI_M As String _
                        = " UPDATE $LM_TRN$..H_INKAEDI_M  SET          " & vbNewLine _
                        & " DEL_KB              = '1'                   " & vbNewLine _
                        & ",UPD_USER            = @UPD_USER             " & vbNewLine _
                        & ",UPD_DATE            = @UPD_DATE             " & vbNewLine _
                        & ",UPD_TIME            = @UPD_TIME             " & vbNewLine _
...
#Region "H_INKAEDI_L(INSERT：セミEDI)"

    ''' <summary>
    ''' INSERT（H_INKAEDI_L）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_INKAEDI_L As String = "INSERT INTO                           " & vbNewLine _
                                         & "$LM_TRN$..H_INKAEDI_L                         " & vbNewLine _
                                         & "(                                             " & vbNewLine _
                                         & " DEL_KB                                       " & vbNewLine _
                                         & ",NRS_BR_CD                                    " & vbNewLine _
...
#Region "H_INKAEDI_M(INSERT：セミEDI)"

    ''' <summary>
    ''' INSERT（H_INKAEDI_M）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_INKAEDI_M As String = "INSERT INTO                           " & vbNewLine _
                                         & "$LM_TRN$..H_INKAEDI_M                         " & vbNewLine _
                                         & "(                                             " & vbNewLine _
                                         & " DEL_KB                                       " & vbNewLine _
                                         & ",NRS_BR_CD                                    " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC502.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC502.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC502.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "SelectSend", cmd)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC502.SQL_UPD_INKATOROKU_EDI_L

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC502.SQL_UPD_JISSEKITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC502.SQL_UPD_EDITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC502.SQL_UPD_JISSEKIMODOSI_EDI_L

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC502.SQL_UPD_TOUROKUMI_EDI_L

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC502.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC502.SQL_UPD_INKATOROKU_EDI_M
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC502.SQL_UPD_EDITORIKESI_EDI_M

                '実績作成済⇒実績未、実績送信済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                , LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC502.SQL_UPD_JISSEKIMODOSI_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC502.SQL_UPD_JISSEKISAKUSEI_EDI_M

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC502.SQL_UPD_TOUROKUMI_EDI_M

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC502.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC502.SQL_UPD_RCV_HED

            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC502.SQL_UPD_JISSEKITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC502.SQL_UPD_EDITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC502.SQL_UPD_JISSEKIMODOSI_RCV_HED

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC502.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC502.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "UpdateRcvHed", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC502.SQL_UPDATE_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC502.SQL_UPDATE_RCV_DTL_SMK

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI
                setSql = LMH010DAC502.SQL_UPD_JISSEKITORIKESI_RCV_DTL
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC502.SQL_UPD_EDITORIKESI_RCV_DTL

                '実績作成済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI

                setSql = LMH010DAC502.SQL_UPD_JISSEKIZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒実績未、
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC502.SQL_UPD_SOUSINZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC502.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC502.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertInkaS", cmd)
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_SEND, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertSend", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertUnchinData", cmd)
...
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(row.Item("DEL_KB")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(row.Item("NRS_BR_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUT_KB", Me.NullConvertString(row.Item("INOUT_KB")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(row.Item("EDI_CTL_NO")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_CHU", Me.NullConvertString(row.Item("EDI_CTL_NO_CHU")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_EDA", Me.NullConvertString(row.Item("EDI_CTL_NO_EDA")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_L", Me.NullConvertString(row.Item("INKA_NO_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_M", Me.NullConvertString(row.Item("INKA_NO_M")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_S", Me.NullConvertString(row.Item("INKA_NO_S")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO", Me.NullConvertString(row.Item("OUTKA_CTL_NO")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_CHU", Me.NullConvertString(row.Item("OUTKA_CTL_NO_CHU")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_SHO", Me.NullConvertString(row.Item("OUTKA_CTL_NO_SHO")), DBDataType.CHAR))
...
#Region "Update(セミEDI(EDI入荷))"

#Region "H_INKAEDI_L(セミEDI：取消更新)"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI入荷(大)テーブル取消更新SQLの構築・発行</remarks>
    Private Function UpdateDelInkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '取消データがEDI出荷の場合は処理しない
        If Me._Row.Item("INOUT_KB").ToString().Equals("0") = True Then
        ...
        '入荷EDI CONST名
        sSql = LMH010DAC502.SQL_UPDATE_DEL_INKAIEDI_L
        ...
        'パラメータ設定
        Call Me.SetUpdateDelInkaEdiParameter(Me._Row, Me._SqlPrmList)
        Call Me.SetSysdataParameter()
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "UpdateDelInkaEdiL", cmd)
...
#Region "H_INKAEDI_M(セミEDI：取消更新)"

    ''' <summary>
    ''' EDI入荷(中)テーブル更新(セミEDI：取消更新)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ...
    Private Function UpdateDelInkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI入荷SQL
        sSql = LMH010DAC502.SQL_UPDATE_DEL_INKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "UpdateDelInkaEdiM", cmd)
...
#Region "Insert(セミEDI用)"

#Region "H_INKAEDI_L(セミEDI)"

    ''' <summary>
    ''' EDI入荷(大)テーブル新規登録(セミEDI)
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI入荷(大)テーブル新規登録SQLの構築・発行</remarks>
    Private Function InsertInkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'INTableの条件rowの格納
        Me._Row = dtInkaEdiL.Rows(0)
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_INKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))

        'パラメータ設定
        Call Me.SetUpdPrmEdiL(dtInkaEdiL)
        'Call Me.SetDataInsertParameter()
        Call Me.SetDataInsertParameterSemiEdi(Me._Row)
        Call Me.SetJissekiParameterSemiEdi(Me._Row)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertInkaEdiL", cmd)
...
#Region "H_INKAEDI_M(セミEDI)"
    ...
    Private Function InsertInkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOurkaEdiM As DataTable = setDs.Tables("LMH010_INKAEDI_M")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC502.SQL_INSERT_INKAEDI_M _
                                                                       , setDs.Tables("LMH010_INKAEDI_M").Rows(0).Item("NRS_BR_CD").ToString()))
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC502", "InsertInkaEdiM", cmd)
...
#Region "EDI出荷(大・小共通)の削除UPDATE文(セミEDI用)"
    ...
    ''' <summary>
    ''' EDI入荷(大・中共通)の削除UPDATE文(セミEDI用)
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetUpdateDelInkaEdiParameter(ByVal drInkaEdiRcvIn As DataRow, ByVal prmList As ArrayList)
        ...
        prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(drInkaEdiRcvIn.Item("NRS_BR_CD")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(drInkaEdiRcvIn.Item("EDI_CTL_NO")), DBDataType.CHAR))

    End Sub

#End Region

#Region "EDI入荷(大・中共通)の更新共通項目(セミEDI用)"

    ''' <summary>
    ''' 新規登録の共通パラメータ設定
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetDataInsertParameterSemiEdi(ByVal drInkaEdi As DataRow)
...
#Region "EDI入荷(中)の必要項目(セミEDI用)"

    ''' <summary>
    ''' 更新時のパラメータ実績日時(Rcv)
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetJissekiParameterSemiEdi(ByVal row As DataRow)
