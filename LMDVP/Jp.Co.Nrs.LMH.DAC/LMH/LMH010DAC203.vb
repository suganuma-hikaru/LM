...
#Region "SELECT_M_GOODS_MESIAI"

    ''' <summary>
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_M_GOODS_MESIAI As String = " SELECT                                         " & vbNewLine _
                                   ...
                                   & " AND                                                               " & vbNewLine _
                                   & " M_GOODS_DETAILS.SUB_KB = '07'                                     " & vbNewLine _
                                   & " AND                                                               " & vbNewLine _
...
#End Region  '商品明細取得
    ...
    '浮間追加箇所 20120525 start
#Region "SELECT_UkimaBunruiM"

    ''' <summary>
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_UkimaBunruiM As String = " SELECT                                           " & vbNewLine _
                                   & " COUNT(*)                     As resultCount                       " & vbNewLine _
                                   & " FROM                                                              " & vbNewLine _
                                   & " $LM_TRN$..I_UKI_BUNRUI_MST UKI_BUN_M                                " & vbNewLine _
                                   & " WHERE                                                             " & vbNewLine _
                                   & " UKI_BUN_M.CUST_CD_S = @CUST_CD_S                                  " & vbNewLine _
                                   & " AND                                                               " & vbNewLine _
                                   & " UKI_BUN_M.RUI_CD = @FREE_C07                                      " & vbNewLine _
                                   & " AND                                                               " & vbNewLine _
                                   & " UKI_BUN_M.SYS_DEL_FLG = '0'                                       " & vbNewLine
...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND As String = " SELECT                                                         " & vbNewLine _
                                    & " '0'   AS   DEL_KB                                                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.NRS_BR_CD   AS   NRS_BR_CD                          " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.EDI_CTL_NO   AS   EDI_CTL_NO                        " & vbNewLine _
                                    & ",'000'   AS   EDI_CTL_NO_EDA                                            " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INKA_CTL_NO_L   AS   INKA_CTL_NO_L                  " & vbNewLine _
                                    & ",''   AS   FILE_NAME                                                    " & vbNewLine _
                                    & ",''   AS   REC_NO                                                       " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.ID   AS   RCV_ID                                    " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.UKETSUKE_NO   AS   RCV_UKETSUKE_NO                  " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.UKETSUKE_NO_EDA   AS   RCV_UKETSUKE_NO_EDA          " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INPUT_KB   AS   RCV_INPUT_KB                        " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.RCV_EDA_UP_FLG   AS   RCV_EDA_UP_FLG                " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.ID   AS   ID                                        " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.SYSTEM_KB   AS   SYSTEM_KB                          " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.UKETSUKE_NO   AS   UKETSUKE_NO                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.UKETSUKE_NO_EDA   AS   UKETSUKE_NO_EDA              " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.COMPANY_CD   AS   COMPANY_CD                        " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.BASHO_CD   AS   BASHO_CD                            " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INKA_BUMON   AS   INKA_BUMON                        " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INKA_GROUP   AS   INKA_GROUP                        " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INPUT_YMD   AS   INPUT_YMD                          " & vbNewLine _
                                    & ",CASE WHEN B_INKA_L.INKA_DATE IS NULL THEN H_INKAEDI_HED_UKM.INKA_YMD  " & vbNewLine _
                                    & "      ELSE B_INKA_L.INKA_DATE                                           " & vbNewLine _
                                    & " END                          AS INKA_YMD                               " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INKA_YMD   AS   INKA_YMD                            " & vbNewLine _
                                    & ",'1'   AS   INPUT_KB                                                    " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.GOODS_RYAKU   AS   GOODS_RYAKU                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.GRADE_1   AS   GRADE_1                              " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.GRADE_2   AS   GRADE_2                              " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.YORYO   AS   YORYO                                  " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.NISUGATA_CD   AS   NISUGATA_CD                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.YUSHUTSU_KB   AS   YUSHUTSU_KB                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.ZAIKO_KB   AS   ZAIKO_KB                            " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.INKA_BASHO_SP   AS   INKA_BASHO_SP                  " & vbNewLine _
                                    ...
                                    & ",H_INKAEDI_HED_UKM.TTL_KOSU   AS   TTL_KOSU                            " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.TTL_SURYO   AS   TTL_SURYO                          " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.IN_BIKO_ANK   AS   IN_BIKO_ANK                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.IN_BIKO_BIKO   AS   IN_BIKO_BIKO                    " & vbNewLine _
                                    ...
                                    & ",H_INKAEDI_HED_UKM.INKA_SOKUSHORI_KB   AS   INKA_SOKUSHORI_KB          " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.GENKA_BUMON   AS   GENKA_BUMON                      " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.BIN_KB   AS   BIN_KB                                " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.YUSO_COMP_CD   AS   YUSO_COMP_CD                    " & vbNewLine _
                                    & ",''   AS   JUST_OUTKA_KB                                                " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.SHUGENRYO_KB   AS   SHUGENRYO_KB                    " & vbNewLine _
                                    & ",H_INKAEDI_HED_UKM.GEKKAN_KB   AS   GEKKAN_KB                          " & vbNewLine _
                                    & ",''   AS   YOBI                                                         " & vbNewLine _
                                    ...
                                    & " FROM                                                                   " & vbNewLine _
                                    & " $LM_TRN$..H_INKAEDI_HED_UKM     H_INKAEDI_HED_UKM                    " & vbNewLine _
                                    & " LEFT JOIN                                                              " & vbNewLine _
                                    & " $LM_TRN$..H_INKAEDI_DTL_UKM     DTL1                                  " & vbNewLine _
                                    & " ON                                                                     " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.CRT_DATE = DTL1.CRT_DATE                            " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.FILE_NAME = DTL1.FILE_NAME                          " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.REC_NO = DTL1.REC_NO                                " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " DTL1.EDI_CTL_NO_CHU = '001'                                                       " & vbNewLine _
                                    & " LEFT JOIN                                                              " & vbNewLine _
                                    & " $LM_TRN$..H_INKAEDI_DTL_UKM     DTL2                                  " & vbNewLine _
                                    & " ON                                                                     " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.CRT_DATE = DTL2.CRT_DATE                            " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.FILE_NAME = DTL2.FILE_NAME                          " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.REC_NO = DTL2.REC_NO                                " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " DTL2.EDI_CTL_NO_CHU = '002'                                                       " & vbNewLine _
                                    & " LEFT JOIN                                                              " & vbNewLine _
                                    & " $LM_TRN$..H_INKAEDI_DTL_UKM     DTL3                                  " & vbNewLine _
                                    & " ON                                                                     " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.CRT_DATE = DTL3.CRT_DATE                            " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.FILE_NAME = DTL3.FILE_NAME                          " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.REC_NO = DTL3.REC_NO                                " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " DTL3.EDI_CTL_NO_CHU = '003'                                                       " & vbNewLine _
                                    & " LEFT JOIN                                                              " & vbNewLine _
                                    & " $LM_TRN$..H_INKAEDI_DTL_UKM     DTL4                                  " & vbNewLine _
                                    & " ON                                                                     " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.CRT_DATE = DTL4.CRT_DATE                            " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.FILE_NAME = DTL4.FILE_NAME                          " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.REC_NO = DTL4.REC_NO                                " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " DTL4.EDI_CTL_NO_CHU = '004'                                                       " & vbNewLine _
                                    & " LEFT JOIN                                                              " & vbNewLine _
                                    & " $LM_TRN$.H_INKAEDI_DTL_UKM     DTL5                                  " & vbNewLine _
                                    & " ON                                                                     " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.CRT_DATE = DTL5.CRT_DATE                            " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.FILE_NAME = DTL5.FILE_NAME                          " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.REC_NO = DTL5.REC_NO                                " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " DTL5.EDI_CTL_NO_CHU = '005'                                                       " & vbNewLine _
                                    & " LEFT JOIN                                                              " & vbNewLine _
                                    & " $LM_TRN$..B_INKA_L              B_INKA_L                               " & vbNewLine _
                                    & " ON                                                                     " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.NRS_BR_CD  = B_INKA_L.NRS_BR_CD                     " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.INKA_CTL_NO_L = B_INKA_L.INKA_NO_L                  " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " B_INKA_L.NRS_BR_CD = @NRS_BR_CD                                        " & vbNewLine _
                                    & " WHERE                                                                  " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.NRS_BR_CD  = @NRS_BR_CD                             " & vbNewLine _
                                    & " AND                                                                    " & vbNewLine _
                                    & " H_INKAEDI_HED_UKM.EDI_CTL_NO = @EDI_CTL_NO                            " & vbNewLine
...
#Region "SQL_SELECT_ORDER_COUNT"
    Private Const SQL_SELECT_ORDER_COUNT As String = " SELECT                                                  " & vbNewLine _
                                     ...
                                     & " H_INKAEDI_HED_UKM.NRS_BR_CD  = @NRS_BR_CD                            " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.EDI_CTL_NO <> @EDI_CTL_NO                          " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.UKETSUKE_NO = @UKETSUKE_NO                         " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.UKETSUKE_NO_EDA >= @UKETSUKE_NO_EDA                " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.DEL_KB = '0'                                       " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
...
#Region "SQL_SELECT_ORDER_TORIKESHI_COUNT"
    Private Const SQL_SELECT_ORDER_TORIKESHI_COUNT As String = " SELECT                                        " & vbNewLine _
                                     ...
                                     & " H_INKAEDI_HED_UKM.NRS_BR_CD  = @NRS_BR_CD                            " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.EDI_CTL_NO <> 'N00000000'                          " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.UKETSUKE_NO = @UKETSUKE_NO                         " & vbNewLine _
                                     & " AND                                                                   " & vbNewLine _
                                     & " H_INKAEDI_HED_UKM.UKETSUKE_NO_EDA = @UKETSUKE_NO_EDA                 " & vbNewLine _
...
#Region "RCV_HED(入荷登録)"
    ...
    Private Const SQL_UPD_RCV_HED As String = "UPDATE                                               " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_HED_UKM                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L       	        " & vbNewLine _
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_UKM                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#Region "SEND(実績送信済⇒送信未)"
    ...
    Private Const SQL_UPD_JISSEKIMODOSI_SEND As String = "UPDATE                                    " & vbNewLine _
                                              & "$LM_TRN$..H_SENDINEDI_UKM                         " & vbNewLine _
                                              & "SET                                                " & vbNewLine _
                                              & " JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG            " & vbNewLine _
                                              & ",SEND_USER         = @SEND_USER                    " & vbNewLine _
                                              & ",SEND_DATE         = @SEND_DATE                    " & vbNewLine _
...
#Region "SEND"
    Private Const SQL_INSERT_SEND As String = "INSERT INTO $LM_TRN$..H_SENDINEDI_UKM " & vbNewLine _
                                              & "(                              " & vbNewLine _
                                              & "DEL_KB                         " & vbNewLine _
                                              & ",NRS_BR_CD                     " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "SelectSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINEDI_UKM")
        reader.Close()
...
#Region "実績作成オーダー番号チェック"
    ...
    Private Function SelectUketsukeNo(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_UKETSUKENO)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "SelectUketsukeNo", cmd)
    ...
    Private Function OrderChk(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_ORDER_COUNT)

        Dim dtIn As DataTable = ds.Tables("LMH010INOUT")

        Dim dt As DataTable = ds.Tables("H_SENDINEDI_UKM")
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "OrderChk", cmd)
    ...
    Private Function OrderChkTorikeshi(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_ORDER_TORIKESHI_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "OrderChkTorikeshi", cmd)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC203.SQL_UPD_INKATOROKU_EDI_L

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC203.SQL_UPD_JISSEKITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC203.SQL_UPD_EDITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC203.SQL_UPD_JISSEKIMODOSI_EDI_L

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC203.SQL_UPD_TOUROKUMI_EDI_L

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC203.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_L
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC203.SQL_UPD_INKATOROKU_EDI_M
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC203.SQL_UPD_EDITORIKESI_EDI_M

                '実績作成済⇒実績未、実績送信済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                , LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC203.SQL_UPD_JISSEKIMODOSI_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC203.SQL_UPD_JISSEKISAKUSEI_EDI_M

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC203.SQL_UPD_TOUROKUMI_EDI_M

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC203.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC203", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC203.SQL_UPD_RCV_HED

            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC203.SQL_UPD_JISSEKITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC203.SQL_UPD_EDITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC203.SQL_UPD_JISSEKIMODOSI_RCV_HED

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC203.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC203.SQL_UPD_TOUROKUMI_RCV_HED
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC203.SQL_UPDATE_RCV_DTL

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI
                setSql = LMH010DAC203.SQL_UPD_JISSEKITORIKESI_RCV_DTL
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC203.SQL_UPD_EDITORIKESI_RCV_DTL

                '実績作成済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI

                setSql = LMH010DAC203.SQL_UPD_JISSEKIZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒実績未、
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC203.SQL_UPD_SOUSINZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC203.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC203.SQL_UPD_JISSEKISAKUSEI_RCV_DTL

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC203.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC203", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_INKA_M, brCd))
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_INKA_S, brCd))
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINEDI_UKM")
        'INTableの条件rowの格納
        Dim dtRow As DataRow = inTbl.Rows(0)
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_SEND, dtRow.Item("NRS_BR_CD").ToString()))
        Dim eventShubetsu As Integer = Convert.ToInt32(ds.Tables("LMH010_JUDGE").Rows(0)("EVENT_SHUBETSU"))
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC203", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC203", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC203.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC203", "InsertUnchinData", cmd)
...
#Region "商品明細"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataGoodsMeisai(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_M_GOODS_MESIAI)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "SelectDataGoodsMeisai", cmd)
...
#Region "浮間請求分類マスタ"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectUkimaBunruiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC203.SQL_SELECT_UkimaBunruiM)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetUkimabunruiParameter(dtMgoods, dtEdiM)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC203", "SelectUkimaBunruiM", cmd)
        ...
        '処理件数の設定
        reader.Read()
        MyBase.SetResultCount(Convert.ToInt32(reader("resultCount")))
        reader.Close()
...
#Region "運送(大)パラメータ設定"
    ...
    Private Sub SetUnsoLComParameter(ByVal conditionRow As DataRow)
        ...
        With conditionRow
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_CD", Me.NullConvertString(.Item("SHIP_CD")), DBDataType.NVARCHAR))
...
#End Region
    ...
    '浮間追加箇所 20120525 terakawa start
#Region "浮間請求分類マスタのパラメータ設定"
    Private Sub SetUkimabunruiParameter(ByVal goodsM As DataTable, ByVal inkaEdiM As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_S", Me.NullConvertString(goodsM.Rows(0).Item("CUST_CD_S")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FREE_C07", Me.NullConvertString(inkaEdiM.Rows(0).Item("FREE_C07")), DBDataType.NVARCHAR))

    End Sub

#End Region
    '浮間追加箇所 20120525 terakawa end
