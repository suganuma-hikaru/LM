...
'  システム名       :  LM
'  サブシステム名   :  LMH       : EDI
'  プログラムID     :  LMH563    : EDI入出荷受信帳票(日産物流用)
'  作  成  者       :  渡部剛
' ==========================================================================
Imports System.Text
...
#Region "検索処理 SQL"
    ...
    ''' </remarks>
    Private Const SQL_MPrt_FROM As String = "  FROM $LM_TRN$..H_INKAEDI_HED_NSN  HED                             " & vbNewLine _
                                          ...
                                          & "      LEFT OUTER JOIN $LM_TRN$..H_INKAEDI_DTL_NSN  DTL              " & vbNewLine _
                                          ...
                                          & "                  AND M_GOODS.GOODS_CD_CUST   =                     " & vbNewLine _
                                          & "           --連結客先向け商品コード作成開始--                       " & vbNewLine _
                                          & "           CASE WHEN HED.HINSHU_CD + HED.HINMEI_CD LIKE '17%' THEN  " & vbNewLine _
                                          & "                     HED.HINSHU_CD + HED.HINMEI_CD + HED.GRADE      " & vbNewLine _
                                          & "                     ELSE HED.HINSHU_CD + HED.HINMEI_CD END         " & vbNewLine _
                                          & "           --連結客先向け商品コード作成終了--                       " & vbNewLine _
                                          ...
                                          & "                  AND M_CUSTRPT1.PTN_ID      = 'AN'                 " & vbNewLine _
                                          ...
                                          & "                  AND M_CUSTRPT2.PTN_ID      = 'AN'                 " & vbNewLine _
    ...
    Private Const SQL_SELECT As String = " SELECT                                                    " & vbNewLine _
                                       ...
                                       & "      , DTL.KOSU_SURYO             AS KOSU_SURYO           " & vbNewLine _
    ...
    ''' 日産物流EDI受信データHEAD - 日産物流EDI受信データDETAIL,商品Ｍ,区分Ｍ
    ''' </remarks>
    Private Const SQL_FROM As String = "  FROM $LM_TRN$..H_INKAEDI_HED_NSN  HED                             " & vbNewLine _
                                     & " --【Notes】№1007/1008対応 --- START ---                           " & vbNewLine _
                                     & "      -- EDI印刷種別テーブル                                        " & vbNewLine _
                                     & "      LEFT JOIN (                                                   " & vbNewLine _
                                     & "                  SELECT ISNULL(COUNT(*),0)  AS PRT_COUNT           " & vbNewLine _
                                     ...
                                     & "                 FROM $LM_TRN$..H_INKAEDI_HED_NSN AS HED            " & vbNewLine _
                                     & "      LEFT OUTER JOIN $LM_TRN$..H_INKAEDI_DTL_NSN AS DTL ON         " & vbNewLine _
                                     & "                      HED.CRT_DATE = DTL.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = DTL.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = DTL.REC_NO                       " & vbNewLine _
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '01'                                " & vbNewLine _
                                     & "                     ) AS G01                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G01.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G01.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G01.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                     ) AS G02                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G02.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G02.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G02.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                     ) AS G03                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G03.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G03.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G03.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '04'                                " & vbNewLine _
                                     & "                     ) AS G04                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G04.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G04.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G04.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '05'                                " & vbNewLine _
                                     & "                     ) AS G05                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G05.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G05.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G05.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '06'                                " & vbNewLine _
                                     & "                     ) AS G06                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G06.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G06.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G06.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '07'                                " & vbNewLine _
                                     & "                     ) AS G07                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G07.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G07.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G07.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '08'                                " & vbNewLine _
                                     & "                     ) AS G08                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G08.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G08.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G08.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '09'                                " & vbNewLine _
                                     & "                     ) AS G09                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G09.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G09.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G09.REC_NO                       " & vbNewLine _
                                     ...
                                     & "                WHERE HED.CRT_DATE >= @CRT_DATE_FROM                " & vbNewLine _
                                     & "                  AND HED.CRT_DATE <= @CRT_DATE_TO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '10'                                " & vbNewLine _
                                     & "                     ) AS G10                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G10.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G10.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = G10.REC_NO                       " & vbNewLine _
                                     & "      -- 荷主マスタ                                                 " & vbNewLine _
    ...
    ''' 日産物流EDI受信データHEAD - 日産物流EDI受信データDETAIL,商品Ｍ,区分Ｍ
    ''' </remarks>
    Private Const SQL_FROM_OUT As String = "  FROM $LM_TRN$..H_INKAEDI_HED_NSN  HED                         " & vbNewLine _
                                     & " --【Notes】№1007/1008対応 --- START ---                           " & vbNewLine _
                                     & "      -- EDI印刷種別テーブル                                        " & vbNewLine _
                                     & "      LEFT JOIN (                                                   " & vbNewLine _
                                     & "                  SELECT ISNULL(COUNT(*),0)  AS PRT_COUNT           " & vbNewLine _
                                     ...
                                     & "                  AND HED.FILE_NAME = DTL.FILE_NAME                 " & vbNewLine _
                                     & "                  AND HED.REC_NO = DTL.REC_NO                       " & vbNewLine _
                                     & "                WHERE HED.EDI_CTL_NO = @EDI_CTL_NO                  " & vbNewLine _
                                     & "                  AND DTL.GYO = '01'                                " & vbNewLine _
                                     & "                     ) AS G01                                       " & vbNewLine _
                                     & "                   ON HED.CRT_DATE = G01.CRT_DATE                   " & vbNewLine _
                                     & "                  AND HED.FILE_NAME = G01.FILE_NAME                 " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrintPattern(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH563IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMH563DAC.SQL_MPrt_SELECT)    'SQL構築(帳票種別用SELECT句)
        Me._StrSql.Append(LMH563DAC.SQL_MPrt_FROM)      'SQL構築(帳票種別用FROM句)
        '(2012.03.19) WHERE条件を帳票取得時と同じにする -- START --
        'Me._StrSql.Append(LMH563DAC.SQL_MPrt_WHERE)     'SQL構築(帳票種別用WHERE句)
        ...
        MyBase.Logger.WriteSQLLog("LMH563DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH563DAC.SQL_SELECT)      'SQL構築(印刷データ抽出用 SELECT句)

        '追加 2012/11/07(千葉EDI 未出力・出力済みのデータ判別)
        If Me._Row.Item("PRTFLG").ToString = "1" Then 'Notes 1061 2012/05/15 開始

            Me._StrSql.Append(LMH563DAC.SQL_FROM_OUT)        'SQL構築(印刷データ抽出用 FROM句)

            'Call Me.SetConditionPrintPatternMSQL()          '条件設定
        Else
            Me._StrSql.Append(LMH563DAC.SQL_FROM)        'SQL構築(印刷データ抽出用 FROM句)
            'SQL構築(印刷データ抽出条件設定) '未出力・両方(出力済、未出力併せて)
        End If                                       'Notes 1061 2012/05/15 終了
        '追加終了 2012/11/07(千葉EDI 未出力・出力済みのデータ判別)
        ...
        Me._StrSql.Append(LMH563DAC.SQL_ORDER_BY)    'SQL構築(印刷データ抽出用 ORDER BY句)
        'Call Me.SetConditionPrintPatternMSQL()          '条件設定 Notes1061
        ...
        MyBase.Logger.WriteSQLLog("LMH563DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH563OUT")
    ...
    Private Sub SetConditionMasterSQL()
        ...
        With Me._Row
            ...
            If String.IsNullOrEmpty(whereStr) = False Then
                Me._StrSql.Append(" HED.NRS_BR_CD = @NRS_BR_CD")   '013118 '10'固定修正
                'Me._StrSql.Append(" HED.NRS_BR_CD = '10' ")       '013118 '10'固定修正
            ...
            whereStr = .Item("CUST_CD_L").ToString()
            If String.IsNullOrEmpty(whereStr) = False Then
                Me._StrSql.Append(" AND '00145' = @CUST_CD_L ")
            ...
            whereStr = .Item("CUST_CD_M").ToString()
            If String.IsNullOrEmpty(whereStr) = False Then
                Me._StrSql.Append(" AND '00' = @CUST_CD_M ")
                Me._StrSql.Append(vbNewLine) 'Notes 1061
            ...
            whereStr = .Item("INOUT_KB").ToString()
            If String.IsNullOrEmpty(whereStr) = False Then
                Me._StrSql.Append(" AND '1' = @INOUT_KB ")
            ...
            Me._StrSql.Append(vbNewLine)
            '(2012.12.19)要望番号1706 コメント化 -- START --
            ''削除フラグ(千葉EDI用)
            'Me._StrSql.Append(" AND HED.DEL_KB = '0' ")
            'Me._StrSql.Append(vbNewLine)
            '(2012.12.19)要望番号1706 コメント化 --  END  --
    ...
    Private Sub SetConditionMasterSQL_OUT()
        ...
        With Me._Row
            ...
            whereStr = .Item("NRS_BR_CD").ToString()
            If String.IsNullOrEmpty(whereStr) = False Then
                'Me._StrSql.Append(" HED.NRS_BR_CD = '10' ") 'UPD-- 013118 '10'固定修正
