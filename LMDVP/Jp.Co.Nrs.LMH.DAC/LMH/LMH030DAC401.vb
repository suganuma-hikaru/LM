...
#Region "H_SENDOUTEDI_SFJ SELECT句"
    ...
    Private Const SQL_SELECT_SAKURA_SEND_DATA As String = " SELECT                                                                                 " & vbNewLine _
                                                        ...
                                                        & ",ISNULL(OS.ALCTD_NB,0)                                              AS JISSEKI_QT       " & vbNewLine _
                                                        & ",EM.FREE_C09                                                        AS JISSEKI_NISUGATA " & vbNewLine _
                                                        & ",1                                                                  AS JISSEKI_IRISU    " & vbNewLine _
                                                        & ",ISNULL(OS.ALCTD_NB,0)                                              AS JISSEKI_TOTAL_NB " & vbNewLine _
...
#Region "出荷登録処理 サクラ出荷梱包個数自動計算用SQL"

    '2019/01/25 ADD START 要望管理004402
    ''' <summary>
    ''' 荷主明細マスタ取得
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_M_CUST_DETAILS As String = _
          "SELECT M_CUST_DETAILS.SET_NAIYO              " & vbNewLine _
        & "  FROM $LM_MST$..M_CUST_DETAILS              " & vbNewLine _
        & " WHERE M_CUST_DETAILS.NRS_BR_CD = @NRS_BR_CD " & vbNewLine _
        & "   AND M_CUST_DETAILS.CUST_CD = @CUST_CD_L   " & vbNewLine _
        & "   AND M_CUST_DETAILS.SUB_KB = @SUB_KB       " & vbNewLine _
        & "   AND M_CUST_DETAILS.SYS_DEL_FLG = '0'      " & vbNewLine
    '2019/01/25 ADD END 要望管理004402
    ...
    ''' <summary>
    ''' C_OUTKA_LのUPDATE文(サクラ出荷梱包個数自動計算用)
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "検索処理"
    ...
    Private Function SelectData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_COUNT)     'SQL構築(カウント用Select句)
        '2011.09.21 修正START
        Me._StrSql.Append(LMH030DAC401.SQL_COUNT_FROM)             'SQL構築(データ抽出用From句)
        'Me._StrSql.Append(LMH030DAC401.SQL_FROM)             'SQL構築(データ抽出用From句)
        '2011.09.21 修正END
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectData", cmd)
    ...
    Private Function SelectListData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC401.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                      '条件設定
        '2011.09.26 追加START
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectSakuraListData", cmd)
...
#Region "サクラ出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.L_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC401.L_DEF_SQL_FROM)        'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC401.M_DEF_SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                           '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectEdiM", cmd)
...
#Region "サクラまとめチェック"
    ...
    Private Function SelectMatomeCheck(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_COUNT)                    'SQL構築(カウント用Select句)
        Me._StrSql.Append(LMH030DAC401.SQL_MATOME_TARGET_CHECK)             'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                                    '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectMatomeCheck", cmd)
...
#Region "サクラまとめデータ(出荷)取得処理"
    ...
    Private Function SelectMatomeTarget(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SAKURA_MATOME_SELECT)      'SQL構築(データ抽出用Select句)
        ...
        Me._StrSql.Append(LMH030DAC401.SQL_SAKURA_MATOME_FROM)        'SQL構築(データ抽出用From句)
        ...
        Me._StrSql.Append(LMH030DAC401.SQL_SAKURA_MATOME_GROUPBY)     'SQL構築(データ抽出用Group By句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectMatomeTarget", cmd)
...
#Region "サクラまとめデータ(運送M)取得処理"
    ...
    Private Function SelectUnsoMatomeTarget(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_MATOMEMOTO_DATA_UNSO_M)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectUnsoMatomeTarget", cmd)
...
#Region "同一まとめレコード取得処理(出荷取消⇒未登録)"
    ...
    Private Function SelectMatomeTorikesi(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_DATA_MATOMETORIKESI)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectMatomeTorikesi", cmd)
...
#Region "データ取得処理"
    ...
    Private Function SelectSakuraEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_SAKURA_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC401.SQL_FROM_SAKURA_SEND_DATA)             'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                   '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectSakuraEdiSend", cmd)
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectMatome", cmd)
...
#Region "届先マスタ(サクラ用)"
    ...
    Private Function SelectDataSakuraMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectDataMdest", cmd)
...
#Region "運送会社存在チェック＋名称取得処理"
    ...
    Private Function SelectUnsoNM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_UNSONM_GET)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectUnsoNM", cmd)
...
#Region "一括変更時のEDI出荷(大)"
    ...
    Private Function UpdateHenko(ByVal ds As DataSet) As DataSet
        ...
        '共通項目
        Me._StrSql.Append(LMH030DAC401.SQL_UPDATE)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateHenko", cmd)
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC401.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateMatomesakiEdiLData", cmd)
...
#Region "サクラまとめ時のまとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC401.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateMatomesakiUnsoLData", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI _
                ...
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_L

                '実行(実績送信済⇒送信待)SQL CONST名
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI

                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_SOUSINMACHI_EDI_L

                '実行(出荷取消⇒未登録)SQL CONST名
            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPDATE_TOUROKUMI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC401.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKISAKUSEI_EDI_M

                'EDI取消、EDI取消⇒未登録SQL CONST名
            Case LMH030DAC.EventShubetsu.EDITORIKESI _
                , LMH030DAC.EventShubetsu.TORIKESI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPD_EDITORIKESI_EDI_M

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_M
            ...
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI
                ...
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_SOUSINMACHI_EDI_M

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPDATE_TOUROKUMI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED_SFJ"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC401.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED

                '実績取消SQL CONST名
            Case LMH030DAC.EventShubetsu.TORIKESIJISSEKI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKICANSEL_EDI_RCV_HED

                'EDI取消、EDI取消⇒未登録
            Case LMH030DAC.EventShubetsu.EDITORIKESI _
                , LMH030DAC.EventShubetsu.TORIKESI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPDATE_EDITORIKESI_RCV_HED

                '実行(実績作成済⇒実績未,実績送信済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI _
                , LMH030DAC.EventShubetsu.SOUSINZUMI_JISSEKIMI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_RCV_HED

                '実行(実績送信済⇒送信待)
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI

                setSql = LMH030DAC401.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL_SFJ"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC401.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL

                '実績取消SQL CONST名
            Case LMH030DAC.EventShubetsu.TORIKESIJISSEKI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKICANSEL_EDI_RCV_DTL

                'EDI取消、EDI取消⇒未登録、報告用EDI取消
            Case LMH030DAC.EventShubetsu.EDITORIKESI _
                , LMH030DAC.EventShubetsu.TORIKESI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPDATE_EDITORIKESI_RCV_DTL

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_RCV_DTL

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_JISSEKIMI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKISOUSINZUMI_JISSEKIMI_EDI_RCV_DTL

                '実行(実績送信済⇒送信待)
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI

                setSql = LMH030DAC401.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC401.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateEdiRcvDtlData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC401.SQL_UPDATE_C_OUTKASAVE_L
                ...
                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC401.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateOutkaLData", cmd)
...
#Region "H_SENDOUTEDI_SFJ"
    ...
    Private Function UpdateEdiSendLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '実行(実績送信済⇒送信待)SQL CONST名
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI
                setSql = LMH030DAC401.SQL_UPD_JISSEKIMODOSI_SEND
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateEdiSendLData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_SFJ"
    ...
    Private Function InsertSakuraEdiSendData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_H_SENDOUTEDI_SFJ _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertSakuraEdiSendData", cmd)
...
#Region "H_SENDOUTEDI_SFJ"
    ...
    Private Function DeleteEdiSendLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC401.SQL_DELETE_JISSEKIZUMI_JISSEKIMI_EDI_SEND
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "DeleteEdiSendData", cmd)
...
#Region "出荷登録処理 サクラ出荷梱包個数自動計算"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectCustDtlAutoCalcFlg(ByVal ds As DataSet) As DataSet

        Dim dtInkaL As DataTable = ds.Tables("LMH030INOUT")

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(SQL_SELECT_M_CUST_DETAILS)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetCustDtlParameter(dtInkaL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectCustDtlAutoCalcFlg", cmd)
        ...
        map.Add("AUTO_CALC_FLG", "SET_NAIYO")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_CALC_OUTKA_PKG_NB_IN")
    ...
    Private Function SelectCalcMstErrCntSakura(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_CALC_MST_ERR_CNT_SAKURA)   'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectCalcMstErrCntSakura", cmd)
    ...
    Private Function SelectCalcOutkaPkgNbSakura(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC401.SQL_SELECT_CALC_OUTKAPKGNB_SAKURA)   'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "SelectCalcOutkaPkgNbSakura", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_CALC_OUTKA_PKG_NB_SAKURA")
    ...
    Private Function UpdateOutkaLOutkaPkgNb(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Dim setSql As String = LMH030DAC401.SQL_UPDATE_OUTKAL_OUTKAPKGNB
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateOutkaLOutkaPkgNb", cmd)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetCustDtlParameter(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", dt.Rows(0).Item("CUST_CD_L"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SUB_KB", "9N", DBDataType.CHAR))
...
#Region "届先マスタ自動追加/更新"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC401.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "InsertMDestData", cmd)
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC401", "UpdateMDestData", cmd)
