...
'  システム名       :  LM
'  サブシステム名   :  LMH             : EDI
'  プログラムID     :  LMH010DAC404    : EDI入荷検索
'  EDI荷主ID　　　　:  108　　　       : フィルメニッヒ(横浜):ローム(209)から複写
'  作  成  者       :  inoue
' ==========================================================================
Imports System.Text
...
#Region "Const"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Enum FirmeArrivalColumns
...
#Region "H_INKAEDI_DTL_FIR(INSERT)"

    ''' <summary>
    ''' INSERT（H_INKAEDI_DTL_FIR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_INKAEDI_DTL As String _
                                        ...
                                        & " ,AWB_BL_NO	                " & vbNewLine _
                                        & " ,SHIPPING_INSTR	            " & vbNewLine _
                                        & " ,MANUFACTURER	            " & vbNewLine _
                                        & " ,MATERIAL	                " & vbNewLine _
                                        & " ,MATERIAL_DESCRIPTION	    " & vbNewLine _
                                        & " ,OBD_SHIPMENT_NO	        " & vbNewLine _
                                        & " ,DELIVERY	                " & vbNewLine _
                                        & " ,QUANTITY_IN_OPUN	        " & vbNewLine _
                                        & " ,OPEN_QUANTITY	            " & vbNewLine _
                                        & " ,ORDER_UNIT	                " & vbNewLine _
                                        & " ,PURCHASING_DOCUMENT	    " & vbNewLine _
                                        & " ,ITEM                       " & vbNewLine _
                                        & " ,PO_PLUS_LINE	            " & vbNewLine _
                                        & " ,BATCH	                    " & vbNewLine _
                                        & " ,P_DATE	                    " & vbNewLine _
                                        & " ,VENDOR_BATCH	            " & vbNewLine _
                                        & " ,SHIP_TO	                " & vbNewLine _
                                        & " ,SO_NO                      " & vbNewLine _
                                        & " ,CUSTOMER	                " & vbNewLine _
                                        & " ,BIN	                    " & vbNewLine _
                                        & " ,GR_NO	                    " & vbNewLine _
                                        & " ,REMARK                     " & vbNewLine _
...
#Region "H_INKAEDI_L(セミEDI)"
    ...
    Private Function InsertInkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_INKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertInkaEdiL", cmd)
...
#Region "H_INKAEDI_M(セミEDI)"
    ...
    Private Function InsertInkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_INKAEDI_M _
...
#Region "H_INKAEDI_DTL_FIR(セミEDI)"
    ...
    Private Function InsertInkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtInkaEdiRcvDtl As DataTable = setDs.Tables("LMH010_INKAEDI_DTL_FIR")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_INKAEDI_DTL, setDs.Tables("LMH010_INKAEDI_DTL_FIR").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertInkaEdiRcvDtl", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH010_INKAEDI_DTL_FIR")
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC404.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH010DAC404.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH010DAC404.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "SelectDataMgoods", cmd)
...
#Region "商品マスタ(セミEDI：荷主商品コードより抽出)"
    ...
    Private Function CheckGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC404.SQL_SELECT_M_GOODS_CNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "CheckGoods", cmd)
...
#Region "まとめ先取得"
    Private Const SQL_SELECT_MATOME_TARGET As String = "SELECT                                       " & vbNewLine _
                                   ...
                                   & "   WHERE                                                       " & vbNewLine _
                                   & "    INKA_L.INKA_STATE_KB < '40'                                " & vbNewLine _
                                   & "    AND                                                        " & vbNewLine _
                                   ...
                                   & "    AND                                                        " & vbNewLine _
                                   & "    INKA_L.INKA_NO_L IN (                                      " & vbNewLine _
                                   & "      {0}                                                      " & vbNewLine _
                                   & "    )                                                          " & vbNewLine _
                                   & "   GROUP BY                                                    " & vbNewLine _
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_FIR                       " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC404.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC404.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "SelectEdiM", cmd)
...
#Else
            ...
            prmList.Add(MyBase.GetSqlParameter("@AWB_BL_NO", Me.NullConvertString(.Item("AWB_BL_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHIPPING_INSTR", Me.NullConvertString(.Item("SHIPPING_INSTR")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MANUFACTURER", Me.NullConvertString(.Item("MANUFACTURER")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MATERIAL", Me.NullConvertString(.Item("MATERIAL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MATERIAL_DESCRIPTION", Me.NullConvertString(.Item("MATERIAL_DESCRIPTION")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OBD_SHIPMENT_NO", Me.NullConvertString(.Item("OBD_SHIPMENT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY", Me.NullConvertString(.Item("DELIVERY")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@QUANTITY_IN_OPUN", Me.NullConvertString(.Item("QUANTITY_IN_OPUN")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OPEN_QUANTITY", Me.NullConvertString(.Item("DELIVERY")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@ORDER_UNIT", Me.NullConvertString(.Item("ORDER_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PURCHASING_DOCUMENT", Me.NullConvertString(.Item("PURCHASING_DOCUMENT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ITEM", Me.NullConvertString(.Item("ITEM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PO_PLUS_LINE", Me.NullConvertString(.Item("PO_PLUS_LINE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BATCH", Me.NullConvertString(.Item("BATCH")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@P_DATE", Me.NullConvertString(.Item("P_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@VENDOR_BATCH", Me.NullConvertString(.Item("VENDOR_BATCH")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHIP_TO", Me.NullConvertString(.Item("SHIP_TO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SO_NO", Me.NullConvertString(.Item("SO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUSTOMER", Me.NullConvertString(.Item("CUSTOMER")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BIN", Me.NullConvertString(.Item("BIN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GR_NO", Me.NullConvertString(.Item("GR_NO")), DBDataType.NVARCHAR))
...
#If False Then ' フィルメニッヒセミEDI対応　20161024 changed inoue
        'SQL作成
        Select Case matomeFlg
            Case "2"
                Me._StrSql.Append(LMH010DAC404.SQL_SELECT_MATOME_TARGET)

        End Select
#Else
        Dim matomeTargets As String = Me.GetMatomeTargetInkaNoL(ds)

        'SQL作成
        Me._StrSql.Append(String.Format(LMH010DAC404.SQL_SELECT_MATOME_TARGET, matomeTargets))
#End If
    ...
    Private Function GetMatomeFlg(ByVal ds As DataSet) As String
        ...
        Me._StrSql.Append(LMH010DAC404.SQL_SELECT_MATOMEFLG)
...
#If True Then ' フィルメニッヒセミEDI対応　20161024 added inoue
    ...
    ''' <param name="ds"></param>
    ''' <remarks></remarks>
    Private Function GetMatomeTargetInkaNoL(ByVal ds As DataSet) As String

        ' 検索条件設定
        Dim inItems As New StringBuilder()
        Dim table As DataTable = ds.Tables("LMH010_IKKATUMATOME_CHK")
        If table.Rows.Count > 0 Then

            For Each row As DataRow In table.Rows

                If (inItems.Length > 0) Then
                    inItems.Append(", ")
                End If

                inItems.AppendLine(String.Format("'{0}'", row("INKA_NO_L")))
            Next
        Else
            inItems.Append("''")
        End If
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC404.SQL_UPD_INKATOROKU_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC404.SQL_UPD_INKATOROKU_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "UpdateEdiM", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC404.SQL_UPDATE_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertInkaS", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC404.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC404", "InsertUnchinData", cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH010DAC404.SQL_UPDATE_MATOMESAKI_UNSO_L
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH010DAC404.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC404", "UpdateMatomesakiEdiLData", cmd)
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectChkGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", dtRcvDtl.Rows(0).Item(GetColumnName(FirmeArrivalColumns.MATERIAL)).ToString(), DBDataType.NVARCHAR))
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetColumnName(column As FirmeArrivalColumns) As String
