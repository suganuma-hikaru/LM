...
#If True Then ' BP運送会社自動設定対応 20161117 added by inoue
    ...
    Class TableNames
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Const IN_OUTAKA_SAVE_BP As String = "LMH030IN_OUTKA_SAVE_BP"

        ''' <summary>
        ''' 届先,運送重量別運送会社一覧テーブル
        ''' </summary>
        ''' <remarks></remarks>
        Public Const OUT_UNSO_BY_WGT_AND_DEST As String = "LMH030OUT_UNSO_BY_WGT_AND_DEST"

        ''' <summary>
        ''' チャーター便管理テーブル
        ''' </summary>
        ''' <remarks></remarks>
        Public Const OUT_CHARTER_MANAGEMENT As String = "LMH030OUT_CHARTER_MANAGEMENT"

        ''' <summary>
        ''' Amazon届先,運送会社一覧テーブル ADD 2018/06/14
        ''' </summary>
        ''' <remarks></remarks>
        Public Const OUT_UNSO_AMAZON_BY_DEST As String = "LMH030OUT_UNSO_AMAZON_BY_DEST"
...
#Region "SQL_SELECT_Z_KBN_TGT_JIS"

    Private Const SQL_SELECT_Z_KBN_TGT_JIS As String = "SELECT                            " & vbNewLine _
                                  & " KBN_NM1                               AS TGT_JIS_CD " & vbNewLine _
                                  & " FROM                                                " & vbNewLine _
                                  & " $LM_MST$..Z_KBN                       Z_KBN         " & vbNewLine _
                                  & " WHERE                                               " & vbNewLine _
                                  & " Z_KBN.KBN_GROUP_CD   = 'J014'                       " & vbNewLine

#End Region

#Region "SQL_SELECT_M_ZIP_GET_JIS"

    Private Const SQL_SELECT_M_ZIP_GET_JIS As String = "SELECT                            " & vbNewLine _
                                  & "  ZIP_NO                               AS ZIP_NO     " & vbNewLine _
                                  & " ,JIS_CD                               AS JIS_CD     " & vbNewLine _
                                  & " FROM                                                " & vbNewLine _
                                  & " $LM_MST$..M_ZIP                       M_ZIP         " & vbNewLine _
                                  & " WHERE                                               " & vbNewLine _
                                  & " M_ZIP.ZIP_NO   = @ZIP_NO                            " & vbNewLine
...
#Region "H_OUTKAEDI_DTL_BP"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BP）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BP SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_BP"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_BP）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_BP SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#Region "M_DEST UPDATE(届先項目差異有りの場合)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_BP As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "RCV_HED(実績作成)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPD_JISSEKI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_BP SET   " & vbNewLine _
                                      & " OUTKA_CTL_NO           = @OUTKA_CTL_NO       	        " & vbNewLine _
                                      & ",OUTKA_USER             = @UPD_USER                    " & vbNewLine _
                                      & ",OUTKA_DATE             = @UPD_DATE                    " & vbNewLine _
                                      & ",OUTKA_TIME             = @UPD_TIME                    " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPD_JISSEKI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BP SET                           " & vbNewLine _
                                              & " OUTKA_CTL_NO           = @OUTKA_CTL_NO       	                        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU       = @OUTKA_CTL_NO_CHU       	                    " & vbNewLine _
                                              ...
                                              & ",SYS_UPD_PGID           = @SYS_UPD_PGID                                " & vbNewLine _
                                              & ",SYS_UPD_USER           = @SYS_UPD_USER                                " & vbNewLine _
                                              & "WHERE   H_OUTKAEDI_DTL_BP.NRS_BR_CD       = @NRS_BR_CD                 " & vbNewLine _
                                              & "AND H_OUTKAEDI_DTL_BP.EDI_CTL_NO          = @EDI_CTL_NO                " & vbNewLine _
                                              & "AND H_OUTKAEDI_DTL_BP.JISSEKI_SHORI_FLG   = '1'      			        " & vbNewLine _
                                              & "AND H_OUTKAEDI_DTL_BP.SYS_DEL_FLG         = '0'                        " & vbNewLine
    ...
    '                                      & ",SYS_UPD_PGID           = @SYS_UPD_PGID                                    " & vbNewLine _
    '                                      & ",SYS_UPD_USER           = @SYS_UPD_USER                                    " & vbNewLine _
    '                                      & "--FROM $LM_TRN$..H_OUTKAEDI_DTL_BP                                       " & vbNewLine _
    '                                      & "--INNER JOIN $LM_TRN$..H_OUTKAEDI_M                                         " & vbNewLine _
    '                                      & "--ON  H_OUTKAEDI_M.SYS_DEL_FLG = '0'                                      " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.NRS_BR_CD = H_OUTKAEDI_M.NRS_BR_CD              " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.EDI_CTL_NO = H_OUTKAEDI_M.EDI_CTL_NO            " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.EDI_CTL_NO_CHU = H_OUTKAEDI_M.EDI_CTL_NO_CHU    " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_M.JISSEKI_FLAG = '0'                                      " & vbNewLine _
    '                                      & "--INNER JOIN $LM_TRN$..C_OUTKA_L                                            " & vbNewLine _
    '                                      & "--ON  C_OUTKA_L.SYS_DEL_FLG = '0'                                         " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.NRS_BR_CD = C_OUTKA_L.NRS_BR_CD                 " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.OUTKA_CTL_NO = C_OUTKA_L.OUTKA_NO_L           " & vbNewLine _
    '                                      & "--INNER JOIN $LM_TRN$..C_OUTKA_M                                            " & vbNewLine _
    '                                      & "--ON  C_OUTKA_M.SYS_DEL_FLG = '0'                                         " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                 " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.OUTKA_CTL_NO = C_OUTKA_M.OUTKA_NO_L           " & vbNewLine _
    '                                      & "--AND H_OUTKAEDI_DTL_BP.OUTKA_CTL_NO_CHU = C_OUTKA_M.OUTKA_NO_M           " & vbNewLine _
    '                                      & "--INNER JOIN                                                                " & vbNewLine _
    '                                      & "--(SELECT                                                                  " & vbNewLine _
...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND As String = "SELECT                           " & vbNewLine _
                    ...
                    & " ,OUTKA_M.OUTKA_NO_L	          AS INOUT_CTL_NO_L         " & vbNewLine _
                    & " ,OUTKA_M.OUTKA_NO_M	          AS INOUT_CTL_NO_M         " & vbNewLine _
                    & " ,HED.CUST_CD_L	              AS CUST_CD_L              " & vbNewLine _
                    & " ,HED.CUST_CD_M	              AS CUST_CD_M              " & vbNewLine _
                    & " ,HED.KITAKU_CD	              AS KITAKU_CD              " & vbNewLine _
                    & " ,HED.OUTKA_SOKO_CD         	  AS SOKO_CD                " & vbNewLine _
                    & " ,HED.ORDER_TYPE	              AS ORDER_TYPE             " & vbNewLine _
                    & " ,OUTKA_L.OUTKA_PLAN_DATE      AS INOUT_DATE             " & vbNewLine _
                    & " ,''		                      AS FILLER_1               " & vbNewLine _
                    & " ,HED.CUST_ORD_NO	          AS CUST_ORD_NO            " & vbNewLine _
                    & " ,HED.DEST_CD	              AS DEST_CD                " & vbNewLine _
                    & " ,DTL.GYO	                  AS MEI_NO                 " & vbNewLine _
                    & " ,DTL.GOODS_CD	              AS GOODS_CD               " & vbNewLine _
                    & " ,'00000000'		              AS SEIZO_DATE             " & vbNewLine _
                    & " ,''		                      AS LOT_NO                 " & vbNewLine _
                    & " ,''		                      AS SOKO_NO                " & vbNewLine _
                    & " ,''		                      AS LOCA                   " & vbNewLine _
                    & " ,EDI_M.OUTKA_TTL_NB	          AS INOUT_PKG_NB           " & vbNewLine _
                    & " ,HED.BUMON_CD                 AS BUMON_CD               " & vbNewLine _
                    & " ,HED.JIGYOBU_CD	              AS JIGYOBU_CD             " & vbNewLine _
                    & " --(2013.03.11)BPC新レイアウト対応 SATRT                 " & vbNewLine _
                    & " ,SUBSTRING(EDI_M.EDI_CTL_NO,1,1) + '00000000' AS INKA_CTL_NO  " & vbNewLine _
                    & " --(2013.03.11)BPC新レイアウト対応 END                   " & vbNewLine _
                    & " ,HED.TOKUI_CD		          AS TOKUI_CD               " & vbNewLine _
                    & " ,''		                      AS OKURIJO_NO             " & vbNewLine _
                    & " ,''		                      AS FILLER_2               " & vbNewLine _
                    ...
                    & "   ON OUTKA_M.NRS_BR_CD = EDI_M.NRS_BR_CD                " & vbNewLine _
                    & "  AND OUTKA_M.OUTKA_NO_L = EDI_M.OUTKA_CTL_NO            " & vbNewLine _
                    & "  AND OUTKA_M.OUTKA_NO_M = EDI_M.OUTKA_CTL_NO_CHU        " & vbNewLine _
                    ...
                    & " INNER JOIN $LM_TRN$..H_OUTKAEDI_HED_BP HED              " & vbNewLine _
                    & "   ON HED.NRS_BR_CD = EDI_M.NRS_BR_CD                    " & vbNewLine _
                    & "  AND HED.EDI_CTL_NO = EDI_M.EDI_CTL_NO                  " & vbNewLine _
                    & "  AND HED.SYS_DEL_FLG = '0'                              " & vbNewLine _
                    & " INNER JOIN $LM_TRN$..H_OUTKAEDI_DTL_BP DTL              " & vbNewLine _
                    & "   ON DTL.NRS_BR_CD = EDI_M.NRS_BR_CD                    " & vbNewLine _
                    ...
                    & " WHERE EDI_M.NRS_BR_CD = @NRS_BR_CD                      " & vbNewLine _
                    & "  AND  EDI_M.EDI_CTL_NO = @EDI_CTL_NO                    " & vbNewLine _
                    & "  AND  EDI_M.JISSEKI_FLAG = '0'                          " & vbNewLine _
                    & "  AND  EDI_M.DEL_KB = '0'                                " & vbNewLine

#End Region  '実績作成

#Region "SEND"

    Private Const SQL_INSERT_SEND As String = "INSERT INTO $LM_TRN$..H_SENDEDI_BP " & vbNewLine _
                    & "(                                    " & vbNewLine _
                    & "DEL_KB                               " & vbNewLine _
                    ...
                    & ",INOUT_CTL_NO_L                      " & vbNewLine _
                    & ",INOUT_CTL_NO_M                      " & vbNewLine _
                    & ",CUST_CD_L                           " & vbNewLine _
                    & ",CUST_CD_M                           " & vbNewLine _
...
#If True Then ' BP運送会社自動設定対応 20161116 added by inoue
    ...
    Private Const SQL_SELECT_UNSO_BY_WEIGHT_AND_DEST_LIST_DATA As String _
        = "  SELECT                                                                                    " & vbNewLine _
        & "         L.NRS_BR_CD                        AS NRS_BR_CD                                    " & vbNewLine _
        & "       , L.CUST_CD_L                        AS CUST_CD_L                                    " & vbNewLine _
        & "       , L.CUST_CD_M                        AS CUST_CD_M                                    " & vbNewLine _
        & "       , L.OUTKA_PLAN_DATE                  AS OUTKA_PLAN_DATE                              " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM2, '99')      AS KEN_CD                                       " & vbNewLine _
        & "       , L.DEST_CD                          AS DEST_CD                                      " & vbNewLine _
        & "       , HED.CRT_DATE                       AS CRT_DATE                                     " & vbNewLine _
        & "       , HED.[FILE_NAME]                    AS [FILE_NAME]                                  " & vbNewLine _
        & "       , CASE WHEN L.FREE_C05 = 'JP'                                                        " & vbNewLine _
        & "              THEN L.FREE_C05                                                               " & vbNewLine _
        & "              ELSE ''                                                                       " & vbNewLine _
        & "         END                                AS MOSIOKURI_KB                                 " & vbNewLine _
        & "       , SUM(M.FREE_N07)                    AS SUM_WEIGHT_KG                                " & vbNewLine _
        & "       , CASE WHEN L.FREE_C05 = 'JP'                                                        " & vbNewLine _
        & "              THEN ISNULL(PUMP.VALUE1, P_OUTSIDE.VALUE1)                                    " & vbNewLine _
        & "              ELSE ISNULL(NORMAL.VALUE1, OUTSIDE.VALUE1)                                    " & vbNewLine _
        & "         END                                AS THRESHOLD_WEIGHT_KG                          " & vbNewLine _
        & "       , CASE WHEN L.FREE_C05 = 'JP'                                                        " & vbNewLine _
        & "              THEN ISNULL(PUMP.KBN_NM4, P_OUTSIDE.KBN_NM4)                                  " & vbNewLine _
        & "              ELSE ISNULL(NORMAL.KBN_NM4, OUTSIDE.KBN_NM4)                                  " & vbNewLine _
        & "         END                                AS UNSOCO_CD                                    " & vbNewLine _
        & "       , CASE WHEN L.FREE_C05 = 'JP'                                                        " & vbNewLine _
        & "              THEN ISNULL(PUMP.KBN_NM5, P_OUTSIDE.KBN_NM5)                                  " & vbNewLine _
        & "              ELSE ISNULL(NORMAL.KBN_NM5, OUTSIDE.KBN_NM5)                                  " & vbNewLine _
        & "         END                                AS UNSOCO_BR_CD                                 " & vbNewLine _
        & "       , CASE WHEN L.FREE_C05 = 'JP'                                                        " & vbNewLine _
        & "              THEN ISNULL(PUMP.KBN_NM6, P_OUTSIDE.KBN_NM6)                                  " & vbNewLine _
        & "              ELSE ISNULL(NORMAL.KBN_NM6, OUTSIDE.KBN_NM6)                                  " & vbNewLine _
        & "         END                               AS OVER_TH_UNSOCO_CD                             " & vbNewLine _
        & "       , CASE WHEN L.FREE_C05 = 'JP'                                                        " & vbNewLine _
        & "              THEN ISNULL(PUMP.KBN_NM7, P_OUTSIDE.KBN_NM7)                                  " & vbNewLine _
        & "              ELSE ISNULL(NORMAL.KBN_NM7, OUTSIDE.KBN_NM7)                                  " & vbNewLine _
        & "         END                               AS OVER_TH_UNSOCO_BR_CD                          " & vbNewLine _
        & "       , ISNULL(CHARTER.VALUE1, C_OUTSIDE.VALUE1)         AS CHARTER_THRESHOLD_WEIGHT_KG    " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM4, C_OUTSIDE.KBN_NM4)       AS CHARTER_UNSOCO_1               " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM5, C_OUTSIDE.KBN_NM5)       AS CHARTER_UNSOCO_2               " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM6, C_OUTSIDE.KBN_NM6)       AS CHARTER_UNSOCO_3               " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM7, C_OUTSIDE.KBN_NM7)       AS CHARTER_UNSOCO_4               " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM8, C_OUTSIDE.KBN_NM8)       AS CHARTER_UNSOCO_5               " & vbNewLine _
        & "       , CASE WHEN ISLAND_TARIFF.KBN_NM2 IS NULL                                            " & vbNewLine _
        & "              THEN '0'                                                                      " & vbNewLine _
        & "              ELSE '1'                                                                      " & vbNewLine _
        & "         END                                              AS IS_REMOTE_ISLAND               " & vbNewLine _
        & "       , ISNULL(NORMAL.KBN_NM8, OUTSIDE.KBN_NM8)          AS ISLAND_UNSOCO_CD               " & vbNewLine _
        & "       , ISNULL(NORMAL.KBN_NM9, OUTSIDE.KBN_NM9)          AS ISLAND_UNSOCO_BR_CD            " & vbNewLine _
        & "    FROM $LM_TRN$..H_OUTKAEDI_L AS L                                                        " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_TRN$..H_OUTKAEDI_M AS M                                                        " & vbNewLine _
        & "      ON L.NRS_BR_CD = M.NRS_BR_CD                                                          " & vbNewLine _
        & "     AND L.EDI_CTL_NO = M.EDI_CTL_NO                                                        " & vbNewLine _
        & "     AND L.SYS_DEL_FLG = M.SYS_DEL_FLG                                                      " & vbNewLine _
        & "     AND L.DEL_KB = M.DEL_KB                                                                " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_TRN$..H_OUTKAEDI_HED_BP AS HED                                                 " & vbNewLine _
        & "      ON HED.NRS_BR_CD = L.NRS_BR_CD                                                        " & vbNewLine _
        & "     AND HED.EDI_CTL_NO = L.EDI_CTL_NO                                                      " & vbNewLine _
        & "     AND HED.SYS_DEL_FLG = '0'                                                              " & vbNewLine _
        & "     AND HED.DEL_KB = '0'                                                                   " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN as NORMAL        -- エリア別運送会社                               " & vbNewLine _
        & "      ON NORMAL.KBN_GROUP_CD = 'B029'                                                       " & vbNewLine _
        & "     AND NORMAL.KBN_NM2 <> '99'                                                             " & vbNewLine _
        & "     AND NORMAL.KBN_NM2 = RIGHT(RTRIM(HED.DEST_JIS_CD), 2)                                  " & vbNewLine _
        & "     AND NORMAL.KBN_NM3 = L.NRS_BR_CD                                                       " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN as OUTSIDE       -- エリア外運送会社                               " & vbNewLine _
        & "      ON OUTSIDE.KBN_GROUP_CD = 'B029'                                                      " & vbNewLine _
        & "     AND OUTSIDE.KBN_NM2       = '99'                                                       " & vbNewLine _
        & "     AND OUTSIDE.KBN_NM3 = L.NRS_BR_CD                                                      " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN as PUMP          -- エリア別運送会社(ポンプアップ)                 " & vbNewLine _
        & "      ON PUMP.KBN_GROUP_CD = 'B030'                                                         " & vbNewLine _
        & "     AND PUMP.KBN_NM2 <> '99'                                                               " & vbNewLine _
        & "     AND PUMP.KBN_NM2 = RIGHT(RTRIM(HED.DEST_JIS_CD), 2)                                    " & vbNewLine _
        & "     AND PUMP.KBN_NM3 = L.NRS_BR_CD                                                         " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN as P_OUTSIDE     -- エリア外運送会社(ポンプアップ)                 " & vbNewLine _
        & "      ON P_OUTSIDE.KBN_GROUP_CD = 'B030'                                                    " & vbNewLine _
        & "     AND P_OUTSIDE.KBN_NM2      = '99'                                                      " & vbNewLine _
        & "     AND P_OUTSIDE.KBN_NM3      = L.NRS_BR_CD                                               " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN as CHARTER       -- エリア別運送会社(チャーター)                   " & vbNewLine _
        & "      ON CHARTER.KBN_GROUP_CD = 'B031'                                                      " & vbNewLine _
        & "     AND CHARTER.KBN_NM2 <> '99'                                                            " & vbNewLine _
        & "     AND CHARTER.KBN_NM2 = RIGHT(RTRIM(HED.DEST_JIS_CD), 2)                                 " & vbNewLine _
        & "     AND CHARTER.KBN_NM3 = L.NRS_BR_CD                                                      " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN as C_OUTSIDE     -- エリア外運送会社(チャーター)                   " & vbNewLine _
        & "      ON C_OUTSIDE.KBN_GROUP_CD = 'B031'                                                    " & vbNewLine _
        & "     AND C_OUTSIDE.KBN_NM2      = '99'                                                      " & vbNewLine _
        & "     AND C_OUTSIDE.KBN_NM3      = L.NRS_BR_CD                                               " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..M_UNCHIN_TARIFF_SET  AS TARIFF                                           " & vbNewLine _
        & "      ON TARIFF.NRS_BR_CD       = L.NRS_BR_CD                                               " & vbNewLine _
        & "     AND TARIFF.CUST_CD_L       = L.CUST_CD_L                                               " & vbNewLine _
        & "     AND TARIFF.CUST_CD_M       = L.CUST_CD_M                                               " & vbNewLine _
        & "     AND TARIFF.DEST_CD         = L.DEST_CD                                                 " & vbNewLine _
        & "     AND TARIFF.SET_KB          = '01'                                                      " & vbNewLine _
        & "     AND TARIFF.SYS_DEL_FLG     = '0'                                                       " & vbNewLine _
        & "  LEFT JOIN                                                                                 " & vbNewLine _
        & "         $LM_MST$..Z_KBN AS ISLAND_TARIFF                                                   " & vbNewLine _
        & "      ON ISLAND_TARIFF.KBN_GROUP_CD = 'R017'                                                " & vbNewLine _
        & "     AND ISLAND_TARIFF.KBN_NM1      = TARIFF.NRS_BR_CD                                      " & vbNewLine _
        & "     AND ISLAND_TARIFF.KBN_NM2      = TARIFF.EXTC_TARIFF_CD                                 " & vbNewLine _
        & "  WHERE L.SYS_DEL_FLG         = '0'                                                         " & vbNewLine _
        & "    AND L.DEL_KB              = '0'                                                         " & vbNewLine _
        & "    AND M.SYS_DEL_FLG         = '0'                                                         " & vbNewLine _
        & "    AND M.DEL_KB              = '0'                                                         " & vbNewLine _
        & "   AND L.NRS_BR_CD           = @NRS_BR_CD                                                   " & vbNewLine _
        & "   AND L.CUST_CD_L           = @CUST_CD_L                                                   " & vbNewLine _
        & "   AND L.CUST_CD_M           = @CUST_CD_M                                                   " & vbNewLine _
        & "   AND L.OUTKA_PLAN_DATE    >= @MIN_OUTKA_PLAN_DATE                                         " & vbNewLine _
        & "   AND L.OUTKA_PLAN_DATE    <= @MAX_OUTKA_PLAN_DATE                                         " & vbNewLine _
        & "  GROUP BY                                                                                  " & vbNewLine _
        & "         L.NRS_BR_CD                                                                        " & vbNewLine _
        & "       , L.CUST_CD_L                                                                        " & vbNewLine _
        & "       , L.CUST_CD_M                                                                        " & vbNewLine _
        & "       , L.OUTKA_PLAN_DATE                                                                  " & vbNewLine _
        & "       , ISNULL(CHARTER.KBN_NM2, '99')                                                      " & vbNewLine _
        & "       , L.DEST_CD                                                                          " & vbNewLine _
        ...
        & "              ELSE ISNULL(NORMAL.KBN_NM7, OUTSIDE.KBN_NM7)                                  " & vbNewLine _
        & "         END                                                                                " & vbNewLine _
        & "       , CHARTER.VALUE1                                                                     " & vbNewLine _
        & "       , CHARTER.KBN_NM4                                                                    " & vbNewLine _
        & "       , CHARTER.KBN_NM5                                                                    " & vbNewLine _
        & "       , CHARTER.KBN_NM6                                                                    " & vbNewLine _
        & "       , CHARTER.KBN_NM7                                                                    " & vbNewLine _
        & "       , CHARTER.KBN_NM8                                                                    " & vbNewLine _
        & "       , CHARTER.KBN_NM9                                                                    " & vbNewLine _
        & "       , CHARTER.KBN_NM10                                                                   " & vbNewLine _
        & "       , CHARTER.KBN_NM11                                                                   " & vbNewLine _
        & "       , C_OUTSIDE.VALUE1                                                                   " & vbNewLine _
        & "       , C_OUTSIDE.KBN_NM4                                                                  " & vbNewLine _
        & "       , C_OUTSIDE.KBN_NM5                                                                  " & vbNewLine _
        & "       , C_OUTSIDE.KBN_NM6                                                                  " & vbNewLine _
        & "       , C_OUTSIDE.KBN_NM7                                                                  " & vbNewLine _
        & "       , C_OUTSIDE.KBN_NM8                                                                  " & vbNewLine _
        & "       , ISNULL(NORMAL.KBN_NM8, OUTSIDE.KBN_NM8)                                            " & vbNewLine _
        & "       , ISNULL(NORMAL.KBN_NM9, OUTSIDE.KBN_NM9)                                            " & vbNewLine _
        & "       , CASE WHEN ISLAND_TARIFF.KBN_NM2 IS NULL                                            " & vbNewLine _
        & "              THEN '0'                                                                      " & vbNewLine _
        & "              ELSE '1'                                                                      " & vbNewLine _
        & "         END                                                                                " & vbNewLine
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_CHARTER_MANAGEMENT_LIST As String _
        = " SELECT                                                                       " & vbNewLine _
        & "        EDI.NRS_BR_CD                        AS NRS_BR_CD                     " & vbNewLine _
        & "      , EDI.CUST_CD_L                        AS CUST_CD_L                     " & vbNewLine _
        & "      , EDI.CUST_CD_M                        AS CUST_CD_M                     " & vbNewLine _
        & "      , EDI.KEN_CD                           AS KEN_CD                        " & vbNewLine _
        & "      , EDI.FILE_NAME                        AS FILE_NAME                     " & vbNewLine _
        & "      , EDI.CRT_DATE                         AS CRT_DATE                      " & vbNewLine _
        & "      , EDI.OUTKA_PLAN_DATE                  AS OUTKA_PLAN_DATE               " & vbNewLine _
        & "      , EDI.DEST_CD                          AS DEST_CD                       " & vbNewLine _
        & "      , MAX(                                                                  " & vbNewLine _
        & "         ISNULL(                                                              " & vbNewLine _
        & "             CASE                                                             " & vbNewLine _
        & "              WHEN EDI.UNSO_CD + '-' + EDI.UNSO_BR_CD = CHARTER.KBN_NM8       " & vbNewLine _
        & "              THEN 5                                                          " & vbNewLine _
        & "              WHEN EDI.UNSO_CD + '-' + EDI.UNSO_BR_CD = CHARTER.KBN_NM7       " & vbNewLine _
        & "              THEN 4                                                          " & vbNewLine _
        & "              WHEN EDI.UNSO_CD + '-' + EDI.UNSO_BR_CD = CHARTER.KBN_NM6       " & vbNewLine _
        & "              THEN 3                                                          " & vbNewLine _
        & "              WHEN EDI.UNSO_CD + '-' + EDI.UNSO_BR_CD = CHARTER.KBN_NM5       " & vbNewLine _
        & "              THEN 2                                                          " & vbNewLine _
        & "              WHEN EDI.UNSO_CD + '-' + EDI.UNSO_BR_CD = CHARTER.KBN_NM4       " & vbNewLine _
        & "              THEN 1                                                          " & vbNewLine _
        & "              ELSE 0                                                          " & vbNewLine _
        & "             END, 0))                          AS CHARTER_NO                  " & vbNewLine _
        & " FROM                                                                         " & vbNewLine _
        & "      $LM_MST$..Z_KBN AS CHARTER                                              " & vbNewLine _
        & " LEFT JOIN                                                                    " & vbNewLine _
        & " (                                                                            " & vbNewLine _
        & "   SELECT                                                                     " & vbNewLine _
        & "            L.NRS_BR_CD                        AS NRS_BR_CD                   " & vbNewLine _
        & "          , L.CUST_CD_L                        AS CUST_CD_L                   " & vbNewLine _
        & "          , L.CUST_CD_M                        AS CUST_CD_M                   " & vbNewLine _
        & "          , L.FREE_C02                         AS FILE_NAME                   " & vbNewLine _
        & "          , L.CRT_DATE                         AS CRT_DATE                    " & vbNewLine _
        & "          , L.OUTKA_PLAN_DATE                  AS OUTKA_PLAN_DATE             " & vbNewLine _
        & "          , L.DEST_CD                          AS DEST_CD                     " & vbNewLine _
        & "          , ISNULL(CHARTER.KBN_NM2, '99')      AS KEN_CD                      " & vbNewLine _
        & "          , L.UNSO_CD                                                         " & vbNewLine _
        & "          , L.UNSO_BR_CD                                                      " & vbNewLine _
        & "     FROM $LM_TRN$..H_OUTKAEDI_L AS L                                         " & vbNewLine _
        & "     LEFT JOIN                                                                " & vbNewLine _
        & "            $LM_TRN$..H_OUTKAEDI_HED_BP AS HED                                " & vbNewLine _
        & "       ON HED.NRS_BR_CD   = L.NRS_BR_CD                                       " & vbNewLine _
        ...
        & "      AND L.OUTKA_PLAN_DATE    >= @MIN_OUTKA_PLAN_DATE                        " & vbNewLine _
        & "      AND L.OUTKA_PLAN_DATE    <= @MAX_OUTKA_PLAN_DATE                        " & vbNewLine _
        & "      AND L.UNSO_CD            <> ''                                          " & vbNewLine _
        & "      AND L.UNSO_BR_CD         <> ''                                          " & vbNewLine _
        & "      AND L.JISSEKI_FLAG       <> '0'                                         " & vbNewLine _
        & "    GROUP BY                                                                  " & vbNewLine _
        & "            L.NRS_BR_CD                                                       " & vbNewLine _
        & "          , L.CUST_CD_L                                                       " & vbNewLine _
        & "          , L.CUST_CD_M                                                       " & vbNewLine _
        ...
        & "          , L.UNSO_CD                                                         " & vbNewLine _
        & "          , L.UNSO_BR_CD                                                      " & vbNewLine _
        & "          , L.FREE_C02                                                        " & vbNewLine _
        & "          , L.CRT_DATE                                                        " & vbNewLine _
        & " ) AS EDI                                                                     " & vbNewLine _
        & "    ON CHARTER.KBN_GROUP_CD = 'B031'                                          " & vbNewLine _
        & "   AND CHARTER.KBN_NM2      = EDI.KEN_CD                                      " & vbNewLine _
        & "   AND CHARTER.KBN_NM3      = EDI.NRS_BR_CD                                   " & vbNewLine _
        & " WHERE                                                                        " & vbNewLine _
        & "       EDI.NRS_BR_CD IS NOT NULL                                              " & vbNewLine _
        & " GROUP BY                                                                     " & vbNewLine _
        & "        EDI.NRS_BR_CD                                                         " & vbNewLine _
        & "      , EDI.CUST_CD_L                                                         " & vbNewLine _
        & "      , EDI.CUST_CD_M                                                         " & vbNewLine _
        & "      , EDI.FILE_NAME                                                         " & vbNewLine _
        & "      , EDI.CRT_DATE                                                          " & vbNewLine _
        & "      , EDI.OUTKA_PLAN_DATE                                                   " & vbNewLine _
        & "      , EDI.KEN_CD                                                            " & vbNewLine _
        & "      , EDI.DEST_CD                                                           " & vbNewLine

#End If

#If True Then   'ADD 2018/06/14 依頼番号 : 001580

    Private Const SQL_SELECT_OUT_UNSO_AMAZON_BY_DEST_LIST_DATA As String _
     = "  SELECT                                                                                 " & vbNewLine _
     & "         ISNULL(KBN.KBN_NM1,'')                  AS DEST_NM                              " & vbNewLine _
     & "        ,ISNULL(KBN.KBN_NM2,'')                  AS DEST_CD                              " & vbNewLine _
     & "        ,ISNULL(KBN.KBN_NM3,'')                  AS NRS_BR_CD                            " & vbNewLine _
     & "        ,ISNULL(KBN.KBN_NM4,'')                  AS UNSO_CD                              " & vbNewLine _
     & "        ,ISNULL(KBN.KBN_NM5,'')                  AS UNSO_BR_CD                           " & vbNewLine _
     & "    FROM $LM_MST$..Z_KBN  AS KBN                                                         " & vbNewLine _
     & "    WHERE                                                                                " & vbNewLine _
     & "         KBN.KBN_GROUP_CD = 'B034'                                                       " & vbNewLine _
     & "     AND KBN.KBN_NM2      = @DEST_CD                                                     " & vbNewLine _
     & "     AND KBN.KBN_NM3      = @NRS_BR_CD                                                   " & vbNewLine
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSend(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030INOUT")
        Dim drHed As DataRow = ds.Tables("LMH030_EDI_RCV_HED").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDEDI_BP")
        reader.Close()
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNcgoMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC501.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectDataNcgoMdest", cmd)
...
#Region ""
    ...
    Private Function SelectCharterManagementList(ByVal ds As DataSet) As DataSet
        ...
        If (ds.Tables(TableNames.IN_OUTAKA_SAVE_BP).Rows.Count = 0) Then
            Return ds
        End If

        Me._Row = ds.Tables(TableNames.IN_OUTAKA_SAVE_BP).Rows(0)

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC501.SQL_SELECT_CHARTER_MANAGEMENT_LIST _
                                          , Me _
                                          ._Row.Item("NRS_BR_CD").ToString())
        ...
        Me.SetPrmSelectUnsoByWgtAndDestList(Me._Row)
        ...
        Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
            ...
            Dim map As Hashtable = New Hashtable() From
            {
                {"NRS_BR_CD", "NRS_BR_CD"},
                {"CUST_CD_L", "CUST_CD_L"},
                {"CUST_CD_M", "CUST_CD_M"},
                {"FILE_NAME", "FILE_NAME"},
                {"CRT_DATE", "CRT_DATE"},
                {"OUTKA_PLAN_DATE", "OUTKA_PLAN_DATE"},
                {"KEN_CD", "KEN_CD"},
                {"DEST_CD", "DEST_CD"},
            ...
            ds = MyBase.SetSelectResultToDataSet(map _
                                               , ds _
                                               , reader _
                                               , TableNames.OUT_CHARTER_MANAGEMENT)

            '処理件数の設定
            MyBase.SetResultCount(ds.Tables(TableNames.OUT_CHARTER_MANAGEMENT).Rows.Count())
    ...
    Private Function SelectUnsoByWgtAndDestList(ByVal ds As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC501.SQL_SELECT_UNSO_BY_WEIGHT_AND_DEST_LIST_DATA _
                                          , Me _
                                          ._Row.Item("NRS_BR_CD").ToString())
        ...
        Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
            ...
            Dim map As Hashtable = New Hashtable() From
            {
                ...
                {"THRESHOLD_WEIGHT_KG", "THRESHOLD_WEIGHT_KG"},
                {"UNSOCO_CD", "UNSOCO_CD"},
                {"UNSOCO_BR_CD", "UNSOCO_BR_CD"},
                {"OVER_TH_UNSOCO_CD", "OVER_TH_UNSOCO_CD"},
                {"OVER_TH_UNSOCO_BR_CD", "OVER_TH_UNSOCO_BR_CD"},
                {"MOSIOKURI_KB", "MOSIOKURI_KB"},
                {"CHARTER_THRESHOLD_WEIGHT_KG", "CHARTER_THRESHOLD_WEIGHT_KG"},
                {"CHARTER_UNSOCO_1", "CHARTER_UNSOCO_1"},
                {"CHARTER_UNSOCO_2", "CHARTER_UNSOCO_2"},
                {"CHARTER_UNSOCO_3", "CHARTER_UNSOCO_3"},
                {"CHARTER_UNSOCO_4", "CHARTER_UNSOCO_4"},
                {"CHARTER_UNSOCO_5", "CHARTER_UNSOCO_5"},
                {"IS_REMOTE_ISLAND", "IS_REMOTE_ISLAND"},
                {"ISLAND_UNSOCO_CD", "ISLAND_UNSOCO_CD"},
                {"ISLAND_UNSOCO_BR_CD", "ISLAND_UNSOCO_BR_CD"}
            }

            ds = MyBase.SetSelectResultToDataSet(map _
                                               , ds _
                                               , reader _
                                               , TableNames.OUT_UNSO_BY_WGT_AND_DEST)

            '処理件数の設定
            MyBase.SetResultCount(ds.Tables(TableNames.OUT_UNSO_BY_WGT_AND_DEST).Rows.Count())
...
#If True Then
    ...
    ''' <summary>
    ''' Amazon届先運送会社取得 ADD 2018/06/14
    ''' </summary>
    ''' <param name="ds"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectUnsoAmazonDestList(ds As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC501.SQL_SELECT_OUT_UNSO_AMAZON_BY_DEST_LIST_DATA _
                                          , Me _
                                          ._Row.Item("NRS_BR_CD").ToString())
        ...
        Me.SetPrmSelectUnsoAmazonDestList(Me._Row)
        ...
        Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
            ...
            Dim map As Hashtable = New Hashtable() From
            {
                ...
                {"NRS_BR_CD", "NRS_BR_CD"},
                {"UNSO_CD", "UNSO_CD"},
                {"UNSO_BR_CD", "UNSO_BR_CD"}
            }

            ds = MyBase.SetSelectResultToDataSet(map _
                                               , ds _
                                               , reader _
                                               , TableNames.OUT_UNSO_AMAZON_BY_DEST)

            '処理件数の設定
            MyBase.SetResultCount(ds.Tables(TableNames.OUT_UNSO_AMAZON_BY_DEST).Rows.Count())
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC501.SQL_UPDATE_OUTKASAVEEDI_L
                setSql = String.Concat(setSql, SQL_COM_UPDATE_CONDITION) '出荷の場合は排他チェックを行う

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC501.SQL_UPD_JISSEKI_EDI_L
        ...
        '
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(String.Concat(setSql) _
        ...
        '                                                               , Me._Row.Item("NRS_BR_CD").ToString()))
        'ビーピーカストロール対応 terakawa 2012.12.19 End
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC501.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC501.SQL_UPD_JISSEKI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC501.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC501.SQL_UPD_JISSEKI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC501.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC501.SQL_UPD_JISSEKI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC501.SQL_UPDATE_OUTKAL_MATOME

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC501.SQL_UPD_JISSEKI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC501.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC501.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "UpdateOutkaMData", cmd)
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDEDI_BP")

        '営業所コード
        Dim brCd As String = inTbl.Rows(0).Item("NRS_BR_CD").ToString()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_SEND, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertSend", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC501.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "InsertMDestData", cmd)
...
#Region "運賃パラメータ設定"
    ...
    Private Sub SetUnchinComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@SEIQTO_CD", .Item("SEIQTO_CD").ToString(), DBDataType.NVARCHAR))                   '要望番号1696:(●急●群馬00952：ビーピー・カストロール ＥＤＩ出荷登録でアベンド) 2012/12/05 本明 この行を復活させた
...
#End Region
    ...
    'ビーピーカストロール対応 terakawa 2012.12.19 Start
#Region "取得処理パラメータ設定(SEND)"
    Private Sub SetPrmSend()
...
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUT_CTL_NO_L", Me.NullConvertString(row.Item("INOUT_CTL_NO_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUT_CTL_NO_M", Me.NullConvertString(row.Item("INOUT_CTL_NO_M")), DBDataType.CHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KITAKU_CD", Me.NullConvertString(row.Item("KITAKU_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SOKO_CD", Me.NullConvertString(row.Item("SOKO_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORDER_TYPE", Me.NullConvertString(row.Item("ORDER_TYPE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUT_DATE", Me.NullConvertString(row.Item("INOUT_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FILLER_1", Me.NullConvertString(row.Item("FILLER_1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me.NullConvertString(row.Item("CUST_ORD_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD", Me.NullConvertString(row.Item("DEST_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MEI_NO", Me.NullConvertString(row.Item("MEI_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD", Me.NullConvertString(row.Item("GOODS_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEIZO_DATE", Me.NullConvertString(row.Item("SEIZO_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(row.Item("LOT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SOKO_NO", Me.NullConvertString(row.Item("SOKO_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOCA", Me.NullConvertString(row.Item("LOCA")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUT_PKG_NB", Me.NullConvertString(row.Item("INOUT_PKG_NB")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BUMON_CD", Me.NullConvertString(row.Item("BUMON_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JIGYOBU_CD", Me.NullConvertString(row.Item("JIGYOBU_CD")), DBDataType.NVARCHAR))

        '(2013.02.27) BP新システム切替対応START
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO", Me.NullConvertString(row.Item("INKA_CTL_NO")), DBDataType.CHAR))
        '(2013.02.27) BP新システム切替対応END

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOKUI_CD", Me.NullConvertString(row.Item("TOKUI_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OKURIJO_NO", Me.NullConvertString(row.Item("OKURIJO_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FILLER_2", Me.NullConvertString(row.Item("FILLER_2")), DBDataType.NVARCHAR))
...
#If True Then ' BP運送会社自動設定対応 20161116 added by inoue
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSelectUnsoByWgtAndDestList(ByVal row As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(row.Item("NRS_BR_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(row.Item("CUST_CD_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(row.Item("CUST_CD_M")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MIN_OUTKA_PLAN_DATE", Me.NullConvertString(row.Item("MIN_OUTKA_PLAN_DATE")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MAX_OUTKA_PLAN_DATE", Me.NullConvertString(row.Item("MAX_OUTKA_PLAN_DATE")), DBDataType.CHAR))
...
#If True Then ' BPAmazon運送会社設定対応 2018/06/14 
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSelectUnsoAmazonDestList(ByVal row As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(row.Item("NRS_BR_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD", Me.NullConvertString(row.Item("DEST_CD")), DBDataType.CHAR))
...
#Region "マッピング配列作成"
    ...
    Private Function SetMapSend() As Hashtable
        ...
        map.Add("EDI_CTL_NO", "EDI_CTL_NO")
        map.Add("EDI_CTL_NO_CHU", "EDI_CTL_NO_CHU")
        map.Add("INOUT_CTL_NO_L", "INOUT_CTL_NO_L")
        map.Add("INOUT_CTL_NO_M", "INOUT_CTL_NO_M")
        map.Add("CUST_CD_L", "CUST_CD_L")
        map.Add("CUST_CD_M", "CUST_CD_M")
        ...
        '(2013.02.27) BP新システム切替対応START
        map.Add("INKA_CTL_NO", "INKA_CTL_NO")
        '(2013.02.27) BP新システム切替対応END
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectDataMdestOutkaToroku", cmd)
...
#Region "区分マスタ"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataTgtJisZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.SQL_SELECT_Z_KBN_TGT_JIS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectDataZKBNTgtJis", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            map.Add("TGT_JIS_CD", "TGT_JIS_CD")
            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_TGT_JIS")
...
#Region "郵便番号マスタ"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataTgtJisMZIP(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        Dim dt As DataTable = ds.Tables("LMH030_GET_ZIPJIS")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC501.SQL_SELECT_M_ZIP_GET_JIS)

        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ZIP_NO", Me._Row.Item("ZIP_NO"), DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC501", "SelectDataTgtJisMZIP", cmd)
        ...
        If Not ds.Tables("LMH030_GET_ZIPJIS") Is Nothing AndAlso ds.Tables("LMH030_GET_ZIPJIS").Rows.Count <> 0 Then
            MyBase.Logger.WriteLog(0, "LMH030DAC501", "SelectDataTgtJisMZIS", "1")
        ...
        'DataReader→DataTableへの転記
        Dim map As Hashtable = New Hashtable()
        MyBase.Logger.WriteLog(0, "LMH030DAC501", "SelectDataTgtJisMZIS", "2")
        If reader.HasRows() = True Then

            map.Add("ZIP_NO", "ZIP_NO")
            map.Add("JIS_CD", "JIS_CD")
            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_GET_ZIPJIS")

        End If
        MyBase.Logger.WriteLog(0, "LMH030DAC501", "SelectDataTgtJisMZIS", "3")
