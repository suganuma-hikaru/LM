...
#Region "SELECT_M_DEST"
    ...
    Private Const SELECT_COUNT_OUTKAEDI_L As String = " SELECT                                 " & vbNewLine _
                                     ...
                                     & " AND                                                   " & vbNewLine _
                                     & " H_OUTKAEDI_L.CUST_CD_M   = @CUST_CD_M                 " & vbNewLine _
                                     & " AND                                                   " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DSP(INSERT)"
    ...
    Private Const SQL_INSERT_H_OUTKAEDI_DTL_NRK As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",KAKUTEI_SYUKKA_DATE  " & vbNewLine _
                                        & ",HANBAI_KBN  " & vbNewLine _
                                        & ",HINMOKU_NO  " & vbNewLine _
                                        & ",TANKA  " & vbNewLine _
                                        & ",HINMOKU_MEI  " & vbNewLine _
                                        & ",UNSOU_KAISYA_NAME  " & vbNewLine _
                                        & ",STATUS  " & vbNewLine _
                                        & ",UNSOU_KAISYA  " & vbNewLine _
                                        & ",SITE  " & vbNewLine _
                                        & ",SOUKO  " & vbNewLine _
                                        & ",HINMOKU_G  " & vbNewLine _
                                        & ",OUTKA_SUURYOU  " & vbNewLine _
                                        & ",HANBAI_UKETUKE_SYA  " & vbNewLine _
                                        & ",URIAGE_SYUBETU  " & vbNewLine _
                                        & ",HAISOU_SAKI_NAME  " & vbNewLine _
                                        & ",IDOU_SAKI_SITE  " & vbNewLine _
                                        & ",IDOU_SAKI_SOUKO  " & vbNewLine _
                                        & ",KOKYAKU_NAME  " & vbNewLine _
                                        & ",SYOUMI_KINGAKU  " & vbNewLine _
                                        & ",LOT_NO  " & vbNewLine _
                                        & ",KAKUTEI_INKA_DATE  " & vbNewLine _
                                        & ",AREA_CD  " & vbNewLine _
                                        & ",SOUKO_NAME  " & vbNewLine _
                                        & ",ZAIKO_TANNI  " & vbNewLine _
                                        & ",HAISOUSAKI_ZIP_NO  " & vbNewLine _
                                        & ",KOKYAKU_ID  " & vbNewLine _
                                        & ",HANBAI_SUURYOU  " & vbNewLine _
                                        & ",SEIKYUU_SAKI_NAME  " & vbNewLine _
                                        & ",OUTKA_DATE2  " & vbNewLine _
                                        & ",SEIKYUU_ID  " & vbNewLine _
                                        & ",KAISYUU_SAKI_NAME  " & vbNewLine _
                                        & ",HAISOU_SAKI_RYAKUSYOU  " & vbNewLine _
                                        & ",SEIKYUU_KINGAKU  " & vbNewLine _
                                        & ",HANNBAI_TANNI  " & vbNewLine _
                                        & ",DOKUGEKIBUTU_KBN  " & vbNewLine _
                                        & ",DOKUGEKIBUTU_KBN_NAME  " & vbNewLine _
                                        & ",HAISOU_SAKI_ADDRESS  " & vbNewLine _
                                        & ",HAISOU_SAKI_TEL_NO  " & vbNewLine _
                                        & ",KAISYUU_SAKI_ID  " & vbNewLine _
                                        & ",MEISAI_TEXT  " & vbNewLine _
                                        & ",HAISOU_SAKI_TODOUFUKEN  " & vbNewLine _
                                        & ",HAISOU_SAKI_SHIKUCHOUSON  " & vbNewLine _
                                        & ",GYOU_NO  " & vbNewLine _
                                        & ",HAISOU_SAKI_TANTOUSYA  " & vbNewLine _
                                        & ",GAIBU_TEKIYOU  " & vbNewLine _
                                        & ",HAISOU_SAKI_BUSYO  " & vbNewLine _
                                        & ",HAISOU_SAKI_TATEMONO  " & vbNewLine _
                                        & ",HAISOU_SAKI_FAX  " & vbNewLine _
                                        & ",SAKUSEI_DATE  " & vbNewLine _
                                        & ",YOUKI_SYUBETU  " & vbNewLine _
                                        & ",NAIBU_TEKIYOU  " & vbNewLine _
                                        & ",WMS_SYORI_STATUS  " & vbNewLine _
                                        & ",SAKUSEI_SYA  " & vbNewLine _
                                        & ",WMS_SYORI_NICHIJI  " & vbNewLine _
                                        & ",HARAIDASHI_STATUS  " & vbNewLine _
                                        & ",GETUJI_SHIME_DATE  " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC121.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiLCount(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Dim sql As String = LMH030DAC121.SELECT_COUNT_OUTKAEDI_L
        ...
        'SQLログの出力
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectEdiLCount", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC121.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNcgoMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC121.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC121.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectDataNcgoMdest", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    '    'DataSetのIN情報を取得
    '    Dim inDtlTbl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_NRK")
    ...
    '    'SQL作成
    '    Me._StrSql.Append(LMH030DAC121.SQL_TORIKESI_DTL)      'SQL構築
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectRcvDtlDspComTorikesi", cmd)
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC121", "GetDtlTblNm", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectDataMgoodsOutka(ByVal ds As DataSet) As DataSet
        ...
        Dim rcvDtlDt As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_NRK")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC121.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC121.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC121.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectDataMgoods", cmd)
...
#Region "オーダー番号チェック"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC121.SQL_SELECT_C_OUTKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "SelectDataOrderCheck", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC121.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    '    '出荷EDI CONST名
    '    setSql = LMH030DAC121.SQL_UPDATE_OUTKASEMIEDI_DEL_L
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateEdiDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC121.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    '    'EDI出荷SQL
    '    setSql = LMH030DAC121.SQL_UPDATE_OUTKASEMIEDI_DEL_M
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateEdiDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC121.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    '    setSql = LMH030DAC121.SQL_UPDATE_SEMIEDI_DEL_DTL
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateEdiDelRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC121.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC121.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC121.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertOutkaLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiLData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_H_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertOutkaEdiLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC121", "UpdateOutkaMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiMData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_H_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL_DSP(セミEDI)"
    ...
    Private Function InsertEdiRcvDtlData(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_NRK")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_H_OUTKAEDI_DTL_NRK, setDs.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertEdiRcvDtlData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC121.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC121", "InsertMDestData", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetEdiRcvDtlComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@KAKUTEI_SYUKKA_DATE", Me.NullConvertString(.Item("KAKUTEI_SYUKKA_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HANBAI_KBN", Me.NullConvertString(.Item("HANBAI_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMOKU_NO", Me.NullConvertString(.Item("HINMOKU_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TANKA", Me.NullConvertString(.Item("TANKA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMOKU_MEI", Me.NullConvertString(.Item("HINMOKU_MEI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSOU_KAISYA_NAME", Me.NullConvertString(.Item("UNSOU_KAISYA_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@STATUS", Me.NullConvertString(.Item("STATUS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSOU_KAISYA", Me.NullConvertString(.Item("UNSOU_KAISYA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SITE", Me.NullConvertString(.Item("SITE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOUKO", Me.NullConvertString(.Item("SOUKO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMOKU_G", Me.NullConvertString(.Item("HINMOKU_G")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_SUURYOU", Me.NullConvertString(.Item("OUTKA_SUURYOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HANBAI_UKETUKE_SYA", Me.NullConvertString(.Item("HANBAI_UKETUKE_SYA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@URIAGE_SYUBETU", Me.NullConvertString(.Item("URIAGE_SYUBETU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_NAME", Me.NullConvertString(.Item("HAISOU_SAKI_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@IDOU_SAKI_SITE", Me.NullConvertString(.Item("IDOU_SAKI_SITE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@IDOU_SAKI_SOUKO", Me.NullConvertString(.Item("IDOU_SAKI_SOUKO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KOKYAKU_NAME", Me.NullConvertString(.Item("KOKYAKU_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYOUMI_KINGAKU", Me.NullConvertString(.Item("SYOUMI_KINGAKU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KAKUTEI_INKA_DATE", Me.NullConvertString(.Item("KAKUTEI_INKA_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AREA_CD", Me.NullConvertString(.Item("AREA_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOUKO_NAME", Me.NullConvertString(.Item("SOUKO_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZAIKO_TANNI", Me.NullConvertString(.Item("ZAIKO_TANNI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOUSAKI_ZIP_NO", Me.NullConvertString(.Item("HAISOUSAKI_ZIP_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KOKYAKU_ID", Me.NullConvertString(.Item("KOKYAKU_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HANBAI_SUURYOU", Me.NullConvertString(.Item("HANBAI_SUURYOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUU_SAKI_NAME", Me.NullConvertString(.Item("SEIKYUU_SAKI_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_DATE2", Me.NullConvertString(.Item("OUTKA_DATE2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUU_ID", Me.NullConvertString(.Item("SEIKYUU_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KAISYUU_SAKI_NAME", Me.NullConvertString(.Item("KAISYUU_SAKI_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_RYAKUSYOU", Me.NullConvertString(.Item("HAISOU_SAKI_RYAKUSYOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUU_KINGAKU", Me.NullConvertString(.Item("SEIKYUU_KINGAKU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HANNBAI_TANNI", Me.NullConvertString(.Item("HANNBAI_TANNI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DOKUGEKIBUTU_KBN", Me.NullConvertString(.Item("DOKUGEKIBUTU_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DOKUGEKIBUTU_KBN_NAME", Me.NullConvertString(.Item("DOKUGEKIBUTU_KBN_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_ADDRESS", Me.NullConvertString(.Item("HAISOU_SAKI_ADDRESS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_TEL_NO", Me.NullConvertString(.Item("HAISOU_SAKI_TEL_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KAISYUU_SAKI_ID", Me.NullConvertString(.Item("KAISYUU_SAKI_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MEISAI_TEXT", Me.NullConvertString(.Item("MEISAI_TEXT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_TODOUFUKEN", Me.NullConvertString(.Item("HAISOU_SAKI_TODOUFUKEN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_SHIKUCHOUSON", Me.NullConvertString(.Item("HAISOU_SAKI_SHIKUCHOUSON")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GYOU_NO", Me.NullConvertString(.Item("GYOU_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_TANTOUSYA", Me.NullConvertString(.Item("HAISOU_SAKI_TANTOUSYA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GAIBU_TEKIYOU", Me.NullConvertString(.Item("GAIBU_TEKIYOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_BUSYO", Me.NullConvertString(.Item("HAISOU_SAKI_BUSYO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_TATEMONO", Me.NullConvertString(.Item("HAISOU_SAKI_TATEMONO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOU_SAKI_FAX", Me.NullConvertString(.Item("HAISOU_SAKI_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAKUSEI_DATE", Me.NullConvertString(.Item("SAKUSEI_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOUKI_SYUBETU", Me.NullConvertString(.Item("YOUKI_SYUBETU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NAIBU_TEKIYOU", Me.NullConvertString(.Item("NAIBU_TEKIYOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@WMS_SYORI_STATUS", Me.NullConvertString(.Item("WMS_SYORI_STATUS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAKUSEI_SYA", Me.NullConvertString(.Item("SAKUSEI_SYA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@WMS_SYORI_NICHIJI", Me.NullConvertString(.Item("WMS_SYORI_NICHIJI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HARAIDASHI_STATUS", Me.NullConvertString(.Item("HARAIDASHI_STATUS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GETUJI_SHIME_DATE", Me.NullConvertString(.Item("GETUJI_SHIME_DATE")), DBDataType.NVARCHAR))
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetGoodsSemiParameter(ByVal semiInfoDr As DataRow, ByVal rcvDtlDt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(rcvDtlDt.Rows(0).Item("HINMOKU_NO")), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC121.SQL_SELECT_M_DEST)
