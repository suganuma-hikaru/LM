...
#Region "H_OUTKAEDI_Mデータ抽出用"
    ...
    Private Const M_DEF_SQL_SELECT_DATA As String = " SELECT                                                             " & vbNewLine _
                                        ...
                                        & ",M_DESTGOODS.GOODS_NM                            AS  DEST_GOODS_NM            " & vbNewLine _
                                        & " FROM                                                                         " & vbNewLine _
...
#End Region
    ...
    '2013.08.30 要望番号2100 追加START
#Region "H_INOUTKAEDI_DTL_DIC_NEW"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DIC）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_INOUTKASAVE_EDI_RCV_DTL_NEW As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_DTL_DIC_NEW SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_INOUTKAEDI_HED_DIC_NEW"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_DIC）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_INOUTKASAVE_EDI_RCV_HED_NEW As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_HED_DIC_NEW SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#If False Then          'UPD 2018/05/21 DTL_NEWで処理する 依頼番号 : 001666   【LMS】【EDI】千葉日立FN_キャンセル修正
    #Region "H_OUTKAEDI_DTL_DIC"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DIC）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DIC SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DIC"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DIC_NEW SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#If False Then          'UPD 2018/05/21 DTL_NEWで処理する 依頼番号 : 001666   【LMS】【EDI】千葉日立FN_キャンセル修正
#Region "H_OUTKAEDI_HED_DIC"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_DIC）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_DIC SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_USER        = @UPD_USER                     " & vbNewLine _
                                              & ",OUTKA_DATE        = @UPD_DATE                     " & vbNewLine _
                                              & ",OUTKA_TIME        = @UPD_TIME                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_DIC"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_DIC_NEW SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_USER        = @UPD_USER                     " & vbNewLine _
                                              & ",OUTKA_DATE        = @UPD_DATE                     " & vbNewLine _
                                              & ",OUTKA_TIME        = @UPD_TIME                     " & vbNewLine _
...
#Region "SQL_SELECT_ENTRY_BEFORE"
    Private Const SQL_SELECT_ENTRY_BEFORE As String = "SELECT           " & vbNewLine _
                                     & "COUNT(*)    AS JIS_CNT         " & vbNewLine _
                                     & "FROM                           " & vbNewLine _
                                     & "$LM_TRN$..H_OUTKAEDI_L L       " & vbNewLine _
                                     & "LEFT JOIN(                     " & vbNewLine _
                                     & "SELECT                         " & vbNewLine _
                                     & "D1.JIS                         " & vbNewLine _
                                     & ",L1.EDI_CTL_NO                 " & vbNewLine _
                                     & "FROM                           " & vbNewLine _
                                     & "$LM_MST$..M_DEST D1            " & vbNewLine _
                                     & "JOIN                           " & vbNewLine _
                                     & "$LM_TRN$..H_OUTKAEDI_L L1      " & vbNewLine _
                                     & "ON                             " & vbNewLine _
                                     & "D1.NRS_BR_CD = L1.NRS_BR_CD    " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "D1.CUST_CD_L = L1.CUST_CD_L    " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "D1.DEST_CD = L1.DEST_CD        " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "RTRIM(L1.DEST_CD) <> ''        " & vbNewLine _
                                     & "WHERE                          " & vbNewLine _
                                     & "D1.SYS_DEL_FLG = '0'           " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "L1.NRS_BR_CD = @NRS_BR_CD      " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "L1.EDI_CTL_NO = @EDI_CTL_NO    " & vbNewLine _
                                     & "UNION                          " & vbNewLine _
                                     & "SELECT                         " & vbNewLine _
                                     & "D2.JIS                         " & vbNewLine _
                                     & ",L2.EDI_CTL_NO                 " & vbNewLine _
                                     & "FROM                           " & vbNewLine _
                                     & "$LM_MST$..M_DEST D2            " & vbNewLine _
                                     & "JOIN                           " & vbNewLine _
                                     & "$LM_TRN$..H_OUTKAEDI_L L2      " & vbNewLine _
                                     & "ON                             " & vbNewLine _
                                     & "D2.NRS_BR_CD = L2.NRS_BR_CD    " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "D2.CUST_CD_L = L2.CUST_CD_L    " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "D2.EDI_CD = L2.EDI_DEST_CD     " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "RTRIM(L2.DEST_CD) = ''         " & vbNewLine _
                                     & "WHERE                          " & vbNewLine _
                                     & "D2.SYS_DEL_FLG = '0'           " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "L2.NRS_BR_CD = @NRS_BR_CD      " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "L2.EDI_CTL_NO = @EDI_CTL_NO    " & vbNewLine _
                                     & ")D                             " & vbNewLine _
                                     & "ON                             " & vbNewLine _
                                     & "L.EDI_CTL_NO = D.EDI_CTL_NO    " & vbNewLine _
                                     & "WHERE                          " & vbNewLine _
                                     & "(L.DEST_JIS_CD <> 'XXXX'       " & vbNewLine _
                                     & "OR                             " & vbNewLine _
                                     & "D.JIS IS NOT NULL)             " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "L.NRS_BR_CD = @NRS_BR_CD      " & vbNewLine _
                                     & "AND                            " & vbNewLine _
                                     & "L.EDI_CTL_NO = @EDI_CTL_NO     " & vbNewLine
...
#Region "SELECT_C_OUTKA_L（オーダー番号重複チェック）"
    Private Const SQL_SELECT_C_OUTKA_L As String = " SELECT                                       " & vbNewLine _
                                     ...
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_L.DEST_CD = @DEST_CD                             " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_L.OUTKA_PLAN_DATE = @OUTKA_PLAN_DATE             " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_M.GOODS_CD_NRS = @NRS_GOODS_CD                   " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_M.IRIME = @IRIME                                 " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_M.LOT_NO = @LOT_NO                               " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_M.OUTKA_TTL_NB = @OUTKA_TTL_NB                   " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_M.OUTKA_TTL_QT = @OUTKA_TTL_QT                   " & vbNewLine

    Private Const SQL_SELECT_CUST_ORD_NO As String = " AND                                        " & vbNewLine _
                                     & " C_OUTKA_L.CUST_ORD_NO = @CUST_ORD_NO                     " & vbNewLine

    Private Const SQL_SELECT_CUST_ORD_NO_DTL As String = " AND                                        " & vbNewLine _
                                     & " C_OUTKA_M.CUST_ORD_NO_DTL = @CUST_ORD_NO                     " & vbNewLine
...
#Region "SELECT_C_OUTKA_L（オーダー番号重複チェック）"
    Private Const SQL_SELECT_H_INOUTKAEDI_HED_DIC_NEW As String = " SELECT                                       " & vbNewLine _
                                     & " COUNT(*)                               AS HED_DIC_NEW_CNT" & vbNewLine _
                                     & " FROM                                                     " & vbNewLine _
                                     & "    $LM_TRN$..H_INOUTKAEDI_HED_DIC_NEW  HED_DIC_NEW      " & vbNewLine _
                                     & " WHERE                                                    " & vbNewLine _
                                     & "     HED_DIC_NEW.SYS_DEL_FLG = '0'                        " & vbNewLine _
                                     & " AND HED_DIC_NEW.DEL_KB      = '0'                        " & vbNewLine _
                                     & " AND HED_DIC_NEW.NRS_BR_CD   = @NRS_BR_CD                 " & vbNewLine _
                                     & " AND HED_DIC_NEW.CUST_CD_L   = @CUST_CD_L                 " & vbNewLine _
                                     & " AND HED_DIC_NEW.CUST_CD_M   = @CUST_CD_M                 " & vbNewLine _
                                     & " AND HED_DIC_NEW.DENPYO_NO   = @CUST_ORD_NO               " & vbNewLine _
                                     & " AND HED_DIC_NEW.OUTKA_CTL_NO <> 'C00000000'              " & vbNewLine
...
#Region "M_DEST(INSERT)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_DIC As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
    ...
    ''' <summary>
    ''' 届先マスタINSERT文：群馬用（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_DIC_GNM As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#Region "M_DEST(UPDATE)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_DIC As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
    ...
    ''' <summary>
    ''' 届先マスタUPDATE文：群馬用（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_DIC_GNM As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
...
#Region "届先振分"
    ...
    Private Const SQL_SELECT_DIVIDE_DEST As String _
        = " SELECT DD.NRS_BR_CD       AS NRS_BR_CD                  " & vbNewLine _
        & "      , DD.CUST_CD_L       AS CUST_CD_L                  " & vbNewLine _
        & "      , DD.CUST_CD_M       AS CUST_CD_M                  " & vbNewLine _
        & "      , DD.DEST_CD_WMS     AS DEST_CD_WMS                " & vbNewLine _
        & "      , DD.UNSO_ATT        AS UNSO_ATT                   " & vbNewLine _
        & "      , DD.DEST_CD         AS DIVIDE_DEST_CD             " & vbNewLine _
        & "      , MDD.ZIP            AS DIVIDE_ZIP                 " & vbNewLine _
        & "      , MDD.JIS            AS DIVIDE_JIS                 " & vbNewLine _
        & "      , MDD.TEL            AS DIVIDE_TEL                 " & vbNewLine _
        & "      , MDD.BIN_KB         AS DIVIDE_BIN_KB              " & vbNewLine _
        & "      , MDD.DEST_NM        AS DIVIDE_DEST_NM             " & vbNewLine _
        & "      , MDD.KANA_NM        AS DIVIDE_KANA_NM             " & vbNewLine _
        & "      , MDD.AD_1           AS DIVIDE_AD_1                " & vbNewLine _
        & "      , MDD.AD_2           AS DIVIDE_AD_2                " & vbNewLine _
        & "      , MDD.AD_3           AS DIVIDE_AD_3                " & vbNewLine _
        & "   FROM $LM_MST$..M_DEST_DIVIDE_WMS_DIC AS DD            " & vbNewLine _
        & "   LEFT JOIN                                             " & vbNewLine _
        & "        $LM_MST$..M_DEST AS MD  -- 変換元                " & vbNewLine _
        & "     ON MD.NRS_BR_CD   = DD.NRS_BR_CD                    " & vbNewLine _
        & "    AND MD.CUST_CD_L   = DD.CUST_CD_L                    " & vbNewLine _
        & "    AND MD.DEST_CD     = DD.DEST_CD_WMS                  " & vbNewLine _
        & "    AND MD.SYS_DEL_FLG = DD.SYS_DEL_FLG                  " & vbNewLine _
        & "   LEFT JOIN                                             " & vbNewLine _
        & "        $LM_MST$..M_DEST AS MDD -- 変換先                " & vbNewLine _
        & "     ON MDD.NRS_BR_CD   = DD.NRS_BR_CD                   " & vbNewLine _
        & "    AND MDD.CUST_CD_L   = DD.CUST_CD_L                   " & vbNewLine _
        & "    AND MDD.DEST_CD     = DD.DEST_CD                     " & vbNewLine _
        & "    AND MDD.SYS_DEL_FLG = DD.SYS_DEL_FLG                 " & vbNewLine _
        & "  WHERE MD.NRS_BR_CD       IS NOT NULL                   " & vbNewLine _
        & "    AND MDD.NRS_BR_CD      IS NOT NULL                   " & vbNewLine _
        & "    AND DD.SYS_DEL_FLG     = '0'                         " & vbNewLine _
        & "    AND DD.CUST_CD_L       = @CUST_CD_L                  " & vbNewLine _
        & "    AND DD.CUST_CD_M       = @CUST_CD_M                  " & vbNewLine _
        & "    AND DD.NRS_BR_CD       = @NRS_BR_CD                  " & vbNewLine _
        & "    AND DD.DEST_CD_WMS     = @DEST_CD_WMS                " & vbNewLine

    Private Const SQL_SELECT_DIVIDE_DEST_WHERE_ADD As String _
        = "    AND DD.UNSO_ATT     = @UNSO_ATT             " & vbNewLine

    Private Const SQL_INSERT_M_DEST_DIVIDE_WMS_DIC As String _
        = "INSERT INTO $LM_MST$..M_DEST_DIVIDE_WMS_DIC   " & vbNewLine _
        & "          ( NRS_BR_CD                          " & vbNewLine _
        & "          , CUST_CD_L                          " & vbNewLine _
        & "          , CUST_CD_M                          " & vbNewLine _
        & "          , DEST_CD_WMS                        " & vbNewLine _
    ...
    ''' <remarks></remarks>
    Class COLUMN_NM
        Public Const UNSO_ATT As String = "UNSO_ATT"
        Public Const DEST_CD As String = "DEST_CD"
        Public Const DEST_CD_WMS As String = "DEST_CD_WMS"
        Public Const EDI_DEST_CD As String = "EDI_DEST_CD"
        Public Const DIVIDE_DEST_CD As String = "DIVIDE_DEST_CD"
        Public Const DEST_NM As String = "DEST_NM"
        Public Const DEST_JIS_CD As String = "DEST_JIS_CD"
        Public Const DEST_TEL As String = "DEST_TEL"
        Public Const DEST_AD_1 As String = "DEST_AD_1"
        Public Const DEST_AD_2 As String = "DEST_AD_2"
        Public Const DEST_AD_3 As String = "DEST_AD_3"
        Public Const DEST_AD_4 As String = "DEST_AD_4"
        ...
        Public Const DIVIDE_ZIP As String = "DIVIDE_ZIP"
        Public Const DIVIDE_JIS As String = "DIVIDE_JIS"
        Public Const DIVIDE_DEST_NM As String = "DIVIDE_DEST_NM"
        Public Const DIVIDE_KANA_NM As String = "DIVIDE_KANA_NM"
        Public Const DIVIDE_TEL As String = "DIVIDE_TEL"
        Public Const DIVIDE_AD_1 As String = "DIVIDE_AD_1"
        Public Const DIVIDE_AD_2 As String = "DIVIDE_AD_2"
        Public Const DIVIDE_AD_3 As String = "DIVIDE_AD_3"
        Public Const DIVIDE_BIN_KB As String = "DIVIDE_BIN_KB"

        Public Const AD_1 As String = "AD_1"
        Public Const AD_2 As String = "AD_2"
        Public Const AD_3 As String = "AD_3"
        Public Const ZIP As String = "ZIP"
        Public Const TEL As String = "TEL"
        Public Const JIS As String = "JIS"
        Public Const KANA_NM As String = "KANA_NM"
        Public Const BIN_KB As String = "BIN_KB"
        Public Const UNSO_CD As String = "UNSO_CD"
        Public Const UNSO_BR_CD As String = "UNSO_BR_CD"
        Public Const SP_NHS_KB As String = "SP_NHS_KB"
        Public Const COA_YN As String = "COA_YN"
        Public Const PICK_KB As String = "PICK_KB"
    End Class

    Class M_DEST_COL_NM
        Public Const AD_1 As String = COLUMN_NM.AD_1
        Public Const AD_2 As String = COLUMN_NM.AD_2
        Public Const AD_3 As String = COLUMN_NM.AD_3
        Public Const ZIP As String = COLUMN_NM.ZIP
        Public Const TEL As String = COLUMN_NM.TEL
        Public Const JIS As String = COLUMN_NM.JIS
        Public Const KANA_NM As String = COLUMN_NM.KANA_NM
        Public Const DEST_NM As String = COLUMN_NM.DEST_NM
        Public Const DEST_CD As String = COLUMN_NM.DEST_CD
        Public Const BIN_KB As String = COLUMN_NM.BIN_KB
    End Class
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Class DIVIDE_DEST_COL_NM
        Public Const NRS_BR_CD As String = COLUMN_NM.NRS_BR_CD
        Public Const CUST_CD_L As String = COLUMN_NM.CUST_CD_L
        Public Const CUST_CD_M As String = COLUMN_NM.CUST_CD_M
        Public Const DEST_CD_WMS As String = COLUMN_NM.DEST_CD_WMS
        Public Const UNSO_ATT As String = COLUMN_NM.UNSO_ATT
        Public Const DIVIDE_DEST_CD As String = COLUMN_NM.DIVIDE_DEST_CD
        Public Const DIVIDE_DEST_NM As String = COLUMN_NM.DIVIDE_DEST_NM
        Public Const DIVIDE_KANA_NM As String = COLUMN_NM.DIVIDE_KANA_NM
        Public Const DIVIDE_JIS As String = COLUMN_NM.DIVIDE_JIS
        Public Const DIVIDE_BIN_KB As String = COLUMN_NM.DIVIDE_BIN_KB
        Public Const DIVIDE_ZIP As String = COLUMN_NM.DIVIDE_ZIP
        Public Const DIVIDE_TEL As String = COLUMN_NM.DIVIDE_TEL
        Public Const DIVIDE_AD_1 As String = COLUMN_NM.DIVIDE_AD_1
        Public Const DIVIDE_AD_2 As String = COLUMN_NM.DIVIDE_AD_2
        Public Const DIVIDE_AD_3 As String = COLUMN_NM.DIVIDE_AD_3
    End Class
    ...
    ''' <remarks></remarks>
    Class TABLE_NM
        Public Const LMH030_OUTKAEDI_L As String = "LMH030_OUTKAEDI_L"
        Public Const LMH030OUT_DIVIDE_DEST As String = "LMH030OUT_DIVIDE_DEST"
    End Class
    ...
    ''' <remarks></remarks>
    Class FUNCTION_NM
        Public Const SelectDataMdest As String = "SelectDataMdest"
        Public Const SelectDivideDestByDestCd As String = "SelectDivideDestByDestCd"
        Public Const SelectDivideDestByDestCdAndUnsoAtt As String = "SelectDivideDestByDestCdAndUnsoAtt"
        Public Const InsertDivideDestData As String = "InsertDivideDestData"
    End Class
#End Region
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC205.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC205.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "SelectEdiM", cmd)
        ...
        map.Add("DEST_GOODS_NM", "DEST_GOODS_NM")
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNcgoMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC205.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC205.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "SelectDataNcgoMdest", cmd)
...
#Region "登録前の事前チェック"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>登録前の事前チェック</remarks>
    Private Function EntryBeforeCheck(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC205.SQL_SELECT_ENTRY_BEFORE)
        ...
        'パラメータ設定
        Call Me.EntryBeforeParameterL(dt)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "EntryBeforeCheck", cmd)
        ...
        '処理件数の設定
        reader.Read()
        MyBase.SetResultCount(Convert.ToInt32(reader("JIS_CNT")))
        reader.Close()
        Return ds
    End Function
...
#Region "出荷(大)データ(オーダー番号チェック用)"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC205.SQL_SELECT_C_OUTKA_L)
        ...
        Select Case custIndex
            Case LMH030DAC.EdiCustIndex.DicGnm00039_00 _
               , LMH030DAC.EdiCustIndex.DicGnm00072_00 _
               , LMH030DAC.EdiCustIndex.DicGnm00076_00
                '上記の荷主は、荷主注文番号を(中)レベルでチェックする
                Me._StrSql.Append(LMH030DAC205.SQL_SELECT_CUST_ORD_NO_DTL)
            Case Else
                '上記以外の荷主は、荷主注文番号を(大)レベルでチェックする
                Me._StrSql.Append(LMH030DAC205.SQL_SELECT_CUST_ORD_NO)
        End Select
        'ディック（群馬）追加箇所 20120711 terakawa End
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterL(dt)
        Call Me.SetOutkaParameterM(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "SelectDataOrderCheck", cmd)
...
#Region "出荷(大)データ(オーダー番号チェック用千葉版)"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>オーダー番号重複チェック千葉版</remarks>
    Private Function SelectOrderCheckDataChiba(ByVal ds As DataSet) As DataSet
        Dim custIndex As Integer = Convert.ToInt32(ds.Tables("LMH030INOUT").Rows(0).Item("EDI_CUST_INDEX"))
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC205.SQL_SELECT_H_INOUTKAEDI_HED_DIC_NEW)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterChiba(dt)
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me.NullConvertString(dtInOut.Rows(0).Item("CUST_ORD_NO")), DBDataType.NVARCHAR))
        ...
        '処理件数の設定
        reader.Read()
        MyBase.SetResultCount(Convert.ToInt32(reader("HED_DIC_NEW_CNT")))
        reader.Close()
        Return ds
    End Function
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC205.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC205.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        '要望番号1458:(DIC群馬：速度UP) 2012/09/21 修正START(DIC群馬は排他条件を含まない)
        Dim custIndex As Integer = Convert.ToInt32(ds.Tables("LMH030INOUT").Rows(0).Item("EDI_CUST_INDEX"))

        '2013.08.30 要望番号2100 日立FN対応　修正START
        'イベント種別の判断
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                ...
                Select Case custIndex
                    ...
                    '（群馬）ディック物流群馬トートタンク
                    '（岩槻）ディック物流春日部
                    Case LMH030DAC.EdiCustIndex.DicOsk00010_00 _
                        , LMH030DAC.EdiCustIndex.DicGnm00072_00 _
                        , LMH030DAC.EdiCustIndex.DicGnm00076_00 _
                        , LMH030DAC.EdiCustIndex.DicItk00899_00 _
                        , LMH030DAC.EdiCustIndex.DicItk10001_00 _
                        , LMH030DAC.EdiCustIndex.DicItk10002_00 _
                        , LMH030DAC.EdiCustIndex.DicItk10007_00 _
                        , LMH030DAC.EdiCustIndex.DicItk10008_00 _
                        , LMH030DAC.EdiCustIndex.DicChb00010_00
#If False Then          'UPD 2018/05/21 HED_NEWで処理する 依頼番号 : 001666   【LMS】【EDI】千葉日立FN_キャンセル修正
                        If ds.Tables("LMH030INOUT").Rows(0)("HITACHI_SAP_FLG").ToString().Equals("1") = True Then
                            setSql = LMH030DAC205.SQL_UPDATE_INOUTKASAVE_EDI_RCV_HED_NEW
                        Else
                            setSql = LMH030DAC205.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED
                        End If
...
#End If
        ...
        End Select
        '2013.08.30 要望番号2100 日立FN対応　修正END
        ...
        Select Case custIndex
            Case LMH030DAC.EdiCustIndex.DicGnm00039_00 _
               ...
               , LMH030DAC.EdiCustIndex.DicChb00010_00
                'SQL文のコンパイル
                '(DIC群馬は排他条件を含まないで更新処理)
                cmd = MyBase.CreateSqlCommand(Me.SetSchemaNm(setSql, Me._Row.Item("NRS_BR_CD").ToString()))

            Case Else
                'SQL文のコンパイル
                cmd = MyBase.CreateSqlCommand(Me.SetSchemaNm(String.Concat(setSql, SQL_COM_UPDATE_CONDITION) _
                                                                               , Me._Row.Item("NRS_BR_CD").ToString()))
        End Select
        '要望番号1458:(DIC群馬：速度UP) 2012/09/21 修正END(DIC群馬は排他条件を含まない)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateEdiRcvHedData", cmd)
...
#If False Then          'UPD 2018/05/21 DTL_NEWで処理する 依頼番号 : 001666   【LMS】【EDI】千葉日立FN_キャンセル修正
                        If ds.Tables("LMH030INOUT").Rows(0)("HITACHI_SAP_FLG").ToString().Equals("1") = True Then
                            setSql = LMH030DAC205.SQL_UPDATE_INOUTKASAVE_EDI_RCV_DTL_NEW
                        Else
                            setSql = LMH030DAC205.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                        End If
...
#End If
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC205.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC205.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC205.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        '（群馬）ディック物流群馬
        Select Case custIndex
            Case LMH030DAC.EdiCustIndex.DicGnm00072_00 _
               , LMH030DAC.EdiCustIndex.DicGnm00076_00
                '上記の荷主は、カナ名も更新する
                setSql = SQL_UPDATE_M_DEST_DIC_GNM
            Case Else

                setSql = SQL_UPDATE_M_DEST_DIC
        End Select
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC205.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC205.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC205", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC205.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC205", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC205.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC205.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC205", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC205.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC205", "InsertUnchinData", cmd)
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        Select Case custIndex
            Case LMH030DAC.EdiCustIndex.DicGnm00072_00 _
               , LMH030DAC.EdiCustIndex.DicGnm00076_00
                '上記の荷主は、カナ名も更新する
                setSql = LMH030DAC205.SQL_INSERT_M_DEST_DIC_GNM
            Case Else
                setSql = LMH030DAC205.SQL_INSERT_M_DEST_DIC
        End Select
        '要望番号:1330 terakawa 2012.08.10 End
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "InsertMDestData", cmd)
...
#Region "出荷パラメータ設定(オーダー番号チェック用)"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterL(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD", Me.NullConvertString(dt.Rows(0).Item("DEST_CD")), DBDataType.NVARCHAR))
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterM(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_GOODS_CD", dt.Rows(0).Item("NRS_GOODS_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@IRIME", Me.NullConvertString(dt.Rows(0).Item("IRIME")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO", dt.Rows(0).Item("LOT_NO"), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_NB", Me.NullConvertString(dt.Rows(0).Item("OUTKA_TTL_NB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_QT", Me.NullConvertString(dt.Rows(0).Item("OUTKA_TTL_QT")), DBDataType.NVARCHAR))
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterChiba(ByVal dt As DataTable)
...
#Region "出荷パラメータ設定(事前チェック用)"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub EntryBeforeParameterL(ByVal dt As DataTable)
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        '2012.03.27 SQL不具合対応START(SQLタイムアウトによる型変更　VARCHAR→CHAR)
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", dt.Rows(0).Item("EDI_CTL_NO"), DBDataType.CHAR))
        '2012.03.27 SQL不具合対応END
    End Sub
...
#Region "届先マスタ更新パラメータ設定(日本合成化学専用)"
    ...
    Private Sub SetMdestUpdateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@KANA_NM", Me.NullConvertString(.Item("KANA_NM")), DBDataType.NVARCHAR))
...
#Region "届先マスタ自動追加用パラメータ設定(ディック専用)"
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC205.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "SelectDataMdestOutkaToroku", cmd)
...
#End Region
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectDivideDestByDestCd(ByVal ds As DataSet) As DataSet
        Return Me.SelectDivideDest(ds, False)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectDivideDestByDestCdAndUnsoAtt(ByVal ds As DataSet) As DataSet
        Return Me.SelectDivideDest(ds, True)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectDivideDest(ByVal ds As DataSet, ByVal isFilterUnsoAtt As Boolean) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        Dim inRow As DataRow = ds.Tables(TABLE_NM.LMH030_OUTKAEDI_L).Rows(0)

        'INTableの条件rowの格納
        Me._Row = inRow

        'SQL作成
        Me._StrSql.Append(SQL_SELECT_DIVIDE_DEST)

        If (isFilterUnsoAtt) Then
            Me._StrSql.Append(SQL_SELECT_DIVIDE_DEST_WHERE_ADD)
        End If

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", inRow.Item(COLUMN_NM.NRS_BR_CD), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", inRow.Item(COLUMN_NM.CUST_CD_L), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", inRow.Item(COLUMN_NM.CUST_CD_M), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD_WMS", inRow.Item(COLUMN_NM.DEST_CD), DBDataType.NVARCHAR))

        If (isFilterUnsoAtt) Then
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_ATT", inRow.Item(COLUMN_NM.UNSO_ATT), DBDataType.NVARCHAR))
        End If

        'スキーマ設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), Me._Row.Item(COLUMN_NM.NRS_BR_CD).ToString())
        ...
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(sql)
            ...
            Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
                ...
                If (reader.HasRows()) Then
                    ...
                    Dim map As Hashtable = New Hashtable()
                    For Each item As String In New String() {
                        DIVIDE_DEST_COL_NM.NRS_BR_CD,
                        DIVIDE_DEST_COL_NM.CUST_CD_L,
                        DIVIDE_DEST_COL_NM.CUST_CD_M,
                        DIVIDE_DEST_COL_NM.DEST_CD_WMS,
                        DIVIDE_DEST_COL_NM.UNSO_ATT,
                        DIVIDE_DEST_COL_NM.DIVIDE_DEST_CD,
                        DIVIDE_DEST_COL_NM.DIVIDE_DEST_NM,
                        DIVIDE_DEST_COL_NM.DIVIDE_KANA_NM,
                        DIVIDE_DEST_COL_NM.DIVIDE_JIS,
                        DIVIDE_DEST_COL_NM.DIVIDE_ZIP,
                        DIVIDE_DEST_COL_NM.DIVIDE_TEL,
                        DIVIDE_DEST_COL_NM.DIVIDE_BIN_KB,
                        DIVIDE_DEST_COL_NM.DIVIDE_AD_1,
                        DIVIDE_DEST_COL_NM.DIVIDE_AD_2,
                        DIVIDE_DEST_COL_NM.DIVIDE_AD_3
                        }
                        map.Add(item, item)
                    Next
                    ...
                    ds = MyBase.SetSelectResultToDataSet(map _
                                                       , ds _
                                                       , reader _
                                                       , TABLE_NM.LMH030OUT_DIVIDE_DEST)

                    selectCount = ds.Tables(TABLE_NM.LMH030OUT_DIVIDE_DEST).Rows.Count

                End If

                MyBase.SetResultCount(selectCount)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function InsertDivideDestData(ByVal ds As DataSet) As DataSet

        Dim sql As String = SQL_INSERT_M_DEST_DIVIDE_WMS_DIC

        'INTableの条件rowの格納
        Dim inRow As DataRow = ds.Tables(TABLE_NM.LMH030OUT_DIVIDE_DEST).Rows(0)

        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", inRow.Item(DIVIDE_DEST_COL_NM.NRS_BR_CD), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", inRow.Item(DIVIDE_DEST_COL_NM.CUST_CD_L), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", inRow.Item(DIVIDE_DEST_COL_NM.CUST_CD_M), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD_WMS", inRow.Item(DIVIDE_DEST_COL_NM.DEST_CD_WMS), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_ATT", inRow.Item(DIVIDE_DEST_COL_NM.UNSO_ATT), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD", inRow.Item(DIVIDE_DEST_COL_NM.DIVIDE_DEST_CD), DBDataType.NVARCHAR))
        ...
        'SQL文のコンパイル
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(sql _
                                                                       , inRow.Item(COLUMN_NM.NRS_BR_CD).ToString()))
            ...
            'SQLの発行
            insertCount = MyBase.GetInsertResult(cmd)

        End Using

        MyBase.SetResultCount(insertCount)
...
#Region "休日マスタ取得"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectCountMHol(ByVal ds As DataSet) As DataSet

        Const SQL_SEL_CNT_M_HOL As String = _
              "SELECT COUNT(*) AS CNT    " & vbNewLine _
            & "  FROM $LM_MST$..M_HOL    " & vbNewLine _
            & " WHERE HOL = @DATE        " & vbNewLine _
            & "   AND SYS_DEL_FLG = '0'  "

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_M_HOL_IN")
        ...
        'SQL作成
        Me._StrSql.Append(SQL_SEL_CNT_M_HOL)      'SQL構築
        ...
        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me._Row("NRS_BR_CD").ToString(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATE", Me._Row("DATE").ToString(), DBDataType.CHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC205", "SelectCountMHol", cmd)
