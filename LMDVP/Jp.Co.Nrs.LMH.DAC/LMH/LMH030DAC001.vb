...
#Region "H_OUTKAEDI_DTL_SNK"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_SNK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_SNK SET       " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "UNSO_L"
    ...
    Private Const SQL_INSERT_UNSO_L As String = "INSERT INTO $LM_TRN$..F_UNSO_L" & vbNewLine _
                                              ...
                                              & "--'2012.11.13 センコー対応 追加START" & vbNewLine _
                                              & ",MAIN_DELI_KB                 " & vbNewLine _
                                              & "--'2012.11.13 センコー対応 追加END" & vbNewLine _
                                              & " )SELECT                      " & vbNewLine _
                                              & " @NRS_BR_CD                   " & vbNewLine _
                                              & ",@UNSO_NO_L                   " & vbNewLine _
                                              & ",@YUSO_BR_CD                  " & vbNewLine _
...
#Region "M_DEST INSERT(センコーは自動追加を行う為使用予定)"

    ''' <summary>
    ''' 届先マスタINSERT文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_SNK As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#End Region
    ...
    'センコー　修正箇所START　仕掛中
#Region "M_DEST UPDATE(届先項目差異有りの場合)(センコーは自動更新を行う為使用予定)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_SNK As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "H_SENDOUTEDI_SNK SELECT句"

    Private Const SQL_SELECT_SNK_SEND_DATA As String = "SELECT                                                          " & vbNewLine _
                                          & " '0'                                          AS DEL_KB                    " & vbNewLine _
                                          & ",DTL_SNK.CRT_DATE                             AS RCV_CRT_DATE              " & vbNewLine _
                                          & ",DTL_SNK.FILE_NAME                            AS FILE_NAME                 " & vbNewLine _
                                          & ",DTL_SNK.REC_NO                               AS REC_NO                    " & vbNewLine _
                                          & ",DTL_SNK.NRS_BR_CD                            AS NRS_BR_CD                 " & vbNewLine _
                                          & ",DTL_SNK.EDI_CTL_NO                           AS EDI_CTL_NO                " & vbNewLine _
                                          & ",DTL_SNK.EDI_CTL_NO_CHU                       AS EDI_CTL_NO_CHU            " & vbNewLine _
                                          & ",DTL_SNK.OUTKA_CTL_NO                         AS OUTKA_CTL_NO              " & vbNewLine _
                                          & ",DTL_SNK.OUTKA_CTL_NO_CHU                     AS OUTKA_CTL_NO_CHU          " & vbNewLine _
                                          & ",DTL_SNK.CUST_CD_L                            AS CUST_CD_L                 " & vbNewLine _
                                          & ",DTL_SNK.CUST_CD_M                            AS CUST_CD_M                 " & vbNewLine _
                                          & ",DTL_SNK.CUST_CD_L                            AS CUST_CD_L                 " & vbNewLine _
                                          & ",DTL_SNK.CUST_CD_M                            AS CUST_CD_M                 " & vbNewLine _
                                          & ",DTL_SNK.PRTFLG                               AS PRTFLG                    " & vbNewLine _
                                          & ",DTL_SNK.DATA_CRT_DTTM                        AS DATA_CRT_DTTM             " & vbNewLine _
                                          & ",DTL_SNK.OUTKA_SIJI_ID                        AS OUTKA_SIJI_ID             " & vbNewLine _
                                          & ",DTL_SNK.SENKO_EIGYO_CD                       AS SENKO_EIGYO_CD            " & vbNewLine _
                                          & ",DTL_SNK.SENKO_CUST_CD                        AS SENKO_CUST_CD             " & vbNewLine _
                                          & ",DTL_SNK.KITAKUSYA_CD                         AS KITAKUSYA_CD              " & vbNewLine _
                                          & ",DTL_SNK.OUTKO_NO1                            AS OUTKO_NO1                 " & vbNewLine _
                                          & ",DTL_SNK.OUTKO_NO2                            AS OUTKO_NO2                 " & vbNewLine _
                                          & ",DTL_SNK.SAIHO                                AS SAIHO                     " & vbNewLine _
                                          & ",DTL_SNK.YUSYUTU_KB                           AS YUSYUTU_KB                " & vbNewLine _
                                          & ",DTL_SNK.KANRI_KB1                            AS KANRI_KB1                 " & vbNewLine _
                                          & ",DTL_SNK.KANRI_KB2                            AS KANRI_KB2                 " & vbNewLine _
                                          & ",DTL_SNK.KITAKUSYA_NM                         AS KITAKUSYA_NM              " & vbNewLine _
                                          & ",DTL_SNK.SENKO_CRT_DATE                       AS SENKO_CRT_DATE            " & vbNewLine _
                                          & ",DTL_SNK.SASIZU_DATE                          AS SASIZU_DATE               " & vbNewLine _
                                          & ",DTL_SNK.OUTKO_DATE                           AS OUTKO_DATE                " & vbNewLine _
                                          & ",DTL_SNK.NOUKI_DATE                           AS NOUKI_DATE                " & vbNewLine _
                                          & ",DTL_SNK.OUTKA_SIJI_DATE                      AS OUTKA_SIJI_DATE           " & vbNewLine _
                                          & ",DTL_SNK.NOUHIN_SITEI_DATE                    AS NOUHIN_SITEI_DATE         " & vbNewLine _
                                          & ",DTL_SNK.HINMEI_CD                            AS HINMEI_CD                 " & vbNewLine _
                                          & ",DTL_SNK.HINMEI_NM                            AS HINMEI_NM                 " & vbNewLine _
                                          & ",DTL_SNK.HINSYU_CD                            AS HINSYU_CD                 " & vbNewLine _
                                          & ",DTL_SNK.IRISU                                AS IRISU                     " & vbNewLine _
                                          & ",DTL_SNK.IRISU_UT                             AS IRISU_UT                  " & vbNewLine _
                                          & ",DTL_SNK.NISUGATA                             AS NISUGATA                  " & vbNewLine _
                                          & ",DTL_SNK.LOT1_SITEI_KB                        AS LOT1_SITEI_KB             " & vbNewLine _
                                          & ",DTL_SNK.LOT1                                 AS LOT1                      " & vbNewLine _
                                          & ",DTL_SNK.LOT2_SITEI_KB                        AS LOT2_SITEI_KB             " & vbNewLine _
                                          & ",DTL_SNK.LOT2                                 AS LOT2                      " & vbNewLine _
                                          & ",DTL_SNK.SIJI_KOSU                            AS SIJI_KOSU                 " & vbNewLine _
                                          & ",DTL_SNK.SIJI_SURYO                           AS SIJI_SURYO                " & vbNewLine _
                                          & ",DTL_SNK.KOSU                                 AS KOSU                      " & vbNewLine _
                                          & ",DTL_SNK.SURYO                                AS SURYO                     " & vbNewLine _
                                          & ",DTL_SNK.WT                                   AS WT                        " & vbNewLine _
                                          & ",DTL_SNK.SUM_WT                               AS SUM_WT                    " & vbNewLine _
                                          & ",DTL_SNK.SIKIRI_CD                            AS SIKIRI_CD                 " & vbNewLine _
                                          & ",DTL_SNK.SIJI_NO                              AS SIJI_NO                   " & vbNewLine _
                                          & ",DTL_SNK.SEIRI_NO                             AS SEIRI_NO                  " & vbNewLine _
                                          & ",DTL_SNK.YAKUJYO_NO                           AS YAKUJYO_NO                " & vbNewLine _
                                          & ",DTL_SNK.CYUMON_NO                            AS CYUMON_NO                 " & vbNewLine _
                                          & ",DTL_SNK.JYUCYU_NO                            AS JYUCYU_NO                 " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_CD                         AS OKURISAKI_CD              " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_CHIKU_CD                   AS OKURISAKI_CHIKU_CD        " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_ZIP_CD                     AS OKURISAKI_ZIP_CD          " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_NM1                        AS OKURISAKI_NM1             " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_NM2                        AS OKURISAKI_NM2             " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_NM3                        AS OKURISAKI_NM3             " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_AD1                        AS OKURISAKI_AD1             " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_AD2                        AS OKURISAKI_AD2             " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_TEL                        AS OKURISAKI_TEL             " & vbNewLine _
                                          & ",DTL_SNK.OKURISAKI_FAX                        AS OKURISAKI_FAX             " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_CD                      AS TORIHIKISAKI_CD           " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_CHIKU_CD                AS TORIHIKISAKI_CHIKU_CD     " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_ZIP_CD                  AS TORIHIKISAKI_ZIP_CD       " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_NM                      AS TORIHIKISAKI_NM           " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_AD1                     AS TORIHIKISAKI_AD1          " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_AD2                     AS TORIHIKISAKI_AD2          " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_TEL                     AS TORIHIKISAKI_TEL          " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_FAX                     AS TORIHIKISAKI_FAX          " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_ROUTE                   AS TORIHIKISAKI_ROUTE        " & vbNewLine _
                                          & ",DTL_SNK.TORIHIKISAKI_ROUTE_NM                AS TORIHIKISAKI_ROUTE_NM     " & vbNewLine _
                                          & ",DTL_SNK.KITUKESAKI_CD                        AS KITUKESAKI_CD             " & vbNewLine _
                                          & ",DTL_SNK.TUTUKESAKI_NM                        AS TUTUKESAKI_NM             " & vbNewLine _
                                          & ",DTL_SNK.OUTKA_TANTO                          AS OUTKA_TANTO               " & vbNewLine _
                                          & ",DTL_SNK.TANTO_NM                             AS TANTO_NM                  " & vbNewLine _
                                          & ",DTL_SNK.KIJI_1                               AS KIJI_1                    " & vbNewLine _
                                          & ",DTL_SNK.KIJI_2                               AS KIJI_2                    " & vbNewLine _
                                          & ",DTL_SNK.KIJI_3                               AS KIJI_3                    " & vbNewLine _
                                          & ",DTL_SNK.HAISYA_KIJI                          AS HAISYA_KIJI               " & vbNewLine _
                                          & ",DTL_SNK.SIMUKECHI                            AS SIMUKECHI                 " & vbNewLine _
                                          & ",DTL_SNK.YUSOU_KB1                            AS YUSOU_KB1                 " & vbNewLine _
                                          & ",DTL_SNK.NOUNYUSAKI_BUMON_NM                  AS NOUNYUSAKI_BUMON_NM       " & vbNewLine _
                                          & ",DTL_SNK.NOUNYUSAKI_AD1                       AS NOUNYUSAKI_AD1            " & vbNewLine _
                                          & ",DTL_SNK.NOUNYUSAKI_AD2                       AS NOUNYUSAKI_AD2            " & vbNewLine _
                                          & ",DTL_SNK.NOUNYUSAKI_AD3                       AS NOUNYUSAKI_AD3            " & vbNewLine _
                                          & ",DTL_SNK.NOUNYUSAKI_TEL                       AS NOUNYUSAKI_TEL            " & vbNewLine _
                                          & ",DTL_SNK.NOUNYU_RENRAKUSAKI_TEL               AS NOUNYU_RENRAKUSAKI_TEL    " & vbNewLine _
                                          & ",DTL_SNK.BUNSEKIHYO_KB                        AS BUNSEKIHYO_KB             " & vbNewLine _
                                          & ",DTL_SNK.HOUKISEI_KB                          AS HOUKISEI_KB               " & vbNewLine _
                                          & ",DTL_SNK.BUTURYU_BIKO                         AS BUTURYU_BIKO              " & vbNewLine _
                                          & ",UNSO_LL.TRIP_NO                              AS HAISYA_NO                 " & vbNewLine _
                                          & ",SUBSTRING(VCLE.CAR_NO,1,10)                  AS GOUSYA_NO                 " & vbNewLine _
                                          & ",VCLE.LOAD_WT                                 AS SYAHUKU                   " & vbNewLine _
                                          & ",DTL_SNK.KANSEN_HAITATU_KB                    AS KANSEN_HAITATU_KB         " & vbNewLine _
                                          & ",DTL_SNK.SEIKYU_WT_KB                         AS SEIKYU_WT_KB              " & vbNewLine _
                                          & ",'2'                                          AS JISSEKI_SHORI_FLG         " & vbNewLine

#End Region

#Region "H_SENDOUTEDI_SNK FROM句"

    Private Const SQL_FROM_SNK_SEND_DATA As String = "FROM                                                              " & vbNewLine _
                                          & "$LM_TRN$..H_OUTKAEDI_DTL_SNK DTL_SNK                                       " & vbNewLine _
                                          & "LEFT JOIN $LM_TRN$..H_OUTKAEDI_L OUT_L                                     " & vbNewLine _
                                          & "  ON  OUT_L.SYS_DEL_FLG = '0'                                              " & vbNewLine _
                                          & "  AND OUT_L.NRS_BR_CD = DTL_SNK.NRS_BR_CD                                    " & vbNewLine _
                                          & "  AND OUT_L.EDI_CTL_NO = DTL_SNK.EDI_CTL_NO                                  " & vbNewLine _
                                          & " LEFT JOIN $LM_TRN$..F_UNSO_L  UNSO_L                                      " & vbNewLine _
                                          & "  ON  UNSO_L.SYS_DEL_FLG = '0'                                             " & vbNewLine _
                                          & "  AND UNSO_L.NRS_BR_CD = OUT_L.NRS_BR_CD                                   " & vbNewLine _
                                          & "  AND UNSO_L.UNSO_NO_L = SUBSTRING(OUT_L.FREE_C30,4,9)                    " & vbNewLine _
                                          & " LEFT JOIN $LM_TRN$..F_UNSO_LL  UNSO_LL                                    " & vbNewLine _
                                          & "  ON  UNSO_LL.SYS_DEL_FLG = '0'                                            " & vbNewLine _
                                          & "  AND UNSO_LL.NRS_BR_CD = UNSO_L.NRS_BR_CD                                 " & vbNewLine _
                                          & "  AND UNSO_LL.TRIP_NO = UNSO_L.TRIP_NO                                     " & vbNewLine _
                                          & " LEFT JOIN $LM_MST$..M_VCLE  VCLE                                          " & vbNewLine _
                                          & "  ON VCLE.CAR_KEY = UNSO_LL.CAR_KEY                                        " & vbNewLine _
                                          & " WHERE  DTL_SNK.DEL_KB <> '1'                                              " & vbNewLine _
                                          & " AND DTL_SNK.NRS_BR_CD = @NRS_BR_CD                                        " & vbNewLine _
                                          & " AND DTL_SNK.EDI_CTL_NO = @EDI_CTL_NO                                      " & vbNewLine _
                                          & " AND DTL_SNK.JISSEKI_SHORI_FLG = '1'                                       " & vbNewLine
...
#Region "H_SENDOUTEDI_SNK"

    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_SNK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_SNK As String = "INSERT INTO         " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_SNK     " & vbNewLine _
                                         & "(                              " & vbNewLine _
                                         & " DEL_KB                        " & vbNewLine _
                                         & ",RCV_CRT_DATE                  " & vbNewLine _
                                         ...
                                         & ",CUST_CD_M                     " & vbNewLine _
                                         & ",PRTFLG                        " & vbNewLine _
                                         & ",DATA_CRT_DTTM                 " & vbNewLine _
                                         & ",OUTKA_SIJI_ID                 " & vbNewLine _
                                         & ",SENKO_EIGYO_CD                " & vbNewLine _
                                         & ",SENKO_CUST_CD                 " & vbNewLine _
                                         & ",KITAKUSYA_CD                  " & vbNewLine _
                                         & ",OUTKO_NO1                     " & vbNewLine _
                                         & ",OUTKO_NO2                     " & vbNewLine _
                                         & ",SAIHO                         " & vbNewLine _
                                         & ",YUSYUTU_KB                    " & vbNewLine _
                                         & ",KANRI_KB1                     " & vbNewLine _
                                         & ",KANRI_KB2                     " & vbNewLine _
                                         & ",KITAKUSYA_NM                  " & vbNewLine _
                                         & ",SENKO_CRT_DATE                " & vbNewLine _
                                         & ",SASIZU_DATE                   " & vbNewLine _
                                         & ",OUTKO_DATE                    " & vbNewLine _
                                         & ",NOUKI_DATE                    " & vbNewLine _
                                         & ",OUTKA_SIJI_DATE               " & vbNewLine _
                                         & ",NOUHIN_SITEI_DATE             " & vbNewLine _
                                         & ",HINMEI_CD                     " & vbNewLine _
                                         & ",HINMEI_NM                     " & vbNewLine _
                                         & ",HINSYU_CD                     " & vbNewLine _
                                         & ",IRISU                         " & vbNewLine _
                                         & ",IRISU_UT                      " & vbNewLine _
                                         & ",NISUGATA                      " & vbNewLine _
                                         & ",LOT1_SITEI_KB                 " & vbNewLine _
                                         & ",LOT1                          " & vbNewLine _
                                         & ",LOT2_SITEI_KB                 " & vbNewLine _
                                         & ",LOT2                          " & vbNewLine _
                                         & ",SIJI_KOSU                     " & vbNewLine _
                                         & ",SIJI_SURYO                    " & vbNewLine _
                                         & ",KOSU                          " & vbNewLine _
                                         & ",SURYO                         " & vbNewLine _
                                         & ",WT                            " & vbNewLine _
                                         & ",SUM_WT                        " & vbNewLine _
                                         & ",SIKIRI_CD                     " & vbNewLine _
                                         & ",SIJI_NO                       " & vbNewLine _
                                         & ",SEIRI_NO                      " & vbNewLine _
                                         & ",YAKUJYO_NO                    " & vbNewLine _
                                         & ",CYUMON_NO                     " & vbNewLine _
                                         & ",JYUCYU_NO                     " & vbNewLine _
                                         & ",OKURISAKI_CD                  " & vbNewLine _
                                         & ",OKURISAKI_CHIKU_CD            " & vbNewLine _
                                         & ",OKURISAKI_ZIP_CD              " & vbNewLine _
                                         & ",OKURISAKI_NM1                 " & vbNewLine _
                                         & ",OKURISAKI_NM2                 " & vbNewLine _
                                         & ",OKURISAKI_NM3                 " & vbNewLine _
                                         & ",OKURISAKI_AD1                 " & vbNewLine _
                                         & ",OKURISAKI_AD2                 " & vbNewLine _
                                         & ",OKURISAKI_TEL                 " & vbNewLine _
                                         & ",OKURISAKI_FAX                 " & vbNewLine _
                                         & ",TORIHIKISAKI_CD               " & vbNewLine _
                                         & ",TORIHIKISAKI_CHIKU_CD         " & vbNewLine _
                                         & ",TORIHIKISAKI_ZIP_CD           " & vbNewLine _
                                         & ",TORIHIKISAKI_NM               " & vbNewLine _
                                         & ",TORIHIKISAKI_AD1              " & vbNewLine _
                                         & ",TORIHIKISAKI_AD2              " & vbNewLine _
                                         & ",TORIHIKISAKI_TEL              " & vbNewLine _
                                         & ",TORIHIKISAKI_FAX              " & vbNewLine _
                                         & ",TORIHIKISAKI_ROUTE            " & vbNewLine _
                                         & ",TORIHIKISAKI_ROUTE_NM         " & vbNewLine _
                                         & ",KITUKESAKI_CD                 " & vbNewLine _
                                         & ",TUTUKESAKI_NM                 " & vbNewLine _
                                         & ",OUTKA_TANTO                   " & vbNewLine _
                                         & ",TANTO_NM                      " & vbNewLine _
                                         & ",KIJI_1                        " & vbNewLine _
                                         & ",KIJI_2                        " & vbNewLine _
                                         & ",KIJI_3                        " & vbNewLine _
                                         & ",HAISYA_KIJI                   " & vbNewLine _
                                         & ",SIMUKECHI                     " & vbNewLine _
                                         & ",YUSOU_KB1                     " & vbNewLine _
                                         & ",NOUNYUSAKI_BUMON_NM           " & vbNewLine _
                                         & ",NOUNYUSAKI_AD1                " & vbNewLine _
                                         & ",NOUNYUSAKI_AD2                " & vbNewLine _
                                         & ",NOUNYUSAKI_AD3                " & vbNewLine _
                                         & ",NOUNYUSAKI_TEL                " & vbNewLine _
                                         & ",NOUNYU_RENRAKUSAKI_TEL        " & vbNewLine _
                                         & ",BUNSEKIHYO_KB                 " & vbNewLine _
                                         & ",HOUKISEI_KB                   " & vbNewLine _
                                         & ",BUTURYU_BIKO                  " & vbNewLine _
                                         & ",HAISYA_NO                     " & vbNewLine _
                                         & ",GOUSYA_NO                     " & vbNewLine _
                                         & ",SYAHUKU                       " & vbNewLine _
                                         & ",KANSEN_HAITATU_KB             " & vbNewLine _
                                         & ",SEIKYU_WT_KB                  " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_SNK"
    ...
    ''' <summary>
    ''' センコーEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_SNK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_SNK SET       " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC001.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC001.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "SelectEdiM", cmd)
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>センコーEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectSnkEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC001.SQL_SELECT_SNK_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC001.SQL_FROM_SNK_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                   '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "SelectSnkEdiSend", cmd)
        ...
        '取得データの格納先をマッピング
        map.Add("DEL_KB", "DEL_KB")
        map.Add("RCV_CRT_DATE", "RCV_CRT_DATE")
        ...
        map.Add("DATA_CRT_DTTM", "DATA_CRT_DTTM")
        map.Add("OUTKA_SIJI_ID", "OUTKA_SIJI_ID")
        map.Add("SENKO_EIGYO_CD", "SENKO_EIGYO_CD")
        map.Add("SENKO_CUST_CD", "SENKO_CUST_CD")
        map.Add("KITAKUSYA_CD", "KITAKUSYA_CD")
        map.Add("OUTKO_NO1", "OUTKO_NO1")
        map.Add("OUTKO_NO2", "OUTKO_NO2")
        map.Add("SAIHO", "SAIHO")
        map.Add("YUSYUTU_KB", "YUSYUTU_KB")
        map.Add("KANRI_KB1", "KANRI_KB1")
        map.Add("KANRI_KB2", "KANRI_KB2")
        map.Add("KITAKUSYA_NM", "KITAKUSYA_NM")
        map.Add("SENKO_CRT_DATE", "SENKO_CRT_DATE")
        map.Add("SASIZU_DATE", "SASIZU_DATE")
        map.Add("OUTKO_DATE", "OUTKO_DATE")
        map.Add("NOUKI_DATE", "NOUKI_DATE")
        map.Add("OUTKA_SIJI_DATE", "OUTKA_SIJI_DATE")
        map.Add("NOUHIN_SITEI_DATE", "NOUHIN_SITEI_DATE")
        map.Add("HINMEI_CD", "HINMEI_CD")
        map.Add("HINMEI_NM", "HINMEI_NM")
        map.Add("HINSYU_CD", "HINSYU_CD")
        map.Add("IRISU", "IRISU")
        map.Add("IRISU_UT", "IRISU_UT")
        map.Add("NISUGATA", "NISUGATA")
        map.Add("LOT1_SITEI_KB", "LOT1_SITEI_KB")
        map.Add("LOT1", "LOT1")
        map.Add("LOT2_SITEI_KB", "LOT2_SITEI_KB")
        map.Add("LOT2", "LOT2")
        map.Add("SIJI_KOSU", "SIJI_KOSU")
        map.Add("SIJI_SURYO", "SIJI_SURYO")
        map.Add("KOSU", "KOSU")
        map.Add("SURYO", "SURYO")
        map.Add("WT", "WT")
        map.Add("SUM_WT", "SUM_WT")
        map.Add("SIKIRI_CD", "SIKIRI_CD")
        map.Add("SIJI_NO", "SIJI_NO")
        map.Add("SEIRI_NO", "SEIRI_NO")
        map.Add("YAKUJYO_NO", "YAKUJYO_NO")
        map.Add("CYUMON_NO", "CYUMON_NO")
        map.Add("JYUCYU_NO", "JYUCYU_NO")
        map.Add("OKURISAKI_CD", "OKURISAKI_CD")
        map.Add("OKURISAKI_CHIKU_CD", "OKURISAKI_CHIKU_CD")
        map.Add("OKURISAKI_ZIP_CD", "OKURISAKI_ZIP_CD")
        map.Add("OKURISAKI_NM1", "OKURISAKI_NM1")
        map.Add("OKURISAKI_NM2", "OKURISAKI_NM2")
        map.Add("OKURISAKI_NM3", "OKURISAKI_NM3")
        map.Add("OKURISAKI_AD1", "OKURISAKI_AD1")
        map.Add("OKURISAKI_AD2", "OKURISAKI_AD2")
        map.Add("OKURISAKI_TEL", "OKURISAKI_TEL")
        map.Add("OKURISAKI_FAX", "OKURISAKI_FAX")
        map.Add("TORIHIKISAKI_CD", "TORIHIKISAKI_CD")
        map.Add("TORIHIKISAKI_CHIKU_CD", "TORIHIKISAKI_CHIKU_CD")
        map.Add("TORIHIKISAKI_ZIP_CD", "TORIHIKISAKI_ZIP_CD")
        map.Add("TORIHIKISAKI_NM", "TORIHIKISAKI_NM")
        map.Add("TORIHIKISAKI_AD1", "TORIHIKISAKI_AD1")
        map.Add("TORIHIKISAKI_AD2", "TORIHIKISAKI_AD2")
        map.Add("TORIHIKISAKI_TEL", "TORIHIKISAKI_TEL")
        map.Add("TORIHIKISAKI_FAX", "TORIHIKISAKI_FAX")
        map.Add("TORIHIKISAKI_ROUTE", "TORIHIKISAKI_ROUTE")
        map.Add("TORIHIKISAKI_ROUTE_NM", "TORIHIKISAKI_ROUTE_NM")
        map.Add("KITUKESAKI_CD", "KITUKESAKI_CD")
        map.Add("TUTUKESAKI_NM", "TUTUKESAKI_NM")
        map.Add("OUTKA_TANTO", "OUTKA_TANTO")
        map.Add("TANTO_NM", "TANTO_NM")
        map.Add("KIJI_1", "KIJI_1")
        map.Add("KIJI_2", "KIJI_2")
        map.Add("KIJI_3", "KIJI_3")
        map.Add("HAISYA_KIJI", "HAISYA_KIJI")
        map.Add("SIMUKECHI", "SIMUKECHI")
        map.Add("YUSOU_KB1", "YUSOU_KB1")
        map.Add("NOUNYUSAKI_BUMON_NM", "NOUNYUSAKI_BUMON_NM")
        map.Add("NOUNYUSAKI_AD1", "NOUNYUSAKI_AD1")
        map.Add("NOUNYUSAKI_AD2", "NOUNYUSAKI_AD2")
        map.Add("NOUNYUSAKI_AD3", "NOUNYUSAKI_AD3")
        map.Add("NOUNYUSAKI_TEL", "NOUNYUSAKI_TEL")
        map.Add("NOUNYU_RENRAKUSAKI_TEL", "NOUNYU_RENRAKUSAKI_TEL")
        map.Add("BUNSEKIHYO_KB", "BUNSEKIHYO_KB")
        map.Add("HOUKISEI_KB", "HOUKISEI_KB")
        map.Add("BUTURYU_BIKO", "BUTURYU_BIKO")
        map.Add("HAISYA_NO", "HAISYA_NO")
        map.Add("GOUSYA_NO", "GOUSYA_NO")
        map.Add("SYAHUKU", "SYAHUKU")
        map.Add("KANSEN_HAITATU_KB", "KANSEN_HAITATU_KB")
        map.Add("SEIKYU_WT_KB", "SEIKYU_WT_KB")
        map.Add("JISSEKI_SHORI_FLG", "JISSEKI_SHORI_FLG")
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_SNK")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_SNK").Rows.Count())
        reader.Close()
...
#Region "存在チェック(出荷登録用)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataSnkMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC001.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC001.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "SelectDataSnkMdest", cmd)
...
#Region "H_OUTKAEDI_L"
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC001.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC001.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC001.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC001.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC001.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC001.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateEdiRcvDtlData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録(まとめ時)
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC001.SQL_UPDATE_OUTKAL_MATOME

                '    '実績作成SQL CONST名
                'Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                '    setSql = LMH030DAC001.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC001.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC001.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    'センコー　修正箇所START　仕掛中
#Region "M_DEST(センコーは自動更新を行う為、使用予定)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertUnchinData", cmd)
...
#End Region
    ...
    'センコー　修正箇所START　仕掛中
#Region "M_DEST(センコーは自動追加を行う為、使用予定)"

    ''' <summary>
    ''' 届先マスタ新規登録(荷送人コードまたは届先コードを元に新規登録:センコー専用)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_M_DEST_SNK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertMDestData", cmd)
...
#Region "H_SENDINOUTEDI_SNK"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDIセンコー実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertSnkEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_SNK")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC001.SQL_INSERT_H_SENDOUTEDI_SNK _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_SNK").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC001", "InsertSnkEdiSendData", cmd)
...
#Region "運送(大)パラメータ設定"
    ...
    Private Sub SetUnsoLComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            '2012.11.13 センコー対応 追加START
            prmList.Add(MyBase.GetSqlParameter("@MAIN_DELI_KB", .Item("MAIN_DELI_KB").ToString(), DBDataType.CHAR))
            '2012.11.13 センコー対応 追加END
...
#End Region
    ...
    'センコー　修正箇所START　仕掛中
#Region "届先マスタ自動追加用パラメータ設定(センコー専用)"
...
#Region "EDIセンコー送信(TBL)新規登録パラメータ設定"

    ''' <summary>
    ''' EDIセンコー送信(TBL)の新規登録パラメータ設定
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(.Item("DEL_KB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@RCV_CRT_DATE", Me.NullConvertString(.Item("RCV_CRT_DATE")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@DATA_CRT_DTTM", Me.NullConvertString(.Item("DATA_CRT_DTTM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_SIJI_ID", Me.NullConvertString(.Item("OUTKA_SIJI_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SENKO_EIGYO_CD", Me.NullConvertString(.Item("SENKO_EIGYO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SENKO_CUST_CD", Me.NullConvertString(.Item("SENKO_CUST_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KITAKUSYA_CD", Me.NullConvertString(.Item("KITAKUSYA_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKO_NO1", Me.NullConvertString(.Item("OUTKO_NO1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKO_NO2", Me.NullConvertString(.Item("OUTKO_NO2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAIHO", Me.NullConvertString(.Item("SAIHO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YUSYUTU_KB", Me.NullConvertString(.Item("YUSYUTU_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KANRI_KB1", Me.NullConvertString(.Item("KANRI_KB1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KANRI_KB2", Me.NullConvertString(.Item("KANRI_KB2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KITAKUSYA_NM", Me.NullConvertString(.Item("KITAKUSYA_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SENKO_CRT_DATE", Me.NullConvertString(.Item("SENKO_CRT_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SASIZU_DATE", Me.NullConvertZero(.Item("SASIZU_DATE")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKO_DATE", Me.NullConvertZero(.Item("OUTKO_DATE")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NOUKI_DATE", Me.NullConvertZero(.Item("NOUKI_DATE")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_SIJI_DATE", Me.NullConvertZero(.Item("OUTKA_SIJI_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUHIN_SITEI_DATE", Me.NullConvertString(.Item("NOUHIN_SITEI_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMEI_CD", Me.NullConvertString(.Item("HINMEI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMEI_NM", Me.NullConvertString(.Item("HINMEI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINSYU_CD", Me.NullConvertString(.Item("HINSYU_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@IRISU", Me.NullConvertString(.Item("IRISU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@IRISU_UT", Me.NullConvertString(.Item("IRISU_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NISUGATA", Me.NullConvertString(.Item("NISUGATA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT1_SITEI_KB", Me.NullConvertString(.Item("LOT1_SITEI_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT1", Me.NullConvertString(.Item("LOT1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT2_SITEI_KB", Me.NullConvertString(.Item("LOT2_SITEI_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT2", Me.NullConvertString(.Item("LOT2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SIJI_KOSU", Me.NullConvertZero(.Item("SIJI_KOSU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SIJI_SURYO", Me.NullConvertZero(.Item("SIJI_SURYO")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@WT", Me.NullConvertZero(.Item("WT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@SUM_WT", Me.NullConvertZero(.Item("SUM_WT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@SIKIRI_CD", Me.NullConvertString(.Item("SIKIRI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SIJI_NO", Me.NullConvertString(.Item("SIJI_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIRI_NO", Me.NullConvertString(.Item("SEIRI_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YAKUJYO_NO", Me.NullConvertString(.Item("YAKUJYO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CYUMON_NO", Me.NullConvertString(.Item("CYUMON_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@JYUCYU_NO", Me.NullConvertString(.Item("JYUCYU_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_CD", Me.NullConvertString(.Item("OKURISAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_CHIKU_CD", Me.NullConvertString(.Item("OKURISAKI_CHIKU_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_ZIP_CD", Me.NullConvertString(.Item("OKURISAKI_ZIP_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_NM1", Me.NullConvertString(.Item("OKURISAKI_NM1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_NM2", Me.NullConvertString(.Item("OKURISAKI_NM2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_NM3", Me.NullConvertString(.Item("OKURISAKI_NM3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_AD1", Me.NullConvertString(.Item("OKURISAKI_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_AD2", Me.NullConvertString(.Item("OKURISAKI_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_TEL", Me.NullConvertString(.Item("OKURISAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OKURISAKI_FAX", Me.NullConvertString(.Item("OKURISAKI_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_CD", Me.NullConvertString(.Item("TORIHIKISAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_CHIKU_CD", Me.NullConvertString(.Item("TORIHIKISAKI_CHIKU_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_ZIP_CD", Me.NullConvertString(.Item("TORIHIKISAKI_ZIP_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_NM", Me.NullConvertString(.Item("TORIHIKISAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_AD1", Me.NullConvertString(.Item("TORIHIKISAKI_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_AD2", Me.NullConvertString(.Item("TORIHIKISAKI_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_TEL", Me.NullConvertString(.Item("TORIHIKISAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_FAX", Me.NullConvertString(.Item("TORIHIKISAKI_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_ROUTE", Me.NullConvertString(.Item("TORIHIKISAKI_ROUTE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKISAKI_ROUTE_NM", Me.NullConvertString(.Item("TORIHIKISAKI_ROUTE_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KITUKESAKI_CD", Me.NullConvertString(.Item("KITUKESAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TUTUKESAKI_NM", Me.NullConvertString(.Item("TUTUKESAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_TANTO", Me.NullConvertString(.Item("OUTKA_TANTO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TANTO_NM", Me.NullConvertString(.Item("TANTO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KIJI_1", Me.NullConvertString(.Item("KIJI_1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KIJI_2", Me.NullConvertString(.Item("KIJI_2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KIJI_3", Me.NullConvertString(.Item("KIJI_3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISYA_KIJI", Me.NullConvertString(.Item("HAISYA_KIJI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SIMUKECHI", Me.NullConvertString(.Item("SIMUKECHI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YUSOU_KB1", Me.NullConvertString(.Item("YUSOU_KB1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUNYUSAKI_BUMON_NM", Me.NullConvertString(.Item("NOUNYUSAKI_BUMON_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUNYUSAKI_AD1", Me.NullConvertString(.Item("NOUNYUSAKI_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUNYUSAKI_AD2", Me.NullConvertString(.Item("NOUNYUSAKI_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUNYUSAKI_AD3", Me.NullConvertString(.Item("NOUNYUSAKI_AD3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUNYUSAKI_TEL", Me.NullConvertString(.Item("NOUNYUSAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUNYU_RENRAKUSAKI_TEL", Me.NullConvertString(.Item("NOUNYU_RENRAKUSAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BUNSEKIHYO_KB", Me.NullConvertString(.Item("BUNSEKIHYO_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HOUKISEI_KB", Me.NullConvertString(.Item("HOUKISEI_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BUTURYU_BIKO", Me.NullConvertString(.Item("BUTURYU_BIKO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISYA_NO", Me.NullConvertString(.Item("HAISYA_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOUSYA_NO", Me.NullConvertString(.Item("GOUSYA_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYAHUKU", Me.NullConvertString(.Item("SYAHUKU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KANSEN_HAITATU_KB", Me.NullConvertString(.Item("KANSEN_HAITATU_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYU_WT_KB", Me.NullConvertString(.Item("SEIKYU_WT_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(.Item("JISSEKI_SHORI_FLG")), DBDataType.CHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC001.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC001", "SelectDataMdestOutkaToroku", cmd)
