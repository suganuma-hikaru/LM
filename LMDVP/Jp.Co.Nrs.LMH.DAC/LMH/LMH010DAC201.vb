...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND_INKAS As String = " SELECT                                                " & vbNewLine _
                                ...
                                & "  FROM $LM_TRN$..H_INOUTKAEDI_HED_TOHO  HED                               " & vbNewLine _
                                & "  INNER JOIN $LM_TRN$..H_INOUTKAEDI_DTL_TOHO  DTL                         " & vbNewLine _
                                & "  ON                                                                     " & vbNewLine _
                                ...
                                & "  AND                                                                    " & vbNewLine _
                                & "  EDI_M.JISSEKI_FLAG = '0'                                               " & vbNewLine _
...
#End Region
    ...
    '東邦化学追加箇所 20120216 start(INOUT_KB追加）
#Region "RCV_HED(入荷登録)"
    ''' <summary>
    ''' 受信ヘッダ更新
    ''' </summary>
    ...
    Private Const SQL_UPD_RCV_HED As String = "UPDATE                                               " & vbNewLine _
                                              & " $LM_TRN$..H_INOUTKAEDI_HED_TOHO                   " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L       	        " & vbNewLine _
...
#End Region
    '東邦化学追加箇所 20120216 end(INOUT_KB追加）
    '東邦化学追加箇所 20120216 start(INOUT_KB追加）
#Region "RCV_DTL(入荷登録)"
    ''' <summary>
    ''' 受信明細更新
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INOUTKAEDI_DTL_TOHO                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#Region "SEND(実績送信済⇒送信未)"
    ...
    Private Const SQL_UPD_JISSEKIMODOSI_SEND As String = "UPDATE                                    " & vbNewLine _
                                              & "$LM_TRN$..H_SENDINEDI_TOHO                         " & vbNewLine _
                                              & "SET                                                " & vbNewLine _
                                              & " JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG            " & vbNewLine _
                                              & ",SEND_USER         = @SEND_USER                    " & vbNewLine _
                                              & ",SEND_DATE         = @SEND_DATE                    " & vbNewLine _
...
#Region "SEND"
    Private Const SQL_INSERT_SEND As String = "INSERT INTO $LM_TRN$..H_SENDINEDI_TOHO " & vbNewLine _
                                          & "(                               " & vbNewLine _
                                          & " DEL_KB                         " & vbNewLine _
                                          & ",NRS_BR_CD                      " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC201.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC201.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSendFromInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC201.SQL_SELECT_SEND_INKAS)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "SelectSendFromInkaS", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH010_TOHO_JISSEKI_INKAS")
        reader.Close()
    ...
    Private Function SelectSendFromRcv(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC201.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "SelectSendFromRcv", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINEDI_TOHO")
        reader.Close()
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC201.SQL_UPD_INKATOROKU_EDI_L

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC201.SQL_UPD_JISSEKITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC201.SQL_UPD_EDITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC201.SQL_UPD_JISSEKIMODOSI_EDI_L

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC201.SQL_UPD_TOUROKUMI_EDI_L

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC201.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC201.SQL_UPD_INKATOROKU_EDI_M
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC201.SQL_UPD_EDITORIKESI_EDI_M

                '実績作成済⇒実績未、実績送信済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                , LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC201.SQL_UPD_JISSEKIMODOSI_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC201.SQL_UPD_JISSEKISAKUSEI_EDI_M

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC201.SQL_UPD_TOUROKUMI_EDI_M

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC201.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC201.SQL_UPD_RCV_HED

            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC201.SQL_UPD_JISSEKITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC201.SQL_UPD_EDITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC201.SQL_UPD_JISSEKIMODOSI_RCV_HED

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC201.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC201.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "UpdateRcvHed", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC201.SQL_UPDATE_RCV_DTL

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI
                setSql = LMH010DAC201.SQL_UPD_JISSEKITORIKESI_RCV_DTL
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC201.SQL_UPD_EDITORIKESI_RCV_DTL

                '実績作成済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI

                setSql = LMH010DAC201.SQL_UPD_JISSEKIZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒実績未、
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC201.SQL_UPD_SOUSINZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC201.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC201.SQL_UPD_JISSEKISAKUSEI_RCV_DTL

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC201.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "UpdateRcvDtl", cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH010DAC201.SQL_UPDATE_MATOMESAKI_UNSO_L
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH010DAC201.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "UpdateMatomesakiEdiLData", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertInkaS", cmd)
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINEDI_TOHO")
        'INTableの条件rowの格納
        Dim dtRow As DataRow = inTbl.Rows(0)
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_SEND, dtRow.Item("NRS_BR_CD").ToString()))
        Dim eventShubetsu As Integer = Convert.ToInt32(ds.Tables("LMH010_JUDGE").Rows(0)("EVENT_SHUBETSU"))
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC201.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC201", "InsertUnchinData", cmd)
...
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SAKUSEI_DATE", Me.NullConvertString(row.Item("SAKUSEI_DATE")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_DATE", String.Empty, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_TIME", String.Empty, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CRT_USER", MyBase.GetUserID(), DBDataType.CHAR))
