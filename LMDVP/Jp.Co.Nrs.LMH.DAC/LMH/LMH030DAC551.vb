...
#Region "H_OUTKAEDI_DTL_XXX(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",CANCEL_FLG	     " & vbNewLine _
                                        & ",UNSO_CD	     " & vbNewLine _
                                        & ",NINUSHI_CD	     " & vbNewLine _
                                        & ",SHORI_DATE	     " & vbNewLine _
                                        & ",RENBAN	     " & vbNewLine _
                                        & ",SHORI_TIME	     " & vbNewLine _
                                        & ",JUCHU_NO	     " & vbNewLine _
                                        & ",JUCHU_MEI_NO	     " & vbNewLine _
                                        & ",SHUUKA_DATE	     " & vbNewLine _
                                        & ",SHUUKA_TIME_FLG	     " & vbNewLine _
                                        & ",SHUUKA_TEL	     " & vbNewLine _
                                        & ",HAISO_DATE	     " & vbNewLine _
                                        & ",HAISO_TIME_FLG	     " & vbNewLine _
                                        & ",HAISO_TEL	     " & vbNewLine _
                                        & ",HAISO_NM	     " & vbNewLine _
                                        & ",HAISO_ZIP	     " & vbNewLine _
                                        & ",HAISO_AD_1	     " & vbNewLine _
                                        & ",HAISO_AD_2	     " & vbNewLine _
                                        & ",GOODS_CD_1	     " & vbNewLine _
                                        & ",GOODS_CD_2	     " & vbNewLine _
                                        & ",GOODS_NM_1	     " & vbNewLine _
                                        & ",GOODS_NM_2	     " & vbNewLine _
                                        & ",NISUGATA	     " & vbNewLine _
                                        & ",SURYO	     " & vbNewLine _
                                        & ",TAN_I	     " & vbNewLine _
                                        & ",UNSO_TTL_WT	     " & vbNewLine _
                                        & ",UNSU	     " & vbNewLine _
                                        & ",BIKOU	     " & vbNewLine _
                                        & ",CHUBAN	     " & vbNewLine _
                                        & ",OEM_CD	     " & vbNewLine _
                                        & ",CHARTER_FLG	     " & vbNewLine _
                                        & ",UNSU_KETTEI_1	     " & vbNewLine _
                                        & ",UNSU_KETTEI_2	     " & vbNewLine _
                                        & ",UNSU_KETTEI_3	     " & vbNewLine _
                                        & ",DENP_KB	     " & vbNewLine _
                                        & ",UNSO_KAISHA_CD	     " & vbNewLine _
                                        & ",RECORD_STATUS	     " & vbNewLine _
                                        & ",JISSEKI_SHORI_FLG	     " & vbNewLine _
                                        & ",JISSEKI_USER	     " & vbNewLine _
                                        & ",JISSEKI_DATE	     " & vbNewLine _
...
#Region "運送登録処理 更新用SQL"

#Region "H_OUTKAEDI_L(運送出荷登録)"
    ''' <summary>
...
#Region "H_OUTKAEDI_DTL_KTK"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_KTK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_KTK SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "M_DEST(INSERT)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_KTK As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#Region "M_DEST(関塗工専用)UPDATE(届先項目差異有りの場合)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_KTK As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "運送登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC551.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC551.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "SelectEdiM", cmd)
...
#Region "H_OUTKAEDI_L"
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                ...
                setSql = LMH030DAC551.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC551.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                ...
                setSql = LMH030DAC551.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateEdiRcvDtlData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        'パラメータ設定
        Call Me.SetMdestParameter(inTbl)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateMDestData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_M_DEST_KTK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertMDestData", cmd)
...
#Region "EDI出荷(大,中),EDI受信TBL抽出パラメータ設定"
    ...
    ''' </summary>
    ''' <remarks>運送登録時出荷マスタ検索用SQLの構築</remarks>
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetEdiRcvDtlComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@ZIF_DENSYUBETU", Me.NullConvertString(.Item("ZIF_DENSYUBETU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_NYUKABI", Me.NullConvertString(.Item("ZIF_NYUKABI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HARAI", Me.NullConvertString(.Item("ZIF_HARAI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_WVFBSPDNR", Me.NullConvertString(.Item("ZIF_WVFBSPDNR")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_NAME1", Me.NullConvertString(.Item("ZIF_NAME1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYUKASAKI", Me.NullConvertString(.Item("ZIF_SYUKASAKI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TORIHIKI", Me.NullConvertString(.Item("ZIF_TORIHIKI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HYOJYUNNO", Me.NullConvertString(.Item("ZIF_HYOJYUNNO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SEIRI1", Me.NullConvertString(.Item("ZIF_SEIRI1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CANCEL", Me.NullConvertString(.Item("ZIF_CANCEL")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SEIRI2", Me.NullConvertString(.Item("ZIF_SEIRI2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_DENTYPE", Me.NullConvertString(.Item("ZIF_DENTYPE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYUBETU", Me.NullConvertString(.Item("ZIF_SYUBETU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_GYOUMU", Me.NullConvertString(.Item("ZIF_GYOUMU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TAITLEA", Me.NullConvertString(.Item("ZIF_TAITLEA")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TAITLEB", Me.NullConvertString(.Item("ZIF_TAITLEB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_DENNO", Me.NullConvertString(.Item("ZIF_DENNO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TORNAME1", Me.NullConvertString(.Item("ZIF_TORNAME1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TORNAME2", Me.NullConvertString(.Item("ZIF_TORNAME2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKM_K_SHN", Me.NullConvertString(.Item("FKM_K_SHN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SOUHIJYU1", Me.NullConvertString(.Item("ZIF_SOUHIJYU1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZID_OROSIDEP", Me.NullConvertString(.Item("ZID_OROSIDEP")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BIKOU1", Me.NullConvertString(.Item("ZIF_BIKOU1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BIKOU2", Me.NullConvertString(.Item("ZIF_BIKOU2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZID_BSARK", Me.NullConvertString(.Item("ZID_BSARK")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HOUMEN", Me.NullConvertString(.Item("HOUMEN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@XHAISO", Me.NullConvertString(.Item("XHAISO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HAKOUSUMI", Me.NullConvertString(.Item("ZIF_HAKOUSUMI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKM_NNY", Me.NullConvertString(.Item("FKM_NNY")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_ONETIME", Me.NullConvertString(.Item("ZIF_ONETIME")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKM_XHYO", Me.NullConvertString(.Item("FKM_XHYO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_TRSD", Me.NullConvertString(.Item("FXM_TRSD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_LNTRRD", Me.NullConvertString(.Item("FXM_LNTRRD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_NWJKN", Me.NullConvertString(.Item("FXM_NWJKN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_UKWB", Me.NullConvertString(.Item("FXM_UKWB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_LNUKWB", Me.NullConvertString(.Item("FXM_LNUKWB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_KOKNM", Me.NullConvertString(.Item("FXM_KOKNM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_GBHO", Me.NullConvertString(.Item("FXM_GBHO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CYOKU0", Me.NullConvertString(.Item("ZIF_CYOKU0")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CYOKU1", Me.NullConvertString(.Item("ZIF_CYOKU1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CYOKU2", Me.NullConvertString(.Item("ZIF_CYOKU2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CKUB", Me.NullConvertString(.Item("ZIF_CKUB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_VSBED", Me.NullConvertString(.Item("ZIF_VSBED")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BTCSHIP", Me.NullConvertString(.Item("ZIF_BTCSHIP")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SUTETAS", Me.NullConvertString(.Item("ZIF_SUTETAS")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_JYUFUJU", Me.NullConvertString(.Item("ZIF_JYUFUJU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYORIDATE", Me.NullConvertString(.Item("ZIF_SYORIDATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYORITIME", Me.NullConvertString(.Item("ZIF_SYORITIME")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HAKOUDATE", Me.NullConvertString(.Item("ZIF_HAKOUDATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HAKOUTIME", Me.NullConvertString(.Item("ZIF_HAKOUTIME")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@BWART", Me.NullConvertString(.Item("BWART")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@WERKS", Me.NullConvertString(.Item("WERKS")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@LGORT", Me.NullConvertString(.Item("LGORT")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_JULNO", Me.NullConvertString(.Item("ZIF_JULNO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@MATNR", Me.NullConvertString(.Item("MATNR")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_SP_CD", Me.NullConvertString(.Item("FXM_SP_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHO", Me.NullConvertString(.Item("CHO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_CD_THIN", Me.NullConvertString(.Item("FXM_CD_THIN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_GIMU", Me.NullConvertString(.Item("FXM_GIMU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHRG", Me.NullConvertString(.Item("CHRG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@VFDAT", Me.NullConvertString(.Item("VFDAT")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_FUGOU", Me.NullConvertString(.Item("ZIF_FUGOU")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BARAFG", Me.NullConvertString(.Item("ZIF_BARAFG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_UKE", Me.NullConvertString(.Item("ZIF_UKE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_ZAIKOKUBUN", Me.NullConvertString(.Item("ZIF_ZAIKOKUBUN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TEKIYOU1", Me.NullConvertString(.Item("ZIF_TEKIYOU1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TEKIYOU2", Me.NullConvertString(.Item("ZIF_TEKIYOU2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_YOBIKUB1", Me.NullConvertString(.Item("ZIF_YOBIKUB1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_YOBIKUB2", Me.NullConvertString(.Item("ZIF_YOBIKUB2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_YUKOU", Me.NullConvertString(.Item("ZIF_YUKOU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@MAKTX", Me.NullConvertString(.Item("MAKTX")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOUSAKI_CD", Me.NullConvertString(.Item("HAISOUSAKI_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HIN", Me.NullConvertString(.Item("HIN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@T_KBN", Me.NullConvertString(.Item("T_KBN")), DBDataType.CHAR))

            'EDI受信（DTL）共通項目
            prmList.Add(MyBase.GetSqlParameter("@RECORD_STATUS", Me.NullConvertString(.Item("RECORD_STATUS")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@SEND_USER", Me.NullConvertString(.Item("SEND_USER")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@DELETE_USER", Me.NullConvertString(.Item("DELETE_USER")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@PRT_USER", Me.NullConvertString(.Item("PRT_USER")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@EDI_USER", Me.NullConvertString(.Item("EDI_USER")), DBDataType.CHAR))
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_OUTKAEDI_HED_KTK")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC551.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "SelectOutkaEdiRcvCancel", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_HED_KTK_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_HED_KTK_CANCELOUT").Rows.Count())
        reader.Close()
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_KTK")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC551.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC551.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC551.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "SelectDataMgoods", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_HED_KTK_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC551.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC551.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHedCancel As DataTable = ds.Tables("LMH030_HED_KTK_CANCELOUT")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC551.SQL_UPDATE_DEL_OUTKAEDI_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_HED_KTK_CANCELOUT")   'HEDの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC551.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHed As DataTable = setDs.Tables("LMH030_OUTKAEDI_HED_KTK")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_KTK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_KTK")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC551.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_OUTKAEDI_DTL_KTK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC551", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(HED)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvHedParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）共通項目
            prmList.Add(MyBase.GetSqlParameter("@RECORD_STATUS", "", DBDataType.CHAR))

            prmList.Add(MyBase.GetSqlParameter("@DELETE_USER", "", DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@PRT_USER", "", DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_USER", "", DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(.Item("JISSEKI_SHORI_FLG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JISSEKI_USER", "", DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@SEND_USER", "", DBDataType.CHAR))
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@UNSO_CD", Me.NullConvertString(.Item("UNSO_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NINUSHI_CD", Me.NullConvertString(.Item("NINUSHI_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHORI_DATE", Me.NullConvertString(.Item("SHORI_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@RENBAN", Me.NullConvertString(.Item("RENBAN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHORI_TIME", Me.NullConvertString(.Item("SHORI_TIME")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JUCHU_NO", Me.NullConvertString(.Item("JUCHU_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JUCHU_MEI_NO", Me.NullConvertString(.Item("JUCHU_MEI_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHUUKA_DATE", Me.NullConvertString(.Item("SHUUKA_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHUUKA_TIME_FLG", Me.NullConvertString(.Item("SHUUKA_TIME_FLG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHUUKA_TEL", Me.NullConvertString(.Item("SHUUKA_TEL")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_DATE", Me.NullConvertString(.Item("HAISO_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_TIME_FLG", Me.NullConvertString(.Item("HAISO_TIME_FLG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_TEL", Me.NullConvertString(.Item("HAISO_TEL")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_NM", Me.NullConvertString(.Item("HAISO_NM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_ZIP", Me.NullConvertString(.Item("HAISO_ZIP")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_AD_1", Me.NullConvertString(.Item("HAISO_AD_1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_AD_2", Me.NullConvertString(.Item("HAISO_AD_2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CD_1", Me.NullConvertString(.Item("GOODS_CD_1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CD_2", Me.NullConvertString(.Item("GOODS_CD_2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_NM_1", Me.NullConvertString(.Item("GOODS_NM_1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_NM_2", Me.NullConvertString(.Item("GOODS_NM_2")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@TAN_I", Me.NullConvertString(.Item("TAN_I")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSO_TTL_WT", Me.NullConvertString(.Item("UNSO_TTL_WT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@UNSU", Me.NullConvertString(.Item("UNSU")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@BIKOU", Me.NullConvertString(.Item("BIKOU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHUBAN", Me.NullConvertString(.Item("CHUBAN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OEM_CD", Me.NullConvertString(.Item("OEM_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHARTER_FLG", Me.NullConvertString(.Item("CHARTER_FLG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSU_KETTEI_1", Me.NullConvertString(.Item("UNSU_KETTEI_1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSU_KETTEI_2", Me.NullConvertString(.Item("UNSU_KETTEI_2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSU_KETTEI_3", Me.NullConvertString(.Item("UNSU_KETTEI_3")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENP_KB", Me.NullConvertString(.Item("DENP_KB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSO_KAISHA_CD", Me.NullConvertString(.Item("UNSO_KAISHA_CD")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@EDI_USER", MyBase.GetUserID(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
...
#Region "EDI受信(DTL)削除データ抽出パラメータ設定"
    ...
    Private Sub SetSelectOutkaEdiRcvCancel(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(.Item("CUST_CD_M").ToString()), DBDataType.NVARCHAR))
