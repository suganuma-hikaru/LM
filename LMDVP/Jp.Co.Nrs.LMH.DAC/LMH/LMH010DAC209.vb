...
''' <remarks></remarks>
''' 
Public Class LMH010DAC209
    Inherits Jp.Co.Nrs.LM.Base.DAC.LMBaseDAC

#Region "Const"

#Region "H_INKAEDI_DTL_ROM(INSERT)"

    ''' <summary>
    ''' INSERT（H_INKAEDI_DTL_ROM）
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Const SQL_INSERT_INKAEDI_DTL As String = "INSERT INTO      " & vbNewLine _
                                        ...
                                        & " ,GOODS_ISSUE_DATE	            " & vbNewLine _
                                        & " ,OVERALL_PICK_STATUS	    " & vbNewLine _
                                        & " ,MATERIAL	                    " & vbNewLine _
                                        & " ,DESCRIPTION	            " & vbNewLine _
                                        & " ,DERIVERY_QUANTITY	            " & vbNewLine _
                                        & " ,BATCH	                    " & vbNewLine _
                                        & " ,SOLDTO_PARTY	            " & vbNewLine _
                                        & " ,NAME_OF_SOLDTO_PARTY	    " & vbNewLine _
                                        & " ,DERIVERY_DATE	            " & vbNewLine _
                                        & " ,SHIPPNG_POINT	            " & vbNewLine _
                                        & " ,ROUTE	                    " & vbNewLine _
                                        & " ,PURCHASING_DOCUMENT	    " & vbNewLine _
                                        & " ,TOTAL_WEIGHT	            " & vbNewLine _
                                        & " ,PLANT	                    " & vbNewLine _
                                        & " ,TOTAL_GDS_MVT_STAT	            " & vbNewLine _
                                        & " ,SALES_UNIT	                    " & vbNewLine _
                                        & " ,DELIVERY_TYPE	            " & vbNewLine _
                                        & " ,LODING_DATE	            " & vbNewLine _
...
#End Region
    ...
    '2015.04.22 荷姿チェックを行わない為の廃止START
#Region "SELECT_M_GOODS_DETAILS(セミEDI時)"

    Private Const SQL_SELECT_M_GOODS_DETAILS As String _
                    = " SELECT                                                     " & vbNewLine _
                    ...
                    & " ON                                                         " & vbNewLine _
                    & " MGD.NRS_BR_CD      = MG.NRS_BR_CD                          " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " MGD.GOODS_CD_NRS   = MG.GOODS_CD_NRS                       " & vbNewLine _
                    & " WHERE                                                      " & vbNewLine _
                    & " MGD.NRS_BR_CD      = @NRS_BR_CD                            " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " MGD.SUB_KB        = '44'                                   " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
...
#Region "SELECT_M_GOODS_DETAILS(セミEDI時)"
    ...
    Private Const SQL_SELECT_M_GOODS_CNT As String _
                    = " SELECT                                                     " & vbNewLine _
                    & " COUNT(*)                       AS  SET_NAIYO               " & vbNewLine _
                    & " FROM                                                       " & vbNewLine _
                    & " $LM_MST$..M_GOODS              MG                          " & vbNewLine _
                    & " WHERE                                                      " & vbNewLine _
...
#Region "SELECT_Z_KBN(セミEDI時)"
    ...
    Private Const SQL_SELECT_EXTRACTION_ZKBN As String _
                    = " SELECT                                                     " & vbNewLine _
                    & "  KBN_R016.KBN_NM1             AS  KBN_NM1                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM2             AS  KBN_NM2                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM3             AS  KBN_NM3                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM4             AS  KBN_NM4                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM5             AS  KBN_NM5                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM6             AS  KBN_NM6                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM7             AS  KBN_NM7                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM8             AS  KBN_NM8                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM9             AS  KBN_NM9                  " & vbNewLine _
                    & " ,KBN_R016.KBN_NM10            AS  KBN_NM10                 " & vbNewLine _
                    & " ,KBN_R016.VALUE1              AS  VALUE1                   " & vbNewLine _
                    & " ,KBN_R016.VALUE2              AS  VALUE2                   " & vbNewLine _
                    & " ,KBN_R016.VALUE3              AS  VALUE3                   " & vbNewLine _
                    & " FROM                                                       " & vbNewLine _
                    & " $LM_MST$..Z_KBN               KBN_R016                     " & vbNewLine _
                    & " WHERE                                                      " & vbNewLine _
                    & " KBN_R016.KBN_GROUP_CD = 'R016'                             " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_R016.KBN_NM1      = @NRS_BR_CD                         " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_R016.KBN_NM2      = @CUST_CD_L                         " & vbNewLine
...
#Region "H_INKAEDI_L(セミEDI)"
    ...
    Private Function InsertInkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_INKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertInkaEdiL", cmd)
...
#Region "H_INKAEDI_M(セミEDI)"
    ...
    Private Function InsertInkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_INKAEDI_M _
...
#Region "H_INKAEDI_DTL_ROM(セミEDI)"
    ...
    Private Function InsertInkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtInkaEdiRcvDtl As DataTable = setDs.Tables("LMH010_INKAEDI_DTL_ROM")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_INKAEDI_DTL, setDs.Tables("LMH010_INKAEDI_DTL_ROM").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertInkaEdiRcvDtl", cmd)
...
#Region "SELECT_EDI_L"
    ...
    Private Const SQL_SELECT_EDI_L As String = " SELECT                                                  " & vbNewLine _
                                    ...
                                    & "-- --2018/04/12 【LMS】入荷登録_入荷データの保管料課税区分=免税設定(YCC石川) Annen upd start        " & vbNewLine _
                                    & "-- ,CASE WHEN (    H_INKAEDI_L.NRS_BR_CD = '40'                                         " & vbNewLine _
                                    & "--                 AND H_INKAEDI_L.CUST_CD_L = '00003'                                  " & vbNewLine _
                                    & "--                 AND H_INKAEDI_L.CUST_CD_M = '00'                                     " & vbNewLine _
                                    & "--                 AND H_INKAEDI_L.SYS_ENT_DATE = H_INKAEDI_L.SYS_UPD_DATE              " & vbNewLine _
                                    & "--                 AND H_INKAEDI_L.SYS_ENT_TIME = H_INKAEDI_L.SYS_UPD_TIME              " & vbNewLine _
                                    & "--                 ) THEN M_CUST.TAX_KB                                                 " & vbNewLine _
                                    & "--                 ELSE CASE WHEN H_INKAEDI_L.TAX_KB <> '' THEN H_INKAEDI_L.TAX_KB      " & vbNewLine _
                                    & "--                 ELSE '01'                                                            " & vbNewLine _
                                    & "--                 END                                                                  " & vbNewLine _
                                    ...
                                    & "      ELSE '01'                                                   " & vbNewLine _
                                    & " END                                     AS TAX_KB                " & vbNewLine _
                                    & "-- --2018/04/12 【LMS】入荷登録_入荷データの保管料課税区分=免税設定(YCC石川) Annen upd end          " & vbNewLine _
...
#Region "SELECT_EDI_M"
    ...
    Private Const SQL_SELECT_EDI_M As String = " SELECT                                                  " & vbNewLine _
                                   ...
                                   & ",Z_KBN.KBN_NM2                           AS FREE_C01               " & vbNewLine _
                                   ...
                                   & " ON  Z_KBN.KBN_GROUP_CD = 'T025'                                      " & vbNewLine _
                                   & " AND H_INKAEDI_M.FREE_C01  = Z_KBN.KBN_NM1                         " & vbNewLine _
                                   & " WHERE                                                             " & vbNewLine _
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH010_INKAEDI_DTL_ROM")
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC209.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH010DAC209.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH010DAC209.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "SelectDataMgoods", cmd)
...
#Region "商品明細マスタ→荷姿チェック廃止で商品マスタに切り替え(セミEDI：荷主商品コードより抽出)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function CheckGoodsDetails(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        'Me._StrSql.Append(LMH010DAC209.SQL_SELECT_M_GOODS_DETAILS)
        Me._StrSql.Append(LMH010DAC209.SQL_SELECT_M_GOODS_CNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "CheckGoodsDetails", cmd)
...
#Region "区分マスタ(セミEDI：EXCELデータ抽出条件)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataExtraction(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC209.SQL_SELECT_EXTRACTION_ZKBN)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetSelectkbnParameter(drSemiEdiInfo)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "SelectDataExtraction", cmd)
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_ROM                       " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
...
#End Region
    ...
    '2019/01/29 ADD START 要望管理004404
#Region "区分マスタ取得（ローム横浜用）"

    ''' <summary>
    ''' 税区分の区分コードを区分名2をキーに取得（ローム横浜用）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_ZEI_KBN_CD_FOR_ROME As String = _
          "SELECT KBN1.KBN_CD AS ZEI_KBN_CD1  " & vbNewLine _
        & "      ,KBN2.KBN_CD AS ZEI_KBN_CD2  " & vbNewLine _
        & "  FROM $LM_MST$..Z_KBN  KBN1       " & vbNewLine _
        & " INNER JOIN $LM_MST$..Z_KBN  KBN2  " & vbNewLine _
        & "    ON KBN2.KBN_GROUP_CD = 'Z001'  " & vbNewLine _
        & "   AND KBN2.KBN_NM2 = '2'          " & vbNewLine _
        & "   AND KBN2.SYS_DEL_FLG = '0'      " & vbNewLine _
        & " WHERE KBN1.KBN_GROUP_CD = 'Z001'  " & vbNewLine _
        & "   AND KBN1.KBN_NM2 = '1'          " & vbNewLine _
        & "   AND KBN1.SYS_DEL_FLG = '0'      " & vbNewLine

#End Region
    '2019/01/29 ADD END   要望管理004404
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC209.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC209.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "SelectEdiM", cmd)
...
#Region "EDI受信(DTL)新規追加パラメータ設定"
    ...
    Private Sub SetInsertInkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@GOODS_ISSUE_DATE", Me.NullConvertString(.Item("GOODS_ISSUE_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OVERALL_PICK_STATUS", Me.NullConvertString(.Item("OVERALL_PICK_STATUS")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@SOLDTO_PARTY", Me.NullConvertString(.Item("SOLDTO_PARTY")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NAME_OF_SOLDTO_PARTY", Me.NullConvertString(.Item("NAME_OF_SOLDTO_PARTY")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DERIVERY_DATE", Me.NullConvertString(.Item("DERIVERY_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHIPPNG_POINT", Me.NullConvertString(.Item("SHIPPNG_POINT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ROUTE", Me.NullConvertString(.Item("ROUTE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PURCHASING_DOCUMENT", Me.NullConvertString(.Item("PURCHASING_DOCUMENT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOTAL_WEIGHT", Me.NullConvertString(.Item("TOTAL_WEIGHT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@PLANT", Me.NullConvertString(.Item("PLANT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOTAL_GDS_MVT_STAT", Me.NullConvertString(.Item("TOTAL_GDS_MVT_STAT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SALES_UNIT", Me.NullConvertString(.Item("SALES_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_TYPE", Me.NullConvertString(.Item("DELIVERY_TYPE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LODING_DATE", Me.NullConvertString(.Item("LODING_DATE")), DBDataType.CHAR))
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC209.SQL_UPD_INKATOROKU_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC209.SQL_UPD_INKATOROKU_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "UpdateEdiM", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC209.SQL_UPDATE_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertInkaS", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC209.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC209", "InsertUnchinData", cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH010DAC209.SQL_UPDATE_MATOMESAKI_UNSO_L
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH010DAC209.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "UpdateMatomesakiEdiLData", cmd)
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectChkGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", dtRcvDtl.Rows(0).Item("COLUMN_4").ToString().Substring(3), DBDataType.NVARCHAR))
...
#Region "区分マスタパラメータ設定(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectkbnParameter(ByVal semiInfoDr As DataRow)
...
#Region "マッピング配列作成"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetMapSendTermo() As Hashtable
        ...
        map.Add("CUST_CD_L", "CUST_CD_L")
        map.Add("CUST_CD_M", "CUST_CD_M")
        map.Add("ACCEPTANCE_ID", "ACCEPTANCE_ID")
        map.Add("OPERATING_UNIT_ALT_NAME", "OPERATING_UNIT_ALT_NAME")
        map.Add("PROCESS_CTG", "PROCESS_CTG")
        map.Add("RCV_TRX_TYPE", "RCV_TRX_TYPE")
        map.Add("TO_ORGANIZATION_CODE", "TO_ORGANIZATION_CODE")
        map.Add("TO_SUBINVENTORY_CODE", "TO_SUBINVENTORY_CODE")
        map.Add("PACKING_STYLE", "PACKING_STYLE")
        map.Add("ITEM_CODE", "ITEM_CODE")
        map.Add("SCHEDULE_RECEIVE_QTY", "SCHEDULE_RECEIVE_QTY")
        map.Add("SCHEDULE_SHIP_DATE", "SCHEDULE_SHIP_DATE")
        map.Add("RECEIVE_DATE", "RECEIVE_DATE")
        map.Add("VENDOR_CODE", "VENDOR_CODE")
        map.Add("CUSTOMER_CODE", "CUSTOMER_CODE")
        map.Add("FROM_ORGANIZATION_CODE", "FROM_ORGANIZATION_CODE")
        map.Add("LOT_NUM", "LOT_NUM")
        map.Add("LOT_EXPIRATION_DATE", "LOT_EXPIRATION_DATE")
        map.Add("FIFO_NUM", "FIFO_NUM")
        map.Add("SERIAL_NUM", "SERIAL_NUM")
        map.Add("MANUFACTURE_DATE", "MANUFACTURE_DATE")
        map.Add("CUSTOMER_PO_NUM", "CUSTOMER_PO_NUM")
        map.Add("SHIP_TO_NAME", "SHIP_TO_NAME")
        map.Add("CHUMON_NUM", "CHUMON_NUM")
        map.Add("CASE_FROM", "CASE_FROM")
        map.Add("CASE_TO", "CASE_TO")
        map.Add("CASE_NO_SEQ", "CASE_NO_SEQ")
        map.Add("KANRI_LOT_NUM", "KANRI_LOT_NUM")
        map.Add("ITEM_TYPE_CODE", "ITEM_TYPE_CODE")
        map.Add("HASU_ID", "HASU_ID")
...
#Region "区分マスタ取得（ローム横浜用）"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectZeiKbnCdForRome(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH010_SEMIEDI_INFO")
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC209.SQL_SELECT_ZEI_KBN_CD_FOR_ROME)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC209", "SelectZeiKbnCdForRome", cmd)
        ...
        '取得データの格納先をマッピング
        map.Add("ZEI_KBN_CD1", "ZEI_KBN_CD1")
        map.Add("ZEI_KBN_CD2", "ZEI_KBN_CD2")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH010_ZEI_KBN_ROME")
        reader.Close()
