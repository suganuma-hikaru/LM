...
'  EDI荷主ID　　　　:  108　　　 : 旭化成ケミカルズ(千葉)　コピー元202（ダウケミ）
'  作  成  者       :  honmyo
' ==========================================================================
Imports System.Text
...
#Region "H_OUTKAEDI_DTL_ASH"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_ASH）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_ASH SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_ASH"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_ASH）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_ASH SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#End Region
    ...
    '#Region "M_DEST INSERT(旭化成ケミカルズは自動追加がない為使用しない)"
    ...
    '#Region "M_DEST UPDATE(届先項目差異有りの場合)(旭化成ケミカルズは自動更新がない為使用しない)"
    '    ''' <summary>
    '    ''' 届先マスタUPDATE文（M_DEST）
    '    ''' </summary>
    '    ''' <remarks></remarks>
...
#Region "H_SENDOUTEDI_ASH SELECT句"

    Private Const SQL_SELECT_ASH_SEND_DATA As String = "SELECT                                                  " & vbNewLine _
                                          & " '0'                                       AS  DEL_KB	            " & vbNewLine _
                                          ...
                                          & ",EDI_M.OUTKA_CTL_NO       		            AS  OUTKA_CTL_NO       	" & vbNewLine _
                                          & ",EDI_M.OUTKA_CTL_NO_CHU       	            AS  OUTKA_CTL_NO_CHU    " & vbNewLine _
                                          & ",'001'       	                            AS  OUTKA_CTL_NO_SHO    " & vbNewLine _
                                          & ",HED_ASH.SASHIZU_NO       			        AS  SASHIZU_NO       	" & vbNewLine _
                                          & ",'0'        		                        AS  TORIHIKI_KB       	" & vbNewLine _
                                          & ",HED_ASH.SHUKKA_DATE       		        AS  SHUKKO_DATE       	" & vbNewLine _
                                          & ",'047'         				            AS  SOUKO       		" & vbNewLine _
                                          & ",DTL_ASH.GYO       			            AS  OUTKA_NO       		" & vbNewLine _
                                          & ",DTL_ASH.KANRI_SURYO       		        AS  KANRI_SURYO       	" & vbNewLine _
                                          & ",DTL_ASH.NISUGATA_SURYO       		        AS  NISUGATA_SURYO      " & vbNewLine _
                                          & ",DTL_ASH.LOT_NO       				        AS  LOT_NO       		" & vbNewLine _
                                          & ",'  '       		                        AS  INKO_HOKOKU_KB      " & vbNewLine _
                                          & ",'   '       			                    AS  UNCHIN_CD       	" & vbNewLine _
                                          & ",DTL_ASH.KANRI_KB       			        AS  KANRI_KB       		" & vbNewLine _
                                          & ",DTL_ASH.HINMEI       				        AS  HINMEI       		" & vbNewLine _
                                          & ",'       '       				            AS  YOBI       			" & vbNewLine _
                                          & ",'2'      	                                AS  JISSEKI_SHORI_FLG   " & vbNewLine

#End Region

#Region "H_SENDOUTEDI_ASH FROM句"

    Private Const SQL_FROM_ASH_SEND_DATA As String = "FROM                                                      " & vbNewLine _
                                          & "$LM_TRN$..H_OUTKAEDI_M EDI_M                                       " & vbNewLine _
                                          & "INNER JOIN $LM_TRN$..H_OUTKAEDI_HED_ASH HED_ASH                    " & vbNewLine _
                                          & " ON  HED_ASH.DEL_KB            <> '1'                              " & vbNewLine _
                                          & " AND HED_ASH.NRS_BR_CD         = EDI_M.NRS_BR_CD                   " & vbNewLine _
                                          & " AND HED_ASH.EDI_CTL_NO        = EDI_M.EDI_CTL_NO                  " & vbNewLine _
                                          & "INNER JOIN $LM_TRN$..H_OUTKAEDI_DTL_ASH DTL_ASH                    " & vbNewLine _
                                          & " ON  DTL_ASH.DEL_KB            <> '1'                              " & vbNewLine _
                                          & " AND DTL_ASH.NRS_BR_CD         = EDI_M.NRS_BR_CD                   " & vbNewLine _
                                          & " AND DTL_ASH.EDI_CTL_NO        = EDI_M.EDI_CTL_NO                  " & vbNewLine _
                                          & " AND DTL_ASH.EDI_CTL_NO_CHU    = EDI_M.EDI_CTL_NO_CHU              " & vbNewLine _
                                          & " AND DTL_ASH.JISSEKI_SHORI_FLG = '1'                               " & vbNewLine _
                                          ...
                                          & " ,EDI_M.OUTKA_CTL_NO                                               " & vbNewLine _
                                          & " ,EDI_M.OUTKA_CTL_NO_CHU                                           " & vbNewLine _
                                          & " ,HED_ASH.SASHIZU_NO                                               " & vbNewLine _
                                          & " ,HED_ASH.SHUKKA_DATE                                              " & vbNewLine _
                                          & " ,DTL_ASH.GYO                                                      " & vbNewLine _
                                          & " ,DTL_ASH.KANRI_SURYO                                              " & vbNewLine _
                                          & " ,DTL_ASH.NISUGATA_SURYO                                           " & vbNewLine _
                                          & " ,DTL_ASH.LOT_NO                                                   " & vbNewLine _
                                          & " ,DTL_ASH.KANRI_KB                                                 " & vbNewLine _
                                          & " ,DTL_ASH.HINMEI                                                   " & vbNewLine
...
#Region "H_SENDOUTEDI_ASH"

    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_ASH）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_ASH As String = "INSERT INTO     " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_ASH     " & vbNewLine _
                                         & "(                                " & vbNewLine _
                                         & "  DEL_KB       					" & vbNewLine _
                                         & " ,NRS_BR_CD       				" & vbNewLine _
                                         ...
                                         & " ,SASHIZU_NO       				" & vbNewLine _
                                         & " ,TORIHIKI_KB       			" & vbNewLine _
                                         & " ,SHUKKO_DATE       			" & vbNewLine _
                                         & " ,SOUKO       					" & vbNewLine _
                                         & " ,OUTKA_NO       				" & vbNewLine _
                                         & " ,KANRI_SURYO       			" & vbNewLine _
                                         & " ,NISUGATA_SURYO       			" & vbNewLine _
                                         & " ,LOT_NO       					" & vbNewLine _
                                         & " ,INKO_HOKOKU_KB       			" & vbNewLine _
                                         & " ,UNCHIN_CD       				" & vbNewLine _
                                         & " ,KANRI_KB       				" & vbNewLine _
                                         & " ,HINMEI       					" & vbNewLine _
                                         & " ,YOBI       					" & vbNewLine _
...
#Region "H_OUTKAEDI_HED_ASH"
    ''' <summary>
    ''' 旭化成ケミカルズEDI受信HEDのUPDATE文（H_OUTKAEDI_HED_ASH）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_ASH SET   " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_ASH"
    ...
    ''' <summary>
    ''' 旭化成ケミカルズEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_ASH）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_ASH SET       " & vbNewLine _
...
#Region "実績作成処理 同一まとめ番号データ取得用SQL"
    ...
    ''' 同一まとめ番号データ取得用SQL
    ''' </summary>
    ''' <remarks>旭化成ケミカルズは現状まとめ処理はないが、切り替えた時の為に記載</remarks>
    Private Const SQL_SELECT_DATA_MATOME As String = " SELECT                                                              " & vbNewLine _
                                            ...
                                            & " LEFT JOIN                                                                  " & vbNewLine _
                                            & " $LM_TRN$..H_OUTKAEDI_HED_ASH                                             " & vbNewLine _
                                            & " ON                                                                         " & vbNewLine _
                                            & " H_OUTKAEDI_L.NRS_BR_CD =H_OUTKAEDI_HED_ASH.NRS_BR_CD                     " & vbNewLine _
                                            & " AND                                                                        " & vbNewLine _
                                            & " H_OUTKAEDI_L.EDI_CTL_NO =H_OUTKAEDI_HED_ASH.EDI_CTL_NO                   " & vbNewLine _
                                            & " --AND                                                                        " & vbNewLine _
                                            & " --H_OUTKAEDI_HED_ASH.INOUT_KB = '0'                                        " & vbNewLine _
                                            & " INNER JOIN                                                                 " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC108.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC108.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC108.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC108.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC108", "SelectDataNcgoMdest", cmd)
...
#Region "旭化成ケミカルズ実績作成処理"

#Region "データ取得処理"

    ''' <summary>
    ''' 旭化成ケミカルズEDI実績データの値設定
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>旭化成ケミカルズEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectASHEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC108.SQL_SELECT_ASH_SEND_DATA)    'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC108.SQL_FROM_ASH_SEND_DATA)      'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                            '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "SelectASHEdiSend", cmd)
        ...
        map.Add("SHUKKO_DATE", "SHUKKO_DATE")
        map.Add("SOUKO", "SOUKO")
        map.Add("OUTKA_NO", "OUTKA_NO")
        map.Add("KANRI_SURYO", "KANRI_SURYO")
        map.Add("NISUGATA_SURYO", "NISUGATA_SURYO")
        map.Add("LOT_NO", "LOT_NO")
        map.Add("INKO_HOKOKU_KB", "INKO_HOKOKU_KB")
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_ASH")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_ASH").Rows.Count())
        reader.Close()
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC108.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "SelectMatome", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC108.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC108.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC108.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC108.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC108.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC108.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC108.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC108.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC108.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC108.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC108.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC108.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(旭化成ケミカルズは自動更新がないため使用しない)"
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_ASH"
    ...
    ''' <summary>
    ''' EDI旭化成ケミカルズ実績テーブル新規登録
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI旭化成ケミカルズ実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertASHEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim ASHSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_ASH")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_H_SENDOUTEDI_ASH _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_ASH").Rows(0).Item("NRS_BR_CD").ToString()))
        Dim max As Integer = ASHSendTbl.Rows.Count() - 1
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertSakuraEdiSendData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(旭化成ケミカルズは自動追加がない為、使用しない)"
    ...
    '        'SQL文のコンパイル
    '        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC108.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC108", "InsertMDestData", cmd)
...
#Region "作業更新パラメータ設定"
    ...
    Private Sub SetSagyoParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@INOUTKA_NO_LM", .Item("INOUTKA_NO_LM").ToString(), DBDataType.CHAR))       'UPD 2019/08/02 復活　006202 
...
#Region "届先マスタ自動追加用パラメータ設定(旭化成専用)"
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO", Me.NullConvertString(.Item("OUTKA_CTL_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_CHU", Me.NullConvertString(.Item("OUTKA_CTL_NO_CHU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_SHO", Me.NullConvertString(.Item("OUTKA_CTL_NO_SHO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SASHIZU_NO", Me.NullConvertString(.Item("SASHIZU_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKI_KB", Me.NullConvertString(.Item("TORIHIKI_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHUKKO_DATE", Me.NullConvertString(.Item("SHUKKO_DATE")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@KANRI_SURYO", Me.NullConvertString(.Item("KANRI_SURYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NISUGATA_SURYO", Me.NullConvertString(.Item("NISUGATA_SURYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@INKO_HOKOKU_KB", Me.NullConvertString(.Item("INKO_HOKOKU_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNCHIN_CD", Me.NullConvertString(.Item("UNCHIN_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KANRI_KB", Me.NullConvertString(.Item("KANRI_KB")), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC108.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC108", "SelectDataMdestOutkaToroku", cmd)
