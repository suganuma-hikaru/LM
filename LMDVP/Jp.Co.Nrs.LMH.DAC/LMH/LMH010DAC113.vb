...
#Region "SELECT_SEND(テルモ専用)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_SELECT_SEND_TRM As String = "SELECT                                                                     " & vbNewLine _
                                          & "  '0'                               AS DEL_KB                                    " & vbNewLine _
                                          ...
                                          & " ,DTL_TRM.DATA_CD                   AS DATA_CD                                  " & vbNewLine _
                                          & " ,DTL_TRM.WH_CD                     AS WH_CD                                    " & vbNewLine _
                                          & " ,DTL_TRM.SEIHIN_CD                 AS SEIHIN_CD                                " & vbNewLine _
                                          & " ,SUM(INKA_S.KONSU * M_GOODS.PKG_NB + INKA_S.HASU) AS QT                        " & vbNewLine _
                                          & " ,DTL_TRM.CASE_QT                   AS CASE_QT                                  " & vbNewLine _
                                          & " ,DTL_TRM.YOBI1                     AS YOBI1                                    " & vbNewLine _
                                          & " ,DTL_TRM.KANRI_LOT                 AS KANRI_LOT                                " & vbNewLine _
                                          & " ,DTL_TRM.SEQ_NO                    AS SEQ_NO                                   " & vbNewLine _
                                          & " ,INKA_L.INKA_DATE                  AS INKA_DATE                                " & vbNewLine _
                                          & " ,DTL_TRM.YOBI2                     AS YOBI2                                    " & vbNewLine _
                                          & " ,DTL_TRM.KOUJYO_CD                 AS KOUJYO_CD                                " & vbNewLine _
                                          & " ,DTL_TRM.DATA_NO                   AS DATA_NO                                  " & vbNewLine _
                                          & " ,DTL_TRM.YOBI3                     AS YOBI3                                    " & vbNewLine _
                                          & " ,DTL_TRM.HONLOT_NO                 AS HONLOT_NO                                " & vbNewLine _
                                          & " ,DTL_TRM.KANRI_KANRILOT_NO         AS KANRI_KANRILOT_NO                        " & vbNewLine _
                                          & " ,DTL_TRM.KANRI_HONLOT_NO           AS KANRI_HONLOT_NO                          " & vbNewLine _
                                          & " ,space(9)                          AS YOBI4                                    " & vbNewLine _
                                          & " ,DTL_TRM.SU_KBN                    AS SU_KBN                                   " & vbNewLine _
                                          & " ,space(1)                          AS YOBI5                                    " & vbNewLine _
                                          & " ,DTL_TRM.REAL_SP                   AS REAL_SP                                  " & vbNewLine _
                                          & " ,DTL_TRM.WH_CD2                    AS WH_CD2                                   " & vbNewLine _
                                          ...
                                          & "  ON  EDI_L.DEL_KB <> '1'                                                        " & vbNewLine _
                                          & "  AND EDI_L.NRS_BR_CD = EDI_M.NRS_BR_CD                                          " & vbNewLine _
                                          & "  AND EDI_L.EDI_CTL_NO = EDI_M.EDI_CTL_NO                                        " & vbNewLine _
                                          & " INNER JOIN $LM_TRN$..H_INKAEDI_ANNAI_TRM2  DTL_TRM                               " & vbNewLine _
                                          ...
                                          & "     DTL_TRM.CRT_DATE                                                                   " & vbNewLine _
                                          & "    ,DTL_TRM.FILE_NAME                                                                  " & vbNewLine _
                                          & "    ,DTL_TRM.REC_NO                                                                     " & vbNewLine _
                                          & "    ,DTL_TRM.GYO_NO                                                                     " & vbNewLine _
                                          ...
                                          & "    ,DTL_TRM.DATA_CD                                                                    " & vbNewLine _
                                          & "    ,DTL_TRM.WH_CD                                                                      " & vbNewLine _
                                          & "    ,DTL_TRM.SEIHIN_CD                                                                  " & vbNewLine _
                                          & "    ,DTL_TRM.CASE_QT                                                                    " & vbNewLine _
                                          & "    ,DTL_TRM.YOBI1                                                                      " & vbNewLine _
                                          & "    ,DTL_TRM.KANRI_LOT                                                                  " & vbNewLine _
                                          & "    ,DTL_TRM.SEQ_NO                                                                     " & vbNewLine _
                                          & "    ,INKA_L.INKA_DATE                                                                   " & vbNewLine _
                                          & "    ,DTL_TRM.YOBI2                                                                      " & vbNewLine _
                                          & "    ,DTL_TRM.KOUJYO_CD                                                                  " & vbNewLine _
                                          & "    ,DTL_TRM.DATA_NO                                                                    " & vbNewLine _
                                          & "    ,DTL_TRM.YOBI3                                                                      " & vbNewLine _
                                          & "    ,DTL_TRM.HONLOT_NO                                                                  " & vbNewLine _
                                          & "    ,DTL_TRM.KANRI_KANRILOT_NO                                                          " & vbNewLine _
                                          & "    ,DTL_TRM.KANRI_HONLOT_NO                                                            " & vbNewLine _
                                          & "    ,DTL_TRM.SU_KBN                                                                     " & vbNewLine _
                                          & "    ,DTL_TRM.REAL_SP                                                                    " & vbNewLine _
                                          & "    ,DTL_TRM.WH_CD2                                                                     " & vbNewLine

    ''' <summary>
    ''' SELECT_SEND(テルモ専用／倉庫移動用)
    ''' </summary>
    ''' <remarks>
    ''' 入荷登録を行わないので、入荷データが存在しない
    ''' </remarks>
    Private Const SQL_SELECT_SEND_TRM_IDO As String = "SELECT                                                                   " & vbNewLine _
                                          & "  '0'                               AS DEL_KB                                      " & vbNewLine _
                                          & " ,DTL_TRM.CRT_DATE                  AS CRT_DATE                                    " & vbNewLine _
                                          & " ,DTL_TRM.FILE_NAME                 AS FILE_NAME                                   " & vbNewLine _
                                          & " ,DTL_TRM.REC_NO                    AS REC_NO                                      " & vbNewLine _
                                          ...
                                          & " ,DTL_TRM.WH_CD                     AS WH_CD                                       " & vbNewLine _
                                          & " ,DTL_TRM.SEIHIN_CD                 AS SEIHIN_CD                                   " & vbNewLine _
                                          & " ,SUM(EDI_M.INKA_PKG_NB * M_GOODS.PKG_NB + EDI_M.HASU) AS QT                        " & vbNewLine _
                                          & " ,DTL_TRM.CASE_QT                   AS CASE_QT                                     " & vbNewLine _
                                          & " ,DTL_TRM.YOBI1                     AS YOBI1                                       " & vbNewLine _
                                          & " ,DTL_TRM.KANRI_LOT                 AS KANRI_LOT                                   " & vbNewLine _
                                          & " ,DTL_TRM.SEQ_NO                    AS SEQ_NO                                      " & vbNewLine _
                                          & " ,EDI_L.INKA_DATE                   AS INKA_DATE                                   " & vbNewLine _
                                          & " ,DTL_TRM.YOBI2                     AS YOBI2                                       " & vbNewLine _
                                          & " ,DTL_TRM.KOUJYO_CD                 AS KOUJYO_CD                                   " & vbNewLine _
                                          & " ,DTL_TRM.DATA_NO                   AS DATA_NO                                     " & vbNewLine _
                                          & " ,DTL_TRM.YOBI3                     AS YOBI3                                       " & vbNewLine _
                                          ...
                                          & " INNER JOIN $LM_MST$..M_GOODS  M_GOODS                                             " & vbNewLine _
                                          & "--  ON  M_GOODS.SYS_DEL_FLG = '0'                                                  " & vbNewLine _
                                          & "  ON M_GOODS.CUST_CD_L = EDI_L.CUST_CD_L                                           " & vbNewLine _
                                          & "  AND M_GOODS.CUST_CD_M = EDI_L.CUST_CD_M                                          " & vbNewLine _
                                          & "  AND M_GOODS.GOODS_CD_NRS = EDI_M.NRS_GOODS_CD                                    " & vbNewLine _
                                          & "  AND M_GOODS.NRS_BR_CD = EDI_M.NRS_BR_CD                                          " & vbNewLine _
                                          & " WHERE EDI_M.SYS_DEL_FLG <> '1'                                                    " & vbNewLine _
                                          & "  AND  EDI_M.NRS_BR_CD = @NRS_BR_CD                                                " & vbNewLine _
                                          & "  AND  EDI_M.EDI_CTL_NO = @EDI_CTL_NO                                              " & vbNewLine _
                                          & "  AND  EDI_M.JISSEKI_FLAG = '0'                                                    " & vbNewLine _
                                          ...
                                          & "    ,EDI_M.EDI_CTL_NO                                                              " & vbNewLine _
                                          & "    ,EDI_M.EDI_CTL_NO_CHU                                                          " & vbNewLine _
                                          & "    ,EDI_L.CUST_CD_L                                                               " & vbNewLine _
                                          & "    ,EDI_L.CUST_CD_M                                                               " & vbNewLine _
                                          & "    ,DTL_TRM.DATA_CD                                                               " & vbNewLine _
                                          & "    ,DTL_TRM.WH_CD                                                                 " & vbNewLine _
                                          & "    ,DTL_TRM.SEIHIN_CD                                                             " & vbNewLine _
                                          & "    ,DTL_TRM.CASE_QT                                                               " & vbNewLine _
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_ANNAI_TRM2                     " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L                " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M                " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPDATE_RCV_DTL_TRM As String = "UPDATE $LM_TRN$..H_INKAEDI_ANNAI_TRM2 SET        " & vbNewLine _
...
#Region "H_SENDINEDI_TRM"

    Private Const SQL_INSERT_SEND_TRM As String = "INSERT INTO $LM_TRN$..H_SENDINEDI_TRM      " & vbNewLine _
                                              & "(                                        " & vbNewLine _
                                              & " DEL_KB                                  " & vbNewLine _
                                              ...
                                              & ",DATA_CD                                 " & vbNewLine _
                                              & ",WH_CD                                   " & vbNewLine _
                                              & ",SEIHIN_CD                               " & vbNewLine _
                                              & ",QT                                      " & vbNewLine _
                                              & ",CASE_QT                                 " & vbNewLine _
                                              & ",YOBI1                                   " & vbNewLine _
                                              & ",KANRI_LOT                               " & vbNewLine _
                                              & ",SEQ_NO                                  " & vbNewLine _
                                              & ",INKA_DATE                               " & vbNewLine _
                                              & ",YOBI2                                   " & vbNewLine _
                                              & ",KOUJYO_CD                               " & vbNewLine _
                                              & ",DATA_NO                                 " & vbNewLine _
                                              & ",YOBI3                                   " & vbNewLine _
                                              & ",HONLOT_NO                               " & vbNewLine _
                                              & ",KANRI_KANRILOT_NO                       " & vbNewLine _
                                              & ",KANRI_HONLOT_NO                         " & vbNewLine _
                                              & ",YOBI4                                   " & vbNewLine _
                                              & ",SU_KBN                                  " & vbNewLine _
                                              & ",YOBI5                                   " & vbNewLine _
                                              & ",REAL_SP                                 " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC113.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC113.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理(テルモ専用)"
    ''' <summary>
    ''' 実績送信データ取得処理(テルモ専用)
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectSendTermo(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        If "倉庫移動".Equals(Left(Me._Row.Item("OUTKA_FROM_ORD_NO").ToString, 4)) Then
            '倉庫移動データ用SQL
            Me._StrSql.Append(LMH010DAC113.SQL_SELECT_SEND_TRM_IDO)
        Else
            '通常のSQL
            Me._StrSql.Append(LMH010DAC113.SQL_SELECT_SEND_TRM)
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "SelectSendTermo", cmd)
        ...
        '取得データの格納先をマッピング
        map = Me.SetMapSendTermo()

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINEDI_TRM")
        reader.Close()
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC113.SQL_UPD_INKATOROKU_EDI_L

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC113.SQL_UPD_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC113.SQL_UPD_INKATOROKU_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC113.SQL_UPD_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "UpdateEdiM", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC113.SQL_UPDATE_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC113.SQL_UPDATE_RCV_DTL_TRM
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertInkaS", cmd)
...
#Region "H_SENDINEDI_TRM"
    ...
    Private Function InsertSendTermo(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINEDI_TRM")

        '営業所コード
        Dim brCd As String = inTbl.Rows(0).Item("NRS_BR_CD").ToString()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_SEND_TRM, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertSendTermo", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC113.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC113", "InsertUnchinData", cmd)
...
#Region "挿入パラメータ設定(H_SENDINEDI_NIK)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(row.Item("CUST_CD_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(row.Item("CUST_CD_M")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATA_CD", Me.NullConvertString(row.Item("DATA_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WH_CD", Me.NullConvertString(row.Item("WH_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEIHIN_CD", Me.NullConvertString(row.Item("SEIHIN_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@QT", Me.NullConvertZero(row.Item("QT")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CASE_QT", Me.NullConvertZero(row.Item("CASE_QT")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI1", Me.NullConvertString(row.Item("YOBI1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KANRI_LOT", Me.NullConvertString(row.Item("KANRI_LOT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEQ_NO", Me.NullConvertString(row.Item("SEQ_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_DATE", Me.NullConvertString(row.Item("INKA_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI2", Me.NullConvertString(row.Item("YOBI2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOUJYO_CD", Me.NullConvertString(row.Item("KOUJYO_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATA_NO", Me.NullConvertString(row.Item("DATA_NO")), DBDataType.NVARCHAR))
        'Me._SqlPrmList.Add(GetSqlParameter("@DATA_NO", row.DATA_NO, DBDataType.VARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI3", Me.NullConvertString(row.Item("YOBI3")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HONLOT_NO", Me.NullConvertString(row.Item("HONLOT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KANRI_KANRILOT_NO", Me.NullConvertString(row.Item("KANRI_KANRILOT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KANRI_HONLOT_NO", Me.NullConvertString(row.Item("KANRI_HONLOT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI4", Me.NullConvertString(row.Item("YOBI4")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SU_KBN", Me.NullConvertString(row.Item("SU_KBN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI5", Me.NullConvertString(row.Item("YOBI5")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REAL_SP", Me.NullConvertString(row.Item("REAL_SP")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WH_CD2", Me.NullConvertString(row.Item("WH_CD2")), DBDataType.NVARCHAR))
...
#Region "マッピング配列作成"
    ...
    Private Function SetMapSendTermo() As Hashtable
        ...
        map.Add("CUST_CD_L", "CUST_CD_L")
        map.Add("CUST_CD_M", "CUST_CD_M")
        map.Add("DATA_CD", "DATA_CD")
        map.Add("WH_CD", "WH_CD")
        map.Add("SEIHIN_CD", "SEIHIN_CD")
        map.Add("QT", "QT")
        map.Add("CASE_QT", "CASE_QT")
        map.Add("YOBI1", "YOBI1")
        map.Add("KANRI_LOT", "KANRI_LOT")
        map.Add("SEQ_NO", "SEQ_NO")
        map.Add("INKA_DATE", "INKA_DATE")
        map.Add("YOBI2", "YOBI2")
        map.Add("KOUJYO_CD", "KOUJYO_CD")
        map.Add("DATA_NO", "DATA_NO")
        map.Add("YOBI3", "YOBI3")
        map.Add("HONLOT_NO", "HONLOT_NO")
        map.Add("KANRI_KANRILOT_NO", "KANRI_KANRILOT_NO")
        map.Add("KANRI_HONLOT_NO", "KANRI_HONLOT_NO")
        map.Add("YOBI4", "YOBI4")
        map.Add("SU_KBN", "SU_KBN")
        map.Add("YOBI5", "YOBI5")
        map.Add("REAL_SP", "REAL_SP")
        map.Add("WH_CD2", "WH_CD2")
