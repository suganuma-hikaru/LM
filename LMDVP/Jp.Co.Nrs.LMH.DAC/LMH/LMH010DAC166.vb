...
''' <remarks></remarks>
''' 
Public Class LMH010DAC166
    Inherits Jp.Co.Nrs.LM.Base.DAC.LMBaseDAC

#Region "Const"

#Region "H_INKAEDI_DTL_TST(INSERT)"

    ''' <summary>
    ''' INSERT（H_INKAEDI_DTL_TST）
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Const SQL_INSERT_INKAEDI_DTL As String = "INSERT INTO       " & vbNewLine _
                                        ...
                                        & " ,PUR_DOC                    " & vbNewLine _
                                        & " ,NAME_OF_SHIP_TO            " & vbNewLine _
                                        & " ,SHIP_TO                    " & vbNewLine _
                                        & " ,MATERIAL                   " & vbNewLine _
                                        & " ,DESCRIPTION                " & vbNewLine _
                                        & " ,DELIVERY_QUANTITY          " & vbNewLine _
                                        & " ,SU                         " & vbNewLine _
...
#Region "WHERE1_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_WHERE2_M_GOODS As String =
                                       " WHERE                                        " & vbNewLine _
                                     & " MG.NRS_BR_CD      = @NRS_BR_CD               " & vbNewLine _
                                     & " AND                                          " & vbNewLine _
...
#Region "H_INKAEDI_L(セミEDI)"
    ...
    Private Function InsertInkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_INKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertInkaEdiL", cmd)
...
#Region "H_INKAEDI_M(セミEDI)"
    ...
    Private Function InsertInkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_INKAEDI_M _
...
#Region "H_INKAEDI_DTL_TST(セミEDI)"
    ...
    Private Function InsertInkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtInkaEdiRcvDtl As DataTable = setDs.Tables("LMH010_INKAEDI_DTL_TST")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_INKAEDI_DTL, setDs.Tables("LMH010_INKAEDI_DTL_TST").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertInkaEdiRcvDtl", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH010_INKAEDI_DTL_TST")
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC166.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        'If String.IsNullOrEmpty(dtToriDtl.Rows(0).Item("COLUMN_19").ToString()) = True Then
        If dtRcvDtl.Rows.Count = 0 Then
            Me._StrSql.Append(LMH010DAC166.SQL_WHERE1_M_GOODS)
        Else
            Me._StrSql.Append(LMH010DAC166.SQL_WHERE2_M_GOODS)
        End If

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH010DAC166.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "SelectDataMgoods", cmd)
...
#Region "商品マスタ(セミEDI：荷主商品コードより抽出)"
    ...
    Private Function CheckGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC166.SQL_SELECT_M_GOODS_CNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "CheckGoods", cmd)
...
#Region "区分マスタ(汎用抽出)"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC166.SQL_SELECT_ZKBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "SelectDataZkbn", cmd)
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_TST                       " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC166.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC166.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "SelectEdiM", cmd)
...
#Region "EDI受信(DTL)新規追加パラメータ設定"
    ...
    Private Sub SetInsertInkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@PUR_DOC", Me.NullConvertString(.Item("PUR_DOC")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NAME_OF_SHIP_TO", Me.NullConvertString(.Item("NAME_OF_SHIP_TO")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_QUANTITY", Me.NullConvertZero(.Item("DELIVERY_QUANTITY")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@SU", Me.NullConvertString(.Item("SU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NET_WEIGHT", Me.NullConvertZero(.Item("NET_WEIGHT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@BUN", Me.NullConvertString(.Item("BUN")), DBDataType.NVARCHAR))
...
#Region "ファイル名重複チェック"
    ...
    Private Function SelectRcvCount(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH010_SEMIEDI_INFO").Rows(0)
        Dim inTbl As DataTable = ds.Tables("LMH010_EDI_TORIKOMI_HED")
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC166.SQL_GET_RCV_COUNT)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC166.SQL_UPD_INKATOROKU_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC166.SQL_UPD_INKATOROKU_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "UpdateEdiM", cmd)
...
#Region "H_INKAEDI_M(セミEDI)同一データの場合の更新"
    ...
    Private Function UpdateInkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_UPDATE_EDIT_INKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "UpdateInkaEdiM", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC166.SQL_UPDATE_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertInkaS", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC166.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC166", "InsertUnchinData", cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH010DAC166.SQL_UPDATE_MATOMESAKI_UNSO_L
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH010DAC166.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC166", "UpdateMatomesakiEdiLData", cmd)
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectMstGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtToriDtl As DataTable, ByVal dtRcvDtl As DataTable)
        ...
        If dtRcvDtl.Rows.Count = 0 Then
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", dtToriDtl.Rows(0).Item("COLUMN_5").ToString(), DBDataType.NVARCHAR))
        Else
