...
#Region "SELECT_ZIP"
    ...
    Private Const SQL_SELECT_ZIP As String _
                    = " SELECT                                                     " & vbNewLine _
                    & " JIS_CD                                               " & vbNewLine _
                    & " FROM                                                       " & vbNewLine _
...
#Region "SELECT_Z_KBN(配送会社コード変換)"

    Private Const SQL_SELECT_Z_KBN_H029 As String _
                    = " SELECT                                                     " & vbNewLine _
                    ...
                    & " AND                                                        " & vbNewLine _
                    & " KBN_NM1 = @KBN_NM1                                         " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_NM2 = @KBN_NM2                                         " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " SYS_DEL_FLG = '0'                                          " & vbNewLine

#End Region

#Region "SELECT_Z_KBN(商品コード変換)"

    Private Const SQL_SELECT_Z_KBN_M030 As String _
                    = " SELECT                                                     " & vbNewLine _
                    & " KBN_NM5                         AS    HENKAN_GOODS_CD      " & vbNewLine _
                    & " FROM                                                       " & vbNewLine _
                    & " $LM_MST$..Z_KBN                                            " & vbNewLine _
                    & " WHERE                                                      " & vbNewLine _
                    & " KBN_GROUP_CD = 'M030'                                      " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_NM1 = @NRS_BR_CD                                       " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_NM2 = @CUST_CD_L                                       " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_NM3 = @CUST_CD_M                                       " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " KBN_NM4 = @GOODS_CD                                        " & vbNewLine _
                    & " AND                                                        " & vbNewLine _
                    & " SYS_DEL_FLG = '0'                                          " & vbNewLine

#End Region

#Region "H_OUTKAEDI_DTL_CJC(COUNT)"

    Private Const SQL_GET_OUTKAEDIRCVDTL_COUNT As String _
                    = " SELECT" & vbNewLine _
                    & " COUNT(*)" & vbNewLine _
                    & " FROM" & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_CJC(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_DTL_CJC）
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = " INSERT INTO" & vbNewLine _
                                        ...
                                        & " ,PRTFLG" & vbNewLine _
                                        & " ,WKO_NO" & vbNewLine _
                                        & " ,CONTAINER_CODE" & vbNewLine _
                                        & " ,PROJECT" & vbNewLine _
                                        & " ,SITE_NO" & vbNewLine _
                                        & " ,ENTERED" & vbNewLine _
                                        & " ,QTY" & vbNewLine _
                                        & " ,SYSTEM_KRD" & vbNewLine _
                                        & " ,MODIFIED_KRD" & vbNewLine _
                                        & " ,SHUKASU" & vbNewLine _
                                        & " ,NOUKI" & vbNewLine _
                                        & " ,DUPLICATE_CHECK" & vbNewLine _
                                        & " ,SAISOKAISU" & vbNewLine _
                                        & " ,HACHUDATE" & vbNewLine _
                                        & " ,HINBAN" & vbNewLine _
                                        & " ,MEISHO" & vbNewLine _
                                        & " ,KIKAKU" & vbNewLine _
                                        & " ,LOT" & vbNewLine _
                                        & " ,WKO_MODIFICATION_NO" & vbNewLine _
                                        & " ,POSTNO" & vbNewLine _
                                        & " ,ADDRESS" & vbNewLine _
                                        & " ,SITE" & vbNewLine _
                                        & " ,SR" & vbNewLine _
                                        ...
                                        & " ,MISSING_INFORMATION" & vbNewLine _
                                        & " ,RECEIPT_OF_DELIVERY" & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_CJC(取込削除時)"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_CJC）
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "H_OUTKAEDI_RCV_CAN 取消データ抽出用"
    ...
    Private Const SQL_SELECT_OUTKAEDI_RCV_CAN As String = _
                ...
                & " AND   H_OUTKAEDI_DTL.WKO_NO        = @WKO_NO            " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_CJC"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_CJC）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_CJC SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "SAGYO"
    ...
    'ADD S 2019/12/23 009981
    ''' <summary>
    ''' 作業項目マスタ取得(営業所コード、荷主コード(大)で絞り込み)
    ''' </summary>
    Private Const SQL_SELECT_M_SAGYO As String =
                                          "SELECT                          " & vbNewLine _
                                        & "      NRS_BR_CD                 " & vbNewLine _
                                        & "     ,SAGYO_CD                  " & vbNewLine _
                                        & "     ,CUST_CD_L                 " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC133.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectDataNcgoMdest", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC133.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC133.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC133.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                'setSql = LMH030DAC133.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC133.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC133.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC133.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(日興産業用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertSagyoData", cmd)
    ...
    Private Function SelectMSagyo(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_M_SAGYO_IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_M_SAGYO)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectMSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertUnchinData", cmd)
...
#Region "M_DEST(日興産業用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertMDestData", cmd)
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectDataMdestOutkaToroku", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        '取消データは受信DTLから取得する
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_CJC")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectOutkaEdiRcvCancel", cmd)
        ...
        map.Add("EDI_CTL_NO_CHU", "EDI_CTL_NO_CHU")
        map.Add("OUTKA_CTL_NO", "OUTKA_CTL_NO")
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_CJC_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_CJC_CANCELOUT").Rows.Count())
        reader.Close()
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_CJC")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC133.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC133.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectDataMgoods", cmd)
...
#Region "届先マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_M_DEST1)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC133.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectDataMDEST", cmd)
...
#Region "商品変換(取込時)"
    ...
    Private Function CheckGoods(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtDTL_CJC As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_CJC")

        'INTableの条件rowの格納
        Me._Row = dtDTL_CJC.Rows(0)
        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_SELECT_Z_KBN_M030 _
                                                                       , Me._Row.Item("NRS_BR_CD").ToString()))
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        'Call Me.SetGOODS_CHKParameter(Me._Row, Me._SqlPrmList
        _SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(_Row.Item("NRS_BR_CD")), DBDataType.CHAR))
        _SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(_Row.Item("CUST_CD_L")), DBDataType.VARCHAR))
        _SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(_Row.Item("CUST_CD_M")), DBDataType.VARCHAR))
        _SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD", Me.NullConvertString(_Row.Item("HINBAN")), DBDataType.VARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "CheckGoods", cmd)
        ...
        '取得データの格納先をマッピング
        map.Add("HENKAN_GOODS_CD", "HENKAN_GOODS_CD")
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_HENKAN_GOODS")
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_DTL_CJC_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC133.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC133.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_CJC_CANCELOUT")   'DTLの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC133.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_H_OUTKAEDI_DTL_CJC")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC133.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_H_OUTKAEDI_DTL_CJC").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "商品変換パラメータ設定"
    ...
    ''' 商品変換パラメータ設定
    ''' </summary>
    ''' <param name="chkRow">DataRow</param>
    ''' <remarks></remarks>
    Private Sub SetGOODS_CHKParameter(ByVal chkRow As DataRow _
                                       , ByVal prmList As ArrayList)
        ...
        With chkRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", .Item("CUST_CD_L").ToString(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", .Item("CUST_CD_M").ToString(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CD", .Item("GOODS_CD").ToString(), DBDataType.CHAR))
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@WKO_NO", Me.NullConvertString(.Item("WKO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CONTAINER_CODE", Me.NullConvertString(.Item("CONTAINER_CODE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PROJECT", Me.NullConvertString(.Item("PROJECT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SITE_NO", Me.NullConvertString(.Item("SITE_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ENTERED", Me.NullConvertString(.Item("ENTERED")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@QTY", Me.NullConvertString(.Item("QTY")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYSTEM_KRD", Me.NullConvertString(.Item("SYSTEM_KRD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MODIFIED_KRD", Me.NullConvertString(.Item("MODIFIED_KRD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHUKASU", Me.NullConvertString(.Item("SHUKASU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUKI", Me.NullConvertString(.Item("NOUKI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DUPLICATE_CHECK", Me.NullConvertString(.Item("DUPLICATE_CHECK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAISOKAISU", Me.NullConvertString(.Item("SAISOKAISU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HACHUDATE", Me.NullConvertString(.Item("HACHUDATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINBAN", Me.NullConvertString(.Item("HINBAN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MEISHO", Me.NullConvertString(.Item("MEISHO")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@WKO_MODIFICATION_NO", Me.NullConvertString(.Item("WKO_MODIFICATION_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@POSTNO", Me.NullConvertString(.Item("POSTNO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ADDRESS", Me.NullConvertString(.Item("ADDRESS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SITE", Me.NullConvertString(.Item("SITE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SR", Me.NullConvertString(.Item("SR")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TELNO", Me.NullConvertString(.Item("TELNO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@COMMENTS", Me.NullConvertString(.Item("COMMENTS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MISSING_INFORMATION", Me.NullConvertString(.Item("MISSING_INFORMATION")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@RECEIPT_OF_DELIVERY", Me.NullConvertString(.Item("RECEIPT_OF_DELIVERY")), DBDataType.NVARCHAR))
            'EDI受信（DTL）共通項目
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectMstGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(dtRcvDtl.Rows(0).Item("HINBAN")), DBDataType.NVARCHAR))
...
#Region "EDI受信(DTL)削除データ抽出パラメータ設定"
    ...
    Private Sub SetSelectOutkaEdiRcvCancel(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@WKO_NO", Me.NullConvertString(.Item("WKO_NO").ToString()), DBDataType.NVARCHAR))
        End With
...
#Region "件数取得処理(EDI受信(DTL)テーブル)"

    ''' <summary>
    ''' 件数取得処理(EDI受信(DTL)テーブル)
    ''' </summary>
    ''' <remarks></remarks>
    Public Function GetOutkaEdiRcvDtlCount(ByVal ds As DataSet) As Integer
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC133.SQL_GET_OUTKAEDIRCVDTL_COUNT, dtRcvDtl.Rows(0).Item("NRS_BR_CD").ToString())

        '受信DTLテーブル名設定
        Dim RcvNm As String = drSemiEdiInfo.Item("RCV_NM_DTL").ToString()  '"H_OUTKAEDI_DTL_CJC"
        ...
        Me._SqlPrmList = New ArrayList()
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dtRcvDtl.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKO_DATE", Me.NullConvertString(dtRcvDtl.Rows(0).Item("OUTKO_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_TEL", Me.NullConvertString(dtRcvDtl.Rows(0).Item("DEST_TEL")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(drSemiEdiInfo.Item("CUST_CD_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(drSemiEdiInfo.Item("CUST_CD_M")), DBDataType.CHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectOutkaEdiRcvDtl", cmd)
...
#Region "郵便番号マスタ取得"
    ...
    ''' 郵便番号マスタ取得
    ''' </summary>
    Private Function SelectZip(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_ZIP_CJC")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC133.SQL_SELECT_ZIP)      'SQL構築
        '条件設定
        Me._SqlPrmList = New ArrayList()
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ZIP_NO", Me._Row("ZIP_NO").ToString(), DBDataType.CHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC133", "SelectZip", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_ZIP_CJC")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_ZIP_CJC").Rows.Count())
        reader.Close()
