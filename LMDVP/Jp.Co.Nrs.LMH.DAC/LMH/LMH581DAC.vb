...
'  システム名       :  LM
'  サブシステム名   :  LMH       : 出荷管理
'  プログラムID     :  LMH581    : 納品書(埼玉BP・納品書　オートバックス)
'  作  成  者       :  渡部　剛
' ==========================================================================
Imports System.Text
...
#Region "出力件数処理 SQL"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_CNT As String = " SELECT                                                              " & vbNewLine _
                                        & "       '黒' AS DENP_SHUBETU                                             " & vbNewLine _
                                        & "      ,CAST(BPDTL.ROW_NO AS INT) AS ROWCNT                              " & vbNewLine _
                                        & "      ,CAST(SUB.MAXCNT AS INT)   AS MAXCNT                              " & vbNewLine _
                                        ...
                                        & "      , CASE WHEN SUB.MAXCNT = BPDTL.ROW_NO                             " & vbNewLine _
                                        & "             THEN CAST(CEILING(SUB.CNT / Z_KBN.VALUE1) AS INT)          " & vbNewLine _
                                        & "        ELSE 0                                                          " & vbNewLine _
                                        & "        END OUTPUT_CNT                                                  " & vbNewLine _
                                        & " --出荷(大)                                                             " & vbNewLine _
                                        ...
                                        & "              ,MAX(SUBDTL.ROW_NO) AS MAXCNT                             " & vbNewLine _
                                        & "              ,SUBHED.OUTKA_PLAN_DATE                                   " & vbNewLine _
                                        & "              ,SUBHED.CUST_ORD_NO                                       " & vbNewLine _
                                        & "              ,SUBHED.DENPYO_NO                                         " & vbNewLine _
                                        ...
                                        & "       AND   SUBDTL.ROW_TYPE  <> 'U'                                    " & vbNewLine _
                                        & "       AND   SUBHED.CUST_ORD_NO  = @DENPYO_NO                           " & vbNewLine _
                                        ...
                                        & "       AND BPHED.DENPYO_NO = SUB.DENPYO_NO                              " & vbNewLine _
                                        ...
                                        & "             AND Z_KBN.KBN_CD        = '02'                             " & vbNewLine _
                                        & "  WHERE                                                                 " & vbNewLine _
                                        ...
                                        & "   (SELECT                                                              " & vbNewLine _
                                        & "          OUTEDIL.NRS_BR_CD                                             " & vbNewLine _
                                        & "         ,OUTEDIL.CUST_CD_L                                             " & vbNewLine _
                                        & "         ,OUTEDIL.CUST_CD_M                                             " & vbNewLine _
                                        ...
                                        & " AND BPHED.CUST_CD_L = @CUST_CD_L                                       " & vbNewLine _
                                        & " AND BPHED.CUST_CD_M = @CUST_CD_M                                       " & vbNewLine _
                                        & " AND BPHED.EDI_CTL_NO = @EDI_CTL_NO                                     " & vbNewLine _
                                        & "  AND (OUTEDIL.FREE_C04='S2' OR OUTEDIL.FREE_C04='UE')                  " & vbNewLine _
                                        & "  AND OUTEDIL.FREE_C18 = '11500057'                                     " & vbNewLine _
                                        & "  AND OUTEDIL.DEL_KB = '0'                                              " & vbNewLine _
                                        & "    ) BASE                                                              " & vbNewLine _
                                        & "WHERE                                                                   " & vbNewLine _
                                        ...
                                        & "UNION                                                                   " & vbNewLine _
                                        & "SELECT                                                                  " & vbNewLine _
                                        & "       '値引' AS DENP_SHUBETU                                           " & vbNewLine _
                                        & "      ,CAST(BPDTL.ROW_NO AS INT) AS ROWCNT                              " & vbNewLine _
                                        & "      ,CAST(SUB.MAXCNT AS INT)   AS MAXCNT                              " & vbNewLine _
                                        & "      , CASE WHEN SUB.MAXCNT = BPDTL.ROW_NO                             " & vbNewLine _
                                        & "             THEN CAST(CEILING(SUB.CNT / Z_KBN.VALUE1) AS INT)          " & vbNewLine _
                                        ...
                                        & " AND BPHED.CUST_CD_L = @CUST_CD_L                                       " & vbNewLine _
                                        & " AND BPHED.CUST_CD_M = @CUST_CD_M                                       " & vbNewLine _
                                        & " AND BPHED.CUST_ORD_NO  = @DENPYO_NO                                    " & vbNewLine _
                                        & "  AND (OUTEDIL.FREE_C04='S2' OR OUTEDIL.FREE_C04='UE')                  " & vbNewLine _
                                        & "  AND OUTEDIL.FREE_C18 = '11500057'                                     " & vbNewLine _
                                        & "  AND OUTEDIL.DEL_KB = '0'                                              " & vbNewLine _
                                        & "    ) BASE                                                              " & vbNewLine _
                                        & "WHERE                                                                   " & vbNewLine _
                                        & "     BASE.CUST_ORD_NO = BPHED.CUST_ORD_NO                               " & vbNewLine _
                                        & "AND  RIGHT(BASE.DENPYO_NO,5) = RIGHT(BPHED.DENPYO_NO,5)                 " & vbNewLine _
...
#Region "検索処理 SQL"
    ...
    Private Const SQL_FROM As String = " --出荷(大)                                                                                         " & vbNewLine _
                                     ...
                                     & "             AND EDI_PRT.PRINT_TP   = '07'                                                          " & vbNewLine _
                                     & "       LEFT JOIN (                                                                                  " & vbNewLine _
                                     ...
                                     & "                      AND H_EDI_PRINT.PRINT_TP    = '07'                                            " & vbNewLine _
                                     ...
                                     & "              ON S_USER.USER_CD = EDI_PRT.SYS_ENT_USER                                              " & vbNewLine _
                                     ...
                                     & "                    AND M_CUSTRPT1.PTN_ID      = 'B2'                                               " & vbNewLine _
                                     ...
                                     & "                    AND M_CUSTRPT2.PTN_ID      = 'B2'                                               " & vbNewLine _
    ...
    '                                       & " AND BPHED.OUTKA_PLAN_DATE  >= @OUTKA_PLAN_DATE_FROM                           " & vbNewLine _
    '                                       & " AND BPHED.OUTKA_PLAN_DATE  <= @OUTKA_PLAN_DATE_TO                           " & vbNewLine _
    '                                       & " AND (BPDTL.ORDER_TYPE='SO' OR BPDTL.ORDER_TYPE='UE')        " & vbNewLine _
    '                                       & " AND BPHED.TOKUI_CD = '11030000'                             " & vbNewLine _
    '                                       & " AND BPDTL.DEL_KB  = '0'                                     " & vbNewLine
    ...
    Private Const SQL_EXISTS As String = "	 AND EXISTS (                                                                                        " & vbNewLine _
                                       & "SELECT * FROM                                                                                          " & vbNewLine _
                                       & "--(2013.02.27) BP新システム切替対応START                                                               " & vbNewLine _
                                       & "--   (SELECT OUTEDIL.NRS_BR_CD,OUTEDIL.CUST_CD_L,OUTEDIL.CUST_CD_M,BPHED.CUST_ORD_NO                     " & vbNewLine _
                                       ...
                                       & "--                AND HEDIPRINT.DENPYO_NO  = BPHED.DENPYO_NO                                             " & vbNewLine _
                                       & "                AND HEDIPRINT.DENPYO_NO  = BPHED.CUST_ORD_NO                                           " & vbNewLine _
                                       & "--(2013.02.27) BP新システム切替対応START                                                            " & vbNewLine
    ...
    Private Const SQL_EXISTS_WHERE As String = "	   ) BASE WHERE                   " & vbNewLine _
                                         ...
                                         & "--(2013.02.27) BP新システム切替対応START                    " & vbNewLine _
                                         & "--AND  (LEFT(BASE.DENPYO_NO,7) = LEFT(BPHED.DENPYO_NO,7)      " & vbNewLine _
                                         & "--OR   RIGHT(BASE.DENPYO_NO,5) = RIGHT(BPHED.DENPYO_NO,5) )   " & vbNewLine _
                                         & "--(2013.02.27) BP新システム切替対応END                      " & vbNewLine _
                                         & "AND  BASE.NRS_BR_CD   = BPHED.NRS_BR_CD   " & vbNewLine _
                                         & "AND  BASE.CUST_CD_L   = BPHED.CUST_CD_L   " & vbNewLine _
                                         & "AND  BASE.CUST_CD_M   = BPHED.CUST_CD_M   " & vbNewLine _
    ...
    Private Const SQL_ORDER_BY As String = "ORDER BY                     " & vbNewLine _
                                         & "      BPHED.CUST_ORD_NO      " & vbNewLine _
                                         & "--(2013.02.27) BP新システム切替対応START    " & vbNewLine _
                                         & "--    , BPHED.DENPYO_NO DESC   " & vbNewLine _
                                         & "    , BPHED.DENPYO_NO        " & vbNewLine _
                                         & "--(2013.02.27) BP新システム切替対応END    " & vbNewLine _
                                         & "    , BPHED.EDI_CTL_NO       " & vbNewLine _
                                         & "    , BPDTL.GYO              " & vbNewLine _
                                         & "    , BPDTL.EDI_CTL_NO_CHU   " & vbNewLine _
                                         & "    , BPHED.SEIKYU_KB        " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH581IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMH581DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMH581DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMH581DAC", "SelectMPrt", cmd)
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>専用帳票出力件数取得SQLの構築・発行</remarks>
    Private Function SelectOutputData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH581DAC.SQL_SELECT_CNT)      'SQL構築(出力件数)

        '出力件数用パラメータ
        Call Me.SetConditionOutputSQL()                 '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH581DAC", "SelectOutputData", cmd)
        ...
        '取得データの格納先をマッピング
        map.Add("DENP_SHUBETU", "DENP_SHUBETU")
        map.Add("ROWCNT", "ROWCNT")
        map.Add("MAXCNT", "MAXCNT")
        map.Add("OUTPUT_CNT", "OUTPUT_CNT")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "CNT_TBL")
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH581DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH581DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMH581DAC.SQL_WHERE)            'SQL構築(データ抽出用WHERE句)(新規)
        Me._StrSql.Append(LMH581DAC.SQL_EXISTS)           'SQL構築(データ抽出用SELECT句(AND EXISTS))(新規)

        '(2013.02.05)要望番号1822 -- START --
        'If Me._Row.Item("PRTFLG").ToString = "1" Then
        '    '出力済の場合
        '    'Me._StrSql.Append(LMH581DAC.SQL_WHERE)            'SQL構築(データ抽出用Where句)
        '    Call Me.SetConditionMasterSQL_OUT()
        'Else
        '    '未出力の場合
        '    Call Me.SetConditionMasterSQL()
        ...
        Me._StrSql.Append(LMH581DAC.SQL_EXISTS_WHERE) 'SQL構築(データ抽出用WHERE句(AND EXISTS))(新規)
        Me._StrSql.Append(LMH581DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        Call Me.SetConditionPrintPatternMSQL()       '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH581DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH581OUT")
    ...
    '2013.06.17 追加START
    ''' <summary>
    ''' 出力件数取得 条件文・パラメータ設定モジュール
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetConditionOutputSQL()
        ...
        With Me._Row
            ...
            '伝票№(オーダー№)
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_NO", Me._Row.Item("DENPYO_NO").ToString(), DBDataType.NVARCHAR))
    ...
    Private Sub SetConditionMasterSQL()
        ...
        With Me._Row
            ...
            '(2013.01.17)参照テーブルの変更 -- START --
            'オーダータイプ
            '(2013.02.27) BP新システム切替対応START
            'Me._StrSql.Append(vbNewLine)
            'Me._StrSql.Append("  AND (OUTEDIL.FREE_C04='SO' OR OUTEDIL.FREE_C04='UE') ")
            ''Me._StrSql.Append(" AND (BPDTL.ORDER_TYPE='SO' OR BPDTL.ORDER_TYPE='UE') ")
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("  AND (OUTEDIL.FREE_C04='S2' OR OUTEDIL.FREE_C04='UE') ")
            '(2013.02.27) BP新システム切替対応END

            '得意先コード
            '(2013.02.27) BP新システム切替対応START
            'Me._StrSql.Append(vbNewLine)
            'Me._StrSql.Append("  AND OUTEDIL.FREE_C18 = '11030000' ")
            ''Me._StrSql.Append(" AND BPHED.TOKUI_CD = '11030000' ")
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("  AND OUTEDIL.FREE_C18 = '11500057' ")
            '(2013.02.27) BP新システム切替対応END

            '削除フラグ
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("  AND OUTEDIL.DEL_KB = '0' ")
            'Me._StrSql.Append(" AND BPDTL.DEL_KB = '0' ")
            '(2013.01.17)参照テーブルの変更 -- END --
    ...
    Private Sub SetConditionMasterSQL_OUT()
        ...
        With Me._Row
            ...
            ''(2013.06.17) BP新システム切替対応で修正START
            ''EDI出荷管理番号
