...
#End Region
    ...
    '2018/07/02 依頼番号 : 001708   エクセル商品コード変換用
#Region "区分マスタ読込"
    Private Const SQL_SELECT_Z_KBN_CHK As String = " SELECT                                        " & vbNewLine _
                                     & " Z_KBN.KBN_NM5              AS  GET_GOODS_CD_CUST      " & vbNewLine _
                                     & " FROM                                                  " & vbNewLine _
                                     & " $LM_MST$..Z_KBN                        Z_KBN          " & vbNewLine _
                                     & " WHERE                                                 " & vbNewLine _
                                     & " 　　Z_KBN.KBN_GROUP_CD = 'M028'               　　　　" & vbNewLine _
                                     & " AND Z_KBN.KBN_NM1      = @NRS_BR_CD                　 " & vbNewLine _
                                     & " AND Z_KBN.KBN_NM2      = @CUST_CD_L                　 " & vbNewLine _
                                     & " AND Z_KBN.KBN_NM3      = @CUST_CD_M                　 " & vbNewLine _
                                     & " AND Z_KBN.KBN_NM4      = @CHK_GOODS_CD_CUST        　 " & vbNewLine
...
#Region "キャンセルデータ抽出"
    ...
    ''' キャンセルデータの抽出
    ''' </summary>
    Private Const SQL_SELECT_CANCEL_DATA As String = " SELECT                                       " & vbNewLine _
                                                   & "    COL.OUTKA_NO_L AS OUTKA_CTL_NO            " & vbNewLine _
                                                   & "   ,HOL.EDI_CTL_NO                            " & vbNewLine _
                                                   & " FROM                                         " & vbNewLine _
                                                   & "   $LM_TRN$..H_OUTKAEDI_L AS HOL              " & vbNewLine _
                                                   ...
                                                   & "   AND HOL.NRS_BR_CD      = @NRS_BR_CD        " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_MRC(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL_MRC As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",PLNT                            " & vbNewLine _
                                        & ",SHIP_TO                         " & vbNewLine _
                                        & ",SHIP_TO_NM                      " & vbNewLine _
                                        & ",SHIP_TO_LOCA                    " & vbNewLine _
                                        & ",TRSPRT_ID                       " & vbNewLine _
                                        & ",MATERIAL                        " & vbNewLine _
                                        & ",DESCRIPTION                     " & vbNewLine _
                                        & ",BATCH                           " & vbNewLine _
                                        & ",DELIVERY_QTY                    " & vbNewLine _
                                        & ",SU                              " & vbNewLine _
                                        & ",TOTAL_WT                        " & vbNewLine _
                                        & ",GI_DATE                         " & vbNewLine _
                                        & ",DELIV_DATE                      " & vbNewLine _
...
#Region "H_OUTKAEDI_L(セミEDI)同一出荷日＋届け先追加データ有りの場合の更新"
    ''' <summary>
    ''' H_OUTKAEDI_L(セミEDI)同一出荷日＋届け先追加データ有りの場合の更新
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "H_OUTKAEDI_L データ抽出用"
    ...
    Private Const L_DEF_SQL_SELECT_DATA As String = " SELECT                                                                             " & vbNewLine _
                                             ...
                                             & " --(2015.08.06) MRCデュポン 要望番号2346 修正START                                       " & vbNewLine _
                                             & ",ISNULL(MDD.SET_NAIYO,H_OUTKAEDI_L.ARR_PLAN_TIME)    AS ARR_PLAN_TIME                    " & vbNewLine _
                                             & " --(2015.08.06) MRCデュポン 要望番号2346 修正END                                         " & vbNewLine _
                                             ...
                                             & " --(2015.08.06) MRCデュポン 要望番号2346 追加START                                       " & vbNewLine _
                                             & " LEFT JOIN                                                                               " & vbNewLine _
                                             & " $LM_MST$..M_DEST_DETAILS       MDD                                                      " & vbNewLine _
                                             & " ON                                                                                      " & vbNewLine _
                                             & " H_OUTKAEDI_L.NRS_BR_CD = MDD.NRS_BR_CD                                                  " & vbNewLine _
                                             & " AND                                                                                     " & vbNewLine _
                                             & " H_OUTKAEDI_L.CUST_CD_L = MDD.CUST_CD_L                                                  " & vbNewLine _
                                             & " AND                                                                                     " & vbNewLine _
                                             & " H_OUTKAEDI_L.DEST_CD = MDD.DEST_CD                                                      " & vbNewLine _
                                             & " AND                                                                                     " & vbNewLine _
                                             & " MDD.SUB_KB = '12'                                                                       " & vbNewLine _
                                             & " AND                                                                                     " & vbNewLine _
                                             & " MDD.SYS_DEL_FLG   = '0'                                                                 " & vbNewLine _
                                             & " --(2015.08.06) MRCデュポン 要望番号2346 追加END                                         " & vbNewLine _
                                             & " WHERE                                                                                   " & vbNewLine _
...
#Region "H_OUTKAEDI_Mデータ抽出用"
    ...
    Private Const M_DEF_SQL_SELECT_DATA As String = " SELECT                                                             " & vbNewLine _
                                        ...
                                        & ",'0'                                             AS  SYS_DEL_FLG              " & vbNewLine _
                                        & ",ISNULL(M_DEST_DETAILS_10.SET_NAIYO,'')          AS  SAGYO_KB_1               " & vbNewLine _
                                        & ",ISNULL(M_DEST_DETAILS_11.SET_NAIYO,'')          AS  SAGYO_KB_2               " & vbNewLine _
                                        & " FROM                                                                         " & vbNewLine _
                                        & " $LM_TRN$..H_OUTKAEDI_M                                                       " & vbNewLine _
                                        ...
                                        & " --(2015.06.09) Ｍ・Ｒ・Ｃデュポン　修正START　届け先明細を取得する           " & vbNewLine _
                                        & " LEFT JOIN                                                                    " & vbNewLine _
                                        & " $LM_MST$..M_DEST_DETAILS    M_DEST_DETAILS_10                                " & vbNewLine _
                                        & " ON                                                                           " & vbNewLine _
                                        & " H_OUTKAEDI_L.NRS_BR_CD = M_DEST_DETAILS_10.NRS_BR_CD                         " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
                                        & " H_OUTKAEDI_L.CUST_CD_L = M_DEST_DETAILS_10.CUST_CD_L                         " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
                                        & " H_OUTKAEDI_L.DEST_CD = M_DEST_DETAILS_10.DEST_CD                             " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
                                        & " M_DEST_DETAILS_10.SUB_KB = '10'                                              " & vbNewLine _
                                        & " LEFT JOIN                                                                    " & vbNewLine _
                                        & " $LM_MST$..M_DEST_DETAILS    M_DEST_DETAILS_11                                " & vbNewLine _
                                        & " ON                                                                           " & vbNewLine _
                                        & " H_OUTKAEDI_L.NRS_BR_CD = M_DEST_DETAILS_11.NRS_BR_CD                         " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
                                        & " H_OUTKAEDI_L.CUST_CD_L = M_DEST_DETAILS_11.CUST_CD_L                         " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
                                        & " H_OUTKAEDI_L.DEST_CD = M_DEST_DETAILS_11.DEST_CD                             " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
                                        & " M_DEST_DETAILS_11.SUB_KB = '11'                                              " & vbNewLine _
                                        & " --(2015.06.09) Ｍ・Ｒ・Ｃデュポン　修正END　届け先明細を取得する             " & vbNewLine _
                                        & " WHERE                                                                        " & vbNewLine _
                                        & " H_OUTKAEDI_L.SYS_DEL_FLG  = '0'                                              " & vbNewLine _
                                        & " AND                                                                          " & vbNewLine _
...
#Region "商品マスタ"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC115.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC115.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectDataMgoods", cmd)
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC115.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC115.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectDataMdestOutkaToroku", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectDataZkbn", cmd)
...
#Region "区分マスタ 変換商品コード取得"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectMkbnMRC(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SQL_SELECT_Z_KBN_CHK)

        Dim dt As DataTable = ds.Tables("LMH030_GOODS_ZKBN_CHK")
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CHK_GOODS_CD_CUST", dt.Rows(0).Item("CHK_GOODS_CD_CUST"), DBDataType.CHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectMkbnMRC", cmd)
        ...
        map.Add("GET_GOODS_CD_CUST", "GET_GOODS_CD_CUST")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_GOODS_ZKBN_CHK")
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SQL_SELECT_CANCEL_DATA)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    Private Function SelectCompareData(ByVal ds As DataSet) As DataSet
        ...
        'スキーマ設定
        sql = Me.SetSchemaNm(LMH030DAC115.SQL_SELECT_COMPARE_CHECK_MRC, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC115.SQL_WHERE_M_CUST_DETAILS_ALL)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC115.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC115.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC115.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC115.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI：受信テーブル取消更新)"
    ...
    Private Function UpdateDelRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Dim sql As String = Me.SetSchemaNm(LMH030DAC115.SQL_UPDATE_DEL_OUTKAIEDI_DTL, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateDelRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_UPDATE_EDIT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateEditOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_UPDATE_EDIT_OUTKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateEditOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一出荷日＋届け先追加データ有りの場合の更新"
    ...
    Private Function UpdateRevivalOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_UPDATE_REVIVAL_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateRevivalOutkaEdiL", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC115.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "SelectEdiM", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC115.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC115.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC115.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC115", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertMDestData", cmd)
...
#Region "EDI受信(DTL)同一パラメータ設定"
    ...
    Private Sub SetCompareDataParameter(ByVal ds As DataSet)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHUKKA_BI", Left(Replace(Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)).ToString(), "/", String.Empty), 8), DBDataType.CHAR))
        '納期
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NOUKI", Left(Replace(Me.NullConvertZero(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)).ToString(), "/", String.Empty), 8), DBDataType.CHAR))
        '備考
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = String.Empty
        sql = Me.SetSchemaNm(LMH030DAC115.SQL_INSERT_OUTKAEDI_DTL_MRC, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC115", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal setDs As DataSet, ByVal prmList As ArrayList)
        ...
        'EDI受信（DTL）荷主個別項目(ＭＲＣデュポン)
        '※2021/08/31までの受信ファイル用
        '※2021/09/01以降は未使用項目となるので初期値をセット
        prmList.Add(MyBase.GetSqlParameter("@SOKO_CD", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@KEIYAKUSAKI_CD", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@TORIHIKI_NO", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@SHUKKASAKI_CD", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@SHUKKASAKI_NM", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@ADDRESS", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@SEIHIN_BUNRUI", String.Empty, DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@GOODS_NM", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@SIKICHOU_NM", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@KYAKUSAKI_HINBAN", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@SASIZU_SURYO", "0", DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@SASIZU_SURYO_TANI", String.Empty, DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@KANRI_SURYO", "0", DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@KANRI_SURYO_TANI", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@LOT_NO_SITEI", String.Empty, DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@SHUKKA_BI", String.Empty, DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@NOUKI", String.Empty, DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@BIKO", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@SITEI_TRUCK", String.Empty, DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@UKEHARAI_KBN", String.Empty, DBDataType.CHAR))

        'EDI受信（DTL）荷主個別項目(ＭＲＣデュポン)
        '※2021/09/01からの受信ファイル用
        prmList.Add(MyBase.GetSqlParameter("@DELIVERY", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_1")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@PLNT", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_2")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@SHIP_TO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_3")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@SHIP_TO_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_4")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@SHIP_TO_LOCA", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_5")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@TRSPRT_ID", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_6")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@MATERIAL", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_7")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@DESCRIPTION", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_8")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@BATCH", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_9")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@DELIVERY_QTY", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_10")), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@SU", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_11")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@TOTAL_WT", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_12")), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@GI_DATE", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_13")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@DELIV_DATE", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_14")), DBDataType.CHAR))
