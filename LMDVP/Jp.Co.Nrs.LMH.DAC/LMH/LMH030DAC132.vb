...
#Region "UNSO_L"
    ...
    Private Const SQL_INSERT_UNSO_L_CBAYUSO As String = "INSERT INTO $LM_TRN$..F_UNSO_L" & vbNewLine _
                                              & "(                             " & vbNewLine _
                                              & " NRS_BR_CD                    " & vbNewLine _
                                              & ",UNSO_NO_L                    " & vbNewLine _
                                              & ",YUSO_BR_CD                   " & vbNewLine _
...
#Region "M_DEST INSERT"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_DICUNSO As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#Region "M_DEST(ディック運送専用)UPDATE(届先項目差異有りの場合)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_DICUNSO As String = "UPDATE $LM_MST$..M_DEST SET    " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & "--,ZIP               = @ZIP              " & vbNewLine _
...
#Region "SELECT_F_UNSO_L"
    Private Const SQL_SELECT_F_UNSO_L As String = " SELECT                                        " & vbNewLine _
                                     ...
                                     & "   AND F_UNSO_L.DENP_NO     = @CUST_ORD_NO                " & vbNewLine _
                                     & "   AND F_UNSO_L.NRS_BR_CD   = @NRS_BR_CD                  " & vbNewLine _
                                     & "   AND F_UNSO_L.CUST_CD_L   = @CUST_CD_L                  " & vbNewLine _
                                     & "   AND F_UNSO_L.CUST_CD_M   = @CUST_CD_M                  " & vbNewLine
#End Region
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectEdiM", cmd)
...
#Region "登録前の事前チェック"
    ...
    Private Function EntryBeforeCheck(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.SQL_SELECT_ENTRY_BEFORE)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "EntryBeforeCheck", cmd)
...
#Region "出荷(大)データ(オーダー番号チェック用)"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.SQL_SELECT_C_OUTKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectDataOrderCheck", cmd)
...
#Region "運送(大)データ(オーダー番号チェック用)　ADD 2018/09/12 依頼番号 : 002436   【LMS】千葉東レ_セミEDI運送バグ"
    ...
    Private Function SelectOrderCheckUnsoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.SQL_SELECT_F_UNSO_L)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC132.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC132.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC132.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC132.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateEdiRcvDtlData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        setSql = SQL_UPDATE_M_DEST_DICUNSO
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateMDestData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        cmd = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_UNSO_L_CBAYUSO _
                                                           , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))

        'パラメータ設定
        Call Me.SetDataInsertParameter(Me._SqlPrmList)
        Call Me.SetUnsoLComParameterCbaYuso(Me._Row, Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    ''' <summary>
    ''' 届先マスタ新規登録(届先コードまたはEDI届け先コードを元に新規登録)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_M_DEST_DICUNSO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertMDestData", cmd)
...
#Region "運送(大)パラメータ設定"
    ...
    Private Sub SetUnsoLComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'prmList.Add(MyBase.GetSqlParameter("@ORIG_CD", .Item("ORIG_CD").ToString(), DBDataType.CHAR))
            ''2012.06.18 追加END
...
#Region "運送(大)パラメータ設定(DIC千葉輸送専用)"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetUnsoLComParameterCbaYuso(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@TRIP_NO_TYUKEI", .Item("TRIP_NO_TYUKEI").ToString(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TRIP_NO_HAIKA", .Item("TRIP_NO_HAIKA").ToString(), DBDataType.CHAR))
            '2013.01.28 DIC千葉輸送専用 ORIGはFREE_C03をセットするSTART
            prmList.Add(MyBase.GetSqlParameter("@ORIG_CD", .Item("ORIG_CD").ToString(), DBDataType.CHAR))
            '2013.01.28 DIC千葉輸送専用 ORIGはFREE_C03をセットするEND
...
#If True Then   'ADD 2018/09/12 依頼番号 : 002436   【LMS】千葉東レ_セミEDI運送バグ

#Region "運送パラメータ設定(オーダー番号チェック用)"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetUnsoParameterL(ByVal dt As DataTable)
...
#Region "届先マスタ更新パラメータ設定(ディック共同配送専用)"
...
#Region "届先マスタ自動追加用パラメータ設定(ディック共同配送専用)"
...
#Region "届先マスタ(DIC千葉輸送専用ORIG情報取得)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDicYusoOrigData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.SQL_SELECT_M_DEST)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetMdestOrigParameter(dtL, dtM, 1)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC132.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectDicYusoOrigData", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_M_DEST_ORIG")

            '処理件数の設定
            destCnt = ds.Tables("LMH030_M_DEST_ORIG").Rows.Count
...
#Region "届先マスタ(DIC千葉輸送専用ORIG情報取得)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDicYusoOrigEditData(ByVal ds As DataSet) As DataSet
        ...
        If String.IsNullOrEmpty(dtM.Rows(0).Item("FREE_C03").ToString()) = True Then
        ...
        'パラメータ設定
        Call Me.SetMdestOrigParameter(dtL, dtM, 2)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectDicYusoOrigEditData", cmd)
...
#Region "届先マスタ抽出パラメータ設定(DIC千葉輸送ORIG専用)"
    ''' <summary>
    ''' 届先マスタのパラメータ設定
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetMdestOrigParameter(ByVal dtL As DataTable, ByVal dtM As DataTable, ByVal prmEditFlg As Integer)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dtL.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", dtL.Rows(0).Item("CUST_CD_L"), DBDataType.CHAR))

        If prmEditFlg = 1 Then
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD", dtM.Rows(0).Item("FREE_C03"), DBDataType.NVARCHAR))
        ElseIf prmEditFlg = 2 Then
            If String.IsNullOrEmpty(dtM.Rows(0).Item("FREE_C03").ToString()) = False Then

                Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_CD", String.Concat(Left(dtM.Rows(0).Item("FREE_C03").ToString(), 2), "*"), DBDataType.NVARCHAR))
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC132.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC132.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC132.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectDataMgoods", cmd)
...
#Region "EDI出荷(大)テーブル件数確認(セミEDI)"
    Private Function SelectOutkaEdiLCount(ByVal setDs As DataSet) As DataSet
        ...
        'EDI出荷（大）の件数取得
        'SQL（EDI出荷（大））の件数取得
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_SELECT_H_OUTKA_L_COUNT, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "SelectOutkaEdiLCount", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC132.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC132.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet
        ...
        sSql = LMH030DAC132.SQL_UPDATE_DEL_OUTKAEDI_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC132.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_KTK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC132.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_H_OUTKAEDI_DTL_ITW").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC132", "InsertOutkaEdiRcvDtl", cmd)
