...
#Region "H_OUTKAEDI_DTL_XXX(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",SALES_PERSON	     " & vbNewLine _
                                        & ",SLIP_INPUT_PERSON	     " & vbNewLine _
                                        ...
                                        & ",GOODS_CAPACITY	     " & vbNewLine _
                                        & ",JAN_CD	     " & vbNewLine _
                                        & ",LOT_NO	     " & vbNewLine _
                                        & ",OUTKA_TTL_NB	     " & vbNewLine _
                                        & ",TRAN_UNIT	     " & vbNewLine _
                                        & ",CUST_ORD_NO_DTL2	     " & vbNewLine _
                                        & ",REMARK	     " & vbNewLine _
                                        & ",RECORD_STATUS	     " & vbNewLine _
                                        & ",JISSEKI_SHORI_FLG	     " & vbNewLine _
                                        & ",JISSEKI_USER	     " & vbNewLine _
...
#Region "SELECT_H_OUTKAEDI_L_COUNT"
    Private Const SQL_SELECT_H_OUTKA_L_COUNT As String _
                    = "SELECT                                                     " & vbNewLine _
                    & "    COUNT(0)                    AS DATA_COUNT              " & vbNewLine _
                    & "FROM $LM_TRN$..H_OUTKAEDI_L OUTKAEDIL                      " & vbNewLine _
                    ...
                    & "WHERE                                                      " & vbNewLine _
                    & "(OUTKAEDIL.DEL_KB = '0' AND                                " & vbNewLine _
                    & "(OUTKAL.SYS_DEL_FLG = '0' OR OUTKAL.SYS_DEL_FLG IS NULL))  " & vbNewLine _
                    & "AND OUTKAEDIL.NRS_BR_CD = @NRS_BR_CD                       " & vbNewLine _
                    & "AND OUTKAEDIL.CUST_ORD_NO = @CUST_ORD_NO                   " & vbNewLine _
                    & "AND OUTKAEDIL.CUST_CD_L = @CUST_CD_L                       " & vbNewLine
#End Region
...
#Region "WHERE1_M_GOODS(セミEDI時)"
    Private Const SQL_WHERE1_M_GOODS As String = _
                                     ...
                                     & " M_GOODS.NRS_BR_CD     = @NRS_BR_CD                 " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS.CUST_CD_L = '00555'                        " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
...
#Region "運送登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC120.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC120.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_OUTKA_M _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
...
#Region "H_OUTKAEDI_L"
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                ...
                setSql = LMH030DAC120.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC120.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                ...
                setSql = LMH030DAC120.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateEdiRcvDtlData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateMDestData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_M_DEST_KTK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertMDestData", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC120.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "SelectOutkaEdiRcvCancel", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_ITW")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC120.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC120.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC120.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "SelectDataMgoods", cmd)
...
#Region "EDI出荷(大)テーブル件数確認(セミEDI)"
    Private Function SelectOutkaEdiLCount(ByVal setDs As DataSet) As DataSet
        ...
        'EDI出荷（大）の件数取得
        'SQL（EDI出荷（大））の件数取得
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_SELECT_H_OUTKA_L_COUNT, Me._Row.Item("NRS_BR_CD").ToString()))

        'パラメータ設定
        Call Me.SetSelecOutkaEdiLParameter(Me._Row, Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "SelectOutkaEdiLCount", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            Call Me.SetDataCountMap(reader, map)

            setDs = MyBase.SetSelectResultToDataSet(map, setDs, reader, "DATA_COUNT")
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC120.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC120.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet
        ...
        sSql = LMH030DAC120.SQL_UPDATE_DEL_OUTKAEDI_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC120.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_KTK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_H_OUTKAEDI_DTL_ITW")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC120.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_H_OUTKAEDI_DTL_ITW").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC120", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@DEST_FAX", Me.NullConvertString(.Item("DEST_FAX")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO_DTL", Me.NullConvertString(.Item("CUST_ORD_NO_DTL")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SALES_PERSON", Me.NullConvertString(.Item("SALES_PERSON")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SLIP_INPUT_PERSON", Me.NullConvertString(.Item("SLIP_INPUT_PERSON")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_DATE", Me.NullConvertString(.Item("OUTKA_PLAN_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ORDER_DATE", Me.NullConvertString(.Item("ORDER_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_DATE", Me.NullConvertString(.Item("ARR_PLAN_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_TIME", Strings.Right(String.Concat("0", Me.NullConvertString(.Item("ARR_PLAN_TIME"))), 5), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CAPACITY", Me.NullConvertString(.Item("GOODS_CAPACITY")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JAN_CD", Me.NullConvertString(.Item("JAN_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_NB", Me.NullConvertString(.Item("OUTKA_TTL_NB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TRAN_UNIT", Me.NullConvertString(.Item("TRAN_UNIT")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO_DTL2", Me.NullConvertString(.Item("CUST_ORD_NO_DTL2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@REMARK", Me.NullConvertString(.Item("REMARK")), DBDataType.CHAR))
...
#Region "EDI出荷(大)件数取得パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetSelecOutkaEdiLParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        With conditionRow
            prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(.Item("NRS_BR_CD")), DBDataType.CHAR))
...
#Region "対象データ件数をHashTableに設定"
    Private Function SetDataCountMap(ByVal reader As SqlDataReader, ByVal map As Hashtable) As Hashtable
