...
#Region "SAGYO"
    ...
    Private Const SQL_INSERT_SAGYO As String = "INSERT INTO                                          " & vbNewLine _
                                         ...
                                         & "-- UPD START 2023/08/17 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定 " & vbNewLine _
                                         & "-- ,@SAGYO_GK                                               " & vbNewLine _
                                         & ",ROUND((@SAGYO_NB * M_SAGYO.SAGYO_UP), 0)                " & vbNewLine _
                                         & "-- UPD END 2023/08/17 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定 " & vbNewLine _
...
#End Region
    ...
    ''現場要望(要望番号922 2012.03.29 修正START(まとめ処理：買主注文番号連結)
...
#End Region
    ''現場要望(要望番号922 2012.03.29 修正END(まとめ処理：買主注文番号連結)
...
#Region "H_OUTKAEDI_DTL_DSP(INSERT)"
    ...
    Private Const SQL_INSERT_H_OUTKAEDI_DTL_DSP As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",PRTFLG  " & vbNewLine _
                                        & ",ZIF_DENSYUBETU  " & vbNewLine _
                                        & ",ZIF_NYUKABI  " & vbNewLine _
                                        & ",ZIF_HARAI  " & vbNewLine _
                                        & ",ZIF_WVFBSPDNR  " & vbNewLine _
                                        & ",ZIF_NAME1  " & vbNewLine _
                                        & ",ZIF_SYUKASAKI  " & vbNewLine _
                                        & ",ZIF_TORIHIKI  " & vbNewLine _
                                        & ",ZIF_HYOJYUNNO  " & vbNewLine _
                                        & ",ZIF_SEIRI1  " & vbNewLine _
                                        & ",ZIF_CANCEL  " & vbNewLine _
                                        & ",ZIF_SEIRI2  " & vbNewLine _
                                        & ",ZIF_DENTYPE  " & vbNewLine _
                                        & ",ZIF_SYUBETU  " & vbNewLine _
                                        & ",ZIF_GYOUMU  " & vbNewLine _
                                        & ",ZIF_TAITLEA  " & vbNewLine _
                                        & ",ZIF_TAITLEB  " & vbNewLine _
                                        & ",ZIF_DENNO  " & vbNewLine _
                                        & ",ZIF_TORNAME1  " & vbNewLine _
                                        & ",ZIF_TORNAME2  " & vbNewLine _
                                        & ",FKM_K_SHN  " & vbNewLine _
                                        & ",ZIF_SOUHIJYU1  " & vbNewLine _
                                        & ",ZID_OROSIDEP  " & vbNewLine _
                                        & ",ZIF_BIKOU1  " & vbNewLine _
                                        & ",ZIF_BIKOU2  " & vbNewLine _
                                        & ",ZID_BSARK  " & vbNewLine _
                                        & ",HOUMEN  " & vbNewLine _
                                        & ",XHAISO  " & vbNewLine _
                                        & ",ZIF_HAKOUSUMI  " & vbNewLine _
                                        & ",FKM_NNY  " & vbNewLine _
                                        & ",ZIF_ONETIME  " & vbNewLine _
                                        & ",FKM_XHYO  " & vbNewLine _
                                        & ",FXM_TRSD  " & vbNewLine _
                                        & ",FXM_LNTRRD  " & vbNewLine _
                                        & ",FXM_NWJKN  " & vbNewLine _
                                        & ",FXM_UKWB  " & vbNewLine _
                                        & ",FXM_LNUKWB  " & vbNewLine _
                                        & ",FXM_KOKNM  " & vbNewLine _
                                        & ",FXM_GBHO  " & vbNewLine _
                                        & ",ZIF_CYOKU0  " & vbNewLine _
                                        & ",ZIF_CYOKU1  " & vbNewLine _
                                        & ",ZIF_CYOKU2  " & vbNewLine _
                                        & ",ZIF_CKUB  " & vbNewLine _
                                        & ",ZIF_VSBED  " & vbNewLine _
                                        & ",ZIF_BTCSHIP  " & vbNewLine _
                                        & ",ZIF_SUTETAS  " & vbNewLine _
                                        & ",ZIF_JYUFUJU  " & vbNewLine _
                                        & ",ZIF_SYORIDATE  " & vbNewLine _
                                        & ",ZIF_SYORITIME  " & vbNewLine _
                                        & ",ZIF_HAKOUDATE  " & vbNewLine _
                                        & ",ZIF_HAKOUTIME  " & vbNewLine _
                                        & ",BWART  " & vbNewLine _
                                        & ",WERKS  " & vbNewLine _
                                        & ",LGORT  " & vbNewLine _
                                        & ",ZIF_JULNO  " & vbNewLine _
                                        & ",MATNR  " & vbNewLine _
                                        & ",FXM_SP_CD  " & vbNewLine _
                                        & ",CHO  " & vbNewLine _
                                        & ",FXM_CD_THIN  " & vbNewLine _
                                        & ",FXM_GIMU  " & vbNewLine _
                                        & ",CHRG  " & vbNewLine _
                                        & ",VFDAT  " & vbNewLine _
                                        & ",ZIF_FUGOU  " & vbNewLine _
                                        & ",FKIMG  " & vbNewLine _
                                        & ",FXM_RYO_KNP  " & vbNewLine _
                                        & ",FXM_RYO_BR  " & vbNewLine _
                                        & ",ZIF_BARAFG  " & vbNewLine _
                                        & ",ZIF_UKE  " & vbNewLine _
                                        & ",ZIF_ZAIKOKUBUN  " & vbNewLine _
                                        & ",ZIF_TEKIYOU1  " & vbNewLine _
                                        & ",ZIF_TEKIYOU2  " & vbNewLine _
                                        & ",ZIF_YOBIKUB1  " & vbNewLine _
                                        & ",ZIF_YOBIKUB2  " & vbNewLine _
                                        & ",ZIF_YUKOU  " & vbNewLine _
                                        & ",MAKTX  " & vbNewLine _
                                        & ",HAISOUSAKI_CD  " & vbNewLine _
                                        & ",HIN  " & vbNewLine _
                                        & ",T_KBN  " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DSP(取込削除時)"
...
#Region "SELECT_C_OUTKA_L(オーダー番号重複チェック用)"
    Private Const SQL_SELECT_C_OUTKA_L As String = " SELECT                                       " & vbNewLine _
                                     ...
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_L.OUTKA_PLAN_DATE   = @OUTKA_PLAN_DATE           " & vbNewLine

#End Region
    '要望番号:1159　対応　2012.06.28 End

    'ADD START 2023/08/17 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定
#Region "作業コード設定チェック用SQL"
...
#End Region
    'ADD END 2023/08/17 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定

    'ADD START 2023/08/09 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定
#Region "作業コード設定チェック用SQL"
    Private Const SQL_SELECT_C_OUTKA_M_SAGYOCDSETCHECK As String = " SELECT     " & vbNewLine _
                                     & " COUNT(*)  AS OUTKA_M_CNT               " & vbNewLine _
                                     & " FROM                                   " & vbNewLine _
                                     ...
                                     & " AND                                    " & vbNewLine _
                                     & " C_OUTKA_M.OUTKA_NO_L  = @OUTKA_NO_L    " & vbNewLine _
                                     & " AND                                    " & vbNewLine _
                                     & " C_OUTKA_M.OUTKA_HASU  >= 1             " & vbNewLine
#End Region
    'ADD END 2023/08/09 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定

    'ADD START 2023/07/14 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定
#Region "荷主明細マスタ抽出用SQL"
    Private Const SQL_SELECT_M_CUST_DETAILS As String = " SELECT                        " & vbNewLine _
                                     ...
                                     & " AND                                            " & vbNewLine _
                                     & " M_CUST_DETAILS.SUB_KB     = 'B3'               " & vbNewLine _
                                     & " AND                                            " & vbNewLine _
                                     & " M_CUST_DETAILS.CUST_CLASS = '00'               " & vbNewLine _
                                     & " AND                                            " & vbNewLine _
                                     & " M_CUST_DETAILS.SET_NAIYO  = '1'                " & vbNewLine _
                                     ...
                                     & ",REMARK                                         " & vbNewLine
#End Region
    'ADD END 2023/07/14 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNcgoMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC206.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectDataNcgoMdest", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectRcvDtlDspComTorikesi(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inDtlTbl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_DSPCOM")



        'INTableの条件rowの格納
        Me._Row = inDtlTbl.Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_TORIKESI_DTL)      'SQL構築
        Call Me.setSQLSelectRcvDelData(Me._Row, Me._SqlPrmList)                      '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectRcvDtlDspComTorikesi", cmd)
        ...
        map.Add("OUTKA_CTL_NO", "OUTKA_CTL_NO")
        map.Add("NRS_BR_CD", "NRS_BR_CD")
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_DSPCOM_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_DSPCOM_CANCELOUT").Rows.Count())
        reader.Close()
    ...
    '''' <param name="ds"></param>
    '''' <returns></returns>
    '''' <remarks>EDI荷主マスタから受信テーブル名を取得する</remarks>
    'Private Function GetDtlTblNm(ByVal ds As DataSet) As String

    '    'SQL格納変数の初期化
    '    Me._StrSql = New StringBuilder()

    '    Me._StrSql.Append(LMH030DAC.SQL_SELECT_DTLTBL_NM)

    '    Dim dt As DataTable = ds.Tables("LMH030_SEMIEDI_INFO")

    '    Me._SqlPrmList = New ArrayList()

    '    'パラメータ設定
    '    Call Me.SetEdiCustPrm(dt)
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC206", "GetDtlTblNm", cmd)

    '    'SQLの発行
    '    Dim reader As SqlDataReader = MyBase.GetSelectResult(cmd)

    '    If reader.Read() = True Then
    '        Dim rtnFlg As String = reader("RCV_NM_DTL").ToString().Trim()
    '        reader.Close()
    '        Return rcvNmDtl
    '    End If
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectDataMgoodsOutka(ByVal ds As DataSet) As DataSet
        ...
        Dim rcvDtlDt As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_DSPCOM")
        Dim semiInfoDr As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        'Dim semiInfoDr As DataRow = ds.Tables("LMH030_SEMIEDI_INFO")

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC206.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC206.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectDataMgoods", cmd)
...
#Region "オーダー番号チェック：大日本住友製薬専用"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_C_OUTKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectDataOrderCheck", cmd)
...
#Region "作業項目マスタ抽出"
    ...
    Private Function SelectMSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_M_SAGYO)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetMSagyoParameter(dt)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectMSagyo", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            '処理件数の設定
            custDtlCnt = ds.Tables("LMH030_M_SAGYO").Rows.Count
...
#Region "作業コード設定チェック"
    ''' <summary>
    ''' 作業コード設定チェック用件数取得処理(C_OUTKA_M)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectSagyoCdSetCheckData(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_C_OUTKA_M_SAGYOCDSETCHECK)

        Dim dt As DataTable = ds.Tables("LMH030_C_OUTKA_L")

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetSagyoCdSetCheckParameter(dt)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectSagyoCdSetCheckData", cmd)
        ...
        '処理件数の設定
        reader.Read()
        MyBase.SetResultCount(Convert.ToInt32(reader("OUTKA_M_CNT")))
        reader.Close()
        Return ds
...
#Region "荷主明細マスタ抽出"
    ...
    Private Function SelectListDataMcustDetails(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_M_CUST_DETAILS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "SelectListDataMcustDetails", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC206.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateEdiDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        setSql = LMH030DAC206.SQL_UPDATE_OUTKASEMIEDI_DEL_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateEdiDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC206.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateEdiDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        setSql = LMH030DAC206.SQL_UPDATE_OUTKASEMIEDI_DEL_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateEdiDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC206.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateEdiDelRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH030DAC206.SQL_UPDATE_SEMIEDI_DEL_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateEdiDelRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC206.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC206.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC206.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertOutkaLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiLData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_H_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertOutkaEdiLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC206", "UpdateOutkaMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiMData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_H_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertOutkaEdiMData", cmd)
...
#End Region
    ...
    '2012.03.12 大阪対応START
#Region "H_OUTKAEDI_DTL_DSP(セミEDI)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function InsertEdiRcvDtlData(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_DSPCOM")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_H_OUTKAEDI_DTL_DSP, setDs.Tables("LMH030_OUTKAEDI_DTL_DSPCOM").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        'パラメータ設定
        Call Me.SetEdiRcvDtlComParameter(Me._Row, Me._SqlPrmList)
        Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertEdiRcvDtlData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC206.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC206", "InsertMDestData", cmd)
...
#Region "EDI受信DTLテーブル名設定"
    ...
    Private Function SetRcvDtlTableNmEDI(ByVal dr As DataRow, ByVal sql As String) As String
        ...
        'Dim ediCustIndex As String = dr.Item("EDI_CUST_INDEX").ToString()
        'Select Case ediCustIndex
        '    Case "82"   '医薬品の場合
        '        rcvTblNm = "H_OUTKAEDI_DTL_DSP"
        '    Case "85"   '動物薬の場合
        '        rcvTblNm = "H_OUTKAEDI_DTL_DSPAH"
        'End Select
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiRcvDtlComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@ZIF_DENSYUBETU", Me.NullConvertString(.Item("ZIF_DENSYUBETU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_NYUKABI", Me.NullConvertString(.Item("ZIF_NYUKABI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HARAI", Me.NullConvertString(.Item("ZIF_HARAI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_WVFBSPDNR", Me.NullConvertString(.Item("ZIF_WVFBSPDNR")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_NAME1", Me.NullConvertString(.Item("ZIF_NAME1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYUKASAKI", Me.NullConvertString(.Item("ZIF_SYUKASAKI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TORIHIKI", Me.NullConvertString(.Item("ZIF_TORIHIKI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HYOJYUNNO", Me.NullConvertString(.Item("ZIF_HYOJYUNNO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SEIRI1", Me.NullConvertString(.Item("ZIF_SEIRI1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CANCEL", Me.NullConvertString(.Item("ZIF_CANCEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SEIRI2", Me.NullConvertString(.Item("ZIF_SEIRI2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_DENTYPE", Me.NullConvertString(.Item("ZIF_DENTYPE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYUBETU", Me.NullConvertString(.Item("ZIF_SYUBETU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_GYOUMU", Me.NullConvertString(.Item("ZIF_GYOUMU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TAITLEA", Me.NullConvertString(.Item("ZIF_TAITLEA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TAITLEB", Me.NullConvertString(.Item("ZIF_TAITLEB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_DENNO", Me.NullConvertString(.Item("ZIF_DENNO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TORNAME1", Me.NullConvertString(.Item("ZIF_TORNAME1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TORNAME2", Me.NullConvertString(.Item("ZIF_TORNAME2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKM_K_SHN", Me.NullConvertString(.Item("FKM_K_SHN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SOUHIJYU1", Me.NullConvertString(.Item("ZIF_SOUHIJYU1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZID_OROSIDEP", Me.NullConvertString(.Item("ZID_OROSIDEP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BIKOU1", Me.NullConvertString(.Item("ZIF_BIKOU1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BIKOU2", Me.NullConvertString(.Item("ZIF_BIKOU2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZID_BSARK", Me.NullConvertString(.Item("ZID_BSARK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HOUMEN", Me.NullConvertString(.Item("HOUMEN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@XHAISO", Me.NullConvertString(.Item("XHAISO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HAKOUSUMI", Me.NullConvertString(.Item("ZIF_HAKOUSUMI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKM_NNY", Me.NullConvertString(.Item("FKM_NNY")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_ONETIME", Me.NullConvertString(.Item("ZIF_ONETIME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKM_XHYO", Me.NullConvertString(.Item("FKM_XHYO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_TRSD", Me.NullConvertString(.Item("FXM_TRSD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_LNTRRD", Me.NullConvertString(.Item("FXM_LNTRRD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_NWJKN", Me.NullConvertString(.Item("FXM_NWJKN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_UKWB", Me.NullConvertString(.Item("FXM_UKWB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_LNUKWB", Me.NullConvertString(.Item("FXM_LNUKWB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_KOKNM", Me.NullConvertString(.Item("FXM_KOKNM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_GBHO", Me.NullConvertString(.Item("FXM_GBHO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CYOKU0", Me.NullConvertString(.Item("ZIF_CYOKU0")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CYOKU1", Me.NullConvertString(.Item("ZIF_CYOKU1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CYOKU2", Me.NullConvertString(.Item("ZIF_CYOKU2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_CKUB", Me.NullConvertString(.Item("ZIF_CKUB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_VSBED", Me.NullConvertString(.Item("ZIF_VSBED")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BTCSHIP", Me.NullConvertString(.Item("ZIF_BTCSHIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SUTETAS", Me.NullConvertString(.Item("ZIF_SUTETAS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_JYUFUJU", Me.NullConvertString(.Item("ZIF_JYUFUJU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYORIDATE", Me.NullConvertString(.Item("ZIF_SYORIDATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_SYORITIME", Me.NullConvertString(.Item("ZIF_SYORITIME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HAKOUDATE", Me.NullConvertString(.Item("ZIF_HAKOUDATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_HAKOUTIME", Me.NullConvertString(.Item("ZIF_HAKOUTIME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BWART", Me.NullConvertString(.Item("BWART")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@WERKS", Me.NullConvertString(.Item("WERKS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LGORT", Me.NullConvertString(.Item("LGORT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_JULNO", Me.NullConvertString(.Item("ZIF_JULNO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MATNR", Me.NullConvertString(.Item("MATNR")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_SP_CD", Me.NullConvertString(.Item("FXM_SP_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHO", Me.NullConvertString(.Item("CHO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_CD_THIN", Me.NullConvertString(.Item("FXM_CD_THIN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FXM_GIMU", Me.NullConvertString(.Item("FXM_GIMU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHRG", Me.NullConvertString(.Item("CHRG")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@VFDAT", Me.NullConvertString(.Item("VFDAT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_FUGOU", Me.NullConvertString(.Item("ZIF_FUGOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@FKIMG", Me.NullConvertZero(.Item("FKIMG")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FXM_RYO_KNP", Me.NullConvertZero(.Item("FXM_RYO_KNP")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FXM_RYO_BR", Me.NullConvertZero(.Item("FXM_RYO_BR")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_BARAFG", Me.NullConvertString(.Item("ZIF_BARAFG")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_UKE", Me.NullConvertString(.Item("ZIF_UKE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_ZAIKOKUBUN", Me.NullConvertString(.Item("ZIF_ZAIKOKUBUN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TEKIYOU1", Me.NullConvertString(.Item("ZIF_TEKIYOU1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_TEKIYOU2", Me.NullConvertString(.Item("ZIF_TEKIYOU2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_YOBIKUB1", Me.NullConvertString(.Item("ZIF_YOBIKUB1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_YOBIKUB2", Me.NullConvertString(.Item("ZIF_YOBIKUB2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZIF_YUKOU", Me.NullConvertString(.Item("ZIF_YUKOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MAKTX", Me.NullConvertString(.Item("MAKTX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISOUSAKI_CD", Me.NullConvertString(.Item("HAISOUSAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HIN", Me.NullConvertString(.Item("HIN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@T_KBN", Me.NullConvertString(.Item("T_KBN")), DBDataType.NVARCHAR))
...
#Region "作業更新パラメータ設定"
    ...
    Private Sub SetSagyoParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'prmList.Add(MyBase.GetSqlParameter("@SAGYO_GK", .Item("SAGYO_GK").ToString(), DBDataType.NUMERIC)) 'DEL 2023/08/17 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetGoodsSemiParameter(ByVal semiInfoDr As DataRow, ByVal rcvDtlDt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(rcvDtlDt.Rows(0).Item("MATNR")), DBDataType.NVARCHAR))
...
#Region "作業項目マスタパラメータ設定"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetMSagyoParameter(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", dt.Rows(0).Item("CUST_CD_L").ToString().Trim(), DBDataType.CHAR))
...
#End Region
    ...
    'ADD START 2023/08/09 037987 住友ファーマ 端数出荷時出荷オーダー単位の作業コード設定
#Region "作業コード設定チェック用件数取得処理のパラメータ設定"
    ''' <summary>
    ''' 作業コード設定チェック用件数取得処理のパラメータ設定
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSagyoCdSetCheckParameter(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_NO_L", dt.Rows(0).Item("OUTKA_NO_L"), DBDataType.CHAR))
...
#Region "荷主明細マスタパラメータ設定"
    ...
    Private Sub SetMcustDetailsParameter(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD", dt.Rows(0).Item("CUST_CD_L").ToString().Trim(), DBDataType.CHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC206.SQL_SELECT_M_DEST)
