...
#Region "EDI出荷データ件数および出荷データL 出荷管理番号L 等 SELECT SQL"
    ...
    Private Const SQL_SELECT_OUTKA_NO_L_AND_CNT As String = "" _
        ...
        & "AND H_OUTKAEDI_L.EDI_CTL_NO NOT IN(@EDI_CTL_NO_JOGAI)        " & vbNewLine _
        & "AND H_OUTKAEDI_L.CUST_CD_L = @CUST_CD_L                      " & vbNewLine _
        & "AND H_OUTKAEDI_L.CUST_CD_M = @CUST_CD_M                      " & vbNewLine _
        & "AND H_OUTKAEDI_L.FREE_C04 = @SYS_CHUMON_NO                   " & vbNewLine _
...
#Region "EDI出荷受信テーブル(明細) INSERT SQL"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "" _
        ...
        & "    , PRTFLG                      " & vbNewLine _
        & "    , SYS_CHUMON_NO               " & vbNewLine _
        & "    , CHUMON_NO                   " & vbNewLine _
        & "    , STATUS                      " & vbNewLine _
        & "    , ORD_MAIL_SND_DT_TM          " & vbNewLine _
        & "    , DLVY_MAIL_SND_DT_TM         " & vbNewLine _
        & "    , DENP_CSV_DL_DT_TM           " & vbNewLine _
        & "    , DOT                         " & vbNewLine _
        & "    , URI_FIXED_GK                " & vbNewLine _
        & "    , URI_FIXED_DATE              " & vbNewLine _
        & "    , GENPYO_NO                   " & vbNewLine _
        & "    , TTL_SEIQ_GK                 " & vbNewLine _
        & "    , GK_ADJUST_TITLE             " & vbNewLine _
        & "    , GK_ADJUST                   " & vbNewLine _
        & "    , WRAPPING_GK                 " & vbNewLine _
        & "    , WRAPPING_DTL                " & vbNewLine _
        & "    , PAYMENT_COMMN               " & vbNewLine _
        & "    , POINT_USE_GK                " & vbNewLine _
        & "    , COMP_ORD_CALC_KB            " & vbNewLine _
        & "    , POSTAGE                     " & vbNewLine _
        & "    , DM_POSTAGE                  " & vbNewLine _
        & "    , NEKO_POS_POSTAGE            " & vbNewLine _
        & "    , HOME_DLVY_CCT_POSTAGE       " & vbNewLine _
        & "    , HOME_DLVY_POSTAGE           " & vbNewLine _
        & "    , COOL_COMMN                  " & vbNewLine _
        & "    , ORD_DT_TM                   " & vbNewLine _
        & "    , PAYMENT_METHOD              " & vbNewLine _
        & "    , PAYMENT_METHOD_SUPPL        " & vbNewLine _
        & "    , FAMILY_NAME                 " & vbNewLine _
        & "    , FIRST_NAME                  " & vbNewLine _
        & "    , FAMILY_NAME_KANA            " & vbNewLine _
        & "    , FIRST_NAME_KANA             " & vbNewLine _
        & "    , ZIP                         " & vbNewLine _
        & "    , TODOFUKEN                   " & vbNewLine _
        & "    , SHIKUCHOSON                 " & vbNewLine _
        & "    , CHOIKI_BANCHI               " & vbNewLine _
        & "    , BLDG_ETC                    " & vbNewLine _
        & "    , CORP_NM                     " & vbNewLine _
        & "    , DEPT_NM                     " & vbNewLine _
        & "    , MAIL_ADDRESS                " & vbNewLine _
        & "    , TEL                         " & vbNewLine _
        & "    , CELL_PHONE_NMB              " & vbNewLine _
        & "    , FAX                         " & vbNewLine _
        & "    , GENDER                      " & vbNewLine _
        & "    , BIRTH_DATE                  " & vbNewLine _
        & "    , FREE_1                      " & vbNewLine _
        & "    , FREE_2                      " & vbNewLine _
        & "    , CUST_ORD_NO                 " & vbNewLine _
        & "    , MENBER_ID                   " & vbNewLine _
        & "    , USED_POINT                  " & vbNewLine _
        & "    , ACQ_POINT                   " & vbNewLine _
        & "    , DEST_SELECT                 " & vbNewLine _
        & "    , DEST_UKETORI_NM_1           " & vbNewLine _
        & "    , DEST_UKETORI_NM_2           " & vbNewLine _
        & "    , DEST_FAMILY_NAME_KANA       " & vbNewLine _
        & "    , DEST_FIRST_NAME_KANA        " & vbNewLine _
        ...
        & "    , DLVY_METHOD_NO              " & vbNewLine _
        & "    , DLVY_METHOD                 " & vbNewLine _
        & "    , DENP_NO                     " & vbNewLine _
        & "    , ARR_PLAN_DATE               " & vbNewLine _
        & "    , RECEIVE_TIME                " & vbNewLine _
        & "    , SURVEY                      " & vbNewLine _
        & "    , CUST_GOODS_CD               " & vbNewLine _
        & "    , SYS_CUST_GOODS_CD           " & vbNewLine _
        & "    , GOODS_NM                    " & vbNewLine _
        & "    , VARIATION                   " & vbNewLine _
        & "    , BIN_KB                      " & vbNewLine _
        & "    , PRICE                       " & vbNewLine _
        & "    , OUTKA_TTL_NB                " & vbNewLine _
        & "    , GK                          " & vbNewLine _
        & "    , MEMO                        " & vbNewLine _
        & "    , RECEIVE_PLACE_NM            " & vbNewLine _
        & "    , RECEIVE_PLACE_ZIP           " & vbNewLine _
        & "    , RECEIVE_PLACE_AD            " & vbNewLine _
        & "    , RECEIVE_PLACE_TEL           " & vbNewLine _
        & "    , CERT_NO                     " & vbNewLine _
        & "    , ORG_STATUS                  " & vbNewLine _
        & "    , PROXY_ORD_ROUTE             " & vbNewLine _
        & "    , PROXY_ORD_REGISTER          " & vbNewLine _
        & "    , SYS_DLVY_DEST_NO            " & vbNewLine _
        & "    , CLIENT                      " & vbNewLine _
        & "    , SALES_DET_DENP_NO           " & vbNewLine _
        & "    , GOODS_ATTR                  " & vbNewLine _
        & "    , RESERVE_ORD                 " & vbNewLine _
        & "    , COUPON_INFO                 " & vbNewLine _
        & "    , COUPON_DISCOUNT             " & vbNewLine _
        & "    , SALES_PROMO_MAIL_DLVY       " & vbNewLine _
        & "    , B2_CUSTOMER_NO              " & vbNewLine _
        & "    , DENP_OUT_UNIT               " & vbNewLine _
        & "    , BR_CD                       " & vbNewLine _
        & "    , SYUKKA_PLAN_DATE            " & vbNewLine _
        & "    , TAX_RATE_KB                 " & vbNewLine _
        & "    , TAX_RATE                    " & vbNewLine _
        & "    , DISCOUNT_SUBTOTAL_1         " & vbNewLine _
        & "    , DISCOUNT_SUBTOTAL_2         " & vbNewLine _
        & "    , DISCOUNT_SUBTOTAL_3         " & vbNewLine _
        & "    , TOTAL_1                     " & vbNewLine _
        & "    , TOTAL_2                     " & vbNewLine _
        & "    , TOTAL_3                     " & vbNewLine _
        & "    , TOTAL_4                     " & vbNewLine _
        ...
        & "    , QRURL_PARAM                 " & vbNewLine _
        & "    , UNSO_IRAI_NO                " & vbNewLine _
        & "    , YOBI_1                      " & vbNewLine _
        & "    , YOBI_2                      " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_MRCCSV"

    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_MRCCSV）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_MRCCSV SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得"
    ...
    Private Function GetOutkaCntAndNoL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_SELECT_OUTKA_NO_L_AND_CNT)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_MRCCSV")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "GetOutkaCntAndNoL", cmd)
...
#Region "EDI出荷(大)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_UPDATE_DEL_OUTKAIEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateDelOutkaEdiL", cmd)
...
#Region "EDI出荷(中)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_UPDATE_DEL_OUTKAIEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateDelOutkaEdiM", cmd)
...
#Region "EDI出荷受信テーブル(明細) 件数取得"
    ...
    Private Function GetOutkaEdiDtlCnt(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_SELECT_COUNT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "GetOutkaEdiDtlCnt", cmd)
...
#Region "EDI出荷受信テーブル(明細) 物理削除"
    ...
    Private Function DeleteOutkaEdiDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_DELETE_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "DeleteOutkaEdiDtl", cmd)
...
#Region "EDI出荷受信テーブル(明細) 新規登録"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_INSERT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "商品マスタ 件数取得"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        ' SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC159.SQL_WHERE1_M_GOODS)

        ' SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC159.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "SelectMstGoods", cmd)
...
#Region "EDI出荷(中)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_INSERT_OUTKAEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertOutkaEdiM", cmd)
...
#Region "EDI出荷(大)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_INSERT_OUTKAEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertOutkaEdiL", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC159.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "SelectDataZkbn", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC159.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC159.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_OUTKA_M _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC159.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "InsertMDestData", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC159.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(String.Concat(setSql, LMH030DAC159.SQL_COM_UPDATE_CONDITION) _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC159.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                'setSql = LMH030DAC159.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC159.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateOutkaEdiMData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC159.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC159.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC159.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC159", "UpdateMDestData", cmd)
...
#Region "SQL パラメータ設定 セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得 用"
    ...
    Private Sub SetSqlParamGetOutkaCntAndNoL(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_JOGAI", dt.Rows(0).Item("EDI_CTL_NO_JOGAI"), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_CHUMON_NO", dt.Rows(0).Item("SYS_CHUMON_NO"), DBDataType.CHAR))
    End Sub
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(明細) 新規登録 用"
    ...
    Private Sub SetSqlParamInsertOutkaEdiRcvDtl(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            ' EDI受信（DTL）荷主個別項目
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_CHUMON_NO", Me.NullConvertString(.Item("SYS_CHUMON_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CHUMON_NO", Me.NullConvertString(.Item("CHUMON_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@STATUS", Me.NullConvertString(.Item("STATUS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORD_MAIL_SND_DT_TM", Me.NullConvertString(.Item("ORD_MAIL_SND_DT_TM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DLVY_MAIL_SND_DT_TM", Me.NullConvertString(.Item("DLVY_MAIL_SND_DT_TM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_CSV_DL_DT_TM", Me.NullConvertString(.Item("DENP_CSV_DL_DT_TM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DOT", Me.NullConvertString(.Item("DOT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@URI_FIXED_GK", Me.NullConvertString(.Item("URI_FIXED_GK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@URI_FIXED_DATE", Me.NullConvertString(.Item("URI_FIXED_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GENPYO_NO", Me.NullConvertString(.Item("GENPYO_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TTL_SEIQ_GK", Me.NullConvertString(.Item("TTL_SEIQ_GK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GK_ADJUST_TITLE", Me.NullConvertString(.Item("GK_ADJUST_TITLE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GK_ADJUST", Me.NullConvertString(.Item("GK_ADJUST")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WRAPPING_GK", Me.NullConvertString(.Item("WRAPPING_GK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WRAPPING_DTL", Me.NullConvertString(.Item("WRAPPING_DTL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PAYMENT_COMMN", Me.NullConvertString(.Item("PAYMENT_COMMN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@POINT_USE_GK", Me.NullConvertString(.Item("POINT_USE_GK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@COMP_ORD_CALC_KB", Me.NullConvertString(.Item("COMP_ORD_CALC_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@POSTAGE", Me.NullConvertString(.Item("POSTAGE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DM_POSTAGE", Me.NullConvertString(.Item("DM_POSTAGE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NEKO_POS_POSTAGE", Me.NullConvertString(.Item("NEKO_POS_POSTAGE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HOME_DLVY_CCT_POSTAGE", Me.NullConvertString(.Item("HOME_DLVY_CCT_POSTAGE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HOME_DLVY_POSTAGE", Me.NullConvertString(.Item("HOME_DLVY_POSTAGE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@COOL_COMMN", Me.NullConvertString(.Item("COOL_COMMN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORD_DT_TM", Me.NullConvertString(.Item("ORD_DT_TM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PAYMENT_METHOD", Me.NullConvertString(.Item("PAYMENT_METHOD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PAYMENT_METHOD_SUPPL", Me.NullConvertString(.Item("PAYMENT_METHOD_SUPPL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FAMILY_NAME", Me.NullConvertString(.Item("FAMILY_NAME")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FIRST_NAME", Me.NullConvertString(.Item("FIRST_NAME")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FAMILY_NAME_KANA", Me.NullConvertString(.Item("FAMILY_NAME_KANA")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FIRST_NAME_KANA", Me.NullConvertString(.Item("FIRST_NAME_KANA")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ZIP", Me.NullConvertString(.Item("ZIP")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TODOFUKEN", Me.NullConvertString(.Item("TODOFUKEN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIKUCHOSON", Me.NullConvertString(.Item("SHIKUCHOSON")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CHOIKI_BANCHI", Me.NullConvertString(.Item("CHOIKI_BANCHI")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BLDG_ETC", Me.NullConvertString(.Item("BLDG_ETC")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CORP_NM", Me.NullConvertString(.Item("CORP_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEPT_NM", Me.NullConvertString(.Item("DEPT_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MAIL_ADDRESS", Me.NullConvertString(.Item("MAIL_ADDRESS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TEL", Me.NullConvertString(.Item("TEL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CELL_PHONE_NMB", Me.NullConvertString(.Item("CELL_PHONE_NMB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FAX", Me.NullConvertString(.Item("FAX")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GENDER", Me.NullConvertString(.Item("GENDER")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BIRTH_DATE", Me.NullConvertString(.Item("BIRTH_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FREE_1", Me.NullConvertString(.Item("FREE_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FREE_2", Me.NullConvertString(.Item("FREE_2")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me.NullConvertString(.Item("CUST_ORD_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MENBER_ID", Me.NullConvertString(.Item("MENBER_ID")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@USED_POINT", Me.NullConvertString(.Item("USED_POINT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ACQ_POINT", Me.NullConvertString(.Item("ACQ_POINT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_SELECT", Me.NullConvertString(.Item("DEST_SELECT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_UKETORI_NM_1", Me.NullConvertString(.Item("DEST_UKETORI_NM_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_UKETORI_NM_2", Me.NullConvertString(.Item("DEST_UKETORI_NM_2")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_FAMILY_NAME_KANA", Me.NullConvertString(.Item("DEST_FAMILY_NAME_KANA")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_FIRST_NAME_KANA", Me.NullConvertString(.Item("DEST_FIRST_NAME_KANA")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_NM_1", Me.NullConvertString(.Item("DEST_NM_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_NM_2", Me.NullConvertString(.Item("DEST_NM_2")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_TEL", Me.NullConvertString(.Item("DEST_TEL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DLVY_METHOD_NO", Me.NullConvertString(.Item("DLVY_METHOD_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DLVY_METHOD", Me.NullConvertString(.Item("DLVY_METHOD")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RECEIVE_TIME", Me.NullConvertString(.Item("RECEIVE_TIME")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SURVEY", Me.NullConvertString(.Item("SURVEY")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_GOODS_CD", Me.NullConvertString(.Item("CUST_GOODS_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_CUST_GOODS_CD", Me.NullConvertString(.Item("SYS_CUST_GOODS_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_NM", Me.NullConvertString(.Item("GOODS_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@VARIATION", Me.NullConvertString(.Item("VARIATION")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BIN_KB", Me.NullConvertString(.Item("BIN_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PRICE", Me.NullConvertString(.Item("PRICE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_NB", Me.NullConvertZero(.Item("OUTKA_TTL_NB")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GK", Me.NullConvertString(.Item("GK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MEMO", Me.NullConvertString(.Item("MEMO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RECEIVE_PLACE_NM", Me.NullConvertString(.Item("RECEIVE_PLACE_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RECEIVE_PLACE_ZIP", Me.NullConvertString(.Item("RECEIVE_PLACE_ZIP")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RECEIVE_PLACE_AD", Me.NullConvertString(.Item("RECEIVE_PLACE_AD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RECEIVE_PLACE_TEL", Me.NullConvertString(.Item("RECEIVE_PLACE_TEL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CERT_NO", Me.NullConvertString(.Item("CERT_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORG_STATUS", Me.NullConvertString(.Item("ORG_STATUS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PROXY_ORD_ROUTE", Me.NullConvertString(.Item("PROXY_ORD_ROUTE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PROXY_ORD_REGISTER", Me.NullConvertString(.Item("PROXY_ORD_REGISTER")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_DLVY_DEST_NO", Me.NullConvertString(.Item("SYS_DLVY_DEST_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CLIENT", Me.NullConvertString(.Item("CLIENT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SALES_DET_DENP_NO", Me.NullConvertString(.Item("SALES_DET_DENP_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_ATTR", Me.NullConvertString(.Item("GOODS_ATTR")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RESERVE_ORD", Me.NullConvertString(.Item("RESERVE_ORD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@COUPON_INFO", Me.NullConvertString(.Item("COUPON_INFO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@COUPON_DISCOUNT", Me.NullConvertString(.Item("COUPON_DISCOUNT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SALES_PROMO_MAIL_DLVY", Me.NullConvertString(.Item("SALES_PROMO_MAIL_DLVY")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@B2_CUSTOMER_NO", Me.NullConvertString(.Item("B2_CUSTOMER_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_OUT_UNIT", Me.NullConvertString(.Item("DENP_OUT_UNIT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BR_CD", Me.NullConvertString(.Item("BR_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYUKKA_PLAN_DATE", Me.NullConvertString(.Item("SYUKKA_PLAN_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TAX_RATE_KB", Me.NullConvertString(.Item("TAX_RATE_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TAX_RATE", Me.NullConvertString(.Item("TAX_RATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DISCOUNT_SUBTOTAL_1", Me.NullConvertString(.Item("DISCOUNT_SUBTOTAL_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DISCOUNT_SUBTOTAL_2", Me.NullConvertString(.Item("DISCOUNT_SUBTOTAL_2")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DISCOUNT_SUBTOTAL_3", Me.NullConvertString(.Item("DISCOUNT_SUBTOTAL_3")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOTAL_1", Me.NullConvertString(.Item("TOTAL_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOTAL_2", Me.NullConvertString(.Item("TOTAL_2")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOTAL_3", Me.NullConvertString(.Item("TOTAL_3")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOTAL_4", Me.NullConvertString(.Item("TOTAL_4")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOTAL_5", Me.NullConvertString(.Item("TOTAL_5")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYUKKA_DATE", Me.NullConvertString(.Item("SYUKKA_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@QRURL_PARAM", Me.NullConvertString(.Item("QRURL_PARAM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_IRAI_NO", Me.NullConvertString(.Item("UNSO_IRAI_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI_1", Me.NullConvertString(.Item("YOBI_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI_2", Me.NullConvertString(.Item("YOBI_2")), DBDataType.NVARCHAR))
