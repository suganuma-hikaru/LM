...
#Region "H_OUTKAEDI_DTL_XXX(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO      " & vbNewLine _
                                        ...
                                        & ",PRTFLG	                    " & vbNewLine _
                                        & ",CANCEL_FLG	                " & vbNewLine _
                                        & ",SAKUSEI_BI			" & vbNewLine _
                                        & ",HASSO_BI			" & vbNewLine _
                                        & ",CUST_ORD_NO			" & vbNewLine _
                                        & ",HIBETSU_DAISU		" & vbNewLine _
                                        & ",OUTKA_PLAN_DATE		" & vbNewLine _
                                        & ",ARR_PLAN_DATE		" & vbNewLine _
                                        & ",HASSO_MOTO			" & vbNewLine _
                                        & ",DEST_CD				" & vbNewLine _
                                        & ",KOJO_NM				" & vbNewLine _
                                        & ",YUSO_KT				" & vbNewLine _
                                        & ",ZAIRO_KBN			" & vbNewLine _
                                        & ",SUPPLIER			" & vbNewLine _
                                        & ",CUST_GOODS_CD		" & vbNewLine _
                                        & ",ZAIRYO_NM			" & vbNewLine _
                                        & ",OUTKA_TTL_QT		" & vbNewLine _
                                        & ",IRIME_UT			" & vbNewLine _
                                        & ",OUTKA_TTL_NB		" & vbNewLine _
                                        & ",KONPO_KT			" & vbNewLine _
                                        & ",IRIME				" & vbNewLine _
                                        & ",YUSOFT_WT_KG		" & vbNewLine _
                                        & ",BETU_WT				" & vbNewLine _
                                        & ",LOT_NO				" & vbNewLine _
                                        & ",YUSO_SYSU			" & vbNewLine _
                                        & ",CNTNER_OR_NOT		" & vbNewLine _
                                        & ",RECORD_STATUS	            " & vbNewLine _
                                        & ",JISSEKI_SHORI_FLG	        " & vbNewLine _
                                        & ",JISSEKI_USER	            " & vbNewLine _
                                        & ",JISSEKI_DATE	            " & vbNewLine _
...
#Region "オーダー番号重複チェック(ジェイティ物流専用)"
    Private Const SQL_SELECT_C_OUTKA_LM_JT As String = " SELECT                                  " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_JT"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_JT）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_JT SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_JT"
    'ジェイティ物流は受信HEDを持っていないため更新しない
    '''' <summary>
    '''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_JT）
    '''' </summary>
    '''' <remarks></remarks>
    'Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_JT SET       " & vbNewLine _
    '                                          & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#End Region
    ...
    '#Region "M_DEST INSERT(ジェイティ物流は自動追加がない為使用しない)"
    ...
    '#Region "M_DEST UPDATE(届先項目差異有りの場合)(ジェイティ物流は自動更新がない為使用しない)"
    '    ''' <summary>
    '    ''' 届先マスタUPDATE文（M_DEST）
    '    ''' </summary>
    '    ''' <remarks></remarks>
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC111.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC111.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC111.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC111.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectDataNcgoMdest", cmd)
...
#Region "出荷(大,中)データ(オーダー番号チェック用)：ジェイティ物流専用"
    ...
    Private Function SelectOrderCheckDataJT(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC111.SQL_SELECT_C_OUTKA_LM_JT)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterLJT(dt)
        Call Me.SetOutkaParameterMJT(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectOrderCheckDataJT", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC111.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC111.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    '        '出荷登録、紐付けSQL CONST名
    '        Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
    '            setSql = LMH030DAC111.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

    '            '実績作成SQL CONST名
    '        Case LMH030DAC.EventShubetsu.CREATEJISSEKI
    '            setSql = LMH030DAC111.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC111.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '    '実績作成SQL CONST名
                'Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                '    setSql = LMH030DAC111.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC111.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC111.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC111.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ジェイティ物流は自動更新がないため使用しない)"
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertUnchinData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ジェイティ物流は自動追加がない為、使用しない)"
    ...
    '        'SQL文のコンパイル
    '        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertMDestData", cmd)
...
#Region "出荷パラメータ設定(オーダー番号チェック用) ジェイティ物流専用"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterLJT(ByVal dt As DataTable)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterMJT(ByVal dt As DataTable)
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC111.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectDataMdestOutkaToroku", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        '取消データは受信DTLから取得する
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_JT")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC111.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectOutkaEdiRcvCancel", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_JT_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_JT_CANCELOUT").Rows.Count())
        reader.Close()
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_JT")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC111.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC111.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC111.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectDataMgoods", cmd)
...
#Region "届先マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC111.SQL_SELECT_M_DEST1)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC111.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "SelectDataMDEST", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_DTL_JT_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC111.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC111.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHedCancel As DataTable = ds.Tables("LMH030_DTL_JT_CANCELOUT")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC111.SQL_UPDATE_DEL_OUTKAEDI_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_JT_CANCELOUT")   'DTLの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC111.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHed As DataTable = setDs.Tables("LMH030_OUTKAEDI_HED_JT")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_JT").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_JT")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC111.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_OUTKAEDI_DTL_JT").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC111", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@SAKUSEI_BI", Me.NullConvertString(.Item("SAKUSEI_BI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HASSO_BI", Me.NullConvertString(.Item("HASSO_BI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me.NullConvertString(.Item("CUST_ORD_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HIBETSU_DAISU", Me.NullConvertString(.Item("HIBETSU_DAISU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_DATE", Me.NullConvertString(.Item("OUTKA_PLAN_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_DATE", Me.NullConvertString(.Item("ARR_PLAN_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@HASSO_MOTO", Me.NullConvertString(.Item("HASSO_MOTO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_CD", Me.NullConvertString(.Item("DEST_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KOJO_NM", Me.NullConvertString(.Item("KOJO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YUSO_KT", Me.NullConvertString(.Item("YUSO_KT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZAIRO_KBN", Me.NullConvertString(.Item("ZAIRO_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SUPPLIER", Me.NullConvertString(.Item("SUPPLIER")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_GOODS_CD", Me.NullConvertString(.Item("CUST_GOODS_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ZAIRYO_NM", Me.NullConvertString(.Item("ZAIRYO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_QT", Me.NullConvertString(.Item("OUTKA_TTL_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@IRIME_UT", Me.NullConvertString(.Item("IRIME_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_NB", Me.NullConvertString(.Item("OUTKA_TTL_NB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KONPO_KT", Me.NullConvertString(.Item("KONPO_KT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@IRIME", Me.NullConvertString(.Item("IRIME")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@YUSOFT_WT_KG", Me.NullConvertString(.Item("YUSOFT_WT_KG")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@YUSO_SYSU", Me.NullConvertString(.Item("YUSO_SYSU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CNTNER_OR_NOT", Me.NullConvertString(.Item("CNTNER_OR_NOT")), DBDataType.NVARCHAR))
