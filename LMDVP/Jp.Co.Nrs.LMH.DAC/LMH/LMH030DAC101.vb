...
#Region "H_OUTKAEDI_DTL_NIK"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_NIK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_NIK SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_SENDOUTEDI_NIK SELECT句"

    Private Const SQL_SELECT_NIK_SEND_DATA As String = "SELECT                                                      " & vbNewLine _
                                          & " '0'                                          AS DEL_KB	            " & vbNewLine _
                                          & ",DTL_NIK.CRT_DATE                             AS CRT_DATE              " & vbNewLine _
                                          & ",DTL_NIK.FILE_NAME                            AS FILE_NAME             " & vbNewLine _
                                          & ",DTL_NIK.REC_NO                               AS REC_NO                " & vbNewLine _
                                          & ",DTL_NIK.GYO                                  AS GYO                   " & vbNewLine _
                                          ...
                                          & ",DTL_NIK.MAKER_CD                             AS MAKER_CD              " & vbNewLine _
                                          & ",DTL_NIK.DEPO_CD                              AS DEPO_CD               " & vbNewLine _
                                          & ",DTL_NIK.KYOTEN_CD                            AS KYOTEN_CD             " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS OUTKA_DATE            " & vbNewLine _
                                          & ",SUBSTRING(CAST(EDI_L.CUST_ORD_NO AS TEXT),1,10) AS DENP_NO            " & vbNewLine _
                                          & ",DTL_NIK.TORI_KB                              AS TORI_KB               " & vbNewLine _
                                          & ",SUBSTRING(CAST(EDI_L.FREE_C10 AS TEXT),1,10) AS TOKUI_CD              " & vbNewLine _
                                          & ",SUBSTRING(CAST(EDI_L.FREE_C11 AS TEXT),1,10) AS CHOKUSO_CD            " & vbNewLine _
                                          & ",DTL_NIK.GYO_NO                               AS GYO_NO                " & vbNewLine _
                                          & ",DTL_NIK.MAKER_CD + M_GOODS.GOODS_CD_CUST     AS GOODS_CD_NIK          " & vbNewLine _
                                          & ",CASE OUT_M.LOT_NO                                                     " & vbNewLine _
                                          & " WHEN ''   THEN '00000000000000000000'                                 " & vbNewLine _
                                          & " WHEN NULL THEN '00000000000000000000'                                 " & vbNewLine _
                                          & " ELSE OUT_M.LOT_NO                                                     " & vbNewLine _
                                          & " END                                          AS SEIZO_NO              " & vbNewLine _
                                          & ",DTL_NIK.YUKOU_KIGEN                          AS YUKOU_KIGEN           " & vbNewLine _
                                          & ",DTL_NIK.OUTKA_NB                             AS OUTKA_PLAN_NB         " & vbNewLine _
                                          & ",OUT_M.OUTKA_TTL_NB                           AS OUTKA_NB              " & vbNewLine _
                                          & ",DTL_NIK.KICHO_KB                             AS KICHO_KB              " & vbNewLine _
                                          & ",DTL_NIK.SEI_YURAI_KB                         AS SEI_YURAI_KB          " & vbNewLine _
                                          & ",SUBSTRING(CAST(OUT_M.REMARK AS TEXT),1,10)   AS REMARK_UPPER          " & vbNewLine _
                                          & ",SUBSTRING(CAST(OUT_M.REMARK AS TEXT),11,10)  AS REMARK_LOWER          " & vbNewLine _
                                          & ",SUBSTRING(CAST(OUT_L.REMARK AS TEXT),1,40)   AS REMARK                " & vbNewLine _
                                          & ",DTL_NIK.NIK_OUTKA_KB                         AS NIK_OUTKA_KB          " & vbNewLine _
                                          & ",''                                           AS RECORD_STATUS         " & vbNewLine _
                                          & ",'2'                                          AS JISSEKI_SHORI_FLG     " & vbNewLine

#End Region

#Region "H_SENDOUTEDI_NIK FROM句"

    Private Const SQL_FROM_NIK_SEND_DATA As String = "FROM                                                          " & vbNewLine _
                                          ...
                                          & "INNER JOIN $LM_TRN$..H_OUTKAEDI_DTL_NIK DTL_NIK                        " & vbNewLine _
                                          & " ON  DTL_NIK.DEL_KB <> '1'                                             " & vbNewLine _
                                          & " AND DTL_NIK.NRS_BR_CD = EDI_M.NRS_BR_CD                               " & vbNewLine _
                                          & " AND DTL_NIK.EDI_CTL_NO = EDI_M.EDI_CTL_NO                             " & vbNewLine _
                                          & " AND DTL_NIK.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU                     " & vbNewLine _
                                          & " AND DTL_NIK.JISSEKI_SHORI_FLG = '1'                                   " & vbNewLine _
                                          & " INNER JOIN $LM_MST$..M_GOODS  M_GOODS                                 " & vbNewLine _
                                          & "--  ON  M_GOODS.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  ON M_GOODS.CUST_CD_L = OUT_L.CUST_CD_L                               " & vbNewLine _
                                          & "  AND M_GOODS.CUST_CD_M = OUT_L.CUST_CD_M                              " & vbNewLine _
                                          & "  AND M_GOODS.GOODS_CD_NRS = OUT_M.GOODS_CD_NRS                        " & vbNewLine _
                                          & "  AND M_GOODS.NRS_BR_CD = OUT_M.NRS_BR_CD                        	    " & vbNewLine _
                                          & " LEFT JOIN $LM_MST$..M_DEST  M_DEST_SHIP                               " & vbNewLine _
                                          & "--  ON  M_DEST_SHIP.SYS_DEL_FLG = '0'                                  " & vbNewLine _
                                          & "  ON M_DEST_SHIP.CUST_CD_L = OUT_L.CUST_CD_L                           " & vbNewLine _
                                          & "  AND M_DEST_SHIP.DEST_CD = OUT_L.SHIP_CD_L                            " & vbNewLine _
                                          & "  AND M_DEST_SHIP.NRS_BR_CD = OUT_L.NRS_BR_CD                          " & vbNewLine _
                                          & " INNER JOIN $LM_MST$..M_DEST  M_DEST_DEST                              " & vbNewLine _
                                          & "--  ON  M_DEST_DEST.SYS_DEL_FLG = '0'                                  " & vbNewLine _
                                          & "  ON M_DEST_DEST.CUST_CD_L = OUT_L.CUST_CD_L                           " & vbNewLine _
                                          & "  AND M_DEST_DEST.DEST_CD = OUT_L.DEST_CD                              " & vbNewLine _
                                          & "  AND M_DEST_DEST.NRS_BR_CD = OUT_L.NRS_BR_CD                          " & vbNewLine _
...
#Region "H_SENDOUTEDI_NIK"
    ...
    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_NIK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_NIK As String = "INSERT INTO       " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_NIK       " & vbNewLine _
                                         & "(                                " & vbNewLine _
                                         & " DEL_KB                          " & vbNewLine _
                                         ...
                                         & ",GYO_NO                          " & vbNewLine _
                                         & ",GOODS_CD_NIK                    " & vbNewLine _
                                         & ",SEIZO_NO                        " & vbNewLine _
                                         & ",YUKOU_KIGEN                     " & vbNewLine _
                                         & ",OUTKA_PLAN_NB                   " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_NIK"
    ...
    ''' <summary>
    ''' 日医工EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_NIK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_NIK SET       " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNikMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC101.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectDataNikMdest", cmd)
...
#Region "M_GOODS"
    ...
    Private Function SelectDataSeihinNik(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.SQL_SELECT_M_SEHIN_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectDataSeihinNik", cmd)
...
#Region "出荷(大)データ(オーダー番号チェック用)日医工専用"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.SQL_SELECT_C_OUTKA_L_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectDataOrderCheckNik", cmd)
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>日医工EDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectNikEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.SQL_SELECT_NIK_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC101.SQL_FROM_NIK_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectNikEdiSend", cmd)
        ...
        map.Add("REMARK", "REMARK")
        map.Add("NIK_OUTKA_KB", "NIK_OUTKA_KB")
        map.Add("RECORD_STATUS", "RECORD_STATUS")
        map.Add("JISSEKI_SHORI_FLG", "JISSEKI_SHORI_FLG")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_NIK")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_NIK").Rows.Count())
        reader.Close()
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectMatome", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC101.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC101.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC101.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC101.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC101.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC101.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC101.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC101.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC101.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC101.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(日医工は自動更新を行う為、使用予定)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_NIK"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>日医工EDI実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertNikEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_NIK")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_H_SENDOUTEDI_NIK _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_NIK").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertNikEdiSendData", cmd)
...
#Region "M_DEST(日医工は自動追加を行う為、使用予定)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC101.SQL_INSERT_M_DEST_NIK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "InsertMDestData", cmd)
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@DEPO_CD", Me.NullConvertString(.Item("DEPO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KYOTEN_CD", Me.NullConvertString(.Item("KYOTEN_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_DATE", Me.NullConvertString(.Item("OUTKA_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENP_NO", Me.NullConvertString(.Item("DENP_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORI_KB", Me.NullConvertString(.Item("TORI_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUI_CD", Me.NullConvertString(.Item("TOKUI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHOKUSO_CD", Me.NullConvertString(.Item("CHOKUSO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GYO_NO", Me.NullConvertString(.Item("GYO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NIK", Me.NullConvertString(.Item("GOODS_CD_NIK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIZO_NO", Me.NullConvertString(.Item("SEIZO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YUKOU_KIGEN", Me.NullConvertString(.Item("YUKOU_KIGEN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_NB", Me.NullConvertZero(.Item("OUTKA_PLAN_NB")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_NB", Me.NullConvertZero(.Item("OUTKA_NB")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@KICHO_KB", Me.NullConvertString(.Item("KICHO_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEI_YURAI_KB", Me.NullConvertString(.Item("SEI_YURAI_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REMARK_UPPER", Me.NullConvertString(.Item("REMARK_UPPER")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REMARK_LOWER", Me.NullConvertString(.Item("REMARK_LOWER")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REMARK", Me.NullConvertString(.Item("REMARK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NIK_OUTKA_KB", Me.NullConvertString(.Item("NIK_OUTKA_KB")), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC101.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC101", "SelectDataMdestOutkaToroku", cmd)
