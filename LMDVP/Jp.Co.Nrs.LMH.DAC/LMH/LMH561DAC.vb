...
#Region "検索処理 SQL"
    ...
    Private Const SQL_MPrt_FROM As String = "  FROM $LM_TRN$..H_INOUTKAEDI_HED_DOW  HED                          " & vbNewLine _
                                          ...
                                          & "                     --(2012.06.20)要望番号1182 -- STAR --          " & vbNewLine _
                                          & "                     --AND H_EDI_PRINT.PRINT_TP  = '02'             " & vbNewLine _
                                          & "                     AND H_EDI_PRINT.PRINT_TP    = '04'             " & vbNewLine _
                                          & "                     --(2012.06.20)要望番号1182 --  END --          " & vbNewLine _
                                          ...
                                          & "                  AND M_CUSTRPT1.PTN_ID      = '81'                 " & vbNewLine _
                                          ...
                                          & "                  AND M_CUSTRPT2.PTN_ID      = '81'                 " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrintPattern(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH561IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMH561DAC.SQL_MPrt_SELECT)    'SQL構築(帳票種別用SELECT句)
        Me._StrSql.Append(LMH561DAC.SQL_MPrt_FROM)      'SQL構築(帳票種別用FROM句)
        ...
        MyBase.Logger.WriteSQLLog("LMH561DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH561DAC.SQL_SELECT)      'SQL構築(印刷データ抽出用 SELECT句)
        Me._StrSql.Append(LMH561DAC.SQL_FROM)        'SQL構築(印刷データ抽出用 FROM句)
        If Me._Row.Item("PRTFLG").ToString = "1" Then 'Notes 1061 2012/05/15　開始
            Call Me.SetConditionMasterSQL_OUT()          '出力済の場合
        Else
            Call Me.SetConditionMasterSQL()              'SQL構築(印刷データ抽出条件設定)  '未出力・両方(出力済、未出力併せて)
        ...
        Me._StrSql.Append(LMH561DAC.SQL_ORDER_BY)    'SQL構築(印刷データ抽出用 ORDER BY句)
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), Me._Row.Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH561DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH561OUT")
