...
#End Region  '入荷登録
    ...
    '日産物流追加箇所 terakawa 2012.09.07 start
#Region "まとめ先取得"
    Private Const SQL_SELECT_MATOME_TARGET As String = "SELECT                                       " & vbNewLine _
                                    ...
                                    & "   LEFT JOIN $LM_TRN$..H_INKAEDI_L EDI_L                      " & vbNewLine _
                                    & "    ON                                                        " & vbNewLine _
                                    ...
                                    & "    AND                                                       " & vbNewLine _
                                    & "    EDI_L.OUTKA_MOTO = @OUTKA_MOTO                            " & vbNewLine _
...
#Region "SELECT_SEND"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_SEND_INKAS As String = " SELECT                                                " & vbNewLine _
                                & "  INKA_S.LOT_NO                                                          " & vbNewLine _
                                & "  ,SUM(INKA_S.KONSU * M_GOODS.PKG_NB + INKA_S.HASU) AS SUM_NB            " & vbNewLine _
                                & "  FROM $LM_TRN$..H_INKAEDI_HED_NSN  HED                                  " & vbNewLine _
                                & "  INNER JOIN $LM_TRN$..H_INKAEDI_DTL_NSN  DTL                            " & vbNewLine _
                                & "  ON                                                                     " & vbNewLine _
                                ...
                                & "--Del005439  AND                                                                    " & vbNewLine _
                                & "--Del005439  DTL.GYO = '01'                                                         " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  DTL.DEL_KB <> '1'                                                      " & vbNewLine _
                                & "  INNER JOIN $LM_TRN$..H_INKAEDI_M EDI_M                                 " & vbNewLine _
                                & "  ON                                                                     " & vbNewLine _
                                & "  EDI_M.DEL_KB <> '1'                                                    " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  EDI_M.NRS_BR_CD = DTL.NRS_BR_CD                                        " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  EDI_M.EDI_CTL_NO = DTL.EDI_CTL_NO                                      " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  EDI_M.EDI_CTL_NO_CHU = DTL.EDI_CTL_NO_CHU                              " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  EDI_M.JISSEKI_FLAG = '1'                                               " & vbNewLine _
                                ...
                                & "  AND                                                                    " & vbNewLine _
                                & "  INKA_S.INKA_NO_L = HED.INKA_CTL_NO_L                                   " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  INKA_S.INKA_NO_M = DTL.INKA_CTL_NO_M                                   " & vbNewLine _
                                ...
                                & "  INKA_M.NRS_BR_CD = @NRS_BR_CD                                          " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
                                & "  INKA_M.GOODS_CD_NRS = M_GOODS.GOODS_CD_NRS                             " & vbNewLine _
                                & "  WHERE                                                                  " & vbNewLine _
                                & "  HED.DEL_KB <> '1'                                                      " & vbNewLine _
                                & "  AND                                                                    " & vbNewLine _
    ...
    Private Const SQL_SELECT_SEND As String = "SELECT                                               " & vbNewLine _
                             ...
                             & ",INKA_L.INKA_DATE            AS NYUKO_DATE                          " & vbNewLine _
                             ...
                             & ",HED.SHUKKA_CD               AS NYUKO_CD                            " & vbNewLine _
                             ...
                             & ",HED.CAR_NO                  AS CONTEINER_NO                        " & vbNewLine _
                             & ",HED.MOTOUKE_CD              AS MOTOUKE_CD                          " & vbNewLine _
                             & ",''                          AS YOBI                                " & vbNewLine _
                             & ",''                          AS YOBI_2                              " & vbNewLine _
                             ...
                             & " INKA_L.SYS_DEL_FLG <> '1'                                          " & vbNewLine _
                             & " AND                                                                " & vbNewLine _
                             & " INKA_L.NRS_BR_CD = HED.NRS_BR_CD                                   " & vbNewLine _
                             & " AND                                                                " & vbNewLine _
                             & " INKA_L.INKA_NO_L = HED.INKA_CTL_NO_L                               " & vbNewLine _
                             & " INNER JOIN  $LM_TRN$..H_INKAEDI_DTL_NSN DTL                        " & vbNewLine _
                             & " ON                                                                 " & vbNewLine _
                             & " DTL.CRT_DATE = HED.CRT_DATE                                        " & vbNewLine _
                             & " AND                                                                " & vbNewLine _
                             ...
                             & " HED.EDI_CTL_NO = @EDI_CTL_NO                                       " & vbNewLine _
                             & " AND                                                                " & vbNewLine _
                             & " DTL.JISSEKI_SHORI_FLG = '1'                                        " & vbNewLine

#End Region  '実績作成
    '日産物流追加箇所 terakawa 2012.09.07 End
...
#Region "RCV_HED(入荷登録)"
    ...
    Private Const SQL_UPD_RCV_HED As String = "UPDATE                                               " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_HED_NSN                    " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L       	        " & vbNewLine _
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_NSN                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#End Region
    ...
    '日産物流追加箇所 terakawa 2012.09.07 Start
#Region "SEND"
    Private Const SQL_INSERT_SEND As String = "INSERT INTO $LM_TRN$..H_SENDINEDI_NSN " & vbNewLine _
                                          & "(                               " & vbNewLine _
                                          & " DEL_KB                         " & vbNewLine _
                                          & ",NRS_BR_CD                      " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC104.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC104.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectSendFromInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC104.SQL_SELECT_SEND_INKAS)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "SelectSendFromInkaS", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH010_NSN_JISSEKI_INKAS")
        reader.Close()
    ...
    Private Function SelectSendFromRcv(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC104.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "SelectSendFromRcv", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINEDI_NSN")
        reader.Close()
...
#Region "まとめ先取得"
    ...
    Private Function SelectMatomeTarget(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC104.SQL_SELECT_MATOME_TARGET)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "SelectMatomeTarget", cmd)
    ...
    Private Sub SetCondition(ByVal ds As DataSet)
        ...
        Me._StrSql.Append(" INKA_STATE_KB_1 < '50' ")
        Me._StrSql.Append(vbNewLine)
        ...
        If max > -1 Then
            ...
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append(" INKA_NO_L IN ( ")
            Me._StrSql.Append(vbNewLine)
    ...
    Private Function SelectUnsoMatomeTarget(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC104.SQL_MATOMESAKI_DATA_UNSO_M)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "SelectUnsoMatomeTarget", cmd)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC104.SQL_UPD_INKATOROKU_EDI_L

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC104.SQL_UPD_JISSEKITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC104.SQL_UPD_EDITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC104.SQL_UPD_JISSEKIMODOSI_EDI_L

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC104.SQL_UPD_TOUROKUMI_EDI_L

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC104.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC104.SQL_UPD_INKATOROKU_EDI_M
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC104.SQL_UPD_EDITORIKESI_EDI_M

                '実績作成済⇒実績未、実績送信済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                , LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC104.SQL_UPD_JISSEKIMODOSI_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC104.SQL_UPD_JISSEKISAKUSEI_EDI_M

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC104.SQL_UPD_TOUROKUMI_EDI_M

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC104.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC104.SQL_UPD_RCV_HED

            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC104.SQL_UPD_JISSEKITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC104.SQL_UPD_EDITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC104.SQL_UPD_JISSEKIMODOSI_RCV_HED

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC104.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC104.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "UpdateRcvHed", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC104.SQL_UPDATE_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC104.SQL_UPD_JISSEKISAKUSEI_RCV_DTL

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI
                setSql = LMH010DAC104.SQL_UPD_JISSEKITORIKESI_RCV_DTL
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC104.SQL_UPD_EDITORIKESI_RCV_DTL

                '実績作成済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI

                setSql = LMH010DAC104.SQL_UPD_JISSEKIZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒実績未、
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC104.SQL_UPD_SOUSINZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC104.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC104.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH010DAC104.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC", "UpdateInkaLMatome", cmd)
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH010DAC104.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "UpdateMatomesakiEdiLData", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertInkaS", cmd)
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINEDI_NSN")
        'INTableの条件rowの格納
        Dim dtRow As DataRow = inTbl.Rows(0)
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_SEND, dtRow.Item("NRS_BR_CD").ToString()))
        Dim eventShubetsu As Integer = Convert.ToInt32(ds.Tables("LMH010_JUDGE").Rows(0)("EVENT_SHUBETSU"))
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC104.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC104", "InsertUnchinData", cmd)
...
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(row.Item("EDI_CTL_NO")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_L", Me.NullConvertString(row.Item("INKA_CTL_NO_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATA_SHURUI", Me.NullConvertString(row.Item("DATA_SHURUI")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SAKUSEI_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SAKUSEI_TIME", Me.NullConvertString(row.Item("SAKUSEI_TIME")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENSO_SAKI", Me.NullConvertString(row.Item("DENSO_SAKI")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENSO_MOTO", Me.NullConvertString(row.Item("DENSO_MOTO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHORI_KB", Me.NullConvertString(row.Item("SHORI_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TORIHIKI_KB", Me.NullConvertString(row.Item("TORIHIKI_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NYUKO_DATE", Me.NullConvertString(row.Item("NYUKO_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD", Me.NullConvertString(row.Item("CUST_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_BUSHO", Me.NullConvertString(row.Item("CUST_BUSHO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EIGYO_SASHIZU", Me.NullConvertString(row.Item("EIGYO_SASHIZU")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOJO_KANRI_NO", Me.NullConvertString(row.Item("KOJO_KANRI_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NYUKO_CD", Me.NullConvertString(row.Item("NYUKO_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HINSHU_CD", Me.NullConvertString(row.Item("HINSHU_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HINMEI_CD", Me.NullConvertString(row.Item("HINMEI_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GRADE", Me.NullConvertString(row.Item("GRADE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YORYO", Me.NullConvertZero(row.Item("YORYO")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TAN_I", Me.NullConvertString(row.Item("TAN_I")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU", Me.NullConvertZero(row.Item("KOSU")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SURYO", Me.NullConvertZero(row.Item("SURYO")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CONTEINER_NO", Me.NullConvertString(row.Item("CONTEINER_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MOTOUKE_CD", Me.NullConvertString(row.Item("MOTOUKE_CD")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_1", Me.NullConvertZero(row.Item("KOSU_SURYO_1")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_2", Me.NullConvertString(row.Item("LOT_NO_2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_2", Me.NullConvertZero(row.Item("KOSU_SURYO_2")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_3", Me.NullConvertString(row.Item("LOT_NO_3")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_3", Me.NullConvertZero(row.Item("KOSU_SURYO_3")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_4", Me.NullConvertString(row.Item("LOT_NO_4")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_4", Me.NullConvertZero(row.Item("KOSU_SURYO_4")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_5", Me.NullConvertString(row.Item("LOT_NO_5")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_5", Me.NullConvertZero(row.Item("KOSU_SURYO_5")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_6", Me.NullConvertString(row.Item("LOT_NO_6")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_6", Me.NullConvertZero(row.Item("KOSU_SURYO_6")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_7", Me.NullConvertString(row.Item("LOT_NO_7")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_7", Me.NullConvertZero(row.Item("KOSU_SURYO_7")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_8", Me.NullConvertString(row.Item("LOT_NO_8")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_8", Me.NullConvertZero(row.Item("KOSU_SURYO_8")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_9", Me.NullConvertString(row.Item("LOT_NO_9")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_9", Me.NullConvertZero(row.Item("KOSU_SURYO_9")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO_10", Me.NullConvertString(row.Item("LOT_NO_10")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOSU_SURYO_10", Me.NullConvertZero(row.Item("KOSU_SURYO_10")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOBI_2", Me.NullConvertString(row.Item("YOBI_2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(row.Item("JISSEKI_SHORI_FLG")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_TIME", updTime, DBDataType.CHAR))
...
#Region "マッピング配列作成"
    ...
    Private Function SetMapSend() As Hashtable
        ...
        map.Add("KOSU", "KOSU")
        map.Add("SURYO", "SURYO")
        map.Add("CONTEINER_NO", "CONTEINER_NO")
        map.Add("MOTOUKE_CD", "MOTOUKE_CD")
        map.Add("YOBI", "YOBI")
        map.Add("YOBI_2", "YOBI_2")
