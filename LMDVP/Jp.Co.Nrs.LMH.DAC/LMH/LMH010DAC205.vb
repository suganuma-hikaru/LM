...
#End Region  '入荷登録
    ...
    '要望番号2100 追加START 日立FNの入荷はまとめ処理を行う 2013.10.07
#Region "まとめ先取得"
    Private Const SQL_SELECT_MATOME_TARGET As String = "SELECT                                       " & vbNewLine _
                                    ...
                                    & "--  2018/06/04 001528 千葉物流センター、入荷で纏まらないものがあったものの対応   Annen Upd Start" & vbNewLine _
                                    & "--    AND                                                       " & vbNewLine _
                                    & "--    EDI_L.OUTKA_MOTO = @OUTKA_MOTO                            " & vbNewLine _
                                    & "--    EDI_L.FREE_C14 = @OUTKA_MOTO                              " & vbNewLine _
                                    & "    AND                                                      " & vbNewLine _
                                    & "    EDI_L.FREE_C14 = CASE WHEN (INKA_L.NRS_BR_CD = '10'  AND INKA_L.CUST_CD_L = '00010') THEN EDI_L.FREE_C14" & vbNewLine _
                                    & "                                ELSE @OUTKA_MOTO  END         " & vbNewLine _
                                    & "--  2018/06/04 001528 千葉物流センター、入荷で纏まらないものがあったものの対応   Annen Upd End" & vbNewLine _
...
#End Region '入荷登録（まとめ先取得）
    '要望番号2100 追加END 日立FNの入荷はまとめ処理を行う 2013.10.07
...
#Region "まとめ先取得"
    ...
    Private Function SelectMatomeTarget(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC205.SQL_SELECT_MATOME_TARGET)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "SelectMatomeTarget", cmd)
    ...
    Private Sub SetCondition(ByVal ds As DataSet)
        ...
        Me._StrSql.Append(" INKA_STATE_KB_1 < '40' ")
        Me._StrSql.Append(vbNewLine)
    ...
    Private Function SelectUnsoMatomeTarget(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC205.SQL_MATOMESAKI_DATA_UNSO_M)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "SelectUnsoMatomeTarget", cmd)
...
#Region "INKA_L(入荷登録まとめ)"
    ...
    Private Const SQL_UPD_MATOME_INKA_L As String = "UPDATE                                         " & vbNewLine _
                                              ...
                                              & ",SYS_UPD_PGID      = @SYS_UPD_PGID                 " & vbNewLine _
                                              & ",SYS_UPD_USER      = @SYS_UPD_USER                 " & vbNewLine _
                                              & ",OUTKA_FROM_ORD_NO_L = @OUTKA_FROM_ORD_NO_L   --ADD 2018/10/03 依頼番号 : 002498   【LMS】【既存バグ】入荷まとめ機能バグ対応        " & vbNewLine _
                                              & " WHERE                                             " & vbNewLine _
                                              & " NRS_BR_CD         = @NRS_BR_CD                    " & vbNewLine _
                                              & " AND                                               " & vbNewLine _
...
#Region "INKA_S"
    ...
    Private Const SQL_INSERT_INKA_S As String = "INSERT INTO $LM_TRN$..B_INKA_S" & vbNewLine _
                                              ...
                                              & ",''                           " & vbNewLine _
                                              & ",@LOT_NO                      " & vbNewLine _
                                              & ",@LOCA         --ADD 2020/08/05  014005  " & vbNewLine _
                                              & ",@TOU_NO                      " & vbNewLine _
                                              & ",@SITU_NO                     " & vbNewLine _
                                              & ",@ZONE_CD                     " & vbNewLine _
                                              & ",@KONSU                       " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC205.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC205.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "SelectEdiM", cmd)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC205.SQL_UPD_INKATOROKU_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC205.SQL_UPD_INKATOROKU_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC205.SQL_UPD_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "UpdateRcvHed", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC205.SQL_UPDATE_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "UpdateRcvDtl", cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH010DAC205.SQL_UPDATE_MATOMESAKI_UNSO_L
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU
                setSql = LMH010DAC205.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "UpdateMatomesakiEdiLData", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertInkaS", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC205.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC205", "InsertUnchinData", cmd)
...
#If True Then   'ADD 2020/08/05 014005   【LMS】商品マスタ_入荷仮置場機能の追加
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOCA", row.Item("LOCA").ToString(), DBDataType.CHAR))
#End If
...
#Region "まとめ先データ取得パラメータ設定"
    Private Sub SetMatomePrm(ByVal dt As DataTable)
        ...
        'Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_MOTO", Me.NullConvertString(dt.Rows(0).Item("OUTKA_MOTO")), DBDataType.NVARCHAR))
        '出荷元コード(FREE_C14)
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_MOTO", Me.NullConvertString(dt.Rows(0).Item("FREE_C14")), DBDataType.NVARCHAR))
