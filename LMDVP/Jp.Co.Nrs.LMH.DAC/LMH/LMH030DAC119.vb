...
'  EDI荷主ID　　　　:  119　　　 : エア・ウォーター・ゾル(セミ標準より分岐)
'  作  成  者       :  YAMAMOTO　:(000　　　 : セミ標準ベース) 
' ==========================================================================
Imports System.Text
...
#Region "H_OUTKAEDI_DTL_AWS(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_DTL_AWS）
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_INSERT_OUTKAEDI_DTL_AWS As String = "INSERT INTO    " & vbNewLine _
                                        & "$LM_TRN$..H_OUTKAEDI_DTL_AWS   " & vbNewLine _
                                        & "(                                " & vbNewLine _
                                        & " DEL_KB                          " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_AWS(取込削除)"
    ''' <summary>
    ''' 受信テーブル(AWS)更新
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC119.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC119.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "荷主明細マスタ（SUB_KB=0L）"
    ...
    Private Function SelectMstCustD0L(ByVal ds As DataSet) As DataSet
        ...
        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC119.SQL_WHERE1_M_CUST_DETAILS_FIR)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC119.SQL_SELECT_M_DEST)

        If dt.Rows(0)("DEST_NM").ToString() <> String.Empty Then
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC119.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectDataMdestOutkaToroku", cmd)
    ...
    Private Function SelectLikeDataMdest(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectDataMdest", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC119.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectDataZkbn", cmd)
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals(LMConst.FLG.ON) = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC119.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC119.SQL_WHERE_CANCER_DATA_DTL)

            'オーダー番号＋オーダー番号明細チェックの場合
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("3") = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC119.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC119.SQL_WHERE_CANCER_DATA_DTL_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("4") = True Then
            ...
            Me._StrSql.Append(LMH030DAC119.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC119.SQL_WHERE_CANCER_DATA_DTL_ONLY_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("5") = True Then
            ...
            Me._StrSql.Append(LMH030DAC119.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC119.SQL_WHERE_CANCER_DATA_DTL_M_FREE_C25)
            '2015.04.28 Ｍ・Ｒ・Ｃデュポン対応 M_FREE_C25_NOの(オーダー番号明細のみ)チェックの場合 追加END
        Else
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC119.SQL_SELECT_CANCER_DATA)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC119.SQL_WHERE_CANCER_DATA)
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    Private Function SelectCompareData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_ARB") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC119.SQL_SELECT_COMPARE_CHECK_ARB, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_MRC") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC119.SQL_SELECT_COMPARE_CHECK_MRC, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC119.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC119.SQL_WHERE_M_CUST_DETAILS_ALL)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC119.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC119.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC119.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC119.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_AWS(セミEDI：受信テーブル取消更新)"
    ''' <summary>
    ...
    Private Function UpdateDelRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Dim sql As String = Me.SetSchemaNm(LMH030DAC119.SQL_UPDATE_DEL_OUTKAIEDI_DTL, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateDelRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_UPDATE_EDIT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateEditOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_UPDATE_EDIT_OUTKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateEditOutkaEdiM", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC119.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC119.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC119.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateOutkaLData", cmd)
    ...
    Private Function UpdateOutkaLDataWithBuyerOrdNo(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録(まとめ時)
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC119.SQL_UPDATE_OUTKAL_MATOME_WITH_BUYER_ORD_NO
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC119.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC119.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC119", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertMDestData", cmd)
...
#If False Then  'UPD 2017/10/13 入目単位をm3固定とする。
            prmList.Add(MyBase.GetSqlParameter("@IRIME_UT", .Item("IRIME_UT").ToString(), DBDataType.NVARCHAR))

#Else
            prmList.Add(MyBase.GetSqlParameter("@IRIME_UT", "m3", DBDataType.NVARCHAR))
...
#Region "届先マスタ抽出パラメータ設定"
    ...
    Private Sub SetMdestParameter(ByVal dt As DataTable, ByVal prmUpdFlg As Integer)
        ...
        If prmUpdFlg = 1 Then
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_NM", dt.Rows(0).Item("DEST_NM"), DBDataType.NVARCHAR))
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = String.Empty
        sql = Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKAEDI_DTL_AWS, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        'If setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_AWS") = True Then
        '    sql = Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKAEDI_DTL_AWS, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        'ElseIf setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_AWS") = True Then
        '    sql = Me.SetSchemaNm(LMH030DAC119.SQL_INSERT_OUTKAEDI_DTL_AWS, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        'End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC119", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal setDs As DataSet, ByVal prmList As ArrayList)
        ...
        prmList.Add(MyBase.GetSqlParameter("@DEST_NM1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_C01_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_NM2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_AD_1_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@AD1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_AD_2_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@AD2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_AD_3_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@AD3", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_CUST_ORD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DENPYO_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_GOODS_CD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@GOODS_CD", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        ...
        prmList.Add(MyBase.GetSqlParameter("@LOT1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_LOT_NO_NO").ToString())
        setColKey = "COLUMN_10"
        prmList.Add(MyBase.GetSqlParameter("@LOT2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_C02_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@TANABAN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("").ToString())
        setColKey = "COLUMN_12"
        prmList.Add(MyBase.GetSqlParameter("@NB1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("").ToString())
        setColKey = "COLUMN_13"
        prmList.Add(MyBase.GetSqlParameter("@NB_UT1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.CHAR))
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("").ToString())
        setColKey = "COLUMN_14"
        prmList.Add(MyBase.GetSqlParameter("@PL", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.CHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_OUTKA_TTL_NB_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@NB2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_IRIME_UT_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@NB_UT2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.CHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_C03_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@BIN_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_C24_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@OUTKA_KB", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_C25_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@OKURI_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@OKURI_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_C26_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@EDP", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_OUTKA_PLAN_DATE_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@OUTKOBI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.CHAR))
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("").ToString())
        setColKey = "COLUMN_22"
        prmList.Add(MyBase.GetSqlParameter("@SYORI_KB", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_ARR_PLAN_DATE_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@NOHINBI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.CHAR))
