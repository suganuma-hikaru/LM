...
'  EDI荷主ID　　　　:  505　　　 : ディック共同配送(埼玉)、ディック春日部
'  作  成  者       :  umano
' ==========================================================================
Imports System.Text
...
#If True Then   'ADD 2019/02/18
    Private Const L_DEF_SQL_SELECT_DATA2 As String = " SELECT                                                                             " & vbNewLine _
                                         & " '0'                                                 AS DEL_KB                           " & vbNewLine _
                                         & ",H_OUTKAEDI_L.NRS_BR_CD                              AS NRS_BR_CD                        " & vbNewLine _
                                         & ",H_OUTKAEDI_L.EDI_CTL_NO                             AS EDI_CTL_NO                       " & vbNewLine _
                                         & ",H_OUTKAEDI_L.OUTKA_CTL_NO                           AS OUTKA_CTL_NO                     " & vbNewLine _
                                         ...
                                         & "  ((H_OUTKAEDI_L.SYS_UPD_DATE  = @SYS_UPD_DATE                                           " & vbNewLine _
                                         & "     AND                                                                                 " & vbNewLine _
                                         & "    H_OUTKAEDI_L.SYS_UPD_TIME  = @SYS_UPD_TIME)                                          " & vbNewLine _
                                         & "   or                                                                                    " & vbNewLine _
                                         & "   (H_OUTKAEDI_L.SYS_UPD_DATE  = @SYS_UPD_DATE_NEW                                       " & vbNewLine _
                                         & "     AND                                                                                 " & vbNewLine _
                                         & "    H_OUTKAEDI_L.SYS_UPD_TIME  = @SYS_UPD_TIME_NEW))                                    " & vbNewLine
...
#If True Then   'ADD 2019/02/15 依頼番号 : 004085   【LMS】古河事業所日立物流_危険品と一般品の運賃請求：オーダー合算を廃止、別オーダーとして請求(営業松本)
    ...
    Private Const M_DEF_SQL_SELECT_DATA1 As String = " SELECT                                                             " & vbNewLine _
                                    & " '0'                                             AS  DEL_KB                   " & vbNewLine _
                                    & ",H_OUTKAEDI_M.NRS_BR_CD                          AS  NRS_BR_CD                " & vbNewLine _
                                    & ",H_OUTKAEDI_M.EDI_CTL_NO                         AS  EDI_CTL_NO               " & vbNewLine _
                                    & ",H_OUTKAEDI_M.EDI_CTL_NO_CHU                     AS  EDI_CTL_NO_CHU           " & vbNewLine _
                                    ...
                                    & " H_OUTKAEDI_L.SYS_UPD_TIME  = @SYS_UPD_TIME                                   " & vbNewLine _
                                    & " AND                                                                          " & vbNewLine _
                                    & " NOT (H_OUTKAEDI_M.FREE_C08 >= '40' and H_OUTKAEDI_M.FREE_C08 <= '49')              " & vbNewLine


    Private Const M_DEF_SQL_SELECT_DATA2 As String = " SELECT                                                             " & vbNewLine _
                                & " '0'                                             AS  DEL_KB                   " & vbNewLine _
                                & ",H_OUTKAEDI_M.NRS_BR_CD                          AS  NRS_BR_CD                " & vbNewLine _
                                & ",H_OUTKAEDI_M.EDI_CTL_NO                         AS  EDI_CTL_NO               " & vbNewLine _
                                & ",H_OUTKAEDI_M.EDI_CTL_NO_CHU                     AS  EDI_CTL_NO_CHU           " & vbNewLine _
                                ...
                                & "-- H_OUTKAEDI_L.SYS_UPD_TIME  = @SYS_UPD_TIME                                   " & vbNewLine _
                                & " AND                                                                          " & vbNewLine _
                                    & " H_OUTKAEDI_M.FREE_C08 >= '40' and H_OUTKAEDI_M.FREE_C08 <= '49'              " & vbNewLine
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectEdiL", cmd)
...
#If True Then   'ADD 2019/02/18
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷データLテーブル更新対象データ一覧検索結果取得SQLの構築・発行</remarks>
    Private Function SelectEdiL2(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.L_DEF_SQL_SELECT_DATA2)      'SQL構築
        Call Me.setSQLSelectDataExists()                           '条件設定
        Call Me.setSQLSelectDataExists2()
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectEdiL2", cmd)
...
#End If
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectEdiM", cmd)
...
#If True Then   'ADD 2019/02/15 依頼番号 : 004085   【LMS】古河事業所日立物流_危険品と一般品の運賃請求：オーダー合算を廃止、別オーダーとして請求(営業松本)◎
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷データMテーブル更新対象データ結果取得SQLの構築・発行</remarks>
    Private Function SelectEdiM1(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.M_DEF_SQL_SELECT_DATA1)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectEdiM1", cmd)
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷データMテーブル更新対象データ結果取得SQLの構築・発行</remarks>
    Private Function SelectEdiM2(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.M_DEF_SQL_SELECT_DATA2)      'SQL構築(データ抽出用)
...
#Region "登録前の事前チェック"
    ...
    Private Function EntryBeforeCheck(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.SQL_SELECT_ENTRY_BEFORE)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "EntryBeforeCheck", cmd)
...
#Region "出荷(大)データ(オーダー番号チェック用)"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.SQL_SELECT_C_OUTKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectDataOrderCheck", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC505.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC505.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC505", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC505.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC505.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC505", "UpdateEdiRcvDtlData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "UpdateMDestData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        If LMH030DAC.EdiCustIndex.DicChbYuso10010_00 = custIndex Then
            cmd = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC505.SQL_INSERT_UNSO_L_CBAYUSO _
                                                               , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))

        Else
            cmd = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC505.SQL_INSERT_UNSO_L _
                                                               , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC505.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC505", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC505.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC505", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC505.SQL_INSERT_M_DEST_DICUNSO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "InsertMDestData", cmd)
...
#If True Then   'ADD 2019/02/18
#Region "EDI出荷(大),EDI受信TBL抽出パラメータ設定"

    ''' <summary>
    '''  パラメータ設定（EDI出荷(大・中),EDI受信テーブル・存在チェック）
    ''' </summary>
    ''' <remarks>出荷登録時出荷マスタ検索用SQLの構築</remarks>
    Private Sub setSQLSelectDataExists2()

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_UPD_DATE_NEW", MyBase.GetSystemDate(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_UPD_TIME_NEW", MyBase.GetSystemTime(), DBDataType.CHAR))
...
#Region "届先マスタ(DIC千葉輸送専用ORIG情報取得)"
    ...
    Private Function SelectDicYusoOrigData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC505.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC505.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectDicYusoOrigData", cmd)
...
#Region "届先マスタ(DIC千葉輸送専用ORIG情報取得)"
    ...
    Private Function SelectDicYusoOrigEditData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC505", "SelectDicYusoOrigEditData", cmd)
