...
#Region "EDI出荷受信テーブル(明細) INSERT SQL"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "" _
        ...
        & "    , PACK_INSTRUCTION            " & vbNewLine _
        & "    , CUST_GOODS_CD               " & vbNewLine _
        & "    , GOODS_NM                    " & vbNewLine _
        & "    , REQUEST_SHIP_LINE_QTY       " & vbNewLine _
        & "    , CARRIER                     " & vbNewLine _
...
#Region "出荷梱包個数計算単位取得(商品明細マスタ)"
    ...
    Private Const SQL_SELECT_GOODS_DETAILS As String = "" _
        ...
        & "         ON  M_GOODS.NRS_BR_CD = H_OUTKAEDI_M.NRS_BR_CD               " & vbNewLine _
        & "         AND M_GOODS.GOODS_CD_CUST = H_OUTKAEDI_M.CUST_GOODS_CD       " & vbNewLine _
        ...
        & "     WHERE                                                            " & vbNewLine _
        & "         NRS_BR_CD = @NRS_BR_CD                                       " & vbNewLine _
        & "     AND SUB_KB = '75'                                                " & vbNewLine _
        & "     AND SYS_DEL_FLG = '0'                                            " & vbNewLine _
        & "     GROUP BY                                                         " & vbNewLine _
        & "           NRS_BR_CD                                                  " & vbNewLine _
        & "         , GOODS_CD_NRS                                               " & vbNewLine _
        & "     ) M_GOODS_DETAILS                                                " & vbNewLine _
        & "         ON  M_GOODS_DETAILS.NRS_BR_CD = H_OUTKAEDI_M.NRS_BR_CD       " & vbNewLine _
        ...
        & " AND M_GOODS.NRS_BR_CD IS NOT NULL                                    " & vbNewLine _
        & " AND M_GOODS_DETAILS.NRS_BR_CD IS NOT NULL                            " & vbNewLine _
        & ""


#End Region ' "出荷梱包個数計算単位取得(商品明細マスタ)"
...
#Region "H_OUTKAEDI_DTL_DHL"

    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DHL）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DHL SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得"
    ...
    Private Function GetOutkaCntAndNoL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_SELECT_OUTKA_NO_L_AND_CNT)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_DHL")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "GetOutkaCntAndNoL", cmd)
...
#Region "EDI出荷(大)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_UPDATE_DEL_OUTKAIEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateDelOutkaEdiL", cmd)
...
#Region "EDI出荷(中)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_UPDATE_DEL_OUTKAIEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateDelOutkaEdiM", cmd)
...
#Region "EDI出荷受信テーブル(明細) 件数取得"
    ...
    Private Function GetOutkaEdiDtlCnt(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_SELECT_COUNT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "GetOutkaEdiDtlCnt", cmd)
...
#Region "EDI出荷受信テーブル(明細) 物理削除"
    ...
    Private Function DeleteOutkaEdiDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_DELETE_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "DeleteOutkaEdiDtl", cmd)
...
#Region "EDI出荷受信テーブル(明細) 新規登録"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_INSERT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "商品マスタ 件数取得"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        ' SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC160.SQL_WHERE1_M_GOODS)

        ' SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC160.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "SelectMstGoods", cmd)
...
#Region "EDI出荷(中)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_INSERT_OUTKAEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertOutkaEdiM", cmd)
...
#Region "EDI出荷(大)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_INSERT_OUTKAEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertOutkaEdiL", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "SelectDataZkbn", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC160.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC160.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "SelectEdiM", cmd)
...
#Region "出荷梱包個数計算単位取得処理(商品明細マスタ)"

    ''' <summary>
    ''' 出荷梱包個数計算単位取得処理(商品明細マスタ)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectGoodsDetails(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC160.SQL_SELECT_GOODS_DETAILS)

        'パラメータ設定
        Call Me.SetSelectGoodsDetailsParameter()
        ...
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(sql)
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "SelectGoodsDetails", cmd)
...
#End Region ' "出荷梱包個数計算単位取得処理(商品明細マスタ)"
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_OUTKA_M _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC160.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "InsertMDestData", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC160.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(String.Concat(setSql, LMH030DAC160.SQL_COM_UPDATE_CONDITION) _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC160.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                'setSql = LMH030DAC160.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC160.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateOutkaEdiMData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC160.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC160.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC160.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC160", "UpdateMDestData", cmd)
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(明細) 新規登録 用"
    ...
    Private Sub SetSqlParamInsertOutkaEdiRcvDtl(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PACK_INSTRUCTION", Me.NullConvertString(.Item("PACK_INSTRUCTION")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REQUEST_SHIP_LINE_QTY", Me.NullConvertString(.Item("REQUEST_SHIP_LINE_QTY")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CARRIER", Me.NullConvertString(.Item("CARRIER")), DBDataType.NVARCHAR))
...
#Region "出荷梱包個数計算単位取得処理(商品明細マスタ) パラメータ設定"

    ''' <summary>
    ''' 出荷梱包個数計算単位取得処理(商品明細マスタ) パラメータ設定
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectGoodsDetailsParameter()
...
#End Region ' "出荷梱包個数計算単位取得処理(商品明細マスタ) パラメータ設定"
