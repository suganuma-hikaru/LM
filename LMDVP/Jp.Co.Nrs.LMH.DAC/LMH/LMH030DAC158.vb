...
''' </summary>
''' <remarks></remarks>
Public Class LMH030DAC158
    Inherits Jp.Co.Nrs.LM.Base.DAC.LMBaseDAC

#Region "Const"

#Region "区分マスタ取得(区分グループコード単位)"

    Private Const SQL_SELECT_Z_KBN_2 As String = "" _
                                     & " SELECT                           " & vbNewLine _
                                     ...
                                     & " WHERE                            " & vbNewLine _
                                     & "     KBN_GROUP_CD = @KBN_GROUP_CD " & vbNewLine _
                                     & " ORDER BY                         " & vbNewLine _
                                     & "       KBN_GROUP_CD               " & vbNewLine _
                                     & "     , KBN_CD                     " & vbNewLine

#End Region ' "区分マスタ取得(区分グループコード単位)"
...
#Region "EDI出荷受信テーブル(ヘッダ) 件数 SELECT SQL"

    ''' <summary>
    ''' EDI出荷受信テーブル(ヘッダ) 件数 SELECT SQL
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_SELECT_COUNT_OUTKAEDI_HED As String = "" _
        & " SELECT                     " & vbNewLine _
...
#End Region ' "EDI出荷受信テーブル(ヘッダ) 件数取得 SQL"

#Region "EDI出荷受信テーブル(ヘッダ) 物理削除 SQL"

    ''' <summary>
    ''' EDI出荷受信テーブル(ヘッダ) 物理削除 SQL
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_DELETE_OUTKAEDI_HED As String = "" _
        & " DELETE                     " & vbNewLine _
        & " FROM                       " & vbNewLine _
        & "     $LM_TRN$..$RCV_HED$    " & vbNewLine _
        & " WHERE                      " & vbNewLine _
...
#End Region ' "EDI出荷受信テーブル(ヘッダ) 物理削除 SQL"

#Region "EDI出荷受信テーブル(ヘッダ) INSERT SQL"

    ''' <summary>
    ''' EDI出荷受信テーブル(ヘッダ) INSERT SQL
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_INSERT_OUTKAEDI_HED As String = "" _
        ...
        & "    , DENPYO_DATE                 " & vbNewLine _
        & "    , IRAI_SAKI_WH_CD             " & vbNewLine _
        & "    , DENPYO_KB                   " & vbNewLine _
        & "    , DENPYO_SB                   " & vbNewLine _
        & "    , SEND_WH_CD                  " & vbNewLine _
        & "    , DEST_NM                     " & vbNewLine _
        ...
        & "    , REMARK                      " & vbNewLine _
        & "    , SEND_MOTO_NM                " & vbNewLine _
        & "    , SEND_MOTO_ZIP               " & vbNewLine _
        & "    , SEND_MOTO_AD_1              " & vbNewLine _
        & "    , SEND_MOTO_AD_2              " & vbNewLine _
        & "    , SEND_MOTO_TEL               " & vbNewLine _
        & "    , SEND_NIN_NM                 " & vbNewLine _
        & "    , OUTKA_PLAN_DATE             " & vbNewLine _
        & "    , ARR_PLAN_DATE               " & vbNewLine _
        & "    , ARR_PLAN_TIME               " & vbNewLine _
        & "    , OUTKA_METHOD                " & vbNewLine _
        & "    , DENP_YN                     " & vbNewLine _
        & "    , RETURN_DENP_YN              " & vbNewLine _
        & "    , REPAIR_DENP_YN              " & vbNewLine _
        & "    , RECEIPT_YN                  " & vbNewLine _
        & "    , ASSEMBLY_YN                 " & vbNewLine _
        & "    , FURIWAKE_ID                 " & vbNewLine _
        & "    , NOTES                       " & vbNewLine _
        & "    , UNSOCO_DEPOT_CD             " & vbNewLine _
        & "    , UNSOCO_INQ_NO               " & vbNewLine _
        & "    , PROD_OUTKA_DENPYO_NO        " & vbNewLine _
        & "    , UNSOCO_CD                   " & vbNewLine _
        & "    , ASSORT_CD                   " & vbNewLine _
        & "    , ONDO_KB                     " & vbNewLine _
        & "    , SYUKA_TIME_JOKEN            " & vbNewLine _
        & "    , SERVICE_LEVEL_KB            " & vbNewLine _
        & "    , DATA_SKBT_KB                " & vbNewLine _
        & "    , PRIOR_NOTICE_FLG            " & vbNewLine _
        & "    , PRIOR_NOTICE_EMAIL_AD       " & vbNewLine _
        & "    , IMP_DEV_SB                  " & vbNewLine _
        & "    , MESSAGE_AREA                " & vbNewLine _
...
#End Region ' "EDI出荷受信テーブル(ヘッダ) INSERT  SQL"
...
#Region "EDI出荷受信テーブル(明細) INSERT SQL"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "" _
        ...
        & "    , LOT_NO                      " & vbNewLine _
        & "    , PRODUCT_NO                  " & vbNewLine _
        & "    , VERSION                     " & vbNewLine _
        & "    , GOODS_SB                    " & vbNewLine _
        ...
        & "    , GK                          " & vbNewLine _
        & "    , USER_NM                     " & vbNewLine _
        & "    , HOSP_DEPT                   " & vbNewLine _
        & "    , DOCTOR_NM                   " & vbNewLine _
        & "    , RENT_FROM                   " & vbNewLine _
        & "    , RENT_TO                     " & vbNewLine _
        & "    , RENT_DEV_KB                 " & vbNewLine _
        & "    , BOX_PIECE_KB                " & vbNewLine _
        & "    , SCI_MGMT_NO                 " & vbNewLine _
        & "    , CLASS_BR                    " & vbNewLine _
        & "    , MAINT_SPECIFIC              " & vbNewLine _
        & "    , USER_NM_FLG                 " & vbNewLine _
        & "    , USER_AD                     " & vbNewLine _
        & "    , PATIENT_ID                  " & vbNewLine _
        & "    , INSTALL_PLACE               " & vbNewLine _
        & "    , REPL_PIC                    " & vbNewLine _
        & "    , DELIV_DT                    " & vbNewLine _
        & "    , REPL_DEV                    " & vbNewLine _
        & "    , PATIENT_NM                  " & vbNewLine _
        & "    , DEST_ZIP                    " & vbNewLine _
        & "    , DEST_AD_1                   " & vbNewLine _
        & "    , DEST_TEL                    " & vbNewLine _
        & "    , RECORD_STATUS               " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_TRMSMPL"

    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_TRMSMPL）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_TRMSMPL SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "区分マスタ取得(区分グループコード単位)"
    ...
    ''' <remarks></remarks>
    Private Function SelectDataZkbn2(ByVal ds As DataSet) As DataSet

        ' SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_Z_KBN_2)

        Dim dt As DataTable = ds.Tables("LMH030_Z_KBN_IN")
        Dim drSemiEdiInfo As DataTable = ds.Tables("LMH030_SEMIEDI_INFO")

        Me._SqlPrmList = New ArrayList()

        ' パラメータ設定
        Call Me.SetKbnParameter2(dt)
        ...
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(sql)
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "SelectDataZkbn2", cmd)
            ...
            Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
                ...
                If reader.HasRows() = True Then
                    ...
                    ' 処理件数の設定
                    cnt = ds.Tables("LMH030_Z_KBN_OUT").Rows.Count
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得"
    ...
    Private Function GetOutkaCntAndNoL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_OUTKA_NO_L_AND_CNT)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_HED_TRMSMPL")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "GetOutkaCntAndNoL", cmd)
...
#Region "EDI出荷(大)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_UPDATE_DEL_OUTKAIEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateDelOutkaEdiL", cmd)
...
#Region "EDI出荷(中)テーブル更新(論理削除)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_UPDATE_DEL_OUTKAIEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateDelOutkaEdiM", cmd)
...
#Region "EDI出荷受信テーブル(ヘッダ) 件数取得"

    ''' <summary>
    ''' EDI出荷受信テーブル(ヘッダ) 件数取得
    ''' </summary>
    ''' <param name="ds"></param>
    ''' <returns></returns>
    Private Function GetOutkaEdiHedCnt(ByVal ds As DataSet) As DataSet

        ' SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_COUNT_OUTKAEDI_HED)
        ...
        ' EDI出荷受信テーブル(ヘッダ) テーブル名 設定
        Call Me.SetTableNmInsertOutkaEdiRcvHed(ds.Tables("LMH030_SEMIEDI_INFO"))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "GetOutkaEdiHedCnt", cmd)
...
#End Region ' "EDI出荷受信テーブル(ヘッダ) 件数取得"

#Region "EDI出荷受信テーブル(ヘッダ) 物理削除"

    ''' <summary>
    ''' EDI出荷受信テーブル(ヘッダ) 物理削除
    ''' </summary>
    ''' <param name="ds"></param>
    ''' <returns></returns>
    Private Function DeleteOutkaEdiHed(ByVal ds As DataSet) As DataSet

        ' SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_DELETE_OUTKAEDI_HED)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "DeleteOutkaEdiHed", cmd)
...
#End Region ' "EDI出荷受信テーブル(ヘッダ) 物理削除"

#Region "EDI出荷受信テーブル(ヘッダ) 新規登録"

    ''' <summary>
    ''' EDI出荷受信テーブル(ヘッダ) 新規登録
    ''' </summary>
    ''' <param name="ds"></param>
    ''' <returns></returns>
    Private Function InsertOutkaEdiRcvHed(ByVal ds As DataSet) As DataSet

        ' SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_INSERT_OUTKAEDI_HED)
        ...
        ' パラメータ設定
        Call Me.SetSqlParamInsertOutkaEdiRcvHed(dt)
        ' EDI出荷受信テーブル(ヘッダ) テーブル名 設定
        Call Me.SetTableNmInsertOutkaEdiRcvHed(ds.Tables("LMH030_SEMIEDI_INFO"))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertOutkaEdiRcvHed", cmd)
...
#End Region '  "EDI出荷受信テーブル(ヘッダ) 新規登録"
...
#Region "EDI出荷受信テーブル(明細) 件数取得"
    ...
    Private Function GetOutkaEdiDtlCnt(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_COUNT_OUTKAEDI_DTL)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_TRMSMPL")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "GetOutkaEdiDtlCnt", cmd)
...
#Region "EDI出荷受信テーブル(明細) 物理削除"
    ...
    Private Function DeleteOutkaEdiDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_DELETE_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "DeleteOutkaEdiDtl", cmd)
...
#Region "EDI出荷受信テーブル(明細) 新規登録"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_INSERT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "商品マスタ 件数取得"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        ' SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC158.SQL_WHERE1_M_GOODS)

        ' SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC158.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "SelectMstGoods", cmd)
...
#Region "EDI出荷(中)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_INSERT_OUTKAEDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertOutkaEdiM", cmd)
...
#Region "EDI出荷(大)テーブル新規登録"
    ...
    Private Function InsertOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_INSERT_OUTKAEDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertOutkaEdiL", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "SelectDataZkbn", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC158.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC158.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "SelectEdiM", cmd)
...
#Region "作業項目マスタ"
    ...
    Private Function SelectMSagyo(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC158.SQL_SELECT_M_SAGYO)
        ...
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(sql)
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "SelectMSagyo", cmd)
            ...
            Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
                ...
                If reader.HasRows() = True Then
                    ...
                    ' 処理件数の設定
                    cnt = ds.Tables("LMH030_M_SAGYO").Rows.Count()
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_OUTKA_M _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC158.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "InsertMDestData", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC158.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(String.Concat(setSql, LMH030DAC158.SQL_COM_UPDATE_CONDITION) _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC158.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                'setSql = LMH030DAC158.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC158.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateOutkaEdiMData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC158.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC158.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC158.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC158", "UpdateMDestData", cmd)
...
#Region "SQL パラメータ設定 区分マスタ取得(区分グループコード単位) 用"

    ''' <summary>
    ''' 区分マスタ取得(区分グループコード単位) パラメータ設定
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetKbnParameter2(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KBN_GROUP_CD", dt.Rows(0).Item("KBN_GROUP_CD"), DBDataType.CHAR))

    End Sub

#End Region ' "SQL パラメータ設定 区分マスタ取得(区分グループコード単位) 用"
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ・明細共通) 件数取得 用"

    ''' <summary>
    ''' SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ・明細共通) 件数取得 用
    ''' </summary>
    ''' <param name="dt"></param>
...
#End Region ' "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ・明細共通) 件数取得 用"

#Region "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ・明細共通) 物理削除 用"

    ''' <summary>
    ''' SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ・明細共通) 物理削除 用
    ''' </summary>
    ''' <param name="dt"></param>
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ) 新規登録 用"

    ''' <summary>
    ''' SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ) 新規登録 用
    ''' </summary>
    ''' <param name="dt"></param>
    Private Sub SetSqlParamInsertOutkaEdiRcvHed(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_DATE", Me.NullConvertString(.Item("DENPYO_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@IRAI_SAKI_WH_CD", Me.NullConvertString(.Item("IRAI_SAKI_WH_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_KB", Me.NullConvertString(.Item("DENPYO_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_SB", Me.NullConvertString(.Item("DENPYO_SB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_WH_CD", Me.NullConvertString(.Item("SEND_WH_CD")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_MOTO_NM", Me.NullConvertString(.Item("SEND_MOTO_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_MOTO_ZIP", Me.NullConvertString(.Item("SEND_MOTO_ZIP")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_MOTO_AD_1", Me.NullConvertString(.Item("SEND_MOTO_AD_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_MOTO_AD_2", Me.NullConvertString(.Item("SEND_MOTO_AD_2")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_MOTO_TEL", Me.NullConvertString(.Item("SEND_MOTO_TEL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_NIN_NM", Me.NullConvertString(.Item("SEND_NIN_NM")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_TIME", Me.NullConvertString(.Item("ARR_PLAN_TIME")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_METHOD", Me.NullConvertString(.Item("OUTKA_METHOD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_YN", Me.NullConvertString(.Item("DENP_YN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RETURN_DENP_YN", Me.NullConvertString(.Item("RETURN_DENP_YN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REPAIR_DENP_YN", Me.NullConvertString(.Item("REPAIR_DENP_YN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RECEIPT_YN", Me.NullConvertString(.Item("RECEIPT_YN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ASSEMBLY_YN", Me.NullConvertString(.Item("ASSEMBLY_YN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FURIWAKE_ID", Me.NullConvertString(.Item("FURIWAKE_ID")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NOTES", Me.NullConvertString(.Item("NOTES")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSOCO_DEPOT_CD", Me.NullConvertString(.Item("UNSOCO_DEPOT_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSOCO_INQ_NO", Me.NullConvertString(.Item("UNSOCO_INQ_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PROD_OUTKA_DENPYO_NO", Me.NullConvertString(.Item("PROD_OUTKA_DENPYO_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSOCO_CD", Me.NullConvertString(.Item("UNSOCO_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ASSORT_CD", Me.NullConvertString(.Item("ASSORT_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ONDO_KB", Me.NullConvertString(.Item("ONDO_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYUKA_TIME_JOKEN", Me.NullConvertString(.Item("SYUKA_TIME_JOKEN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SERVICE_LEVEL_KB", Me.NullConvertString(.Item("SERVICE_LEVEL_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATA_SKBT_KB", Me.NullConvertString(.Item("DATA_SKBT_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PRIOR_NOTICE_FLG", Me.NullConvertString(.Item("PRIOR_NOTICE_FLG")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PRIOR_NOTICE_EMAIL_AD", Me.NullConvertString(.Item("PRIOR_NOTICE_EMAIL_AD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@IMP_DEV_SB", Me.NullConvertString(.Item("IMP_DEV_SB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MESSAGE_AREA", Me.NullConvertString(.Item("MESSAGE_AREA")), DBDataType.NVARCHAR))
...
#End Region ' "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ) 新規登録 用"

#Region "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ) テーブル名"

    ''' <summary>
    ''' SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ) テーブル名
    ''' </summary>
    ''' <param name="dt"></param>
    Private Sub SetTableNmInsertOutkaEdiRcvHed(ByVal dt As DataTable)
...
#End Region ' "SQL パラメータ設定 EDI出荷受信テーブル(ヘッダ) テーブル名"
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(明細) 新規登録 用"
    ...
    Private Sub SetSqlParamInsertOutkaEdiRcvDtl(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            ' EDI受信（DTL）荷主個別項目
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_NO", Me.NullConvertString(.Item("DENPYO_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_DATE", Me.NullConvertString(.Item("DENPYO_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@IRAI_SAKI_WH_CD", Me.NullConvertString(.Item("IRAI_SAKI_WH_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_KB", Me.NullConvertString(.Item("DENPYO_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_SB", Me.NullConvertString(.Item("DENPYO_SB")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PRODUCT_NO", Me.NullConvertString(.Item("PRODUCT_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@VERSION", Me.NullConvertString(.Item("VERSION")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_SB", Me.NullConvertString(.Item("GOODS_SB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_NM", Me.NullConvertString(.Item("GOODS_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PURPOSE", Me.NullConvertString(.Item("PURPOSE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_TTL_NB", Me.FormatNumValue(.Item("OUTKA_TTL_NB").ToString()), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TANKA", Me.NullConvertString(.Item("TANKA")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GK", Me.NullConvertString(.Item("GK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@USER_NM", Me.NullConvertString(.Item("USER_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HOSP_DEPT", Me.NullConvertString(.Item("HOSP_DEPT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DOCTOR_NM", Me.NullConvertString(.Item("DOCTOR_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RENT_FROM", Me.NullConvertString(.Item("RENT_FROM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RENT_TO", Me.NullConvertString(.Item("RENT_TO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@RENT_DEV_KB", Me.NullConvertString(.Item("RENT_DEV_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BOX_PIECE_KB", Me.NullConvertString(.Item("BOX_PIECE_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SCI_MGMT_NO", Me.NullConvertString(.Item("SCI_MGMT_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CLASS_BR", Me.NullConvertString(.Item("CLASS_BR")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MAINT_SPECIFIC", Me.NullConvertString(.Item("MAINT_SPECIFIC")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@USER_NM_FLG", Me.NullConvertString(.Item("USER_NM_FLG")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@USER_AD", Me.NullConvertString(.Item("USER_AD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PATIENT_ID", Me.NullConvertString(.Item("PATIENT_ID")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INSTALL_PLACE", Me.NullConvertString(.Item("INSTALL_PLACE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REPL_PIC", Me.NullConvertString(.Item("REPL_PIC")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DELIV_DT", Me.NullConvertString(.Item("DELIV_DT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REPL_DEV", Me.NullConvertString(.Item("REPL_DEV")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PATIENT_NM", Me.NullConvertString(.Item("PATIENT_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_ZIP", Me.NullConvertString(.Item("DEST_ZIP")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_AD_1", Me.NullConvertString(.Item("DEST_AD_1")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_TEL", Me.NullConvertString(.Item("DEST_TEL")), DBDataType.NVARCHAR))
...
#Region "作業項目マスタパラメータ設定"
    ...
    Private Sub SelectMSagyoParameter(ByVal sagyoMIn As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(sagyoMIn.Item("NRS_BR_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(sagyoMIn.Item("CUST_CD_L")), DBDataType.CHAR))

    End Sub

#End Region ' "作業項目マスタパラメータ設定"
