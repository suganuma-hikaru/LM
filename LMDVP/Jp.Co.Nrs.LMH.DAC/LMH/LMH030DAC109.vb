...
#Region "H_OUTKAEDI_DTL_XXX(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO      " & vbNewLine _
                                        ...
                                        & ",JYUCYU_NO_GYO		" & vbNewLine _
                                        & ",M_TEKIYO			" & vbNewLine _
                                        & ",GOODS_NM			" & vbNewLine _
                                        & ",GOODS_REMARKS		" & vbNewLine _
                                        & ",OUTKA_QT			" & vbNewLine _
                                        & ",NISUGATA_QT			" & vbNewLine _
                                        & ",NISUGATA_UT			" & vbNewLine _
                                        & ",TOKUISAKI_NM		" & vbNewLine _
                                        & ",NOUHINSAKI_NM		" & vbNewLine _
                                        & ",NOUHINSAKI_BIKOU	" & vbNewLine _
                                        & ",OUTKA_IRAISYO		" & vbNewLine _
                                        & ",OUTKA_KBN			" & vbNewLine _
                                        & ",GOODS_CD			" & vbNewLine _
                                        & ",TOKUISAKI_CD		" & vbNewLine _
                                        & ",NOUHINSAKI_CD		" & vbNewLine _
                                        & ",NISUGATA_KBN		" & vbNewLine _
                                        & ",OUTKA_NO			" & vbNewLine _
                                        & ",OUTKA_NO_GYO		" & vbNewLine _
                                        & ",OUTKA_SIJI_NO		" & vbNewLine _
                                        & ",SIJI_GYO			" & vbNewLine _
                                        & ",URIAGE_NO			" & vbNewLine _
                                        & ",URIAGE_GYO			" & vbNewLine _
                                        & ",RECORD_STATUS	            " & vbNewLine _
                                        & ",JISSEKI_SHORI_FLG	        " & vbNewLine _
                                        & ",JISSEKI_USER	            " & vbNewLine _
                                        & ",JISSEKI_DATE	            " & vbNewLine _
...
#Region "オーダー番号重複チェック(美浜専用)"
    Private Const SQL_SELECT_C_OUTKA_LM_MHM As String = " SELECT                                  " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_MHM"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_MHM）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_MHM SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_MHM"
    '美浜は受信HEDを持っていないため更新しない
    '''' <summary>
    '''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_MHM）
    '''' </summary>
    '''' <remarks></remarks>
    'Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_MHM SET       " & vbNewLine _
    '                                          & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#End Region
    ...
    '#Region "M_DEST INSERT(美浜は自動追加がない為使用しない)"
    ...
    '#Region "M_DEST UPDATE(届先項目差異有りの場合)(美浜は自動更新がない為使用しない)"
    '    ''' <summary>
    '    ''' 届先マスタUPDATE文（M_DEST）
    '    ''' </summary>
    '    ''' <remarks></remarks>
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC109.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC109.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectDataNcgoMdest", cmd)
...
#Region "出荷(大,中)データ(オーダー番号チェック用)：美浜専用"
    ...
    Private Function SelectOrderCheckDataMHM(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC109.SQL_SELECT_C_OUTKA_LM_MHM)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterLMHM(dt)
        Call Me.SetOutkaParameterMMHM(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectOrderCheckDataMHM", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC109.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC109.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    '        '出荷登録、紐付けSQL CONST名
    '        Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
    '            setSql = LMH030DAC109.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

    '            '実績作成SQL CONST名
    '        Case LMH030DAC.EventShubetsu.CREATEJISSEKI
    '            setSql = LMH030DAC109.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC109.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '    '実績作成SQL CONST名
                'Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                '    setSql = LMH030DAC109.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC109.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC109.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC109.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(美浜は自動更新がないため使用しない)"
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertUnchinData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(美浜は自動追加がない為、使用しない)"
    ...
    '        'SQL文のコンパイル
    '        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertMDestData", cmd)
...
#Region "出荷パラメータ設定(オーダー番号チェック用) 美浜専用"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterLMHM(ByVal dt As DataTable)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterMMHM(ByVal dt As DataTable)
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectDataMdestOutkaToroku", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        '取消データは受信DTLから取得する
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_MHM")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectOutkaEdiRcvCancel", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_MHM_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_MHM_CANCELOUT").Rows.Count())
        reader.Close()
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_MHM")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC109.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC109.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectDataMgoods", cmd)
...
#Region "届先マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.SQL_SELECT_M_DEST1)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC109.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "SelectDataMDEST", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_DTL_MHM_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC109.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC109.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHedCancel As DataTable = ds.Tables("LMH030_DTL_MHM_CANCELOUT")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC109.SQL_UPDATE_DEL_OUTKAEDI_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_MHM_CANCELOUT")   'DTLの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC109.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHed As DataTable = setDs.Tables("LMH030_OUTKAEDI_HED_MHM")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_MHM").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_MHM")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC109.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_OUTKAEDI_DTL_MHM").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@JYUCYU_NO_GYO", Me.NullConvertString(.Item("JYUCYU_NO_GYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@M_TEKIYO", Me.NullConvertString(.Item("M_TEKIYO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_NM", Me.NullConvertString(.Item("GOODS_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_REMARKS", Me.NullConvertString(.Item("GOODS_REMARKS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_QT", Me.NullConvertString(.Item("OUTKA_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NISUGATA_QT", Me.NullConvertString(.Item("NISUGATA_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NISUGATA_UT", Me.NullConvertString(.Item("NISUGATA_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_NM", Me.NullConvertString(.Item("TOKUISAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUHINSAKI_NM", Me.NullConvertString(.Item("NOUHINSAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NOUHINSAKI_BIKOU", Me.NullConvertString(.Item("NOUHINSAKI_BIKOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_IRAISYO", Me.NullConvertString(.Item("OUTKA_IRAISYO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_KBN", Me.NullConvertString(.Item("OUTKA_KBN")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@NOUHINSAKI_CD", Me.NullConvertString(.Item("NOUHINSAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NISUGATA_KBN", Me.NullConvertString(.Item("NISUGATA_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_NO", Me.NullConvertString(.Item("OUTKA_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_NO_GYO", Me.NullConvertString(.Item("OUTKA_NO_GYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_SIJI_NO", Me.NullConvertString(.Item("OUTKA_SIJI_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SIJI_GYO", Me.NullConvertString(.Item("SIJI_GYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@URIAGE_NO", Me.NullConvertString(.Item("URIAGE_NO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@URIAGE_GYO", Me.NullConvertString(.Item("URIAGE_GYO")), DBDataType.NUMERIC))
...
#Region "明細数取得"
    ...
    Public Function GetEdiMCount(ByVal sNRS_BR_CD As String, ByVal sOUTKA_NO As String, ByVal sOUTKA_NO_GYO As String) As Integer
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC109.SQL_GET_EDI_M_COUNT)      'SQL構築(データ抽出用)
