...
'  EDI荷主ID　　　　:  163　　　 : ENEOS(2023/01/11(REV.5582)のセミEDI標準仕様000からコピー)
'  作  成  者       :  
' ==========================================================================
Imports System.Text
...
''' </summary>
''' <remarks></remarks>
Public Class LMH030DAC163
    Inherits Jp.Co.Nrs.LM.Base.DAC.LMBaseDAC

#Region "Const(EDI取込系)"

#Region "運送フラグ SELECT SQL"

    ''' <summary>
    ''' 運送フラグ SELECT SQL
    ''' </summary>
    Private Const SQL_SELECT_UNSOFLG As String = "" _
        & "SELECT                         " & vbNewLine _
        & " FLAG_14 AS  EDI_CUST_UNSOFLG  " & vbNewLine _
...
#Region "EDI出荷データ件数および出荷データL 出荷管理番号L 等 SELECT SQL"
    ...
    Private Const SQL_SELECT_OUTKA_NO_L_AND_CNT As String = "" _
        ...
        & "AND H_OUTKAEDI_L.FREE_C01 = @DENP_NO                         " & vbNewLine _
        & "AND H_OUTKAEDI_L.SYS_DEL_FLG = '0'                           " & vbNewLine

    ''' <summary>
    ''' EDI出荷データ件数および運送データL 運送番号L 等 SELECT SQL
    ''' </summary>
    Private Const SQL_SELECT_INOUTKA_NO_L_AND_CNTO As String = "" _
        & "SELECT                                                                " & vbNewLine _
        & "      COUNT(*) AS OUTKA_CNT                                           " & vbNewLine _
        & "    , MAX(F_UNSO_L.UNSO_NO_L) AS OUTKA_NO_L                           " & vbNewLine _
        & "    , MAX(H_OUTKAEDI_L.EDI_CTL_NO) AS EDI_CTL_NO                      " & vbNewLine _
        & "FROM                                                                  " & vbNewLine _
        & "    $LM_TRN$..H_OUTKAEDI_L                                            " & vbNewLine _
        & "LEFT JOIN                                                             " & vbNewLine _
        & "    $LM_TRN$..F_UNSO_L                                                " & vbNewLine _
        & "        ON  F_UNSO_L.NRS_BR_CD = H_OUTKAEDI_L.NRS_BR_CD               " & vbNewLine _
        & "        AND F_UNSO_L.UNSO_NO_L = SUBSTRING(H_OUTKAEDI_L.FREE_C30,4,9) " & vbNewLine _
        & "        AND F_UNSO_L.SYS_DEL_FLG = '0'                                " & vbNewLine _
        & "WHERE                                                                 " & vbNewLine _
        & "    H_OUTKAEDI_L.NRS_BR_CD = @NRS_BR_CD                               " & vbNewLine _
        & "AND H_OUTKAEDI_L.CUST_CD_L = @CUST_CD_L                               " & vbNewLine _
        & "AND H_OUTKAEDI_L.CUST_CD_M = @CUST_CD_M                               " & vbNewLine _
...
#Region "EDI出荷受信テーブル(明細) INSERT SQL"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "" _
        ...
        & "    , INOUTKA_KBN                 " & vbNewLine _
        & "    , DENP_TYPE                   " & vbNewLine _
        & "    , DENP_TYPE_TXT               " & vbNewLine _
        & "    , DTL_CTG                     " & vbNewLine _
        & "    , DTL_CTG_TXT                 " & vbNewLine _
        & "    , DENP_NO                     " & vbNewLine _
        & "    , DTL_NO                      " & vbNewLine _
        & "    , INOUTKA_PLAN_DATE           " & vbNewLine _
        & "    , DUE_DATE                    " & vbNewLine _
        & "    , DUE_TIME                    " & vbNewLine _
        & "    , GOODS_CD_CUST               " & vbNewLine _
        & "    , GOODS_NM                    " & vbNewLine _
        & "    , PKG_UT                      " & vbNewLine _
        & "    , EVA_CLASS                   " & vbNewLine _
        & "    , LOT_NO                      " & vbNewLine _
        & "    , GASOLINE_TAX_KB             " & vbNewLine _
        & "    , DENPYO_QT_TTL               " & vbNewLine _
        & "    , DENP_QT                     " & vbNewLine _
        & "    , DENP_QT_UT                  " & vbNewLine _
        & "    , NB_TTL                      " & vbNewLine _
        & "    , NB                          " & vbNewLine _
        & "    , NB_UT                       " & vbNewLine _
        & "    , WT_TTL                      " & vbNewLine _
        & "    , WT                          " & vbNewLine _
        & "    , WT_UT                       " & vbNewLine _
        & "    , IRIME_TTL                   " & vbNewLine _
        & "    , STD_IRIME_NB                " & vbNewLine _
        & "    , STD_IRIME_UT                " & vbNewLine _
        & "    , JYUYOKA_CD                  " & vbNewLine _
        & "    , JYUYOKA_NM                  " & vbNewLine _
        & "    , ORD_RCV_CD                  " & vbNewLine _
        & "    , ORD_RCV_NM                  " & vbNewLine _
        & "    , PURCHASE_CD                 " & vbNewLine _
        & "    , PURCHASE_NM                 " & vbNewLine _
        & "    , SUPPLY_PLANT_CD             " & vbNewLine _
        & "    , SUPPLY_PLANT_NM             " & vbNewLine _
        & "    , DEST_CD                     " & vbNewLine _
        & "    , DEST_NM                     " & vbNewLine _
        & "    , DEST_ZIP                    " & vbNewLine _
        & "    , DEST_ADDRESS                " & vbNewLine _
        & "    , SHIP_FROM_CD                " & vbNewLine _
        & "    , SHIP_FROM_NM                " & vbNewLine _
        & "    , SHIP_FROM_ZIP               " & vbNewLine _
        & "    , SHIP_FROM_ADDRESS           " & vbNewLine _
        & "    , UNSO_MODE_CD                " & vbNewLine _
        & "    , UNSO_MODE_TXT               " & vbNewLine _
        & "    , UNSO_CD                     " & vbNewLine _
        & "    , UNSO_NM                     " & vbNewLine _
        & "    , UNSO_TYPE_CD                " & vbNewLine _
        & "    , UNSO_TYPE_TXT               " & vbNewLine _
        & "    , TRANS_CD                    " & vbNewLine _
        & "    , TRANS_TXT                   " & vbNewLine _
        ...
        & "    , KEEP_MK                     " & vbNewLine _
        & "    , UPD_KB                      " & vbNewLine _
        & "    , KOKUYU_KB                   " & vbNewLine _
        & "    , INOUTKA_DONE_KB             " & vbNewLine _
        & "    , SENPO_ORD_NO                " & vbNewLine _
        & "    , DO_NO                       " & vbNewLine _
        & "    , ORDER_COM                   " & vbNewLine _
        & "    , SENPO_COM                   " & vbNewLine _
        & "    , SASHIZU_COM                 " & vbNewLine _
...
#Region "SELECT_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_SELECT_M_GOODS As String _
                    ...
                    & ",M_GOODS.AVAL_YN                AS  AVAL_YN                 " & vbNewLine _
                    & " FROM                                                       " & vbNewLine _
                    & " $LM_MST$..M_GOODS              M_GOODS                     " & vbNewLine _
                    & " LEFT JOIN                                                  " & vbNewLine _
                    & "     $LM_MST$..M_GOODS_DETAILS   DETAILS83                  " & vbNewLine _
                    & "     ON  DETAILS83.NRS_BR_CD = M_GOODS.NRS_BR_CD            " & vbNewLine _
                    & "     AND DETAILS83.GOODS_CD_NRS = M_GOODS.GOODS_CD_NRS      " & vbNewLine _
                    & "     AND DETAILS83.SUB_KB = '83'                            " & vbNewLine _
                    & "     AND DETAILS83.SYS_DEL_FLG = '0'                        " & vbNewLine _
                    & " LEFT JOIN                                                  " & vbNewLine _
                    & "     $LM_MST$..M_GOODS_DETAILS   DETAILS84                  " & vbNewLine _
                    & "     ON  DETAILS84.NRS_BR_CD = M_GOODS.NRS_BR_CD            " & vbNewLine _
                    & "     AND DETAILS84.GOODS_CD_NRS = M_GOODS.GOODS_CD_NRS      " & vbNewLine _
                    & "     AND DETAILS84.SUB_KB = '84'                            " & vbNewLine _
                    & "     AND DETAILS84.SYS_DEL_FLG = '0'                        " & vbNewLine
...
#Region "WHERE1_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_WHERE1_M_GOODS As String =
                                     ...
                                     & " AND                                                " & vbNewLine _
                                     & " DETAILS83.SET_NAIYO = @GOODS_CD_CUST               " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " DETAILS84.SET_NAIYO = @PKG_UT                      " & vbNewLine
...
#Region "GROUP_BY_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_GROUP_BY_M_GOODS As String _
                    ...
                    & ",M_GOODS.SYS_DEL_FLG           " & vbNewLine _
                    & ",M_GOODS.AVAL_YN               " & vbNewLine
...
#Region "SELECT_M_DEST"
    ...
    Private Const SQL_SELECT_M_DEST As String = " SELECT                                   " & vbNewLine _
                                     ...
                                     & " AND                                                   " & vbNewLine _
                                     & " M_DEST.SYS_DEL_FLG = '0'                              " & vbNewLine
...
#Region "H_OUTKAEDI_L(取込削除時)"
    ...
    Private Const SQL_UPDATE_DEL_OUTKAIEDI_L As String _
                        ...
                        & " AND   CUST_CD_L     = @CUST_CD_L            " & vbNewLine _
                        & " AND   CUST_CD_M     = @CUST_CD_M            " & vbNewLine _
                        & " AND   FREE_C01      = @DENP_NO              " & vbNewLine
...
#Region "H_OUTKAEDI_M(取込削除)"
    ...
    Private Const SQL_UPDATE_DEL_OUTKAIEDI_M As String _
                        ...
                        & "WHERE HOM.NRS_BR_CD  = @NRS_BR_CD            " & vbNewLine _
                        & "AND   HOL.CUST_CD_L  = @CUST_CD_L            " & vbNewLine _
                        & "AND   HOL.CUST_CD_M  = @CUST_CD_M            " & vbNewLine _
                        & "AND   HOL.FREE_C01   = @DENP_NO              " & vbNewLine
#End Region
...
#Region "H_OUTKAEDI_M(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_M As String = "INSERT INTO          " & vbNewLine _
                                         ...
                                         & ",GOODS_NM                     " & vbNewLine _
                                         & ",GOODSM_FUKAKUTEI_FLG  --ADD 2019/12/16 " & vbNewLine _
                                         & ",RSV_NO                       " & vbNewLine _
                                         & ",LOT_NO                       " & vbNewLine _
...
#Region "運送フラグ取得処理"
    ...
    ''' <param name="ds"></param>
    ''' <returns></returns>
    Private Function GetUnsoFlg(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_UNSOFLG)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "GetUnsoFlg", cmd)
        ...
        If reader.Read() = True Then
            ...
            Dim dr As DataRow
            dr = ds.Tables("LMH030INOUT").NewRow()
            dr("EDI_CUST_UNSOFLG") = reader("EDI_CUST_UNSOFLG").ToString().Trim()
            ds.Tables("LMH030INOUT").Rows.Add(dr)
        ...
        MyBase.SetResultCount(recCnt)
        Return ds

    End Function

#End Region ' "運送フラグ取得処理"
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得"
    ...
    Private Function GetOutkaCntAndNoL(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_OUTKA_NO_L_AND_CNT)

        Dim dt As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_ENE")
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "GetOutkaCntAndNoL", cmd)
...
#Region "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および入出荷管理番号L 等 の取得"

    ''' <summary>
    ''' セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および入出荷管理番号L 等 の取得
    ''' </summary>
    ''' <param name="ds"></param>
    ''' <returns></returns>
    Private Function GetOutkaCntAndNoLUnso(ByVal ds As DataSet) As DataSet

        ' SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        ' SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_INOUTKA_NO_L_AND_CNTO)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "GetOutkaCntAndNoLUnso", cmd)
...
#End Region ' "セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および入出荷管理番号L 等 の取得"
...
#Region "EDI出荷受信テーブル(明細) 件数取得"
    ...
    Private Function GetOutkaEdiDtlCnt(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_COUNT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "GetOutkaEdiDtlCnt", cmd)
...
#Region "商品マスタ"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC163.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC163.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectDataMgoods", cmd)
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC163.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "荷主明細マスタ（SUB_KB=0L）"
    ...
    Private Function SelectMstCustD0L(ByVal ds As DataSet) As DataSet
        ...
        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC163.SQL_WHERE1_M_CUST_DETAILS_FIR)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC163.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectDataMdestOutkaToroku", cmd)
    ...
    Private Function SelectLikeDataMdest(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectDataMdest", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectDataZkbn", cmd)
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals(LMConst.FLG.ON) = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC163.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC163.SQL_WHERE_CANCER_DATA_DTL)

            'オーダー番号＋オーダー番号明細チェックの場合
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("3") = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC163.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC163.SQL_WHERE_CANCER_DATA_DTL_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("4") = True Then
            ...
            Me._StrSql.Append(LMH030DAC163.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC163.SQL_WHERE_CANCER_DATA_DTL_ONLY_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("5") = True Then
            ...
            Me._StrSql.Append(LMH030DAC163.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC163.SQL_WHERE_CANCER_DATA_DTL_M_FREE_C25)
            '2015.04.28 Ｍ・Ｒ・Ｃデュポン対応 M_FREE_C25_NOの(オーダー番号明細のみ)チェックの場合 追加END
        Else
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC163.SQL_SELECT_CANCER_DATA)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC163.SQL_WHERE_CANCER_DATA)
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    Private Function SelectCompareData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_ARB") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC163.SQL_SELECT_COMPARE_CHECK_ARB, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_MRC") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC163.SQL_SELECT_COMPARE_CHECK_MRC, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC163.SQL_WHERE_M_CUST_DETAILS_ALL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectMstCustAll", cmd)
...
#Region "H_OUTKAEDI_L"
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC163.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE _
               , LMH030DAC.EventShubetsu.SAVEUNSO
                setSql = LMH030DAC163.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC163.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC163.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertOutkaEdiM", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC163.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC163.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateOutkaLData", cmd)
    ...
    Private Function UpdateOutkaLDataWithBuyerOrdNo(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録(まとめ時)
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC163.SQL_UPDATE_OUTKAL_MATOME_WITH_BUYER_ORD_NO
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC163.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC163.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC163", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC163.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertMDestData", cmd)
...
#Region "SQL パラメータ設定 運送フラグ取得 用"
    ...
    ''' <param name="dt"></param>
    ''' <remarks></remarks>
    Private Sub SetUnsoFlgPrm(ByVal dt As DataTable)
...
#End Region ' "SQL パラメータ設定 運送フラグ取得 用"
...
#Region "SQL パラメータ設定 セミEDI入力ファイル(Excel Book) 伝票番号からの、EDI出荷件数および出荷管理番号L 等 の取得 用"
    ...
    Private Sub SetSqlParamGetOutkaCntAndNoL(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", dt.Rows(0).Item("CUST_CD_L"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", dt.Rows(0).Item("CUST_CD_M"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_NO", dt.Rows(0).Item("DENP_NO"), DBDataType.CHAR))
    End Sub
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectMstGoodsParameter(ByVal drMgoods As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PKG_UT", Me.NullConvertString(drMgoods.Item("PKG_UT")), DBDataType.NVARCHAR))
...
#Region "EDI出荷(大・中共通)の削除UPDATE文(セミEDI用)"
    ...
    Private Sub SetUpdateDelOutkaEdiParameter(ByVal drOutkaEdiRcvIn As DataRow, ByVal prmList As ArrayList)
        ...
        prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(drOutkaEdiRcvIn.Item("CUST_CD_L")), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(drOutkaEdiRcvIn.Item("CUST_CD_M")), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_NO", Me.NullConvertString(drOutkaEdiRcvIn.Item("DENP_NO")), DBDataType.VARCHAR))
    End Sub
...
#Region "共通パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetDataInsertParameter(ByVal prmList As ArrayList, Optional ByVal sysDelFlg As String = BaseConst.FLG.OFF)
        ...
        prmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", sysDelFlg, DBDataType.CHAR))
...
#Region "EDI出荷受信テーブル(明細) 物理削除"
    ...
    Private Function DeleteOutkaEdiDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_DELETE_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "DeleteOutkaEdiDtl", cmd)
...
#Region "EDI出荷受信テーブル(明細) 新規登録"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        ' SQL作成
        Me._StrSql.Append(LMH030DAC163.SQL_INSERT_OUTKAEDI_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC163", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "SQL パラメータ設定 EDI出荷受信テーブル(明細) 新規登録 用"
    ...
    Private Sub SetSqlParamInsertOutkaEdiRcvDtl(ByVal dt As DataTable)
        ...
        With dt.Rows(0)
            ...
            ' EDI受信（DTL）荷主個別項目
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUT_TGT", Me.NullConvertString(.Item("OUT_TGT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PLANT_CD", Me.NullConvertString(.Item("PLANT_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PLANT_NM", Me.NullConvertString(.Item("PLANT_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUTKA_KBN", Me.NullConvertString(.Item("INOUTKA_KBN")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_TYPE", Me.NullConvertString(.Item("DENP_TYPE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_TYPE_TXT", Me.NullConvertString(.Item("DENP_TYPE_TXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DTL_CTG", Me.NullConvertString(.Item("DTL_CTG")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DTL_CTG_TXT", Me.NullConvertString(.Item("DTL_CTG_TXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_NO", Me.NullConvertString(.Item("DENP_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DTL_NO", Me.NullConvertString(.Item("DTL_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUTKA_PLAN_DATE", Me.NullConvertString(.Item("INOUTKA_PLAN_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DUE_DATE", Me.NullConvertString(.Item("DUE_DATE")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DUE_TIME", Me.NullConvertString(.Item("DUE_TIME")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(.Item("GOODS_CD_CUST")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_NM", Me.NullConvertString(.Item("GOODS_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PKG_UT", Me.NullConvertString(.Item("PKG_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EVA_CLASS", Me.NullConvertString(.Item("EVA_CLASS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GASOLINE_TAX_KB", Me.NullConvertString(.Item("GASOLINE_TAX_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENPYO_QT_TTL", Me.NullConvertString(.Item("DENPYO_QT_TTL")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_QT", Me.NullConvertString(.Item("DENP_QT")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_QT_UT", Me.NullConvertString(.Item("DENP_QT_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NB_TTL", Me.NullConvertString(.Item("NB_TTL")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NB", Me.NullConvertString(.Item("NB")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NB_UT", Me.NullConvertString(.Item("NB_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WT_TTL", Me.NullConvertString(.Item("WT_TTL")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WT", Me.NullConvertString(.Item("WT")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@WT_UT", Me.NullConvertString(.Item("WT_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@IRIME_TTL", Me.NullConvertString(.Item("IRIME_TTL")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@STD_IRIME_NB", Me.NullConvertString(.Item("STD_IRIME_NB")), DBDataType.NUMERIC))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@STD_IRIME_UT", Me.NullConvertString(.Item("STD_IRIME_UT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JYUYOKA_CD", Me.NullConvertString(.Item("JYUYOKA_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JYUYOKA_NM", Me.NullConvertString(.Item("JYUYOKA_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORD_RCV_CD", Me.NullConvertString(.Item("ORD_RCV_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORD_RCV_NM", Me.NullConvertString(.Item("ORD_RCV_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PURCHASE_CD", Me.NullConvertString(.Item("PURCHASE_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PURCHASE_NM", Me.NullConvertString(.Item("PURCHASE_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SUPPLY_PLANT_CD", Me.NullConvertString(.Item("SUPPLY_PLANT_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SUPPLY_PLANT_NM", Me.NullConvertString(.Item("SUPPLY_PLANT_NM")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEST_ADDRESS", Me.NullConvertString(.Item("DEST_ADDRESS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_FROM_CD", Me.NullConvertString(.Item("SHIP_FROM_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_FROM_NM", Me.NullConvertString(.Item("SHIP_FROM_NM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_FROM_ZIP", Me.NullConvertString(.Item("SHIP_FROM_ZIP")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIP_FROM_ADDRESS", Me.NullConvertString(.Item("SHIP_FROM_ADDRESS")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_MODE_CD", Me.NullConvertString(.Item("UNSO_MODE_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_MODE_TXT", Me.NullConvertString(.Item("UNSO_MODE_TXT")), DBDataType.NVARCHAR))
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_TYPE_CD", Me.NullConvertString(.Item("UNSO_TYPE_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSO_TYPE_TXT", Me.NullConvertString(.Item("UNSO_TYPE_TXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TRANS_CD", Me.NullConvertString(.Item("TRANS_CD")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TRANS_TXT", Me.NullConvertString(.Item("TRANS_TXT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DESCRIPTION", Me.NullConvertString(.Item("DESCRIPTION")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TRIP_NO", Me.NullConvertString(.Item("TRIP_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EQT", Me.NullConvertString(.Item("EQT")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KENPOU", Me.NullConvertString(.Item("KENPOU")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KEEP_MK", Me.NullConvertString(.Item("KEEP_MK")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_KB", Me.NullConvertString(.Item("UPD_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KOKUYU_KB", Me.NullConvertString(.Item("KOKUYU_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUTKA_DONE_KB", Me.NullConvertString(.Item("INOUTKA_DONE_KB")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SENPO_ORD_NO", Me.NullConvertString(.Item("SENPO_ORD_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DO_NO", Me.NullConvertString(.Item("DO_NO")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ORDER_COM", Me.NullConvertString(.Item("ORDER_COM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SENPO_COM", Me.NullConvertString(.Item("SENPO_COM")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SASHIZU_COM", Me.NullConvertString(.Item("SASHIZU_COM")), DBDataType.NVARCHAR))
            ...
            ' システム管理用項目（削除フラグ指定あり）
            Call Me.SetDataInsertParameter(Me._SqlPrmList, sysDelFlg:=Me.NullConvertString(.Item("DEL_KB")).ToString())
        End With
