...
#Region "SELECT_M_GOODS_DETAILS(SUB_KB = '48')"

    ''' <summary>
    ''' 商品明細マスタ読込(SELECT句)
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SELECT_M_GOODS_DETL As String _
                                     = " SELECT                                              " & vbNewLine _
                                     & " NRS_BR_CD                      AS  NRS_BR_CD        " & vbNewLine _
                                     & ",GOODS_CD_NRS                   AS  GOODS_CD_NRS     " & vbNewLine _
                                     ...
                                     & ",SET_NAIYO                      AS  SET_NAIYO        " & vbNewLine _
                                     & ",REMARK                         AS  REMARK           " & vbNewLine _
                                     & " FROM $LM_MST$..M_GOODS_DETAILS  M_GOODS_DETAILS     " & vbNewLine

    ''' <summary>
    ''' 商品明細マスタ読込(WHERE句)
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_WHERE_M_GOODS_DETL_SUB48 As String = _
                                       " WHERE                                              " & vbNewLine _
                                     & " M_GOODS_DETAILS.NRS_BR_CD = @NRS_BR_CD             " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.GOODS_CD_NRS = @NRS_GOODS_CD       " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.SUB_KB = '48'                      " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.SYS_DEL_FLG = '0'                  " & vbNewLine

    ''' <summary>
    ''' 商品明細マスタ読込(WHERE句)
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_WHERE_M_GOODS_DETL_SUB49 As String = _
                                       " WHERE                                              " & vbNewLine _
                                     & " M_GOODS_DETAILS.NRS_BR_CD = @NRS_BR_CD             " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.GOODS_CD_NRS = @GOODS_CD_NRS       " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.SUB_KB = '49'                      " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.SYS_DEL_FLG = '0'                  " & vbNewLine
...
#End Region
    ...
    '    ''' <remarks></remarks>
    '    Private Function SelectDataCustDetails(ByVal ds As DataSet) As DataSet
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC210.SELECT_M_DEST_DETL)

    '        Me._StrSql.Append(LMH030DAC210.SQL_WHERE_M_DEST_DETL)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectDataCustDetails", cmd)
    ...
    '            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_M_DEST_DETAILS")

    '            '処理件数の設定
    '            destCnt = ds.Tables("LMH030_M_DEST_DETAILS").Rows.Count
...
#Region "キャンセルデータ抽出"
    ...
    Private Const SQL_WHERE_CANCER_DATA_DTL As String = "  AND HOL.NRS_BR_CD       = @NRS_BR_CD      --@パラ " & vbNewLine _
                                                   ...
                                                   & "--  AND ISNULL(COL.CUST_ORD_NO + COM.CUST_ORD_NO_DTL,HOL.CUST_ORD_NO +HOM.CUST_ORD_NO_DTL) = @CUST_ORD_NO    --@パラ " & vbNewLine _
                                                   & "  AND ISNULL(COL.CUST_ORD_NO,HOL.CUST_ORD_NO) = @CUST_ORD_NO    --@パラ " & vbNewLine _
    ...
    Private Const SQL_SELECT_CANCER_DATA_DTL_CNT As String = " SELECT                                " & vbNewLine _
                                                   ...
                                                   & "  AND ISNULL(COL.SYS_DEL_FLG,HOL.SYS_DEL_FLG) = '0' " & vbNewLine _
                                                   & "  AND ISNULL(COM.SYS_DEL_FLG,HOM.SYS_DEL_FLG) = '0' " & vbNewLine
...
#Region "受信テーブル同一データ抽出"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_COMPARE_CHECK_KRT As String = " SELECT                                                  " & vbNewLine _
                                                        & "  COUNT(*) AS CNT                                         " & vbNewLine _
                                                        & " ,CNT.NRS_BR_CD                                           " & vbNewLine _
                                                        & " ,CNT.CUST_CD_L                                           " & vbNewLine _
                                                        & " ,CNT.CUST_CD_M                                           " & vbNewLine _
                                                        & " ,CNT.KYOHI_RIYU                                          " & vbNewLine _
                                                        & " ,CNT.TOKUISAKI_HACCYU_NO                                 " & vbNewLine _
                                                        & " ,CNT.HANBAI_DENPYO                                       " & vbNewLine _
                                                        & " ,CNT.HANBAI_DENPYO_MEISAI                                " & vbNewLine _
                                                        & " ,CNT.SITEI_NOUKI                                         " & vbNewLine _
                                                        & " ,CNT.HOKANBASHO                                          " & vbNewLine _
                                                        & " ,CNT.SYUKKASAKI_CD                                       " & vbNewLine _
                                                        & " ,CNT.SYUKKASAKI_NM1                                      " & vbNewLine _
                                                        & " ,CNT.HINMOKU_CD                                          " & vbNewLine _
                                                        & " ,CNT.LOT_NO                                              " & vbNewLine _
                                                        & " ,CNT.IRIME                                               " & vbNewLine _
                                                        & " ,CNT.JYUCYU_SURYO                                        " & vbNewLine _
                                                        & " ,CNT.UNSOBIN_NM                                          " & vbNewLine _
                                                        & " ,CNT.TEKIYOU                                             " & vbNewLine _
                                                        & " ,CNT.SYS_DEL_FLG                                         " & vbNewLine _
                                                        & "FROM                                                      " & vbNewLine _
                                                        & "(                                                         " & vbNewLine _
                                                        & " SELECT                                                   " & vbNewLine _
                                                        & "  TOP 1                                                   " & vbNewLine _
                                                        & "  KRT.NRS_BR_CD                                           " & vbNewLine _
                                                        & " ,KRT.CUST_CD_L                                           " & vbNewLine _
                                                        & " ,KRT.CUST_CD_M                                           " & vbNewLine _
                                                        & " ,KRT.KYOHI_RIYU                                          " & vbNewLine _
                                                        & " ,KRT.TOKUISAKI_HACCYU_NO                                 " & vbNewLine _
                                                        & " ,KRT.HANBAI_DENPYO                                       " & vbNewLine _
                                                        & " ,KRT.HANBAI_DENPYO_MEISAI                                " & vbNewLine _
                                                        & " ,KRT.SITEI_NOUKI                                         " & vbNewLine _
                                                        & " ,KRT.HOKANBASHO                                          " & vbNewLine _
                                                        & " ,KRT.SYUKKASAKI_CD                                       " & vbNewLine _
                                                        & " ,KRT.SYUKKASAKI_NM1                                      " & vbNewLine _
                                                        & " ,KRT.HINMOKU_CD                                          " & vbNewLine _
                                                        & " ,KRT.LOT_NO                                              " & vbNewLine _
                                                        & " ,KRT.IRIME                                               " & vbNewLine _
                                                        & " ,KRT.HINMOKU_NM                                          " & vbNewLine _
                                                        & " ,KRT.JYUCYU_SURYO                                        " & vbNewLine _
                                                        & " ,KRT.UNSOBIN_NM                                          " & vbNewLine _
                                                        & " ,KRT.TEKIYOU                                             " & vbNewLine _
                                                        & " ,KRT.JYUCYUSAKI_CD                                       " & vbNewLine _
                                                        & " ,KRT.JYUCYUSAKI_NM1                                      " & vbNewLine _
                                                        & " ,KRT.SYS_DEL_FLG                                         " & vbNewLine _
                                                        & " ,KRT.DEL_KB                                              " & vbNewLine _
                                                        & " ,KRT.SYS_ENT_DATE + KRT.SYS_ENT_TIME AS SYS_ENT_DATETIME " & vbNewLine _
                                                        & "  FROM $LM_TRN$..H_OUTKAEDI_DTL_KRT KRT                   " & vbNewLine _
                                                        & " WHERE                                                    " & vbNewLine _
                                                        & " KRT.NRS_BR_CD = @NRS_BR_CD                               " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " KRT.CUST_CD_L = @CUST_CD_L                               " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " KRT.CUST_CD_M = @CUST_CD_M                               " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " KRT.HANBAI_DENPYO = @HANBAI_DENPYO                       " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " KRT.HANBAI_DENPYO_MEISAI = @HANBAI_DENPYO_MEISAI         " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " KRT.SYS_DEL_FLG = '0'                                    " & vbNewLine _
                                                        & " GROUP BY                                                 " & vbNewLine _
                                                        & "  KRT.NRS_BR_CD                                           " & vbNewLine _
                                                        & " ,KRT.CUST_CD_L                                           " & vbNewLine _
                                                        & " ,KRT.CUST_CD_M                                           " & vbNewLine _
                                                        ...
                                                        & " ,KRT.SYS_DEL_FLG                                         " & vbNewLine _
                                                        & " ,KRT.DEL_KB                                              " & vbNewLine _
                                                        & " ,KRT.SYS_ENT_DATE + KRT.SYS_ENT_TIME                     " & vbNewLine _
                                                        & " ORDER BY                                                 " & vbNewLine _
                                                        & "  KRT.SYS_ENT_DATE + KRT.SYS_ENT_TIME DESC                " & vbNewLine _
                                                        & "  ) CNT                                                   " & vbNewLine _
                                                        & " WHERE                                                    " & vbNewLine _
                                                        ...
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.KYOHI_RIYU = @KYOHI_RIYU                             " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.TOKUISAKI_HACCYU_NO = @TOKUISAKI_HACCYU_NO           " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.HANBAI_DENPYO = @HANBAI_DENPYO                       " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.HANBAI_DENPYO_MEISAI = @HANBAI_DENPYO_MEISAI         " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.SITEI_NOUKI = @SITEI_NOUKI                           " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.HOKANBASHO = @HOKANBASHO                             " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.SYUKKASAKI_CD = @SYUKKASAKI_CD                       " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.SYUKKASAKI_NM1 = @SYUKKASAKI_NM1                     " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.HINMOKU_CD = @HINMOKU_CD                             " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.LOT_NO = @LOT_NO                                     " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.IRIME = @IRIME                                       " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.JYUCYU_SURYO = @JYUCYU_SURYO                         " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.UNSOBIN_NM = @UNSOBIN_NM                             " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
                                                        & " CNT.TEKIYOU = @TEKIYOU                                   " & vbNewLine _
                                                        & " AND                                                      " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_KRT(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_DTL_KRT）
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_INSERT_OUTKAEDI_DTL_KRT As String = "INSERT INTO      " & vbNewLine _
                                        & "$LM_TRN$..H_OUTKAEDI_DTL_KRT     " & vbNewLine _
                                        & "(                                " & vbNewLine _
                                        & " DEL_KB                          " & vbNewLine _
                                        ...
                                        & ",TOKUISAKI_HACCYU_NO             " & vbNewLine _
                                        & ",HANBAI_DENPYO                   " & vbNewLine _
                                        & ",HANBAI_DENPYO_MEISAI            " & vbNewLine _
                                        & ",SITEI_NOUKI                     " & vbNewLine _
                                        & ",HOKANBASHO                      " & vbNewLine _
                                        & ",SYUKKASAKI_CD                   " & vbNewLine _
                                        & ",SYUKKASAKI_NM1                  " & vbNewLine _
                                        & ",HINMOKU_CD                      " & vbNewLine _
                                        & ",LOT_NO                          " & vbNewLine _
                                        & ",IRIME                           " & vbNewLine _
                                        & ",HINMOKU_NM                      " & vbNewLine _
                                        & ",JYUCYU_SURYO                    " & vbNewLine _
                                        & ",UNSOBIN_NM                      " & vbNewLine _
                                        & ",TEKIYOU                         " & vbNewLine _
                                        & ",JYUCYUSAKI_CD                   " & vbNewLine _
                                        & ",JYUCYUSAKI_NM1                  " & vbNewLine _
...
#Region "オーダー番号重複チェック(オーダー番号＋オーダー番号明細)"
    Private Const SQL_SELECT_C_OUTKA_LM_DTL As String = " SELECT                                " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_MRC(取込削除)"
...
#End Region
    ...
    '2015.06.11 追加START 同一オーダーの追加データ不具合
#Region "H_OUTKAEDI_L(セミEDI)同一出荷日＋届け先追加データ有りの場合の更新"
    ''' <summary>
    ''' H_OUTKAEDI_L(セミEDI)オーダー追加データ有りの場合の更新
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_REVIVAL_OUTKAEDI_L As String _
                        = " UPDATE $LM_TRN$..H_OUTKAEDI_L  SET          " & vbNewLine _
                        ...
                        & " WHERE HOEL.NRS_BR_CD  = @NRS_BR_CD          " & vbNewLine _
                        & " AND   HOEL.EDI_CTL_NO = @EDI_CTL_NO         " & vbNewLine _
                        & " AND   HOEL.DEL_KB     = '1'                 " & vbNewLine _
                        & " AND   HOEM.DEL_KB     = '1'                 " & vbNewLine

#End Region
    '2015.06.11 追加END 同一オーダーの追加データ不具合

    '2015.10.20 協立化学　正常なし削除データ　保留になる対応START
#Region "H_OUTKAEDI_L(セミEDI)同一オーダー　削除のみデータの場合の更新"
    ''' <summary>
    ''' H_OUTKAEDI_L(セミEDI)オーダー削除の場合の更新
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_DELETE_OUTKAEDI_L As String _
                        = " UPDATE $LM_TRN$..H_OUTKAEDI_L  SET          " & vbNewLine _
                        & " DEL_KB              = '1'                   " & vbNewLine _
                        & ",UPD_USER            = @UPD_USER             " & vbNewLine _
                        & ",UPD_DATE            = @UPD_DATE             " & vbNewLine _
                        ...
                        & "   NRS_BR_CD                                 " & vbNewLine _
                        & "  ,EDI_CTL_NO                                " & vbNewLine _
                        & " )  HOEM_DEL                                 " & vbNewLine _
                        & " ON                                          " & vbNewLine _
                        & "     HOEL.NRS_BR_CD    = HOEM_DEL.NRS_BR_CD  " & vbNewLine _
                        & " AND HOEL.EDI_CTL_NO   = HOEM_DEL.EDI_CTL_NO " & vbNewLine _
                        & " WHERE HOEL.NRS_BR_CD  = @NRS_BR_CD          " & vbNewLine _
                        & " AND   HOEL.EDI_CTL_NO = @EDI_CTL_NO         " & vbNewLine _
                        & " AND   HOEM.CNT = HOEM_DEL.CNT               " & vbNewLine

#End Region
    '2015.10.20 協立化学　正常なし削除データ　保留になる対応END
...
#Region "商品名"
    Private Const SQL_SELECT_CASEINFO_GOODS_NM_ As String = _
               ...
               & "--通常商品名                                        " & vbNewLine _
               & "LEFT JOIN                                           " & vbNewLine _
               & "     $LM_MST$..M_GOODS MGD                          " & vbNewLine _
               & "  ON CM.NRS_BR_CD    = MGD.NRS_BR_CD                " & vbNewLine _
               & " AND CM.GOODS_CD_NRS = MGD.GOODS_CD_NRS             " & vbNewLine _
               ...
               & "     LEFT JOIN                                      " & vbNewLine _
               & "          $LM_MST$..M_DEST_DETAILS DEST_DTL         " & vbNewLine _
               ...
               & "  ON CM.NRS_BR_CD  = DEST_GOODS.NRS_BR_CD           " & vbNewLine _
               & " AND CM.OUTKA_NO_L = DEST_GOODS.OUTKA_NO_L          " & vbNewLine _
               ...
               & "AND CM.OUTKA_NO_M            = @OUTKA_NO_M          " & vbNewLine _
               & "AND CM.SYS_DEL_FLG           = '0'                  " & vbNewLine

#End Region

#Region "現状ケースNOの取得"

    Private Const SQL_SELECT_CASE_NO_MAXTO As String = _
                                "SELECT                                         " & vbNewLine _
                              & "     MAX(CMH.CASE_NO_TO)   AS NIS_CNT          " & vbNewLine _
                              & "FROM $LM_TRN$..C_OUTKA_L CL                    " & vbNewLine _
                              & "LEFT JOIN                                      " & vbNewLine _
                              & "     $LM_TRN$..C_MARK_HED CMH                  " & vbNewLine _
                              & "  ON CL.NRS_BR_CD    = CMH.NRS_BR_CD           " & vbNewLine _
                              & " AND CL.OUTKA_NO_L = CMH.OUTKA_NO_L            " & vbNewLine _
                              & "WHERE                                          " & vbNewLine _
                              & "    CL.NRS_BR_CD             = @NRS_BR_CD      " & vbNewLine _
                              & "AND CL.CUST_CD_L             = @CUST_CD_L      " & vbNewLine _
                              & "AND CL.CUST_CD_M             = @CUST_CD_M      " & vbNewLine _
                              & "AND CL.BUYER_ORD_NO          = @BUYER_ORD_NO   " & vbNewLine _
                              & "AND CL.SYS_DEL_FLG           = '0'             " & vbNewLine _
                              & "AND CMH.SYS_DEL_FLG          = '0'             " & vbNewLine
...
#Region "商品マスタ"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC210.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC210.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectDataMgoods", cmd)
...
#Region "商品明細マスタ"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectGoodsDetailsSub48(ByVal ds As DataSet) As DataSet

        Me._Row = ds.Tables("LMH030_OUTKAEDI_M").Rows(0)

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SELECT_M_GOODS_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC210.SQL_WHERE_M_GOODS_DETL_SUB48)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectGoodsDetailsSub48", cmd)
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectGoodsDetailsSub49(ByVal ds As DataSet) As DataSet

        Me._Row = ds.Tables("LMH030_M_GOODS_DETAILS").Rows(0)
        ...
        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC210.SQL_WHERE_M_GOODS_DETL_SUB49)

        'パラメータ設定
        Call Me.SetSelectMstDetailsGoodsParameter(Me._Row)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectGoodsDetailsSub49", cmd)
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC210.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC210.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectDataMdestOutkaToroku", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectDataZkbn", cmd)
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成(SELECT)
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_CANCER_DATA_DTL_CNT)
        'SQL作成(WHERE)
        Me._StrSql.Append(LMH030DAC210.SQL_WHERE_CANCER_DATA_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    Private Function SelectCompareData(ByVal ds As DataSet) As DataSet
        ...
        'スキーマ設定
        sql = Me.SetSchemaNm(LMH030DAC210.SQL_SELECT_COMPARE_CHECK_KRT, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC210.SQL_WHERE_M_CUST_DETAILS_ALL)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC210.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC210.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC210.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC210.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI：受信テーブル取消更新)"
    ...
    Private Function UpdateDelRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Dim sql As String = Me.SetSchemaNm(LMH030DAC210.SQL_UPDATE_DEL_OUTKAIEDI_DTL, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateDelRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_UPDATE_EDIT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateEditOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_UPDATE_EDIT_OUTKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateEditOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一オーダー追加データ有りの場合の更新"
    ''' <summary>
    ''' EDI出荷(大)テーブル更新処理(セミEDI)
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(大)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateRevivalOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_UPDATE_REVIVAL_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateRevivalOutkaEdiL", cmd)
...
#End Region
    ...
    '2015.10.20 協立化学　正常なし削除データ　保留になる対応START
#Region "H_OUTKAEDI_L(セミEDI)同一オーダー　中削除データのみの場合の更新"
    ''' <summary>
    ''' EDI出荷(大)テーブル更新処理(セミEDI)
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(大)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateDeleteOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_UPDATE_DELETE_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateDeleteOutkaEdiL", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectEdiM", cmd)
...
#Region "ｹｰｽﾏｰｸ用"
    ...
    Private Function SelectGoodsDetails(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim outTbl As DataTable = ds.Tables("LMH030_C_OUTKA_M")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_FROM_GOODS_DETAILS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectGoodsDetails", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_GOODS_SIZE_WT")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function GetCaseInfoGoodsNm(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_CASEINFO_GOODS_NM_)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "GetCaseInfoGoodsNm", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_C_OUTKA_M")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function GetCaseToMaxNo(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim outTbl As DataTable = ds.Tables("LMH030_C_OUTKA_L")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_CASE_NO_MAXTO)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BUYER_ORD_NO", Me._Row.Item("BUYER_ORD_NO").ToString(), DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "GetCaseToMaxNo", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC210.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC210.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC210.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC210", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertMDestData", cmd)
...
#Region "C_MARK_HED"
    ...
    Private Function InsertMarkHedData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_C_MARK_HED")
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_C_MARK_HED, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertMarkHedData", cmd)
...
#Region "C_MARK_DTL"
    ...
    Private Function InsertMarkDtlData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_C_MARK_DTL")
        ...
        For Each row As DataRow In inTbl.Rows
            ...
            'SQL文のコンパイル
            Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_C_MARK_DTL, Me._Row.Item("NRS_BR_CD").ToString()))
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertMarkDtlData", cmd)
...
#Region "EDI受信(DTL)同一パラメータ設定"
    ...
    Private Sub SetCompareDataParameter(ByVal ds As DataSet)
        ...
        'EDI受信（DTL）荷主個別項目(協立化学)
        '拒否理由
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_DEL_KB_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KYOHI_RIYU", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '得意先発注番号
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_BUYER_ORD_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_HACCYU_NO", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '販売伝票
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_CUST_ORD_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HANBAI_DENPYO", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '販売伝票明細
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_ORD_NO_DTL_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HANBAI_DENPYO_MEISAI", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '指定納入期日
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_ARR_PLAN_DATE_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SITEI_NOUKI", Left(Replace(Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)).ToString(), "/", String.Empty), 8), DBDataType.CHAR))
        '保管場所テキスト
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_FREE_C01_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HOKANBASHO", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '出荷先
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_CD_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYUKKASAKI_CD", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '出荷先名 1
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_NM_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYUKKASAKI_NM1", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '品目コード
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_GOODS_CD_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HINMOKU_CD", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        'ロット
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_LOT_NO_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '入目
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_IRIME_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@IRIME", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))
        '受注数量
        setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_OUTKA_TTL_NB_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JYUCYU_SURYO", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))
        '運送便名称
        Dim tempNo As String() = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_REMARK_NO").ToString().Trim().Split(","c)
        setColKey = String.Concat("COLUMN_", tempNo(0))
        'setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_REMARK_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UNSOBIN_NM", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '摘要03
        setColKey = String.Concat("COLUMN_", tempNo(1))
        'setColKey = String.Concat("COLUMN_", ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_REMARK_NO").ToString())
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TEKIYOU", Me.NullConvertString(ds.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
...
#Region "商品明細マスタパラメータ設定"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectMstDetailsGoodsParameter(ByVal drMgoods As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", drMgoods.Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NRS", Me.NullConvertString(drMgoods.Item("GOODS_CD_NRS")), DBDataType.NVARCHAR))
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = String.Empty
        sql = Me.SetSchemaNm(LMH030DAC210.SQL_INSERT_OUTKAEDI_DTL_KRT, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "休日マスタ件数取得処理"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function SelectMHolList(ByVal sNRS_BR_CD As String, ByVal sDate As String) As Integer
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectMHolList", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal setDs As DataSet, ByVal prmList As ArrayList)
        ...
        '拒否理由
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_DEL_KB_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@KYOHI_RIYU", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '得意先発注番号
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_BUYER_ORD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_HACCYU_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '販売伝票
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_CUST_ORD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@HANBAI_DENPYO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '販売伝票明細
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_ORD_NO_DTL_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@HANBAI_DENPYO_MEISAI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '指定納入期日
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_ARR_PLAN_DATE_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@SITEI_NOUKI", Left(Replace(Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)).ToString(), "/", String.Empty), 8), DBDataType.CHAR))
        '保管場所テキスト
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_FREE_C01_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@HOKANBASHO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '出荷先
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_CD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@SYUKKASAKI_CD", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '出荷先名 1
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_NM_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@SYUKKASAKI_NM1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '品目コード
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_GOODS_CD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@HINMOKU_CD", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        'ロット
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_LOT_NO_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '入目
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_IRIME_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@IRIME", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))
        '品目名称
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_GOODS_NM_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@HINMOKU_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '受注数量
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_OUTKA_TTL_NB_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@JYUCYU_SURYO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))
        '運送便名称
        Dim tempNo As String() = setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_REMARK_NO").ToString().Trim().Split(","c)
        setColKey = String.Concat("COLUMN_", tempNo(0))
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_REMARK_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@UNSOBIN_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '摘要03
        'setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_REMARK_NO").ToString())
        setColKey = String.Concat("COLUMN_", tempNo(1))
        prmList.Add(MyBase.GetSqlParameter("@TEKIYOU", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '受注先
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_FREE_C02_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@JYUCYUSAKI_CD", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        '受注先
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_FREE_C03_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@JYUCYUSAKI_NM1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))
        'EDI受信（DTL）共通項目
...
#Region "出荷(大,中)データ(オーダー番号+オーダー番号明細チェック用)"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>オーダー番号重複チェック(明細までチェック)</remarks>
    Private Function SelectOrderCheckDataDtl(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC210.SQL_SELECT_C_OUTKA_LM_DTL)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterLDtl(dt)
        Call Me.SetOutkaParameterMDtl(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC210", "SelectOrderCheckDataDtl", cmd)
...
#Region "出荷パラメータ設定(オーダー番号チェック用)明細"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterLDtl(ByVal dt As DataTable)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterMDtl(ByVal dt As DataTable)
