...
#Region "検索処理"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_SELECT_SEND_BAH As String = "SELECT                                                   " & vbNewLine _
                                              & "  '0'                               AS DEL_KB              " & vbNewLine _
                                              & " ,DTL_BAH.CRT_DATE                  AS CRT_DATE            " & vbNewLine _
                                              & " ,DTL_BAH.FILE_NAME                 AS FILE_NAME           " & vbNewLine _
                                              & " ,DTL_BAH.REC_NO                    AS REC_NO              " & vbNewLine _
                                              ...
                                              & " INNER JOIN $LM_TRN$..H_INKAEDI_DTL_BAH  DTL_BAH           " & vbNewLine _
                                              & "  ON  DTL_BAH.DEL_KB <> '1'                                " & vbNewLine _
...
#Region "更新処理"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_BAH                       " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPDATE_RCV_DTL_BAH As String = "UPDATE $LM_TRN$..H_INKAEDI_DTL_BAH SET        " & vbNewLine _
...
#Region "登録処理"
    ...
    Private Const SQL_INSERT_SEND_BAH As String = "INSERT INTO $LM_TRN$..H_SENDINEDI_BAH " & vbNewLine _
                                              & "(                               " & vbNewLine _
                                              & " DEL_KB                         " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC612.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC612.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "SelectEdiM", cmd)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectSendBah(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC612.SQL_SELECT_SEND_BAH)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "SelectSendBah", cmd)
        ...
        '取得データの格納先をマッピング
        map = Me.SetMapSendBah()

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINEDI_BAH")
        reader.Close()
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC612.SQL_SELECT_INKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "SelectDataOrderCheck", cmd)
...
#Region "更新処理"
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC612.SQL_UPD_INKATOROKU_EDI_L
            '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC612.SQL_UPD_JISSEKISAKUSEI_EDI_L
        End Select
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録、紐付け
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC612.SQL_UPD_INKATOROKU_EDI_M
            '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC612.SQL_UPD_JISSEKISAKUSEI_EDI_M
        End Select
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC612.SQL_UPDATE_RCV_DTL
            '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC612.SQL_UPDATE_RCV_DTL_BAH
        End Select
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "UpdateRcvDtl", cmd)
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(Me.SetSchemaNm(LMH010DAC612.SQL_UPD_JISSEKISAKUSEI_INKA_L, dt.Rows(0)("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "登録処理"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertInkaL", cmd)
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertInkaM", cmd)
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertInkaS", cmd)
    ...
    Private Function InsertSendBah(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINEDI_BAH")

        '営業所コード
        Dim brCd As String = inTbl.Rows(0).Item("NRS_BR_CD").ToString()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_SEND_BAH, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertSendBah", cmd)
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertSagyo", cmd)
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertUnsoL", cmd)
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertUnsoM", cmd)
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC612.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC612", "InsertUnchinData", cmd)
...
#Region "挿入パラメータ設定(H_SENDINEDI_NIK)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(row.Item("CUST_CD_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(row.Item("CUST_CD_M")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OBIC_SHUBETU", Me.NullConvertString(row.Item("OBIC_SHUBETU")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OBIC_TORIHIKI_KBN", Me.NullConvertString(row.Item("OBIC_TORIHIKI_KBN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OBIC_DENP_NO", Me.NullConvertString(row.Item("OBIC_DENP_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OBIC_GYO_NO", Me.NullConvertString(row.Item("OBIC_GYO_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OBIC_DETAIL_NO", Me.NullConvertString(row.Item("OBIC_DETAIL_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_NO_L", Me.NullConvertString(row.Item("INKA_NO_L")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_NO_M", Me.NullConvertString(row.Item("INKA_NO_M")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_RANK", Me.NullConvertString(row.Item("GOODS_RANK")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NB", Me.NullConvertString(row.Item("NB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(row.Item("LOT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@LT_DATE", Me.NullConvertString(row.Item("LT_DATE")), DBDataType.NVARCHAR))
...
#Region "マッピング配列作成"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetMapSendBah() As Hashtable
