...
#Region "H_OUTKAEDI_HED_XXX(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_HED_XXX）
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_INSERT_OUTKAEDI_HED As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",HAKKO_KB_NM       " & vbNewLine _
                                        & ",OUT_KB_NM         " & vbNewLine _
                                        & ",JIGYO_CD          " & vbNewLine _
                                        & ",JIGYO_NM          " & vbNewLine _
                                        & ",SOUKO_CD          " & vbNewLine _
                                        & ",SOUKO_NM          " & vbNewLine _
                                        & ",OUTKA_BI          " & vbNewLine _
                                        & ",NONYU_ZIP         " & vbNewLine _
                                        & ",NONYU_CD          " & vbNewLine _
                                        & ",NONYU_NM          " & vbNewLine _
                                        & ",NONYU_AD_1        " & vbNewLine _
                                        & ",NONYU_AD_2        " & vbNewLine _
                                        & ",NONYU_TEL         " & vbNewLine _
                                        & ",TORIKESHI_KB_NM   " & vbNewLine _
                                        & ",DENP_NO           " & vbNewLine _
...
#End Region
    ...
    '(2013.02.25)要望番号1889 新レイアウト切替 修正START(NONYU_NM3,GOODS_CD_NEWの追加)
#Region "H_OUTKAEDI_DTL_XXX(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_DTL_DSP）
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO      " & vbNewLine _
                                        ...
                                        & ",PRTFLG	                    " & vbNewLine _
                                        & "--,CANCEL_FLG	                " & vbNewLine _
                                        & ",BYK_BR_CD  		" & vbNewLine _
                                        & ",OUTKA_REQ_DATE  " & vbNewLine _
                                        & ",BYK_OUTKA_NO  	" & vbNewLine _
                                        & ",DATA_KB  		" & vbNewLine _
                                        & ",OUTKA_PLAN_DATE " & vbNewLine _
                                        & ",NONYU_DATE  	" & vbNewLine _
                                        & ",TOKUI_CD  		" & vbNewLine _
                                        & ",TOKUI_NM  		" & vbNewLine _
                                        & ",NONYU_CD  		" & vbNewLine _
                                        & ",NONYU_NM1  		" & vbNewLine _
                                        & ",NONYU_NM2  		" & vbNewLine _
                                        & ",NONYU_NM3  		" & vbNewLine _
                                        & ",MAKER_CD  		" & vbNewLine _
                                        & ",GOODS_CD  		" & vbNewLine _
                                        & ",IRIME  			" & vbNewLine _
                                        & ",LOT_NO  		" & vbNewLine _
                                        & ",LOT_NO_EDA  	" & vbNewLine _
                                        & ",GOODS_CD_NEW  	" & vbNewLine _
                                        ...
                                        & ",NONYU_REMARK  	" & vbNewLine _
                                        & ",JUTYU_NO  		" & vbNewLine _
                                        & ",RECORD_STATUS	            " & vbNewLine _
                                        & ",JISSEKI_SHORI_FLG	        " & vbNewLine _
                                        & ",JISSEKI_USER	            " & vbNewLine _
                                        & ",JISSEKI_DATE	            " & vbNewLine _
...
#End Region
    '(2013.02.25)要望番号1889 新レイアウト切替 修正END
...
#Region "H_OUTKAEDI_HED_XXX(取込削除時)"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_XXX）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_DEL_OUTKAEDI_HED As String _
...
#Region "H_OUTKAEDI_DTL_XXX(取込削除時)"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_XXX）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_DEL_OUTKAEDI_DTL As String _
...
#Region "WHERE1_M_GOODS(セミEDI時)"
    Private Const SQL_WHERE1_M_GOODS As String = _
                                     ...
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS.CUST_CD_L IN ('31022','31023')           " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS.GOODS_CD_CUST = @GOODS_CD_CUST             " & vbNewLine
...
#Region "SELECT_M_DEST(セミEDI用)"

    Private Const SQL_SELECT_M_DEST1 As String = " SELECT                       " & vbNewLine _
                                     & " COUNT(*)           AS MST_CNT          " & vbNewLine _
                                     & ",NRS_BR_CD			AS NRS_BR_CD	    " & vbNewLine _
                                     & ",CUST_CD_L			AS CUST_CD_L		" & vbNewLine _
...
#Region "H_OUTKAEDI_RCV_CAN 取消データ抽出用"
    ''' <summary>
    ''' H_OUTKAEDI_DTL_XXX 取消データ抽出用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_OUTKAEDI_RCV_CAN As String = _
                  " SELECT                                                  " & vbNewLine _
                & " H_OUTKAEDI_DTL.CRT_DATE            AS CRT_DATE          " & vbNewLine _
                & ",H_OUTKAEDI_DTL.FILE_NAME           AS FILE_NAME         " & vbNewLine _
                & ",H_OUTKAEDI_DTL.REC_NO              AS REC_NO            " & vbNewLine _
                & ",H_OUTKAEDI_DTL.GYO                 AS GYO               " & vbNewLine _
                & ",H_OUTKAEDI_DTL.NRS_BR_CD           AS NRS_BR_CD         " & vbNewLine _
                & ",H_OUTKAEDI_DTL.EDI_CTL_NO          AS EDI_CTL_NO        " & vbNewLine _
                & ",H_OUTKAEDI_DTL.EDI_CTL_NO_CHU      AS EDI_CTL_NO_CHU    " & vbNewLine _
                & ",H_OUTKAEDI_DTL.OUTKA_CTL_NO        AS OUTKA_CTL_NO      " & vbNewLine _
                & "--,H_OUTKAEDI_DTL.CANCEL_FLG          AS CANCEL_FLG        " & vbNewLine _
                & " FROM                                                    " & vbNewLine _
                & " $LM_TRN$..$RCV_DTL$                H_OUTKAEDI_DTL       " & vbNewLine _
                & " WHERE H_OUTKAEDI_DTL.DEL_KB        = '0'                " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.NRS_BR_CD     = @NRS_BR_CD         " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.CUST_CD_L     = @CUST_CD_L         " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.CUST_CD_M     = @CUST_CD_M         " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.JUTYU_NO      = @JUTYU_NO          " & vbNewLine _
                & " ORDER BY                                                " & vbNewLine _
                & " EDI_DATE    DESC                                        " & vbNewLine _
                & ",EDI_TIME    DESC                                        " & vbNewLine _
                & ",REC_NO      DESC                                        " & vbNewLine _
                & ",GYO         DESC                                        " & vbNewLine
...
#Region "H_SENDOUTEDI_BYKTST SELECT句"

    Private Const SQL_SELECT_BYKTST_SEND_DATA As String = "SELECT                                                                      " & vbNewLine _
                                          & " '0'                                          AS DEL_KB	                               " & vbNewLine _
                                          & ",DTL_BYKTST.CRT_DATE                          AS CRT_DATE                                 " & vbNewLine _
                                          & ",DTL_BYKTST.FILE_NAME + OUT_S.OUTKA_NO_S      AS FILE_NAME                                " & vbNewLine _
                                          & ",DTL_BYKTST.REC_NO                            AS REC_NO                                   " & vbNewLine _
                                          & ",DTL_BYKTST.GYO                               AS GYO                                      " & vbNewLine _
                                          ...
                                          & ",Z_B018.KBN_NM1                               AS E1EDKA1_PARVW_LIFNR_AG                   " & vbNewLine _
                                          & ",DTL_BYKTST.NONYU_CD                          AS E1EDKA1_PARVW_LIFNR_WE                   " & vbNewLine _
                                          & ",DTL_BYKTST.TOKUI_CD                          AS E1EDKA1_PARVW_PARTN_ZZ                   " & vbNewLine _
                                          ...
                                          & ",DTL_BYKTST.NONYU_NM1                         AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE1        " & vbNewLine _
                                          & ",DTL_BYKTST.NONYU_NM2 + DTL_BYKTST.NONYU_NM3  AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE2        " & vbNewLine _
                                          ...
                                          & ",DTL_BYKTST.JUTYU_NO                          AS E1EDK02_QUALF_BELNR_001                  " & vbNewLine _
                                          ...
                                          & "--,DTL_BYKTST.GOODS_CD_NEW                      AS E1EDP01_MATNR                            " & vbNewLine _
                                          & ",DTL_BYKTST.GOODS_CD_NEW                      AS E1EDP01_MATNR                            " & vbNewLine _
                                          ...
                                          & ",DTL_BYKTST.ORDER_NO                          AS E1EDP02_QUALF_BELNR_044                  " & vbNewLine _
                                          ...
                                          & "--,DTL_BYKTST.GOODS_CD_NEW                      AS E1EDP19_QUALF_IDTNR_002                  " & vbNewLine _
                                          & ",DTL_BYKTST.GOODS_CD_NEW                      AS E1EDP19_QUALF_IDTNR_002                  " & vbNewLine _
                                          ...
                                          & ",CASE WHEN M_GOODS.CUST_CD_S = '01' THEN DTL_BYKTST.NONYU_NM1                             " & vbNewLine _
                                          & "      ELSE ''                                 END E1EDKA1_NAME1                           " & vbNewLine _
                                          & ",CASE WHEN M_GOODS.CUST_CD_S = '01' THEN DTL_BYKTST.NONYU_NM2 + DTL_BYKTST.NONYU_NM3      " & vbNewLine _
                                          & "      ELSE ''                                 END E1EDKA1_NAME2                           " & vbNewLine _
...
#Region "H_SENDOUTEDI_BYKTST FROM句"

    'Private Const SQL_FROM_BYKTST_SEND_DATA As String = "FROM                                                       " & vbNewLine _
    '                                      & "$LM_TRN$..H_OUTKAEDI_M EDI_M                                           " & vbNewLine _
    '                                      & " LEFT JOIN $LM_TRN$..C_OUTKA_M OUT_M                                   " & vbNewLine _
    '                                      & " ON  OUT_M.SYS_DEL_FLG = '0'                                           " & vbNewLine _
    '                                      & " AND OUT_M.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
    '                                      & " AND OUT_M.OUTKA_NO_L = EDI_M.OUTKA_CTL_NO                             " & vbNewLine _
    '                                      & " AND OUT_M.OUTKA_NO_M = EDI_M.OUTKA_CTL_NO_CHU                         " & vbNewLine _
    ...
    '                                      & " LEFT JOIN $LM_TRN$..H_OUTKAEDI_DTL_BYKTST DTL_BYKTST                  " & vbNewLine _
    '                                      & " ON  DTL_BYKTST.DEL_KB <> '1'                                          " & vbNewLine _
    '                                      & " AND DTL_BYKTST.NRS_BR_CD = EDI_M.NRS_BR_CD                            " & vbNewLine _
    '                                      & " AND DTL_BYKTST.EDI_CTL_NO = EDI_M.EDI_CTL_NO                          " & vbNewLine _
    ...
    '                                      & " LEFT JOIN $LM_MST$..Z_KBN  Z_B018                                     " & vbNewLine _
    '                                      & "  ON  Z_B018.KBN_GROUP_CD = 'B018'                                     " & vbNewLine _
    '                                      & "  AND Z_B018.KBN_CD = '01'                                             " & vbNewLine _
    '                                      & " WHERE EDI_M.DEL_KB <> '1'                                             " & vbNewLine _
    '                                      & " AND  EDI_M.NRS_BR_CD = @NRS_BR_CD                                     " & vbNewLine _
    '                                      & " AND  EDI_M.EDI_CTL_NO = @EDI_CTL_NO                                   " & vbNewLine _
    '                                      & " AND  EDI_M.JISSEKI_FLAG = '0'                                         " & vbNewLine
    ...
    Private Const SQL_FROM_BYKTST_SEND_DATA As String = "FROM                                                       " & vbNewLine _
                                          ...
                                          & " (SELECT                                                               " & vbNewLine _
                                          & "        NRS_BR_CD                                                      " & vbNewLine _
                                          & "       ,ROW_NUMBER() OVER(PARTITION BY OUTKA_NO_L                      " & vbNewLine _
                                          & "                          ORDER BY OUTKA_NO_L, OUTKA_NO_M) AS ROW_NO   " & vbNewLine _
                                          ...
                                          & " AND OUT_M.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
                                          & " AND OUT_M.OUTKA_NO_L = EDI_M.OUTKA_CTL_NO                             " & vbNewLine _
                                          & " AND OUT_M.ROW_NO = CONVERT(INT,EDI_M.OUTKA_CTL_NO_CHU)                " & vbNewLine _
                                          & " LEFT JOIN $LM_TRN$..C_OUTKA_L OUT_L                                   " & vbNewLine _
                                          & "  ON  OUT_L.SYS_DEL_FLG = '0'                                          " & vbNewLine _
                                          & "  AND OUT_L.NRS_BR_CD = OUT_M.NRS_BR_CD                                " & vbNewLine _
                                          & "  AND OUT_L.OUTKA_NO_L = OUT_M.OUTKA_NO_L                              " & vbNewLine _
...
#Region "H_SENDOUTEDI_BYKDIR SELECT句"

    Private Const SQL_SELECT_BYKDIR_SEND_DATA As String = "SELECT                                                                      " & vbNewLine _
                                          & " '0'                                          AS DEL_KB	                               " & vbNewLine _
                                          & ",DTL_BYKDIR.CRT_DATE                          AS CRT_DATE                                 " & vbNewLine _
                                          & ",DTL_BYKDIR.FILE_NAME                         AS FILE_NAME                                " & vbNewLine _
                                          & ",DTL_BYKDIR.REC_NO                            AS REC_NO                                   " & vbNewLine _
                                          & ",DTL_BYKDIR.GYO                               AS GYO                                      " & vbNewLine _
                                          & ",EDI_M.NRS_BR_CD                              AS NRS_BR_CD                                " & vbNewLine _
                                          & ",EDI_M.EDI_CTL_NO                             AS EDI_CTL_NO                               " & vbNewLine _
                                          & ",EDI_M.EDI_CTL_NO_CHU                         AS EDI_CTL_NO_CHU                           " & vbNewLine _
                                          & ",OUT_M.OUTKA_NO_L                             AS OUTKA_CTL_NO                             " & vbNewLine _
                                          ...
                                          & ",OUT_L.CUST_CD_L                              AS CUST_CD_L                                " & vbNewLine _
                                          & ",OUT_L.CUST_CD_M                              AS CUST_CD_M                                " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK01_ACTION                    AS E1EDK01_ACTION                           " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK01_CURCY                     AS E1EDK01_CURCY                            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK01_LIFSK                     AS E1EDK01_LIFSK                            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK02_QUALF_BELNR_002           AS E1EDK02_QUALF_BELNR_002                  " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK14_QUALF_ORGID_012           AS E1EDK14_QUALF_ORGID_012                  " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK14_QUALF_ORGID_008           AS E1EDK14_QUALF_ORGID_008                  " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK14_QUALF_ORGID_007           AS E1EDK14_QUALF_ORGID_007                  " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK14_QUALF_ORGID_006           AS E1EDK14_QUALF_ORGID_006                  " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDKA1_PARVW_LIFNR_AG            AS E1EDKA1_PARVW_LIFNR_AG                   " & vbNewLine _
                                          & "  --20160510 直販代理店コード追加                                                           " & vbNewLine _
                                          & " ,CASE WHEN MDD.SET_NAIYO IS NULL THEN ''                                                 " & vbNewLine _
                                          & "  ELSE MDD.SET_NAIYO                                                                      " & vbNewLine _
                                          & "  END AS E1EDKA1_PARVW_LIFNR_AG                                                           " & vbNewLine _
                                          & "  --20160510 直販代理店コード追加                                                         " & vbNewLine _
                                           & ",DTL_BYKDIR.E1EDKA1_PARVW_LIFNR_WE            AS E1EDKA1_PARVW_LIFNR_WE                   " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDKA1_PARVW_PARTN_ZZ            AS E1EDKA1_PARVW_PARTN_ZZ                   " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDK03_IDDAT_DATUM_001           AS E1EDK03_IDDAT_DATUM_001                  " & vbNewLine _
                                          & ",OUT_L.ARR_PLAN_DATE                          AS E1EDK03_IDDAT_DATUM_001                  " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDKT1_TDID                      AS E1EDKT1_TDID                             " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDKT1_TSSPRAS                   AS E1EDKT1_TSSPRAS                          " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDKT1_TDOBJECT                  AS E1EDKT1_TDOBJECT                         " & vbNewLine _
                                          & ",ISNULL(M_DEST.DEST_NM,DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE1) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE1 " & vbNewLine _
                                          & ",CASE WHEN M_DEST.DEST_NM IS NULL THEN DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE2       " & vbNewLine _
                                          & "      ELSE ''                                                                             " & vbNewLine _
                                          & "      END  E1EDKT2_TDLINE_TDFORMAT_TEXTLINE2                                              " & vbNewLine _
                                          & ",ISNULL(OUT_L.DEST_AD_1,DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE3) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE3    " & vbNewLine _
                                          & ",ISNULL(OUT_L.DEST_AD_2,DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE4) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE4    " & vbNewLine _
                                          & ",ISNULL(OUT_L.DEST_AD_3,DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE5) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE5    " & vbNewLine _
                                          & ",ISNULL(M_DEST.TEL,DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE6) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE6     " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDK02_QUALF_BELNR_001           AS E1EDK02_QUALF_BELNR_001                  " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDK02_QUALF_BELNR_043           AS E1EDK02_QUALF_BELNR_043                  " & vbNewLine _
                                          & "--,OUT_M.RSV_NO                                 AS E1EDK02_QUALF_BELNR_043                  " & vbNewLine _
                                          & ",REPLACE(LEFT(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,''))),'-','')  AS E1EDK02_QUALF_BELNR_043                  " & vbNewLine _
                                          & "--,SUBSTRING(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,'')) +1,40) AS E1EDP01_POSEX            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP01_POSEX                     AS E1EDP01_POSEX                            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP01_MATNR                     AS E1EDP01_MATNR                            " & vbNewLine _
                                          & ",ISNULL(OUT_S.ALCTD_NB,0)                     AS E1EDP01_MENGE                            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP01_MENEE                     AS E1EDP01_MENEE                            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP01_WERKS                     AS E1EDP01_WERKS                            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP01_VSTEL                     AS E1EDP01_VSTEL                            " & vbNewLine _
                                          & "--,ISNULL(M_CUSTC.REMARK,DTL_BYKDIR.E1EDP01_LGORT) AS E1EDP01_LGORT                            " & vbNewLine _
                                          & "--,CASE WHEN M_CUSTC.REMARK IS NULL THEN CASE WHEN DTL_BYKDIR.E1EDP01_LGORT = '' THEN '1000' ELSE DTL_BYKDIR.E1EDP01_LGORT END " & vbNewLine _
                                          & "--      ELSE M_CUSTC.REMARK END  E1EDP01_LGORT                                              " & vbNewLine _
                                          & ",CASE WHEN DTL_BYKDIR.E1EDP01_LGORT IS NOT NULL THEN DTL_BYKDIR.E1EDP01_LGORT                                            " & vbNewLine _
                                          & "      WHEN M_CUSTC.REMARK IS NULL THEN '1000'                                             " & vbNewLine _
                                          & "      ELSE REVERSE(CONVERT(VARCHAR(4), REVERSE(M_CUSTC.REMARK))) END  E1EDP01_LGORT       " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDP02_QUALF_BELNR_043           AS E1EDP02_QUALF_BELNR_043                  " & vbNewLine _
                                          & ",REPLACE(LEFT(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,''))),'-','')  AS E1EDP02_QUALF_BELNR_043                  " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDP02_QUALF_ZEILE_043           AS E1EDP02_QUALF_ZEILE_043                  " & vbNewLine _
                                          & "--,ISNULL(OUT_S.REMARK,'')                      AS E1EDP02_QUALF_ZEILE_043                  " & vbNewLine _
                                          & ",SUBSTRING(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,'')) +1,40) AS E1EDP02_QUALF_ZEILE_043            " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP02_QUALF_BELNR_044           AS E1EDP02_QUALF_BELNR_044                  " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDP03_QUALF_DATE_010            AS E1EDP03_QUALF_DATE_010                   " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS E1EDP03_QUALF_DATE_010                   " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS E1EDP03_QUALF_DATE_024                   " & vbNewLine _
                                          & "--,DTL_BYKDIR.E1EDP20_WMENG_EDATU               AS E1EDP20_WMENG_EDATU                      " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS E1EDP20_WMENG_EDATU                      " & vbNewLine _
                                          & ",DTL_BYKDIR.E1EDP19_QUALF_IDTNR_002           AS E1EDP19_QUALF_IDTNR_002                  " & vbNewLine _
                                          & ",ISNULL(OUT_S.LOT_NO,'')                      AS E1EDP19_QUALF_IDTNR_010                  " & vbNewLine _
                                          & "--要望番号2091(2013.10.24) 追加START                                                      " & vbNewLine _
                                          & ",CASE WHEN M_GOODS.CUST_CD_S = '01' THEN '100000'                                         " & vbNewLine _
                                          & "      ELSE ''                                 END E1EDKA1_PARVW_PARTN_DUMMY               " & vbNewLine _
                                          & ",CASE WHEN M_GOODS.CUST_CD_S = '01' THEN ISNULL(M_DEST.DEST_NM,DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE1)    " & vbNewLine _
                                          & "      ELSE ''                                 END E1EDKA1_NAME1                           " & vbNewLine _
                                          & ",CASE WHEN M_GOODS.CUST_CD_S = '01' THEN CASE WHEN M_DEST.DEST_NM IS NULL THEN DTL_BYKDIR.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE2  ELSE ''  END " & vbNewLine _
                                          & "      ELSE ''                                 END E1EDKA1_NAME2                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_NAME3                            " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_NAME4                            " & vbNewLine _
                                          & ",CASE WHEN M_GOODS.CUST_CD_S = '01' THEN  OUT_L.DEST_AD_1                                 " & vbNewLine _
...
#Region "H_SENDOUTEDI_BYKDIR FROM句"

    Private Const SQL_FROM_BYKDIR_SEND_DATA As String = "FROM                                                       " & vbNewLine _
                                          & "$LM_TRN$..H_OUTKAEDI_M EDI_M                                           " & vbNewLine _
                                          & "LEFT JOIN $LM_TRN$..C_OUTKA_M OUT_M                                   " & vbNewLine _
                                          & " ON  OUT_M.SYS_DEL_FLG = '0'                                           " & vbNewLine _
                                          & " AND OUT_M.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
                                          ...
                                          & "     ,S2.OUTKA_NO_M                                                    " & vbNewLine _
                                          & "     ,S2.LOT_NO                                                        " & vbNewLine _
                                          & "     ,MIN(S2.ZAI_REC_NO) AS ZAI_REC_NO                                 " & vbNewLine _
                                          & "     ,SUM(S2.ALCTD_NB) AS ALCTD_NB                                     " & vbNewLine _
                                          & "--要望番号2091(2013.10.24) 追加START                                   " & vbNewLine _
                                          & "--     ,S2.REMARK                                                        " & vbNewLine _
                                          & "--要望番号2091(2013.10.24) 追加END                                     " & vbNewLine _
                                          & "     FROM                                                              " & vbNewLine _
                                          & "     $LM_TRN$..C_OUTKA_S S2                                            " & vbNewLine _
                                          & "     WHERE                                                             " & vbNewLine _
                                          ...
                                          & "  AND ZAI_TRS.NRS_BR_CD = OUT_S.NRS_BR_CD                              " & vbNewLine _
                                          & "  AND ZAI_TRS.ZAI_REC_NO = OUT_S.ZAI_REC_NO                            " & vbNewLine _
                                          & "LEFT JOIN $LM_TRN$..H_OUTKAEDI_DTL_BYKDIR DTL_BYKDIR                  " & vbNewLine _
                                          & " ON  DTL_BYKDIR.DEL_KB <> '1'                                          " & vbNewLine _
                                          & " AND DTL_BYKDIR.NRS_BR_CD = EDI_M.NRS_BR_CD                            " & vbNewLine _
                                          & " AND DTL_BYKDIR.EDI_CTL_NO = EDI_M.EDI_CTL_NO                          " & vbNewLine _
                                          & " AND DTL_BYKDIR.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU                  " & vbNewLine _
                                          & " AND DTL_BYKDIR.JISSEKI_SHORI_FLG = '1'                                " & vbNewLine _
                                          & " LEFT JOIN $LM_MST$..M_DEST  M_DEST                                    " & vbNewLine _
                                          & "  ON  M_DEST.SYS_DEL_FLG = '0'                                         " & vbNewLine _
                                          & "  AND M_DEST.CUST_CD_L = OUT_L.CUST_CD_L                               " & vbNewLine _
                                          & "  AND M_DEST.DEST_CD = OUT_L.DEST_CD                                   " & vbNewLine _
                                          ...
                                          & "  ON MDD.NRS_BR_CD = OUT_L.NRS_BR_CD                   " & vbNewLine _
                                          & "  AND MDD.CUST_CD_L = OUT_L.CUST_CD_L                  " & vbNewLine _
                                          & "  AND MDD.DEST_CD = OUT_L.DEST_CD                      " & vbNewLine _
                                          & "  AND MDD.SUB_KB = '14'                                " & vbNewLine _
                                          & "  AND MDD.SYS_DEL_FLG = '0'                            " & vbNewLine _
                                          & "  --20160510                                           " & vbNewLine _
                                          & "WHERE EDI_M.DEL_KB <> '1'                                              " & vbNewLine _
                                          & " AND  EDI_M.NRS_BR_CD = @NRS_BR_CD                                     " & vbNewLine _
                                          & " AND  EDI_M.EDI_CTL_NO = @EDI_CTL_NO                                   " & vbNewLine _
                                          & " AND  OUT_M.NRS_BR_CD IS NOT NULL                                      " & vbNewLine _
                                          & " AND  EDI_M.JISSEKI_FLAG = '0'                                         " & vbNewLine

#End Region

#Region "H_SENDOUTEDI_BYEKT SELECT句"

    Private Const SQL_SELECT_BYKEKT_SEND_DATA As String = "SELECT                                                                      " & vbNewLine _
                                          & " '0'                                          AS DEL_KB	                               " & vbNewLine _
                                          & ",DTL_BYKEKT.CRT_DATE                          AS CRT_DATE                                 " & vbNewLine _
                                          & ",DTL_BYKEKT.FILE_NAME + OUT_S.OUTKA_NO_S      AS FILE_NAME                                " & vbNewLine _
                                          & ",DTL_BYKEKT.REC_NO                            AS REC_NO                                   " & vbNewLine _
                                          & ",DTL_BYKEKT.GYO                               AS GYO                                      " & vbNewLine _
                                          & ",EDI_M.NRS_BR_CD                              AS NRS_BR_CD                                " & vbNewLine _
                                          & ",EDI_M.EDI_CTL_NO                             AS EDI_CTL_NO                               " & vbNewLine _
                                          & ",EDI_M.EDI_CTL_NO_CHU                         AS EDI_CTL_NO_CHU                           " & vbNewLine _
                                          & ",OUT_M.OUTKA_NO_L                             AS OUTKA_CTL_NO                             " & vbNewLine _
                                          ...
                                          & ",OUT_L.CUST_CD_L                              AS CUST_CD_L                                " & vbNewLine _
                                          & ",OUT_L.CUST_CD_M                              AS CUST_CD_M                                " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK01_ACTION                    AS E1EDK01_ACTION                           " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK01_CURCY                     AS E1EDK01_CURCY                            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK01_LIFSK                     AS E1EDK01_LIFSK                            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK02_QUALF_BELNR_002           AS E1EDK02_QUALF_BELNR_002                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK14_QUALF_ORGID_012           AS E1EDK14_QUALF_ORGID_012                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK14_QUALF_ORGID_008           AS E1EDK14_QUALF_ORGID_008                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK14_QUALF_ORGID_007           AS E1EDK14_QUALF_ORGID_007                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK14_QUALF_ORGID_006           AS E1EDK14_QUALF_ORGID_006                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDKA1_PARVW_LIFNR_AG            AS E1EDKA1_PARVW_LIFNR_AG                   " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDKA1_PARVW_LIFNR_WE            AS E1EDKA1_PARVW_LIFNR_WE                   " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDKA1_PARVW_PARTN_ZZ            AS E1EDKA1_PARVW_PARTN_ZZ                   " & vbNewLine _
                                          & "--,DTL_BYKEKT.E1EDK03_IDDAT_DATUM_001           AS E1EDK03_IDDAT_DATUM_001                  " & vbNewLine _
                                          & ",OUT_L.ARR_PLAN_DATE                          AS E1EDK03_IDDAT_DATUM_001                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDKT1_TDID                      AS E1EDKT1_TDID                             " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDKT1_TSSPRAS                   AS E1EDKT1_TSSPRAS                          " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDKT1_TDOBJECT                  AS E1EDKT1_TDOBJECT                         " & vbNewLine _
                                          & ",ISNULL(M_DEST.DEST_NM,DTL_BYKEKT.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE1) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE1 " & vbNewLine _
                                          & ",CASE WHEN M_DEST.DEST_NM IS NULL THEN DTL_BYKEKT.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE2       " & vbNewLine _
                                          & "      ELSE ''                                                                             " & vbNewLine _
                                          & "      END  E1EDKT2_TDLINE_TDFORMAT_TEXTLINE2                                              " & vbNewLine _
                                          & ",ISNULL(OUT_L.DEST_AD_1,DTL_BYKEKT.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE3) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE3    " & vbNewLine _
                                          & ",ISNULL(OUT_L.DEST_AD_2,DTL_BYKEKT.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE4) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE4    " & vbNewLine _
                                          & ",ISNULL(OUT_L.DEST_AD_3,DTL_BYKEKT.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE5) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE5    " & vbNewLine _
                                          & ",ISNULL(M_DEST.TEL,DTL_BYKEKT.E1EDKT2_TDLINE_TDFORMAT_TEXTLINE6) AS E1EDKT2_TDLINE_TDFORMAT_TEXTLINE6     " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDK02_QUALF_BELNR_001           AS E1EDK02_QUALF_BELNR_001                  " & vbNewLine _
                                          & "--,DTL_BYKEKT.E1EDK02_QUALF_BELNR_043           AS E1EDK02_QUALF_BELNR_043                  " & vbNewLine _
                                          & "--,OUT_M.RSV_NO                                 AS E1EDK02_QUALF_BELNR_043                  " & vbNewLine _
                                          & ",REPLACE(LEFT(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,''))),'-','')  AS E1EDK02_QUALF_BELNR_043                  " & vbNewLine _
                                          & "--,SUBSTRING(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,'')) +1,40) AS E1EDP01_POSEX            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP01_POSEX                     AS E1EDP01_POSEX                            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP01_MATNR                     AS E1EDP01_MATNR                            " & vbNewLine _
                                          & ",ISNULL(OUT_S.ALCTD_NB,0)                     AS E1EDP01_MENGE                            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP01_MENEE                     AS E1EDP01_MENEE                            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP01_WERKS                     AS E1EDP01_WERKS                            " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP01_VSTEL                     AS E1EDP01_VSTEL                            " & vbNewLine _
                                          & "--,ISNULL(M_CUSTC.REMARK,DTL_BYKEKT.E1EDP01_LGORT) AS E1EDP01_LGORT                            " & vbNewLine _
                                          & "--,CASE WHEN M_CUSTC.REMARK IS NULL THEN CASE WHEN DTL_BYKEKT.E1EDP01_LGORT = '' THEN '1000' ELSE DTL_BYKEKT.E1EDP01_LGORT END " & vbNewLine _
                                          & "--      ELSE M_CUSTC.REMARK END  E1EDP01_LGORT                                              " & vbNewLine _
                                          & ",CASE WHEN OUT_L.CUST_CD_L = '00759' THEN DTL_BYKEKT.E1EDP01_LGORT                        " & vbNewLine _
                                          & "      WHEN M_CUSTC.REMARK IS NULL THEN '1000'                                             " & vbNewLine _
                                          & "      ELSE REVERSE(CONVERT(VARCHAR(4), REVERSE(M_CUSTC.REMARK))) END  E1EDP01_LGORT       " & vbNewLine _
                                          & "--,DTL_BYKEKT.E1EDP02_QUALF_BELNR_043           AS E1EDP02_QUALF_BELNR_043                  " & vbNewLine _
                                          & ",REPLACE(LEFT(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,''))),'-','')  AS E1EDP02_QUALF_BELNR_043                  " & vbNewLine _
                                          & "--,ISNULL(OUT_S.REMARK,'')                      AS E1EDP02_QUALF_ZEILE_043                  " & vbNewLine _
                                          & ",SUBSTRING(ISNULL(OUT_M.SERIAL_NO,''),CHARINDEX('-',ISNULL(OUT_M.SERIAL_NO,'')) +1,40) AS E1EDP02_QUALF_ZEILE_043            " & vbNewLine _
                                          & "--,DTL_BYKEKT.E1EDP02_QUALF_ZEILE_043           AS E1EDP02_QUALF_ZEILE_043                  " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP02_QUALF_BELNR_044           AS E1EDP02_QUALF_BELNR_044                  " & vbNewLine _
                                          & "--,DTL_BYKEKT.E1EDP03_QUALF_DATE_010            AS E1EDP03_QUALF_DATE_010                   " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS E1EDP03_QUALF_DATE_010                   " & vbNewLine _
                                          & ",OUT_L.ARR_PLAN_DATE                          AS E1EDP03_QUALF_DATE_024                   " & vbNewLine _
                                          & "--,DTL_BYKEKT.E1EDP20_WMENG_EDATU               AS E1EDP20_WMENG_EDATU                      " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS E1EDP20_WMENG_EDATU                      " & vbNewLine _
                                          & ",DTL_BYKEKT.E1EDP19_QUALF_IDTNR_002           AS E1EDP19_QUALF_IDTNR_002                  " & vbNewLine _
                                          & ",ISNULL(OUT_S.LOT_NO,'')                       AS E1EDP19_QUALF_IDTNR_010                  " & vbNewLine _
                                          & "--要望番号2091(2013.10.24) 追加START                                                      " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_PARVW_PARTN_DUMMY               " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_NAME1                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_NAME2                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_NAME3                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_NAME4                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_STRAS                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_STRS2                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_ORT01                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_PSTLZ                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_LAND1                           " & vbNewLine _
                                          & ",''                                           AS E1EDKA1_TELF1                           " & vbNewLine _
                                          & ",'0'                                          AS SAMPLE_HOUKOKU_FLG                      " & vbNewLine _
                                          & "--要望番号2091(2013.10.24) 追加END                                                        " & vbNewLine _
                                          & ",''                                           AS RECORD_STATUS                            " & vbNewLine _
                                          & ",'2'                                          AS JISSEKI_SHORI_FLG                        " & vbNewLine _
                                          & ",'0'                                          AS SAMPLEHOUKOKU_SHORI_FLG                 " & vbNewLine

#End Region

#Region "H_SENDOUTEDI_BYKEKT FROM句"

    Private Const SQL_FROM_BYKEKT_SEND_DATA As String = "FROM                                                       " & vbNewLine _
                                          & "$LM_TRN$..H_OUTKAEDI_M EDI_M                                           " & vbNewLine _
                                          & "LEFT JOIN $LM_TRN$..C_OUTKA_M OUT_M                                   " & vbNewLine _
                                          & " ON  OUT_M.SYS_DEL_FLG = '0'                                           " & vbNewLine _
                                          & " AND OUT_M.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
                                          ...
                                          & "  AND ZAI_TRS.NRS_BR_CD = OUT_S.NRS_BR_CD                              " & vbNewLine _
                                          & "  AND ZAI_TRS.ZAI_REC_NO = OUT_S.ZAI_REC_NO                            " & vbNewLine _
                                          & "LEFT JOIN $LM_TRN$..H_OUTKAEDI_DTL_BYKEKT DTL_BYKEKT                  " & vbNewLine _
                                          & " ON  DTL_BYKEKT.DEL_KB <> '1'                                          " & vbNewLine _
                                          & " AND DTL_BYKEKT.NRS_BR_CD = EDI_M.NRS_BR_CD                            " & vbNewLine _
                                          & " AND DTL_BYKEKT.EDI_CTL_NO = EDI_M.EDI_CTL_NO                          " & vbNewLine _
                                          & " AND DTL_BYKEKT.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU                  " & vbNewLine _
                                          & " AND DTL_BYKEKT.JISSEKI_SHORI_FLG = '1'                                " & vbNewLine _
                                          & " LEFT JOIN $LM_MST$..M_DEST  M_DEST                                    " & vbNewLine _
                                          & "  ON  M_DEST.SYS_DEL_FLG = '0'                                         " & vbNewLine _
                                          & "  AND M_DEST.CUST_CD_L = OUT_L.CUST_CD_L                               " & vbNewLine _
                                          & "  AND M_DEST.DEST_CD = OUT_L.DEST_CD                                   " & vbNewLine _
...
#Region "H_SENDOUTEDI_BYKDIR"
    ...
    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_BYKDIR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_BYKDIR As String = "INSERT INTO       " & vbNewLine _
                                     & "$LM_TRN$..H_SENDOUTEDI_BYKDIR       " & vbNewLine _
                                     & "(                                " & vbNewLine _
                                     & " DEL_KB                          " & vbNewLine _
                                     & ",CRT_DATE                        " & vbNewLine _
                                     & ",FILE_NAME                       " & vbNewLine _
...
#Region "H_SENDOUTEDI_BYKEKT"

    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_BYKEKT）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_BYKEKT As String = "INSERT INTO       " & vbNewLine _
                                     & "$LM_TRN$..H_SENDOUTEDI_BYKEKT       " & vbNewLine _
                                     & "(                                " & vbNewLine _
                                     & " DEL_KB                          " & vbNewLine _
                                     & ",CRT_DATE                        " & vbNewLine _
                                     & ",FILE_NAME                       " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DIR"

    ''' <summary>
    ''' BYK(直販)EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYKDIR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTLDIR As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYKDIR SET       " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_TST"

    ''' <summary>
    ''' BYK(テツタニ)EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYKTST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTLTST As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYKTST SET       " & vbNewLine _
                                                  & " JISSEKI_SHORI_FLG      = @JISSEKI_SHORI_FLG       	         " & vbNewLine _
                                                  & ",JISSEKI_USER           = @JISSEKI_USER                         " & vbNewLine _
                                                  & ",JISSEKI_DATE           = @JISSEKI_DATE                         " & vbNewLine _
                                                  & ",JISSEKI_TIME           = @JISSEKI_TIME                         " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_EKT"

    ''' <summary>
    ''' BYK(テツタニ)EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYKEKT）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTLEKT As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYKEKT SET       " & vbNewLine _
                                                  & " JISSEKI_SHORI_FLG      = @JISSEKI_SHORI_FLG       	         " & vbNewLine _
                                                  & ",JISSEKI_USER           = @JISSEKI_USER                         " & vbNewLine _
                                                  & ",JISSEKI_DATE           = @JISSEKI_DATE                         " & vbNewLine _
                                                  & ",JISSEKI_TIME           = @JISSEKI_TIME                         " & vbNewLine _
...
#Region "オーダー番号重複チェック(ビックケミー専用)"
    Private Const SQL_SELECT_C_OUTKA_LM_BYK As String = " SELECT                                  " & vbNewLine _
                                     ...
                                     & " ON                                                       " & vbNewLine _
                                     & " C_OUTKA_M.SYS_DEL_FLG <> '1'                             " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     ...
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_M.CUST_ORD_NO_DTL = @CUST_ORD_NO_DTL             " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_BYK"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYK SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#End Region
    ...
    '2013.07.30 追加START
#Region "H_OUTKAEDI_DTL_BYKDIR"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYKDIR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTLDIR As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYKDIR SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#End Region
    ...
    '2013.07.30 追加START
#Region "H_OUTKAEDI_DTL_BYKTST"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYKTST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTLTST As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYKTST SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#End Region
    ...
    '2013.07.20 追加START
#Region "H_OUTKAEDI_DTL_BYKEKT"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BYKEKT）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTLEKT As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BYKEKT SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_BYK"
    'ビックケミーは受信HEDを持っていないため更新しない
    '''' <summary>
    '''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_BYK）
    '''' </summary>
    '''' <remarks></remarks>
    'Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_BYK SET       " & vbNewLine _
    '                                          & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#End Region
    ...
    '要望番号2091 修正START 2013.10.02
#Region "M_DEST INSERT(ビックケミーは自動追加がない為使用しない→エカルト,直販の場合は自動追加)"
...
#End Region
    ...
    '#Region "M_DEST UPDATE(届先項目差異有りの場合)(ビックケミーは自動更新がない為使用しない)"
    '    ''' <summary>
    '    ''' 届先マスタUPDATE文（M_DEST）
    '    ''' </summary>
    '    ''' <remarks></remarks>
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC102.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectDataNcgoMdest", cmd)
...
#Region "出荷(大,中)データ(オーダー番号チェック用)：ビックケミー専用"

    ''' <summary>
    ''' 件数取得処理(C_OUTKA_L,C_OUTKA_M)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>オーダー番号重複チェック</remarks>
    Private Function SelectOrderCheckDataByk(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_C_OUTKA_LM_BYK)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterLByk(dt)
        Call Me.SetOutkaParameterMByk(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectOrderCheckDataByk", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC102.SQL_UPDATE_OUTKASAVEEDI_L

                '2013.07.30 追加START
                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
                '2013.07.30 追加END
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC102.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '2013.07.30 追加START
                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
                '2013.07.30 追加END
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    '        '出荷登録、紐付けSQL CONST名
    '        Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
    '            setSql = LMH030DAC102.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

    '            '実績作成SQL CONST名
    '        Case LMH030DAC.EventShubetsu.CREATEJISSEKI
    '            setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        '2013.07.30 追加START
        Dim ediCustIndex As String = ds.Tables("LMH030INOUT").Rows(0).Item("EDI_CUST_INDEX").ToString()
        '2013.07.30 追加END
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            ''2013.07.20 コメントSTART
            ''出荷登録、紐付けSQL CONST名
            'Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
            '    setSql = LMH030DAC102.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
            '    loopflg = 1
            '    '2013.07.20 コメントEND
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                ...
                Select Case Convert.ToInt32(ediCustIndex)
                    ...
                    Case LMH030DAC.EdiCustIndex.BykChb00266_00
                        setSql = LMH030DAC102.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTLDIR

                    Case LMH030DAC.EdiCustIndex.BykChb00266_01
                        setSql = LMH030DAC102.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTLTST

                    Case LMH030DAC.EdiCustIndex.BykChb00729_00
                        setSql = LMH030DAC102.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTLEKT
            ...
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                ...
                Select Case Convert.ToInt32(ediCustIndex)
                    ...
                    Case LMH030DAC.EdiCustIndex.BykChb00266_00
                        setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTLDIR

                    Case LMH030DAC.EdiCustIndex.BykChb00266_01
                        setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTLTST

                    Case LMH030DAC.EdiCustIndex.BykChb00729_00
                        setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTLEKT
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC102.SQL_UPDATE_OUTKAL_MATOME

                '2013.07.30 追加START
                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC102.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
                '2013.07.30 追加END
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC102.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC102.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ビックケミーは自動更新がないため使用しない)"
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertUnchinData", cmd)
...
#End Region
    ...
    '要望番号2091 修正START 2013.10.02
#Region "M_DEST(ビックケミーは自動追加がない為、使用しない→エカルト、直販の場合は自動追加を行う)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertMDestData", cmd)
...
#Region "出荷パラメータ設定(オーダー番号チェック用) ビックケミー専用"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterLByk(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        'CUST_ORD_NO_DTLの値を勝手に入れ替えてしまうためコメント(使用していない)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterMByk(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO_DTL", dt.Rows(0).Item("CUST_ORD_NO_DTL"), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectDataMdestOutkaToroku", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet

        '取消データは受信DTLから取得する
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_BYK")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        Call Me.SetSelectOutkaEdiRcvCancel(Me._Row, Me._SqlPrmList)         '条件設定
        ...
        sql = Me.SetTableNmOutkaEdiRcvDtl(drSemiEdiInfo, sql)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectOutkaEdiRcvCancel", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_BYK_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_BYK_CANCELOUT").Rows.Count())
        reader.Close()
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_BYK")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC102.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC102.SQL_GROUP_BY_M_GOODS)

        'パラメータ設定
        Call Me.SetSelectMstGoodsParameter(drSemiEdiInfo, dtRcvDtl)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectDataMgoods", cmd)
...
#Region "届先マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_M_DEST1)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC102.SQL_GROUP_BY_M_DEST)

        'パラメータ設定
        Call Me.SetSelectMstDestParameter(drSemiEdiInfo, dtRcvDtl)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectDataMDEST", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_DTL_BYK_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC102.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"

    ''' <summary>
    ''' EDI出荷(中)テーブル更新(セミEDI：画面取込)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(中)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC102.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet


        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHedCancel As DataTable = ds.Tables("LMH030_DTL_BYK_CANCELOUT")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC102.SQL_UPDATE_DEL_OUTKAEDI_HED

        '受信DTLテーブル名設定
        sSql = Me.SetTableNmOutkaEdiRcvHed(drSemiEdiInfo, sSql)
        ...
        'パラメータ設定
        Call Me.SetUpdateDelOutkaEdiRcvParameter(Me._Row, Me._SqlPrmList)   'Update内容
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_BYK_CANCELOUT")   'DTLの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC102.SQL_UPDATE_DEL_OUTKAEDI_DTL

        '受信DTLテーブル名設定
        sSql = Me.SetTableNmOutkaEdiRcvDtl(drSemiEdiInfo, sSql)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHed As DataTable = setDs.Tables("LMH030_OUTKAEDI_HED_BYK")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_BYK").Rows(0).Item("NRS_BR_CD").ToString())

        '受信DTLテーブル名設定
        Dim drSemiEdiInfo As DataRow = setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        sql = Me.SetTableNmOutkaEdiRcvHed(drSemiEdiInfo, sql)
        ...
        'パラメータ設定
        Call Me.SetInsertOutkaEdiRcvHedParameter(Me._Row, Me._SqlPrmList)
        'Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_BYK")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_OUTKAEDI_DTL_BYK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        'パラメータ設定
        Call Me.SetInsertOutkaEdiRcvDtlParameter(Me._Row, Me._SqlPrmList)
        'Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信HEDテーブル名設定"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetTableNmOutkaEdiRcvHed(ByVal dr As DataRow, ByVal sql As String) As String

        Dim sTableNm As String = dr.Item("RCV_NM_HED").ToString()

        '要望番号1277:(テーブル名が固定で記載されている) 2012/07/12 本明 Start(コメント化)
        ''キャッシュにRCV_NM_HEDが追加されるまでの暫定処置
        'sTableNm = "H_OUTKAEDI_HED_BYK"
...
#Region "EDI受信DTLテーブル名設定"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetTableNmOutkaEdiRcvDtl(ByVal dr As DataRow, ByVal sql As String) As String

        Dim sTableNm As String = dr.Item("RCV_NM_DTL").ToString()

        '要望番号1277:(テーブル名が固定で記載されている) 2012/07/12 本明 Start(コメント化)
        ''キャッシュにRCV_NM_DTLが追加されるまでの暫定処置
        'sTableNm = "H_OUTKAEDI_DTL_BYK"
        '要望番号1277:(テーブル名が固定で記載されている) 2012/07/12 本明 End
...
#Region "EDI受信(HED)更新パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetInsertOutkaEdiRcvHedParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(.Item("DEL_KB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CRT_DATE", Me.NullConvertString(.Item("CRT_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FILE_NAME", Me.NullConvertString(.Item("FILE_NAME")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@REC_NO", Me.NullConvertString(.Item("REC_NO")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@HAKKO_KB_NM", Me.NullConvertString(.Item("HAKKO_KB_NM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUT_KB_NM", Me.NullConvertString(.Item("OUT_KB_NM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JIGYO_CD", Me.NullConvertString(.Item("JIGYO_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JIGYO_NM", Me.NullConvertString(.Item("JIGYO_NM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOUKO_CD", Me.NullConvertString(.Item("SOUKO_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOUKO_NM", Me.NullConvertString(.Item("SOUKO_NM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_BI", Me.NullConvertString(.Item("OUTKA_BI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_ZIP", Me.NullConvertString(.Item("NONYU_ZIP")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_CD", Me.NullConvertString(.Item("NONYU_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_NM", Me.NullConvertString(.Item("NONYU_NM")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_AD_1", Me.NullConvertString(.Item("NONYU_AD_1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_AD_2", Me.NullConvertString(.Item("NONYU_AD_2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_TEL", Me.NullConvertString(.Item("NONYU_TEL")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIKESHI_KB_NM", Me.NullConvertString(.Item("TORIKESHI_KB_NM")), DBDataType.CHAR))
            ...
            'システム管理用項目
            prmList.Add(MyBase.GetSqlParameter("@SYS_ENT_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_ENT_TIME", updTime))
            prmList.Add(MyBase.GetSqlParameter("@SYS_ENT_PGID", MyBase.GetPGID(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_ENT_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_TIME", updTime))
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_PGID", MyBase.GetPGID(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(.Item("CUST_CD_L")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(.Item("CUST_CD_M")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@PRTFLG", Me.NullConvertString(.Item("PRTFLG")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CANCEL_FLG", Me.NullConvertString(.Item("CANCEL_FLG")), DBDataType.CHAR))

            'EDI受信（DTL）荷主個別項目
            'prmList.Add(MyBase.GetSqlParameter("@BYK_BR_CD", Me.NullConvertString(.Item("BYK_BR_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@BYK_BR_CD", Me.NullConvertZero(.Item("BYK_BR_CD")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@OUTKA_REQ_DATE", Me.NullConvertString(.Item("OUTKA_REQ_DATE")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_REQ_DATE", Me.NullConvertZero(.Item("OUTKA_REQ_DATE")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@BYK_OUTKA_NO", Me.NullConvertString(.Item("BYK_OUTKA_NO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@BYK_OUTKA_NO", Me.NullConvertZero(.Item("BYK_OUTKA_NO")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@DATA_KB", Me.NullConvertString(.Item("DATA_KB")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@DATA_KB", Me.NullConvertZero(.Item("DATA_KB")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_DATE", Me.NullConvertString(.Item("OUTKA_PLAN_DATE")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_DATE", Me.NullConvertZero(.Item("OUTKA_PLAN_DATE")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@NONYU_DATE", Me.NullConvertString(.Item("NONYU_DATE")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_DATE", Me.NullConvertZero(.Item("NONYU_DATE")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@TOKUI_CD", Me.NullConvertString(.Item("TOKUI_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@TOKUI_CD", Me.NullConvertZero(.Item("TOKUI_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@TOKUI_NM", Me.NullConvertString(.Item("TOKUI_NM")), DBDataType.CHAR))
            'prmList.Add(MyBase.GetSqlParameter("@NONYU_CD", Me.NullConvertString(.Item("NONYU_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_CD", Me.NullConvertZero(.Item("NONYU_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_NM1", Me.NullConvertString(.Item("NONYU_NM1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_NM2", Me.NullConvertString(.Item("NONYU_NM2")), DBDataType.CHAR))
            '(2013.02.25)要望番号1889 新レイアウト切替 修正START
            prmList.Add(MyBase.GetSqlParameter("@NONYU_NM3", Me.NullConvertString(.Item("NONYU_NM3")), DBDataType.CHAR))
            '(2013.02.25)要望番号1889 新レイアウト切替 修正END
            'prmList.Add(MyBase.GetSqlParameter("@MAKER_CD", Me.NullConvertString(.Item("MAKER_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@MAKER_CD", Me.NullConvertZero(.Item("MAKER_CD")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@GOODS_CD", Me.NullConvertString(.Item("GOODS_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CD", Me.NullConvertZero(.Item("GOODS_CD")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO_EDA", Me.NullConvertString(.Item("LOT_NO_EDA")), DBDataType.CHAR))
            '(2013.02.25)要望番号1889 新レイアウト切替 修正START
            'prmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NEW", Me.NullConvertString(.Item("GOODS_CD_NEW")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NEW", Me.NullConvertZero(.Item("GOODS_CD_NEW")), DBDataType.NUMERIC))
            '(2013.02.25)要望番号1889 新レイアウト切替 修正END
            ...
            prmList.Add(MyBase.GetSqlParameter("@YORYO", Me.NullConvertZero(.Item("YORYO")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@OUTKA_NB", Me.NullConvertString(.Item("OUTKA_NB")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_NB", Me.NullConvertZero(.Item("OUTKA_NB")), DBDataType.NUMERIC))
            'prmList.Add(MyBase.GetSqlParameter("@OUTKA_QT", Me.NullConvertString(.Item("OUTKA_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_QT", Me.NullConvertZero(.Item("OUTKA_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@ORDER_NO", Me.NullConvertString(.Item("ORDER_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_REMARK", Me.NullConvertString(.Item("OUTKA_REMARK")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_REMARK", Me.NullConvertString(.Item("NONYU_REMARK")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JUTYU_NO", Me.NullConvertString(.Item("JUTYU_NO")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@EDI_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_TIME", updTime, DBDataType.CHAR))
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectMstGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
...
#Region "EDI受信(HED/DTL共通)の削除UPDATE文(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetUpdateDelOutkaEdiRcvParameter(ByVal drOutkaEdiRcvIn As DataRow, ByVal prmList As ArrayList)

        'Set内容
        prmList.Add(MyBase.GetSqlParameter("@DELETE_EDI_NO", Me.NullConvertString(drOutkaEdiRcvIn.Item("DELETE_EDI_NO")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@DELETE_EDI_NO_CHU", Me.NullConvertString(drOutkaEdiRcvIn.Item("DELETE_EDI_NO_CHU")), DBDataType.CHAR))
        ...
        prmList.Add(MyBase.GetSqlParameter("@GYO", Me.NullConvertString(drOutkaEdiRcvIn.Item("GYO")), DBDataType.CHAR))
    End Sub
...
#Region "EDI受信(DTL)削除データ抽出パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetSelectOutkaEdiRcvCancel(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@JUTYU_NO", Me.NullConvertString(.Item("JUTYU_NO").ToString()), DBDataType.NVARCHAR))
...
#Region "データ取得処理(BYK直販)"

    ''' <summary>
    ''' BYKEDI実績データの値設定(BYK直販)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>BYKEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectBykDirEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_BYKDIR_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC102.SQL_FROM_BYKDIR_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectBykDirEdiSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_BYKDIR")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_BYKDIR").Rows.Count())
        reader.Close()
...
#Region "データ取得処理(BYKテツタニ)"

    ''' <summary>
    ''' BYKEDI実績データの値設定(BYKテツタニ)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>BYKEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectBykTstEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_BYKTST_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC102.SQL_FROM_BYKTST_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectBykTstEdiSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_BYKTST")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_BYKTST").Rows.Count())
        reader.Close()
...
#Region "データ取得処理(BYKエカルト)"

    ''' <summary>
    ''' BYKEDI実績データの値設定(BYKエカルト)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>BYKEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectBykEktEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC102.SQL_SELECT_BYKEKT_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC102.SQL_FROM_BYKEKT_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC102", "SelectBykEktEdiSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_BYKEKT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_BYKEKT").Rows.Count())
        reader.Close()
...
#Region "H_SENDOUTEDI_BYKAGT"
    ...
    ''' <summary>
    ''' BYK(テツタニ)EDI実績テーブル新規登録
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>BYK(テツタニ)EDI実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertBykTstEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_BYKTST")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_H_SENDOUTEDI_BYKAGT _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_BYKTST").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertBykTstEdiSendData", cmd)
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    Private Sub SetEdiSendAgtCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@SAMPLEHOUKOKU_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAMPLEHOUKOKU_TIME", updTime, DBDataType.CHAR))
            '要望番号2091 追加END 2013.10.24
...
#Region "H_SENDOUTEDI_BYKDIR"
    ...
    ''' <summary>
    ''' BYK(直販)EDI実績テーブル新規登録
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>BYK(直販)EDI実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertBykDirEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_BYKDIR")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_H_SENDOUTEDI_BYKDIR _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_BYKDIR").Rows(0).Item("NRS_BR_CD").ToString()))
        Dim max As Integer = dowSendTbl.Rows.Count() - 1
        For i As Integer = 0 To max
            ...
            'パラメータ設定
            Call Me.SetDataInsertParameter(Me._SqlPrmList)
            Call Me.SetEdiSendDirCreateParameter(Me._Row, Me._SqlPrmList)
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertBykDirEdiSendData", cmd)
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    ''' <summary>
    ''' EDI送信(TBL)の新規登録パラメータ設定(BYK(直販))
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiSendDirCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
...
#Region "H_SENDOUTEDI_BYKEKT"
    ...
    ''' <summary>
    ''' BYK(エカルト)EDI実績テーブル新規登録
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>BYK(エカルト)EDI実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertBykEktEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_BYKEKT")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC102.SQL_INSERT_H_SENDOUTEDI_BYKEKT _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_BYKEKT").Rows(0).Item("NRS_BR_CD").ToString()))
        Dim max As Integer = dowSendTbl.Rows.Count() - 1
        For i As Integer = 0 To max
            ...
            'パラメータ設定
            Call Me.SetDataInsertParameter(Me._SqlPrmList)
            Call Me.SetEdiSendEktCreateParameter(Me._Row, Me._SqlPrmList)
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC102", "InsertBykEktEdiSendData", cmd)
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    ''' <summary>
    ''' EDI送信(TBL)の新規登録パラメータ設定(BYK(エカルト))
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiSendEktCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
