...
#Region "H_OUTKAEDI_NOHINSYO_TRM"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_NOHINSYO_TRM）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_NOHINSYO_TRM SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "M_DEST INSERT(テルモは自動追加を行う為使用予定)"
...
#End Region
    ...
    'テルモ　修正箇所START　仕掛中
#Region "M_DEST UPDATE(届先項目差異有りの場合)(テルモは自動更新を行う為使用予定)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "H_SENDOUTEDI_TRM SELECT句"

    Private Const SQL_SELECT_TRM_SEND_DATA As String = "SELECT                                                        " & vbNewLine _
                                          & " '0'                                          AS DEL_KB	              " & vbNewLine _
                                          & ",DTL_TRM.CRT_DATE                             AS CRT_DATE                " & vbNewLine _
                                          & ",DTL_TRM.FILE_NAME                            AS FILE_NAME               " & vbNewLine _
                                          & ",DTL_TRM.REC_NO                               AS REC_NO                  " & vbNewLine _
                                          & ",DTL_TRM.GYO_NO                               AS GYO                     " & vbNewLine _
                                          ...
                                          & ",OUT_M.OUTKA_NO_L                             AS OUTKA_CTL_NO_L          " & vbNewLine _
                                          & ",OUT_M.OUTKA_NO_M                             AS OUTKA_CTL_NO_M          " & vbNewLine _
                                          & ",OUT_L.CUST_CD_L                              AS CUST_CD_L               " & vbNewLine _
                                          & ",OUT_L.CUST_CD_M                              AS CUST_CD_M               " & vbNewLine _
                                          & ",DTL_TRM.OPERATING_UNIT_ALT_NAME              AS OPERATING_UNIT_ALT_NAME " & vbNewLine _
                                          & ",DTL_TRM.ORGANIZATION_CODE                    AS ORGANIZATION_CODE       " & vbNewLine _
                                          & ",'00000000' + OUT_M.OUTKA_NO_L + OUT_M.OUTKA_NO_M  AS SHIP_ACTUAL_NUM    " & vbNewLine _
                                          & ",DTL_TRM.DELIVERY_ID                          AS DELIVERY_ID             " & vbNewLine _
                                          & ",DTL_TRM.DELIVERY_DETAIL_ID                   AS DELIVERY_DETAIL_ID      " & vbNewLine _
                                          & ",OUT_L.CUST_ORD_NO                            AS DELIVERY_NUM            " & vbNewLine _
                                          & ",DTL_TRM.ITEM_CODE                            AS ITEM_CODE               " & vbNewLine _
                                          & ",OUT_M.LOT_NO                                 AS LOT_NUM                 " & vbNewLine _
                                          & ",OUT_M.SERIAL_NO                              AS SERIAL_NUM              " & vbNewLine _
                                          & ",CASE WHEN M_GOODS_DETAILS.SET_NAIYO IS NULL THEN 0                      " & vbNewLine _
                                          & "      WHEN OUT_M.SYS_DEL_FLG = '1' THEN 0                                " & vbNewLine _
                                          & "      ELSE OUT_M.OUTKA_TTL_NB * M_GOODS_DETAILS.SET_NAIYO                " & vbNewLine _
                                          & "      END SHIPPING_QTY                                                   " & vbNewLine _
                                          & ",CASE WHEN M_GOODS_DETAILS.SET_NAIYO IS NULL THEN 0                      " & vbNewLine _
                                          & "      WHEN OUT_M.SYS_DEL_FLG = '1'                                       " & vbNewLine _
                                          & "      THEN EDI_M.OUTKA_TTL_NB * M_GOODS_DETAILS.SET_NAIYO                " & vbNewLine _
                                          & "      ELSE (EDI_M.OUTKA_TTL_NB * M_GOODS_DETAILS.SET_NAIYO) - (OUT_M.OUTKA_TTL_NB * M_GOODS_DETAILS.SET_NAIYO) " & vbNewLine _
                                          & "      END NON_SHIPPABLE_QTY                                              " & vbNewLine _
                                          & ",OUT_L.OUTKA_PLAN_DATE                        AS ACTUAL_SHIPPED_DATE     " & vbNewLine _
                                          & ",'1'                                          AS SHIP_CTG                " & vbNewLine _
                                          & ",''                                           AS RECORD_STATUS           " & vbNewLine _
                                          & ",'2'                                          AS JISSEKI_SHORI_FLG       " & vbNewLine

#End Region

#Region "H_SENDOUTEDI_TRM FROM句"

    Private Const SQL_FROM_TRM_SEND_DATA As String = "FROM                                                          " & vbNewLine _
                                          & "$LM_TRN$..H_OUTKAEDI_M EDI_M                                           " & vbNewLine _
                                          & "INNER JOIN $LM_TRN$..C_OUTKA_M OUT_M                                   " & vbNewLine _
                                          & "-- ON  OUT_M.SYS_DEL_FLG = '0'                                           " & vbNewLine _
                                          & " ON OUT_M.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
                                          ...
                                          & "  ON OUT_L.NRS_BR_CD = OUT_M.NRS_BR_CD                                " & vbNewLine _
                                          & "  AND OUT_L.OUTKA_NO_L = OUT_M.OUTKA_NO_L                              " & vbNewLine _
                                          & "INNER JOIN $LM_TRN$..H_OUTKAEDI_NOHINSYO_TRM DTL_TRM                   " & vbNewLine _
                                          & " ON  DTL_TRM.DEL_KB <> '1'                                             " & vbNewLine _
                                          & " AND DTL_TRM.NRS_BR_CD = EDI_M.NRS_BR_CD                               " & vbNewLine _
                                          & " AND DTL_TRM.EDI_CTL_NO = EDI_M.EDI_CTL_NO                             " & vbNewLine _
                                          & " AND DTL_TRM.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU                     " & vbNewLine _
                                          & " AND DTL_TRM.JISSEKI_SHORI_FLG = '1'                                   " & vbNewLine _
                                          ...
                                          & " INNER JOIN $LM_MST$..M_GOODS_DETAILS  M_GOODS_DETAILS                 " & vbNewLine _
                                          & "--  ON  M_DEST_DEST.SYS_DEL_FLG = '0'                                  " & vbNewLine _
                                          & " ON OUT_M.NRS_BR_CD = M_GOODS_DETAILS.NRS_BR_CD                       " & vbNewLine _
                                          & " AND OUT_M.GOODS_CD_NRS = M_GOODS_DETAILS.GOODS_CD_NRS                 " & vbNewLine _
                                          & " AND M_GOODS_DETAILS.SUB_KB = '36'                                     " & vbNewLine _
                                          ...
                                          & "ORDER BY OUT_L.CUST_ORD_NO                                             " & vbNewLine _
                                          & "        ,DTL_TRM.DELIVERY_ID                                           " & vbNewLine _
                                          & "        ,DTL_TRM.DELIVERY_DETAIL_ID                                    " & vbNewLine
...
#Region "H_SENDOUTEDI_TRM"

    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_TRM）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_TRM As String = "INSERT INTO       " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_TRM       " & vbNewLine _
                                         & "(                                " & vbNewLine _
                                         & " DEL_KB                          " & vbNewLine _
                                         ...
                                         & ",CUST_CD_L                       " & vbNewLine _
                                         & ",CUST_CD_M                       " & vbNewLine _
                                         & ",OPERATING_UNIT_ALT_NAME         " & vbNewLine _
                                         & ",ORGANIZATION_CODE               " & vbNewLine _
                                         & ",SHIP_ACTUAL_NUM                 " & vbNewLine _
                                         & ",DELIVERY_ID                     " & vbNewLine _
                                         & ",DELIVERY_DETAIL_ID              " & vbNewLine _
                                         & ",DELIVERY_NUM                    " & vbNewLine _
                                         & ",ITEM_CODE                       " & vbNewLine _
                                         & ",LOT_NUM                         " & vbNewLine _
                                         & ",SERIAL_NUM                      " & vbNewLine _
                                         & ",SHIPPING_QTY                    " & vbNewLine _
                                         & ",NON_SHIPPABLE_QTY               " & vbNewLine _
                                         & ",ACTUAL_SHIPPED_DATE             " & vbNewLine _
                                         & ",SHIP_CTG                        " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_TRM"

    ''' <summary>
    ''' テルモEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_NIK）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_NOHINSYO_TRM SET    " & vbNewLine _
...
#Region "実績作成処理 同一まとめ番号データ取得用SQL"
    ...
    ''' 同一まとめ番号データ取得用SQL
    ''' </summary>
    ''' <remarks>テルモは現状まとめ処理はないが、切り替えた時の為に記載</remarks>
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNikMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC113.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectDataNikMdest", cmd)
...
#Region "出荷(大)データ(オーダー番号チェック用)テルモ専用"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>オーダー番号重複チェック(テルモは出荷予定日まで条件に入れる)</remarks>
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.SQL_SELECT_C_OUTKA_L_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectDataOrderCheckNik", cmd)
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>テルモEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectTerumoEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.SQL_SELECT_TRM_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC113.SQL_FROM_TRM_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectTerumoEdiSend", cmd)
        ...
        map.Add("ORGANIZATION_CODE", "ORGANIZATION_CODE")
        map.Add("SHIP_ACTUAL_NUM", "SHIP_ACTUAL_NUM")
        map.Add("DELIVERY_ID", "DELIVERY_ID")
        map.Add("DELIVERY_DETAIL_ID", "DELIVERY_DETAIL_ID")
        map.Add("DELIVERY_NUM", "DELIVERY_NUM")
        map.Add("ITEM_CODE", "ITEM_CODE")
        map.Add("LOT_NUM", "LOT_NUM")
        map.Add("SERIAL_NUM", "SERIAL_NUM")
        map.Add("SHIPPING_QTY", "SHIPPING_QTY")
        map.Add("NON_SHIPPABLE_QTY", "NON_SHIPPABLE_QTY")
        map.Add("ACTUAL_SHIPPED_DATE", "ACTUAL_SHIPPED_DATE")
        map.Add("SHIP_CTG", "SHIP_CTG")
        map.Add("RECORD_STATUS", "RECORD_STATUS")
        map.Add("JISSEKI_SHORI_FLG", "JISSEKI_SHORI_FLG")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_TRM")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_TRM").Rows.Count())
        reader.Close()
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectMatome", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC113.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC113.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC113.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC113.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC113.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC113.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC113.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC113.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC113.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC113.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    'テルモ　修正箇所START　仕掛中
#Region "M_DEST(テルモは自動更新を行う為、使用予定)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_TRM"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>テルモEDI実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertTerumoEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_TRM")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_H_SENDOUTEDI_TRM _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_TRM").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertTerumoEdiSendData", cmd)
...
#End Region
    ...
    'テルモ　修正箇所START　仕掛中
#Region "M_DEST(テルモは自動追加を行う為、使用予定)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC113.SQL_INSERT_M_DEST_NIK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "InsertMDestData", cmd)
...
#End Region
    ...
    'テルモ　修正箇所START　仕掛中
#Region "届先マスタ自動追加用パラメータ設定(テルモ専用)"
...
#End Region
    ...
    '2012.11.21 要望番号1513 追加START
#Region "出荷(大)パラメータ設定(オーダー番号チェック用)テルモ専用"
    ...
    Private Sub SetOutkaParameterNik(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_PLAN_DATE", Me.NullConvertString(dt.Rows(0).Item("OUTKA_PLAN_DATE")), DBDataType.NVARCHAR))
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(.Item("EDI_CTL_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_CHU", Me.NullConvertString(.Item("EDI_CTL_NO_CHU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_L", Me.NullConvertString(.Item("OUTKA_CTL_NO_L")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_M", Me.NullConvertString(.Item("OUTKA_CTL_NO_M")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(.Item("CUST_CD_L")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(.Item("CUST_CD_M")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OPERATING_UNIT_ALT_NAME", Me.NullConvertString(.Item("OPERATING_UNIT_ALT_NAME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ORGANIZATION_CODE", Me.NullConvertString(.Item("ORGANIZATION_CODE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHIP_ACTUAL_NUM", Me.NullConvertString(.Item("SHIP_ACTUAL_NUM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_ID", Me.NullConvertString(.Item("DELIVERY_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_DETAIL_ID", Me.NullConvertString(.Item("DELIVERY_DETAIL_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_NUM", Me.NullConvertString(.Item("DELIVERY_NUM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ITEM_CODE", Me.NullConvertString(.Item("ITEM_CODE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NUM", Me.NullConvertString(.Item("LOT_NUM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SERIAL_NUM", Me.NullConvertString(.Item("SERIAL_NUM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHIPPING_QTY", Me.NullConvertZero(.Item("SHIPPING_QTY")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NON_SHIPPABLE_QTY", Me.NullConvertZero(.Item("NON_SHIPPABLE_QTY")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@ACTUAL_SHIPPED_DATE", Me.NullConvertString(.Item("ACTUAL_SHIPPED_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SHIP_CTG", Me.NullConvertString(.Item("SHIP_CTG")), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC113.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC113", "SelectDataMdestOutkaToroku", cmd)
