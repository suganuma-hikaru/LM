...
#Region "M_SEHIN_TOR(東レダウ製品マスタ)"

    ''' <summary>
    ''' M_SEHIN_TOR(東レダウ製品マスタ)
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_SELECT_M_SEHIN_TOR As String = " SELECT                              " & vbNewLine _
                                 & " COUNT(*)                               AS MST_CNT     " & vbNewLine _
                                 & " FROM                                                  " & vbNewLine _
                                 & " $LM_TRN$..M_SEHIN_TOR                  M_SEHIN_TOR    " & vbNewLine _
                                 & " WHERE                                                 " & vbNewLine _
                                 & " M_SEHIN_TOR.NRS_BR_CD   = @NRS_BR_CD                  " & vbNewLine _
                                 & " AND                                                   " & vbNewLine _
                                 & " M_SEHIN_TOR.GOODS_CD_TOR  = @GOODS_CD_TOR             " & vbNewLine _
                                 & " AND                                                   " & vbNewLine _
                                 & " M_SEHIN_TOR.M_GOODS_UPD_FLG  = '00'                   " & vbNewLine
...
#Region "H_OUTKAEDI_DTL_TOR"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_TOR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_TOR SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_TOR"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_TOR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_TOR SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#Region "M_DEST INSERT(東レダウは自動追加を行う為使用予定)"

    ''' <summary>
    ''' 届先マスタINSERT文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_TOR As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#End Region
    ...
    '東レダウ　修正箇所START　仕掛中
#Region "M_DEST UPDATE(届先項目差異有りの場合)(東レダウは自動更新を行う為使用予定)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_TOR As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND_OUTKAS As String = " SELECT                                                " & vbNewLine _
            ...
            & "	 FROM													" & vbNewLine _
            & "	  (SELECT												" & vbNewLine _
            & "	     MIN(OUTKA_S.OUTKA_CTL_NO_M) AS OUTKA_CTL_NO_M 		" & vbNewLine _
            & "	    ,OUTKA_S.LOT_NO 									" & vbNewLine _
            & "	    ,SUM(OUTKA_S.ALCTD_NB) AS SUM_NB					" & vbNewLine _
            & "	   FROM H_OUTKAEDI_HED_TOR  HED							" & vbNewLine _
            & "	   INNER JOIN H_OUTKAEDI_DTL_TOR  DTL					" & vbNewLine _
            ...
            & "	   INNER JOIN H_OUTKAEDI_M EDI_M						" & vbNewLine _
            ...
            & "	   INNER JOIN C_OUTKA_S OUTKA_S							" & vbNewLine _
            & "	    ON   OUTKA_S.DEL_KB = '0'							" & vbNewLine _
            & "	    AND  OUTKA_S.NRS_BR_CD = @NRS_BR_CD					" & vbNewLine _
            & "	    AND  OUTKA_S.OUTKA_CTL_NO = HED.OUTKA_CTL_NO		" & vbNewLine _
            & "	    AND  OUTKA_S.OUTKA_CTL_NO_M = DTL.OUTKA_CTL_NO_CHU	" & vbNewLine _
...
#Region "H_SENDOUTEDI_TOR SELECT句"
    ...
    Private Const SQL_SELECT_SEND As String = "SELECT                                               " & vbNewLine _
                            ...
                            & ",HED.EIGYO_STORIZU		AS EIGYO_STORIZU                    " & vbNewLine _
                            ...
                            & " FROM $LM_TRN$..H_OUTKAEDI_HED_TOR  HED                      " & vbNewLine _
                            ...
                            & " AND                                                         " & vbNewLine _
                            & " OUTKA_L.OUTKA_NO_L = HED.OUTKA_CTL_NO_L                     " & vbNewLine _
                            & " INNER JOIN  $LM_TRN$..H_OUTKAEDI_DTL_TOR DTL                " & vbNewLine _
                            & " ON                                                          " & vbNewLine _
...
#Region "H_SENDOUTEDI_TOR FROM句"
    Private Const SQL_SELECT_TOR_SEND_DATA As String = "SELECT                              " & vbNewLine

    Private Const SQL_FROM_TOR_SEND_DATA As String = "FROM                                  " & vbNewLine
...
#Region "H_SENDOUTEDI_TOR"

    ''' <summary>
    ''' 実績TBLのINSERT（H_SENDOUTEDI_TOR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_TOR As String = "INSERT INTO      " & vbNewLine _
                                        & "$LM_TRN$..H_SENDOUTEDI_TOR       " & vbNewLine _
                                        & "(                                " & vbNewLine _
                                        & "   DEL_KB                       	" & vbNewLine _
                                        & "   NRS_BR_CD                         " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_TOR"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_TOR SET   " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_TOR"
    ...
    ''' <summary>
    ''' 東レダウEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_TOR）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_TOR SET       " & vbNewLine _
...
#Region "実績作成処理 同一まとめ番号データ取得用SQL"
    ...
    ''' 同一まとめ番号データ取得用SQL
    ''' </summary>
    ''' <remarks>東レダウは現状まとめ処理はないが、切り替えた時の為に記載</remarks>
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataTORMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC106.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectDataTORMdest", cmd)
...
#Region "M_GOODS"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataSeihinTOR(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_M_SEHIN_TOR)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetSeihinTORParameter(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectDataSeihinTOR", cmd)
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>東レダウEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectTOREdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_TOR_SEND_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC106.SQL_FROM_TOR_SEND_DATA)        'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectTOREdiSend", cmd)
        ...
        map.Add("GOODS_CD_TOR", "GOODS_CD_TOR")
        ...
        map.Add("REMARK", "REMARK")
        map.Add("TOR_OUTKA_KB", "TOR_OUTKA_KB")
        map.Add("RECORD_STATUS", "RECORD_STATUS")
        map.Add("JISSEKI_SHORI_FLG", "JISSEKI_SHORI_FLG")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_TOR")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_TOR").Rows.Count())
        reader.Close()
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSendFromOutkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_SEND_OUTKAS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectSendFromOutkaS", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_TOR_JISSEKI_OUTKAS")
        reader.Close()
    ...
    Private Function SelectSendFromRcv(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectSendFromRcv", cmd)
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectMatome", cmd)
...
#Region "商品マスタ(出荷データの場合)"
    ...
    Private Function SelectDataMgoodsOutka(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_M_GOODS)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC106.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectDataMgoods", cmd)
    ...
    Private Function SelectDataMgoodsIrimeOutka(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectDataMgoodsIrime", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC106.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC106.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC106.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC106.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC106.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC106.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC106.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC106.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC106.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC106.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC106.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC106.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '東レダウ　修正箇所START　仕掛中
#Region "M_DEST(東レダウは自動更新を行う為、使用予定)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_TOR"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>東レダウEDI実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertTOREdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_TOR")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_H_SENDOUTEDI_TOR _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_TOR").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertTOREdiSendData", cmd)
...
#End Region
    ...
    '東レダウ　修正箇所START　仕掛中
#Region "M_DEST(東レダウは自動追加を行う為、使用予定)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC106.SQL_INSERT_M_DEST_TOR, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "InsertMDestData", cmd)
...
#Region "東レダウ製品マスタパラメータ設定"

    ''' <summary>
    ''' M_SEHIN_TOR
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSeihinTORParameter(ByVal dt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_TOR", String.Concat("376", dt.Rows(0).Item("CUST_GOODS_CD").ToString()), DBDataType.NVARCHAR))
...
#End Region
    ...
    '東レダウ　修正箇所START　
#Region "届先マスタ自動追加用パラメータ設定(東レダウ専用)"
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC106.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC106", "SelectDataMdestOutkaToroku", cmd)
