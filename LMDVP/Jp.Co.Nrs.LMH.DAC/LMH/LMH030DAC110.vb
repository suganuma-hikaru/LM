...
#Region "H_OUTKAEDI_DTL_XXX(INSERT)"
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO      " & vbNewLine _
                                        ...
                                        & ",PRTFLG	                    " & vbNewLine _
                                        & "--,CANCEL_FLG	                " & vbNewLine _
                                        & ",DELIVERY_NO		" & vbNewLine _
                                        & ",S_ORDER_NO		" & vbNewLine _
                                        & ",CUST_PO			" & vbNewLine _
                                        & ",MAKER_CD		" & vbNewLine _
                                        & ",ITEM_CD			" & vbNewLine _
                                        & ",PRODUCT_NM		" & vbNewLine _
                                        & ",QTY				" & vbNewLine _
                                        & ",LOT_NO			" & vbNewLine _
                                        & ",OUTKA_PLAN_DATE	" & vbNewLine _
                                        & ",ARR_DATE		" & vbNewLine _
                                        & ",SAP_DEST_CD		" & vbNewLine _
                                        & ",DEST_NM			" & vbNewLine _
                                        & ",REIZO			" & vbNewLine _
                                        & ",REMARK			" & vbNewLine _
                                        & ",URIAGESAKI_CD	" & vbNewLine _
                                        & ",URIAGESAKI_NM	" & vbNewLine _
                                        & ",UNSO_ONDO_KB	" & vbNewLine _
                                        & ",MATOME_REIZO	" & vbNewLine _
                                        & ",SET_GROUP_NO	" & vbNewLine _
                                        & ",SET_FLG			" & vbNewLine _
                                        & ",SET_ONDO_KB		" & vbNewLine _
                                        & ",SET_OYA_CD		" & vbNewLine _
                                        & ",GOODS_DOKU_KB	" & vbNewLine _
                                        & ",GOODS_ONDO_KB	" & vbNewLine _
                                        & ",GOODS_ONDO_MX	" & vbNewLine _
                                        & ",MATOME_ONDO		" & vbNewLine _
                                        & ",EDI_DATA_FLG	" & vbNewLine _
                                        & ",RECORD_STATUS	            " & vbNewLine _
                                        & ",JISSEKI_SHORI_FLG	        " & vbNewLine _
                                        & ",JISSEKI_USER	            " & vbNewLine _
                                        & ",JISSEKI_DATE	            " & vbNewLine _
...
#Region "H_OUTKAEDI_L_PRT_LNZ(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_L_PRT_LNZ）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_OUTKAEDI_L_PRT_LNZ As String = "INSERT INTO          " & vbNewLine _
...
#Region "H_OUTKAEDI_M_PRT_LNZ(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_M_PRT_LNZ）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_OUTKAEDI_M_PRT_LNZ As String = "INSERT INTO          " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_XXX(EDI_CTL_NO更新)"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_XXX）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKAEDI_DTL As String _
                        = " UPDATE $LM_TRN$..$RCV_DTL$ SET              " & vbNewLine _
...
#Region "SELECT_M_SET_GOODS_LNZ(セミEDI時)"
    Private Const SQL_SELECT_M_SET_GOODS_LNZ As String _
                    = " SELECT                                          " & vbNewLine _
                    & " SETLNZ.NRS_BR_CD            AS  NRS_BR_CD       " & vbNewLine _
                    & ",SETLNZ.OYA_CD               AS  OYA_CD          " & vbNewLine _
                    & ",SETLNZ.OYA_NM               AS  OYA_NM          " & vbNewLine _
                    & ",SETLNZ.KO_CD                AS  KO_CD           " & vbNewLine _
                    & ",SETLNZ.SAP_CODE             AS  SAP_CODE        " & vbNewLine _
                    & ",SETLNZ.SET_KOSU             AS  SET_KOSU        " & vbNewLine _
                    & ",MIN(GOODS.UNSO_ONDO_KB)     AS  UNSO_ONDO_KB    " & vbNewLine _
                    & " FROM                                            " & vbNewLine _
                    & " $LM_TRN$..M_SET_GOODS_LNZ   SETLNZ              " & vbNewLine _
                    & "   LEFT JOIN                                     " & vbNewLine _
                    & "   $LM_MST$..M_GOODS     GOODS ON                " & vbNewLine _
                    & "   GOODS.NRS_BR_CD     = SETLNZ.NRS_BR_CD        " & vbNewLine _
                    & "   AND                                           " & vbNewLine _
                    & "   GOODS.CUST_CD_L     = @CUST_CD_L              " & vbNewLine _
                    & "   AND                                           " & vbNewLine _
                    & "   GOODS.CUST_CD_M     = @CUST_CD_M              " & vbNewLine _
                    & "   AND                                           " & vbNewLine _
                    & "   GOODS.GOODS_CD_CUST = SETLNZ.KO_CD            " & vbNewLine _
                    & "   AND                                           " & vbNewLine _
                    & "   GOODS.SYS_DEL_FLG   = '0'                     " & vbNewLine _
                    & " WHERE                                           " & vbNewLine _
                    & " SETLNZ.NRS_BR_CD   = @NRS_BR_CD                 " & vbNewLine _
                    & " AND                                             " & vbNewLine _
                    & " SETLNZ.OYA_CD      = @OYA_CD                    " & vbNewLine _
                    & " AND                                             " & vbNewLine _
                    & " SETLNZ.SYS_DEL_FLG = '0'                        " & vbNewLine _
                    & " GROUP BY                                        " & vbNewLine _
                    & " SETLNZ.NRS_BR_CD                                " & vbNewLine _
                    & ",SETLNZ.OYA_CD                                   " & vbNewLine _
                    & ",SETLNZ.OYA_NM                                   " & vbNewLine _
                    & ",SETLNZ.KO_CD                                    " & vbNewLine _
                    & ",SETLNZ.SAP_CODE                                 " & vbNewLine _
                    & ",SETLNZ.SET_KOSU                                 " & vbNewLine
...
#Region "SQL_SELECT_SelectEdiDtlForOutokaEdi まとめ抽出用"
    ''' <summary>
    ''' SQL_SELECT_SelectEdiDtlForOutokaEdi まとめ抽出用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_SelectEdiDtlForOutokaEdi As String = _
                  " SELECT                                                  " & vbNewLine _
                & "  H_OUTKAEDI_DTL.CRT_DATE			AS	CRT_DATE	    " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.FILE_NAME           AS  FILE_NAME       " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.REC_NO              AS  REC_NO         	" & vbNewLine _
                & " ,H_OUTKAEDI_DTL.NRS_BR_CD           AS  NRS_BR_CD       " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.DELIVERY_NO         AS  DELIVERY_NO     " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.S_ORDER_NO          AS  S_ORDER_NO      " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.CUST_PO             AS  CUST_PO         " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.MAKER_CD            AS  MAKER_CD        " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.ITEM_CD             AS  ITEM_CD         " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.PRODUCT_NM          AS  PRODUCT_NM      " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.QTY                 AS  QTY         	" & vbNewLine _
                & " ,H_OUTKAEDI_DTL.LOT_NO              AS  LOT_NO         	" & vbNewLine _
                & " ,H_OUTKAEDI_DTL.OUTKA_PLAN_DATE     AS  OUTKA_PLAN_DATE " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.ARR_DATE            AS  ARR_DATE        " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.SAP_DEST_CD         AS  SAP_DEST_CD     " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.DEST_NM             AS  DEST_NM         " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.REIZO               AS  REIZO         	" & vbNewLine _
                & " ,H_OUTKAEDI_DTL.REMARK              AS  REMARK         	" & vbNewLine _
                & " ,H_OUTKAEDI_DTL.URIAGESAKI_CD       AS  URIAGESAKI_CD   " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.URIAGESAKI_NM       AS  URIAGESAKI_NM   " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.UNSO_ONDO_KB        AS  UNSO_ONDO_KB    " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.MATOME_REIZO        AS  MATOME_REIZO    " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.SET_GROUP_NO        AS  SET_GROUP_NO    " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.SET_FLG             AS  SET_FLG         " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.SET_ONDO_KB         AS  SET_ONDO_KB     " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.SET_OYA_CD          AS  SET_OYA_CD      " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.GOODS_DOKU_KB       AS  GOODS_DOKU_KB   " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.GOODS_ONDO_KB       AS  GOODS_ONDO_KB   " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.GOODS_ONDO_MX       AS  GOODS_ONDO_MX   " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.MATOME_ONDO         AS  MATOME_ONDO     " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.EDI_DATA_FLG        AS  EDI_DATA_FLG    " & vbNewLine _
                & " FROM                                                    " & vbNewLine _
                & " $LM_TRN$..$RCV_DTL$                 H_OUTKAEDI_DTL      " & vbNewLine _
                & " WHERE H_OUTKAEDI_DTL.DEL_KB         = '0'               " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.SET_FLG        = '0'               " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.NRS_BR_CD      = @NRS_BR_CD        " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.CRT_DATE       = @CRT_DATE         " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.FILE_NAME      = @FILE_NAME        " & vbNewLine _
                & " ORDER BY                                " & vbNewLine _
                & "  SAP_DEST_CD		ASC					" & vbNewLine _
                & " ,OUTKA_PLAN_DATE	ASC                 " & vbNewLine _
                & " ,ARR_DATE			ASC                 " & vbNewLine _
                & " ,GOODS_DOKU_KB		ASC                 " & vbNewLine _
                & " ,MATOME_ONDO		ASC                 " & vbNewLine _
                & " ,REC_NO				ASC                 " & vbNewLine

#End Region

#Region "SQL_SELECT_SelectEdiDtlForOutokaEdiPrt まとめ抽出用（印刷）"
    ''' <summary>
    ''' SQL_SELECT_SelectEdiDtlForOutokaEdiPrt まとめ抽出用（印刷）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_SelectEdiDtlForOutokaEdiPrt As String = _
                  " SELECT                                                  " & vbNewLine _
                & "  H_OUTKAEDI_DTL.CRT_DATE			AS	CRT_DATE	    " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.FILE_NAME           AS  FILE_NAME       " & vbNewLine _
                & " ,H_OUTKAEDI_DTL.REC_NO              AS  REC_NO         	" & vbNewLine _
                ...
                & " AND   H_OUTKAEDI_DTL.FILE_NAME      = @FILE_NAME        " & vbNewLine _
                & " ORDER BY                                " & vbNewLine _
                & "  DELIVERY_NO		ASC					" & vbNewLine _
                & " ,SAP_DEST_CD	    ASC                 " & vbNewLine _
                & " ,SET_GROUP_NO		ASC                 " & vbNewLine _
                & " ,REC_NO				ASC                 " & vbNewLine

#End Region

#Region "SQL_SELECT_SelectEdiDtlForOutokaEdiPrt_EdiCtlNo まとめ抽出用（印刷）"
    ''' <summary>
    ''' SQL_SELECT_SelectEdiDtlForOutokaEdiPrt_EdiCtlNo まとめ抽出用（印刷）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_SELECT_SelectEdiDtlForOutokaEdiPrt_EdiCtlNo As String = _
                  " SELECT                                                  " & vbNewLine _
                & "  TOP 1                                                  " & vbNewLine _
                & "  H_OUTKAEDI_DTL.EDI_CTL_NO          AS  EDI_CTL_NO      " & vbNewLine _
                & " FROM                                                    " & vbNewLine _
                ...
                & " AND   H_OUTKAEDI_DTL.CRT_DATE       = @CRT_DATE         " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.FILE_NAME      = @FILE_NAME        " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.DELIVERY_NO    = @DELIVERY_NO      " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.SAP_DEST_CD    = @SAP_DEST_CD      " & vbNewLine _
                & " ORDER BY                                " & vbNewLine _
                & "  EDI_CTL_NO		    ASC					" & vbNewLine
...
#Region "SQL_GET_EDI_M_COUNT"
    Private Const SQL_GET_EDI_M_COUNT As String = " SELECT                             " & vbNewLine _
                                     & " COUNT(*)                                       " & vbNewLine _
                                     & " FROM                                           " & vbNewLine _
                                     & "    $LM_TRN$..H_OUTKAEDI_M                      " & vbNewLine _
                                     & " WHERE                                          " & vbNewLine _
                                     & "    NRS_BR_CD   = @NRS_BR_CD                    " & vbNewLine _
                                     & " AND                                            " & vbNewLine _
                                     & "    FREE_C05    = @OUTKA_NO                     " & vbNewLine _
                                     & " AND                                            " & vbNewLine _
                                     & "    FREE_C06    = @OUTKA_NO_GYO                 " & vbNewLine _
                                     & " AND                                            " & vbNewLine _
                                     & "    SYS_DEL_FLG = '0'                           " & vbNewLine
...
#Region "SELECT_M_GOODS_DETAILS"
    ...
    Private Const SQL_SELECT_M_GOODS_DETAILS_LONZA As String = " SELECT                   " & vbNewLine _
                                     & " M_GOODS_DETAILS.NRS_BR_CD                  AS NRS_BR_CD          " & vbNewLine _
                                     & ",M_GOODS_DETAILS.GOODS_CD_NRS               AS GOODS_CD_NRS       " & vbNewLine _
                                     & ",M_GOODS_DETAILS.GOODS_CD_NRS_EDA           AS GOODS_CD_NRS_EDA   " & vbNewLine _
                                     & ",M_GOODS_DETAILS.SUB_KB                     AS SUB_KB             " & vbNewLine _
                                     & ",M_GOODS_DETAILS.SET_NAIYO                  AS SET_NAIYO          " & vbNewLine _
                                     & ",M_GOODS_DETAILS.REMARK                     AS REMARK             " & vbNewLine _
                                     & " FROM                                             " & vbNewLine _
                                     & " $LM_MST$..M_GOODS_DETAILS  M_GOODS_DETAILS       " & vbNewLine _
                                     & " INNER JOIN                                       " & vbNewLine _
                                     & " $LM_MST$..M_SAGYO  M_SAGYO                       " & vbNewLine _
                                     & " ON                                               " & vbNewLine _
                                     & " M_GOODS_DETAILS.NRS_BR_CD   = M_SAGYO.NRS_BR_CD  " & vbNewLine _
                                     & " AND                                              " & vbNewLine _
                                     & " M_GOODS_DETAILS.SET_NAIYO   = M_SAGYO.SAGYO_CD   " & vbNewLine _
                                     & " WHERE                                            " & vbNewLine _
                                     & " M_GOODS_DETAILS.NRS_BR_CD   = @NRS_BR_CD         " & vbNewLine _
                                     & " AND                                              " & vbNewLine _
                                     & " M_GOODS_DETAILS.GOODS_CD_NRS   = @GOODS_CD_NRS   " & vbNewLine _
                                     & " AND                                              " & vbNewLine _
                                     & " M_GOODS_DETAILS.SUB_KB   = '37'                  " & vbNewLine

#End Region

    '2013.03.29ロンザ　タカラ対応 追加START
#Region "SELECT_M_DEST_DETAILS"

    Private Const SQL_SELECT_M_DEST_DETAILS_LONZA As String = " SELECT                    " & vbNewLine _
                                     & " COUNT(*)                  AS MST_CNT             " & vbNewLine _
                                     & " FROM                                             " & vbNewLine _
                                     & " $LM_MST$..M_DEST_DETAILS  M_DEST_DETAILS         " & vbNewLine _
                                     & " WHERE                                            " & vbNewLine _
                                     & " M_DEST_DETAILS.NRS_BR_CD   = @NRS_BR_CD          " & vbNewLine _
                                     & " AND                                              " & vbNewLine _
                                     & " M_DEST_DETAILS.CUST_CD_L   = @CUST_CD_L          " & vbNewLine _
                                     & " AND                                              " & vbNewLine _
                                     & " M_DEST_DETAILS.SUB_KB   = '03'                   " & vbNewLine

#End Region
    '2013.03.29ロンザ　タカラ対応 追加END

#Region "SQL_SELECT_LONZA_SAGYO_Z_KBN(VALUE1:荷姿)"
    Private Const SQL_SELECT_LONZA_SAGYO_Z_KBN As String = " SELECT                                 " & vbNewLine _
                                     & " KBN_NM3                                 AS NISUGATA   " & vbNewLine _
                                     & " FROM                                                  " & vbNewLine _
                                     & " $LM_MST$..Z_KBN                        Z_KBN          " & vbNewLine _
                                     & " WHERE                                                 " & vbNewLine _
                                     & " Z_KBN.KBN_GROUP_CD = 'L004'                           " & vbNewLine _
                                     & " AND Z_KBN.KBN_NM1   = @NRS_BR_CD                      " & vbNewLine _
                                     & " AND Z_KBN.KBN_NM2   = @CUST_CD_L                      " & vbNewLine

#End Region

#Region "SELECT_M_SAGYO"

    Private Const SQL_SELECT_M_SAGYO As String = " SELECT                          " & vbNewLine _
                                                & "    NRS_BR_CD                    " & vbNewLine _
...
#Region "オーダー番号重複チェック(ロンザ専用)"
    Private Const SQL_SELECT_C_OUTKA_L_LNZ As String = " SELECT                                  " & vbNewLine _
                                     ...
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_L.SYS_ENT_DATE <> @SYS_ENT_DATE                  " & vbNewLine _
                                     & " AND                                                      " & vbNewLine _
                                     & " C_OUTKA_L.SYS_ENT_TIME <> @SYS_ENT_TIME                  " & vbNewLine
...
#Region "H_OUTKAEDI_DTL_LNZ"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_LNZ）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_LNZ SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_LNZ"
    'ロンザは受信HEDを持っていないため更新しない
    '''' <summary>
    '''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_LNZ）
    '''' </summary>
    '''' <remarks></remarks>
    'Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_LNZ SET       " & vbNewLine _
    '                                          & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#End Region
    ...
    '#Region "M_DEST INSERT(ロンザは自動追加がない為使用しない)"
    ...
    '#Region "M_DEST UPDATE(届先項目差異有りの場合)(ロンザは自動更新がない為使用しない)"
    '    ''' <summary>
    '    ''' 届先マスタUPDATE文（M_DEST）
    '    ''' </summary>
    '    ''' <remarks></remarks>
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC110.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectDataNcgoMdest", cmd)
...
#Region "出荷(大,中)データ(オーダー番号チェック用)：ロンザ専用"
    ...
    Private Function SelectOrderCheckDataLNZ(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_C_OUTKA_L_LNZ)
        ...
        'パラメータ設定
        Call Me.SetOutkaParameterLLNZ(dt)
        'Call Me.SetOutkaParameterMLNZ(dtM)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectOrderCheckDataLNZ", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC110.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC110.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    '        '出荷登録、紐付けSQL CONST名
    '        Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
    '            setSql = LMH030DAC110.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

    '            '実績作成SQL CONST名
    '        Case LMH030DAC.EventShubetsu.CREATEJISSEKI
    '            setSql = LMH030DAC110.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC110.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '    '実績作成SQL CONST名
                'Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                '    setSql = LMH030DAC110.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC110.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC110.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC110.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateMatomesakiUnsoLData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ロンザは自動更新がないため使用しない)"
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertUnchinData", cmd)
...
#End Region
    ...
    '#Region "M_DEST(ロンザは自動追加がない為、使用しない)"
    ...
    '        'SQL文のコンパイル
    '        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertMDestData", cmd)
...
#Region "出荷パラメータ設定(オーダー番号チェック用) ロンザ専用"

    ''' <summary>
    ''' C_OUTKA_L
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameterLLNZ(ByVal dt As DataTable)
    ...
    '''' </summary>
    '''' <remarks></remarks>
    'Private Sub SetOutkaParameterMLNZ(ByVal dt As DataTable)
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectDataMdestOutkaToroku", cmd)
...
#Region "商品明細マスタ(作業項目マスタ)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectMgoodsSagyoCd(ByVal ds As DataSet) As DataSet

        Dim drEdiM As DataRow = ds.Tables("LMH030_OUTKAEDI_M").Rows(0)

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_GOODS_DETAILS_LONZA)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SelectMgoodsSagyoCdParameter(drEdiM)

        'スキーマ設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), drEdiM.Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectMgoodsSagyoCd", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            Call Me.SetGoodsDetailsMap(reader, map)

            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_M_GOODS_DETAILS")

            '処理件数の設定
            goodsCnt = ds.Tables("LMH030_M_GOODS_DETAILS").Rows.Count
...
#Region "届先明細マスタ"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectMdestDetailsNotSubject(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_DEST_DETAILS_LONZA)

        If dt.Rows(0)("DEST_CD").ToString() = String.Empty Then
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("AND M_DEST_DETAILS.DEST_CD = @EDI_DEST_CD")
        Else
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("AND M_DEST_DETAILS.DEST_CD = @DEST_CD")
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectMdestDetailsNotSubject", cmd)
...
#Region "作業項目マスタ"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectMSagyo(ByVal ds As DataSet) As DataSet

        Dim drSagyo As DataRow = ds.Tables("LMH030_M_SAGYO_IN").Rows(0)

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_SAGYO)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SelectMSagyoParameter(drSagyo)

        'スキーマ設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), drSagyo.Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectMSagyo", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            Call Me.SetSagyoMap(reader, map)

            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_M_SAGYO")

            '処理件数の設定
            sagyoCnt = ds.Tables("LMH030_M_SAGYO").Rows.Count

        End If

        reader.Close()

        MyBase.SetResultCount(sagyoCnt)
        Return ds
...
#Region "区分マスタ(ロンザ作業)"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_LONZA_SAGYO_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC", "SelectLONZASagyo", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        '取消データは受信DTLから取得する
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_LNZ")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectOutkaEdiRcvCancel", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_LNZ_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_LNZ_CANCELOUT").Rows.Count())
        reader.Close()
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>書き込んだ受信DTLデータをまとめ用にSELECTする</remarks>
    Private Function SelectEdiDtlForOutokaEdi(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_SelectEdiDtlForOutokaEdi)         'SQL構築

        '条件設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(Me._Row.Item("NRS_BR_CD").ToString()), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CRT_DATE", Me.NullConvertString(Me._Row.Item("CRT_DATE").ToString()), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FILE_NAME", Me.NullConvertString(Me._Row.Item("FILE_NAME").ToString()), DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectEdiDtlForOutokaEdi", cmd)
        ...
        map.Add("S_ORDER_NO", "S_ORDER_NO")
        map.Add("CUST_PO", "CUST_PO")
        map.Add("MAKER_CD", "MAKER_CD")
        map.Add("ITEM_CD", "ITEM_CD")
        map.Add("PRODUCT_NM", "PRODUCT_NM")
        map.Add("QTY", "QTY")
        map.Add("LOT_NO", "LOT_NO")
        map.Add("OUTKA_PLAN_DATE", "OUTKA_PLAN_DATE")
        map.Add("ARR_DATE", "ARR_DATE")
        map.Add("SAP_DEST_CD", "SAP_DEST_CD")
        map.Add("DEST_NM", "DEST_NM")
        map.Add("REIZO", "REIZO")
        map.Add("REMARK", "REMARK")
        map.Add("URIAGESAKI_CD", "URIAGESAKI_CD")
        map.Add("URIAGESAKI_NM", "URIAGESAKI_NM")
        map.Add("UNSO_ONDO_KB", "UNSO_ONDO_KB")
        map.Add("MATOME_REIZO", "MATOME_REIZO")
        map.Add("SET_GROUP_NO", "SET_GROUP_NO")
        map.Add("SET_FLG", "SET_FLG")
        map.Add("SET_ONDO_KB", "SET_ONDO_KB")
        map.Add("SET_OYA_CD", "SET_OYA_CD")
        map.Add("GOODS_DOKU_KB", "GOODS_DOKU_KB")
        map.Add("GOODS_ONDO_KB", "GOODS_ONDO_KB")
        map.Add("GOODS_ONDO_MX", "GOODS_ONDO_MX")
        map.Add("MATOME_ONDO", "MATOME_ONDO")
        map.Add("EDI_DATA_FLG", "EDI_DATA_FLG")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_OUTKAEDI_DTL_LNZ")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_OUTKAEDI_DTL_LNZ").Rows.Count())
        reader.Close()
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>書き込んだ受信DTLデータをまとめ用にSELECTする（印刷用）</remarks>
    Private Function SelectEdiDtlForOutokaEdiPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_SelectEdiDtlForOutokaEdiPrt)         'SQL構築
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>書き込んだ受信DTLデータからデリバリーNo. + SAP納入先ｺｰﾄﾞで一番小さいEDI_CTL_NOを取得する（印刷用）</remarks>
    Public Function SelectEdiDtlForOutokaEdiPrt_EdiCtlNo(ByVal ds As DataSet) As String
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_SelectEdiDtlForOutokaEdiPrt_EdiCtlNo)         'SQL構築
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DELIVERY_NO", Me.NullConvertString(Me._Row.Item("DELIVERY_NO").ToString()), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SAP_DEST_CD", Me.NullConvertString(Me._Row.Item("SAP_DEST_CD").ToString()), DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SQL_SELECT_SelectEdiDtlForOutokaEdiPrt_EdiCtlNo", cmd)
        ...
        If reader.HasRows Then
            sEdiCtlNo = reader("EDI_CTL_NO").ToString
        End If
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_LNZ")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC110.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC110.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectDataMgoods", cmd)
...
#Region "届先マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_DEST1)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC110.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectDataMDEST", cmd)
...
#Region "ロンザセット商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectMstSetGoodsLnz(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_SELECT_M_SET_GOODS_LNZ)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dtRcvDtl.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", drSemiEdiInfo.Item("CUST_CD_L"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", drSemiEdiInfo.Item("CUST_CD_M"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OYA_CD", Me.NullConvertString(dtRcvDtl.Rows(0).Item("MAKER_CD")), DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "SelectMstSetGoodsLnz", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            map.Add("KO_CD", "KO_CD")
            map.Add("SAP_CODE", "SAP_CODE")
            map.Add("SET_KOSU", "SET_KOSU")
            map.Add("UNSO_ONDO_KB", "UNSO_ONDO_KB")

            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_SET_GOODS_LNZ")

            '処理件数の設定
            iGoodsCnt = ds.Tables("LMH030_SET_GOODS_LNZ").Rows.Count

        End If
        reader.Close()

        MyBase.SetResultCount(iGoodsCnt)
        Return ds
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_DTL_LNZ_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC110.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC110.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_HED(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvHed(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHedCancel As DataTable = ds.Tables("LMH030_DTL_LNZ_CANCELOUT")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC110.SQL_UPDATE_DEL_OUTKAEDI_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateDelOutkaRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_LNZ_CANCELOUT")   'DTLの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC110.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：EDI_CTL_NO更新)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateOutkaRcvDtl(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dtDtlTbl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_LNZ")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'セミEDI(画面取込)SQL CONST名
        sSql = LMH030DAC110.SQL_UPDATE_OUTKAEDI_DTL
        ...
        '条件rowの格納
        Me._Row = dtDtlTbl.Rows(0)

        'パラメータ設定
        'Set内容
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(Me._Row.Item("EDI_CTL_NO")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_CHU", Me.NullConvertString(Me._Row.Item("EDI_CTL_NO_CHU")), DBDataType.CHAR))

        'Update条件
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(Me._Row.Item("NRS_BR_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CRT_DATE", Me.NullConvertString(Me._Row.Item("CRT_DATE")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@FILE_NAME", Me.NullConvertString(Me._Row.Item("FILE_NAME")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REC_NO", Me.NullConvertString(Me._Row.Item("REC_NO")), DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "UpdateOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L_PRT_LNZ(セミEDI)"

    ''' <summary>
    ''' EDI出荷(大)_PRT_LNZテーブル新規登録(セミEDI)
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(大)_PRT_LNZテーブル新規登録SQLの構築・発行</remarks>
    Private Function InsertOutkaEdiL_PRT_LNZ(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKAEDI_L_PRT_LNZ, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaEdiL_PRT_LNZ", cmd)
...
#Region "H_OUTKAEDI_M_PRT_LNZ(セミEDI)"

    ''' <summary>
    ''' EDI出荷(中)_PRT_LNZテーブル新規登録
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(中)_PRT_LNZテーブル更新SQLの構築・発行</remarks>
    Private Function InsertOutkaEdiM_PRT_LNZ(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKAEDI_M_PRT_LNZ _
                                                                       , setDs.Tables("LMH030_OUTKAEDI_M").Rows(0).Item("NRS_BR_CD").ToString()))
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaEdiM_PRT_LNZ", cmd)
...
#Region "H_OUTKAEDI_HED_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvHed(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvHed As DataTable = setDs.Tables("LMH030_OUTKAEDI_HED_LNZ")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKAEDI_HED, setDs.Tables("LMH030_OUTKAEDI_HED_LNZ").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaEdiRcvHed", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_LNZ")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC110.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_OUTKAEDI_DTL_LNZ").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC110", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(HED)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvHedParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@HAKKO_KB_NM", Me.NullConvertString(.Item("HAKKO_KB_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUT_KB_NM", Me.NullConvertString(.Item("OUT_KB_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@JIGYO_CD", Me.NullConvertString(.Item("JIGYO_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@JIGYO_NM", Me.NullConvertString(.Item("JIGYO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOUKO_CD", Me.NullConvertString(.Item("SOUKO_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOUKO_NM", Me.NullConvertString(.Item("SOUKO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_BI", Me.NullConvertString(.Item("OUTKA_BI")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_ZIP", Me.NullConvertString(.Item("NONYU_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_CD", Me.NullConvertString(.Item("NONYU_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_NM", Me.NullConvertString(.Item("NONYU_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_AD_1", Me.NullConvertString(.Item("NONYU_AD_1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_AD_2", Me.NullConvertString(.Item("NONYU_AD_2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYU_TEL", Me.NullConvertString(.Item("NONYU_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIKESHI_KB_NM", Me.NullConvertString(.Item("TORIKESHI_KB_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENP_NO", Me.NullConvertString(.Item("DENP_NO")), DBDataType.NVARCHAR))
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_NO", Me.NullConvertString(.Item("DELIVERY_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S_ORDER_NO", Me.NullConvertString(.Item("S_ORDER_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_PO", Me.NullConvertString(.Item("CUST_PO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MAKER_CD", Me.NullConvertString(.Item("MAKER_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ITEM_CD", Me.NullConvertString(.Item("ITEM_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PRODUCT_NM", Me.NullConvertString(.Item("PRODUCT_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@QTY", Me.NullConvertString(.Item("QTY")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@ARR_DATE", Me.NullConvertString(.Item("ARR_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAP_DEST_CD", Me.NullConvertString(.Item("SAP_DEST_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_NM", Me.NullConvertString(.Item("DEST_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REIZO", Me.NullConvertString(.Item("REIZO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REMARK", Me.NullConvertString(.Item("REMARK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@URIAGESAKI_CD", Me.NullConvertString(.Item("URIAGESAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@URIAGESAKI_NM", Me.NullConvertString(.Item("URIAGESAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSO_ONDO_KB", Me.NullConvertString(.Item("UNSO_ONDO_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MATOME_REIZO", Me.NullConvertString(.Item("MATOME_REIZO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SET_GROUP_NO", Me.NullConvertString(.Item("SET_GROUP_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SET_FLG", Me.NullConvertString(.Item("SET_FLG")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SET_ONDO_KB", Me.NullConvertString(.Item("SET_ONDO_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SET_OYA_CD", Me.NullConvertString(.Item("SET_OYA_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_DOKU_KB", Me.NullConvertString(.Item("GOODS_DOKU_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_ONDO_KB", Me.NullConvertString(.Item("GOODS_ONDO_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_ONDO_MX", Me.NullConvertString(.Item("GOODS_ONDO_MX")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@MATOME_ONDO", Me.NullConvertString(.Item("MATOME_ONDO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EDI_DATA_FLG", Me.NullConvertString(.Item("EDI_DATA_FLG")), DBDataType.NVARCHAR))
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectMstGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dtRcvDtl.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(dtRcvDtl.Rows(0).Item("MAKER_CD")), DBDataType.NVARCHAR))
...
#Region "商品明細マスタパラメータ設定"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SelectMgoodsSagyoCdParameter(ByVal ediMDr As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", ediMDr.Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NRS", Me.NullConvertString(ediMDr.Item("NRS_GOODS_CD")), DBDataType.NVARCHAR))
...
#End Region
    ...
    '2013.04.5 要望番号2002 作業マスタ取得START
#Region "作業項目マスタパラメータ設定"

    ''' <summary>
    ''' 作業項目マスタパラメータ設定
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SelectMSagyoParameter(ByVal sagyoMIn As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SAGYO_CD", Me.NullConvertString(sagyoMIn.Item("SAGYO_CD")), DBDataType.CHAR))
...
#Region "EDI受信(HED/DTL共通)の削除UPDATE文(セミEDI用)"
    ...
    Private Sub SetUpdateDelOutkaEdiRcvParameter(ByVal drOutkaEdiRcvIn As DataRow, ByVal prmList As ArrayList)
        ...
        'prmList.Add(MyBase.GetSqlParameter("@GYO", Me.NullConvertString(drOutkaEdiRcvIn.Item("GYO")), DBDataType.NVARCHAR))
    End Sub
...
#Region "商品明細マスタをHashTableに設定"
    ...
    Private Function SetGoodsDetailsMap(ByVal reader As SqlDataReader, ByVal map As Hashtable) As Hashtable
...
#Region "商品明細マスタをHashTableに設定"
    ...
    Private Function SetSagyoMap(ByVal reader As SqlDataReader, ByVal map As Hashtable) As Hashtable
...
#Region "明細数取得"
    ...
    Public Function GetEdiMCount(ByVal sNRS_BR_CD As String, ByVal sOUTKA_NO As String, ByVal sOUTKA_NO_GYO As String) As Integer
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC110.SQL_GET_EDI_M_COUNT)      'SQL構築(データ抽出用)

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), sNRS_BR_CD)
        ...
        'パラメータ設定
        _SqlPrmList.Add(GetSqlParameter("@NRS_BR_CD", sNRS_BR_CD, DBDataType.CHAR))
        _SqlPrmList.Add(GetSqlParameter("@OUTKA_NO", sOUTKA_NO, DBDataType.NVARCHAR))
        _SqlPrmList.Add(GetSqlParameter("@OUTKA_NO_GYO", sOUTKA_NO_GYO, DBDataType.NVARCHAR))
        ...
        MyBase.Logger.WriteSQLLog("GetEdiMCount", "SelectData", cmd)
