...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND As String = "SELECT                                                                  " & vbNewLine _
                                              ...
                                              & " ,'1'                               AS INOUT_KB                       " & vbNewLine _
                                              & " ,EDI_M.EDI_CTL_NO                  AS EDI_CTL_NO                     " & vbNewLine _
                                              & " ,EDI_M.EDI_CTL_NO_CHU              AS EDI_CTL_NO_CHU                 " & vbNewLine _
                                              & " ,'001'                             AS EDI_CTL_NO_EDA                 " & vbNewLine _
                                              & " ,INKA_M.INKA_NO_L                  AS INKA_NO_L                      " & vbNewLine _
                                              & " ,INKA_M.INKA_NO_M                  AS INKA_NO_M                      " & vbNewLine _
                                              & " ,MAX(INKA_S.INKA_NO_S)             AS INKA_NO_S                      " & vbNewLine _
                                              & " ,''                                AS OUTKA_CTL_NO                   " & vbNewLine _
                                              & " ,''                                AS OUTKA_CTL_NO_CHU               " & vbNewLine _
                                              & " ,''                                AS OUTKA_CTL_NO_SHO               " & vbNewLine _
                                              & " ,'00000'                           AS S0_MSYM_KEY                    " & vbNewLine _
                                              & " ,'THR'                             AS S1_MTRANS_HEAD                 " & vbNewLine _
                                              & " ,HED.H1_HPAR_NO                    AS S1_MPART_CD                    " & vbNewLine _
                                              & " ,''                                AS S1_MFILLER1                    " & vbNewLine _
                                              & " ,'40'                              AS S1_MCLIENT_CD1                 " & vbNewLine _
                                              & " ,HED.H1_HCOM_CODE1                 AS S1_MCOMPANY_CD1                " & vbNewLine _
                                              & " ,''                                AS S1_MFILLER2                    " & vbNewLine _
                                              & " ,HED.H3_HFILE_VERSION              AS S1_MPRO_VERSION                " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'R' THEN 'YGMV'                                                " & vbNewLine _
                                              & "  WHEN 'W' THEN 'YWSW'                                                " & vbNewLine _
                                              & "  WHEN 'G' THEN 'YWSA'                                                " & vbNewLine _
                                              & "  WHEN 'B' THEN 'YWSA'                                                " & vbNewLine _
                                              & "  ELSE ''                                                             " & vbNewLine _
                                              & " END                                AS S1_MMESSAGE_TYP1               " & vbNewLine _
                                              & " ,''                                AS S1_MDATE                       " & vbNewLine _
                                              & " ,''                                AS S1_MRENBAN                     " & vbNewLine _
                                              & " ,''                                AS S1_MFILLER3                    " & vbNewLine _
                                              & " ,'H'                               AS S2_MREC_TYP2                   " & vbNewLine _
                                              & " ,HED.H1_HPAR_NO                    AS S2_MVAN_NO                     " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'R' THEN 'YGMV'                                                " & vbNewLine _
                                              & "  WHEN 'W' THEN 'YWSW'                                                " & vbNewLine _
                                              & "  WHEN 'G' THEN 'YWSA'                                                " & vbNewLine _
                                              & "  WHEN 'B' THEN 'YWSA'                                                " & vbNewLine _
                                              & "  ELSE ''                                                             " & vbNewLine _
                                              & " END                                AS S2_MESSAGE_TYP2                " & vbNewLine _
                                              & " ,HED.H1_HREQ_FLAG                  AS S2_MREQ_FLAG                   " & vbNewLine _
                                              & " ,''                                AS S2_MSYS_DATE                   " & vbNewLine _
                                              & " ,''                                AS S2_MSYS_TIME                   " & vbNewLine _
                                              & " ,'40'                              AS S2_MCLIENT_CD2                 " & vbNewLine _
                                              & " ,HED.H1_HCOM_CODE1                 AS S2_MCOMPANY_CD2                " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'R' THEN HED.H1_HSEL_PLANT_CD                                  " & vbNewLine _
                                              & "  ELSE HED.H1_HDEL_PLANT_CD1                                          " & vbNewLine _
                                              & " END                                AS S2_MDEL_PLANT_CD               " & vbNewLine _
                                              & " ,HED.H1_HDEL_NO1                   AS S2_MDEL_NOTE_NO                " & vbNewLine _
                                              & " ,HED.H1_HSHIP_NO1                  AS S2_MSHIPMENT_NO                " & vbNewLine _
                                              & " ,INKA_L.INKA_DATE                  AS S2_MSHIP_DATE                  " & vbNewLine _
                                              & " ,''                                AS S2_MRECE_DATE                  " & vbNewLine _
                                              & " ,HED.H3_HCARR_CD                   AS S2_MCARR_BP_CD                 " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'W' THEN HED.H3_HDAIKAN                                        " & vbNewLine _
                                              & "  WHEN 'B' THEN HED.H3_HDAIKAN                                        " & vbNewLine _
                                              & "  ELSE ''                                                             " & vbNewLine _
                                              & " END                                AS S2_MDAIKAN1                    " & vbNewLine _
                                              & " ,'00000000'                        AS S2_MSOLD_BP_CD                 " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'G' THEN HED.H5_HCUST_NO                                       " & vbNewLine _
                                              & "  WHEN 'B' THEN HED.H5_HCUST_NO                                       " & vbNewLine _
                                              & "  ELSE ''                                                             " & vbNewLine _
                                              & " END                                AS S2_MCUST_ORD_NO                " & vbNewLine _
                                              & " ,HED.H4_HCON_NM_KAN AS S2_MCON_NM_KAN                                " & vbNewLine _
                                              & " ,HED.H4_HCON_ADD_KAN AS S2_MCON_ADDRESS_KAN                          " & vbNewLine _
                                              & " ,''                                AS S2_MFILLER4                    " & vbNewLine _
                                              & " ,'M'                               AS S3_MREC_TYP3                   " & vbNewLine _
                                              & " ,DTL.M1_IDEL_ITEM_NO               AS S3_MITEM_NO                    " & vbNewLine _
                                              & " ,DTL.M1_IMATERIAL_CD               AS S3_MMATERIAL_CD                " & vbNewLine _
                                              & " ,DTL.M1_ISTO_LOC                   AS S3_MSTLOC_NO                   " & vbNewLine _
                                              & " ,DTL.M1_ILOT_NO                    AS S3_MLOT_NO                     " & vbNewLine _
                                              & " ,SUM((INKA_S.KONSU * M_GOODS.PKG_NB + INKA_S.HASU)*INKA_S.IRIME) AS S3_MORG_ORD_QTY " & vbNewLine _
                                              & " ,DTL.M1_ISKU_QTY_UNIT              AS S3_MORG_ORD_UNIT               " & vbNewLine _
                                              & " ,SUM(INKA_S.KONSU * M_GOODS.PKG_NB + INKA_S.HASU) AS S3_MGOOD_QTY    " & vbNewLine _
                                              & " ,DTL.M1_IQTY_UNIT                  AS S3_MGOOD_UNIT                  " & vbNewLine _
                                              & " ,0                                 AS S3_MDAIKAN_QTY                 " & vbNewLine _
                                              & " ,''                                AS S3_MDAIKAN_UNIT                " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'R' THEN DTL.M1_IPO_NO                                         " & vbNewLine _
                                              & "  ELSE ''                                                             " & vbNewLine _
                                              & " END                                AS S3_MDOW_YOKO_NO                " & vbNewLine _
                                              & " ,CASE RTRIM(HED.H1_HREQ_FLAG)                                        " & vbNewLine _
                                              & "  WHEN 'R' THEN DTL.M1_IPO_ITEM_NO                                    " & vbNewLine _
                                              & "  ELSE ''                                                             " & vbNewLine _
                                              & " END                                AS S3_MDOW_YOKO_ITEM_NO           " & vbNewLine _
                                              & " ,0                                 AS S3_MIDT_QTY                    " & vbNewLine _
                                              & " ,''                                AS S3_MIDT_UNIT                   " & vbNewLine _
                                              & " ,''                                AS S3_MTEXT                       " & vbNewLine _
                                              & " ,''                                AS S3_MFILLER5                    " & vbNewLine _
                                              & " ,DTL.M1_IMATERIAL_NM1              AS S0_MMATERIAL_NAME1             " & vbNewLine _
                                              & " ,DTL.M1_IMATERIAL_NM2              AS S0_MMATERIAL_NAME2             " & vbNewLine _
                                              & " ,HED.H1_HORD_STATUS                AS S0_MSTATUS                     " & vbNewLine _
                                              & " ,'*'                               AS S0_MFLAG                       " & vbNewLine _
                                              ...
                                              & " INNER JOIN $LM_TRN$..H_INOUTKAEDI_HED_DOW  HED                       " & vbNewLine _
                                              & "  ON  HED.DEL_KB <> '1'                                               " & vbNewLine _
                                              & "  AND HED.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
                                              & "  AND HED.INOUT_KB = '1'                                              " & vbNewLine _
                                              & "  AND HED.EDI_CTL_NO = EDI_M.EDI_CTL_NO                               " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..H_INOUTKAEDI_DTL_DOW  DTL                       " & vbNewLine _
                                              & "  ON  DTL.DEL_KB <> '1'                                               " & vbNewLine _
                                              & "  AND DTL.NRS_BR_CD = EDI_M.NRS_BR_CD                                 " & vbNewLine _
                                              & "  AND DTL.INOUT_KB = '1'                                              " & vbNewLine _
                                              & "  AND DTL.EDI_CTL_NO = EDI_M.EDI_CTL_NO                               " & vbNewLine _
                                              & "  AND DTL.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU                       " & vbNewLine _
                                              & "  AND DTL.JISSEKI_SHORI_FLG = '1'                                     " & vbNewLine _
                                              & " INNER JOIN $LM_MST$..M_GOODS  M_GOODS                                " & vbNewLine _
                                              & "  ON  M_GOODS.SYS_DEL_FLG = '0'                                       " & vbNewLine _
                                              & "  AND M_GOODS.CUST_CD_L = INKA_L.CUST_CD_L                            " & vbNewLine _
                                              ...
                                              & "  EDI_M.NRS_BR_CD                                                     " & vbNewLine _
                                              & "  ,EDI_M.EDI_CTL_NO                                                   " & vbNewLine _
                                              & "  ,EDI_M.EDI_CTL_NO_CHU                                               " & vbNewLine _
                                              & "  ,INKA_M.INKA_NO_L                                                   " & vbNewLine _
                                              & "  ,INKA_M.INKA_NO_M                                                   " & vbNewLine _
                                              & "  ,HED.H1_HPAR_NO                                                      " & vbNewLine _
                                              & "  ,HED.H1_HCOM_CODE1                                                   " & vbNewLine _
                                              & "  ,HED.H3_HFILE_VERSION                                                " & vbNewLine _
                                              & "  ,HED.H1_HREQ_FLAG                                                    " & vbNewLine _
                                              & "  ,HED.H1_HSEL_PLANT_CD                                                " & vbNewLine _
                                              & "  ,HED.H1_HDEL_PLANT_CD1                                               " & vbNewLine _
                                              & "  ,HED.H1_HDEL_NO1                                                     " & vbNewLine _
                                              & "  ,HED.H1_HSHIP_NO1                                                    " & vbNewLine _
                                              & "  ,INKA_L.INKA_DATE                                                    " & vbNewLine _
                                              & "  ,HED.H3_HCARR_CD                                                     " & vbNewLine _
                                              & "  ,HED.H3_HDAIKAN                                                      " & vbNewLine _
                                              & "  ,HED.H5_HCUST_NO                                                     " & vbNewLine _
                                              & "  ,HED.H4_HCON_NM_KAN                                                  " & vbNewLine _
                                              & "  ,HED.H4_HCON_ADD_KAN                                                 " & vbNewLine _
                                              & "  ,DTL.M1_IDEL_ITEM_NO                                                 " & vbNewLine _
                                              & "  ,DTL.M1_IMATERIAL_CD                                                 " & vbNewLine _
                                              & "  ,DTL.M1_ISTO_LOC                                                     " & vbNewLine _
                                              & "  ,DTL.M1_ILOT_NO                                                      " & vbNewLine _
                                              & "  ,DTL.M1_ISKU_QTY                                                     " & vbNewLine _
                                              & "  ,DTL.M1_ISKU_QTY_UNIT                                                " & vbNewLine _
                                              & "  ,DTL.M1_IQTY_UNIT                                                    " & vbNewLine _
                                              & "  ,DTL.M1_IPO_NO                                                       " & vbNewLine _
                                              & "  ,DTL.M1_IPO_ITEM_NO                                                  " & vbNewLine _
                                              & "  ,DTL.M1_IMATERIAL_NM1                                                " & vbNewLine _
                                              & "  ,DTL.M1_IMATERIAL_NM2                                                " & vbNewLine _
                                              & "  ,HED.H1_HORD_STATUS                                                  " & vbNewLine
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INOUTKAEDI_DTL_DOW                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPDATE_RCV_DTL_DOW As String = "UPDATE $LM_TRN$..H_INOUTKAEDI_DTL_DOW SET     " & vbNewLine _
                                              & "JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG            " & vbNewLine _
                                              & ",JISSEKI_USER      = @JISSEKI_USER                 " & vbNewLine _
                                              & ",JISSEKI_DATE      = @JISSEKI_DATE                 " & vbNewLine _
                                              & ",JISSEKI_TIME      = @JISSEKI_TIME                 " & vbNewLine _
    ...
    '                                          & ",SYS_UPD_PGID           = @SYS_UPD_PGID                              " & vbNewLine _
    '                                          & ",SYS_UPD_USER           = @SYS_UPD_USER                              " & vbNewLine _
    '                                          & " FROM $LM_TRN$..H_INOUTKAEDI_DTL_DOW                                 " & vbNewLine _
    '                                          & " INNER JOIN $LM_TRN$..H_INKAEDI_M                                    " & vbNewLine _
    '                                          & "  ON  H_INKAEDI_M.SYS_DEL_FLG <> '1'                                 " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.NRS_BR_CD = H_INKAEDI_M.NRS_BR_CD         " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.EDI_CTL_NO = H_INKAEDI_M.EDI_CTL_NO       " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.EDI_CTL_NO_CHU = H_INKAEDI_M.EDI_CTL_NO_CHU  " & vbNewLine _
    '                                          & "  AND H_INKAEDI_M.JISSEKI_FLAG = '0'                                  " & vbNewLine _
    '                                          & " INNER JOIN $LM_TRN$..B_INKA_L                                        " & vbNewLine _
    '                                          & "  ON  B_INKA_L.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.NRS_BR_CD = B_INKA_L.NRS_BR_CD             " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.INKA_CTL_NO_L = B_INKA_L.INKA_NO_L         " & vbNewLine _
    '                                          & " INNER JOIN $LM_TRN$..B_INKA_M                                        " & vbNewLine _
    '                                          & "  ON  B_INKA_M.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.NRS_BR_CD = B_INKA_M.NRS_BR_CD             " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.INKA_CTL_NO_L = B_INKA_M.INKA_NO_L         " & vbNewLine _
    '                                          & "  AND H_INOUTKAEDI_DTL_DOW.INKA_CTL_NO_M = B_INKA_M.INKA_NO_M         " & vbNewLine _
    ...
    '                                          & "WHERE   H_INOUTKAEDI_DTL_DOW.NRS_BR_CD       = @NRS_BR_CD             " & vbNewLine _
    '                                          & "AND H_INOUTKAEDI_DTL_DOW.EDI_CTL_NO          = @EDI_CTL_NO            " & vbNewLine _
    '                                          & "AND H_INOUTKAEDI_DTL_DOW.JISSEKI_SHORI_FLG   = '1'      			   " & vbNewLine _
    '                                          & "AND H_INOUTKAEDI_DTL_DOW.SYS_DEL_FLG         <> '1'      		       " & vbNewLine
...
#Region "SEND(実績送信済⇒送信未)"
    ...
    Private Const SQL_UPD_JISSEKIMODOSI_SEND As String = "UPDATE                                    " & vbNewLine _
                                              & "$LM_TRN$..H_SENDINOUTEDI_DOW                       " & vbNewLine _
                                              & "SET                                                " & vbNewLine _
                                              & " JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG            " & vbNewLine _
                                              & ",SEND_USER         = @SEND_USER                    " & vbNewLine _
                                              & ",SEND_DATE         = @SEND_DATE                    " & vbNewLine _
...
#Region "RCV_HED(入荷取消⇒未登録)"
    ...
    Private Const SQL_UPD_TOUROKUMI_RCV_HED As String = "UPDATE                                     " & vbNewLine _
                                              & " $LM_TRN$..H_INOUTKAEDI_HED_DOW                    " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = 'O00000000'                   " & vbNewLine _
...
#Region "SEND"
    ...
    Private Const SQL_INSERT_SEND As String = "INSERT INTO $LM_TRN$..H_SENDINOUTEDI_DOW " & vbNewLine _
                                              & "(                                      " & vbNewLine _
                                              & " DEL_KB                                " & vbNewLine _
                                              & ",NRS_BR_CD                             " & vbNewLine _
                                              ...
                                              & ",OUTKA_CTL_NO_SHO                      " & vbNewLine _
                                              & ",S0_MSYM_KEY                           " & vbNewLine _
                                              & ",S1_MTRANS_HEAD                        " & vbNewLine _
                                              & ",S1_MPART_CD                           " & vbNewLine _
                                              & ",S1_MFILLER1                           " & vbNewLine _
                                              & ",S1_MCLIENT_CD1                        " & vbNewLine _
                                              & ",S1_MCOMPANY_CD1                       " & vbNewLine _
                                              & ",S1_MFILLER2                           " & vbNewLine _
                                              & ",S1_MPRO_VERSION                       " & vbNewLine _
                                              & ",S1_MMESSAGE_TYP1                      " & vbNewLine _
                                              & ",S1_MDATE                              " & vbNewLine _
                                              & ",S1_MRENBAN                            " & vbNewLine _
                                              & ",S1_MFILLER3                           " & vbNewLine _
                                              & ",S2_MREC_TYP2                          " & vbNewLine _
                                              & ",S2_MVAN_NO                            " & vbNewLine _
                                              & ",S2_MESSAGE_TYP2                       " & vbNewLine _
                                              & ",S2_MREQ_FLAG                          " & vbNewLine _
                                              & ",S2_MSYS_DATE                          " & vbNewLine _
                                              & ",S2_MSYS_TIME                          " & vbNewLine _
                                              & ",S2_MCLIENT_CD2                        " & vbNewLine _
                                              & ",S2_MCOMPANY_CD2                       " & vbNewLine _
                                              & ",S2_MDEL_PLANT_CD                      " & vbNewLine _
                                              & ",S2_MDEL_NOTE_NO                       " & vbNewLine _
                                              & ",S2_MSHIPMENT_NO                       " & vbNewLine _
                                              & ",S2_MSHIP_DATE                         " & vbNewLine _
                                              & ",S2_MRECE_DATE                         " & vbNewLine _
                                              & ",S2_MCARR_BP_CD                        " & vbNewLine _
                                              & ",S2_MDAIKAN1                           " & vbNewLine _
                                              & ",S2_MSOLD_BP_CD                        " & vbNewLine _
                                              & ",S2_MCUST_ORD_NO                       " & vbNewLine _
                                              & ",S2_MCON_NM_KAN                        " & vbNewLine _
                                              & ",S2_MCON_ADDRESS_KAN                   " & vbNewLine _
                                              & ",S2_MFILLER4                           " & vbNewLine _
                                              & ",S3_MREC_TYP3                          " & vbNewLine _
                                              & ",S3_MITEM_NO                           " & vbNewLine _
                                              & ",S3_MMATERIAL_CD                       " & vbNewLine _
                                              & ",S3_MSTLOC_NO                          " & vbNewLine _
                                              & ",S3_MLOT_NO                            " & vbNewLine _
                                              & ",S3_MORG_ORD_QTY                       " & vbNewLine _
                                              & ",S3_MORG_ORD_UNIT                      " & vbNewLine _
                                              & ",S3_MGOOD_QTY                          " & vbNewLine _
                                              & ",S3_MGOOD_UNIT                         " & vbNewLine _
                                              & ",S3_MDAIKAN_QTY                        " & vbNewLine _
                                              & ",S3_MDAIKAN_UNIT                       " & vbNewLine _
                                              & ",S3_MDOW_YOKO_NO                       " & vbNewLine _
                                              & ",S3_MDOW_YOKO_ITEM_NO                  " & vbNewLine _
                                              & ",S3_MIDT_QTY                           " & vbNewLine _
                                              & ",S3_MIDT_UNIT                          " & vbNewLine _
                                              & ",S3_MTEXT                              " & vbNewLine _
                                              & ",S3_MFILLER5                           " & vbNewLine _
                                              & ",S0_MMATERIAL_NAME1                    " & vbNewLine _
                                              & ",S0_MMATERIAL_NAME2                    " & vbNewLine _
                                              & ",S0_MSTATUS                            " & vbNewLine _
                                              & ",S0_MFLAG                              " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC202.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC202.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC202.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "SelectSend", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINOUTEDI_DOW")
        reader.Close()
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC202.SQL_UPD_INKATOROKU_EDI_L

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC202.SQL_UPD_JISSEKITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC202.SQL_UPD_EDITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC202.SQL_UPD_JISSEKIMODOSI_EDI_L

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC202.SQL_UPD_TOUROKUMI_EDI_L

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC202.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC202.SQL_UPD_INKATOROKU_EDI_M
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC202.SQL_UPD_EDITORIKESI_EDI_M

                '実績作成済⇒実績未、実績送信済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                , LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC202.SQL_UPD_JISSEKIMODOSI_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC202.SQL_UPD_JISSEKISAKUSEI_EDI_M

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC202.SQL_UPD_TOUROKUMI_EDI_M

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC202.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC202.SQL_UPD_RCV_HED

            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC202.SQL_UPD_JISSEKITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC202.SQL_UPD_EDITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC202.SQL_UPD_JISSEKIMODOSI_RCV_HED

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC202.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC202.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "UpdateRcvHed", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC202.SQL_UPDATE_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC202.SQL_UPDATE_RCV_DTL_DOW

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI
                setSql = LMH010DAC202.SQL_UPD_JISSEKITORIKESI_RCV_DTL
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC202.SQL_UPD_EDITORIKESI_RCV_DTL

                '実績作成済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI

                setSql = LMH010DAC202.SQL_UPD_JISSEKIZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒実績未、
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC202.SQL_UPD_SOUSINZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC202.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC202.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertInkaS", cmd)
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINOUTEDI_DOW")

        '営業所コード
        Dim brCd As String = inTbl.Rows(0).Item("NRS_BR_CD").ToString()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_SEND, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertSend", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC202.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC202", "InsertUnchinData", cmd)
    ...
    Private Sub SetJissekiParameterEdiLEdiM(ByVal row As DataRow, ByVal eventShubetsu As Integer)
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_DATE", String.Empty, DBDataType.NVARCHAR))
                Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_TIME", String.Empty, DBDataType.NVARCHAR))

            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
                Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_DATE", MyBase.GetSystemDate(), DBDataType.NVARCHAR))
...
#Region "更新パラメータ設定(EDI_L)"
    ...
    Private Sub SetUpdPrmEdiL(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(dt.Rows(0).Item("NRS_BR_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(dt.Rows(0).Item("EDI_CTL_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_L", Me.NullConvertString(dt.Rows(0).Item("INKA_CTL_NO_L")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_TP", Me.NullConvertString(dt.Rows(0).Item("INKA_TP")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_KB", Me.NullConvertString(dt.Rows(0).Item("INKA_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_STATE_KB", Me.NullConvertString(dt.Rows(0).Item("INKA_STATE_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_DATE", Me.NullConvertString(dt.Rows(0).Item("INKA_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_TIME", Me.NullConvertString(dt.Rows(0).Item("INKA_TIME")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_WH_CD", Me.NullConvertString(dt.Rows(0).Item("NRS_WH_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(dt.Rows(0).Item("CUST_CD_L")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(dt.Rows(0).Item("CUST_CD_M")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NAIGAI_KB", Me.NullConvertString(dt.Rows(0).Item("NAIGAI_KB")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOUKI_HOKAN_YN", Me.NullConvertString(dt.Rows(0).Item("TOUKI_HOKAN_YN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HOKAN_YN", Me.NullConvertString(dt.Rows(0).Item("HOKAN_YN")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@HOKAN_STR_DATE", Me.NullConvertString(dt.Rows(0).Item("HOKAN_STR_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NIYAKU_YN", Me.NullConvertString(dt.Rows(0).Item("NIYAKU_YN")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TAX_KB", Me.NullConvertString(dt.Rows(0).Item("TAX_KB")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYARYO_KB", Me.NullConvertString(dt.Rows(0).Item("SYARYO_KB")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUT_FLAG", Me.NullConvertString(dt.Rows(0).Item("OUT_FLAG")), DBDataType.NVARCHAR))
...
#Region "更新パラメータ設定(EDI_M)"
    ...
    Private Sub SetUpdPrmEdiM(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(row.Item("NRS_BR_CD")), DBDataType.NVARCHAR))
...
#Region "更新パラメータ設定(RCV_HED)"
    ...
    Private Sub SetUpdPrmRcvHed(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_TIME", updTime, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(dt.Rows(0).Item("DEL_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", Me.NullConvertString(dt.Rows(0).Item("SYS_DEL_FLG")), DBDataType.NVARCHAR))
...
#Region "更新パラメータ設定(RCV_DTL)"
    ...
    Private Sub SetUpdPrmRcvDtl(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", Me.NullConvertString(row.Item("SYS_DEL_FLG")), DBDataType.NVARCHAR))
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_DATE", String.Empty, DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_TIME", String.Empty, DBDataType.NVARCHAR))
...
#Region "更新パラメータ設定(SEND)"
    ...
    Private Sub SetPrmRcvSend(ByVal dt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_TIME", updTime, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(dt.Rows(0).Item("JISSEKI_SHORI_FLG")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_USER", String.Empty, DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_DATE", String.Empty, DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEND_TIME", String.Empty, DBDataType.NVARCHAR))
...
#Region "挿入パラメータ設定(SEND)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(row.Item("DEL_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(row.Item("NRS_BR_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INOUT_KB", Me.NullConvertString(row.Item("INOUT_KB")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(row.Item("EDI_CTL_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_CHU", Me.NullConvertString(row.Item("EDI_CTL_NO_CHU")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_EDA", Me.NullConvertString(row.Item("EDI_CTL_NO_EDA")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_L", Me.NullConvertString(row.Item("INKA_NO_L")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_M", Me.NullConvertString(row.Item("INKA_NO_M")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_S", Me.NullConvertString(row.Item("INKA_NO_S")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO", Me.NullConvertString(row.Item("OUTKA_CTL_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_CHU", Me.NullConvertString(row.Item("OUTKA_CTL_NO_CHU")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO_SHO", Me.NullConvertString(row.Item("OUTKA_CTL_NO_SHO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S0_MSYM_KEY", Me.NullConvertString(row.Item("S0_MSYM_KEY")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MTRANS_HEAD", Me.NullConvertString(row.Item("S1_MTRANS_HEAD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MPART_CD", Me.NullConvertString(row.Item("S1_MPART_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MFILLER1", Me.NullConvertString(row.Item("S1_MFILLER1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MCLIENT_CD1", Me.NullConvertString(row.Item("S1_MCLIENT_CD1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MCOMPANY_CD1", Me.NullConvertString(row.Item("S1_MCOMPANY_CD1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MFILLER2", Me.NullConvertString(row.Item("S1_MFILLER2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MPRO_VERSION", Me.NullConvertString(row.Item("S1_MPRO_VERSION")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MMESSAGE_TYP1", Me.NullConvertString(row.Item("S1_MMESSAGE_TYP1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MDATE", Me.NullConvertString(row.Item("S1_MDATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MRENBAN", Me.NullConvertString(row.Item("S1_MRENBAN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S1_MFILLER3", Me.NullConvertString(row.Item("S1_MFILLER3")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MREC_TYP2", Me.NullConvertString(row.Item("S2_MREC_TYP2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MVAN_NO", Me.NullConvertString(row.Item("S2_MVAN_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MESSAGE_TYP2", Me.NullConvertString(row.Item("S2_MESSAGE_TYP2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MREQ_FLAG", Me.NullConvertString(row.Item("S2_MREQ_FLAG")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MSYS_DATE", Me.NullConvertString(row.Item("S2_MSYS_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MSYS_TIME", Me.NullConvertString(row.Item("S2_MSYS_TIME")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MCLIENT_CD2", Me.NullConvertString(row.Item("S2_MCLIENT_CD2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MCOMPANY_CD2", Me.NullConvertString(row.Item("S2_MCOMPANY_CD2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MDEL_PLANT_CD", Me.NullConvertString(row.Item("S2_MDEL_PLANT_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MDEL_NOTE_NO", Me.NullConvertString(row.Item("S2_MDEL_NOTE_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MSHIPMENT_NO", Me.NullConvertString(row.Item("S2_MSHIPMENT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MSHIP_DATE", Me.NullConvertString(row.Item("S2_MSHIP_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MRECE_DATE", Me.NullConvertString(row.Item("S2_MRECE_DATE")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MCARR_BP_CD", Me.NullConvertString(row.Item("S2_MCARR_BP_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MDAIKAN1", Me.NullConvertString(row.Item("S2_MDAIKAN1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MSOLD_BP_CD", Me.NullConvertString(row.Item("S2_MSOLD_BP_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MCUST_ORD_NO", Me.NullConvertString(row.Item("S2_MCUST_ORD_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MCON_NM_KAN", Me.NullConvertString(row.Item("S2_MCON_NM_KAN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MCON_ADDRESS_KAN", Me.NullConvertString(row.Item("S2_MCON_ADDRESS_KAN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S2_MFILLER4", Me.NullConvertString(row.Item("S2_MFILLER4")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MREC_TYP3", Me.NullConvertString(row.Item("S3_MREC_TYP3")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MITEM_NO", Me.NullConvertString(row.Item("S3_MITEM_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MMATERIAL_CD", Me.NullConvertString(row.Item("S3_MMATERIAL_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MSTLOC_NO", Me.NullConvertString(row.Item("S3_MSTLOC_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MLOT_NO", Me.NullConvertString(row.Item("S3_MLOT_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MORG_ORD_QTY", Me.NullConvertZero(row.Item("S3_MORG_ORD_QTY")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MORG_ORD_UNIT", Me.NullConvertString(row.Item("S3_MORG_ORD_UNIT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MGOOD_QTY", Me.NullConvertZero(row.Item("S3_MGOOD_QTY")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MGOOD_UNIT", Me.NullConvertString(row.Item("S3_MGOOD_UNIT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MDAIKAN_QTY", Me.NullConvertZero(row.Item("S3_MDAIKAN_QTY")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MDAIKAN_UNIT", Me.NullConvertString(row.Item("S3_MDAIKAN_UNIT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MDOW_YOKO_NO", Me.NullConvertString(row.Item("S3_MDOW_YOKO_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MDOW_YOKO_ITEM_NO", Me.NullConvertString(row.Item("S3_MDOW_YOKO_ITEM_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MIDT_QTY", Me.NullConvertZero(row.Item("S3_MIDT_QTY")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MIDT_UNIT", Me.NullConvertString(row.Item("S3_MIDT_UNIT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MTEXT", Me.NullConvertString(row.Item("S3_MTEXT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S3_MFILLER5", Me.NullConvertString(row.Item("S3_MFILLER5")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S0_MMATERIAL_NAME1", Me.NullConvertString(row.Item("S0_MMATERIAL_NAME1")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S0_MMATERIAL_NAME2", Me.NullConvertString(row.Item("S0_MMATERIAL_NAME2")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S0_MSTATUS", Me.NullConvertString(row.Item("S0_MSTATUS")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@S0_MFLAG", Me.NullConvertString(row.Item("S0_MFLAG")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(row.Item("JISSEKI_SHORI_FLG")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_DATE", MyBase.GetSystemDate(), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_TIME", updTime, DBDataType.NVARCHAR))
        ...
        'Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_DATE", Me.NullConvertString(row.Item("UPD_DATE")), DBDataType.NVARCHAR))
        'Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_TIME", Me.NullConvertString(row.Item("UPD_TIME")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@UPD_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
...
#Region "マッピング配列作成"
    ...
    Private Function SetMapSend() As Hashtable
        ...
        map.Add("OUTKA_CTL_NO_SHO", "OUTKA_CTL_NO_SHO")
        map.Add("S0_MSYM_KEY", "S0_MSYM_KEY")
        map.Add("S1_MTRANS_HEAD", "S1_MTRANS_HEAD")
        map.Add("S1_MPART_CD", "S1_MPART_CD")
        map.Add("S1_MFILLER1", "S1_MFILLER1")
        map.Add("S1_MCLIENT_CD1", "S1_MCLIENT_CD1")
        map.Add("S1_MCOMPANY_CD1", "S1_MCOMPANY_CD1")
        map.Add("S1_MFILLER2", "S1_MFILLER2")
        map.Add("S1_MPRO_VERSION", "S1_MPRO_VERSION")
        map.Add("S1_MMESSAGE_TYP1", "S1_MMESSAGE_TYP1")
        map.Add("S1_MDATE", "S1_MDATE")
        map.Add("S1_MRENBAN", "S1_MRENBAN")
        map.Add("S1_MFILLER3", "S1_MFILLER3")
        map.Add("S2_MREC_TYP2", "S2_MREC_TYP2")
        map.Add("S2_MVAN_NO", "S2_MVAN_NO")
        map.Add("S2_MESSAGE_TYP2", "S2_MESSAGE_TYP2")
        map.Add("S2_MREQ_FLAG", "S2_MREQ_FLAG")
        map.Add("S2_MSYS_DATE", "S2_MSYS_DATE")
        map.Add("S2_MSYS_TIME", "S2_MSYS_TIME")
        map.Add("S2_MCLIENT_CD2", "S2_MCLIENT_CD2")
        map.Add("S2_MCOMPANY_CD2", "S2_MCOMPANY_CD2")
        map.Add("S2_MDEL_PLANT_CD", "S2_MDEL_PLANT_CD")
        map.Add("S2_MDEL_NOTE_NO", "S2_MDEL_NOTE_NO")
        map.Add("S2_MSHIPMENT_NO", "S2_MSHIPMENT_NO")
        map.Add("S2_MSHIP_DATE", "S2_MSHIP_DATE")
        map.Add("S2_MRECE_DATE", "S2_MRECE_DATE")
        map.Add("S2_MCARR_BP_CD", "S2_MCARR_BP_CD")
        map.Add("S2_MDAIKAN1", "S2_MDAIKAN1")
        map.Add("S2_MSOLD_BP_CD", "S2_MSOLD_BP_CD")
        map.Add("S2_MCUST_ORD_NO", "S2_MCUST_ORD_NO")
        map.Add("S2_MCON_NM_KAN", "S2_MCON_NM_KAN")
        map.Add("S2_MCON_ADDRESS_KAN", "S2_MCON_ADDRESS_KAN")
        map.Add("S2_MFILLER4", "S2_MFILLER4")
        map.Add("S3_MREC_TYP3", "S3_MREC_TYP3")
        map.Add("S3_MITEM_NO", "S3_MITEM_NO")
        map.Add("S3_MMATERIAL_CD", "S3_MMATERIAL_CD")
        map.Add("S3_MSTLOC_NO", "S3_MSTLOC_NO")
        map.Add("S3_MLOT_NO", "S3_MLOT_NO")
        map.Add("S3_MORG_ORD_QTY", "S3_MORG_ORD_QTY")
        map.Add("S3_MORG_ORD_UNIT", "S3_MORG_ORD_UNIT")
        map.Add("S3_MGOOD_QTY", "S3_MGOOD_QTY")
        map.Add("S3_MGOOD_UNIT", "S3_MGOOD_UNIT")
        map.Add("S3_MDAIKAN_QTY", "S3_MDAIKAN_QTY")
        map.Add("S3_MDAIKAN_UNIT", "S3_MDAIKAN_UNIT")
        map.Add("S3_MDOW_YOKO_NO", "S3_MDOW_YOKO_NO")
        map.Add("S3_MDOW_YOKO_ITEM_NO", "S3_MDOW_YOKO_ITEM_NO")
        map.Add("S3_MIDT_QTY", "S3_MIDT_QTY")
        map.Add("S3_MIDT_UNIT", "S3_MIDT_UNIT")
        map.Add("S3_MTEXT", "S3_MTEXT")
        map.Add("S3_MFILLER5", "S3_MFILLER5")
        map.Add("S0_MMATERIAL_NAME1", "S0_MMATERIAL_NAME1")
        map.Add("S0_MMATERIAL_NAME2", "S0_MMATERIAL_NAME2")
        map.Add("S0_MSTATUS", "S0_MSTATUS")
        map.Add("S0_MFLAG", "S0_MFLAG")
