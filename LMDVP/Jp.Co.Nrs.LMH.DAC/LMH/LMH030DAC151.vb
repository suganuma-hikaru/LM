...
'  EDI荷主ID　　　　:  151　　　 : セミ標準(000)をコピー（2020/04/15）　ジョンソンエンドジョンソンJ&J_土気自動倉庫
'  作  成  者       :  daikoku
' ==========================================================================
Imports System.Text
...
#Region "WHERE1_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_WHERE1_M_GOODS_FLM As String =
                                       " AND                                                " & vbNewLine _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_WHERE1_M_CUST_DETAILS_FIR As String =
                                       " WHERE                                              " & vbNewLine _
...
#If True Then   'ADD 2019/02/27 依頼番号 : 004291   【LMS】千葉テルモ_EDIテスト+EDI出荷改修(
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_WHERE1_M_CUST_DETAILS_TRM As String =
                                       " WHERE                                              " & vbNewLine _
                                     & " M_CUST_DETAILS.NRS_BR_CD = @NRS_BR_CD              " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_CUST_DETAILS.CUST_CD = @CUST_CD_L                " & vbNewLine _
...
#End If
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_WHERE1_M_CUST_DETAILS As String =
                                       " WHERE                                              " & vbNewLine _
                                     & " M_CUST_DETAILS.NRS_BR_CD = @NRS_BR_CD              " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_CUST_DETAILS.CUST_CD = @CUST_CD_L                " & vbNewLine _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_WHERE_M_CUST_DETAILS_ALL As String =
                                       " WHERE                                              " & vbNewLine _
                                     & " M_CUST_DETAILS.NRS_BR_CD = @NRS_BR_CD              " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_CUST_DETAILS.CUST_CD = @CUST_CD_L                " & vbNewLine _
...
#Region "商品マスタ"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC151.SQL_WHERE1_M_GOODS)

        'ADD 2016/07/20 フィルメ対応
        If ds.Tables("LMH030_M_CUST_DETAILS").Select("SUB_KB='0L'").Count > 0 Then
            'SQL条件設定(Where + 入り目を追加)
            Me._StrSql.Append(LMH030DAC151.SQL_WHERE1_M_GOODS_FLM)

        End If

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC151.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectDataMgoods", cmd)
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC151.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "荷主明細マスタ（SUB_KB=0L）"
    ...
    Private Function SelectMstCustD0L(ByVal ds As DataSet) As DataSet
        ...
        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC151.SQL_WHERE1_M_CUST_DETAILS_FIR)
...
#Region "荷主明細マスタ（SUB_KB=9X）"
    ...
    Private Function SelectMstCustD9X(ByVal ds As DataSet) As DataSet
        ...
        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC151.SQL_WHERE1_M_CUST_DETAILS_TRM)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC151.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectDataMdestOutkaToroku", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectDataZkbn", cmd)
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals(LMConst.FLG.ON) = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC151.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC151.SQL_WHERE_CANCER_DATA_DTL)

            'オーダー番号＋オーダー番号明細チェックの場合
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("3") = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC151.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC151.SQL_WHERE_CANCER_DATA_DTL_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("4") = True Then
            ...
            Me._StrSql.Append(LMH030DAC151.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC151.SQL_WHERE_CANCER_DATA_DTL_ONLY_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("5") = True Then
            ...
            Me._StrSql.Append(LMH030DAC151.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC151.SQL_WHERE_CANCER_DATA_DTL_M_FREE_C25)
            '2015.04.28 Ｍ・Ｒ・Ｃデュポン対応 M_FREE_C25_NOの(オーダー番号明細のみ)チェックの場合 追加END
        Else
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC151.SQL_SELECT_CANCER_DATA)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC151.SQL_WHERE_CANCER_DATA)
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    Private Function SelectCompareData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_ARB") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC151.SQL_SELECT_COMPARE_CHECK_ARB, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_MRC") = True Then
            'スキーマ設定
            sql = Me.SetSchemaNm(LMH030DAC151.SQL_SELECT_COMPARE_CHECK_MRC, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC151.SQL_WHERE_M_CUST_DETAILS_ALL)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC151.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC151.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC151.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC151.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI：受信テーブル取消更新)"
    ...
    Private Function UpdateDelRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Dim sql As String = Me.SetSchemaNm(LMH030DAC151.SQL_UPDATE_DEL_OUTKAIEDI_DTL, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateDelRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_UPDATE_EDIT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateEditOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_UPDATE_EDIT_OUTKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateEditOutkaEdiM", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC151.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC151.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateOutkaLData", cmd)
    ...
    Private Function UpdateOutkaLDataWithBuyerOrdNo(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録(まとめ時)
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC151.SQL_UPDATE_OUTKAL_MATOME_WITH_BUYER_ORD_NO
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC151.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC151.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC151", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertMDestData", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        If setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_ARB") = True Then
            sql = Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_OUTKAEDI_DTL_ARB, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ElseIf setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_MRC") = True Then
            sql = Me.SetSchemaNm(LMH030DAC151.SQL_INSERT_OUTKAEDI_DTL_MRC, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC151", "InsertOutkaEdiRcvDtl", cmd)
