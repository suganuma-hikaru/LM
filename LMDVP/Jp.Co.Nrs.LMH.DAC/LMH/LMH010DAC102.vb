...
''' <remarks></remarks>
''' 
Public Class LMH010DAC102
    Inherits Jp.Co.Nrs.LM.Base.DAC.LMBaseDAC

#Region "Const"

#Region "H_INKAEDI_DTL_BYK(INSERT)"

    ''' <summary>
    ''' INSERT（H_INKAEDI_DTL_BYK）
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_INSERT_INKAEDI_DTL As String = "INSERT INTO       " & vbNewLine _
                                        ...
                                        & " ,DELIVERY	                " & vbNewLine _
                                        & " ,DELIVERY_DATE	            " & vbNewLine _
                                        & " ,ITEM_NO	                " & vbNewLine _
                                        & " ,MATERIAL	                " & vbNewLine _
                                        & " ,DESCRIPTION	            " & vbNewLine _
                                        & " ,DERIVERY_QUANTITY	        " & vbNewLine _
                                        & " ,SALES_UNIT	                " & vbNewLine _
                                        & " ,NET_WEIGHT	                " & vbNewLine _
                                        & " ,BUSINESS_UNIT	            " & vbNewLine _
                                        & " ,PICK_STATUS	            " & vbNewLine _
                                        & " ,PURCHASING_DOCUMENT        " & vbNewLine _
                                        & " ,REF_ITEM	                " & vbNewLine _
                                        & " ,EXTERNAL_DELIVERY_ID       " & vbNewLine _
                                        & " ,BATCH	                    " & vbNewLine _
                                        & " ,VENDOR	                    " & vbNewLine _
                                        & " ,STORAGE_LOCATION           " & vbNewLine _
...
#Region "SELECT_M_GOODS(セミEDI時)"
    Private Const SQL_SELECT_M_GOODS As String _
                              ...
                              & ",MG.CONSUME_PERIOD_DATE            AS  CONSUME_PERIOD_DATE    " & vbNewLine _
                              & ",MG.SYS_ENT_DATE                   AS  SYS_ENT_DATE           " & vbNewLine _
                              & ",MG.SYS_ENT_TIME                   AS  SYS_ENT_TIME           " & vbNewLine _
                              & ",MG.SYS_ENT_PGID                   AS  SYS_ENT_PGID           " & vbNewLine _
                              & ",MG.SYS_ENT_USER                   AS  SYS_ENT_USER           " & vbNewLine _
                              & ",MG.SYS_UPD_DATE                   AS  SYS_UPD_DATE           " & vbNewLine _
                              & ",MG.SYS_UPD_TIME                   AS  SYS_UPD_TIME           " & vbNewLine _
                              & ",MG.SYS_UPD_PGID                   AS  SYS_UPD_PGID           " & vbNewLine _
                              & ",MG.SYS_UPD_USER                   AS  SYS_UPD_USER           " & vbNewLine _
                              ...
                              & "-- ON                                                         " & vbNewLine _
                              & "-- MG.NRS_BR_CD   = BIM.NRS_BR_CD                             " & vbNewLine _
                              & "-- AND                                                        " & vbNewLine _
                              & "-- MG.GOODS_CD_NRS   = BIM.GOODS_CD_NRS                       " & vbNewLine _
                              & " $LM_MST$..M_CUST_DETAILS     M_CUST_DETAILS                  " & vbNewLine _
                              & " ON                                                           " & vbNewLine _
                              & " MG.NRS_BR_CD = M_CUST_DETAILS.NRS_BR_CD                      " & vbNewLine _
                              & " AND                                                          " & vbNewLine _
                              & " MG.CUST_CD_L + MG.CUST_CD_M = M_CUST_DETAILS.CUST_CD         " & vbNewLine _
                              & " AND                                                          " & vbNewLine _
                              & " M_CUST_DETAILS.SUB_KB = '0D'                                 " & vbNewLine _
                              & " AND                                                          " & vbNewLine _
                              & " M_CUST_DETAILS.SYS_DEL_FLG = '0'                             " & vbNewLine _
                              & "-- LEFT JOIN                                                  " & vbNewLine _
                              & "-- $LM_MST$..M_EDI_CUST   MEC                                 " & vbNewLine _
                              & "-- ON                                                         " & vbNewLine _
                              & "-- MG.NRS_BR_CD   = MEC.NRS_BR_CD                             " & vbNewLine _
                              & "-- AND                                                        " & vbNewLine _
                              & "-- MG.CUST_CD_L   = MEC.CUST_CD_L                             " & vbNewLine _
                              & "-- AND                                                        " & vbNewLine _
                              & "-- MG.CUST_CD_M   = MEC.CUST_CD_M                             " & vbNewLine _
                              & "-- AND                                                        " & vbNewLine _
                              & "-- MEC.INOUT_KB   = '1'                                       " & vbNewLine
...
#Region "WHERE1_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_WHERE1_M_GOODS As String = _
                                     ...
                                     & " AND                                          " & vbNewLine _
                                     & "-- MG.CUST_CD_L      = @CUST_CD_L             " & vbNewLine _
                                     & "-- AND                                        " & vbNewLine _
                                     & "-- MG.CUST_CD_M      = @CUST_CD_M             " & vbNewLine _
                                     & "-- AND                                        " & vbNewLine _
                                     & " MG.GOODS_CD_CUST  = @GOODS_CD_CUST           " & vbNewLine _
                                     & " AND                                          " & vbNewLine _
                                     & " M_CUST_DETAILS.SYS_DEL_FLG = '0'             " & vbNewLine _
                                     & " AND                                          " & vbNewLine _
                                     & " MG.SYS_DEL_FLG = '0'                         " & vbNewLine _
                                     & " AND                                          " & vbNewLine _
                                     & " MG.AVAL_YN <> '00'                           " & vbNewLine _
                                     & "-- AND                                          " & vbNewLine _
                                     & "-- MEC.SYS_DEL_FLG = '0'                        " & vbNewLine

    Private Const SQL_WHERE2_M_GOODS As String = _
                                       " WHERE                                        " & vbNewLine _
                                     & " MG.NRS_BR_CD      = @NRS_BR_CD               " & vbNewLine _
                                     & " AND                                          " & vbNewLine _
                                     & " MG.CUST_CD_L      = @CUST_CD_L             " & vbNewLine _
...
#Region "GROUP_BY_M_GOODS(セミEDI時)"
    ...
    Private Const SQL_GROUP_BY_M_GOODS As String _
                              ...
                              & ",MG.CONSUME_PERIOD_DATE    " & vbNewLine _
                              & ",MG.SYS_ENT_DATE           " & vbNewLine _
                              & ",MG.SYS_ENT_TIME           " & vbNewLine _
                              & ",MG.SYS_ENT_PGID           " & vbNewLine _
                              & ",MG.SYS_ENT_USER           " & vbNewLine _
                              & ",MG.SYS_UPD_DATE           " & vbNewLine _
                              & ",MG.SYS_UPD_TIME           " & vbNewLine _
                              & ",MG.SYS_UPD_PGID           " & vbNewLine _
                              & ",MG.SYS_UPD_USER           " & vbNewLine _
...
#End Region
    ...
    '2015.04.22 商品マスタの件数チェック 追加START
#Region "SELECT_M_GOODS_DETAILS(セミEDI時)"

    Private Const SQL_SELECT_M_GOODS_CNT As String _
                              = "SELECT                                           " & vbNewLine _
                              & " COUNT(*)             AS  MST_CNT                " & vbNewLine _
                              & "FROM                                             " & vbNewLine _
                              & "(                                                " & vbNewLine _
                              ...
                              & "	 $LM_MST$..M_GOODS   MG                       " & vbNewLine _
                              & "--	 ON                                           " & vbNewLine _
                              & "--	 BIM.NRS_BR_CD   = MG.NRS_BR_CD               " & vbNewLine _
                              & "--	 AND                                          " & vbNewLine _
                              & "--	 BIM.GOODS_CD_NRS   = MG.GOODS_CD_NRS         " & vbNewLine _
                              & "	 LEFT JOIN                                    " & vbNewLine _
                              & "    $LM_MST$..M_CUST_DETAILS     M_CUST_DETAILS          " & vbNewLine _
                              & "    ON                                                   " & vbNewLine _
                              & "    M_CUST_DETAILS.NRS_BR_CD = MG.NRS_BR_CD              " & vbNewLine _
                              & "    AND                                                  " & vbNewLine _
                              & "    M_CUST_DETAILS.CUST_CD = MG.CUST_CD_L + MG.CUST_CD_M " & vbNewLine _
                              & "    AND                                                  " & vbNewLine _
                              & "    M_CUST_DETAILS.SUB_KB = '0D'                         " & vbNewLine _
                              & "    AND                                                  " & vbNewLine _
                              & "    M_CUST_DETAILS.SYS_DEL_FLG = '0'                     " & vbNewLine _
                              ...
                              & "    M_CUST_DETAILS.SYS_DEL_FLG = '0'                     " & vbNewLine _
                              & "--	 AND                                          " & vbNewLine _
                              & "--	 BIM.SYS_DEL_FLG = '0'                        " & vbNewLine _
                              & "	 AND                                          " & vbNewLine _
                              & "	 MG.SYS_DEL_FLG = '0'                         " & vbNewLine _
                              & "--	 AND                                          " & vbNewLine _
                              & "--	 MEC.SYS_DEL_FLG = '0'                        " & vbNewLine _
                              & "--	 GROUP BY                                     " & vbNewLine _
                              & "--	 BIM.GOODS_CD_NRS                             " & vbNewLine _
                              & "	 GROUP BY                                     " & vbNewLine _
                              & "	 MG.GOODS_CD_NRS                             " & vbNewLine _
                              & " ) MAIN                                          " & vbNewLine
    '= " SELECT                                                     " & vbNewLine _
    ...
    '& "-- MG.CUST_CD_M      = @CUST_CD_M                             " & vbNewLine _
    '& "-- AND                                                        " & vbNewLine _
    '& " MG.GOODS_CD_CUST  = @GOODS_CD_CUST                         " & vbNewLine

#End Region
    '2015.04.22 商品マスタの件数チェック 追加END

    '2015.04.22 EXCELデータ抽出条件 追加START
#Region "SELECT_Z_KBN(セミEDI時)"

    Private Const SQL_SELECT_ZKBN As String _
                    = " SELECT                                                " & vbNewLine _
                    & "  KBN.KBN_NM1             AS  KBN_NM1                  " & vbNewLine _
                    & " ,KBN.KBN_NM2             AS  KBN_NM2                  " & vbNewLine _
                    & " ,KBN.KBN_NM3             AS  KBN_NM3                  " & vbNewLine _
                    & " ,KBN.KBN_NM4             AS  KBN_NM4                  " & vbNewLine _
                    & " ,KBN.KBN_NM5             AS  KBN_NM5                  " & vbNewLine _
                    & " ,KBN.KBN_NM6             AS  KBN_NM6                  " & vbNewLine _
                    & " ,KBN.KBN_NM7             AS  KBN_NM7                  " & vbNewLine _
                    & " ,KBN.KBN_NM8             AS  KBN_NM8                  " & vbNewLine _
                    & " ,KBN.KBN_NM9             AS  KBN_NM9                  " & vbNewLine _
                    & " ,KBN.KBN_NM10            AS  KBN_NM10                 " & vbNewLine _
                    & " ,KBN.VALUE1              AS  VALUE1                   " & vbNewLine _
                    & " ,KBN.VALUE2              AS  VALUE2                   " & vbNewLine _
                    & " ,KBN.VALUE3              AS  VALUE3                   " & vbNewLine _
                    & " FROM                                                  " & vbNewLine _
                    & " $LM_MST$..Z_KBN               KBN                     " & vbNewLine _
                    & " WHERE                                                 " & vbNewLine _
                    & " KBN.KBN_GROUP_CD = @KBN_GROUP_CD                      " & vbNewLine _
                    & " AND                                                   " & vbNewLine _
                    & " KBN.KBN_NM1      = @KBN_CD                            " & vbNewLine

#End Region
    '2015.04.22 EXCELデータ抽出条件 追加END

#Region "EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)"

    Private Const SQL_SELECT_INKAEDI_DTL_BYK_DUP_CNT As String = "" _
        & "SELECT                                                           " & vbNewLine _
        & "    COUNT(*) AS CNT                                              " & vbNewLine _
        & "FROM                                                             " & vbNewLine _
        & "    $LM_TRN$..$RCV_DTL$ INKAEDI_DTL_BYK                          " & vbNewLine _
        & "WHERE                                                            " & vbNewLine _
        & "    INKAEDI_DTL_BYK.DEL_KB = @DEL_KB                             " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.NRS_BR_CD = @NRS_BR_CD                       " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.NRS_WH_CD = @NRS_WH_CD                       " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.CUST_CD_L = @CUST_CD_L                       " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.CUST_CD_M = @CUST_CD_M                       " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.DELIVERY = @DELIVERY                         " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.DELIVERY_DATE = @DELIVERY_DATE               " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.ITEM_NO = @ITEM_NO                           " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.MATERIAL = @MATERIAL                         " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.[DESCRIPTION] = @DESCRIPTION                 " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.DERIVERY_QUANTITY = @DERIVERY_QUANTITY       " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.SALES_UNIT = @SALES_UNIT                     " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.NET_WEIGHT = @NET_WEIGHT                     " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.BUSINESS_UNIT = @BUSINESS_UNIT               " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.PICK_STATUS = @PICK_STATUS                   " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.PURCHASING_DOCUMENT = @PURCHASING_DOCUMENT   " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.REF_ITEM = @REF_ITEM                         " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.EXTERNAL_DELIVERY_ID = @EXTERNAL_DELIVERY_ID " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.BATCH = @BATCH                               " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.VENDOR = @VENDOR                             " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.STORAGE_LOCATION = @STORAGE_LOCATION         " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG       " & vbNewLine _
        & "AND INKAEDI_DTL_BYK.SYS_DEL_FLG = @SYS_DEL_FLG                   " & vbNewLine _
        & ""

#End Region ' "EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)"
...
#Region "H_INKAEDI_L(セミEDI)"
    ...
    Private Function InsertInkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_INKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))

        'パラメータ設定
        Call Me.SetInsertInkaEdiLParameter(Me._Row, Me._SqlPrmList, LMH010DAC.EventShubetsu.TORIKOMI)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertInkaEdiL", cmd)
...
#Region "H_INKAEDI_M(セミEDI)"
    ...
    Private Function InsertInkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_INKAEDI_M _
                                                                       , setDs.Tables("LMH010_INKAEDI_M").Rows(0).Item("NRS_BR_CD").ToString()))
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        '条件rowの格納
        Me._Row = dtInkaEdiM.Rows(0)

        'パラメータ設定
        Call Me.SetInsertInkaEdiMParameter(Me._Row, Me._SqlPrmList, LMH030DAC.EventShubetsu.TORIKOMI)
        Call Me.SetDataInsertParameter()
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC109", "InsertInkaEdiM", cmd)
...
#Region "H_INKAEDI_DTL_BYK(セミEDI)"
    ...
    Private Function InsertInkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtInkaEdiRcvDtl As DataTable = setDs.Tables("LMH010_INKAEDI_DTL_BYK")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_INKAEDI_DTL, setDs.Tables("LMH010_INKAEDI_DTL_BYK").Rows(0).Item("NRS_BR_CD").ToString())

        '受信DTLテーブル名設定
        Dim drSemiEdiInfo As DataRow = setDs.Tables("LMH010_SEMIEDI_INFO").Rows(0)
        Dim RcvNm As String = drSemiEdiInfo.Item("RCV_NM_DTL").ToString()
        sql = sql.Replace("$RCV_DTL$", RcvNm)
        ...
        '条件rowの格納
        Me._Row = dtInkaEdiRcvDtl.Rows(0)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertInkaEdiRcvDtl", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH010_INKAEDI_DTL_BYK")
        Dim dtToriDtl As DataTable = ds.Tables("LMH010_EDI_TORIKOMI_DTL")
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC102.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        'If String.IsNullOrEmpty(dtRcvDtl.Rows(0).Item("CUST_CD_L").ToString()) = True Then
        If String.IsNullOrEmpty(dtToriDtl.Rows(0).Item("COLUMN_19").ToString()) = True Then
            Me._StrSql.Append(LMH010DAC102.SQL_WHERE1_M_GOODS)
        Else
            Me._StrSql.Append(LMH010DAC102.SQL_WHERE2_M_GOODS)
        End If

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH010DAC102.SQL_GROUP_BY_M_GOODS)

        'パラメータ設定
        Call Me.SetSelectMstGoodsParameter(drSemiEdiInfo, dtToriDtl, dtRcvDtl)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "SelectDataMgoods", cmd)
...
#Region "商品マスタ(セミEDI：荷主商品コードより抽出)"
    ...
    Private Function CheckGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC102.SQL_SELECT_M_GOODS_CNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "CheckGoods", cmd)
...
#Region "区分マスタ(汎用抽出)"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        Dim drRcvDtl As DataRow = ds.Tables("LMH010_JUDGE").Rows(0)
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH010_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC102.SQL_SELECT_ZKBN)

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetSelectkbnParameter(drRcvDtl)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "SelectDataZkbn", cmd)
        ...
        If reader.HasRows() = True Then
            ...
            ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH010_Z_KBN")

            '処理件数の設定
            kbnCnt = ds.Tables("LMH010_Z_KBN").Rows.Count

        End If

        reader.Close()

        MyBase.SetResultCount(kbnCnt)
        Return ds
...
#Region "EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)"
    ...
    ''' <summary>
    ''' EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectInkaediDtlBykDupCnt(ByVal ds As DataSet) As DataSet

        Dim drRcvDtl As DataRow = ds.Tables("LMH010_INKAEDI_DTL_BYK").Rows(0)
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH010_SEMIEDI_INFO").Rows(0)
        ...
        ' SQL作成
        Me._StrSql.Append(LMH010DAC102.SQL_SELECT_INKAEDI_DTL_BYK_DUP_CNT)

        Me._SqlPrmList = New ArrayList()

        ' パラメータ設定
        SetSelectInkaediDtlBykDupCntParameter(drRcvDtl)

        ' スキーマ設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), drSemiEdiInfo.Item("NRS_BR_CD").ToString())

        ' 受信DTLテーブル名設定
        sql = sql.Replace("$RCV_DTL$", drSemiEdiInfo.Item("RCV_NM_DTL").ToString())
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_BYK                       " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
...
#Region "H_INKAEDI_M(同一データ DELIVERY+MATERIAL+BACHI同一データ更新処理)"
    ''' <summary>
    ''' EDI入荷(中)セミEDI(同一データの場合は入荷個数を更新)
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_EDIT_INKAEDI_M As String _
...
#Region "INKA_L(入荷登録まとめ)"
    ''' <summary>
    ''' INKA_L(入荷登録まとめ)
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPD_MATOME_INKA_L As String = "UPDATE                                         " & vbNewLine _
...
#Region "H_INKAEDI_L(まとめ先の更新用)"
    ''' <summary>
    ''' H_INTKAEDI_LのUPDATE文（H_INTKAEDI_L）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_MATOMESAKI_INKAEDI_L As String = "UPDATE $LM_TRN$..H_INKAEDI_L SET      " & vbNewLine _
                                              & " FREE_C30          = @FREE_C30                        " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                        " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                        " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                        " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC102.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC102.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "SelectEdiM", cmd)
...
#Region "EDI受信(DTL)新規追加パラメータ設定"
    ...
    Private Sub SetInsertInkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@NRS_WH_CD", Me.NullConvertString(.Item("NRS_WH_CD")), DBDataType.NVARCHAR))
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY", Me.NullConvertString(.Item("DELIVERY")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DELIVERY_DATE", Me.NullConvertString(.Item("DELIVERY_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@ITEM_NO", Me.NullConvertString(.Item("ITEM_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MATERIAL", Me.NullConvertString(.Item("MATERIAL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DESCRIPTION", Me.NullConvertString(.Item("DESCRIPTION")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DERIVERY_QUANTITY", Me.NullConvertString(.Item("DERIVERY_QUANTITY")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@BUSINESS_UNIT", Me.NullConvertString(.Item("BUSINESS_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SALES_UNIT", Me.NullConvertString(.Item("SALES_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NET_WEIGHT", Me.NullConvertString(.Item("NET_WEIGHT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@PICK_STATUS", Me.NullConvertString(.Item("PICK_STATUS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PURCHASING_DOCUMENT", Me.NullConvertString(.Item("PURCHASING_DOCUMENT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REF_ITEM", Me.NullConvertString(.Item("REF_ITEM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXTERNAL_DELIVERY_ID", Me.NullConvertString(.Item("EXTERNAL_DELIVERY_ID")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BATCH", Me.NullConvertString(.Item("BATCH")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@VENDOR", Me.NullConvertString(.Item("VENDOR")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@STORAGE_LOCATION", Me.NullConvertString(.Item("STORAGE_LOCATION")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@INKA_USER", "", DBDataType.VARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@INKA_DATE", "", DBDataType.VARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@INKA_TIME", "", DBDataType.VARCHAR))
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC102.SQL_UPD_INKATOROKU_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC102.SQL_UPD_INKATOROKU_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "UpdateEdiM", cmd)
...
#Region "H_INKAEDI_M(セミEDI)同一データの場合の更新"
    ''' <summary>
    ''' EDI入荷(中)テーブル更新処理(セミEDI)
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI入荷(中)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateInkaEdiM(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim dtInkaEdiL As DataTable = setDs.Tables("LMH010_INKAEDI_M")
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_UPDATE_EDIT_INKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "UpdateInkaEdiM", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC102.SQL_UPDATE_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertInkaS", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC102.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC102", "InsertUnchinData", cmd)
...
#Region "INKA_L（まとめ登録）"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function UpdateInkaLMatome(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "UpdateInkaLMatome", cmd)
...
#Region "UNSO_L（まとめ登録）"
    ...
    Private Function UpdateUnsoLMatome(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtUnso As DataTable = ds.Tables("LMH010_UNSO_L")
        Dim dtIn As DataTable = ds.Tables("LMH010INOUT")
        Dim nrsBrCd As String = dtIn.Rows(0)("NRS_BR_CD").ToString()
        Dim setSql As String = String.Empty

        'INTableの条件rowの格納
        Me._Row = dtUnso.Rows(0)
        ...
        setSql = LMH010DAC102.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        'SQLパラメータ設定
        Call Me.SetSysdataParameter()
        Call Me.SetUnsoLComParameter(dtUnso.Rows(0))
        Call Me.SetHaitaDateTime(dtUnso.Rows(0))
...
#Region "まとめ先EDI入荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Dim dtEventShubetsu As Integer = Convert.ToInt32(ds.Tables("LMH010_JUDGE").Rows(0)("EVENT_SHUBETSU"))
        Dim setSql As String = String.Empty
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH010DAC102.SQL_UPDATE_MATOMESAKI_INKAEDI_L
        ...
        'パラメータ設定
        Call Me.SetIntkaEdiLMatomeParameter(inTbl.Rows(0), Me._SqlPrmList, dtEventShubetsu)
        Call Me.SetSysdataParameter()
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC102", "UpdateMatomesakiEdiLData", cmd)
...
#Region "EDI入荷(大)新規追加パラメータ設定"

    ''' <summary>
    ''' EDI入荷(大)の新規追加パラメータ設定
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetInsertInkaEdiLParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList, ByVal eventShubetsu As Integer)
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@INKA_PLAN_QT", Me.NullConvertString(.Item("INKA_PLAN_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@INKA_PLAN_QT_UT", Me.NullConvertString(.Item("INKA_PLAN_QT_UT")), DBDataType.VARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@INKA_TTL_NB", Me.NullConvertString(.Item("INKA_TTL_NB")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@HOKAN_FREE_KIKAN", Me.NullConvertString(.Item("HOKAN_FREE_KIKAN")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@UNCHIN", Me.NullConvertString(.Item("UNCHIN")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@FREE_N01", Me.NullConvertString(.Item("FREE_N01")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N02", Me.NullConvertString(.Item("FREE_N02")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N03", Me.NullConvertString(.Item("FREE_N03")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N04", Me.NullConvertString(.Item("FREE_N04")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N05", Me.NullConvertString(.Item("FREE_N05")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N06", Me.NullConvertString(.Item("FREE_N06")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N07", Me.NullConvertString(.Item("FREE_N07")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N08", Me.NullConvertString(.Item("FREE_N08")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N09", Me.NullConvertString(.Item("FREE_N09")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@FREE_N10", Me.NullConvertString(.Item("FREE_N10")), DBDataType.NUMERIC))
            ...
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_PGID", MyBase.GetPGID(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", Me.NullConvertString(.Item("DEL_KB")), DBDataType.VARCHAR))
...
#Region "EDI入荷(中)新規追加パラメータ設定"

    ''' <summary>
    ''' EDI入荷(中)の新規追加パラメータ設定
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetInsertInkaEdiMParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList, ByVal eventShubetsu As Integer)
        With conditionRow

            Dim updTime As String = Me.GetColonEditTime(MyBase.GetSystemTime())

            '2015.06.01 ビックケミー修正START
            'パラメータ設定
            prmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(.Item("DEL_KB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(.Item("NRS_BR_CD")), DBDataType.VARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(.Item("EDI_CTL_NO")), DBDataType.VARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_PGID", MyBase.GetPGID(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_UPD_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", .Item("DEL_KB"), DBDataType.VARCHAR))
            '2015.06.01 ビックケミー修正END
...
#Region "更新パラメータ設定(INKA_S)"
    ...
    Private Sub SetInkaSComParameter(ByVal row As DataRow)
        ...
        'ビックケミー 特殊設定　追加START
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_COND_KB_3", row.Item("GOODS_COND_KB_3").ToString(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CRT_DATE", row.Item("GOODS_CRT_DATE").ToString(), DBDataType.CHAR))
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectMstGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtToriDtl As DataTable, ByVal dtRcvDtl As DataTable)

        If String.IsNullOrEmpty(dtToriDtl.Rows(0).Item("COLUMN_19").ToString()) = True Then
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", semiInfoDr.Item("NRS_BR_CD"), DBDataType.CHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", dtToriDtl.Rows(0).Item("COLUMN_4").ToString(), DBDataType.NVARCHAR))
        Else
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", dtRcvDtl.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(dtRcvDtl.Rows(0).Item("MATERIAL")), DBDataType.NVARCHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(dtRcvDtl.Rows(0).Item("CUST_CD_L")), DBDataType.CHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(dtRcvDtl.Rows(0).Item("CUST_CD_M")), DBDataType.CHAR))
        End If
    ...
    Private Sub SetSelectChkGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", semiInfoDr.Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", dtRcvDtl.Rows(0).Item("COLUMN_4").ToString(), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", semiInfoDr.Item("CUST_CD_L"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", semiInfoDr.Item("CUST_CD_M"), DBDataType.CHAR))
...
#Region "区分マスタパラメータ設定(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectkbnParameter(ByVal drRcvDtl As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KBN_GROUP_CD", drRcvDtl.Item("KBN_GROUP_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KBN_CD", drRcvDtl.Item("KBN_CD"), DBDataType.CHAR))

    End Sub

#End Region

#Region "パラメータ設定 EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)"

    ''' <summary>
    ''' パラメータ設定 EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetSelectInkaediDtlBykDupCntParameter(ByVal drRcvDtl As DataRow)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(drRcvDtl.Item("DEL_KB")), DBDataType.NVARCHAR))

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(drRcvDtl.Item("NRS_BR_CD")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_WH_CD", Me.NullConvertString(drRcvDtl.Item("NRS_WH_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(drRcvDtl.Item("CUST_CD_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(drRcvDtl.Item("CUST_CD_M")), DBDataType.CHAR))

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DELIVERY", Me.NullConvertString(drRcvDtl.Item("DELIVERY")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DELIVERY_DATE", Me.NullConvertString(drRcvDtl.Item("DELIVERY_DATE")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ITEM_NO", Me.NullConvertString(drRcvDtl.Item("ITEM_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MATERIAL", Me.NullConvertString(drRcvDtl.Item("MATERIAL")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DESCRIPTION", Me.NullConvertString(drRcvDtl.Item("DESCRIPTION")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DERIVERY_QUANTITY", Me.NullConvertZero(drRcvDtl.Item("DERIVERY_QUANTITY")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SALES_UNIT", Me.NullConvertString(drRcvDtl.Item("SALES_UNIT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NET_WEIGHT", Me.NullConvertZero(drRcvDtl.Item("NET_WEIGHT")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BUSINESS_UNIT", Me.NullConvertString(drRcvDtl.Item("BUSINESS_UNIT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PICK_STATUS", Me.NullConvertString(drRcvDtl.Item("PICK_STATUS")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PURCHASING_DOCUMENT", Me.NullConvertString(drRcvDtl.Item("PURCHASING_DOCUMENT")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@REF_ITEM", Me.NullConvertString(drRcvDtl.Item("REF_ITEM")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EXTERNAL_DELIVERY_ID", Me.NullConvertString(drRcvDtl.Item("EXTERNAL_DELIVERY_ID")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@BATCH", Me.NullConvertString(drRcvDtl.Item("BATCH")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@VENDOR", Me.NullConvertString(drRcvDtl.Item("VENDOR")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@STORAGE_LOCATION", Me.NullConvertString(drRcvDtl.Item("STORAGE_LOCATION")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(drRcvDtl.Item("JISSEKI_SHORI_FLG")), DBDataType.VARCHAR))

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", Me.NullConvertString(drRcvDtl.Item("DEL_KB")), DBDataType.CHAR))

    End Sub

#End Region ' "パラメータ設定 EDI受信データ(DTL) 今回登録分との重複件数取得 (セミEDI時)"
...
#Region "まとめ先EDI入荷(大)更新パラメータ設定"

    ''' <summary>
    ''' まとめ先EDI入荷(大)の更新パラメータ設定
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetIntkaEdiLMatomeParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList, ByVal eventShubetsu As Integer)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@INKA_CTL_NO_L", Me.NullConvertString(.Item("INKA_NO_L")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@FREE_C30", String.Concat("05-", .Item("EDI_CTL_NO").ToString())))
            prmList.Add(MyBase.GetSqlParameter("@UPD_USER", MyBase.GetUserID(), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UPD_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@UPD_TIME", updTime))
