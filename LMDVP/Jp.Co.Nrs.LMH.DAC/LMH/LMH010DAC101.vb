...
#Region "SELECT_SEND(日医工専用)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_SELECT_SEND_NIK As String = "SELECT                                                              " & vbNewLine _
                                              & "  '0'                               AS DEL_KB                         " & vbNewLine _
                                              ...
                                              & "  --要望番号1204 2012.06.26 追加START                                 " & vbNewLine _
                                              & " ,SUBSTRING(INKA_L.OUTKA_FROM_ORD_NO_L,1,10)   AS DENP_NO             " & vbNewLine _
                                              & "  --要望番号1204 2012.06.26 追加END                                   " & vbNewLine _
                                              & " ,EDI_L.FREE_C06                    AS SIIRE_CD                       " & vbNewLine _
                                              & " ,DTL_NIK.INKA_PLAN_DATE            AS INKA_PLAN_DATE                 " & vbNewLine _
                                              & " ,DTL_NIK.GYO_NO                    AS GYO_NO                         " & vbNewLine _
                                              & " ,DTL_NIK.MAKER_CD + M_GOODS.GOODS_CD_CUST     AS GOODS_CD_NIK        " & vbNewLine _
                                              & " ,CASE MIN(INKA_S.LOT_NO)                                             " & vbNewLine _
                                              & "  WHEN ''   THEN '00000000000000000000'                               " & vbNewLine _
                                              & "  WHEN NULL THEN '00000000000000000000'                               " & vbNewLine _
                                              & "  ELSE MAX(INKA_S.LOT_NO)                                             " & vbNewLine _
                                              & "  END                               AS SEIZO_NO                       " & vbNewLine _
                                              & " ,SUBSTRING(MIN(ZAI_TRS.LT_DATE),1,6) + '00'        AS YUKOU_KIGEN    " & vbNewLine _
                                              & "-- ,SUBSTRING(MIN(INKA_S.LT_DATE),1,6) + '00'        AS YUKOU_KIGEN   " & vbNewLine _
                                              & "-- ,DTL_NIK.YUKOU_KIGEN               AS YUKOU_KIGEN                  " & vbNewLine _
                                              & " ,DTL_NIK.INKA_PLAN_NB              AS INKA_PLAN_NB                   " & vbNewLine _
                                              & " ,SUM(INKA_S.KONSU * M_GOODS.PKG_NB + INKA_S.HASU) AS INKA_NB         " & vbNewLine _
                                              ...
                                              & " ,EDI_M.FREE_C03                    AS INKA_KB                        " & vbNewLine _
                                              ...
                                              & " INNER JOIN $LM_TRN$..D_ZAI_TRS      ZAI_TRS                          " & vbNewLine _
                                              & "  ON  ZAI_TRS.SYS_DEL_FLG <> '1'                                      " & vbNewLine _
                                              & "  AND ZAI_TRS.NRS_BR_CD = INKA_S.NRS_BR_CD                            " & vbNewLine _
                                              & "  --要望番号1204 2012.06.28 修正START                                   " & vbNewLine _
                                              ...
                                              & "  AND ZAI_TRS.ZAI_REC_NO = INKA_S.ZAI_REC_NO                            " & vbNewLine _
                                              & "  --要望番号1204 2012.06.28 修正END                                   " & vbNewLine _
                                              ...
                                              & " INNER JOIN $LM_TRN$..H_INKAEDI_DTL_NIK  DTL_NIK                      " & vbNewLine _
                                              ...
                                              & "  --要望番号1204 2012.06.28 追加START                                 " & vbNewLine _
                                              & "  AND M_GOODS.NRS_BR_CD = INKA_M.NRS_BR_CD                            " & vbNewLine _
                                              & "  --要望番号1204 2012.06.28 追加END                                   " & vbNewLine _
                                              ...
                                              & "  DTL_NIK.CRT_DATE                                                    " & vbNewLine _
                                              & " ,DTL_NIK.FILE_NAME                                                   " & vbNewLine _
                                              & " ,DTL_NIK.REC_NO                                                      " & vbNewLine _
                                              & " ,DTL_NIK.GYO                                                         " & vbNewLine _
                                              ...
                                              & " ,DTL_NIK.MAKER_CD                                                    " & vbNewLine _
                                              & " ,DTL_NIK.KYOTEN_CD                                                   " & vbNewLine _
                                              & " ,INKA_L.OUTKA_FROM_ORD_NO_L                                          " & vbNewLine _
                                              & " ,EDI_L.FREE_C06                                                      " & vbNewLine _
                                              & " ,DTL_NIK.INKA_PLAN_DATE                                              " & vbNewLine _
                                              & " ,DTL_NIK.GYO_NO                                                      " & vbNewLine _
                                              & " ,DTL_NIK.MAKER_CD + M_GOODS.GOODS_CD_CUST                            " & vbNewLine _
                                              & "-- ,DTL_NIK.YUKOU_KIGEN                                               " & vbNewLine _
                                              & " ,DTL_NIK.INKA_PLAN_NB                                                " & vbNewLine _
                                              & " ,INKA_L.INKA_DATE                                                    " & vbNewLine _
                                              & " ,M_GOODS.PKG_NB                                                      " & vbNewLine _
                                              & " ,EDI_M.FREE_C03                                                      " & vbNewLine
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_NIK                       " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPDATE_RCV_DTL_NIK As String = "UPDATE $LM_TRN$..H_INKAEDI_DTL_NIK SET        " & vbNewLine _
...
#Region "H_SENDINEDI_NIK"

    Private Const SQL_INSERT_SEND_NIK As String = "INSERT INTO $LM_TRN$..H_SENDINEDI_NIK " & vbNewLine _
                                              & "(                               " & vbNewLine _
                                              & " DEL_KB                         " & vbNewLine _
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC101.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC101.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理(日医工専用)"
    ''' <summary>
    ''' 実績送信データ取得処理(日医工専用)
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectSendNichiiko(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC101.SQL_SELECT_SEND_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "SelectSendNichiiko", cmd)
        ...
        '取得データの格納先をマッピング
        map = Me.SetMapSendNichiiko()

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_SENDINEDI_NIK")
        reader.Close()
...
#Region "M_GOODS"
    ...
    Private Function SelectDataSeihinNik(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC101.SQL_SELECT_M_SEHIN_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "SelectDataSeihinNik", cmd)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC101.SQL_UPD_INKATOROKU_EDI_L

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC101.SQL_UPD_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC101.SQL_UPD_INKATOROKU_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC101.SQL_UPD_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "UpdateEdiM", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC101.SQL_UPDATE_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC101.SQL_UPDATE_RCV_DTL_NIK
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertInkaS", cmd)
...
#Region "H_SENDINEDI_NIK"
    ...
    Private Function InsertSendNichiiko(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("H_SENDINEDI_NIK")

        '営業所コード
        Dim brCd As String = inTbl.Rows(0).Item("NRS_BR_CD").ToString()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_SEND_NIK, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertSendNichiiko", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC101.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC101", "InsertUnchinData", cmd)
...
#Region "INKA_L"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC101.SQL_SELECT_INKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC101", "SelectDataOrderCheck", cmd)
...
#Region "挿入パラメータ設定(H_SENDINEDI_NIK)"
    Private Sub SetPrmSendIn(ByVal row As DataRow)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(row.Item("CUST_CD_L")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(row.Item("CUST_CD_M")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@MAKER_CD", Me.NullConvertString(row.Item("MAKER_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KYOTEN_CD", Me.NullConvertString(row.Item("KYOTEN_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DENP_NO", Me.NullConvertString(row.Item("DENP_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SIIRE_CD", Me.NullConvertString(row.Item("SIIRE_CD")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_PLAN_DATE", Me.NullConvertString(row.Item("INKA_PLAN_DATE")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GYO_NO", Me.NullConvertString(row.Item("GYO_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NIK", Me.NullConvertString(row.Item("GOODS_CD_NIK")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SEIZO_NO", Me.NullConvertString(row.Item("SEIZO_NO")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YUKOU_KIGEN", Me.NullConvertString(row.Item("YUKOU_KIGEN")), DBDataType.NVARCHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_PLAN_NB", Me.NullConvertZero(row.Item("INKA_PLAN_NB")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_NB", Me.NullConvertZero(row.Item("INKA_NB")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_DATE", Me.NullConvertString(row.Item("INKA_DATE")), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PKG_NB", Me.NullConvertZero(row.Item("PKG_NB")), DBDataType.NUMERIC))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@INKA_KB", Me.NullConvertString(row.Item("INKA_KB")), DBDataType.NVARCHAR))
...
#Region "マッピング配列作成"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetMapSendNichiiko() As Hashtable
