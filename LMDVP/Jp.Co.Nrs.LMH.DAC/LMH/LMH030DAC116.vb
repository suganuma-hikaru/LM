...
#Region "H_OUTKAEDI_DTL_EST(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_DTL_EST）
    ''' </summary>
    ''' <remarks></remarks>

    Private Const SQL_INSERT_OUTKAEDI_DTL_EST As String = "INSERT INTO    " & vbNewLine _
                                        & "$LM_TRN$..H_OUTKAEDI_DTL_EST   " & vbNewLine _
                                        & "(                                " & vbNewLine _
                                        & " DEL_KB                          " & vbNewLine _
                                        ...
                                        & ",ORDER_DTL_NO    " & vbNewLine _
                                        & ",ORDER_KBN       " & vbNewLine _
                                        & ",KOKYAKU_KBN     " & vbNewLine _
                                        & ",GAIBU_ORDER_NO  " & vbNewLine _
                                        & ",IRAINUSI_KANA   " & vbNewLine _
                                        & ",IRAINUSI_NM     " & vbNewLine _
                                        & ",IRAINUSI_ZIP    " & vbNewLine _
                                        & ",IRAINUSI_ADD1   " & vbNewLine _
                                        & ",IRAINUSI_ADD2   " & vbNewLine _
                                        & ",IRAINUSI_ADD3   " & vbNewLine _
                                        & ",IRAINUSI_ADD4   " & vbNewLine _
                                        & ",IRAINUSI_TEL    " & vbNewLine _
                                        & ",DEST_KBN        " & vbNewLine _
                                        & ",DEST_KANA       " & vbNewLine _
                                        & ",DEST_NM         " & vbNewLine _
                                        ...
                                        & ",SEIBETU         " & vbNewLine _
                                        & ",SAGYO_SIJIBI    " & vbNewLine _
                                        & ",JYUCHU_TIME     " & vbNewLine _
                                        & ",ITEM_NO         " & vbNewLine _
                                        & ",ITEM_KIKAKU     " & vbNewLine _
                                        & ",TANI_NM         " & vbNewLine _
                                        & ",ITEM_TANKA      " & vbNewLine _
                                        & ",GENTANK         " & vbNewLine _
                                        & ",CHUMONSU        " & vbNewLine _
                                        & ",SOURYO          " & vbNewLine _
                                        & ",TESURYO         " & vbNewLine _
                                        & ",TAX             " & vbNewLine _
                                        & ",TOTAL_AMT       " & vbNewLine _
                                        & ",DENPYO_TOTAL_AMT   " & vbNewLine _
                                        & ",HAITATU_KIBOUBI    " & vbNewLine _
                                        & ",HAITATU_SITEI_YOUBI  " & vbNewLine _
                                        & ",HAITATU_SITEI_JIKAN  " & vbNewLine _
                                        & ",BIKO                " & vbNewLine _
                                        & ",SHIHARAI_KBN        " & vbNewLine _
                                        & ",HAISO_KBN           " & vbNewLine _
                                        & ",DENP_KBN            " & vbNewLine _
                                        & ",CSV_BARCODE_INFO    " & vbNewLine _
                                        & ",DATA_KBN            " & vbNewLine _
                                        & ",NOSI_KBN            " & vbNewLine _
                                        & ",HINSITU_KBN         " & vbNewLine _
                                        & ",TANTO               " & vbNewLine _
                                        & ",KIJI                " & vbNewLine _
                                        & ",IRREGULAR_DTL_AMT   " & vbNewLine _
                                        & ",DTL_SYOKEI          " & vbNewLine _
                                        & ",HANYO7              " & vbNewLine _
                                        & ",HANYO8              " & vbNewLine _
                                        & ",DENP_TAX_AMT        " & vbNewLine _
                                        & ",DENP_JYUCHU_AMT     " & vbNewLine _
                                        & ",DENP_DEST_NM        " & vbNewLine _
                                        & ",DENP_ZIP            " & vbNewLine _
                                        & ",DENP_ADD1           " & vbNewLine _
                                        & ",DENP_ADD2           " & vbNewLine _
                                        & ",DENP_ADD3           " & vbNewLine _
...
#Region "商品マスタ"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC116.SQL_WHERE1_M_GOODS)

        'ADD 2016/07/20 フィルメ対応
        If ds.Tables("LMH030_M_CUST_DETAILS").Select("SUB_KB='0L'").Count > 0 Then
            'SQL条件設定(Where + 入り目を追加)
            Me._StrSql.Append(LMH030DAC116.SQL_WHERE1_M_GOODS_FLM)

        End If

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC116.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectDataMgoods", cmd)
...
#Region "荷主明細マスタ（SUB_KB=87）"
    ...
    Private Function SelectMstCustD87(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.SELECT_M_CUST_DETL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC116.SQL_WHERE1_M_CUST_DETAILS)
...
#Region "荷主明細マスタ（SUB_KB=0L）"
    ...
    Private Function SelectMstCustD0L(ByVal ds As DataSet) As DataSet
        ...
        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC116.SQL_WHERE1_M_CUST_DETAILS_FIR)
...
#Region "届先マスタ"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC116.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectDataMdestOutkaToroku", cmd)
...
#Region "区分マスタ"
    ...
    Private Function SelectDataZkbn(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.SQL_SELECT_Z_KBN)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectDataZkbn", cmd)
...
#Region "キャンセルデータ抽出"
    Private Function SelectCancelData(ByVal ds As DataSet) As DataSet
        ...
        If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals(LMConst.FLG.ON) = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC116.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC116.SQL_WHERE_CANCER_DATA_DTL)

            'オーダー番号＋オーダー番号明細チェックの場合
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("3") = True Then
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC116.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC116.SQL_WHERE_CANCER_DATA_DTL_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("4") = True Then
            ...
            Me._StrSql.Append(LMH030DAC116.SQL_SELECT_CANCER_DATA_DTL_CNT)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC116.SQL_WHERE_CANCER_DATA_DTL_ONLY_CNT)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("DTL_DATACHECK_FLG").ToString().Equals("5") = True Then
            ...
            Me._StrSql.Append(LMH030DAC116.SQL_SELECT_CANCER_DATA_DTL)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC116.SQL_WHERE_CANCER_DATA_DTL_M_FREE_C25)
            '2015.04.28 Ｍ・Ｒ・Ｃデュポン対応 M_FREE_C25_NOの(オーダー番号明細のみ)チェックの場合 追加END
        Else
            'SQL作成(SELECT)
            Me._StrSql.Append(LMH030DAC116.SQL_SELECT_CANCER_DATA)
            'SQL作成(WHERE)
            Me._StrSql.Append(LMH030DAC116.SQL_WHERE_CANCER_DATA)
        End If
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectCancelData", cmd)
...
#Region "受信テーブル同一データ抽出"
    ...
    '    If ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_EST") = True Then
    '        'スキーマ設定
    '        sql = Me.SetSchemaNm(LMH030DAC116.SQL_SELECT_COMPARE_CHECK_MRC, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
    '    End If
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectCompareData", cmd)
...
#Region "荷主明細マスタ（SUB_KB検索条件に含まない）"
    ...
    Private Function SelectMstCustAll(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.SELECT_M_CUST_DETL_ALL)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC116.SQL_WHERE_M_CUST_DETAILS_ALL)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC116.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC116.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC116.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC116.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI：受信テーブル取消更新)"
    ...
    Private Function UpdateDelRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Dim sql As String = Me.SetSchemaNm(LMH030DAC116.SQL_UPDATE_DEL_OUTKAIEDI_DTL, ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateDelRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_UPDATE_EDIT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateEditOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)同一データ整合性差異有りの場合の更新"
    ...
    Private Function UpdateEditOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_UPDATE_EDIT_OUTKAEDI_M, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateEditOutkaEdiM", cmd)
...
#Region "出荷登録処理用EDIデータ 抽出処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC116.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "SelectEdiM", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC116.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateOutkaLData", cmd)
    ...
    Private Function UpdateOutkaLDataWithBuyerOrdNo(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録(まとめ時)
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC116.SQL_UPDATE_OUTKAL_MATOME_WITH_BUYER_ORD_NO
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC116.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC116.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(自動更新用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC116", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertUnchinData", cmd)
...
#Region "M_DEST(自動追加用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertMDestData", cmd)
...
#Region "EDI受信(DTL)同一パラメータ設定"
    ...
    Private Sub SetCompareDataParameter(ByVal ds As DataSet)
        ...
        ElseIf ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("RCV_NM_DTL").ToString().Equals("H_OUTKAEDI_DTL_EST") = True Then
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = String.Empty
        sql = Me.SetSchemaNm(LMH030DAC116.SQL_INSERT_OUTKAEDI_DTL_EST, setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC116", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal setDs As DataSet, ByVal prmList As ArrayList)
        ...
        'CSV内容を全て設定
        'seq(連番)
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_FREE_N03_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@SEQ", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))

        '注文番号 2
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_CUST_ORD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@ORDER_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))

        '注文明細番号 3
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_ORD_NO_DTL_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@ORDER_DTL_NO", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))

        '注文区分 4
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_FREE_C01_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@ORDER_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))

        '顧客区分 5
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_FREE_C02_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@KOKYAKU_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))

        '外部顧客番号 6
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_BUYER_ORD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@GAIBU_ORDER_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))

        '依頼主カナ 7　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_KANA", Me.NullConvertString(""), DBDataType.NVARCHAR))
        '依頼主名称 8　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_NM", Me.NullConvertString(""), DBDataType.NVARCHAR))
        '依頼主郵便番号 9　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ZIP", Me.NullConvertString(""), DBDataType.VARCHAR))
        '依頼主住所１ 10　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD1", Me.NullConvertString(""), DBDataType.NVARCHAR))
        '依頼主住所２ 11　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD2", Me.NullConvertString(""), DBDataType.NVARCHAR))
        '依頼主住所3 12　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD3", Me.NullConvertString(""), DBDataType.NVARCHAR))
        '依頼主住所４ 13　未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD4", Me.NullConvertString(""), DBDataType.NVARCHAR))
        '依頼主電話番号 14 未設定
        prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_TEL", Me.NullConvertString(""), DBDataType.VARCHAR))
        '届先区分 15 未設定
        prmList.Add(MyBase.GetSqlParameter("@DEST_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        '届先カナ 16 未設定
        prmList.Add(MyBase.GetSqlParameter("@DEST_KANA", Me.NullConvertString(""), DBDataType.NVARCHAR))

        '届先名称 17
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_NM_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))

        '届先郵便番号 18
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_ZIP_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_ZIP", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))

        '届先住所１ 19
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_AD_1_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_ADD1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))

        '届先住所２ 20
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_AD_2_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_ADD2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))

        '届先住所３ 21
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_AD_3_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_ADD3", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))

        '届先住所4 22
        prmList.Add(MyBase.GetSqlParameter("@DEST_ADD4", Me.NullConvertString(""), DBDataType.NVARCHAR))

        '届先電話番号 23
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_DEST_TEL_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@DEST_TEL", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))

        '性別 24
        prmList.Add(MyBase.GetSqlParameter("@SEIBETU", Me.NullConvertString(""), DBDataType.VARCHAR))

        '
        prmList.Add(MyBase.GetSqlParameter("@SAGYO_SIJIBI", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@JYUCHU_TIME", Me.NullConvertString(""), DBDataType.VARCHAR))

        '商品番号 27
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_CUST_GOODS_CD_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@ITEM_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.VARCHAR))


        prmList.Add(MyBase.GetSqlParameter("@ITEM_KIKAKU", Me.NullConvertString(""), DBDataType.VARCHAR))


        prmList.Add(MyBase.GetSqlParameter("@TANI_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_29")), DBDataType.VARCHAR))

        prmList.Add(MyBase.GetSqlParameter("@ITEM_TANKA", Me.NullConvertZero(0), DBDataType.NUMERIC))

        prmList.Add(MyBase.GetSqlParameter("@GENTANK", Me.NullConvertZero(0), DBDataType.NUMERIC))

        '申込数量 32 （個数）
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_OUTKA_TTL_NB_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@CHUMONSU", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NUMERIC))

        prmList.Add(MyBase.GetSqlParameter("@SOURYO", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@TESURYO", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@TAX", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@TOTAL_AMT", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@DENPYO_TOTAL_AMT", Me.NullConvertZero(0), DBDataType.NUMERIC))

        '配達希望日 38
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("L_ARR_PLAN_DATE_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@HAITATU_KIBOUBI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))

        prmList.Add(MyBase.GetSqlParameter("@HAITATU_SITEI_YOUBI", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@HAITATU_SITEI_JIKAN", Me.NullConvertString(""), DBDataType.VARCHAR))

        '備考 41
        setColKey = String.Concat("COLUMN_", setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("M_REMARK_NO").ToString())
        prmList.Add(MyBase.GetSqlParameter("@BIKO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item(setColKey)), DBDataType.NVARCHAR))

        prmList.Add(MyBase.GetSqlParameter("@SHIHARAI_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@HAISO_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@CSV_BARCODE_INFO", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DATA_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@NOSI_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@HINSITU_KBN", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@TANTO", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@KIJI", Me.NullConvertString(""), DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@IRREGULAR_DTL_AMT", Me.NullConvertZero(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DTL_SYOKEI", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@HANYO7", Me.NullConvertString(""), DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@HANYO8", Me.NullConvertString(""), DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_TAX_AMT", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@DENP_JYUCHU_AMT", Me.NullConvertZero(0), DBDataType.NUMERIC))
        prmList.Add(MyBase.GetSqlParameter("@DENP_DEST_NM", Me.NullConvertString(""), DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_ZIP", Me.NullConvertString(""), DBDataType.VARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_ADD1", Me.NullConvertString(""), DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_ADD2", Me.NullConvertString(""), DBDataType.NVARCHAR))
        prmList.Add(MyBase.GetSqlParameter("@DENP_ADD3", Me.NullConvertString(""), DBDataType.NVARCHAR))

        '----修正前　退避
        'テキスト内容を全て設定
        'prmList.Add(MyBase.GetSqlParameter("@SEQ", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_1")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@ORDER_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_2")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@ORDER_DTL_NO", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_3")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@ORDER_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_4")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@KOKYAKU_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_5")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@GAIBU_ORDER_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_6")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_KANA", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_7")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_8")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ZIP", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_9")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_10")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_11")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD3", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_12")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_ADD4", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_13")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRAINUSI_TEL", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_14")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_15")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_KANA", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_16")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_17")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_ZIP", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_18")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_ADD1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_19")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_ADD2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_20")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_ADD3", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_21")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_ADD4", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_22")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DEST_TEL", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_23")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@SEIBETU", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_24")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@SAGYO_SIJIBI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_25")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@JYUCHU_TIME", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_26")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@ITEM_NO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_27")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@ITEM_KIKAKU", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_28")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@TANI_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_29")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@ITEM_TANKA", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_30")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@GENTANK", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_31")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@CHUMONSU", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_32")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@SOURYO", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_33")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@TESURYO", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_34")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@TAX", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_35")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@TOTAL_AMT", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_36")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@DENPYO_TOTAL_AMT", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_37")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@HAITATU_KIBOUBI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_38")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@HAITATU_SITEI_YOUBI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_39")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@HAITATU_SITEI_JIKAN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_40")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@BIKO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_41")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@SHIHARAI_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_42")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@HAISO_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_43")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_44")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@CSV_BARCODE_INFO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_45")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DATA_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_46")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@NOSI_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_47")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@HINSITU_KBN", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_48")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@TANTO", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_49")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@KIJI", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_50")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@IRREGULAR_DTL_AMT", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_51")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DTL_SYOKEI", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_52")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@HANYO7", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_53")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@HANYO8", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_54")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_TAX_AMT", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_55")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_JYUCHU_AMT", Me.NullConvertZero(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_56")), DBDataType.NUMERIC))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_DEST_NM", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_57")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_ZIP", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_58")), DBDataType.VARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_ADD1", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_59")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_ADD2", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_60")), DBDataType.NVARCHAR))
        'prmList.Add(MyBase.GetSqlParameter("@DENP_ADD3", Me.NullConvertString(setDs.Tables("LMH030_EDI_TORIKOMI_DTL").Rows(0).Item("COLUMN_61")), DBDataType.NVARCHAR))
        '----
        'EDI受信（DTL）共通項目
