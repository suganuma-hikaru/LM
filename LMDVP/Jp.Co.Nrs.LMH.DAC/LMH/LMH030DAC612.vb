...
#Region "SQL_SELECT_A_TORIHIKI_KBN_MOTO"

    Private Const SQL_SELECT_A_TORIHIKI_KBN_MOTO As String = "" _
        & "SELECT TOP 1                     " & vbNewLine _
        & "    A_TORIHIKI_KBN               " & vbNewLine _
        & "FROM                             " & vbNewLine _
        & "    $LM_TRN$..H_OUTKAEDI_DTL_BAH " & vbNewLine _
        & "WHERE                            " & vbNewLine _
...
#End Region ' "SQL_SELECT_A_TORIHIKI_KBN_MOTO"

#Region "SQL_SELECT_A_TORIHIKI_KBN_SAKI"

    Private Const SQL_SELECT_A_TORIHIKI_KBN_SAKI As String = "" _
        & "SELECT TOP 1                     " & vbNewLine _
        & "    A_TORIHIKI_KBN               " & vbNewLine _
        & "FROM                             " & vbNewLine _
        & "    $LM_TRN$..H_OUTKAEDI_DTL_BAH " & vbNewLine _
...
#End Region ' "SQL_SELECT_A_TORIHIKI_KBN_SAKI"
...
#Region "H_OUTKAEDI_DTL_BAH"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_BAH）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BAH SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "実績作成処理 データ抽出用SQL"
    ...
    Private Const SQL_SELECT_SEND_DATA As String = "SELECT                                              " & vbNewLine _
                                          & "   '0' AS DEL_KB                                           " & vbNewLine _
                                          & "  ,DTL_BAH.CRT_DATE                                        " & vbNewLine _
                                          & "  ,DTL_BAH.FILE_NAME                                       " & vbNewLine _
                                          & "  ,DTL_BAH.REC_NO                                          " & vbNewLine _
                                          & "  ,DTL_BAH.GYO_NO AS GYO                                   " & vbNewLine _
                                          ...
                                          & "  ,DTL_BAH.OBIC_SHUBETU                                    " & vbNewLine _
                                          & "  ,DTL_BAH.OBIC_TORIHIKI_KBN                               " & vbNewLine _
                                          & "  ,DTL_BAH.OBIC_DENP_NO                                    " & vbNewLine _
                                          & "  ,DTL_BAH.OBIC_GYO_NO                                     " & vbNewLine _
                                          & "  ,DTL_BAH.OBIC_DETAIL_NO                                  " & vbNewLine _
                                          & "  ,OUT_M.OUTKA_NO_L                                        " & vbNewLine _
                                          & "  ,OUT_M.OUTKA_NO_M                                        " & vbNewLine _
                                          & "  ,'' AS NA_NO                                             " & vbNewLine _
                                          & "  ,'' AS NA_GYO                                            " & vbNewLine _
                                          & "  ,'' AS NA_NB                                             " & vbNewLine _
                                          & "  ,'' AS NA_PKG                                            " & vbNewLine _
                                          & "  ,'' AS NA_HASU                                           " & vbNewLine _
                                          & "  ,'' AS NA_LOT_NO                                         " & vbNewLine _
                                          & "  ,'' AS NA_LT_DATE                                        " & vbNewLine _
                                          & "  ,OUT_L.OUTKA_PLAN_DATE AS OUTKA_DATE                     " & vbNewLine _
                                          & "  ,DTL_BAH.GOODS_CD                                        " & vbNewLine _
                                          & "  ,DTL_BAH.GOODS_RANK                                      " & vbNewLine _
                                          & "  ,DTL_BAH.NB                                              " & vbNewLine _
                                          & "  ,DTL_BAH.LOT_NO                                          " & vbNewLine _
                                          & "  ,CASE DTL_BAH.LT_DATE                                    " & vbNewLine _
                                          & "        WHEN '----/--/--' THEN ''                          " & vbNewLine _
                                          & "        ELSE DTL_BAH.LT_DATE                               " & vbNewLine _
                                          & "        END AS LT_DATE                                     " & vbNewLine _
                                          & "  ,DTL_BAH.YOBI1                                           " & vbNewLine _
                                          & "  ,DTL_BAH.YOBI2                                           " & vbNewLine _
                                          & "  ,DTL_BAH.YOBI3                                           " & vbNewLine _
                                          & "  ,DTL_BAH.YOBI4                                           " & vbNewLine _
                                          & "  ,DTL_BAH.YOBI5                                           " & vbNewLine _
                                          & "  ,OUT_S.REMARK AS NHS_INFO                                " & vbNewLine _
                                          ...
                                          & "      AND OUT_S.REMARK LIKE '納品案内書%'                  " & vbNewLine _
                                          & "  INNER JOIN                                               " & vbNewLine _
                                          & "    $LM_TRN$..H_OUTKAEDI_DTL_BAH AS DTL_BAH                " & vbNewLine _
                                          & "    ON                                                     " & vbNewLine _
                                          & "          DTL_BAH.DEL_KB <> '1'                            " & vbNewLine _
                                          & "      AND DTL_BAH.NRS_BR_CD = EDI_M.NRS_BR_CD              " & vbNewLine _
                                          & "      AND DTL_BAH.EDI_CTL_NO = EDI_M.EDI_CTL_NO            " & vbNewLine _
                                          & "      AND DTL_BAH.EDI_CTL_NO_CHU = EDI_M.EDI_CTL_NO_CHU    " & vbNewLine _
                                          & "      AND DTL_BAH.JISSEKI_SHORI_FLG = '1'                  " & vbNewLine _
                                          & "WHERE                                                      " & vbNewLine _
...
#Region "H_SENDOUTEDI"
    ...
    Private Const SQL_INSERT_H_SENDOUTEDI As String = "INSERT INTO       " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_BAH       " & vbNewLine _
                                         & "(                                " & vbNewLine _
                                         & " DEL_KB                          " & vbNewLine _
                                         ...
                                         & ",NA_PKG                          " & vbNewLine _
                                         & ",NA_HASU                         " & vbNewLine _
                                         & ",NA_LOT_NO                       " & vbNewLine _
                                         & ",NA_LT_DATE                      " & vbNewLine _
                                         & ",OUTKA_DATE                      " & vbNewLine _
                                         & ",GOODS_CD                        " & vbNewLine _
                                         & ",GOODS_RANK                      " & vbNewLine _
                                         & ",NB                              " & vbNewLine _
                                         & ",LOT_NO                          " & vbNewLine _
                                         & ",LT_DATE                         " & vbNewLine _
                                         & ",YOBI1                           " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_BAH"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_BAH SET         " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNikMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC612.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectDataNikMdest", cmd)
...
#Region "案内書_取引区分(まとめ元)取得処理"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectA_TorihikiKbnMoto(ByVal ds As DataSet) As DataSet

        Return SelectA_TorihikiKbn(ds, getMoto:=True)
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectA_TorihikiKbnSaki(ByVal ds As DataSet) As DataSet

        Return SelectA_TorihikiKbn(ds, getMoto:=False)
    ...
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <param name="getMoto">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectA_TorihikiKbn(ByVal ds As DataSet, ByVal getMoto As Boolean) As DataSet
        ...
        Dim dt As DataTable
        If getMoto Then
            dt = ds.Tables("LMH030_OUTKAEDI_L")
        Else
            dt = ds.Tables("LMH030_MATOMESAKI_EDIL")
        End If
        ...
        ' SQL作成
        If getMoto Then
            Me._StrSql.Append(LMH030DAC612.SQL_SELECT_A_TORIHIKI_KBN_MOTO)
        Else
            Me._StrSql.Append(LMH030DAC612.SQL_SELECT_A_TORIHIKI_KBN_SAKI)
        End If

        Me._SqlPrmList = New ArrayList()

        ' パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me._Row.Item("NRS_BR_CD"), DBDataType.CHAR))
        If getMoto Then
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me._Row.Item("EDI_CTL_NO"), DBDataType.CHAR))
        Else
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO", Me._Row.Item("OUTKA_CTL_NO"), DBDataType.CHAR))
        End If
        ...
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(sql)
            ...
            Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
                ...
                If reader.HasRows() Then
                    ...
                    ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "H_OUTKAEDI_DTL_BAH")

                    ' 件数取得
                    destCnt = ds.Tables("H_OUTKAEDI_DTL_BAH").Rows.Count
...
#Region "M_GOODS"
    ...
    Private Function SelectDataSeihinNik(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_M_SEHIN_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectDataSeihinNik", cmd)
...
#Region "出荷(大)データ(オーダー番号チェック用)日医工専用"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_C_OUTKA_L_NIK)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectDataOrderCheckNik", cmd)
...
#Region "データ取得処理"
    ...
    Private Function SelectEdiSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_SEND_DATA)
        Call Me.setSQLSelectDataExists()                              '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectEdiSend", cmd)
        ...
        map.Add("NA_NO", "NA_NO")
        map.Add("NA_GYO", "NA_GYO")
        map.Add("NA_NB", "NA_NB")
        map.Add("NA_PKG", "NA_PKG")
        map.Add("NA_HASU", "NA_HASU")
        map.Add("NA_LOT_NO", "NA_LOT_NO")
        map.Add("NA_LT_DATE", "NA_LT_DATE")
        ...
        map.Add("YOBI4", "YOBI4")
        map.Add("YOBI5", "YOBI5")
        map.Add("NHS_INFO", "NHS_INFO")
        map.Add("RECORD_STATUS", "RECORD_STATUS")
        map.Add("JISSEKI_SHORI_FLG", "JISSEKI_SHORI_FLG")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_BAH")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_BAH").Rows.Count())
        reader.Close()
...
#Region "同一まとめレコード取得処理"
    ...
    Private Function SelectMatome(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_DATA_MATOME)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectMatome", cmd)
...
#Region "作業項目マスタ抽出"
    ...
    Private Function SelectMSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_M_SAGYO)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectMSagyo", cmd)
...
#Region "作業コード設定チェック"
    ...
    Private Function SelectSagyoCdSetCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_C_OUTKA_M_SAGYOCDSETCHECK)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectSagyoCdSetCheckData", cmd)
...
#Region "荷主明細マスタ抽出"
    ...
    Private Function SelectListDataMcustDetails(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_M_CUST_DETAILS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectListDataMcustDetails", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC612.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC612.SQL_UPDATE_JISSEKISAKUSEI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC612.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC612.SQL_UPDATE_JISSEKISAKUSEI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC612.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC612.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC612.SQL_UPDATE_OUTKAL_MATOME

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC612.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC612.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC612.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(日医工は自動更新を行う為、使用予定)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_NIK"
    ...
    Private Function InsertEdiSendData(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dowSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_BAH")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_H_SENDOUTEDI _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_BAH").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertEdiSendData", cmd)
...
#Region "M_DEST(日医工は自動追加を行う為、使用予定)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC612.SQL_INSERT_M_DEST_NIK, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "InsertMDestData", cmd)
...
#Region "EDI送信(TBL)新規登録パラメータ設定"
    ...
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(.Item("CUST_CD_L")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(.Item("CUST_CD_M")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OBIC_SHUBETU", Me.NullConvertString(.Item("OBIC_SHUBETU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OBIC_TORIHIKI_KBN", Me.NullConvertString(.Item("OBIC_TORIHIKI_KBN")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OBIC_DENP_NO", Me.NullConvertString(.Item("OBIC_DENP_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OBIC_GYO_NO", Me.NullConvertString(.Item("OBIC_GYO_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OBIC_DETAIL_NO", Me.NullConvertString(.Item("OBIC_DETAIL_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_NO_L", Me.NullConvertString(.Item("OUTKA_NO_L")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_NO_M", Me.NullConvertString(.Item("OUTKA_NO_M")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NA_NO", Me.NullConvertString(.Item("NA_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NA_GYO", Me.NullConvertString(.Item("NA_GYO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NA_NB", Me.NullConvertString(.Item("NA_NB")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NA_PKG", Me.NullConvertString(.Item("NA_PKG")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NA_HASU", Me.NullConvertString(.Item("NA_HASU")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@NA_LOT_NO", Me.NullConvertString(.Item("NA_LOT_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NA_LT_DATE", Me.NullConvertString(.Item("NA_LT_DATE")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@GOODS_RANK", Me.NullConvertString(.Item("GOODS_RANK")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@NB", Me.NullConvertString(.Item("NA_NB")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("NA_LOT_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@LT_DATE", Me.NullConvertString(.Item("LT_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOBI1", Me.NullConvertString(.Item("YOBI1")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOBI2", Me.NullConvertString(.Item("YOBI2")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOBI3", Me.NullConvertString(.Item("YOBI3")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOBI4", Me.NullConvertString(.Item("YOBI4")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@YOBI5", Me.NullConvertString(.Item("YOBI5")), DBDataType.CHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC612.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC612", "SelectDataMdestOutkaToroku", cmd)
