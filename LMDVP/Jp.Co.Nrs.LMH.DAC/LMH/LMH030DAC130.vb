...
#Region "SELECT_M_DEST"
    ...
    Private Const SELECT_COUNT_OUTKAEDI_L As String = " SELECT                                 " & vbNewLine _
                                     & " COUNT(0)                               AS DATA_COUNT  " & vbNewLine _
                                     & " FROM                                                  " & vbNewLine _
                                     & " $LM_TRN$..H_OUTKAEDI_L                                " & vbNewLine _
                                     & " WHERE                                                 " & vbNewLine _
                                     & " H_OUTKAEDI_L.DEL_KB = '0'                             " & vbNewLine _
                                     & " AND                                                   " & vbNewLine _
                                     & " H_OUTKAEDI_L.NRS_BR_CD   = @NRS_BR_CD                 " & vbNewLine _
                                     & " AND                                                   " & vbNewLine _
                                     & " H_OUTKAEDI_L.CUST_CD_L   = @CUST_CD_L                 " & vbNewLine _
                                     & " AND                                                   " & vbNewLine _
                                     & " H_OUTKAEDI_L.CUST_ORD_NO   = @CUST_ORD_NO             " & vbNewLine
...
#Region "H_OUTKAEDI_DTL_GK*"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DSP）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..$RCV_DTL$ SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "M_DEST(日本合成化学専用)UPDATE(届先項目差異有りの場合)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_NCGO As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "M_DEST(日本合成化学専用)UPDATE(荷送人コードより届先名称入替の場合)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_NCGO_SHIP_CD_L As String = "UPDATE $LM_MST$..M_DEST SET " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE     " & vbNewLine _
                                              & ",SYS_UPD_TIME      = @SYS_UPD_TIME     " & vbNewLine _
                                              & ",SYS_UPD_PGID      = @SYS_UPD_PGID     " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DSPGKY(INSERT)CSV用"
    Private Const SQL_INSERT_H_OUTKAEDI_DTL_DSPGKY_CSV As String = "INSERT INTO        " & vbNewLine _
                                    ...
                                    & " , PRTFLG                                       " & vbNewLine _
                                    & " , CSV_IDO_NO                                   " & vbNewLine _
                                    & " , CSV_IDO_DATE                                 " & vbNewLine _
                                    & " , CSV_IDO_KB                                   " & vbNewLine _
                                    & " , CSV_IDO_KB_NM                                " & vbNewLine _
                                    & " , CSV_ARR_PLAN_DATE                            " & vbNewLine _
                                    & " , CSV_REMARK                                   " & vbNewLine _
                                    & " , CSV_DEST_CD                                  " & vbNewLine _
                                    & " , CSV_DEST_ZIP                                 " & vbNewLine _
                                    & " , CSV_DEST_AD_1                                " & vbNewLine _
                                    & " , CSV_DEST_AD_2                                " & vbNewLine _
                                    & " , CSV_DEST_TEL                                 " & vbNewLine _
                                    & " , CSV_DEST_FAX                                 " & vbNewLine _
                                    & " , CSV_DEST_NM1                                 " & vbNewLine _
                                    & " , CSV_DEST_NM2                                 " & vbNewLine _
                                    & " , CSV_DEST_NM3                                 " & vbNewLine _
                                    & " , CSV_IDO_MOTO_CD                              " & vbNewLine _
                                    & " , CSV_IDO_MOTO_ZIP                             " & vbNewLine _
                                    & " , CSV_IDO_MOTO_AD_1                            " & vbNewLine _
                                    & " , CSV_IDO_MOTO_AD_2                            " & vbNewLine _
                                    & " , CSV_IDO_MOTO_TEL                             " & vbNewLine _
                                    & " , CSV_IDO_MOTO_FAX                             " & vbNewLine _
                                    & " , CSV_IDO_MOTO_NM1                             " & vbNewLine _
                                    & " , CSV_IDO_MOTO_NM2                             " & vbNewLine _
                                    & " , CSV_IDO_MOTO_NM3                             " & vbNewLine _
                                    & " , CSV_BLANK1                                   " & vbNewLine _
                                    & " , CSV_BLANK2                                   " & vbNewLine _
                                    & " , CSV_BLANK3                                   " & vbNewLine _
                                    & " , CSV_CUST_GOODS_CD                            " & vbNewLine _
                                    & " , CSV_GOODS_NM                                 " & vbNewLine _
                                    & " , CSV_STANDARD                                 " & vbNewLine _
                                    & " , CSV_PROPERTY_NO                              " & vbNewLine _
                                    & " , CSV_PROPERTY_NO_UNIT                         " & vbNewLine _
                                    & " , CSV_GOODS_RANK                               " & vbNewLine _
                                    & " , CSV_CTR_NO                                   " & vbNewLine _
                                    & " , CSV_ASTERRISK                                " & vbNewLine _
                                    & " , CSV_IDO_MOTO_TANABAN                         " & vbNewLine _
                                    & " , CSV_IDO_SAKI_TANABAN                         " & vbNewLine _
                                    & " , CSV_IRIME                                    " & vbNewLine _
                                    & " , CSV_LOAD_NO                                  " & vbNewLine _
                                    & " , CSV_BARA_NO                                  " & vbNewLine _
                                    & " , CSV_PACK_UT_NM                               " & vbNewLine _
                                    & " , CSV_BARA_UT_NM                               " & vbNewLine _
                                    & " , CSV_OUTKA_QT                                 " & vbNewLine _
                                    & " , CSV_QT_UT                                    " & vbNewLine _
                                    & " , CSV_ASSET_QT                                 " & vbNewLine _
                                    & " , CSV_ASSET_QT_UT                              " & vbNewLine _
                                    & " , CSV_IDO_TANKA                                " & vbNewLine _
                                    & " , CSV_IDO_KINGAKU                              " & vbNewLine _
                                    & " , CSV_DTL_APL                                  " & vbNewLine _
                                    & " , CSV_TANZAI_FLG                               " & vbNewLine _
                                    & " , CSV_IDO_TOTAL                                " & vbNewLine _
                                    & " , CSV_ASSET_OWNER_CD                           " & vbNewLine _
                                    & " , CSV_ASSET_OWNER_NM                           " & vbNewLine _
                                    & " , CSV_LOT_BIKOU1                               " & vbNewLine _
                                    & " , CSV_LOT_BIKOU2                               " & vbNewLine _
                                    & " , CSV_DENPYOU_GENKA_KINGAKU                    " & vbNewLine _
                                    & " , CSV_ZAIKO_BASHO_CD                           " & vbNewLine _
                                    & " , CSV_ZAIKO_BASHO_NM                           " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DSPGKY_EXL"
    Private Const SQL_INSERT_H_OUTKAEDI_DTL_DSPGKY_EXL As String = "INSERT INTO       " & vbNewLine _
                                    & "$LM_TRN$..$RCV_DTL$                            " & vbNewLine _
                                    & "(                                              " & vbNewLine _
                                    & "   DEL_KB                                      " & vbNewLine _
                                    & " , CRT_DATE                                    " & vbNewLine _
                                    ...
                                    & " , OUTKA_CTL_NO_CHU                            " & vbNewLine _
                                    & " , PRTFLG                                      " & vbNewLine _
                                    & " , EXL_OUTKA_PLAN_DATE                         " & vbNewLine _
                                    & " , EXL_OUTKA_DTE                               " & vbNewLine _
                                    & " , EXL_CUST_ORD_NO                             " & vbNewLine _
                                    & " , EXL_OFFICE_NM                               " & vbNewLine _
                                    & " , EXL_PERSON_NM                               " & vbNewLine _
                                    & " , EXL_GROUP_TEL                               " & vbNewLine _
                                    & " , EXL_GROUP_FAX                               " & vbNewLine _
                                    & " , EXL_CUSOMER_CD                              " & vbNewLine _
                                    & " , EXL_CUSOMER_NM                              " & vbNewLine _
                                    & " , EXL_DEST_ZIP                                " & vbNewLine _
                                    & " , EXL_DEST_CD                                 " & vbNewLine _
                                    & " , EXL_DEST_NM1                                " & vbNewLine _
                                    & " , EXL_DEST_NM2                                " & vbNewLine _
                                    & " , EXL_DEST_TEL                                " & vbNewLine _
                                    & " , EXL_DEST_FAX                                " & vbNewLine _
                                    & " , EXL_DEST_AD_1                               " & vbNewLine _
                                    & " , EXL_DEST_AD_2                               " & vbNewLine _
                                    & " , EXL_DEST_AD_3                               " & vbNewLine _
                                    & " , EXL_OFFICIAL_COMPANY_NM                     " & vbNewLine _
                                    & " , EXL_COMPANY_NM                              " & vbNewLine _
                                    & " , EXL_WH_CD                                   " & vbNewLine _
                                    & " , EXL_WH_NM                                   " & vbNewLine _
                                    & " , EXL_CUST_GOODS_CD                           " & vbNewLine _
                                    & " , EXL_GOODS_NM                                " & vbNewLine _
                                    & " , EXL_STANDARD                                " & vbNewLine _
                                    & " , EXL_PROPERTY_NO                             " & vbNewLine _
                                    & " , EXL_PROPERTY_NO_UNIT                        " & vbNewLine _
                                    & " , EXL_ORDER_NO                                " & vbNewLine _
                                    & " , EXL_ORDER_ROW_NO                            " & vbNewLine _
                                    & " , EXL_TRADE_KB                                " & vbNewLine _
                                    & " , EXL_GOODS_RANK_NM                           " & vbNewLine _
                                    & " , EXL_CTR_NO                                  " & vbNewLine _
                                    & " , EXL_LOT_NO                                  " & vbNewLine _
                                    & " , EXL_IRIME                                   " & vbNewLine _
                                    & " , EXL_LOAD_NO                                 " & vbNewLine _
                                    & " , EXL_KB_UT                                   " & vbNewLine _
                                    & " , EXL_BARA_NO                                 " & vbNewLine _
                                    & " , EXL_QUANTITY_UT                             " & vbNewLine _
                                    & " , EXL_TOTAL_NO                                " & vbNewLine _
                                    & " , EXL_REMARK                                  " & vbNewLine _
                                    & " , EXL_UNSO_ATT                                " & vbNewLine _
                                    & " , EXL_HIKIATE_BIKOU                           " & vbNewLine _
                                    & " , EXL_ARR_PLAN_DATE                           " & vbNewLine _
                                    & " , EXL_REMARK_M                                " & vbNewLine _
                                    & " , EXL_CUSTOMER_ORD_NO                         " & vbNewLine _
                                    & " , RECORD_STATUS                               " & vbNewLine _
                                    & " , JISSEKI_SHORI_FLG                           " & vbNewLine _
                                    & " , JISSEKI_USER                                " & vbNewLine _
                                    & " , JISSEKI_DATE                                " & vbNewLine _
...
#Region "H_OUTKAEDI_L(INSERT)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_OUTKAEDI_L As String = "INSERT INTO          " & vbNewLine _
                                         & "$LM_TRN$..H_OUTKAEDI_L        " & vbNewLine _
                                         & "(                          " & vbNewLine _
                                         & " DEL_KB                    " & vbNewLine _
                                         & ",NRS_BR_CD                 " & vbNewLine _
...
#Region "H_OUTKAEDI_M(INSERT)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_OUTKAEDI_M As String = "INSERT INTO          " & vbNewLine _
                                         & "$LM_TRN$..H_OUTKAEDI_M        " & vbNewLine _
                                         & "(                          " & vbNewLine _
                                         & " DEL_KB            " & vbNewLine _
                                         & ",NRS_BR_CD         " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_GK*(取込削除時)"

    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_GK*）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_SEMIEDI_DEL_DTL As String = "UPDATE $LM_TRN$..$RCV_DTL$ SET   " & vbNewLine _
...
#Region "H_OUTKAEDI_L(取込削除時)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    ''' '2012/04/03 Honmyo SYS_UPD_DATE,SYS_UPD_TIME,SYS_UPD_PGID,SYS_UPD_USER 追加
    Private Const SQL_UPDATE_OUTKASEMIEDI_DEL_L As String = " UPDATE                               " & vbNewLine _
                                         & " $LM_TRN$..H_OUTKAEDI_L                                " & vbNewLine _
                                         & " SET                                                   " & vbNewLine _
                                         & " DEL_KB = '1'                                          " & vbNewLine _
                                         & ",UPD_USER = @UPD_USER                                  " & vbNewLine _
...
#Region "H_OUTKAEDI_M(取込削除時)"
    ...
    ''' <remarks></remarks>
    ''' '2012/04/03 Honmyo SYS_UPD_DATE,SYS_UPD_TIME,SYS_UPD_PGID,SYS_UPD_USER 追加
    Private Const SQL_UPDATE_OUTKASEMIEDI_DEL_M As String = " UPDATE                               " & vbNewLine _
                                         & " $LM_TRN$..H_OUTKAEDI_M                                " & vbNewLine _
                                         & " SET                                                   " & vbNewLine _
                                         & " DEL_KB = '1'                                          " & vbNewLine _
                                         & ",UPD_USER = @UPD_USER                                  " & vbNewLine _
...
#Region "SELECT_M_GOODS_DTL(セミEDI時)"
    Private Const SQL_SELECT_M_GOODS_DTL As String = " SELECT                                           " & vbNewLine _
                                     & " COUNT(*)                       AS MST_CNT                      " & vbNewLine _
                                     & ",NRS_BR_CD                      AS  NRS_BR_CD                   " & vbNewLine _
                                     & ",GOODS_CD_NRS                   AS  GOODS_CD_NRS                " & vbNewLine _
                                     & ",CUST_CD_L                      AS  CUST_CD_L                   " & vbNewLine _
...
#Region "WHERE1_M_GOODS_DTL(セミEDI時)"
    Private Const SQL_WHERE1_M_GOODS_DTL As String = _
                                       " WHERE                                              " & vbNewLine _
                                     & " M_GOODS_DETAILS.NRS_BR_CD = @NRS_BR_CD             " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.CUST_CD_L = @CUST_CD_L             " & vbNewLine _
                                     & " AND                                                " & vbNewLine _
                                     & " M_GOODS_DETAILS.SET_NAIYO = @GOODS_CD_CUST         " & vbNewLine
...
#Region "セミEDI(画面取込)データ抽出用SQL"

#Region "H_OUTKAEDI_DTL_DSP(DSPAH) 取消データ抽出用"

    ''' <summary>
    ''' H_OUTKAEDI_DTL_DSP(DSPAH) 取消データ抽出用
    ''' </summary>
    ''' <remarks></remarks>
    ''' '2012/04/03 Honmyo ORDER項目をEDI_DATE,EDI_TIME,REC_NOに変更
    Private Const SQL_TORIKESI_DTL As String = " SELECT                                                               " & vbNewLine _
                                             ...
                                             & " WHERE                                                                " & vbNewLine _
                                             & " H_OUTKAEDI_DTL.DEL_KB        = '0'                                   " & vbNewLine _
                                             & " AND                                                                  " & vbNewLine _
                                             & " H_OUTKAEDI_DTL.NRS_BR_CD     = @NRS_BR_CD                            " & vbNewLine _
                                             & " AND                                                                  " & vbNewLine _
                                             & " H_OUTKAEDI_DTL.ZIF_SEIRI1    = @ZIF_SEIRI1                           " & vbNewLine _
                                             & " ORDER BY                                                             " & vbNewLine _
                                             & " EDI_DATE   DESC                                                      " & vbNewLine _
                                             & ",EDI_TIME   DESC                                                      " & vbNewLine _
                                             & ",ZIF_SEIRI2 DESC                                                      " & vbNewLine
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC130.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "SelectEdiL", cmd)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SelectEdiLCount(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Dim sql As String = LMH030DAC130.SELECT_COUNT_OUTKAEDI_L

        'スキーマ名設定
        sql = Me.SetSchemaNm(sql, Me._Row.Item("NRS_BR_CD").ToString())

        'パラメータ設定
        Call Me.setSQLSelectDataEdiOutkaLExists()                           '条件設定
        ...
        'SQLログの出力
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "SelectEdiLCount", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC130.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "SelectEdiM", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectDataMgoodsOutka(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC130.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC130.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC130.SQL_GROUP_BY_M_GOODS)

        'パラメータ設定
        Call Me.SetGoodsSemiParameter(semiInfoDr, rcvDtlDt)

        'スキーマ設定
        Dim sql As String = Me.SetSchemaNm(Me._StrSql.ToString(), rcvDtlDt.Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "SelectDataMgoodsOutka", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC130.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateEdiDelOutkaEdiL(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inCnsTbl As DataTable = ds.Tables("LMH030_DTL_DSPCOM_CANCELOUT")
        Dim setSql As String = String.Empty

        'INTableの条件rowの格納
        Me._Row = inCnsTbl.Rows(0)

        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        '出荷EDI CONST名
        setSql = LMH030DAC130.SQL_UPDATE_OUTKASEMIEDI_DEL_L

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(setSql, Me._Row.Item("NRS_BR_CD").ToString()))

        'パラメータ設定
        Call Me.SetUpdateOutkaSemiEdiDelParameter(Me._Row, Me._SqlPrmList)
        Call Me.SetSysdataParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateEdiDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC130.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(中)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateEdiDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        setSql = LMH030DAC130.SQL_UPDATE_OUTKASEMIEDI_DEL_M

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(setSql, Me._Row.Item("NRS_BR_CD").ToString()))
        Dim max As Integer = inCnsTbl.Rows.Count() - 1
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateEdiDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC130.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        '受信テーブル名判断
        '大日本住友製薬の場合
        If drIn.Item("EDI_CUST_INDEX").Equals("82") Then
            drIn.Item("RCV_NM_DTL") = "H_OUTKAEDI_DTL_DSP"
            '大日本住友製薬（動物薬）の場合
        ElseIf drIn.Item("EDI_CUST_INDEX").Equals("85") Then
            drIn.Item("RCV_NM_DTL") = "H_OUTKAEDI_DTL_DSPAH"
        End If
        '大阪対応　20120324　End

        '受信DTLテーブル名設定
        setSql = Me.SetRcvDtlTableNm(drIn, setSql)
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function UpdateEdiDelRcvDtlData(ByVal ds As DataSet) As DataSet


        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_DSPCOM_CANCELOUT")
        Dim semiDr As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        setSql = LMH030DAC130.SQL_UPDATE_SEMIEDI_DEL_DTL

        '受信DTLテーブル名設定
        setSql = Me.SetRcvDtlTableNmEDI(semiDr, setSql)

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(setSql, semiDr.Item("NRS_BR_CD").ToString()))
        ...
        'パラメータ設定
        Call Me.SetUpdateSemiEdiDelDtlParameter(Me._Row, Me._SqlPrmList)    'Update内容
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateEdiDelRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC130.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC130.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC130.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        If mDestShipCnt > 0 AndAlso ds.Tables("LMH030_M_DEST_SHIP_CD_L").Rows(0).Item("UPDATE_TARGET_FLG").Equals("1") = True Then
            inTbl = ds.Tables("LMH030_M_DEST_SHIP_CD_L")
        ElseIf mDestCnt > 0 AndAlso ds.Tables("LMH030_M_DEST").Rows(0).Item("UPDATE_TARGET_FLG").Equals("1") = True Then
        ...
        'SQL文のコンパイル
        If inTbl.TableName.Equals("LMH030_M_DEST_SHIP_CD_L") = True Then
            setSql = SQL_UPDATE_M_DEST_NCGO_SHIP_CD_L
        ElseIf inTbl.TableName.Equals("LMH030_M_DEST") = True Then
            setSql = SQL_UPDATE_M_DEST_NCGO
        End If
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(setSql, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertOutkaLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiLData(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_OUTKAEDI_L")

        'INTableの条件rowの格納
        Me._Row = rcvDtlDtTbl.Rows(0)
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_H_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))

        'パラメータ設定
        Call Me.SetOutkaEdiLComParameter(Me._Row, Me._SqlPrmList, LMH030DAC.EventShubetsu.TORIKOMI)
        Call Me.SetJissekiParameterEdiLM(Me._Row, LMH030DAC.EventShubetsu.TORIKOMI)
        Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertOutkaEdiLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC130", "UpdateOutkaMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI出荷(中)テーブル更新SQLの構築・発行</remarks>
    Private Function InsertOutkaEdiMData(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_OUTKAEDI_M")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_H_OUTKAEDI_M _
        ...
        'パラメータ設定
        Call Me.SetOutkaEdiMComParameter(Me._Row, Me._SqlPrmList, LMH030DAC.EventShubetsu.TORIKOMI)
        Call Me.SetJissekiParameterEdiLM(Me._Row, LMH030DAC.EventShubetsu.TORIKOMI)
        Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertOutkaEdiMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertMDestData", cmd)
...
#Region "H_OUTKAEDI_DTL_GKC(セミEDI)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function InsertEdiRcvDtlDataCsv(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_H_OUTKAEDI_DTL_GKC")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_H_OUTKAEDI_DTL_DSPGKY_CSV, setDs.Tables("LMH030_H_OUTKAEDI_DTL_GKC").Rows(0).Item("NRS_BR_CD").ToString())

        '受信DTLテーブル名設定
        Dim semiDr As DataRow = setDs.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        sql = Me.SetRcvDtlTableNmEDI(semiDr, sql)
        ...
        'パラメータ設定
        Call Me.SetEdiRcvDtlComParameterCsv(Me._Row, Me._SqlPrmList)
        Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC130", "InsertEdiRcvDtlDataCsv", cmd)
...
#Region "H_OUTKAEDI_DTL_GKE(セミEDI)"
    ''' <summary>
    ''' EDI受信(DTL)テーブル新規登録
    ''' </summary>
    ''' <param name="setDs">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI受信(DTL)テーブル更新SQLの構築・発行</remarks>
    Private Function InsertEdiRcvDtlDataExcel(ByVal setDs As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_H_OUTKAEDI_DTL_GKE")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC130.SQL_INSERT_H_OUTKAEDI_DTL_DSPGKY_EXL, setDs.Tables("LMH030_H_OUTKAEDI_DTL_GKE").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        'パラメータ設定
        Call Me.SetEdiRcvDtlComParameterExcel(Me._Row, Me._SqlPrmList)
        Call Me.SetDataInsertParameter(Me._SqlPrmList)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertEdiRcvDtlDataExcel", cmd)
...
#Region "受信DTLテーブル名設定"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetRcvDtlTableNm(ByVal dr As DataRow, ByVal sql As String) As String

        Dim rcvTblNm As String = dr.Item("RCV_NM_DTL").ToString()
...
#Region "EDI受信DTLテーブル名設定"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetRcvDtlTableNmEDI(ByVal dr As DataRow, ByVal sql As String) As String
...
#Region "EDI出荷(大,中),EDI受信TBL抽出パラメータ設定"
    ...
    Private Sub setSQLSelectDataEdiOutkaLExists()
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me._Row("CUST_ORD_NO").ToString(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SYS_UPD_DATE", Me._Row("SYS_UPD_DATE").ToString(), DBDataType.CHAR))
...
#Region "EDI受信(DTL)更新パラメータ設定Csv"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiRcvDtlComParameterCsv(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_NO", Me.NullConvertString(.Item("IDO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_DATE", Me.NullConvertString(.Item("IDO_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_KB", Me.NullConvertString(.Item("IDO_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_KB_NM", Me.NullConvertString(.Item("IDO_KB_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ARR_PLAN_DATE", Me.NullConvertString(.Item("ARR_PLAN_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_REMARK", Me.NullConvertString(.Item("REMARK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_CD", Me.NullConvertString(.Item("DEST_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_ZIP", Me.NullConvertString(.Item("DEST_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_AD_1", Me.NullConvertString(.Item("DEST_AD_1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_AD_2", Me.NullConvertString(.Item("DEST_AD_2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_TEL", Me.NullConvertString(.Item("DEST_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_FAX", Me.NullConvertString(.Item("DEST_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_NM1", Me.NullConvertString(.Item("DEST_NM1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_NM2", Me.NullConvertString(.Item("DEST_NM2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DEST_NM3", Me.NullConvertString(.Item("DEST_NM3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_CD", Me.NullConvertString(.Item("IDO_MOTO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_ZIP", Me.NullConvertString(.Item("IDO_MOTO_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_AD_1", Me.NullConvertString(.Item("IDO_MOTO_AD_1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_AD_2", Me.NullConvertString(.Item("IDO_MOTO_AD_2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_TEL", Me.NullConvertString(.Item("IDO_MOTO_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_FAX", Me.NullConvertString(.Item("IDO_MOTO_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_NM1", Me.NullConvertString(.Item("IDO_MOTO_NM1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_NM2", Me.NullConvertString(.Item("IDO_MOTO_NM2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_NM3", Me.NullConvertString(.Item("IDO_MOTO_NM3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_BLANK1", Me.NullConvertString(.Item("BLANK1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_BLANK2", Me.NullConvertString(.Item("BLANK2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_BLANK3", Me.NullConvertString(.Item("BLANK3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_CUST_GOODS_CD", Me.NullConvertString(.Item("CUST_GOODS_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_GOODS_NM", Me.NullConvertString(.Item("GOODS_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_STANDARD", Me.NullConvertString(.Item("STANDARD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_PROPERTY_NO", Me.NullConvertString(.Item("PROPERTY_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_PROPERTY_NO_UNIT", Me.NullConvertString(.Item("PROPERTY_NO_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_GOODS_RANK", Me.NullConvertString(.Item("GOODS_RANK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_CTR_NO", Me.NullConvertString(.Item("CTR_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ASTERRISK", Me.NullConvertString(.Item("ASTERRISK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_MOTO_TANABAN", Me.NullConvertString(.Item("IDO_MOTO_TANABAN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_SAKI_TANABAN", Me.NullConvertString(.Item("IDO_SAKI_TANABAN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IRIME", Me.NullConvertString(.Item("IRIME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_LOAD_NO", Me.NullConvertString(.Item("LOAD_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_BARA_NO", Me.NullConvertString(.Item("BARA_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_PACK_UT_NM", Me.NullConvertString(.Item("PACK_UT_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_BARA_UT_NM", Me.NullConvertString(.Item("BARA_UT_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_OUTKA_QT", Me.NullConvertString(.Item("OUTKA_QT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_QT_UT", Me.NullConvertString(.Item("QT_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ASSET_QT", Me.NullConvertString(.Item("ASSET_QT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ASSET_QT_UT", Me.NullConvertString(.Item("ASSET_QT_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_TANKA", Me.NullConvertString(.Item("IDO_TANKA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_KINGAKU", Me.NullConvertString(.Item("IDO_KINGAKU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DTL_APL", Me.NullConvertString(.Item("DTL_APL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_TANZAI_FLG", Me.NullConvertString(.Item("TANZAI_FLG")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_IDO_TOTAL", Me.NullConvertString(.Item("IDO_TOTAL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ASSET_OWNER_CD", Me.NullConvertString(.Item("ASSET_OWNER_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ASSET_OWNER_NM", Me.NullConvertString(.Item("ASSET_OWNER_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_LOT_BIKOU1", Me.NullConvertString(.Item("LOT_BIKOU1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_LOT_BIKOU2", Me.NullConvertString(.Item("LOT_BIKOU2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_DENPYOU_GENKA_KINGAKU", Me.NullConvertString(.Item("DENPYOU_GENKA_KINGAKU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ZAIKO_BASHO_CD", Me.NullConvertString(.Item("ZAIKO_BASHO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CSV_ZAIKO_BASHO_NM", Me.NullConvertString(.Item("ZAIKO_BASHO_NM")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@PRT_USER", Me.NullConvertString(.Item("PRT_USER")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PRT_DATE", Me.NullConvertString(.Item("PRT_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@PRT_TIME", Me.NullConvertString(.Item("PRT_TIME")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_DATE", Me.NullConvertString(.Item("OUTKA_DATE")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_TIME", Me.NullConvertString(.Item("OUTKA_TIME")), DBDataType.CHAR))
...
#Region "EDI受信(DTL)更新パラメータ設定Excel"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiRcvDtlComParameterExcel(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@EXL_OUTKA_PLAN_DATE", Me.NullConvertString(.Item("OUTKA_PLAN_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_OUTKA_DTE", Me.NullConvertString(.Item("OUTKA_DTE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_CUST_ORD_NO", Me.NullConvertString(.Item("CUST_ORD_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_OFFICE_NM", Me.NullConvertString(.Item("OFFICE_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_PERSON_NM", Me.NullConvertString(.Item("PERSON_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_GROUP_TEL", Me.NullConvertString(.Item("GROUP_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_GROUP_FAX", Me.NullConvertString(.Item("GROUP_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_CUSOMER_CD", Me.NullConvertString(.Item("CUSOMER_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_CUSOMER_NM", Me.NullConvertString(.Item("CUSOMER_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_ZIP", Me.NullConvertString(.Item("DEST_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_CD", Me.NullConvertString(.Item("DEST_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_NM1", Me.NullConvertString(.Item("DEST_NM1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_NM2", Me.NullConvertString(.Item("DEST_NM2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_TEL", Me.NullConvertString(.Item("DEST_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_FAX", Me.NullConvertString(.Item("DEST_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_AD_1", Me.NullConvertString(.Item("DEST_AD_1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_AD_2", Me.NullConvertString(.Item("DEST_AD_2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_DEST_AD_3", Me.NullConvertString(.Item("DEST_AD_3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_OFFICIAL_COMPANY_NM", Me.NullConvertString(.Item("OFFICIAL_COMPANY_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_COMPANY_NM", Me.NullConvertString(.Item("COMPANY_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_WH_CD", Me.NullConvertString(.Item("WH_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_WH_NM", Me.NullConvertString(.Item("WH_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_CUST_GOODS_CD", Me.NullConvertString(.Item("CUST_GOODS_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_GOODS_NM", Me.NullConvertString(.Item("GOODS_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_STANDARD", Me.NullConvertString(.Item("STANDARD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_PROPERTY_NO", Me.NullConvertString(.Item("PROPERTY_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_PROPERTY_NO_UNIT", Me.NullConvertString(.Item("PROPERTY_NO_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_ORDER_NO", Me.NullConvertString(.Item("ORDER_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_ORDER_ROW_NO", Me.NullConvertString(.Item("ORDER_ROW_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_TRADE_KB", Me.NullConvertString(.Item("TRADE_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_GOODS_RANK_NM", Me.NullConvertString(.Item("GOODS_RANK_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_CTR_NO", Me.NullConvertString(.Item("CTR_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_IRIME", Me.NullConvertString(.Item("IRIME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_LOAD_NO", Me.NullConvertString(.Item("LOAD_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_KB_UT", Me.NullConvertString(.Item("KB_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_BARA_NO", Me.NullConvertString(.Item("BARA_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_QUANTITY_UT", Me.NullConvertString(.Item("QUANTITY_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_TOTAL_NO", Me.NullConvertString(.Item("TOTAL_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_REMARK", Me.NullConvertString(.Item("REMARK")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_UNSO_ATT", Me.NullConvertString(.Item("UNSO_ATT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_HIKIATE_BIKOU", Me.NullConvertString(.Item("HIKIATE_BIKOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_ARR_PLAN_DATE", Me.NullConvertString(.Item("ARR_PLAN_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_REMARK_M", Me.NullConvertString(.Item("REMARK_M")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EXL_CUSTOMER_ORD_NO", Me.NullConvertString(.Item("CUSTOMER_ORD_NO")), DBDataType.NVARCHAR))
...
#Region "EDI出荷(大)更新パラメータ設定"
    ...
    Private Sub SetOutkaEdiLComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList, ByVal eventShubetsu As Integer)
        ...
        With conditionRow
            ...
            If eventShubetsu = LMH030DAC.EventShubetsu.TORIKOMI Then
...
#Region "EDI出荷(大)更新パラメータ設定(実績日時用)"
    ...
    Private Sub SetJissekiParameterEdiLM(ByVal row As DataRow, ByVal eventShubetsu As Integer)
        ...
        Select Case DirectCast(eventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE, LMH030DAC.EventShubetsu.TORIKOMI
...
#Region "EDI出荷(中)更新パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetOutkaEdiMComParameter(ByVal conditionRow As DataRow _
...
#Region "出荷(大)パラメータ設定(オーダー番号チェック用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetOutkaParameter(ByVal dt As DataTable)
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetGoodsSemiParameter(ByVal semiInfoDr As DataRow, ByVal rcvDtlDt As DataTable)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", rcvDtlDt.Rows(0).Item("NRS_BR_CD"), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(rcvDtlDt.Rows(0).Item("CUST_GOODS_CD")), DBDataType.NVARCHAR))
...
#Region "EDI受信DTLの削除UPDATE文(セミEDI用)"

    ''' <summary>
    ''' EDI受信DTLの削除UPDATE文(セミEDI用)
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetUpdateSemiEdiDelDtlParameter(ByVal rcvDtlDr As DataRow, ByVal prmList As ArrayList)

        'Update内容
        prmList.Add(MyBase.GetSqlParameter("@DELETE_EDI_NO", Me.NullConvertString(rcvDtlDr.Item("DELETE_EDI_NO")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@DELETE_EDI_NO_CHU", Me.NullConvertString(rcvDtlDr.Item("DELETE_EDI_NO_CHU")), DBDataType.CHAR))
        ...
        'Update条件
        prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(rcvDtlDr.Item("NRS_BR_CD")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(rcvDtlDr.Item("EDI_CTL_NO")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@CRT_DATE", Me.NullConvertString(rcvDtlDr.Item("CRT_DATE")), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@FILE_NAME", Me.NullConvertString(rcvDtlDr.Item("FILE_NAME")), DBDataType.NVARCHAR))
    End Sub
...
#Region "EDI出荷(大・小共通)の削除UPDATE文(セミEDI用)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetUpdateOutkaSemiEdiDelParameter(ByVal rcvDtlDr As DataRow, ByVal prmList As ArrayList)
...
#Region "EDI受信(DTL)削除データ抽出パラメータ設定"
    ...
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub setSQLSelectRcvDelData(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)

        'With conditionRow

        'prmList.Add(MyBase.GetSqlParameter("@DEL_KB", Me.NullConvertString(conditionRow.Item("DEL_KB").ToString()), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(conditionRow.Item("NRS_BR_CD").ToString()), DBDataType.CHAR))
        prmList.Add(MyBase.GetSqlParameter("@ZIF_SEIRI1", Me.NullConvertString(conditionRow.Item("ZIF_SEIRI1").ToString()), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC130.SQL_SELECT_M_DEST)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC130.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC", "SelectDataMdestOutkaToroku", cmd)
