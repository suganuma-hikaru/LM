...
'  EDI荷主ID　　　　:  122　　　 : ミマキエンジニアリング（121：片山ナルコよりコピー）
'  作  成  者       :  annen
' ==========================================================================
Imports System.Text
...
#Region "Const"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Enum MimakiArrivalColumns
        ''' <summary>
        ''' 出庫希望日
        ''' </summary>
        ''' <remarks></remarks>
...
#Region "H_OUTKAEDI_DTL_DSP(INSERT)"
    ...
    Private Const SQL_INSERT_H_OUTKAEDI_DTL_MMK As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",PRTFLG  " & vbNewLine _
                                        & ",GYO_NO	            " & vbNewLine _
                                        & ",SYUKKO_KIBOU_DATE	                " & vbNewLine _
                                        & ",PALETTE_NO	            " & vbNewLine _
                                        & ",BOX_NO	            " & vbNewLine _
                                        & ",KAKUNIN	                " & vbNewLine _
                                        & ",HINBAN	    " & vbNewLine _
                                        & ",HINMEI	        " & vbNewLine _
                                        & ",LOT_NO	                " & vbNewLine _
                                        & ",YUUKOU_KIGEN	        " & vbNewLine _
                                        & ",ZAIKO_SUU	            " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiLCount(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Dim sql As String = LMH030DAC122.SELECT_COUNT_OUTKAEDI_L
        ...
        'SQLログの出力
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectEdiLCount", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNcgoMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC122.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectDataNcgoMdest", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    '    'DataSetのIN情報を取得
    '    Dim inDtlTbl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_MMK")
    ...
    '    'SQL作成
    '    Me._StrSql.Append(LMH030DAC122.SQL_TORIKESI_DTL)      'SQL構築
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectRcvDtlDspComTorikesi", cmd)
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC122", "GetDtlTblNm", cmd)
...
#Region "商品マスタ(セミEDI：荷主商品コードより抽出)"
    ...
    Private Function CheckGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_EDI_TORIKOMI_DTL")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.SQL_SELECT_M_GOODS_CNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "CheckGoods", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectDataMgoodsOutka(ByVal ds As DataSet) As DataSet
        ...
        Dim rcvDtlDt As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_MMK")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC122.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC122.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectDataMgoods", cmd)
...
#Region "オーダー番号チェック"
    ...
    Private Function SelectOrderCheckData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.SQL_SELECT_C_OUTKA_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "SelectDataOrderCheck", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC122.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    '    '出荷EDI CONST名
    '    setSql = LMH030DAC122.SQL_UPDATE_OUTKASEMIEDI_DEL_L
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateEdiDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC122.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    '    'EDI出荷SQL
    '    setSql = LMH030DAC122.SQL_UPDATE_OUTKASEMIEDI_DEL_M
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateEdiDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC122.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    '    setSql = LMH030DAC122.SQL_UPDATE_SEMIEDI_DEL_DTL
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateEdiDelRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC122.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC122.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC122.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertOutkaLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiLData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_H_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertOutkaEdiLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC122", "UpdateOutkaMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiMData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_H_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL_DSP(セミEDI)"
    ...
    Private Function InsertEdiRcvDtlData(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim rcvDtlDtTbl As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_MMK")

        Dim rtn As Integer = 0

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_H_OUTKAEDI_DTL_MMK, setDs.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertEdiRcvDtlData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC122.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC122", "InsertMDestData", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetEdiRcvDtlComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@GYO_NO", Me.NullConvertString(.Item("GYO_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYUKKO_KIBOU_DATE", Me.NullConvertString(.Item("SYUKKO_KIBOU_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PALETTE_NO", Me.NullConvertString(.Item("PALETTE_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BOX_NO", Me.NullConvertString(.Item("BOX_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KAKUNIN", Me.NullConvertString(.Item("KAKUNIN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINBAN", Me.NullConvertString(.Item("HINBAN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMEI", Me.NullConvertString(.Item("HINMEI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YUUKOU_KIGEN", Me.NullConvertString(.Item("YUUKOU_KIGEN")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@ZAIKO_SUU", Me.NullConvertString(.Item("ZAIKO_SUU")), DBDataType.NUMERIC))
...
#End Region
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetColumnName(column As MimakiArrivalColumns) As String
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetGoodsSemiParameter(ByVal semiInfoDr As DataRow, ByVal rcvDtlDt As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(rcvDtlDt.Rows(0).Item("HINBAN")), DBDataType.NVARCHAR))
...
#Region "EDI取込時該当商品コード件数取得時商品マスタパラメータ設定"
    ...
    Private Sub SetSelectChkGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", dtRcvDtl.Rows(0).Item(GetColumnName(MimakiArrivalColumns.HINBAN)).ToString(), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC122.SQL_SELECT_M_DEST)
