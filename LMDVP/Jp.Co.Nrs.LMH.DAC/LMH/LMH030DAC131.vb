...
#Region "H_OUTKAEDI_DTL_DSP(INSERT)"
    ...
    Private Const SQL_INSERT_H_OUTKAEDI_DTL_DSP As String = "INSERT INTO    " & vbNewLine _
                                        ...
                                        & ",PRTFLG  " & vbNewLine _
                                        & ",OUTKA_PLAN_DATE  " & vbNewLine _
                                        & ",OUTKA_DTE  " & vbNewLine _
                                        & ",CUST_ORD_NO  " & vbNewLine _
                                        & ",OFFICE_NM  " & vbNewLine _
                                        & ",PERSON_NM  " & vbNewLine _
                                        & ",GROUP_TEL  " & vbNewLine _
                                        & ",GROUP_FAX  " & vbNewLine _
                                        & ",CUSOMER_CD  " & vbNewLine _
                                        & ",CUSOMER_NM  " & vbNewLine _
                                        ...
                                        & ",DEST_AD_2  " & vbNewLine _
                                        & ",DEST_AD_3  " & vbNewLine _
                                        & ",OFFICIAL_COMPANY_NM  " & vbNewLine _
                                        & ",COMPANY_NM  " & vbNewLine _
                                        & ",WH_CD  " & vbNewLine _
                                        & ",WH_NM  " & vbNewLine _
                                        & ",CUST_GOODS_CD  " & vbNewLine _
                                        & ",GOODS_NM  " & vbNewLine _
                                        & ",STANDARD  " & vbNewLine _
                                        & ",PROPERTY_NO  " & vbNewLine _
                                        & ",PROPERTY_NO_UNIT  " & vbNewLine _
                                        & ",ORDER_NO  " & vbNewLine _
                                        & ",ORDER_ROW_NO  " & vbNewLine _
                                        & ",TRADE_KB  " & vbNewLine _
                                        & ",GOODS_RANK_NM  " & vbNewLine _
                                        & ",CTR_NO  " & vbNewLine _
                                        & ",LOT_NO  " & vbNewLine _
                                        & ",IRIME  " & vbNewLine _
                                        & ",LOAD_NO  " & vbNewLine _
                                        & ",KB_UT  " & vbNewLine _
                                        & ",BARA_NO  " & vbNewLine _
                                        & ",QUANTITY_UT  " & vbNewLine _
                                        & ",TOTAL_NO  " & vbNewLine _
                                        & ",REMARK  " & vbNewLine _
                                        & ",UNSO_ATT  " & vbNewLine _
                                        & ",HIKIATE_BIKOU  " & vbNewLine _
                                        & ",ARR_PLAN_DATE  " & vbNewLine _
                                        & ",REMARK_M  " & vbNewLine _
                                        & ",CUSTOMER_ORD_NO  " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC131.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiLCount(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Dim sql As String = LMH030DAC131.SELECT_COUNT_OUTKAEDI_L
        ...
        'SQLログの出力
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectEdiLCount", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC131.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC131.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC131.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectDataNcgoMdest", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    '    'SQL作成
    '    Me._StrSql.Append(LMH030DAC131.SQL_TORIKESI_DTL)      'SQL構築
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectRcvDtlDspComTorikesi", cmd)
    ...
    '    MyBase.Logger.WriteSQLLog("LMH030DAC131", "GetDtlTblNm", cmd)
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectDataMgoodsOutka(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC131.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC131.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC131.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectDataMgoods", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC131.SQL_SELECT_C_OUTKA_L)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC131", "SelectDataOrderCheck", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC131.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateEdiDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        '出荷EDI CONST名
        setSql = LMH030DAC131.SQL_UPDATE_OUTKASEMIEDI_DEL_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateEdiDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC131.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateEdiDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        setSql = LMH030DAC131.SQL_UPDATE_OUTKASEMIEDI_DEL_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateEdiDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC131.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateEdiRcvDtlData", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateEdiDelRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        setSql = LMH030DAC131.SQL_UPDATE_SEMIEDI_DEL_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateEdiDelRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC131.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC131.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC131.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertOutkaLData", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiLData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_H_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertOutkaEdiLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC131", "UpdateOutkaMData", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiMData(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_H_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL_GKC(セミEDI)"
    ...
    Private Function InsertEdiRcvDtlData(ByVal setDs As DataSet) As DataSet
        ...
        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_H_OUTKAEDI_DTL_DSP, setDs.Tables("LMH030_H_OUTKAEDI_DTL_GKE").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertEdiRcvDtlData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC131.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC131", "InsertMDestData", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetEdiRcvDtlComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_DTE", Me.NullConvertString(.Item("OUTKA_DTE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_ORD_NO", Me.NullConvertString(.Item("CUST_ORD_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@OFFICE_NM", Me.NullConvertString(.Item("OFFICE_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PERSON_NM", Me.NullConvertString(.Item("PERSON_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GROUP_TEL", Me.NullConvertString(.Item("GROUP_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GROUP_FAX", Me.NullConvertString(.Item("GROUP_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUSOMER_CD", Me.NullConvertString(.Item("CUSOMER_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUSOMER_NM", Me.NullConvertString(.Item("CUSOMER_NM")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@DEST_NM1", Me.NullConvertString(.Item("DEST_NM1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DEST_NM2", Me.NullConvertString(.Item("DEST_NM2")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@OFFICIAL_COMPANY_NM", Me.NullConvertString(.Item("OFFICIAL_COMPANY_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@COMPANY_NM", Me.NullConvertString(.Item("COMPANY_NM")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@STANDARD", Me.NullConvertString(.Item("STANDARD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PROPERTY_NO", Me.NullConvertString(.Item("PROPERTY_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PROPERTY_NO_UNIT", Me.NullConvertString(.Item("PROPERTY_NO_UNIT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ORDER_NO", Me.NullConvertString(.Item("ORDER_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ORDER_ROW_NO", Me.NullConvertString(.Item("ORDER_ROW_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TRADE_KB", Me.NullConvertString(.Item("TRADE_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@GOODS_RANK_NM", Me.NullConvertString(.Item("GOODS_RANK_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CTR_NO", Me.NullConvertString(.Item("CTR_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOT_NO", Me.NullConvertString(.Item("LOT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@IRIME", Me.NullConvertString(.Item("IRIME")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@LOAD_NO", Me.NullConvertString(.Item("LOAD_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KB_UT", Me.NullConvertString(.Item("KB_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BARA_NO", Me.NullConvertString(.Item("BARA_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@QUANTITY_UT", Me.NullConvertString(.Item("QUANTITY_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOTAL_NO", Me.NullConvertString(.Item("TOTAL_NO")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@HIKIATE_BIKOU", Me.NullConvertString(.Item("HIKIATE_BIKOU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@ARR_PLAN_DATE", Me.NullConvertString(.Item("ARR_PLAN_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@REMARK_M", Me.NullConvertString(.Item("REMARK_M")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUSTOMER_ORD_NO", Me.NullConvertString(.Item("CUSTOMER_ORD_NO")), DBDataType.NVARCHAR))
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC131.SQL_SELECT_M_DEST)
