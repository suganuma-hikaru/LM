...
'  システム名       :  LM
'  サブシステム名   :  LMH       : 出荷管理
'  プログラムID     :  LMH583    : 納品書(埼玉BP・納品書　イエローハット)
'  作  成  者       :  渡部　剛
' ==========================================================================
Imports System.Text
...
#Region "出力件数処理 SQL"
    ...
    Private Const SQL_SELECT_CNT As String = " SELECT                                                              " & vbNewLine _
                                        ...
                                        & "             AND Z_KBN.KBN_CD        = '04'                             " & vbNewLine _
                                        & "  WHERE                                                                 " & vbNewLine _
                                        ...
                                        & "  AND OUTEDIL.FREE_C18 = '11500153'                                     " & vbNewLine _
                                        & "  AND OUTEDIL.DEL_KB = '0'                                              " & vbNewLine _
                                        & "    ) BASE                                                              " & vbNewLine _
                                        & "WHERE                                                                   " & vbNewLine _
...
#Region "検索処理 SQL"
    ...
    Private Const SQL_FROM As String = " --出荷(大)                                                                                         " & vbNewLine _
                                     ...
                                     & "             AND EDI_PRT.PRINT_TP  = '09'                                                           " & vbNewLine _
                                     & "       LEFT JOIN (                                                                                  " & vbNewLine _
                                     ...
                                     & "                      AND H_EDI_PRINT.PRINT_TP    = '09'                                            " & vbNewLine _
                                     ...
                                     & "                    AND M_CUSTRPT1.PTN_ID      = 'B4'                                               " & vbNewLine _
                                     ...
                                     & "                    AND M_CUSTRPT2.PTN_ID      = 'B4'                                               " & vbNewLine _
    ...
    '                                       & " AND BPHED.TOKUI_CD = '17930000'                             " & vbNewLine _
    ...
    Private Const SQL_EXISTS As String = "	 AND EXISTS (                                                                                        " & vbNewLine _
                                       ...
                                       & "--                AND HEDIPRINT.DENPYO_NO  = BPHED.DENPYO_NO                                             " & vbNewLine _
                                       & "                AND HEDIPRINT.DENPYO_NO  = BPHED.CUST_ORD_NO                                           " & vbNewLine _
                                       & "--(2013.02.27) BP新システム切替対応END                                                              " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH583IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMH583DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMH583DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMH583DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectOutputData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH583DAC.SQL_SELECT_CNT)      'SQL構築(出力件数)
        ...
        MyBase.Logger.WriteSQLLog("LMH583DAC", "SelectOutputData", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH583DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH583DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMH583DAC.SQL_WHERE)            'SQL構築(データ抽出用WHERE句)(新規)
        Me._StrSql.Append(LMH583DAC.SQL_EXISTS)           'SQL構築(データ抽出用SELECT句(AND EXISTS))(新規)

        '(2013.02.05)要望番号1822 -- START --
        'If Me._Row.Item("PRTFLG").ToString = "1" Then
        '    '出力済の場合
        '    'Me._StrSql.Append(LMH583DAC.SQL_WHERE)      'SQL構築(データ抽出用Where句)
        '    Call Me.SetConditionMasterSQL_OUT()
        'Else
        '    '未出力の場合
        '    Call Me.SetConditionMasterSQL()
        ...
        Me._StrSql.Append(LMH583DAC.SQL_EXISTS_WHERE) 'SQL構築(データ抽出用WHERE句(AND EXISTS))(新規)
        Me._StrSql.Append(LMH583DAC.SQL_ORDER_BY)     'SQL構築(データ抽出用ORDER BY句)
        Call Me.SetConditionPrintPatternMSQL()        '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH583DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH583OUT")
    ...
    Private Sub SetConditionMasterSQL()
        ...
        With Me._Row
            ...
            '(2013.02.27) BP新システム切替対応START
            'Me._StrSql.Append(vbNewLine)
            'Me._StrSql.Append("  AND OUTEDIL.FREE_C18 = '17930000' ")
            ''Me._StrSql.Append(" AND BPHED.TOKUI_CD = '17930000' ")
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("  AND OUTEDIL.FREE_C18 = '11500153' ")
            '(2013.02.27) BP新システム切替対応END
