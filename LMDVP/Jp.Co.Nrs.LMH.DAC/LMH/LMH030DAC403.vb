...
#Region "H_OUTKAEDI_L SELECT句"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                                      " & vbNewLine _
                                                ...
                                                & ",H_OUTKAEDI_HED_DPN.SYS_UPD_DATE                     AS RCV_SYS_UPD_DATE     " & vbNewLine _
                                                & ",H_OUTKAEDI_HED_DPN.SYS_UPD_TIME                     AS RCV_SYS_UPD_TIME     " & vbNewLine _
...
#Region "H_OUTKAEDI_L FROM句"
    ...
    Private Const SQL_FROM As String = "FROM                                                              " & vbNewLine _
                                        ...
                                        & "LEFT JOIN                                                      " & vbNewLine _
                                        & "$LM_TRN$..H_OUTKAEDI_HED_DPN                                   " & vbNewLine _
                                        & "ON                                                             " & vbNewLine _
                                        & "H_OUTKAEDI_L.NRS_BR_CD =H_OUTKAEDI_HED_DPN.NRS_BR_CD           " & vbNewLine _
                                        & "AND                                                            " & vbNewLine _
                                        & "H_OUTKAEDI_L.EDI_CTL_NO =H_OUTKAEDI_HED_DPN.EDI_CTL_NO         " & vbNewLine _
                                        & "LEFT JOIN                                                      " & vbNewLine _
                                        & "(                                                              " & vbNewLine _
                                        & "SELECT                                                         " & vbNewLine _
                                        & "H_SENDOUTEDI_DPN.EDI_CTL_NO                                    " & vbNewLine _
                                        & ",MAX(H_SENDOUTEDI_DPN.SEND_DATE) AS SEND_DATE                  " & vbNewLine _
                                        & ",MAX(H_SENDOUTEDI_DPN.SEND_TIME) AS SEND_TIME                  " & vbNewLine _
                                        & ",MAX(H_SENDOUTEDI_DPN.SYS_UPD_DATE) AS SYS_UPD_DATE            " & vbNewLine _
                                        & ",MAX(H_SENDOUTEDI_DPN.SYS_UPD_TIME) AS SYS_UPD_TIME            " & vbNewLine _
                                        & "FROM                                                           " & vbNewLine _
                                        & "$LM_TRN$..H_SENDOUTEDI_DPN   H_SENDOUTEDI_DPN                  " & vbNewLine _
                                        & "WHERE                                                          " & vbNewLine _
                                        & "H_SENDOUTEDI_DPN.NRS_BR_CD = @NRS_BR_CD                        " & vbNewLine _
                                        & "GROUP BY                                                       " & vbNewLine _
                                        & "H_SENDOUTEDI_DPN.EDI_CTL_NO                                    " & vbNewLine _
                                        & ")                           SENDTBL                            " & vbNewLine _
                                        & "ON                                                             " & vbNewLine _
...
#Region "H_OUTKAEDI_L SELECT句"
    ...
    Private Const L_DEF_SQL_SELECT_DATA As String = " SELECT                                                                                " & vbNewLine _
                                            ...
                                            & "-- 2011.10.05追加END 荷送人名称不具合                          " & vbNewLine _
                                            ...
                                            & ",CASE WHEN H_OUTKAEDI_L.DEST_TEL <> ''                                                      " & vbNewLine _
                                            & "      THEN H_OUTKAEDI_L.DEST_TEL                                                            " & vbNewLine _
                                            & "      WHEN H_OUTKAEDI_L.DEST_CD <> ''                                                  " & vbNewLine _
                                            & "           AND H_OUTKAEDI_L.DEST_TEL = ''                                            " & vbNewLine _
                                            & "           AND D_M_DEST.TEL <> '' OR D_M_DEST.TEL IS NOT NULL                                           " & vbNewLine _
                                            & "      THEN D_M_DEST.TEL                                                                        " & vbNewLine _
                                            & "      ELSE E_M_DEST.TEL                                                                        " & vbNewLine _
                                            & " END                                                 AS DEST_TEL                            " & vbNewLine _
                                            & ",H_OUTKAEDI_L.DEST_FAX                               AS DEST_FAX	                            " & vbNewLine _
                                            & ",H_OUTKAEDI_L.DEST_MAIL                              AS DEST_MAIL	                        " & vbNewLine _
                                            & ",CASE WHEN H_OUTKAEDI_L.DEST_JIS_CD <> ''                                                      " & vbNewLine _
                                            & "      THEN H_OUTKAEDI_L.DEST_JIS_CD                                                            " & vbNewLine _
                                            & "      WHEN H_OUTKAEDI_L.DEST_CD <> ''                                                  " & vbNewLine _
                                            & "           AND H_OUTKAEDI_L.DEST_JIS_CD = ''                                            " & vbNewLine _
                                            & "           AND D_M_DEST.JIS <> '' OR D_M_DEST.JIS IS NOT NULL                                           " & vbNewLine _
                                            & "      THEN D_M_DEST.JIS                                                                        " & vbNewLine _
                                            & "      ELSE E_M_DEST.JIS                                                                        " & vbNewLine _
                                            & " END                                                 AS DEST_JIS_CD                            " & vbNewLine _
                                            & ",CASE WHEN H_OUTKAEDI_L.SP_NHS_KB <> ''                                                      " & vbNewLine _
                                            & "      THEN H_OUTKAEDI_L.SP_NHS_KB                                                            " & vbNewLine _
                                            & "      WHEN H_OUTKAEDI_L.DEST_CD <> ''                                                  " & vbNewLine _
                                            & "           AND H_OUTKAEDI_L.SP_NHS_KB = ''                                            " & vbNewLine _
                                            & "           AND D_M_DEST.SP_NHS_KB <> '' OR D_M_DEST.SP_NHS_KB IS NOT NULL                                           " & vbNewLine _
                                            & "      THEN D_M_DEST.SP_NHS_KB                                                                        " & vbNewLine _
                                            & "      ELSE E_M_DEST.SP_NHS_KB                                                                        " & vbNewLine _
                                            & " END                                                 AS SP_NHS_KB                            " & vbNewLine _
                                            & "--'要望番号:483((出荷登録時)EDI出荷(大,中)の更新不具合のCOA_YN) 2012/06/21 本明 Start        " & vbNewLine _
                                            & "--,CASE WHEN H_OUTKAEDI_L.COA_YN <> ''                                                       " & vbNewLine _
                                            & "--      THEN H_OUTKAEDI_L.COA_YN                                                             " & vbNewLine _
                                            & "--      WHEN H_OUTKAEDI_L.DEST_CD <> ''                                                      " & vbNewLine _
                                            & "--           AND H_OUTKAEDI_L.COA_YN = ''                                                    " & vbNewLine _
                                            & "--           AND D_M_DEST.COA_YN <> '' OR D_M_DEST.COA_YN IS NOT NULL                        " & vbNewLine _
                                            & "--      THEN RIGHT(D_M_DEST.COA_YN,1)                                                        " & vbNewLine _
                                            & "--      ELSE RIGHT(E_M_DEST.COA_YN,1)                                                        " & vbNewLine _
                                            ...
                                            & "           ELSE                                                                              " & vbNewLine _
                                            & "                --E_M_DEST.COA_YNが空の場合は既定値を採用（デュポンの場合は'0'）             " & vbNewLine _
                                            & "                '0'                                                                          " & vbNewLine _
                                            & "           END                                                                               " & vbNewLine _
                                            & "      END                                                                                    " & vbNewLine _
                                            & " END                                                 AS COA_YN                               " & vbNewLine _
                                            ...
                                            & "      WHEN H_OUTKAEDI_L.UNSO_CD = '' AND (D_M_DEST.SP_UNSO_CD <> '' AND D_M_DEST.SP_UNSO_CD IS NOT NULL)                  " & vbNewLine _
                                            & " THEN D_M_DEST.SP_UNSO_CD                                                                    " & vbNewLine _
                                            & "      WHEN H_OUTKAEDI_L.UNSO_CD = '' AND (E_M_DEST.SP_UNSO_CD <> '' AND E_M_DEST.SP_UNSO_CD IS NOT NULL)                  " & vbNewLine _
                                            ...
                                            & "      WHEN H_OUTKAEDI_L.UNSO_BR_CD = '' AND (D_M_DEST.SP_UNSO_BR_CD <> '' AND D_M_DEST.SP_UNSO_BR_CD IS NOT NULL)            " & vbNewLine _
                                            & " THEN D_M_DEST.SP_UNSO_BR_CD                                                                    " & vbNewLine _
                                            & "      WHEN H_OUTKAEDI_L.UNSO_BR_CD = '' AND (E_M_DEST.SP_UNSO_BR_CD <> '' AND E_M_DEST.SP_UNSO_BR_CD IS NOT NULL)            " & vbNewLine _
                                            ...
                                            & "-- 2012.03.07修正START 要望番号793                          " & vbNewLine _
                                            & ",CASE WHEN H_OUTKAEDI_L.UNCHIN_TARIFF_CD <> ''                                                                              " & vbNewLine _
                                            & " THEN H_OUTKAEDI_L.UNCHIN_TARIFF_CD                                                                                         " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) = '01' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '10' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')       " & vbNewLine _
                                            & " THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1                                                                               " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) = '01' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '20' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')       " & vbNewLine _
                                            & " THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2                                                                               " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) = '01' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '40' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')       " & vbNewLine _
                                            ...
                                            & "      AND  H_OUTKAEDI_L.FREE_C29 = '' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '10' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')            " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1 = '' OR D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1 IS NULL)                 " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND H_OUTKAEDI_L.FREE_C29 = '' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '10' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')             " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1 <> '' AND D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1 IS NOT NULL)           " & vbNewLine _
                                            & "      THEN D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND H_OUTKAEDI_L.FREE_C29 = '' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '20' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')             " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2 = '' OR D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2 IS NULL)                 " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND H_OUTKAEDI_L.FREE_C29 = '' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '20' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')             " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2 <> '' AND D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2 IS NOT NULL)           " & vbNewLine _
                                            & "      THEN D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND H_OUTKAEDI_L.FREE_C29 = '' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '40' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')             " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD = '' OR D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD IS NULL)                       " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND H_OUTKAEDI_L.FREE_C29 = '' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '40' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')             " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD <> '' AND D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD IS NOT NULL)                 " & vbNewLine _
                                            & "      THEN D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '0' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '10' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            & " THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1                                                                               " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '0' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '20' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            & " THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2                                                                               " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '0' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '40' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            & " THEN C_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD                                                                                  " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '1' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '10' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1 = '' OR D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1 IS NULL)                 " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '1' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '10' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            ...
                                            & "      THEN D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD1                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '1' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '20' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2 = '' OR D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2 IS NULL)                 " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '1' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '20' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            ...
                                            & "      THEN D_M_UNCHIN_TARIFF_SET.UNCHIN_TARIFF_CD2                                                                          " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '1' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '40' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            & "      AND(D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD = '' OR D_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD IS NULL)                        " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.YOKO_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.UNCHIN_TARIFF_CD = ''                                          " & vbNewLine _
                                            & "      AND LEFT(H_OUTKAEDI_L.FREE_C29,1) = '1' AND (H_OUTKAEDI_L.UNSO_TEHAI_KB = '40' OR H_OUTKAEDI_L.UNSO_TEHAI_KB = '')    " & vbNewLine _
                                            ...
                                            & "      AND SUBSTRING(H_OUTKAEDI_L.FREE_C29,2,1) = ''                                                                         " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD = '' OR D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD IS NULL)                       " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.EXTC_TARIFF_CD = ''                                            " & vbNewLine _
                                            & "      AND SUBSTRING(H_OUTKAEDI_L.FREE_C29,2,1) = ''                                                                         " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD <> '' AND D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD IS NOT NULL)                 " & vbNewLine _
                                            & "      THEN D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.EXTC_TARIFF_CD = ''                                            " & vbNewLine _
                                            & "      AND SUBSTRING(H_OUTKAEDI_L.FREE_C29,2,1) = '0'                                                                        " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.EXTC_TARIFF_CD = ''                                            " & vbNewLine _
                                            & "      AND SUBSTRING(H_OUTKAEDI_L.FREE_C29,2,1) = '1'                                                                        " & vbNewLine _
                                            & "      AND (D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD = '' OR D_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD IS NULL)                       " & vbNewLine _
                                            & "      THEN C_M_UNCHIN_TARIFF_SET.EXTC_TARIFF_CD                                                                             " & vbNewLine _
                                            & " WHEN LEFT(H_OUTKAEDI_L.FREE_C30,2) <> '01' AND H_OUTKAEDI_L.EXTC_TARIFF_CD = ''                                            " & vbNewLine _
                                            & "      AND SUBSTRING(H_OUTKAEDI_L.FREE_C29,2,1) = '1'                                                                        " & vbNewLine _
                                            ...
                                            & "-- 2012.03.07修正END 要望番号793                          " & vbNewLine _
                                            ...
                                            & ",CASE WHEN H_OUTKAEDI_L.DEST_CD <> ''                                                        " & vbNewLine _
                                            & "           AND D_M_DEST.DEST_NM <> '' OR D_M_DEST.DEST_NM IS NOT NULL                        " & vbNewLine _
                                            & "      THEN D_M_DEST.DEST_NM                                                                  " & vbNewLine _
                                            & "      WHEN H_OUTKAEDI_L.DEST_CD = ''                                                         " & vbNewLine _
                                            & "           AND E_M_DEST.DEST_NM <> '' OR E_M_DEST.DEST_NM IS NOT NULL                        " & vbNewLine _
                                            & "      THEN E_M_DEST.DEST_NM                                                                  " & vbNewLine _
                                            & "      ELSE H_OUTKAEDI_L.FREE_C11                                                             " & vbNewLine _
                                            & " END                                                 AS FREE_C11                             " & vbNewLine _
...
#Region "H_OUTKAEDI_M SELECT句"
    ...
    Private Const M_DEF_SQL_SELECT_DATA As String = " SELECT                                                                            " & vbNewLine _
                                        ...
                                        & ",M_DESTGOODS.SAGYO_KB_2                              AS SAGYO_KB_2	                        " & vbNewLine
...
#Region "SQL_SELECT_CUST_DETAILS"
...
#Region "H_OUTKAEDI_HED_DPN"
    ''' <summary>
    ''' デュポンEDI受信HEDのUPDATE文（H_OUTKAEDI_HED_DPN）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_DPN SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DPN"
    ''' <summary>
    ''' デュポンEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DPN）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DPN SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "M_DEST(デュポン専用)INSERT"

    ''' <summary>
    ''' 届先マスタINSERT文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_M_DEST_DUPONT As String = "INSERT INTO $LM_MST$..M_DEST        " & vbNewLine _
                                       & "(                                   " & vbNewLine _
                                       & "      NRS_BR_CD                     " & vbNewLine _
                                       & "      ,CUST_CD_L                    " & vbNewLine _
                                       & "      ,DEST_CD                      " & vbNewLine _
...
#Region "実績作成処理 チェック用SQL(出荷(中)オーダー番号)"

    Private Const SQL_SELECT_DUPONT_CHECK_00588_00 As String = " SELECT * FROM (                                                                  " & vbNewLine _
                                                                & "  SELECT                                                                    " & vbNewLine _
                                                                & "    C_OUTKA_M.OUTKA_NO_L                      AS OUTKA_NO_L                 " & vbNewLine _
                                                                & "   ,C_OUTKA_M.OUTKA_NO_M                      AS OUTKA_NO_M                 " & vbNewLine _
                                                                & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.EDI_CTL_NO, H_OUTKAEDI_L.EDI_CTL_NO)          AS EDI_CTL_NO             " & vbNewLine _
                                                                & "   ,H_OUTKAEDI_DTL_DPN.EDI_CTL_NO_CHU         AS EDI_CTL_NO_CHU             " & vbNewLine _
                                                                & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.S5_ORDER_NO_DTL,'') + '/' + ISNULL(H_OUTKAEDI_DTL_DPN.S6_ORDER_NO_LOT,'') AS EDI_ORDER_NO                   " & vbNewLine _
                                                                & "   ,C_OUTKA_M.CUST_ORD_NO_DTL                 AS CUST_ORD_NO_DTL            " & vbNewLine _
                                                                & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.S5_GOODS_CD,'') AS EDI_GOODS                  " & vbNewLine _
                                                                & "   ,M_GOODS.GOODS_CD_CUST                     AS GOODS_CD_CUST              " & vbNewLine _
                                                                & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.S6_LOT_NO,'')   AS EDI_LOT                    " & vbNewLine _
                                                                & "   ,S.LOT_NO                                  AS LOT_NO                     " & vbNewLine _
                                                                & "   --,CONVERT(Integer,(ISNULL(H_OUTKAEDI_DTL_DPN.S6_NB,0))        AS EDI_NB   " & vbNewLine _
                                                                & "   ,CONVERT(Integer,(ISNULL(H_OUTKAEDI_DTL_DPN.S6_NB,0)))       AS EDI_NB   " & vbNewLine _
                                                                & "   ,S.ALCTD_NB                                AS ALCTD_NB                   " & vbNewLine _
                                                                & "   FROM $LM_TRN$..C_OUTKA_M                                                 " & vbNewLine _
                                                                & "   INNER JOIN $LM_TRN$..C_OUTKA_L                                           " & vbNewLine _
                                                                & "   ON  C_OUTKA_L.SYS_DEL_FLG <> '1'                                         " & vbNewLine _
                                                                & "   AND C_OUTKA_L.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                            " & vbNewLine _
                                                                & "   AND C_OUTKA_L.OUTKA_NO_L = C_OUTKA_M.OUTKA_NO_L                          " & vbNewLine _
                                                                & "   INNER JOIN $LM_TRN$..H_OUTKAEDI_L                                        " & vbNewLine _
                                                                & "   ON  H_OUTKAEDI_L.SYS_DEL_FLG <> '1'                                      " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_L.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                         " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_L.OUTKA_CTL_NO = C_OUTKA_M.OUTKA_NO_L                     " & vbNewLine _
                                                                & "   INNER JOIN $LM_MST$..M_GOODS                                             " & vbNewLine _
                                                                & "   ON C_OUTKA_M.GOODS_CD_NRS = M_GOODS.GOODS_CD_NRS                         " & vbNewLine _
                                                                & "   AND C_OUTKA_M.NRS_BR_CD = M_GOODS.NRS_BR_CD                              " & vbNewLine _
                                                                & "   INNER JOIN                                                               " & vbNewLine _
                                                                & "    (SELECT                                                                 " & vbNewLine _
                                                                & "      C_OUTKA_S.OUTKA_NO_L                                                  " & vbNewLine _
                                                                & "     ,C_OUTKA_S.OUTKA_NO_M                                                  " & vbNewLine _
                                                                & "     ,MIN(C_OUTKA_S.OUTKA_NO_S) AS OUTKA_NO_S                               " & vbNewLine _
                                                                & "     ,C_OUTKA_S.LOT_NO                                                      " & vbNewLine _
                                                                & "     ,SUM(C_OUTKA_S.ALCTD_NB) AS ALCTD_NB                                   " & vbNewLine _
                                                                & "     FROM $LM_TRN$..C_OUTKA_S                                               " & vbNewLine _
                                                                & "     WHERE C_OUTKA_S.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                                                ...
                                                                & "     ,C_OUTKA_S.LOT_NO                                                      " & vbNewLine _
                                                                & "    ) S                                                                     " & vbNewLine _
                                                                & "    ON  S.OUTKA_NO_L = C_OUTKA_M.OUTKA_NO_L                                 " & vbNewLine _
                                                                & "    AND S.OUTKA_NO_M = C_OUTKA_M.OUTKA_NO_M                                 " & vbNewLine _
                                                                & "   INNER JOIN $LM_TRN$..H_OUTKAEDI_HED_DPN                                            " & vbNewLine _
                                                                & "   ON  H_OUTKAEDI_HED_DPN.DEL_KB <> '1'                                     " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_HED_DPN.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                   " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_HED_DPN.OUTKA_CTL_NO = C_OUTKA_M.OUTKA_NO_L               " & vbNewLine _
                                                                & "   LEFT JOIN $LM_TRN$..H_OUTKAEDI_DTL_DPN                                   " & vbNewLine _
                                                                & "   ON  H_OUTKAEDI_DTL_DPN.DEL_KB <> '1'                                     " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_DTL_DPN.CRT_DATE = H_OUTKAEDI_HED_DPN.CRT_DATE            " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_DTL_DPN.FILE_NAME = H_OUTKAEDI_HED_DPN.FILE_NAME          " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_DTL_DPN.REC_NO = H_OUTKAEDI_HED_DPN.REC_NO                " & vbNewLine _
                                                                & "   AND H_OUTKAEDI_DTL_DPN.OUTKA_CTL_NO_CHU = C_OUTKA_M.OUTKA_NO_M           " & vbNewLine _
                                                                & "   WHERE C_OUTKA_M.SYS_DEL_FLG <> '1'                                       " & vbNewLine _
                                                                & "    AND  C_OUTKA_M.NRS_BR_CD = @NRS_BR_CD                                   " & vbNewLine _
                                                                & "    AND  H_OUTKAEDI_HED_DPN.EDI_CTL_NO = @EDI_CTL_NO                        " & vbNewLine _
                                                                & "    AND H_OUTKAEDI_HED_DPN.SYS_UPD_DATE  = @SYS_UPD_DATE                    " & vbNewLine _
                                                                & "    AND H_OUTKAEDI_HED_DPN.SYS_UPD_TIME  = @SYS_UPD_TIME                    " & vbNewLine _
                                                                & "  ) X                                                                       " & vbNewLine _
                                                                & " WHERE EDI_ORDER_NO <> CUST_ORD_NO_DTL                                      " & vbNewLine _
                                                                & "  OR   EDI_GOODS    <> GOODS_CD_CUST                                        " & vbNewLine _
                                                                & "  OR   EDI_LOT      <> LOT_NO                                               " & vbNewLine _
                                                                & "  OR   EDI_NB       <> ALCTD_NB                                             " & vbNewLine _
                                                                & " ORDER BY EDI_CTL_NO_CHU                                                    " & vbNewLine

            '要望番号1041 追加START
    Private Const SQL_SELECT_DUPONT_CHECK_00689_00 As String = " SELECT * FROM (                                                                  " & vbNewLine _
                                                            & "  SELECT                                                                    " & vbNewLine _
                                                            & "    C_OUTKA_M.OUTKA_NO_L                      AS OUTKA_NO_L                 " & vbNewLine _
                                                            & "   ,C_OUTKA_M.OUTKA_NO_M                      AS OUTKA_NO_M                 " & vbNewLine _
                                                            & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.EDI_CTL_NO, H_OUTKAEDI_L.EDI_CTL_NO)          AS EDI_CTL_NO             " & vbNewLine _
                                                            ...
                                                            & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.S6_LOT_NO,'')   AS EDI_LOT                    " & vbNewLine _
                                                            & "   ,S.LOT_NO                                  AS LOT_NO                     " & vbNewLine _
                                                            & "   ,ISNULL(H_OUTKAEDI_DTL_DPN.S6_NB,0)        AS EDI_NB                     " & vbNewLine _
                                                            & "   ,S.ALCTD_QT                                AS ALCTD_NB                   " & vbNewLine _
                                                            & "   FROM $LM_TRN$..C_OUTKA_M                                                 " & vbNewLine _
                                                            & "   INNER JOIN $LM_TRN$..C_OUTKA_L                                           " & vbNewLine _
                                                            & "   ON  C_OUTKA_L.SYS_DEL_FLG <> '1'                                         " & vbNewLine _
                                                            & "   AND C_OUTKA_L.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                            " & vbNewLine _
                                                            ...
                                                            & "     ,MIN(C_OUTKA_S.OUTKA_NO_S) AS OUTKA_NO_S                               " & vbNewLine _
                                                            & "     ,C_OUTKA_S.LOT_NO                                                      " & vbNewLine _
                                                            & "     ,SUM(C_OUTKA_S.ALCTD_QT) AS ALCTD_QT                                   " & vbNewLine _
                                                            & "     FROM $LM_TRN$..C_OUTKA_S                                               " & vbNewLine _
                                                            & "     WHERE C_OUTKA_S.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                                            & "     AND  C_OUTKA_S.NRS_BR_CD = @NRS_BR_CD                                  " & vbNewLine _
                                                            & "--     AND  C_OUTKA_S.OUTKA_NO_L = @OUTKA_CTL_NO                            " & vbNewLine _
                                                            ...
                                                            & "  ) X                                                                       " & vbNewLine _
                                                            & "-- WHERE EDI_ORDER_NO <> CUST_ORD_NO_DTL                                    " & vbNewLine _
                                                            & "  WHERE   EDI_GOODS    <> GOODS_CD_CUST                                     " & vbNewLine _
                                                            & "  OR   EDI_LOT      <> LOT_NO                                               " & vbNewLine _
                                                            & "  OR   EDI_NB       <> ALCTD_NB                                             " & vbNewLine _
                                                            & " ORDER BY EDI_CTL_NO_CHU                                                    " & vbNewLine
    '要望番号1041 追加END
...
#Region "H_SENDOUTEDI_DPN SELECT句"

    Private Const SQL_SELECT_DUPONT_SEND_DATA As String = " SELECT                                                                                                 " & vbNewLine _
                                                        & " '0'                                                                                AS DEL_KB           " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CRT_DATE                                                        AS CRT_DATE         " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.FILE_NAME                                                       AS FILE_NAME        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.REC_NO                                                          AS REC_NO           " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.GYO                                                             AS GYO              " & vbNewLine _
                                                        & ",'001'                                                                              AS EDA              " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.NRS_BR_CD                                                       AS NRS_BR_CD        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.EDI_CTL_NO                                                      AS EDI_CTL_NO       " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.EDI_CTL_NO_CHU                                                  AS EDI_CTL_NO_CHU   " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.OUTKA_CTL_NO                                                    AS OUTKA_CTL_NO     " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.OUTKA_CTL_NO_CHU                                                AS OUTKA_CTL_NO_CHU " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CUST_CD_L                                                       AS CUST_CD_L        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CUST_CD_M                                                       AS CUST_CD_M        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_OUTKA_SIJI_NO                                                AS S1_OUTKA_SIJI_NO " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S5_ORDER_NO                                                     AS S5_ORDER_NO      " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S5_ORDER_NO_DTL                                                 AS S5_ORDER_NO_DTL  " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S6_ORDER_NO_LOT                                                 AS S6_ORDER_NO_LOT  " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S5_GOODS_CD                                                     AS S5_GOODS_CD      " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S6_NB                                                           AS S6_QT            " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S6_LOT_NO                                                       AS S6_LOT_NO        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_CLIENT                                                       AS S1_CLIENT        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_KYOKYU_WH                                                    AS S1_KYOKYU_WH     " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_PLANT_CD                                                     AS S1_PLANT_CD      " & vbNewLine _
                                                        & ",H_OUTKAEDI_DTL_DPN.S5_UT                                                           AS S5_UT            " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.RECORD_STATUS                                                   AS RECORD_STATUS    " & vbNewLine _
                                                        & ",'2'                                                               	               AS JISSEKI_SHORI_FLG" & vbNewLine

#End Region

#Region "H_SENDOUTEDI_DPN FROM句"

    Private Const SQL_FROM_DUPONT_SEND_DATA As String = "FROM                                                                                                      " & vbNewLine _
                                                        & " $LM_TRN$..H_OUTKAEDI_HED_DPN                                                                           " & vbNewLine _
                                                        & " INNER JOIN $LM_TRN$..H_OUTKAEDI_DTL_DPN                                                                " & vbNewLine _
                                                        & "  ON  H_OUTKAEDI_DTL_DPN.DEL_KB <> '1'                                                                  " & vbNewLine _
                                                        & "  AND H_OUTKAEDI_DTL_DPN.CRT_DATE = H_OUTKAEDI_HED_DPN.CRT_DATE                                         " & vbNewLine _
                                                        & "  AND H_OUTKAEDI_DTL_DPN.FILE_NAME = H_OUTKAEDI_HED_DPN.FILE_NAME                                       " & vbNewLine _
                                                        & "  AND H_OUTKAEDI_DTL_DPN.REC_NO = H_OUTKAEDI_HED_DPN.REC_NO                                             " & vbNewLine _
                                                        & "  AND H_OUTKAEDI_DTL_DPN.JISSEKI_SHORI_FLG = '2'                                                        " & vbNewLine _
                                                        & " WHERE H_OUTKAEDI_HED_DPN.DEL_KB <> '1'                                                                 " & vbNewLine _
                                                        & "  AND  H_OUTKAEDI_HED_DPN.NRS_BR_CD = @NRS_BR_CD                                                        " & vbNewLine _
                                                        & "  AND  H_OUTKAEDI_HED_DPN.EDI_CTL_NO = @EDI_CTL_NO                                                    " & vbNewLine _
                                                        & " AND H_OUTKAEDI_HED_DPN.SYS_UPD_DATE  = @SYS_UPD_DATE                                                   " & vbNewLine _
                                                        & " AND H_OUTKAEDI_HED_DPN.SYS_UPD_TIME  = @SYS_UPD_TIME                                                   " & vbNewLine


#End Region

#Region "H_SENDOUTEDI_DPN(荷主コード:00588-00用) SELECT句"

    Private Const SQL_SELECT_DUPONT_SEND_DATA_00588_00 As String = " SELECT                                                                                           " & vbNewLine _
                                                        & " '0'                                                                                AS DEL_KB           " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CRT_DATE                                                        AS CRT_DATE         " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.FILE_NAME                                                       AS FILE_NAME        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.REC_NO                                                          AS REC_NO           " & vbNewLine _
                                                        & ",ISNULL(DTL_DPN_LEFT.GYO,H_OUTKAEDI_M.EDI_CTL_NO_CHU)                               AS GYO              " & vbNewLine _
                                                        & ",S.OUTKA_NO_S                                                                              AS EDA              " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.NRS_BR_CD                                                       AS NRS_BR_CD        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.EDI_CTL_NO                                                      AS EDI_CTL_NO       " & vbNewLine _
                                                        & ",H_OUTKAEDI_M.EDI_CTL_NO_CHU                                                        AS EDI_CTL_NO_CHU   " & vbNewLine _
                                                        & ",C_OUTKA_M.OUTKA_NO_L                                                               AS OUTKA_CTL_NO     " & vbNewLine _
                                                        & ",C_OUTKA_M.OUTKA_NO_M                                                               AS OUTKA_CTL_NO_CHU " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CUST_CD_L                                                       AS CUST_CD_L        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CUST_CD_M                                                       AS CUST_CD_M        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_OUTKA_SIJI_NO                                                AS S1_OUTKA_SIJI_NO " & vbNewLine _
                                                        & ",ISNULL(DTL_DPN_LEFT.S5_ORDER_NO,DTL_DPN_INNER.S5_ORDER_NO)                         AS S5_ORDER_NO      " & vbNewLine _
                                                        & ",LEFT(C_OUTKA_M.CUST_ORD_NO_DTL,6)                                                  AS S5_ORDER_NO_DTL  " & vbNewLine _
                                                        & ",SUBSTRING(C_OUTKA_M.CUST_ORD_NO_DTL,8,6)                                           AS S6_ORDER_NO_LOT  " & vbNewLine _
                                                        & ",M_GOODS.GOODS_CD_CUST                                                              AS S5_GOODS_CD      " & vbNewLine _
                                                        & ",S.ALCTD_NB                                                                         AS S6_QT            " & vbNewLine _
                                                        & ",S.LOT_NO                                                                           AS S6_LOT_NO        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_CLIENT                                                       AS S1_CLIENT        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_KYOKYU_WH                                                    AS S1_KYOKYU_WH     " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_PLANT_CD                                                     AS S1_PLANT_CD      " & vbNewLine _
                                                        & ",'EA'                                                                 AS S5_UT            " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.RECORD_STATUS                                                   AS RECORD_STATUS    " & vbNewLine _
                                                        & ",'2'                                                               	               AS JISSEKI_SHORI_FLG" & vbNewLine

#End Region

#Region "H_SENDOUTEDI_DPN (荷主コード:00588-00用)FROM句"

    Private Const SQL_FROM_DUPONT_SEND_DATA_00588_00 As String = "FROM                                                                          " & vbNewLine _
                                                        & " $LM_TRN$..H_OUTKAEDI_HED_DPN                                                     " & vbNewLine _
                                                        & " INNER JOIN $LM_TRN$..C_OUTKA_M                                                   " & vbNewLine _
                                                        & " ON  C_OUTKA_M.SYS_DEL_FLG <> '1'                                                 " & vbNewLine _
                                                        & " AND C_OUTKA_M.NRS_BR_CD = @NRS_BR_CD                                             " & vbNewLine _
                                                        & " AND C_OUTKA_M.OUTKA_NO_L = H_OUTKAEDI_HED_DPN.OUTKA_CTL_NO                       " & vbNewLine _
                                                        & " INNER JOIN $LM_MST$..M_GOODS                                                     " & vbNewLine _
                                                        & " ON C_OUTKA_M.NRS_BR_CD = M_GOODS.NRS_BR_CD                                       " & vbNewLine _
                                                        & " AND C_OUTKA_M.GOODS_CD_NRS = M_GOODS.GOODS_CD_NRS                                " & vbNewLine _
                                                        & " INNER JOIN $LM_TRN$..H_OUTKAEDI_L                                                " & vbNewLine _
                                                        & " ON  H_OUTKAEDI_L.SYS_DEL_FLG <> '1'                                              " & vbNewLine _
                                                        & " AND H_OUTKAEDI_L.NRS_BR_CD = H_OUTKAEDI_HED_DPN.NRS_BR_CD                        " & vbNewLine _
                                                        & " AND H_OUTKAEDI_L.EDI_CTL_NO = H_OUTKAEDI_HED_DPN.EDI_CTL_NO                      " & vbNewLine _
                                                        & " INNER JOIN $LM_TRN$..H_OUTKAEDI_M                                                " & vbNewLine _
                                                        & " ON  H_OUTKAEDI_M.SYS_DEL_FLG <> '1'                                              " & vbNewLine _
                                                        & " AND H_OUTKAEDI_M.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                                 " & vbNewLine _
                                                        ...
                                                        & "  ON  S.OUTKA_NO_L = C_OUTKA_M.OUTKA_NO_L                                         " & vbNewLine _
                                                        & "  AND S.OUTKA_NO_M = C_OUTKA_M.OUTKA_NO_M                                         " & vbNewLine _
                                                        & " INNER JOIN $LM_TRN$..H_OUTKAEDI_DTL_DPN      DTL_DPN_INNER                       " & vbNewLine _
                                                        & " ON  DTL_DPN_INNER.CRT_DATE = H_OUTKAEDI_HED_DPN.CRT_DATE                         " & vbNewLine _
                                                        & " AND DTL_DPN_INNER.FILE_NAME = H_OUTKAEDI_HED_DPN.FILE_NAME                       " & vbNewLine _
                                                        & " AND DTL_DPN_INNER.REC_NO = H_OUTKAEDI_HED_DPN.REC_NO                             " & vbNewLine _
                                                        & " AND DTL_DPN_INNER.GYO = '001'                                                    " & vbNewLine _
                                                        & " LEFT JOIN $LM_TRN$..H_OUTKAEDI_DTL_DPN DTL_DPN_LEFT                              " & vbNewLine _
                                                        & " ON  DTL_DPN_LEFT.DEL_KB <> '1'                                                   " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.CRT_DATE = H_OUTKAEDI_HED_DPN.CRT_DATE                          " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.FILE_NAME = H_OUTKAEDI_HED_DPN.FILE_NAME                        " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.REC_NO = H_OUTKAEDI_HED_DPN.REC_NO                              " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.JISSEKI_SHORI_FLG = '2'                                         " & vbNewLine _
                                                        & "-- 2012.03.07修正START 要望番号787                                                " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.OUTKA_CTL_NO = C_OUTKA_M.OUTKA_NO_L                             " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.OUTKA_CTL_NO_CHU = C_OUTKA_M.OUTKA_NO_M                         " & vbNewLine _
                                                        & " AND DTL_DPN_LEFT.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                                 " & vbNewLine _
                                                        & "-- 2012.03.07修正END 要望番号787                                                  " & vbNewLine _
                                                        & " WHERE H_OUTKAEDI_HED_DPN.DEL_KB <> '1'                                           " & vbNewLine _
                                                        & " AND H_OUTKAEDI_HED_DPN.NRS_BR_CD = @NRS_BR_CD                                    " & vbNewLine _
                                                        & " AND H_OUTKAEDI_HED_DPN.EDI_CTL_NO = @EDI_CTL_NO                                  " & vbNewLine _
                                                        & " AND H_OUTKAEDI_HED_DPN.SYS_UPD_DATE  = @SYS_UPD_DATE                             " & vbNewLine _
...
#End Region
    ...
    '要望番号1041 追加START
#Region "H_SENDOUTEDI_DPN(荷主コード:00689-00用) SELECT句"
    '注意)PVFMの場合は数量で報告を作成する

    Private Const SQL_SELECT_DUPONT_SEND_DATA_00689_00 As String = " SELECT                                                                                           " & vbNewLine _
                                                        & " '0'                                                                                AS DEL_KB           " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.CRT_DATE                                                        AS CRT_DATE         " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.FILE_NAME                                                       AS FILE_NAME        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.REC_NO                                                          AS REC_NO           " & vbNewLine _
                                                        ...
                                                        & ",H_OUTKAEDI_HED_DPN.S1_OUTKA_SIJI_NO                                                AS S1_OUTKA_SIJI_NO " & vbNewLine _
                                                        & ",ISNULL(DTL_DPN_LEFT.S5_ORDER_NO,DTL_DPN_INNER.S5_ORDER_NO)                         AS S5_ORDER_NO      " & vbNewLine _
                                                        & ",ISNULL(DTL_DPN_LEFT.S5_ORDER_NO_DTL,DTL_DPN_INNER.S5_ORDER_NO_DTL)                 AS S5_ORDER_NO_DTL  " & vbNewLine _
                                                        & ",ISNULL(DTL_DPN_LEFT.S6_ORDER_NO_LOT,DTL_DPN_INNER.S6_ORDER_NO_LOT)                 AS S6_ORDER_NO_LOT  " & vbNewLine _
                                                        & ",M_GOODS.GOODS_CD_CUST                                                              AS S5_GOODS_CD      " & vbNewLine _
                                                        & ",S.ALCTD_QT                                                                         AS S6_QT            " & vbNewLine _
                                                        & ",S.LOT_NO                                                                           AS S6_LOT_NO        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_CLIENT                                                       AS S1_CLIENT        " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_KYOKYU_WH                                                    AS S1_KYOKYU_WH     " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.S1_PLANT_CD                                                     AS S1_PLANT_CD      " & vbNewLine _
                                                        & ",ISNULL(DTL_DPN_LEFT.S5_UT,DTL_DPN_INNER.S5_UT)                                                                 AS S5_UT            " & vbNewLine _
                                                        & ",H_OUTKAEDI_HED_DPN.RECORD_STATUS                                                   AS RECORD_STATUS    " & vbNewLine _
                                                        & ",'2'                                                               	               AS JISSEKI_SHORI_FLG" & vbNewLine

#End Region

#Region "H_SENDOUTEDI_DPN (荷主コード:00689-00用)FROM句"

    Private Const SQL_FROM_DUPONT_SEND_DATA_00689_00 As String = "FROM                                                                          " & vbNewLine _
                                                        & " $LM_TRN$..H_OUTKAEDI_HED_DPN                                                     " & vbNewLine _
                                                        & " INNER JOIN $LM_TRN$..C_OUTKA_M                                                   " & vbNewLine _
                                                        & " ON  C_OUTKA_M.SYS_DEL_FLG <> '1'                                                 " & vbNewLine _
                                                        & " AND C_OUTKA_M.NRS_BR_CD = @NRS_BR_CD                                             " & vbNewLine _
...
#Region "H_SENDOUTEDI_DPN"

    ''' <summary>
    ''' INSERT（H_SENDOUTEDI_DPN）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_H_SENDOUTEDI_DPN As String = "INSERT INTO                  " & vbNewLine _
                                         & "$LM_TRN$..H_SENDOUTEDI_DPN                  " & vbNewLine _
                                         & "(                             " & vbNewLine _
                                         & " DEL_KB                       " & vbNewLine _
                                         ...
                                         & ",CUST_CD_L                    " & vbNewLine _
                                         & ",CUST_CD_M                    " & vbNewLine _
                                         & ",S1_OUTKA_SIJI_NO             " & vbNewLine _
                                         & ",S5_ORDER_NO                  " & vbNewLine _
                                         & ",S5_ORDER_NO_DTL              " & vbNewLine _
                                         & ",S6_ORDER_NO_LOT              " & vbNewLine _
                                         & ",S5_GOODS_CD                  " & vbNewLine _
                                         & ",S6_QT                        " & vbNewLine _
                                         & ",S6_LOT_NO                    " & vbNewLine _
                                         & ",S1_CLIENT                    " & vbNewLine _
                                         & ",S1_KYOKYU_WH                 " & vbNewLine _
                                         & ",S1_PLANT_CD                  " & vbNewLine _
                                         & ",S5_UT                        " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_DPN"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_DPN SET       " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DPN"
    ...
    ''' デュポンEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DPN）
    ''' </summary>
    ''' <remarks>2011.10.07 追加 デュポン一時対応(請求ロジックが修正されるまでの対応)</remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDIONLY_RCV_DTL_DUPONT As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DPN SET     " & vbNewLine _
                                                  ...
                                                  & ",SYS_UPD_PGID           = @SYS_UPD_PGID                                " & vbNewLine _
                                                  & ",SYS_UPD_USER           = @SYS_UPD_USER                                " & vbNewLine _
                                                  & " FROM $LM_TRN$..H_OUTKAEDI_DTL_DPN                                     " & vbNewLine _
                                                  & " INNER JOIN $LM_TRN$..H_OUTKAEDI_M                                     " & vbNewLine _
                                                  & "  ON  H_OUTKAEDI_M.SYS_DEL_FLG <> '1'                                  " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.NRS_BR_CD = H_OUTKAEDI_M.NRS_BR_CD            " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.EDI_CTL_NO = H_OUTKAEDI_M.EDI_CTL_NO          " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.EDI_CTL_NO_CHU = H_OUTKAEDI_M.EDI_CTL_NO_CHU  " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_M.JISSEKI_FLAG = '0'                                  " & vbNewLine _
                                                  & "WHERE   H_OUTKAEDI_DTL_DPN.NRS_BR_CD       = @NRS_BR_CD                " & vbNewLine _
                                                  & "AND H_OUTKAEDI_DTL_DPN.EDI_CTL_NO          = @EDI_CTL_NO               " & vbNewLine _
                                                  & "AND H_OUTKAEDI_DTL_DPN.JISSEKI_SHORI_FLG   = '1'      				    " & vbNewLine _
                                                  & "AND H_OUTKAEDI_DTL_DPN.SYS_DEL_FLG         <> '1'      				" & vbNewLine

    ''' <summary>
    ''' デュポンEDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_DPN）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL_DUPONT As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DPN SET       " & vbNewLine _
                                                  & " JISSEKI_SHORI_FLG      = @JISSEKI_SHORI_FLG       	              " & vbNewLine _
                                                  & ",JISSEKI_USER           = @JISSEKI_USER                              " & vbNewLine _
                                                  & ",JISSEKI_DATE           = @JISSEKI_DATE                              " & vbNewLine _
                                                  & ",JISSEKI_TIME           = @JISSEKI_TIME                              " & vbNewLine _
                                                  ...
                                                  & " INNER JOIN $LM_TRN$..C_OUTKA_L                                        " & vbNewLine _
                                                  & "  ON  C_OUTKA_L.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.NRS_BR_CD = C_OUTKA_L.NRS_BR_CD               " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.OUTKA_CTL_NO = C_OUTKA_L.OUTKA_NO_L           " & vbNewLine _
                                                  & " INNER JOIN $LM_TRN$..C_OUTKA_M                                        " & vbNewLine _
                                                  & "  ON  C_OUTKA_M.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD               " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.OUTKA_CTL_NO = C_OUTKA_M.OUTKA_NO_L           " & vbNewLine _
                                                  & "  AND H_OUTKAEDI_DTL_DPN.OUTKA_CTL_NO_CHU = C_OUTKA_M.OUTKA_NO_M       " & vbNewLine _
                                                  & "  AND C_OUTKA_M.ALCTD_QT > 0                                           " & vbNewLine _
                                                  & "-- INNER JOIN                                                            " & vbNewLine _
                                                  & "--  (SELECT                                                              " & vbNewLine _
                                                  & "--    C_OUTKA_S.OUTKA_NO_L,                                              " & vbNewLine _
                                                  & "--    C_OUTKA_S.OUTKA_NO_M,                                              " & vbNewLine _
...
#Region "RCV_DTL(EDI取消、EDI取消⇒未登録)"
    ...
    Private Const SQL_UPDATE_EDITORIKESI_RCV_DTL As String = "UPDATE                                " & vbNewLine _
                                              & " $LM_TRN$..H_OUTKAEDI_DTL_DPN                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " DEL_KB            = @DEL_KB                       " & vbNewLine _
                                              & ",DELETE_USER       = @DELETE_USER                  " & vbNewLine _
                                              & ",DELETE_DATE       = @DELETE_DATE                  " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_DPN"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKICANSEL_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_DPN SET       " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DPN"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKICANSEL_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DPN SET       " & vbNewLine _
                                              & " JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_DPN"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_DPN SET       " & vbNewLine _
                                              & " UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
                                              & ",UPD_TIME          = @UPD_TIME                     " & vbNewLine _
                                              & ",SYS_UPD_DATE      = @SYS_UPD_DATE                 " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_DPN"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DPN SET       " & vbNewLine _
                                                  & " JISSEKI_SHORI_FLG      = @JISSEKI_SHORI_FLG       	              " & vbNewLine _
                                                  & ",JISSEKI_USER           = @JISSEKI_USER                              " & vbNewLine _
                                                  & ",JISSEKI_DATE           = @JISSEKI_DATE                              " & vbNewLine _
                                                  & ",JISSEKI_TIME           = @JISSEKI_TIME                              " & vbNewLine _
    ...
    Private Const SQL_UPDATE_JISSEKISOUSINZUMI_JISSEKIMI_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_DPN SET           " & vbNewLine _
                                              & " JISSEKI_SHORI_FLG          = @JISSEKI_SHORI_FLG       	                        " & vbNewLine _
                                              & ",JISSEKI_USER               = @JISSEKI_USER                                        " & vbNewLine _
                                              & ",JISSEKI_DATE               = @JISSEKI_DATE                                        " & vbNewLine _
                                              & ",JISSEKI_TIME               = @JISSEKI_TIME                                        " & vbNewLine _
...
#Region "H_SENDOUTEDI_DPN"
    ''' <summary>
    ''' デュポンEDI送信TBLのDELETE文（H_SENDOUTEDI_DPN）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_DELETE_JISSEKIZUMI_JISSEKIMI_EDI_SEND As String = "DELETE $LM_TRN$..H_SENDOUTEDI_DPN       " & vbNewLine _
                                              & "WHERE   NRS_BR_CD  = @NRS_BR_CD                    " & vbNewLine _
                                              & "AND EDI_CTL_NO     = @EDI_CTL_NO                   " & vbNewLine _
                                              & "AND SYS_DEL_FLG     <> '1'      " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.SQL_SELECT_COUNT)     'SQL構築(カウント用Select句)
        '2011.09.21 修正START
        Me._StrSql.Append(LMH030DAC403.SQL_COUNT_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectData", cmd)
    ...
    Private Function SelectListData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC403.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                      '条件設定
        '2011.09.26 追加START
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectDupontListData", cmd)
...
#Region "入時刻全件設定情報取得処理"
    '2018/02/05 Annen 000589 出荷 _横浜アクサルタ-納入日の時間帯指定を全てAM必着にする add start

    Private Function SelectNounyuuJikokuZenken(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.SQL_SELECT_CUST_DETAILS)

        Call Me.SetPrmCustDetails()
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectNounyuuJikokuZenken", cmd)
...
#Region "デュポン出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.L_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC403.L_DEF_SQL_FROM)        'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMH030DAC403.M_DEF_SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.setSQLSelectDataExists()                           '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectEdiM", cmd)
...
#Region "届先マスタ(デュポン用)"
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function SelectDataDupontMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectDataMdest", cmd)
...
#Region "出荷(中)オーダー番号チェック(荷主コード:00588-00)"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>出荷(中)取得SQLの構築・発行</remarks>
    Private Function SelectDupontOrderCheck(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_EDI_RCV_HED")
        '要望番号1041 追加START
        Dim ediCustIdx As Integer = Convert.ToInt32(ds.Tables("LMH030INOUT").Rows(0).Item("EDI_CUST_INDEX").ToString())
        '要望番号1041 追加END
        ...
        'SQL作成
        '要望番号1041 修正START
        If ediCustIdx.Equals(LMH030DAC.EdiCustIndex.Dupont00588_00) = True Then
            Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DUPONT_CHECK_00588_00)      'SQL構築(データ抽出用Select/From句)
        ElseIf ediCustIdx.Equals(LMH030DAC.EdiCustIndex.Dupont00689_00) = True OrElse _
               ediCustIdx.Equals(LMH030DAC.EdiCustIndex.DupontChb00689_00) = True Then
            Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DUPONT_CHECK_00689_00)      'SQL構築(データ抽出用Select/From句)
        End If
        '要望番号1041 修正END
        Call Me.setSQLSelectDataExists()                   '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectDupontOrderCheck", cmd)
        ...
        map.Add("EDI_CTL_NO", "EDI_CTL_NO")
        map.Add("EDI_CTL_NO_CHU", "EDI_CTL_NO_CHU")
        map.Add("EDI_ORDER_NO", "EDI_ORDER_NO")
        map.Add("CUST_ORD_NO_DTL", "CUST_ORD_NO_DTL")
        map.Add("EDI_GOODS", "EDI_GOODS")
        map.Add("GOODS_CD_CUST", "GOODS_CD_CUST")
        map.Add("EDI_LOT", "EDI_LOT")
        map.Add("LOT_NO", "LOT_NO")
        map.Add("EDI_NB", "EDI_NB")
        map.Add("ALCTD_NB", "ALCTD_NB")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SEND_CHECK_DPN")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SEND_CHECK_DPN").Rows.Count())
        reader.Close()
...
#Region "データ取得処理"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>デュポンEDI実績データ結果取得SQLの構築・発行</remarks>
    Private Function SelectDupontEdiSend(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMH030_EDI_RCV_HED")
        '2011.09.14 追加START
        Dim dtIn As DataTable = ds.Tables("LMH030INOUT")
        Dim dtDupontCustIndex As Integer = Convert.ToInt32(ds.Tables("LMH030INOUT").Rows(0)("EDI_CUST_INDEX"))
        '2011.09.14 追加END
        ...
        '2011.09.14 追加START
        'デュポン荷主コードでの判断
        Select Case DirectCast(dtDupontCustIndex, LMH030DAC.EdiCustIndex)

            'Case LMH030DAC.EdiCustIndex.Dupont00295_00, LMH030DAC.EdiCustIndex.Dupont00331_00, _
            '     LMH030DAC.EdiCustIndex.Dupont00331_02, LMH030DAC.EdiCustIndex.Dupont00331_03  '荷主コード:00295-00,00331-00,00331-02,,00331-03
            '    'SQL作成
            '    Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DUPONT_SEND_DATA)      'SQL構築(データ抽出用Select句)
            '    Me._StrSql.Append(LMH030DAC403.SQL_FROM_DUPONT_SEND_DATA)             'SQL構築(データ抽出用From句)


            Case LMH030DAC.EdiCustIndex.Dupont00588_00                                    '荷主コード:00588-00(SFTP塗料横浜)
                'デュポン(SFTP塗料)千葉・横浜は分岐項目は出荷TBLより取得

                'SQL作成
                Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DUPONT_SEND_DATA_00588_00)      'SQL構築(データ抽出用Select句)
                Me._StrSql.Append(LMH030DAC403.SQL_FROM_DUPONT_SEND_DATA_00588_00)             'SQL構築(データ抽出用From句)

                '要望番号1041 修正START
            Case LMH030DAC.EdiCustIndex.Dupont00689_00, LMH030DAC.EdiCustIndex.DupontChb00689_00   '荷主コード:00689-00(PVFM大阪・千葉)

                'SQL作成
                Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DUPONT_SEND_DATA_00689_00)      'SQL構築(データ抽出用Select句)
                Me._StrSql.Append(LMH030DAC403.SQL_FROM_DUPONT_SEND_DATA_00689_00)        'SQL構築(データ抽出用From句)
                'デュポン(PVFM)大阪は分岐項目は出荷TBLより取得
                '↑要望番号1041 修正END

            Case Else
                'デュポン(SFTP塗料)千葉・横浜以外は同一SQL(分岐項目は受信TBLより取得)
                'SQL作成
                Me._StrSql.Append(LMH030DAC403.SQL_SELECT_DUPONT_SEND_DATA)      'SQL構築(データ抽出用Select句)
                Me._StrSql.Append(LMH030DAC403.SQL_FROM_DUPONT_SEND_DATA)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectDupontEdiSend", cmd)
        ...
        map.Add("CUST_CD_L", "CUST_CD_L")
        map.Add("CUST_CD_M", "CUST_CD_M")
        map.Add("S1_OUTKA_SIJI_NO", "S1_OUTKA_SIJI_NO")
        map.Add("S5_ORDER_NO", "S5_ORDER_NO")
        map.Add("S5_ORDER_NO_DTL", "S5_ORDER_NO_DTL")
        map.Add("S6_ORDER_NO_LOT", "S6_ORDER_NO_LOT")
        map.Add("S5_GOODS_CD", "S5_GOODS_CD")
        map.Add("S6_QT", "S6_QT")
        map.Add("S6_LOT_NO", "S6_LOT_NO")
        map.Add("S1_CLIENT", "S1_CLIENT")
        map.Add("S1_KYOKYU_WH", "S1_KYOKYU_WH")
        map.Add("S1_PLANT_CD", "S1_PLANT_CD")
        map.Add("S5_UT", "S5_UT")
        map.Add("RECORD_STATUS", "RECORD_STATUS")
        map.Add("JISSEKI_SHORI_FLG", "JISSEKI_SHORI_FLG")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_H_SENDOUTEDI_DPN")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_H_SENDOUTEDI_DPN").Rows.Count())
        reader.Close()
...
#Region "運送会社存在チェック＋名称取得処理"
    ...
    Private Function SelectUnsoNM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC403.SQL_UNSONM_GET)      'SQL構築(データ抽出用Select句)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "SelectUnsoNM", cmd)
...
#Region "一括変更時のEDI出荷(大)"
    ...
    Private Function UpdateHenko(ByVal ds As DataSet) As DataSet
        ...
        '共通項目
        Me._StrSql.Append(LMH030DAC403.SQL_UPDATE)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateHenko", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI _
                ...
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_L

                '実行(実績送信済⇒送信待)SQL CONST名
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI

                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_SOUSINMACHI_EDI_L

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPDATE_TOUROKUMI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC403.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKISAKUSEI_EDI_M

                'EDI取消、EDI取消⇒未登録SQL CONST名
            Case LMH030DAC.EventShubetsu.EDITORIKESI _
                , LMH030DAC.EventShubetsu.TORIKESI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPD_EDITORIKESI_EDI_M

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_M
            ...
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI
                ...
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_SOUSINMACHI_EDI_M

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPDATE_TOUROKUMI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED_DPN"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC403.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_HED

                '実績取消SQL CONST名
            Case LMH030DAC.EventShubetsu.TORIKESIJISSEKI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKICANSEL_EDI_RCV_HED

                'EDI取消、EDI取消⇒未登録
            Case LMH030DAC.EventShubetsu.EDITORIKESI _
                , LMH030DAC.EventShubetsu.TORIKESI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPDATE_EDITORIKESI_RCV_HED

                '実行(実績作成済⇒実績未,実績送信済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI _
                , LMH030DAC.EventShubetsu.SOUSINZUMI_JISSEKIMI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_RCV_HED

                '実行(実績送信済⇒送信待)
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI

                setSql = LMH030DAC403.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL_DPN"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Dim outkaDelFlg As String = String.Empty
        Dim outkaCnt As Integer = ds.Tables("LMH030_C_OUTKA_L").Rows.Count
        If outkaCnt > 0 Then
            outkaDelFlg = ds.Tables("LMH030_C_OUTKA_L").Rows(0).Item("SYS_DEL_FLG").ToString()
        End If
        '2011.10.07 END
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC403.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1
            ...
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                '2011.10.07 START デュポンEDIデータ即実績作成対応
                '!!!!請求のロジックが修正されるまでの対応!!!!!
                Select Case outkaDelFlg

                    Case String.Empty
                        setSql = LMH030DAC403.SQL_UPDATE_JISSEKISAKUSEI_EDIONLY_RCV_DTL_DUPONT

                    Case Else
                        setSql = LMH030DAC403.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL_DUPONT
                ...
                '実績取消SQL CONST名
            Case LMH030DAC.EventShubetsu.TORIKESIJISSEKI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKICANSEL_EDI_RCV_DTL

                'EDI取消、EDI取消⇒未登録、報告用EDI取消
            Case LMH030DAC.EventShubetsu.EDITORIKESI _
                , LMH030DAC.EventShubetsu.TORIKESI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPDATE_EDITORIKESI_RCV_DTL

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_EDI_RCV_DTL

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_JISSEKIMI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKISOUSINZUMI_JISSEKIMI_EDI_RCV_DTL

                '実行(実績送信済⇒送信待)
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI

                setSql = LMH030DAC403.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

            Case LMH030DAC.EventShubetsu.TOUROKUZUMI_MITOUROKU

                setSql = LMH030DAC403.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateEdiRcvDtlData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKISAKUSEI_OUTKA_L

                '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC403.SQL_UPDATE_JISSEKIZUMI_JISSEKIMI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateOutkaLData", cmd)
...
#Region "H_SENDOUTEDI_DPN"
    ...
    Private Function UpdateEdiSendLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '実行(実績送信済⇒送信待)SQL CONST名
            Case LMH030DAC.EventShubetsu.SOUSINZUMI_SOUSINMACHI
                setSql = LMH030DAC403.SQL_UPD_JISSEKIMODOSI_SEND
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateEdiSendLData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertUnchinData", cmd)
...
#Region "H_SENDOUTEDI_DPN"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDIデュポン実績テーブル更新SQLの構築・発行</remarks>
    Private Function InsertDupontEdiSendData(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim DupontSendTbl As DataTable = ds.Tables("LMH030_H_SENDOUTEDI_DPN")

        Dim rtn As Integer = 0

        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_H_SENDOUTEDI_DPN _
                                                                       , ds.Tables("LMH030_H_SENDOUTEDI_DPN").Rows(0).Item("NRS_BR_CD").ToString()))
        Dim max As Integer = DupontSendTbl.Rows.Count() - 1
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertDupontEdiSendData", cmd)
...
#End Region
    ...
    '★★★2011.11.08 要望番号439 届先マスタ自動追加 追加START

#Region "M_DEST"

    ''' <summary>
    ''' 届先マスタ新規登録(届先コードを元に新規登録:デュポン専用)
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC403.SQL_INSERT_M_DEST_DUPONT, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "InsertMDestData", cmd)
...
#End Region
    ...
    '★★★2011.11.08 要望番号439 届先マスタ自動追加 追加END
...
#Region "H_SENDOUTEDI_DPN"
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>EDI送信テーブル(デュポン用)削除SQLの構築・発行</remarks>
    Private Function DeleteEdiSendLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '実行(実績作成済⇒実績未)SQL CONST名
            Case LMH030DAC.EventShubetsu.SAKUSEIZUMI_JISSEKIMI
                setSql = LMH030DAC403.SQL_DELETE_JISSEKIZUMI_JISSEKIMI_EDI_SEND
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC403", "DeleteEdiSendData", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetOutkaEdiRcvDtlComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'prmList.Add(MyBase.GetSqlParameter("@UPD_DATE", MyBase.GetSystemDate(), DBDataType.CHAR))
            'prmList.Add(MyBase.GetSqlParameter("@UPD_TIME", updTime))
            'prmList.Add(MyBase.GetSqlParameter("@SYS_DEL_FLG", Me.NullConvertString(.Item("SYS_DEL_FLG")), DBDataType.NVARCHAR))
...
#Region "EDIデュポン送信(TBL)新規登録パラメータ設定"

    ''' <summary>
    ''' EDI送信デュポン(TBL)の新規登録パラメータ設定
    ''' </summary>
    ''' <param name="conditionRow">DataRow</param>
    ''' <param name="prmList">パラメータ</param>
    ''' <remarks></remarks>
    Private Sub SetEdiSendCreateParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@GYO", Me.NullConvertString(.Item("GYO")), DBDataType.CHAR)) '20161026 NVARCHAR->CHAR
            prmList.Add(MyBase.GetSqlParameter("@EDA", Me.NullConvertString(.Item("EDA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me.NullConvertString(.Item("NRS_BR_CD")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO", Me.NullConvertString(.Item("EDI_CTL_NO")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@EDI_CTL_NO_CHU", Me.NullConvertString(.Item("EDI_CTL_NO_CHU")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@OUTKA_CTL_NO", Me.NullConvertString(.Item("OUTKA_CTL_NO")), DBDataType.CHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_L", Me.NullConvertString(.Item("CUST_CD_L")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@CUST_CD_M", Me.NullConvertString(.Item("CUST_CD_M")), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@S1_OUTKA_SIJI_NO", Me.NullConvertString(.Item("S1_OUTKA_SIJI_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S5_ORDER_NO", Me.NullConvertString(.Item("S5_ORDER_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S5_ORDER_NO_DTL", Me.NullConvertString(.Item("S5_ORDER_NO_DTL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S6_ORDER_NO_LOT", Me.NullConvertString(.Item("S6_ORDER_NO_LOT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S5_GOODS_CD", Me.NullConvertString(.Item("S5_GOODS_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S6_QT", Me.NullConvertZero(.Item("S6_QT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@S6_LOT_NO", Me.NullConvertString(.Item("S6_LOT_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S1_CLIENT", Me.NullConvertString(.Item("S1_CLIENT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S1_KYOKYU_WH", Me.NullConvertString(.Item("S1_KYOKYU_WH")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S1_PLANT_CD", Me.NullConvertString(.Item("S1_PLANT_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@S5_UT", Me.NullConvertString(.Item("S5_UT")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@RECORD_STATUS", Me.NullConvertString(.Item("RECORD_STATUS")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@JISSEKI_SHORI_FLG", Me.NullConvertString(.Item("JISSEKI_SHORI_FLG")), DBDataType.NVARCHAR)) '20161026 CHAR->NVARCHAR
...
#Region "運送(大)パラメータ設定"
    ...
    Private Sub SetUnsoLComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@UNSO_TEHAI_KB", .Item("UNSO_TEHAI_KB").ToString(), DBDataType.CHAR)) '20161026 NVARCHAR->CHAR
...
#Region "運賃パラメータ設定"
    ...
    Private Sub SetUnchinComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@SIZE_KB", .Item("SIZE_KB").ToString(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@TAX_KB", .Item("TAX_KB").ToString(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@SAGYO_KANRI", .Item("SAGYO_KANRI").ToString(), DBDataType.NVARCHAR)) '20161026 CHAR->NVARCHAR
...
#Region "取得処理パラメータ設定(EDI_L)"
    '2018/02/05 Annen 000589 出荷 _横浜アクサルタ-納入日の時間帯指定を全てAM必着にする add start
    Private Sub SetPrmCustDetails()
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", Me._Row("NRS_BR_CD").ToString(), DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@CUST_CD", Me._Row("CUST_CD_L").ToString(), DBDataType.CHAR))
...
#Region "届先マスタ自動追加用パラメータ設定(デュポン専用)"
