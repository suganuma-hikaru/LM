...
#Region "H_OUTKAEDI_DTL_NKS(INSERT)"

    ''' <summary>
    ''' INSERT（H_OUTKAEDI_DTL_NKS）
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Const SQL_INSERT_OUTKAEDI_DTL As String = "INSERT INTO                        " & vbNewLine _
                                        ...
                                        & ",NKS_DEL_KB                                    " & vbNewLine _
                                        & ",TOKUISAKI_CD                                  " & vbNewLine _
                                        & ",TOKUISAKI_NM                                  " & vbNewLine _
                                        & ",CYOHYO_CD                                     " & vbNewLine _
                                        & ",JYUCYU_NO                                     " & vbNewLine _
                                        & ",NKS_GYO_NO                                    " & vbNewLine _
                                        & ",JYUCYU_DATE                                   " & vbNewLine _
                                        & ",UNSO_CD                                       " & vbNewLine _
                                        & ",UNSO_NM                                       " & vbNewLine _
                                        & ",AITESAKI_CYUMON_NO                            " & vbNewLine _
                                        & ",PACKING_NO                                    " & vbNewLine _
                                        & ",SEIKYU_CD                                     " & vbNewLine _
                                        & ",SEIKYU_NM                                     " & vbNewLine _
                                        & ",NONYUSAKI_CD                                  " & vbNewLine _
                                        & ",NONYUSAKI_NM                                  " & vbNewLine _
                                        & ",SYAIN_CD                                      " & vbNewLine _
                                        & ",SYAIN_NM                                      " & vbNewLine _
                                        & ",BIKO                                          " & vbNewLine _
                                        & ",DENPYO_BIKO_NM1                               " & vbNewLine _
                                        & ",DENPYO_BIKO_NM2                               " & vbNewLine _
                                        & ",DENPYO_BIKO_NM3                               " & vbNewLine _
                                        & ",DENPYO_BIKO_NM4                               " & vbNewLine _
                                        & ",AITE_TOKUISAKI_CD                             " & vbNewLine _
                                        & ",AITE_UNSO_BIN_CD                              " & vbNewLine _
                                        & ",AITE_NONYUSAKI_CD                             " & vbNewLine _
                                        & ",CHIIKI_CD                                     " & vbNewLine _
                                        & ",EOS_DENPYO_NO                                 " & vbNewLine _
                                        & ",TORIHIKI_KB_CD                                " & vbNewLine _
                                        & ",TORIHIKI_KB_NM                                " & vbNewLine _
                                        & ",HINMOKU_CD                                    " & vbNewLine _
                                        & ",HINMOKU_NM                                    " & vbNewLine _
                                        & ",KIKAKU                                        " & vbNewLine _
                                        & ",TANKA                                         " & vbNewLine _
                                        & ",SURYO                                         " & vbNewLine _
                                        & ",TANI                                          " & vbNewLine _
                                        & ",KINGAKU                                       " & vbNewLine _
                                        & ",URI_TANKA                                     " & vbNewLine _
                                        & ",URI_KINGAKU                                   " & vbNewLine _
                                        & ",SOKO_CD                                       " & vbNewLine _
                                        & ",SOKO_NM                                       " & vbNewLine _
                                        & ",MEISAI_BIKO1                                  " & vbNewLine _
                                        & ",MEISAI_BIKO2                                  " & vbNewLine _
                                        & ",AITE_HINMOKU_CD                               " & vbNewLine _
                                        & ",AITE_HINMOKU_NM                               " & vbNewLine _
                                        & ",CYOHYO_INJI_CD                                " & vbNewLine _
                                        & ",CYOHYO_INJI_NISUGATA                          " & vbNewLine _
                                        & ",DENPYO_TANI_TTLQT                             " & vbNewLine _
                                        & ",EOS_HINMOKU_NM                                " & vbNewLine _
                                        & ",EOS_NISUGATA                                  " & vbNewLine _
                                        & ",EOS_KOSU                                      " & vbNewLine _
                                        & ",EOS_SURYO                                     " & vbNewLine _
                                        & ",EOS_TEKIYO                                    " & vbNewLine _
                                        & ",EOS_SIJI_NO                                   " & vbNewLine _
                                        & ",EOS_PAGE1                                     " & vbNewLine _
                                        & ",EOS_PAGE2                                     " & vbNewLine _
                                        & ",EOS_PAGE3                                     " & vbNewLine _
                                        & ",EOS_KBN_NM                                    " & vbNewLine _
                                        & ",EOS_TEN_CD                                    " & vbNewLine _
                                        & ",SIHARAI_CD                                    " & vbNewLine _
                                        & ",UNSO_KBN                                      " & vbNewLine _
                                        & ",BUMON_CD                                      " & vbNewLine _
                                        & ",BUMON_NM                                      " & vbNewLine _
                                        & ",KANSAN_TANKA                                  " & vbNewLine _
                                        & ",KANSAN_SURYO                                  " & vbNewLine _
                                        & ",L_KANSANCHI                                   " & vbNewLine _
                                        & ",L_KANSAN_SURYO                                " & vbNewLine _
                                        & ",L_TANKA                                       " & vbNewLine _
                                        & ",IRISU                                         " & vbNewLine _
                                        & ",TOKUISAKI_ZIP                                 " & vbNewLine _
                                        & ",TOKUISAKI_AD1                                 " & vbNewLine _
                                        & ",TOKUISAKI_AD2                                 " & vbNewLine _
                                        & ",TOKUISAKI_AD3                                 " & vbNewLine _
                                        & ",TOKUISAKI_TEL                                 " & vbNewLine _
                                        & ",TOKUISAKI_FAX                                 " & vbNewLine _
                                        & ",NONYUSAKI_ZIP                                 " & vbNewLine _
                                        & ",NONYUSAKI_AD1                                 " & vbNewLine _
                                        & ",NONYUSAKI_AD2                                 " & vbNewLine _
                                        & ",NONYUSAKI_AD3                                 " & vbNewLine _
                                        & ",NONYUSAKI_TEL                                 " & vbNewLine _
                                        & ",NONYUSAKI_FAX                                 " & vbNewLine _
                                        & ",SEIKYUSAKI_ZIP                                " & vbNewLine _
                                        & ",SEIKYUSAKI_AD1                                " & vbNewLine _
                                        & ",SEIKYUSAKI_AD2                                " & vbNewLine _
                                        & ",SEIKYUSAKI_AD3                                " & vbNewLine _
                                        & ",SEIKYUSAKI_TEL                                " & vbNewLine _
                                        & ",SEIKYUSAKI_FAX                                " & vbNewLine _
                                        & ",OUTKA_PLAN_DATE                               " & vbNewLine _
                                        & ",ARR_PLAN_DATE                                 " & vbNewLine _
                                        & ",REPLY_ARR_DATE                                " & vbNewLine _
                                        & ",NSL_JYUCYU_NO                                 " & vbNewLine _
                                        & ",DENPYO_OUTKA_BASHO                            " & vbNewLine _
                                        & ",DENPYO_OUTKA_AD1                              " & vbNewLine _
                                        & ",DENPYO_OUTKA_AD2                              " & vbNewLine _
                                        & ",DENPYO_OUTKA_AD3                              " & vbNewLine _
                                        & ",DENPYO_OUTKA_TEL                              " & vbNewLine _
                                        & ",DENPYO_OUTKA_FAX                              " & vbNewLine _
                                        & ",DENPYO_OUTKA_ZIP                              " & vbNewLine _
                                        & ",TENPO_CD                                      " & vbNewLine _
                                        & ",KANSAN_BAIKA                                  " & vbNewLine _
                                        & ",YELLOW_NONYU_TANKA                            " & vbNewLine _
                                        & ",EOS_NONYU_TANKA                               " & vbNewLine _
                                        & ",EOS_URI_TANKA                                 " & vbNewLine _
                                        & ",EOS_NONYUSAKI_CD                              " & vbNewLine _
                                        & ",YELLOW_DENPYO_KBN                             " & vbNewLine _
                                        & ",CODE_FREE1                                    " & vbNewLine _
                                        & ",CODE_FREE2                                    " & vbNewLine _
                                        & ",CYOHYO_CD2                                    " & vbNewLine _
                                        & ",URI_TANKA2                                    " & vbNewLine _
                                        & ",URI_KINGAKU2                                  " & vbNewLine _
                                        & ",EOS_OUTKA_AD1                                 " & vbNewLine _
                                        & ",EOS_OUTKA_AD2                                 " & vbNewLine _
                                        & ",EOS_BIKO1                                     " & vbNewLine _
                                        & ",EOS_BIKO2                                     " & vbNewLine _
                                        & ",EOS_CYUMONSAKI_NM                             " & vbNewLine _
                                        & ",EOS_NONYUSAKI_NM                              " & vbNewLine _
                                        & ",DENPYO_KBN                                    " & vbNewLine _
                                        & ",NONYUSHA_CD                                   " & vbNewLine _
                                        & ",EOS_UNSOSITEI_CD                              " & vbNewLine _
                                        & ",NSL_DENPYO_BIKO                               " & vbNewLine _
                                        & ",EOS_CYUMONSAKI_CD                             " & vbNewLine _
                                        & ",EOS_OUTKA_AD3                                 " & vbNewLine _
                                        & ",EOS_NONYU_SAKI_TEL                            " & vbNewLine _
                                        & ",NSL_HANBAI_TANKA                              " & vbNewLine _
                                        & ",EOS_NONYUSAKI_FAX                             " & vbNewLine _
                                        & ",RECORD_STATUS                                 " & vbNewLine _
                                        & ",HAISO_DATE                                    " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_NKS(取込削除時)"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_NKS）
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "H_OUTKAEDI_RCV_CAN 取消データ抽出用"
    ...
    Private Const SQL_SELECT_OUTKAEDI_RCV_CAN As String = _
                ...
                & " AND   H_OUTKAEDI_DTL.DENPYO_NO     = @DENPYO_NO         " & vbNewLine _
                & " AND   H_OUTKAEDI_DTL.NKS_GYO_NO    = @NKS_GYO_NO        " & vbNewLine _
...
#Region "H_OUTKAEDI_DTL_NKS"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_NKS）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_NKS SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "M_DEST UPDATE(届先項目差異有りの場合)(日興産業用)"
    ''' <summary>
    ''' 届先マスタUPDATE文（M_DEST）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_NKS As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC208.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC208.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectEdiM", cmd)
...
#End Region
    ...
    '        'SQL作成
    '        Me._StrSql.Append(LMH030DAC208.SQL_SELECT_COUNT_M_DEST)
    ...
    '        Me._StrSql.Append(LMH030DAC208.SQL_GROUP_BY_M_DEST_COUNT)
    ...
    '        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectDataNcgoMdest", cmd)
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC208.SQL_UPDATE_OUTKASAVEEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC208.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC208.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成SQL CONST名
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                'setSql = LMH030DAC208.SQL_UPDATE_JISSEKISAKUSEI_EDI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC208.SQL_UPDATE_OUTKAL_MATOME
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC208.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC208.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST(日興産業用)"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertUnchinData", cmd)
...
#Region "M_DEST(日興産業用)"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_M_DEST, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertMDestData", cmd)
...
#Region "届先マスタ自動追加用パラメータ設定(日興産業専用)"
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdestOutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC208.SQL_SELECT_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectDataMdestOutkaToroku", cmd)
...
#Region "セミEDI(画面取込)処理"
    ...
    Private Function SelectOutkaEdiRcvCancel(ByVal ds As DataSet) As DataSet
        ...
        '取消データは受信DTLから取得する
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_NKS")
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC208.SQL_SELECT_OUTKAEDI_RCV_CAN)         'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectOutkaEdiRcvCancel", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMH030_DTL_NKS_CANCELOUT")

        '処理件数の設定
        MyBase.SetResultCount(ds.Tables("LMH030_DTL_NKS_CANCELOUT").Rows.Count())
        reader.Close()
...
#Region "商品マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstGoods(ByVal ds As DataSet) As DataSet
        ...
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_H_OUTKAEDI_DTL_NKS")
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC208.SQL_SELECT_M_GOODS)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Where)
        Me._StrSql.Append(LMH030DAC208.SQL_WHERE1_M_GOODS)

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC208.SQL_GROUP_BY_M_GOODS)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectDataMgoods", cmd)
...
#Region "届先マスタ(セミEDI：受信情報からの抽出)"
    ...
    Private Function SelectMstDest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC208.SQL_SELECT_M_DEST1)

        Me._SqlPrmList = New ArrayList()

        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC208.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "SelectDataMDEST", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaEdiL(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim tbOutkaEdiRcvIn As DataTable = ds.Tables("LMH030_DTL_NKS_CANCELOUT")
        ...
        '出荷EDI CONST名
        sSql = LMH030DAC208.SQL_UPDATE_DEL_OUTKAIEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateDelOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI：画面取込)"
    ...
    Private Function UpdateDelOutkaEdiM(ByVal ds As DataSet) As DataSet
        ...
        'EDI出荷SQL
        sSql = LMH030DAC208.SQL_UPDATE_DEL_OUTKAIEDI_M
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateDelOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL(セミEDI：取消更新)"
    ...
    Private Function UpdateDelOutkaRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim canDtlTbl As DataTable = ds.Tables("LMH030_DTL_NKS_CANCELOUT")   'DTLの内容で処理する
        Dim drSemiEdiInfo As DataRow = ds.Tables("LMH030_SEMIEDI_INFO").Rows(0)
        ...
        sSql = LMH030DAC208.SQL_UPDATE_DEL_OUTKAEDI_DTL
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "UpdateDelOutkaRcvDtl", cmd)
...
#Region "H_OUTKAEDI_L(セミEDI)"
    ...
    Private Function InsertOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_OUTKAEDI_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertOutkaEdiL", cmd)
...
#Region "H_OUTKAEDI_M(セミEDI)"
    ...
    Private Function InsertOutkaEdiM(ByVal setDs As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_OUTKAEDI_M _
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertOutkaEdiM", cmd)
...
#Region "H_OUTKAEDI_DTL_XXX(セミEDI)"
    ...
    Private Function InsertOutkaEdiRcvDtl(ByVal setDs As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim dtOutkaEdiRcvDtl As DataTable = setDs.Tables("LMH030_H_OUTKAEDI_DTL_NKS")

        'スキーマ名設定
        Dim sql As String = Me.SetSchemaNm(LMH030DAC208.SQL_INSERT_OUTKAEDI_DTL, setDs.Tables("LMH030_H_OUTKAEDI_DTL_NKS").Rows(0).Item("NRS_BR_CD").ToString())
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC208", "InsertOutkaEdiRcvDtl", cmd)
...
#Region "EDI受信(DTL)更新パラメータ設定"
    ...
    Private Sub SetInsertOutkaEdiRcvDtlParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            'EDI受信（DTL）荷主個別項目
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_NO", Me.NullConvertString(.Item("DENPYO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NKS_DEL_KB", Me.NullConvertString(.Item("NKS_DEL_KB")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_CD", Me.NullConvertString(.Item("TOKUISAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_NM", Me.NullConvertString(.Item("TOKUISAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CYOHYO_CD", Me.NullConvertString(.Item("CYOHYO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@JYUCYU_NO", Me.NullConvertString(.Item("JYUCYU_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NKS_GYO_NO", Me.NullConvertString(.Item("NKS_GYO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@JYUCYU_DATE", Me.NullConvertString(.Item("JYUCYU_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSO_CD", Me.NullConvertString(.Item("UNSO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSO_NM", Me.NullConvertString(.Item("UNSO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AITESAKI_CYUMON_NO", Me.NullConvertString(.Item("AITESAKI_CYUMON_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@PACKING_NO", Me.NullConvertString(.Item("PACKING_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYU_CD", Me.NullConvertString(.Item("SEIKYU_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYU_NM", Me.NullConvertString(.Item("SEIKYU_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_CD", Me.NullConvertString(.Item("NONYUSAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_NM", Me.NullConvertString(.Item("NONYUSAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYAIN_CD", Me.NullConvertString(.Item("SYAIN_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SYAIN_NM", Me.NullConvertString(.Item("SYAIN_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BIKO", Me.NullConvertString(.Item("BIKO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_BIKO_NM1", Me.NullConvertString(.Item("DENPYO_BIKO_NM1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_BIKO_NM2", Me.NullConvertString(.Item("DENPYO_BIKO_NM2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_BIKO_NM3", Me.NullConvertString(.Item("DENPYO_BIKO_NM3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_BIKO_NM4", Me.NullConvertString(.Item("DENPYO_BIKO_NM4")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AITE_TOKUISAKI_CD", Me.NullConvertString(.Item("AITE_TOKUISAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AITE_UNSO_BIN_CD", Me.NullConvertString(.Item("AITE_UNSO_BIN_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AITE_NONYUSAKI_CD", Me.NullConvertString(.Item("AITE_NONYUSAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CHIIKI_CD", Me.NullConvertString(.Item("CHIIKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_DENPYO_NO", Me.NullConvertString(.Item("EOS_DENPYO_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKI_KB_CD", Me.NullConvertString(.Item("TORIHIKI_KB_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TORIHIKI_KB_NM", Me.NullConvertString(.Item("TORIHIKI_KB_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMOKU_CD", Me.NullConvertString(.Item("HINMOKU_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HINMOKU_NM", Me.NullConvertString(.Item("HINMOKU_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KIKAKU", Me.NullConvertString(.Item("KIKAKU")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TANKA", Me.NullConvertString(.Item("TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@SURYO", Me.NullConvertString(.Item("SURYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@TANI", Me.NullConvertString(.Item("TANI")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KINGAKU", Me.NullConvertString(.Item("KINGAKU")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@URI_TANKA", Me.NullConvertString(.Item("URI_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@URI_KINGAKU", Me.NullConvertString(.Item("URI_KINGAKU")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@SOKO_CD", Me.NullConvertString(.Item("SOKO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SOKO_NM", Me.NullConvertString(.Item("SOKO_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MEISAI_BIKO1", Me.NullConvertString(.Item("MEISAI_BIKO1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@MEISAI_BIKO2", Me.NullConvertString(.Item("MEISAI_BIKO2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AITE_HINMOKU_CD", Me.NullConvertString(.Item("AITE_HINMOKU_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@AITE_HINMOKU_NM", Me.NullConvertString(.Item("AITE_HINMOKU_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CYOHYO_INJI_CD", Me.NullConvertString(.Item("CYOHYO_INJI_CD")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@CYOHYO_INJI_NISUGATA", Me.NullConvertString(.Item("CYOHYO_INJI_NISUGATA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_TANI_TTLQT", Me.NullConvertString(.Item("DENPYO_TANI_TTLQT")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_HINMOKU_NM", Me.NullConvertString(.Item("EOS_HINMOKU_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_NISUGATA", Me.NullConvertString(.Item("EOS_NISUGATA")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_KOSU", Me.NullConvertString(.Item("EOS_KOSU")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_SURYO", Me.NullConvertString(.Item("EOS_SURYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_TEKIYO", Me.NullConvertString(.Item("EOS_TEKIYO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_SIJI_NO", Me.NullConvertString(.Item("EOS_SIJI_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_PAGE1", Me.NullConvertString(.Item("EOS_PAGE1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_PAGE2", Me.NullConvertString(.Item("EOS_PAGE2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_PAGE3", Me.NullConvertString(.Item("EOS_PAGE3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_KBN_NM", Me.NullConvertString(.Item("EOS_KBN_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_TEN_CD", Me.NullConvertString(.Item("EOS_TEN_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SIHARAI_CD", Me.NullConvertString(.Item("SIHARAI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@UNSO_KBN", Me.NullConvertString(.Item("UNSO_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BUMON_CD", Me.NullConvertString(.Item("BUMON_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@BUMON_NM", Me.NullConvertString(.Item("BUMON_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KANSAN_TANKA", Me.NullConvertString(.Item("KANSAN_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@KANSAN_SURYO", Me.NullConvertString(.Item("KANSAN_SURYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@L_KANSANCHI", Me.NullConvertString(.Item("L_KANSANCHI")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@L_KANSAN_SURYO", Me.NullConvertString(.Item("L_KANSAN_SURYO")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@L_TANKA", Me.NullConvertString(.Item("L_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@IRISU", Me.NullConvertString(.Item("IRISU")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_ZIP", Me.NullConvertString(.Item("TOKUISAKI_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_AD1", Me.NullConvertString(.Item("TOKUISAKI_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_AD2", Me.NullConvertString(.Item("TOKUISAKI_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_AD3", Me.NullConvertString(.Item("TOKUISAKI_AD3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_TEL", Me.NullConvertString(.Item("TOKUISAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TOKUISAKI_FAX", Me.NullConvertString(.Item("TOKUISAKI_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_ZIP", Me.NullConvertString(.Item("NONYUSAKI_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_AD1", Me.NullConvertString(.Item("NONYUSAKI_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_AD2", Me.NullConvertString(.Item("NONYUSAKI_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_AD3", Me.NullConvertString(.Item("NONYUSAKI_AD3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_TEL", Me.NullConvertString(.Item("NONYUSAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSAKI_FAX", Me.NullConvertString(.Item("NONYUSAKI_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUSAKI_ZIP", Me.NullConvertString(.Item("SEIKYUSAKI_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUSAKI_AD1", Me.NullConvertString(.Item("SEIKYUSAKI_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUSAKI_AD2", Me.NullConvertString(.Item("SEIKYUSAKI_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUSAKI_AD3", Me.NullConvertString(.Item("SEIKYUSAKI_AD3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUSAKI_TEL", Me.NullConvertString(.Item("SEIKYUSAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@SEIKYUSAKI_FAX", Me.NullConvertString(.Item("SEIKYUSAKI_FAX")), DBDataType.NVARCHAR))
            ...
            prmList.Add(MyBase.GetSqlParameter("@REPLY_ARR_DATE", Me.NullConvertString(.Item("REPLY_ARR_DATE")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NSL_JYUCYU_NO", Me.NullConvertString(.Item("NSL_JYUCYU_NO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_BASHO", Me.NullConvertString(.Item("DENPYO_OUTKA_BASHO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_AD1", Me.NullConvertString(.Item("DENPYO_OUTKA_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_AD2", Me.NullConvertString(.Item("DENPYO_OUTKA_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_AD3", Me.NullConvertString(.Item("DENPYO_OUTKA_AD3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_TEL", Me.NullConvertString(.Item("DENPYO_OUTKA_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_FAX", Me.NullConvertString(.Item("DENPYO_OUTKA_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_OUTKA_ZIP", Me.NullConvertString(.Item("DENPYO_OUTKA_ZIP")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@TENPO_CD", Me.NullConvertString(.Item("TENPO_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@KANSAN_BAIKA", Me.NullConvertString(.Item("KANSAN_BAIKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@YELLOW_NONYU_TANKA", Me.NullConvertString(.Item("YELLOW_NONYU_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_NONYU_TANKA", Me.NullConvertString(.Item("EOS_NONYU_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_URI_TANKA", Me.NullConvertString(.Item("EOS_URI_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_NONYUSAKI_CD", Me.NullConvertString(.Item("EOS_NONYUSAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@YELLOW_DENPYO_KBN", Me.NullConvertString(.Item("YELLOW_DENPYO_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CODE_FREE1", Me.NullConvertString(.Item("CODE_FREE1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CODE_FREE2", Me.NullConvertString(.Item("CODE_FREE2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@CYOHYO_CD2", Me.NullConvertString(.Item("CYOHYO_CD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@URI_TANKA2", Me.NullConvertString(.Item("URI_TANKA2")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@URI_KINGAKU2", Me.NullConvertString(.Item("URI_KINGAKU2")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_OUTKA_AD1", Me.NullConvertString(.Item("EOS_OUTKA_AD1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_OUTKA_AD2", Me.NullConvertString(.Item("EOS_OUTKA_AD2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_BIKO1", Me.NullConvertString(.Item("EOS_BIKO1")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_BIKO2", Me.NullConvertString(.Item("EOS_BIKO2")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_CYUMONSAKI_NM", Me.NullConvertString(.Item("EOS_CYUMONSAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_NONYUSAKI_NM", Me.NullConvertString(.Item("EOS_NONYUSAKI_NM")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_KBN", Me.NullConvertString(.Item("DENPYO_KBN")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NONYUSHA_CD", Me.NullConvertString(.Item("NONYUSHA_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_UNSOSITEI_CD", Me.NullConvertString(.Item("EOS_UNSOSITEI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NSL_DENPYO_BIKO", Me.NullConvertString(.Item("NSL_DENPYO_BIKO")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_CYUMONSAKI_CD", Me.NullConvertString(.Item("EOS_CYUMONSAKI_CD")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_OUTKA_AD3", Me.NullConvertString(.Item("EOS_OUTKA_AD3")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@EOS_NONYU_SAKI_TEL", Me.NullConvertString(.Item("EOS_NONYU_SAKI_TEL")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NSL_HANBAI_TANKA", Me.NullConvertString(.Item("NSL_HANBAI_TANKA")), DBDataType.NUMERIC))
            prmList.Add(MyBase.GetSqlParameter("@EOS_NONYUSAKI_FAX", Me.NullConvertString(.Item("EOS_NONYUSAKI_FAX")), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@HAISO_DATE", Me.NullConvertString(.Item("HAISO_DATE")), DBDataType.NVARCHAR))
            'EDI受信（DTL）共通項目
...
#Region "商品マスタパラメータ設定(セミEDI用)"
    ...
    Private Sub SetSelectMstGoodsParameter(ByVal semiInfoDr As DataRow, ByVal dtRcvDtl As DataTable)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@GOODS_CD_CUST", Me.NullConvertString(dtRcvDtl.Rows(0).Item("HINMOKU_CD")), DBDataType.NVARCHAR))
...
#Region "EDI受信(DTL)削除データ抽出パラメータ設定"
    ...
    Private Sub SetSelectOutkaEdiRcvCancel(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@DENPYO_NO", Me.NullConvertString(.Item("DENPYO_NO").ToString()), DBDataType.NVARCHAR))
            prmList.Add(MyBase.GetSqlParameter("@NKS_GYO_NO", Me.NullConvertString(.Item("NKS_GYO_NO").ToString()), DBDataType.NVARCHAR))
