...
#Region "SELECT_SEND"
    ...
    Private Const SQL_SELECT_SEND As String = "SELECT                           " & vbNewLine _
                    ...
                    & " ,INKA_M.INKA_NO_L	          AS INOUT_CTL_NO_L         " & vbNewLine _
                    & " ,INKA_M.INKA_NO_M	          AS INOUT_CTL_NO_M         " & vbNewLine _
                    & " ,HED.CUST_CD_L	              AS CUST_CD_L              " & vbNewLine _
                    & " ,HED.CUST_CD_M	              AS CUST_CD_M              " & vbNewLine _
                    & " ,HED.KITAKU_CD	              AS KITAKU_CD              " & vbNewLine _
                    & " ,HED.INKA_SOKO_CD         	  AS SOKO_CD                " & vbNewLine _
                    & " ,HED.ORDER_TYPE	              AS ORDER_TYPE             " & vbNewLine _
                    & " ,INKA_L.INKA_DATE             AS INOUT_DATE             " & vbNewLine _
                    ...
                    & " ,''		                      AS LOCA                   " & vbNewLine _
                    & " --,EDI_M.INKA_PKG_NB          AS INOUT_PKG_NB           " & vbNewLine _
                    & " ,S.KONSU                      AS INOUT_PKG_NB           " & vbNewLine _
                    & " ,''		                      AS BUMON_CD               " & vbNewLine _
                    & " ,''		                      AS JIGYOBU_CD             " & vbNewLine _
                    & " --(2013.03.11)BPC新レイアウト対応 SATRT                 " & vbNewLine _
                    & " ,INKA_L.INKA_NO_L             AS INKA_CTL_NO            " & vbNewLine _
                    & " --(2013.03.11)BPC新レイアウト対応 END                   " & vbNewLine _
                    & " ,'00000000'		              AS TOKUI_CD               " & vbNewLine _
                    ...
                    & "   ON INKA_M.NRS_BR_CD = EDI_M.NRS_BR_CD                 " & vbNewLine _
                    ...
                    & " INNER JOIN $LM_TRN$..H_INKAEDI_HED_BP HED               " & vbNewLine _
                    ...
                    & " INNER JOIN $LM_TRN$..H_INKAEDI_DTL_BP DTL               " & vbNewLine _
                    ...
                    & "     SUM(INKA_S.KONSU) AS KONSU                          " & vbNewLine _
                    & "   FROM $LM_TRN$..B_INKA_S INKA_S                        " & vbNewLine _
                    & "    WHERE INKA_S.SYS_DEL_FLG <> '1'                      " & vbNewLine _
                    & "     AND  INKA_S.NRS_BR_CD = @NRS_BR_CD                  " & vbNewLine _
                    & "    GROUP BY                                             " & vbNewLine _
                    & "     INKA_S.INKA_NO_L,                                   " & vbNewLine _
                    & "     INKA_S.INKA_NO_M                                    " & vbNewLine _
                    & "   ) S                                                   " & vbNewLine _
                    & "   ON  S.INKA_NO_L = EDI_M.INKA_CTL_NO_L                 " & vbNewLine _
                    & "   AND S.INKA_NO_M = EDI_M.INKA_CTL_NO_M                 " & vbNewLine _
...
#Region "SELECT_TOU_SITU_M"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_SELECT_TOU_SITU_M As String = "SELECT                                               " & vbNewLine _
                                              & "   COUNT(*)                         As SELECT_CNT        " & vbNewLine _
                                              & " FROM $LM_MST$..M_TOU_SITU TOUSITU                       " & vbNewLine _
                                              & " WHERE                                                   " & vbNewLine _
                                              & "     TOUSITU.NRS_BR_CD = @NRS_BR_CD                      " & vbNewLine _
                                              & " AND TOUSITU.WH_CD     = @NRS_WH_CD                      " & vbNewLine _
                                              & " AND TOUSITU.TOU_NO    = @TOU_NO                         " & vbNewLine _
                                              & " AND TOUSITU.SITU_NO   = @SITU_NO                        " & vbNewLine
#End Region '棟室マスタ存在チェック

#Region "SELECT_ZONE_M"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_SELECT_ZONE_M As String = "SELECT                                                   " & vbNewLine _
                                              & "   COUNT(*)                         As SELECT_CNT        " & vbNewLine _
                                              & " FROM $LM_MST$..M_ZONE ZONE                              " & vbNewLine _
                                              & " WHERE                                                   " & vbNewLine _
                                              & "     ZONE.NRS_BR_CD = @NRS_BR_CD                         " & vbNewLine _
                                              & " AND ZONE.WH_CD     = @NRS_WH_CD                         " & vbNewLine _
                                              & " AND ZONE.TOU_NO    = @TOU_NO                            " & vbNewLine _
                                              & " AND ZONE.SITU_NO   = @SITU_NO                           " & vbNewLine _
                                              & " AND ZONE.ZONE_CD   = @ZONE_CD                           " & vbNewLine

#End Region 'ゾーンマスタ存在チェック
    'ビーピー・カストロール対応 terakawa 2012.12.12 Start
...
#Region "RCV_HED(入荷登録)"
    ...
    Private Const SQL_UPD_RCV_HED As String = "UPDATE                                               " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_HED_BP                    " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L       	        " & vbNewLine _
...
#Region "RCV_DTL(入荷登録)"
    ...
    Private Const SQL_UPDATE_RCV_DTL As String = "UPDATE                                            " & vbNewLine _
                                              & " $LM_TRN$..H_INKAEDI_DTL_BP                      " & vbNewLine _
                                              & " SET                                               " & vbNewLine _
                                              & " INKA_CTL_NO_L     = @INKA_CTL_NO_L    	        " & vbNewLine _
                                              & ",INKA_CTL_NO_M     = @INKA_CTL_NO_M        	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    '''' <remarks></remarks>
    '''' 
    'Private Const SQL_UPDATE_RCV_DTL_BP As String = "UPDATE $LM_TRN$..H_INKAEDI_DTL_BP SET     " & vbNewLine _
    '                                          & "JISSEKI_SHORI_FLG = @JISSEKI_SHORI_FLG            " & vbNewLine _
    '                                          & ",JISSEKI_USER      = @JISSEKI_USER                 " & vbNewLine _
    '                                          & ",JISSEKI_DATE      = @JISSEKI_DATE                 " & vbNewLine _
    '                                          & ",JISSEKI_TIME      = @JISSEKI_TIME                 " & vbNewLine _
    ...
    Private Const SQL_UPDATE_RCV_DTL_BP As String = "UPDATE $LM_TRN$..H_INKAEDI_DTL_BP SET                       " & vbNewLine _
                                              ...
                                              & ",SYS_UPD_PGID           = @SYS_UPD_PGID                              " & vbNewLine _
                                              & ",SYS_UPD_USER           = @SYS_UPD_USER                              " & vbNewLine _
                                              & " FROM $LM_TRN$..H_INKAEDI_DTL_BP                                 " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..H_INKAEDI_M                                    " & vbNewLine _
                                              & "  ON  H_INKAEDI_M.SYS_DEL_FLG <> '1'                                 " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.NRS_BR_CD = H_INKAEDI_M.NRS_BR_CD         " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.EDI_CTL_NO = H_INKAEDI_M.EDI_CTL_NO       " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.EDI_CTL_NO_CHU = H_INKAEDI_M.EDI_CTL_NO_CHU  " & vbNewLine _
                                              & "  AND H_INKAEDI_M.JISSEKI_FLAG = '0'                                  " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..B_INKA_L                                        " & vbNewLine _
                                              & "  ON  B_INKA_L.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.NRS_BR_CD = B_INKA_L.NRS_BR_CD             " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.INKA_CTL_NO_L = B_INKA_L.INKA_NO_L         " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..B_INKA_M                                        " & vbNewLine _
                                              & "  ON  B_INKA_M.SYS_DEL_FLG <> '1'                                     " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.NRS_BR_CD = B_INKA_M.NRS_BR_CD             " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.INKA_CTL_NO_L = B_INKA_M.INKA_NO_L         " & vbNewLine _
                                              & "  AND H_INKAEDI_DTL_BP.INKA_CTL_NO_M = B_INKA_M.INKA_NO_M         " & vbNewLine _
                                              & " INNER JOIN                                                           " & vbNewLine _
                                              & "  (SELECT                                                             " & vbNewLine _
                                              ...
                                              & "WHERE   H_INKAEDI_DTL_BP.NRS_BR_CD       = @NRS_BR_CD             " & vbNewLine _
                                              & "AND H_INKAEDI_DTL_BP.EDI_CTL_NO          = @EDI_CTL_NO            " & vbNewLine _
                                              & "AND H_INKAEDI_DTL_BP.JISSEKI_SHORI_FLG   = '1'      			   " & vbNewLine _
                                              & "AND H_INKAEDI_DTL_BP.SYS_DEL_FLG         <> '1'                   " & vbNewLine
...
#Region "EDI(大)データ取得処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC501.SQL_SELECT_EDI_L)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "SelectEdiL", cmd)
...
#Region "EDI(中)データ取得処理"
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC501.SQL_SELECT_EDI_M)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "SelectEdiM", cmd)
...
#Region "実績送信データ取得処理"
    ...
    Private Function SelectSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH010DAC501.SQL_SELECT_SEND)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "SelectSend", cmd)
...
#Region "存在チェック"
    ...
    Private Function TouSituMstExistChk(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH010DAC501.SQL_SELECT_TOU_SITU_M)

        Dim dtGoodsDtl As DataTable = ds.Tables("LMH010_M_GOODS_DETAILS")
        Dim dtEdiL As DataTable = ds.Tables("LMH010_INKAEDI_L")

        Me._SqlPrmList = New ArrayList()

        'パラメータ設定
        Call Me.SetTouSituParameter(dtEdiL, dtGoodsDtl)
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC", "TouSituMstExistChk", cmd)
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks>オーダー番号重複チェック</remarks>
    Private Function ZoneMstExistChk(ByVal ds As DataSet) As DataSet

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMH010DAC501.SQL_SELECT_ZONE_M)
        ...
        'パラメータ設定
        Call Me.SetZoneParameter(dtEdiL, dtGoodsDtl)
    ...
    Private Function UpdateEdiL(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC501.SQL_UPD_INKATOROKU_EDI_L

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC501.SQL_UPD_JISSEKITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC501.SQL_UPD_EDITORIKESI_EDI_L
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC501.SQL_UPD_JISSEKIMODOSI_EDI_L

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC501.SQL_UPD_TOUROKUMI_EDI_L

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC501.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "LMH010_INKAEDI_L", cmd)
    ...
    Private Function UpdateEdiM(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC501.SQL_UPD_INKATOROKU_EDI_M
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC501.SQL_UPD_EDITORIKESI_EDI_M

                '実績作成済⇒実績未、実績送信済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                , LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC501.SQL_UPD_JISSEKIMODOSI_EDI_M

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE

                setSql = LMH010DAC501.SQL_UPD_JISSEKISAKUSEI_EDI_M

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC501.SQL_UPD_TOUROKUMI_EDI_M

                '送信済み⇒送信待ち
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC501.SQL_JISSEKIZUMI_SOUSINMACHI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "UpdateEdiM", cmd)
    ...
    Private Function UpdateRcvHed(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            ...
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                ...
                setSql = LMH010DAC501.SQL_UPD_RCV_HED

            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI

                setSql = LMH010DAC501.SQL_UPD_JISSEKITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC501.SQL_UPD_EDITORIKESI_RCV_HED
            ...
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI _
                ...
                setSql = LMH010DAC501.SQL_UPD_JISSEKIMODOSI_RCV_HED

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC501.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_HED

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC501.SQL_UPD_TOUROKUMI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "UpdateRcvHed", cmd)
...
#Region "RCV_DTL"
    ...
    Private Function UpdateRcvDtl(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(eventShubetsu, LMH010DAC.EventShubetsu)
            '入荷登録
            Case LMH010DAC.EventShubetsu.TOROKU, LMH010DAC.EventShubetsu.HIMODUKE
                setSql = LMH010DAC501.SQL_UPDATE_RCV_DTL

                '実績作成
            Case LMH010DAC.EventShubetsu.JISSEKI_SAKUSE
                setSql = LMH010DAC501.SQL_UPDATE_RCV_DTL_BP

                '実績取消
            Case LMH010DAC.EventShubetsu.JISSEKI_TORIKESI
                setSql = LMH010DAC501.SQL_UPD_JISSEKITORIKESI_RCV_DTL
            ...
            Case LMH010DAC.EventShubetsu.EDI_TORIKESI _
                ...
                setSql = LMH010DAC501.SQL_UPD_EDITORIKESI_RCV_DTL

                '実績作成済⇒実績未
            Case LMH010DAC.EventShubetsu.JIKKOU_SAKUSEI_JISSEKIMI

                setSql = LMH010DAC501.SQL_UPD_JISSEKIZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒実績未、
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_JISSEKIMI

                setSql = LMH010DAC501.SQL_UPD_SOUSINZUMI_JISSEKIMI_RCV_DTL

                '実績送信済⇒送信未
            Case LMH010DAC.EventShubetsu.JIKKOU_SOUSIN_SOUSINMI

                setSql = LMH010DAC501.SQL_UPD_SOUSINZUMI_SOUSINMI_RCV_DTL

            Case LMH010DAC.EventShubetsu.JIKKOU_TOUROKU_MITOUROKU

                setSql = LMH010DAC501.SQL_UPD_TOUROKUMI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "UpdateRcvDtl", cmd)
...
#Region "INKA_L"
    ...
    Private Function UpdateInkaL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "UpdateInkaL", cmd)
        'SQLの発行
        Dim resultCnt As Integer = MyBase.GetUpdateResult(cmd)
...
#Region "INKA_L"
    ...
    Private Function InsertInkaL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_INKA_L, dtRow.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertInkaL", cmd)
...
#Region "INKA_M"
    ...
    Private Function InsertInkaM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_INKA_M, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertInkaM", cmd)
...
#Region "INKA_S"
    ...
    Private Function InsertInkaS(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_INKA_S, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertInkaS", cmd)
...
#Region "SEND"
    ...
    Private Function InsertSend(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_SEND, brCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertSend", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyo(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_SAGYO, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertSagyo", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_UNSO_L, nrsBrCd))
        ...
        MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertUnsoL", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoM(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_UNSO_M, nrsBrCd))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertUnsoM", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH010DAC501.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH010DAC501", "InsertUnchinData", cmd)
...
#End Region
    ...
    'ビーピー・カストロール対応 terakawa 2012.12.12 Start
#Region "存在チェックパラメータ設定"
    ''' <summary>
    ''' M_TOU_SITU
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetTouSituParameter(ByVal dtEdiL As DataTable, ByVal dtGoodsDtl As DataTable)

        Dim nrsBrCd As String = dtEdiL.Rows(0).Item("NRS_BR_CD").ToString()
        Dim nrsWhCd As String = dtEdiL.Rows(0).Item("NRS_WH_CD").ToString()
        Dim touNo As String = dtGoodsDtl.Rows(0).Item("SET_NAIYO").ToString().Substring(0, 2)
        Dim situNo As String = dtGoodsDtl.Rows(0).Item("SET_NAIYO").ToString().Substring(2, 1)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", nrsBrCd, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_WH_CD", nrsWhCd, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOU_NO", touNo, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SITU_NO", situNo, DBDataType.CHAR))
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetZoneParameter(ByVal dtEdiL As DataTable, ByVal dtGoodsDtl As DataTable)

        Dim nrsBrCd As String = dtEdiL.Rows(0).Item("NRS_BR_CD").ToString()
        Dim nrsWhCd As String = dtEdiL.Rows(0).Item("NRS_WH_CD").ToString()
        Dim touNo As String = dtGoodsDtl.Rows(0).Item("SET_NAIYO").ToString().Substring(0, 2)
        Dim situNo As String = dtGoodsDtl.Rows(0).Item("SET_NAIYO").ToString().Substring(2, 1)
        Dim zoneCd As String = dtGoodsDtl.Rows(0).Item("SET_NAIYO").ToString().Substring(3, 1)

        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", nrsBrCd, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_WH_CD", nrsWhCd, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@TOU_NO", touNo, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SITU_NO", situNo, DBDataType.CHAR))
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@ZONE_CD", zoneCd, DBDataType.CHAR))
