...
''' </summary>
''' <remarks></remarks>
Public Class LMH030DAC105
    Inherits Jp.Co.Nrs.LM.Base.DAC.LMBaseDAC

#Region "Const"


    'ハネウェル対応 terakawa 2013.01.28 Start
#Region "汎用届先コード(ハネウェル専用)パラメータ用CONST"

    ''' <summary>
    ''' 汎用届先コード(0000000001)
    ''' </summary>
    ''' <remarks></remarks>
    Public Const EDI_DEST_CD_HANYO As String = "0000000001"

#End Region
    'ハネウェル対応 terakawa 2013.01.28 End
...
#Region "出荷登録処理 更新用SQL"
    ...
    'ハネウェル対応 terakawa 2013.01.28 Start
#Region "事前チェック用"
    Private Const SQL_SELECT_ENTRY_BEFORE As String = "UPDATE  $LM_TRN$..H_OUTKAEDI_M  SET       " & vbNewLine _
                                     & "  CUST_GOODS_CD = GOODS.GOODS_CD_CUST                    " & vbNewLine _
                                     & "  ,NRS_GOODS_CD = GOODS.GOODS_CD_NRS                     " & vbNewLine _
                                     & "  ,GOODS_NM = GOODS.GOODS_NM_1                           " & vbNewLine _
                                     & "  ,UPD_USER = @UPD_USER                                  " & vbNewLine _
                                     & "  ,UPD_DATE = @UPD_DATE                                  " & vbNewLine _
                                     & "  ,UPD_TIME = @UPD_TIME                                  " & vbNewLine _
                                     & " FROM  $LM_TRN$..H_OUTKAEDI_M EDI_M                      " & vbNewLine _
                                     & " INNER JOIN  $LM_TRN$..H_OUTKAEDI_L EDI_L                " & vbNewLine _
                                     ...
                                     & "  ON  GOODS.SYS_DEL_FLG <> '1'                           " & vbNewLine _
                                     & "  AND GOODS.NRS_BR_CD = EDI_L.NRS_BR_CD                  " & vbNewLine _
                                     & "  AND GOODS.CUST_CD_L = EDI_L.CUST_CD_L                  " & vbNewLine _
                                     & "  AND GOODS.CUST_CD_M = EDI_L.CUST_CD_M                  " & vbNewLine _
                                     & "  AND RTRIM(REPLACE(GOODS.JAN_CD,CHAR(13)+CHAR(10),''))  " & vbNewLine _
                                     & "              = RIGHT(RTRIM(EDI_M.FREE_C02),13)          " & vbNewLine _
                                     & " WHERE EDI_M.NRS_BR_CD = @NRS_BR_CD                      " & vbNewLine _
                                     & "  AND  EDI_M.EDI_CTL_NO = @EDI_CTL_NO                    " & vbNewLine _
                                     & "  AND  RTRIM(EDI_M.CUST_GOODS_CD) = ''                   " & vbNewLine _
                                     & "  AND  RTRIM(EDI_M.NRS_GOODS_CD) = ''                    " & vbNewLine
...
#Region "H_OUTKAEDI_DTL_HON"
    ''' <summary>
    ''' EDI受信DTLのUPDATE文（H_OUTKAEDI_DTL_HON）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_HON SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
                                              & ",OUTKA_CTL_NO_CHU  = @OUTKA_CTL_NO_CHU       	    " & vbNewLine _
                                              & ",UPD_USER          = @UPD_USER                     " & vbNewLine _
                                              & ",UPD_DATE          = @UPD_DATE                     " & vbNewLine _
...
#Region "H_OUTKAEDI_HED_HON"
    ''' <summary>
    ''' EDI受信HEDのUPDATE文（H_OUTKAEDI_HED_HON）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_OUTKASAVE_EDI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_HON SET       " & vbNewLine _
                                              & " OUTKA_CTL_NO      = @OUTKA_CTL_NO       	        " & vbNewLine _
...
#Region "M_DEST UPDATE(届先項目差異有りの場合)"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_UPDATE_M_DEST_HON As String = "UPDATE $LM_MST$..M_DEST SET       " & vbNewLine _
                                              & " DEST_NM           = @DEST_NM       	" & vbNewLine _
                                              & ",ZIP               = @ZIP              " & vbNewLine _
...
#Region "RCV_HED(実績作成)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPD_JISSEKI_RCV_HED As String = "UPDATE $LM_TRN$..H_OUTKAEDI_HED_HON SET                             " & vbNewLine _
                                              & " UPD_USER               = @UPD_USER                                        " & vbNewLine _
                                              & ",UPD_DATE               = @UPD_DATE                                        " & vbNewLine _
                                              & ",UPD_TIME               = @UPD_TIME                                        " & vbNewLine _
                                              & ",SYS_UPD_DATE           = @SYS_UPD_DATE                                    " & vbNewLine _
...
#Region "RCV_DTL(実績作成)"
    ...
    ''' <remarks></remarks>
    ''' 
    Private Const SQL_UPD_JISSEKI_RCV_DTL As String = "UPDATE $LM_TRN$..H_OUTKAEDI_DTL_HON SET                             " & vbNewLine _
                                              & " LOADING_DATE           = C_OUTKA_L.OUTKA_PLAN_DATE                    " & vbNewLine _
                                              ...
                                              & ",SYS_UPD_PGID           = @SYS_UPD_PGID                                    " & vbNewLine _
                                              & ",SYS_UPD_USER           = @SYS_UPD_USER                                    " & vbNewLine _
                                              & " FROM $LM_TRN$..H_OUTKAEDI_DTL_HON                                       " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..H_OUTKAEDI_M                                         " & vbNewLine _
                                              & "  ON  H_OUTKAEDI_M.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.NRS_BR_CD = H_OUTKAEDI_M.NRS_BR_CD              " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.EDI_CTL_NO = H_OUTKAEDI_M.EDI_CTL_NO            " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.EDI_CTL_NO_CHU = H_OUTKAEDI_M.EDI_CTL_NO_CHU    " & vbNewLine _
                                              & "  AND H_OUTKAEDI_M.JISSEKI_FLAG = '0'                                      " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..C_OUTKA_L                                            " & vbNewLine _
                                              & "  ON  C_OUTKA_L.SYS_DEL_FLG = '0'                                         " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.NRS_BR_CD = C_OUTKA_L.NRS_BR_CD                 " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.OUTKA_CTL_NO = C_OUTKA_L.OUTKA_NO_L           " & vbNewLine _
                                              & " INNER JOIN $LM_TRN$..C_OUTKA_M                                            " & vbNewLine _
                                              & "  ON  C_OUTKA_M.SYS_DEL_FLG = '0'                                         " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.NRS_BR_CD = C_OUTKA_M.NRS_BR_CD                 " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.OUTKA_CTL_NO = C_OUTKA_M.OUTKA_NO_L           " & vbNewLine _
                                              & "  AND H_OUTKAEDI_DTL_HON.OUTKA_CTL_NO_CHU = C_OUTKA_M.OUTKA_NO_M           " & vbNewLine _
                                              & "WHERE   H_OUTKAEDI_DTL_HON.NRS_BR_CD       = @NRS_BR_CD                  " & vbNewLine _
                                              & "AND H_OUTKAEDI_DTL_HON.EDI_CTL_NO          = @EDI_CTL_NO                 " & vbNewLine _
                                              & "AND H_OUTKAEDI_DTL_HON.JISSEKI_SHORI_FLG   = '1'      			        " & vbNewLine _
                                              & "AND H_OUTKAEDI_DTL_HON.SYS_DEL_FLG         = '0'                        " & vbNewLine
...
#Region "出荷登録処理"
    ...
    Private Function SelectEdiL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC105.L_DEF_SQL_SELECT_DATA)      'SQL構築
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "SelectEdiL", cmd)
    ...
    Private Function SelectEdiM(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC105.M_DEF_SQL_SELECT_DATA)      'SQL構築(データ抽出用)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "SelectEdiM", cmd)
...
#Region "存在チェック(出荷登録用)"
    ...
    Private Function SelectDataNcgoMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC105.SQL_SELECT_COUNT_M_DEST)
        ...
        Me._StrSql.Append(LMH030DAC105.SQL_GROUP_BY_M_DEST_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "SelectDataNcgoMdest", cmd)
...
#Region "Update"
    ...
    'ハネウェル対応 terakawa 2012.01.28 Start 
#Region "登録前の事前チェック"
    ...
    Private Function EntryBeforeCheck(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC105.SQL_SELECT_ENTRY_BEFORE)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "EntryBeforeCheck", cmd)
...
#End Region
    'ハネウェル対応 terakawa 2012.01.28 End
    ...
    Private Function UpdateOutkaEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC105.SQL_UPDATE_OUTKASAVEEDI_L

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC105.SQL_UPD_JISSEKI_EDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateOutkaEdiLData", cmd)
...
#Region "H_OUTKAEDI_M"
    ...
    Private Function UpdateOutkaEdiMData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC105.SQL_UPDATE_OUTKAEDI_M
                loopflg = 1

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC105.SQL_UPD_JISSEKI_EDI_M
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateOutkaEdiMData", cmd)
...
#Region "H_OUTKAEDI_HED"
    ...
    Private Function UpdateEdiRcvHedData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC105.SQL_UPDATE_OUTKASAVE_EDI_RCV_HED

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC105.SQL_UPD_JISSEKI_RCV_HED
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateEdiRcvHedData", cmd)
...
#Region "H_OUTKAEDI_DTL"
    ...
    Private Function UpdateEdiRcvDtlData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録、紐付けSQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA, LMH030DAC.EventShubetsu.HIMODUKE
                setSql = LMH030DAC105.SQL_UPDATE_OUTKASAVE_EDI_RCV_DTL
                loopflg = 1

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC105.SQL_UPD_JISSEKI_RCV_DTL
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateEdiRcvDtlData", cmd)
    ...
    Private Function UpdateOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC105.SQL_UPDATE_OUTKAL_MATOME

                '実績作成
            Case LMH030DAC.EventShubetsu.CREATEJISSEKI
                setSql = LMH030DAC105.SQL_UPD_JISSEKI_OUTKA_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateOutkaLData", cmd)
...
#Region "まとめ先EDI出荷(大)"
    ...
    Private Function UpdateMatomesakiEdiLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC105.SQL_UPDATE_MATOMESAKI_OUTKAEDI_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateMatomesakiEdiLData", cmd)
...
#Region "まとめ先運送(大)"
    ...
    Private Function UpdateMatomesakiUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        Select Case DirectCast(dtEventShubetsu, LMH030DAC.EventShubetsu)
            ...
            '出荷登録SQL CONST名
            Case LMH030DAC.EventShubetsu.SAVEOUTKA
                setSql = LMH030DAC105.SQL_UPDATE_MATOMESAKI_UNSO_L
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateMatomesakiUnsoLData", cmd)
...
#Region "M_DEST"
    ...
    Private Function UpdateMDestData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateMDestData", cmd)
...
#Region "C_OUTKA_L"
    ...
    Private Function InsertOutkaLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_OUTKA_L, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "InsertOutkaLData", cmd)
...
#Region "C_OUTKA_M"
    ...
    Private Function InsertOutkaMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_OUTKA_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC105", "UpdateOutkaMData", cmd)
...
#Region "E_SAGYO_REC"
    ...
    Private Function InsertSagyoData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_SAGYO _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC105", "InsertSagyoData", cmd)
...
#Region "UNSO_L"
    ...
    Private Function InsertUnsoLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_UNSO_L _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "InsertUnsoLData", cmd)
...
#Region "UNSO_M"
    ...
    Private Function InsertUnsoMData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_UNSO_M _
                                                                       , ds.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("NRS_BR_CD").ToString()))
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC105", "InsertUnsoMData", cmd)
...
#Region "UNCHIN"
    ...
    Private Function InsertUnchinData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_UNCHIN _
        ...
        For i As Integer = 0 To max
            ...
            MyBase.Logger.WriteSQLLog("LMH030DAC105", "InsertUnchinData", cmd)
...
#Region "M_DEST"
    ...
    Private Function InsertMDestData(ByVal ds As DataSet) As DataSet
        ...
        'SQL文のコンパイル
        Dim cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(LMH030DAC105.SQL_INSERT_M_DEST_NCGO, Me._Row.Item("NRS_BR_CD").ToString()))
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "InsertMDestData", cmd)
...
#Region "運賃パラメータ設定"
    ...
    Private Sub SetUnchinComParameter(ByVal conditionRow As DataRow, ByVal prmList As ArrayList)
        ...
        With conditionRow
            ...
            prmList.Add(MyBase.GetSqlParameter("@SEIQTO_CD", .Item("SEIQTO_CD").ToString(), DBDataType.NVARCHAR))                   '要望番号1696:(●急●群馬00952：ハネウェル ＥＤＩ出荷登録でアベンド) 2012/12/05 本明 この行を復活させた
...
#Region "届先マスタ"
    ...
    Private Function SelectDataMdest(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMH030DAC105.SQL_SELECT_M_DEST)

        If dt.Rows(0)("EDI_DEST_CD").ToString() = String.Empty OrElse _
           dt.Rows(0)("EDI_DEST_CD").ToString().Equals(LMH030DAC105.EDI_DEST_CD_HANYO) Then
            Me._StrSql.Append(vbNewLine)
            Me._StrSql.Append("AND M_DEST.DEST_CD = @DEST_CD")
        Else
            Me._StrSql.Append(vbNewLine)
        ...
        'SQL条件設定(Group by)
        Me._StrSql.Append(LMH030DAC105.SQL_GROUP_BY_M_DEST)
        ...
        MyBase.Logger.WriteSQLLog("LMH030DAC105", "SelectDataMdest", cmd)
