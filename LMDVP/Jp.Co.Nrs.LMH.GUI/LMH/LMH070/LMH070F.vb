...
'  システム名       :  LM
'  サブシステム名   :  LMH     : EDI
'  プログラムID     :  LMH070F : 手入力入荷データ分報告用ＥＤＩデータ作成
'  作  成  者       :  
' ==========================================================================
...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMH070H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMH070F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
