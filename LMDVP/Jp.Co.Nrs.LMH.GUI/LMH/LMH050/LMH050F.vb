...
'  システム名       :  LM
'  サブシステム名   :  LMH     : EDI
'  プログラムID     :  LMH050F : EDIワーニング・エラーチェック画面
'  作  成  者       :  
' ==========================================================================
...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMH050H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMH050F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
