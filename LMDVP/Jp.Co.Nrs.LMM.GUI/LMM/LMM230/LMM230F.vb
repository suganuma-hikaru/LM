...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM230H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM230F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        Call Me._Handler.LMM230F_KeyDown(Me, e)
