...
''' 
''' </histry>
Public Class LMM060C
    Inherits Jp.Co.Nrs.LM.Const.LMConst

    'データセットテーブル名
    Public Const TABLE_NM_IN As String = "LMM060IN"
    Public Const TABLE_NM_OUT As String = "LMM060OUT"
    Public Const TABLE_NM_KYORI As String = "LMM060_KYORI"
    Public Const TABLE_NM_UNCHIN_TARRIF_MAXEDA As String = "LMM060_UNCHIN_TARRIF_MAXEDA"
