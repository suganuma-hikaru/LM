...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMM180F, ByRef v As LMMControlV)
...
#Region "Method"
    ...
    Private Sub TrimSpaceTextValue()
        ...
        With Me._Frm
            ...
            .cmbKenNm.TextValue = .cmbKenNm.TextValue.Trim()
    ...
    Private Function IsSaveSingleCheck() As Boolean
        ...
        With Me._Frm
            ...
            '都道府県(漢字)
            .cmbKenNm.ItemName = "都道府県"
            .cmbKenNm.IsHissuCheck = True
            If MyBase.IsValidateCheck(.cmbKenNm) = False Then
                Return False
            End If

            '市区町村名(漢字)
            .txtCityN.ItemName = "市区町村名"
    ...
    Private Function IsKensakuSingleCheck() As Boolean
        ...
        With Me._Frm
            ...
            '市区町村名(漢字)
            vCell.SetValidateCell(0, LMM180G.sprDetailDef.SHI.ColNo)
            ...
            End If
            'JISコード
            vCell.SetValidateCell(0, LMM180G.sprDetailDef.JIS_CD.ColNo)
    ...
    Private Function IsKensakuHissuCheck() As Boolean
        ...
        With Me._Frm
            ...
            Dim jc As String = String.Empty
            Dim tm As String = String.Empty
            jc = Me._Vcon.GetCellValue(.sprDetail.ActiveSheet.Cells(0, LMM180G.sprDetailDef.JIS_CD.ColNo))
            tm = Me._Vcon.GetCellValue(.sprDetail.ActiveSheet.Cells(0, LMM180G.sprDetailDef.KEN.ColNo))
            If String.IsNullOrEmpty(jc) = True _
                AndAlso String.IsNullOrEmpty(tm) = True Then
                MyBase.ShowMessage("E270", New String() {"JIS", "都道府県名"})
                Return False
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsAuthorityChk(ByVal eventShubetsu As LMM180C.EventShubetsu) As Boolean
        ...
        Select Case eventShubetsu
            ...
            Case LMM180C.EventShubetsu.SHINKI           '新規
            ...
            Case LMM180C.EventShubetsu.HENSHU          '編集
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM180C.EventShubetsu.HUKUSHA          '複写
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM180C.EventShubetsu.SAKUJO          '削除・復活
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM180C.EventShubetsu.KENSAKU         '検索
                '50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
            ...
            Case LMM180C.EventShubetsu.HOZON           '保存
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM180C.EventShubetsu.TOJIRU           '閉じる
                'すべての権限許可
                kengenFlg = True

            Case LMM180C.EventShubetsu.DCLICK         'ダブルクリック
                '50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
            ...
            Case LMM180C.EventShubetsu.ENTER          'Enter
                '50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsFocusChk(ByVal objNm As String, ByVal actionType As LMM180C.EventShubetsu) As Boolean
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsRecordStatusChk(ByVal frm As LMM180F) As Boolean
