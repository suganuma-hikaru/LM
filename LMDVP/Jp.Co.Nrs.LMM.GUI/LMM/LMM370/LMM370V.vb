...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMM370F, ByVal v As LMMControlV)
...
#Region "Method"
    ...
    Private Function IsKensakuSingleCheck() As Boolean
        ...
        With Me._Frm
            ...
            '請求先コード
            vCell.SetValidateCell(0, LMM370G.sprDetailDef.SEIQTO_CD.ColNo)
            ...
            End If
            '請求先名
            vCell.SetValidateCell(0, LMM370G.sprDetailDef.SEIQTO_NM.ColNo)
            vCell.ItemName = "請求先名"
            vCell.IsForbiddenWordsCheck = True
            ...
            End If
            '請求パターンコード
            vCell.SetValidateCell(0, LMM370G.sprDetailDef.PTN_CD.ColNo)
            ...
            End If
            '請求項目コード
            vCell.SetValidateCell(0, LMM370G.sprDetailDef.SEIQKMK_CD.ColNo)
            ...
            End If
            '摘要
            vCell.SetValidateCell(0, LMM370G.sprDetailDef.TEKIYO.ColNo)
            vCell.ItemName = "摘要"
            vCell.IsForbiddenWordsCheck = True
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsAuthorityChk(ByVal eventShubetsu As LMM370C.EventShubetsu) As Boolean
        ...
        Select Case eventShubetsu
            ...
            Case LMM370C.EventShubetsu.SHINKI           '新規
            ...
            Case LMM370C.EventShubetsu.HENSHU          '編集
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM370C.EventShubetsu.HUKUSHA          '複写
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM370C.EventShubetsu.SAKUJO          '削除・復活
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM370C.EventShubetsu.KENSAKU         '検索
                '50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
            ...
            Case LMM370C.EventShubetsu.MASTEROPEN          'マスタ参照
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM370C.EventShubetsu.HOZON           '保存
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMM370C.EventShubetsu.TOJIRU           '閉じる
                'すべての権限許可
                kengenFlg = True

            Case LMM370C.EventShubetsu.DCLICK         'ダブルクリック
                '50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
            ...
            Case LMM370C.EventShubetsu.ENTER          'Enter
                '50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsFocusChk(ByVal objNm As String, ByVal actionType As LMM370C.EventShubetsu) As Boolean

        'フォーカス位置がない場合、スルー
        If objNm Is Nothing = True Then
            '検証結果(メモ)№120対応(2011.09.14)
            'マスタ参照の場合、エラーメッセージ設定
            If actionType.Equals(LMM370C.EventShubetsu.MASTEROPEN) = True Then
