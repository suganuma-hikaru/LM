...
'  システム名       :  LM
'  サブシステム名   :  LMM     : マスタ
'  プログラムID     :  LMM370F : 庭先情報マスタメンテ
'  作  成  者       :  王
' ==========================================================================
Imports Jp.Co.Nrs.LM.Base

Public Class LMM370F
...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM370H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM370F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM370F_KeyDown(Me, e)
    End Sub
