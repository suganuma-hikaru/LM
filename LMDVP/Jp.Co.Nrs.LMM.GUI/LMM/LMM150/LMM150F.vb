...
'  システム名       :  LM
'  サブシステム名   :  LMS     : マスタ
'  プログラムID     :  LMM150F : 請求テンプレートマスタメンテ
'  作  成  者       :  平山
' ==========================================================================
...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM150H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM150F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM150F_KeyDown(Me, e)
    End Sub
    ...
    Private Sub cmbTouhanSashizu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbTouhanSashizu.Load
