...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM130H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM130F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM130F_KeyDown(Me, e)
    End Sub
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnRowAdd_Shinseigai_Click(sender As Object, e As EventArgs) Handles btnRowAdd_Shinseigai.Click
    ...
    Private Sub btnRowDel_Shinseigai_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRowDel_Shinseigai.Click
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnIkkatuTouroku_Click(sender As Object, e As EventArgs) Handles btnIkkatuTouroku.Click

        Call Me._Handler.btnIkkatuTouroku_Click(Me)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub cmbWare_SelectedValueChanged(sender As Object, e As EventArgs) Handles cmbWare.SelectedValueChanged

        Call Me._Handler.cmbWare_SelectedValueChanged(Me)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub cmbJisyatasyaKbn_SelectedValueChanged(sender As Object, e As EventArgs) Handles cmbJisyatasyaKbn.SelectedValueChanged

        Call Me._Handler.cmbJisyatasyaKbn_SelectedValueChanged(Me)
