...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM240H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM240F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM240F_KeyDown(Me, e)
    End Sub
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub cmbRptOut_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbRptOut.SelectedValueChanged

        Call Me._Handler.cmbRptOut_SelectedValueChanged(Me, e)
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub cmbRptNm_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbRptNm.SelectedValueChanged

        Call Me._Handler.cmbRptNm_SelectedValueChanged(Me, e)
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub cmbPtnId_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbPtnId.SelectedValueChanged

        Call Me._Handler.cmbPtnId_SelectedValueChanged(Me, e)
