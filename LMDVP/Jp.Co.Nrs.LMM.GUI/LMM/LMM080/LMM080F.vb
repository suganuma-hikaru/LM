...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM080H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM080F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        Call Me._Handler.LMM080F_KeyDown(Me, e)
    ...
    Private Sub btnRowAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRowAdd.Click
        ...
        Call Me._Handler.btnROWADD_Click(Me, e)
    ...
    Private Sub btnRowDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRowDel.Click
        ...
        Call Me._Handler.btnROWDEL_Click(Me)
