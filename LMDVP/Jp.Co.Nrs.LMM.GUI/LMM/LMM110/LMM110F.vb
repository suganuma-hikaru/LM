...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM110H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM110F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM110F_KeyDown(Me, e)
    End Sub
    ...
    Private Sub btnCopy_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCopy.Click
        Call Me._Handler.btnCopy_Click(Me, e)
    End Sub
