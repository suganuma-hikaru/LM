...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM200H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM200F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        Call Me._Handler.LMM200F_KeyDown(Me, e)
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub cmbCarTpKb_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbCarTpKb.SelectedValueChanged

        Call Me._Handler.cmbCarTpKb_SelectedValueChanged(Me, e)
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub cmbTempYn_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbTempYn.SelectedValueChanged

        Call Me._Handler.cmbTempYn_SelectedValueChanged(Me, e)
