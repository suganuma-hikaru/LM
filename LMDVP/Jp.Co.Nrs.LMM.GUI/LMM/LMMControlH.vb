...
#Region "Method"
    ...
    ''' <remarks></remarks>
    Friend Sub StartAction(ByVal frm As LMFormSxga)
    ...
    ''' <param name="frm">フォーム</param>
    ''' <remarks></remarks>
    Friend Sub EndAction(ByVal frm As LMFormSxga)
    ...
    ''' <param name="frm">フォーム</param>
    ''' <remarks></remarks>
    Friend Sub FailureSelect(ByVal frm As LMFormSxga)
    ...
    ''' <remarks></remarks>
    Friend Function CallWSAAction(ByVal frm As LMFormSxga _
