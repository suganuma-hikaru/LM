...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM040H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM040F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM040F_KeyDown(Me, e)
    End Sub
    ...
    Private Sub btnRowAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRowAdd.Click
        ...
        Call Me._Handler.btnROW_INS_TCUST_Click(Me)
    ...
    Private Sub btnRowDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRowDel.Click
        ...
        Call Me._Handler.btnROW_DEL_TCUST_Click(Me)

    End Sub

    Private Sub LmImTextBox1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtShiharaiAd.Load

    End Sub
    Private Sub LmTitleLabel1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblShiharaiAd.Click
