...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM140H)
...
#Region "Method"
    ...
    Private Sub sprDetail_CellDoubleClick(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprDetail.CellDoubleClick
        ...
        Me._Handler.CellDoubleClick(Me, e)
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM140F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM140F_KeyDown(Me, e)
    End Sub
    ''' <summary>
    '''  温度管理区分の値変更イベント
    ''' </summary>
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub cmbHeatCtlKb_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbHeatCtlKb.SelectedValueChanged

        Call Me._Handler.cmbHeatCtlKb_SelectedValueChanged(Me, e)
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnRowAdd_Yakujiho_Click(sender As Object, e As EventArgs) Handles btnRowAdd_Yakuziho.Click
    ...
    Private Sub btnRowDel_Yakujiho_Doku_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRowDel_Yakuziho.Click
