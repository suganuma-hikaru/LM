...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMM050H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMM050F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMM050F_KeyDown(Me, e)
    End Sub
    ...
    Private Sub chkKeiri_CheckedChanged(sender As Object, e As EventArgs) Handles chkKeiri.CheckedChanged

    End Sub

    Private Sub chkHikae_CheckedChanged(sender As Object, e As EventArgs) Handles chkHikae.CheckedChanged

    End Sub

    Private Sub txtEigyoTanto_Load(sender As Object, e As EventArgs) Handles txtEigyoTanto.Load
    ...
    Private Sub LmCheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles chkdest.CheckedChanged
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub optVarStrageFlg_CheckedChanged(sender As Object, e As EventArgs) Handles optVarStrageFlgN.CheckedChanged, optVarStrageFlgY.CheckedChanged

        If Not IsNothing(Me._Handler) Then
            Call Me._Handler.optVarStrageFlgCheckedChanged(Me, DirectCast(sender, Win.LMOptionButton), e)
        End If
