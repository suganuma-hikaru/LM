...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMD100H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprDetail_SpreadDoubleClick(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprZai.SpreadDoubleClick

        Call Me._Handler.sprCellDoubleClick(Me, e.Row)
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprZai_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles sprZai.KeyDown

        Call Me._Handler.sprCellDoubleClick(Me, Me.sprZai.Sheets(0).ActiveRowIndex)
