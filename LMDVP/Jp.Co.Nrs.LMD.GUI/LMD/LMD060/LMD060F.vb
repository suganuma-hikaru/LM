...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMD060H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMD060F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMD060F_KeyDown(Me, e)
    End Sub
