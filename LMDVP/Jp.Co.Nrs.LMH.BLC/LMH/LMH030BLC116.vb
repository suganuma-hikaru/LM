...
'  EDI荷主ID　　　　:  110　　　        : エストコミュ（千葉）
'  作  成  者       :  daikoku    (000ベース生産): 
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH030DAC116 = New LMH030DAC116()
...
#Region "データセット設定(出荷包装個数)"
    Private Function SumPkgNb(ByVal dt As DataTable) As Double
        ...
        Dim totalOUTKA_TTL_NB As Integer = 0
        ...
        For i As Integer = 0 To max
            ...
            totalOUTKA_TTL_NB = totalOUTKA_TTL_NB + CInt(dt.Rows(i)("OUTKA_TTL_NB"))
        Next

        sumNb = Fix((totalOUTKA_TTL_NB / 12) + 0.99999)
...
#Region "データセット設定(出荷M)"
    ...
    Private Function SetDatasetOutkaM(ByVal ds As DataSet, ByVal matomeflg As Boolean) As DataSet
        ...
        For i As Integer = 0 To max
            ...
            outkaDr("CUST_ORD_NO_DTL") = String.Empty   'エストコミュは不要
...
#Region "セミEDI時　データセット設定(EDI出荷(中))"
    ...
    Private Function SetSemiOutkaEdiM(ByVal setDs As DataSet _
        ...
        '包装個数
        If drMgoods Is Nothing = False Then
...
#Region "セミEDI時  データセット設定(届先マスタ)"
    ...
    Private Sub SetInDataSelectDestMst(ByRef setDs As DataSet, ByVal rowCnt As Integer)
        ...
        'sKey = "L_DEST_TEL_NO"
        'If isNullColKey(drSemiInfo, sKey, sTempColNo) <> False Then
        '    setDr.Item("TEL") = drEdiDtl.Item(sTempColNo).ToString().Trim()
        'End If
            ...
            If bSameKeyFlg = False Then
                ...
                If MyBase.GetResultCount = 0 Then
                    If sFlg17.Equals("0") Then
                        ...
                        MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E493", New String() {String.Concat("届先コード(届先電話番号):", sDestCd), "届先マスタ", String.Concat(" 伝票管理番号:", sDenNo)})
                        bNoErr = False
                        Continue For
                    Else
                        '自動登録(INSERT)
