...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH030DAC102 = New LMH030DAC102()
...
#Region "ビックケミー用CONST"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Const WH_CD_BYK As String = "101"                '倉庫コード
    Public Const CUST_CD_L_BYK As String = "00266"          '荷主コード（大）
    Public Const CUST_CD_M_BYK As String = "00"             '荷主コード（中）
    Public Const CUST_CD_M_TTT As String = "01"             '荷主コード（中）テツタニ
    Public Const CUST_CD_M_NGS As String = "02"             '荷主コード（中）ながせ

    Public Const DEST_PRE_CD_BYK As String = ""             'とどけさきPREコード　BYK
    Public Const DEST_PRE_CD_TTT As String = "777"          'とどけさきPREコード　テツタニ
    Public Const DEST_PRE_CD_NGS As String = "444"          'とどけさきPREコード　ながせ
    ...
    Private Const BYK_BR_CD_OSAKA As String = "1"
    Private Const BYK_BR_CD_TOKYO As String = "2"
    ...
    Private Function OutkaToroku(ByVal ds As DataSet) As DataSet
        ...
        If autoMatomeF.Equals("0") OrElse autoMatomeF.Equals("1") Then
            ...
            ElseIf MyBase.GetResultCount > 1 Then
                choiceKb = Me.SetDestWarningChoiceKb(ds.Tables("LMH030_OUTKAEDI_L"), ds, LMH030BLC.BYK_WID_L001, 0)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    ds = Me._Blc.SetComWarningL("W199", LMH030BLC.BYK_WID_L001, ds, msgArray, matomeNo, String.Empty)
                    Return ds
            ...
            ElseIf autoMatomeF.Equals("0") = True Then
                ...
                choiceKb = Me.SetDestWarningChoiceKb(ds.Tables("LMH030_OUTKAEDI_L"), ds, LMH030BLC.BYK_WID_L002, 0)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    msgArray(4) = String.Empty
                    matomeNo = ds.Tables("LMH030_MATOMESAKI_EDIL").Rows(0).Item("OUTKA_CTL_NO").ToString()
                    ds = Me._Blc.SetComWarningL("W168", LMH030BLC.BYK_WID_L002, ds, msgArray, matomeNo, String.Empty)
                    Return ds
            ...
            ElseIf autoMatomeF.Equals("1") = True Then
                ...
                If matomeStatus.Equals("10") = False Then
                    ...
                    choiceKb = Me.SetDestWarningChoiceKb(ds.Tables("LMH030_OUTKAEDI_L"), ds, LMH030BLC.BYK_WID_L003, 0)
                    ...
                    If String.IsNullOrEmpty(choiceKb) = True Then
                        ...
                        msgArray(4) = String.Empty
                        matomeNo = ds.Tables("LMH030_MATOMESAKI_EDIL").Rows(0).Item("OUTKA_CTL_NO").ToString()
                        ds = Me._Blc.SetComWarningL("W198", LMH030BLC.BYK_WID_L003, ds, msgArray, matomeNo, String.Empty)
                        Return ds
        ...
        Select Case custIndex
            ...
            Case LMH030BLC.EdiCustIndex.BykChb00266_00 _
               , LMH030BLC.EdiCustIndex.BykChb00729_00

                'ビックケミーの場合は自動追加・更新はしない
...
#Region "実績作成処理"
    ...
    Private Function JissekiSakusei(ByVal ds As DataSet) As DataSet
        ...
        Select Case Convert.ToInt32(ediCustIndex)
            ...
            'BYK(直販) 
            Case LMH030BLC.EdiCustIndex.BykChb00266_00
                ds = MyBase.CallDAC(Me._Dac, "SelectBykDirEdiSend", ds)

                'BYK(テツタニ)
            Case LMH030BLC.EdiCustIndex.BykChb00266_01
                ds = MyBase.CallDAC(Me._Dac, "SelectBykTstEdiSend", ds)

                'BYK(エカルト) 
            Case LMH030BLC.EdiCustIndex.BykChb00729_00
                ds = MyBase.CallDAC(Me._Dac, "SelectBykEktEdiSend", ds)
        ...
        Select Case Convert.ToInt32(ediCustIndex)
            ...
            'BYK(直販) 
            Case LMH030BLC.EdiCustIndex.BykChb00266_00
                ds = MyBase.CallDAC(Me._Dac, "InsertBykDirEdiSendData", ds)

                'BYK(テツタニ)
            Case LMH030BLC.EdiCustIndex.BykChb00266_01
                ds = MyBase.CallDAC(Me._Dac, "InsertBykTstEdiSendData", ds)

                'BYK(エカルト) 
            Case LMH030BLC.EdiCustIndex.BykChb00729_00
                ds = MyBase.CallDAC(Me._Dac, "InsertBykEktEdiSendData", ds)
...
#Region "EDI出荷(中)の初期値設定"
    ...
    Private Function EdiMDefaultSet(ByVal ds As DataSet, ByVal setDs As DataSet, _
        ...
        '①商品名
        '要望番号2091 修正START 2013.11.01
        Dim mGoodsNm As String = String.Empty
        If String.IsNullOrEmpty(mGoodsDr("GOODS_NM_1").ToString()) = False Then
            mGoodsNm = Replace(mGoodsDr("GOODS_NM_1").ToString(), "ｰ", "-").Trim()
        End If
        Dim ediGoodsNm As String = String.Empty
        If String.IsNullOrEmpty(ediMDr("GOODS_NM").ToString()) = False Then
            ediGoodsNm = Replace(ediMDr("GOODS_NM").ToString(), "ｰ", "-").Trim()
        End If
        '要望番号2091 修正END 2013.11.01

        '要望番号2091 修正START 2013.10.02
        If String.IsNullOrEmpty(ediGoodsNm) = False Then
            ...
            ElseIf mGoodsNm.Equals(ediGoodsNm) = False Then
                ...
                choiceKb = Me.SetGoodsWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_M002, count)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    ds = Me._Blc.SetComWarningM("W194", LMH030BLC.BYK_WID_M002, ds, setDs, msgArray, _
        ...
        If (ediIrime).Equals(mIrime) = False Then
            ...
            choiceKb = Me.SetGoodsWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_M003, count)
            ...
            If String.IsNullOrEmpty(choiceKb) = True Then
                ...
                msgArray(5) = String.Empty
                ds = Me._Blc.SetComWarningM("W194", LMH030BLC.BYK_WID_M003, ds, setDs, msgArray, ediIrime, mIrime)
        ...
        Else
            If mIRIMENm.Equals(ediIRIMENm) = True Then
                'チェックなし
            Else
                choiceKb = Me.SetGoodsWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_M004, count)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    msgArray(4) = "EDIデータ"
                    msgArray(5) = String.Empty
                    ds = Me._Blc.SetComWarningM("W159", LMH030BLC.BYK_WID_M004, ds, setDs, msgArray, ediIRIMENm, mIRIMENm)
...
#Region "EDI出荷(大)のDAC側でのチェック"
    ...
    Private Function EdiLDbExistsCheck(ByVal ds As DataSet, ByVal rowNo As String, ByVal ediCtlNo As String) As Boolean
        ...
        '●荷主共通チェック
        '-------------------------------------------------------------------------------------
        'ビックケミーでは荷主専用のオーダー番号重複チェックを後続処理で行う(共通のは使用しない)
        'オーダー番号重複チェック(明細単位のチェックの為ここでは行わない)
        'If String.IsNullOrEmpty(drEdiL.Item("CUST_ORD_NO").ToString) = False Then

        '    If drIn("ORDER_CHECK_FLG").Equals("1") = True Then
        '        Call MyBase.CallDAC(Me._Dac, "SelectOrderCheckDataByk", ds)
        '        If MyBase.GetResultCount > 0 Then
        ...
        If mDestCount = 1 Then
            ...
            'ビックケミーの場合、不整合の場合はワーニング(マスタの値に入替える)
            ...
            Select Case custIndex
                ...
                Case LMH030BLC.EdiCustIndex.BykChb00266_00 _
                   , LMH030BLC.EdiCustIndex.BykChb00729_00
                    ...
                    If SetInsMDestFromDest(ds, rowNo, ediCtlNo, workDestCd, workDestString) = True Then
    ...
    Private Function EdiMMasterExistsCheck(ByVal ds As DataSet, ByVal rowNo As String, ByVal ediCtlNo As String) As Boolean
        ...
        For i As Integer = 0 To max
            ...
            If String.IsNullOrEmpty(custGoodsCd) = False Then
                ...
                choiceKb = Me.SetGoodsWarningChoiceKb(setDtM, ds, LMH030BLC.BYK_WID_M001, 0)
                ...
                ElseIf GetResultCount() > 1 Then
                    ...
                    Else
                        ...
                        '2012.03.19 修正START
                        ds = Me._Blc.SetComWarningM("W162", LMH030BLC.BYK_WID_M001, ds, setDs, msgArray, custGoodsCd, String.Empty)
                        '2012.03.19 修正END
                ...
                If Me.EdiMDefaultSet(ds, setDs, i, unsoData, rowNo, ediCtlNo) = False Then
                    ...
                    'ビックケミーは現段階ではワーニングが存在するが、エラーはなし。共通のロジックを組み込む為入れておく
                    Dim chkRowNo As Integer = Convert.ToInt32(rowNo)
                    If MyBase.IsMessageStoreExist(chkRowNo) = True Then
                        '整合性チェックでエラーがあった場合は処理終了
                        Return False
...
#Region "オーダーNO重複チェック(明細単位)"
    ...
    Private Function CustOrderNoCheck(ByVal ds As DataSet, ByVal rowNo As String, ByVal ediCtlNo As String) As Boolean
        ...
        For i As Integer = 0 To edimCount
            ...
            If String.IsNullOrEmpty(drEdiL.Item("CUST_ORD_NO").ToString()) = False Then
                If drIn("ORDER_CHECK_FLG").Equals("1") = True Then
                    Call MyBase.CallDAC(Me._Dac, "SelectOrderCheckDataByk", setDs)
                    If MyBase.GetResultCount > 0 Then
                        MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E377", New String() {"出荷データ"}, rowNo, LMH030BLC.EXCEL_COLTITLE, ediCtlNo)
                        Return False
                    End If
...
#Region "届先マスタチェック(ビックケミー専用)"
    ...
    Private Function DestCompareCheck(ByVal ds As DataSet, ByVal rowNo As String, ByVal ediCtlNo As String) As Boolean
        ...
        Dim ediFreeC16 As String = dtEdi.Rows(0)("FREE_C16").ToString()
        ...
        '(2013.02.25)要望番号1889 新レイアウト切替 追加START
        'FREE_C16(EDI受信(DTL)納入先名１＋納入先名２＋納入先名３)
        '80バイト(EDI出荷　届先名MAXバイト)を超える場合はエラー
        Dim freeC16Len As Integer = System.Text.Encoding.GetEncoding("Shift_JIS").GetByteCount(ediFreeC16)
        If freeC16Len > 80 Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E538", New String() {ediFreeC16}, rowNo, LMH030BLC.EXCEL_COLTITLE, ediCtlNo)
            Return False

        End If
        '(2013.02.25)要望番号1889 新レイアウト切替 追加END
        ...
        If mDestNm.Equals(ediDestNm) = True Then
            'チェックなし
        Else
            choiceKb = Me.SetDestWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_L003, 0)
            ...
            If String.IsNullOrEmpty(choiceKb) = True Then
                ...
                ds = Me._Blc.SetComWarningL("W159", LMH030BLC.BYK_WID_L003, ds, msgArray, _
        ...
        Else
            ...
            If mAdAll.Equals(ediAdAll) = False Then
                ...
                choiceKb = Me.SetDestWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_L004, 0)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    msgArray(4) = "EDIデータ"
                    msgArray(5) = String.Empty
                    ds = Me._Blc.SetComWarningL("W159", LMH030BLC.BYK_WID_L004, ds, msgArray, ediAdAll, mAdAll)
        ...
        Else
            If mTel.Equals(ediTel) = False Then
                ...
                choiceKb = Me.SetDestWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_L005, 0)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    msgArray(4) = "EDIデータ"
                    msgArray(5) = String.Empty
                    ds = Me._Blc.SetComWarningL("W159", LMH030BLC.BYK_WID_L005, ds, msgArray, ediTel, mTel)
        ...
        Else
            If mZip.Equals(ediZip) = False Then
                ...
                choiceKb = Me.SetDestWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_L006, 0)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    msgArray(4) = "EDIデータ"
                    msgArray(5) = String.Empty
                    ds = Me._Blc.SetComWarningL("W159", LMH030BLC.BYK_WID_L006, ds, msgArray, ediZip, mZip)
        ...
        Else
            If mJis.Equals(ediDestJisCd) = False Then
                ...
                choiceKb = Me.SetDestWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_L007, 0)
                ...
                If String.IsNullOrEmpty(choiceKb) = True Then
                    ...
                    msgArray(4) = "EDIデータ"
                    msgArray(5) = String.Empty
                    ds = Me._Blc.SetComWarningL("W159", LMH030BLC.BYK_WID_L007, ds, msgArray, ediDestJisCd, mJis)
...
#Region "届先マスタ追加時チェック"
    ...
    Private Function SetInsMDestFromDest(ByVal ds As DataSet, ByVal rowNo As String, _
                                         ...
                                         ByVal workDestString As String) As Boolean
        ...
        choiceKb = Me.SetDestWarningChoiceKb(dtEdi, ds, LMH030BLC.BYK_WID_L008, 0)
        ...
        If String.IsNullOrEmpty(choiceKb) = True Then
            ...
            ds = Me._Blc.SetComWarningL("W182", LMH030BLC.BYK_WID_L008, ds, msgArray, workDestCd, String.Empty)
    ...
    Private Function SetDatasetOutkaL(ByVal ds As DataSet, ByVal matomeFlg As Boolean) As DataSet
        ...
        If matomeFlg = False Then
            ...
            Select Case custIndex
                ...
                Case LMH030BLC.EdiCustIndex.BykChb00266_01
                    'Start 要望管理2054 2013/6/5 s_kobayashi
                    'outkaDr("CUST_ORD_NO") = ediDr("CUST_ORD_NO")
                    Dim addCharOfOrder As String = String.Empty
                    If BYK_BR_CD_OSAKA.Equals(ediDr("FREE_C01").ToString()) = True Then
                        addCharOfOrder = "T-"
                    ElseIf BYK_BR_CD_TOKYO.Equals(ediDr("FREE_C01").ToString()) = True Then
                        addCharOfOrder = "TT-"
                    End If
                    Dim byteCnt As Integer = 30
                    Dim strBUYER_ORD_NO As String = String.Empty
                    strBUYER_ORD_NO = Me.ConcatOrdNo(dt)
                    outkaDr("CUST_ORD_NO") = Me._Blc.LeftB(String.Concat(addCharOfOrder, strBUYER_ORD_NO.Trim()), byteCnt)
                    'outkaDr("BUYER_ORD_NO") = ediDr("BUYER_ORD_NO")
                    outkaDr("BUYER_ORD_NO") = ediDr("FREE_C12")
                    'End要望管理2054 2013/6/5 s_kobayashi
            ...
            'Start要望管理2054 2013/6/18 s_kobayashi
            'outkaDr("OUTKA_PKG_NB") = SumPkgNb(dt)
            outkaDr("OUTKA_PKG_NB") = Me.SumTotalNb(dt)
            'End要望管理2054 2013/6/18 s_kobayashi
        ...
        Else
            ...
            outkaDr("OUTKA_PKG_NB") = Me.SumTotalNb(dt) + Convert.ToDouble(matomesakiDt.Rows(0)("OUTKA_PKG_NB"))
            'End要望管理2054 2013/6/18 s_kobayashi
            ...
            Select Case custIndex
                ...
                Case LMH030BLC.EdiCustIndex.BykChb00266_01
                    ...
                    Dim strBUYER_ORD_NO As String = String.Empty
                    strBUYER_ORD_NO = Me.ConcatOrdNo(dt)
                    outkaDr("CUST_ORD_NO") = Me._Blc.LeftB(String.Concat(matomesakiDt.Rows(0)("CUST_ORD_NO").ToString().Trim(), ",", strBUYER_ORD_NO.Trim()), byteCnt)
                    '注文番号が空白なら、追記
                    If String.IsNullOrEmpty(matomesakiDt.Rows(0)("BUYER_ORD_NO").ToString()) = True Then
                        outkaDr("BUYER_ORD_NO") = ediDr("FREE_C12")
                    Else
                        outkaDr("BUYER_ORD_NO") = matomesakiDt.Rows(0)("BUYER_ORD_NO").ToString()
                    End If
                    'End要望管理2054 2013/6/5 s_kobayashi
...
#Region "データセット設定(出荷総個数)"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SumTotalNb(ByVal dt As DataTable) As Double
        ...
        For i As Integer = 0 To max
            ...
            sumNb = sumNb + Convert.ToDouble(dt.Rows(i)("OUTKA_TTL_NB"))
...
#Region "データセット設定(オーダ番号連結)"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function ConcatOrdNo(ByVal dt As DataTable) As String
        ...
        For i As Integer = 0 To max
            If i = 0 Then
                orderNo = dt.Rows(i)("FREE_C10").ToString()
            ElseIf i = 1 AndAlso max = 1 Then
                orderNo = String.Concat(orderNo, ",", dt.Rows(i)("FREE_C10"))
            ElseIf i = max Then
                orderNo = String.Concat(orderNo, "-", dt.Rows(i)("FREE_C10"))
            Else
                'no Action
    ...
    Private Function SetDatasetOutkaM(ByVal ds As DataSet) As DataSet
        ...
        For i As Integer = 0 To max
            ...
            Select Case custIndex
                ...
                Case LMH030BLC.EdiCustIndex.BykChb00266_00 _
                   , LMH030BLC.EdiCustIndex.BykChb00729_00
                    If String.IsNullOrEmpty(ediDr("FREE_C05").ToString()) = False AndAlso _
                       String.IsNullOrEmpty(ediDr("SERIAL_NO").ToString()) = False Then
                        outkaDr("SERIAL_NO") = String.Concat(ediDr("SERIAL_NO"), "-", ediDr("FREE_C05"))
                    Else
            ...
            '    Case LMH030BLC.EdiCustIndex.BykChb00266_00 _
            '       , LMH030BLC.EdiCustIndex.BykChb00729_00
            '        'If String.IsNullOrEmpty(ediDr("FREE_C17").ToString()) = False Then
            '        '    outkaDr("REMARK") = String.Concat(ediDr("REMARK"), " 商品明細:", ediDr("FREE_C17"))
            '        'Else
            '        '    outkaDr("REMARK") = ediDr("REMARK")
            '        'End If
...
#Region "データセット設定(運送L)"
    ...
    Private Function SetDatasetUnsoL(ByVal ds As DataSet, ByVal matomeFlg As Boolean) As DataSet
        ...
        If matomeFlg = False Then
            ...
            '要望番号2091 修正START 2013.10.24
            Select Case custIndex

                Case LMH030BLC.EdiCustIndex.BykChb00266_00 _
                   , LMH030BLC.EdiCustIndex.BykChb00729_00
                    unsoDr("REMARK") = _Blc.LeftB(String.Concat(SetRemarkInfoRemark(ds), SetRemarkInfoRsvNo(ds)), 100)
                Case Else
                    unsoDr("REMARK") = ediDr("UNSO_ATT")
            End Select
            '要望番号2091 修正END 2013.10.24
...
#Region "データセット設定(運送L：配送時注意事項)"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetRemarkInfoRemark(ByVal ds As DataSet) As String

        Dim outkaEdiMDr As DataRow
        Dim unsoRemark As String = String.Empty
        Dim max As Integer = ds.Tables("LMH030_OUTKAEDI_M").Rows.Count - 1
        ...
        For i As Integer = 0 To max
            ...
            If String.IsNullOrEmpty(outkaEdiMDr("REMARK").ToString()) = False Then
                If i = 0 Then
                    unsoRemark = String.Concat("ダメージ出荷:", outkaEdiMDr("REMARK").ToString())
                ElseIf i <> 0 AndAlso String.IsNullOrEmpty(unsoRemark) = True Then
                    unsoRemark = String.Concat("ダメージ出荷:", outkaEdiMDr("REMARK").ToString())
                Else
                    unsoRemark = String.Concat(unsoRemark, "/", outkaEdiMDr("REMARK").ToString())
                End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function SetRemarkInfoRsvNo(ByVal ds As DataSet) As String

        Dim outkaMDr As DataRow
        Dim unsoRsvNo As String = String.Empty
        Dim max As Integer = ds.Tables("LMH030_C_OUTKA_M").Rows.Count - 1

        For i As Integer = 0 To max

            outkaMDr = ds.Tables("LMH030_C_OUTKA_M").Rows(i)

            If String.IsNullOrEmpty(outkaMDr("SERIAL_NO").ToString()) = False Then
                If i = 0 Then
                    unsoRsvNo = String.Concat("予約番号:", outkaMDr("SERIAL_NO").ToString())
                ElseIf i <> 0 AndAlso String.IsNullOrEmpty(unsoRsvNo) = True Then
                    unsoRsvNo = String.Concat("予約番号:", outkaMDr("SERIAL_NO").ToString())
                Else
                    unsoRsvNo = String.Concat(unsoRsvNo, "/", outkaMDr("SERIAL_NO").ToString())
                End If
...
#Region "セミEDI時　データセット設定(EDI受信HED・DTL)"
    ...
    Private Function SetSemiOutkaEdiRcv(ByVal ds As DataSet, ByVal i As Integer) As DataSet
        ...
        'Dim drEdiRcvHed As DataRow = ds.Tables("LMH030_OUTKAEDI_HED_BYK").NewRow()
        Dim drEdiRcvDtl As DataRow = ds.Tables("LMH030_OUTKAEDI_DTL_BYK").NewRow()
        ...
        drEdiRcvDtl("CUST_CD_L") = CUST_CD_L_BYK                                                        '荷主コード（大）

        Dim ediCustIndex As String = drSemiEdiInfo.Item("EDI_CUST_INDEX").ToString()
        Dim sCustCodeM As String = String.Empty
        Select Case Convert.ToInt32(ediCustIndex)
            Case LMH030BLC.EdiCustIndex.BykChb00266_00
                sCustCodeM = CUST_CD_M_BYK

            Case LMH030BLC.EdiCustIndex.BykChb00266_01
                sCustCodeM = CUST_CD_M_TTT

            Case LMH030BLC.EdiCustIndex.BykChb00266_02
                sCustCodeM = CUST_CD_M_NGS
        End Select
        drEdiRcvDtl("CUST_CD_M") = sCustCodeM                                                           '荷主コード（中）
        ...
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        '荷主固有データ
        'drEdiRcvDtl("BYK_BR_CD") = Me._Blc.LeftB(drSetDtl("COLUMN_1").ToString().Trim(), 1)             '先方営業所
        drEdiRcvDtl("BYK_BR_CD") = Me._Blc.LeftB(drSetDtl("COLUMN_1").ToString().Trim(), 3)             '先方営業所 1⇒3byteに変更
        drEdiRcvDtl("OUTKA_REQ_DATE") = Me._Blc.LeftB(drSetDtl("COLUMN_2").ToString().Trim(), 8)        '出荷依頼日
        drEdiRcvDtl("BYK_OUTKA_NO") = Me._Blc.LeftB(drSetDtl("COLUMN_3").ToString().Trim(), 3)          '先方出荷指示No
        drEdiRcvDtl("DATA_KB") = Me._Blc.LeftB(drSetDtl("COLUMN_4").ToString().Trim(), 1)               '区分
        drEdiRcvDtl("OUTKA_PLAN_DATE") = Me._Blc.LeftB(drSetDtl("COLUMN_5").ToString().Trim(), 8)       '出荷日
        drEdiRcvDtl("NONYU_DATE") = Me._Blc.LeftB(drSetDtl("COLUMN_6").ToString().Trim(), 8)            '納期
        drEdiRcvDtl("TOKUI_CD") = Me._Blc.LeftB(drSetDtl("COLUMN_7").ToString().Trim(), 6)              '得意先コード
        drEdiRcvDtl("TOKUI_NM") = Me._Blc.LeftB(drSetDtl("COLUMN_8").ToString().Trim(), 40)             '得意先名
        drEdiRcvDtl("NONYU_CD") = Me._Blc.LeftB(drSetDtl("COLUMN_9").ToString().Trim(), 5)              '納入先コード
        'drEdiRcvDtl("NONYU_NM1") = Me._Blc.LeftB(drSetDtl("COLUMN_10").ToString().Trim(), 40)           '納入先名１
        'drEdiRcvDtl("NONYU_NM2") = Me._Blc.LeftB(drSetDtl("COLUMN_11").ToString().Trim(), 40)           '納入先名２

        drEdiRcvDtl("NONYU_NM1") = Me._Blc.LeftB(drSetDtl("COLUMN_10").ToString().Trim(), 32)           '納入先名１ 40⇒32byteに変更
        drEdiRcvDtl("NONYU_NM2") = Me._Blc.LeftB(drSetDtl("COLUMN_11").ToString().Trim(), 32)           '納入先名２ 40⇒32byteに変更
        drEdiRcvDtl("NONYU_NM3") = Me._Blc.LeftB(drSetDtl("COLUMN_12").ToString().Trim(), 32)           '納入先名３ 新規追加(40byte)

        'drEdiRcvDtl("MAKER_CD") = Me._Blc.LeftB(drSetDtl("COLUMN_12").ToString().Trim(), 3)             '商品コード・メーカー   (2013.02.25)未使用に変更
        'drEdiRcvDtl("GOODS_CD") = Me._Blc.LeftB(drSetDtl("COLUMN_13").ToString().Trim(), 3)             '商品コード・商品コード (2013.02.25)未使用に変更
        'drEdiRcvDtl("IRIME") = Me._Blc.LeftB(drSetDtl("COLUMN_14").ToString().Trim(), 1)                '商品コード・入目       (2013.02.25)未使用に変更
        'drEdiRcvDtl("LOT_NO") = Me._Blc.LeftB(drSetDtl("COLUMN_15").ToString().Trim(), 20)              '商品コード・ロットNO    (2013.02.25)未使用に変更
        'drEdiRcvDtl("LOT_NO_EDA") = Me._Blc.LeftB(drSetDtl("COLUMN_16").ToString().Trim(), 2)           '商品コード・ロットNO枝番 (2013.02.25)未使用に変更
        drEdiRcvDtl("GOODS_CD_NEW") = Me._Blc.LeftB(drSetDtl("COLUMN_13").ToString().Trim(), 8)          '商品コード(新)

        'drEdiRcvDtl("GOODS_NM") = Me._Blc.LeftB(drSetDtl("COLUMN_17").ToString().Trim(), 30)            '品名
        'drEdiRcvDtl("YORYO") = Me._Blc.LeftB(drSetDtl("COLUMN_18").ToString().Trim(), 6)                '容量
        'drEdiRcvDtl("OUTKA_NB") = Me._Blc.LeftB(drSetDtl("COLUMN_19").ToString().Trim(), 5)             '個数
        'drEdiRcvDtl("OUTKA_QT") = Me._Blc.LeftB(drSetDtl("COLUMN_20").ToString().Trim(), 9)             '数量
        'drEdiRcvDtl("ORDER_NO") = Me._Blc.LeftB(drSetDtl("COLUMN_21").ToString().Trim(), 20)            '注文番号
        'drEdiRcvDtl("OUTKA_REMARK") = Me._Blc.LeftB(drSetDtl("COLUMN_22").ToString().Trim(), 50)        '出荷依頼書メモ
        'drEdiRcvDtl("NONYU_REMARK") = Me._Blc.LeftB(drSetDtl("COLUMN_23").ToString().Trim(), 20)        '納期メモ
        'drEdiRcvDtl("JUTYU_NO") = Me._Blc.LeftB(drSetDtl("COLUMN_24").ToString().Trim(), 7)             '受注データNO

        drEdiRcvDtl("GOODS_NM") = Me._Blc.LeftB(drSetDtl("COLUMN_14").ToString().Trim(), 30)            '品名
        drEdiRcvDtl("YORYO") = Me._Blc.LeftB(drSetDtl("COLUMN_15").ToString().Trim(), 6)                '容量
        drEdiRcvDtl("OUTKA_NB") = Me._Blc.LeftB(drSetDtl("COLUMN_16").ToString().Trim(), 5)             '個数
        drEdiRcvDtl("OUTKA_QT") = Me._Blc.LeftB(drSetDtl("COLUMN_17").ToString().Trim(), 9)             '数量
        drEdiRcvDtl("ORDER_NO") = Me._Blc.LeftB(drSetDtl("COLUMN_18").ToString().Trim(), 20)            '注文番号
        drEdiRcvDtl("OUTKA_REMARK") = Me._Blc.LeftB(drSetDtl("COLUMN_19").ToString().Trim(), 50)        '出荷依頼書メモ
        drEdiRcvDtl("NONYU_REMARK") = Me._Blc.LeftB(drSetDtl("COLUMN_20").ToString().Trim(), 20)        '納期メモ
        drEdiRcvDtl("JUTYU_NO") = Me._Blc.LeftB(drSetDtl("COLUMN_21").ToString().Trim(), 10)            '受注データNO 7⇒10byteに変更


        '(2013.02.25)要望番号1889 新レイアウト切替 修正END

        'データセットに設定
        'ds.Tables("LMH030_OUTKAEDI_HED_BYK").Rows.Add(drEdiRcvHed)
        ds.Tables("LMH030_OUTKAEDI_DTL_BYK").Rows.Add(drEdiRcvDtl)
...
#Region "セミEDI時　データセット設定(EDI出荷(中))"
    ...
    Private Function SetSemiOutkaEdiM(ByVal setDs As DataSet _
        ...
        Dim drRcvEdiDtl As DataRow = setDs.Tables("LMH030_OUTKAEDI_DTL_BYK").Rows(0)
        'Dim drRcvEdiHed As DataRow = setDs.Tables("LMH030_OUTKAEDI_HED_BYK").Rows(0)
        ...
        drOutkaEdiM("CUST_ORD_NO_DTL") = drRcvEdiDtl("ORDER_NO").ToString
        drOutkaEdiM("BUYER_ORD_NO_DTL") = drRcvEdiDtl("JUTYU_NO").ToString
        drOutkaEdiM("CUST_GOODS_CD") = Right(drRcvEdiDtl("GOODS_NM").ToString, 6)   '商品名の右側６桁が商品コード
        drOutkaEdiM("NRS_GOODS_CD") = ""
        drOutkaEdiM("GOODS_NM") = drRcvEdiDtl("GOODS_NM")

        drOutkaEdiM("RSV_NO") = String.Empty
        drOutkaEdiM("LOT_NO") = drRcvEdiDtl("LOT_NO").ToString & drRcvEdiDtl("LOT_NO_EDA").ToString
        drOutkaEdiM("SERIAL_NO") = String.Empty
        drOutkaEdiM("ALCTD_KB") = "01"

        drOutkaEdiM("OUTKA_PKG_NB") = 1                         '出荷包装個数   1:固定（とりあえず）
        drOutkaEdiM("OUTKA_HASU") = 0                           '出荷端数       0:固定（とりあえず）

        drOutkaEdiM("OUTKA_QT") = drRcvEdiDtl("OUTKA_QT")       '出荷数量
        drOutkaEdiM("OUTKA_TTL_NB") = drRcvEdiDtl("OUTKA_NB")   '出荷総個数
        drOutkaEdiM("OUTKA_TTL_QT") = drRcvEdiDtl("OUTKA_QT")   '出荷総数量

        '商品マスタから取得
        ''drOutkaEdiM("KB_UT") = drGoods("KB_UT")                     '数量単位
        ''drOutkaEdiM("QT_UT") = drGoods("QT_UT")
        ...
        drOutkaEdiM("IRIME") = drRcvEdiDtl("YORYO")                 '入目   ※要確認
        ''drOutkaEdiM("IRIME_UT") = drGoods("IRIME_UT")
        ''drOutkaEdiM("BETU_WT") = drGoods("BETU_WT")                 '個別重量

        '注意事項 
        'drOutkaEdiM("REMARK") = drGoods("OUTKA_REMARK")             '※要確認
        drOutkaEdiM("REMARK") = drRcvEdiDtl("OUTKA_REMARK")         '※要確認
        ...
        drOutkaEdiM("FREE_N01") = drRcvEdiDtl("YORYO")
        drOutkaEdiM("FREE_N02") = drRcvEdiDtl("OUTKA_NB")
        drOutkaEdiM("FREE_N03") = drRcvEdiDtl("OUTKA_QT")
        ...
        drOutkaEdiM("FREE_C01") = drRcvEdiDtl("MAKER_CD")
        drOutkaEdiM("FREE_C02") = drRcvEdiDtl("GOODS_CD")
        drOutkaEdiM("FREE_C03") = drRcvEdiDtl("IRIME")
        drOutkaEdiM("FREE_C04") = drRcvEdiDtl("LOT_NO")
        drOutkaEdiM("FREE_C05") = drRcvEdiDtl("LOT_NO_EDA")
        drOutkaEdiM("FREE_C06") = drRcvEdiDtl("GOODS_NM")
        drOutkaEdiM("FREE_C07") = drRcvEdiDtl("ORDER_NO")
        drOutkaEdiM("FREE_C08") = drRcvEdiDtl("JUTYU_NO")
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        'drOutkaEdiM("FREE_C09") = String.Empty
        drOutkaEdiM("FREE_C09") = drRcvEdiDtl("GOODS_CD_NEW")
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        '(2013.02.25)要望番号2066 新レイアウト切替 修正START
        'drOutkaEdiM("FREE_C10") = String.Empty
        drOutkaEdiM("FREE_C10") = drRcvEdiDtl("BYK_OUTKA_NO")
        '(2013.02.25)要望番号:2066 新レイアウト切替 修正End
...
#Region "セミEDI時　データセット設定(EDI出荷(大))"
    ...
    Private Function SetSemiOutkaEdiL(ByVal setDs As DataSet _
        ...
        '要望番号2130 2013.11.26 修正START 
        'drOutkaEdiL("OUTKAHOKOKU_YN") = "0"
        drOutkaEdiL("OUTKAHOKOKU_YN") = "1"
        '要望番号2130 2013.11.26 修正END
        ...
        drOutkaEdiL("ARR_PLAN_DATE") = drRcvEdiDtl("NONYU_DATE").ToString           '納入予定日

        '納入予定時刻
        Dim sNonyuRemark As String = drRcvEdiDtl("NONYU_REMARK").ToString
        If String.IsNullOrEmpty(sNonyuRemark) = True Then
            '空の場合
            drOutkaEdiL("ARR_PLAN_TIME") = "" '未設定

        ElseIf InStr(sNonyuRemark, "時") > 0 OrElse InStr(sNonyuRemark, "：") > 0 OrElse InStr(sNonyuRemark, ":") > 0 Then
            '時間が指定されているであろうと思われる場合、判定不能なのでとりあえず「指定」を設定
            drOutkaEdiL("ARR_PLAN_TIME") = "10" '「指定」を設定

        ElseIf InStr(sNonyuRemark, "ＡＭ必着") > 0 OrElse InStr(sNonyuRemark, "ＡＭ着") > 0 _
               OrElse InStr(sNonyuRemark, "AM必着") > 0 OrElse InStr(sNonyuRemark, "AM着") > 0 Then
            'update s.kobayashi No.2054 半角AMも含むように修正。
            '午前必着であろうと思われる場合
            drOutkaEdiL("ARR_PLAN_TIME") = "02" '「午前必着」を設定。

        ElseIf InStr(sNonyuRemark, "午後一") > 0 Then
            '午後一であろうと思われる場合
            drOutkaEdiL("ARR_PLAN_TIME") = "03" '「午後一」を設定

        ElseIf InStr(sNonyuRemark, "ＰＭ必着") > 0 OrElse InStr(sNonyuRemark, "ＰＭ着") > 0 _
            OrElse InStr(sNonyuRemark, "PM必着") > 0 OrElse InStr(sNonyuRemark, "PM着") > 0 Then
            'update s.kobayashi No.2054 半角AMも含むように修正。
            '午後必着であろうと思われる場合
            drOutkaEdiL("ARR_PLAN_TIME") = "27" '「午後必着」を設定

        Else
            '上記以外で何か指定されている場合、判定不能なのでとりあえず「指定」を設定
            drOutkaEdiL("ARR_PLAN_TIME") = "10" '「指定」を設定
        ...
        Dim sDestPreCode As String = String.Empty
        Select Case Convert.ToInt32(ediCustIndex)
            Case LMH030BLC.EdiCustIndex.BykChb00266_00
                sDestPreCode = DEST_PRE_CD_BYK

            Case LMH030BLC.EdiCustIndex.BykChb00266_01
                sDestPreCode = DEST_PRE_CD_TTT

            Case LMH030BLC.EdiCustIndex.BykChb00266_02
                sDestPreCode = DEST_PRE_CD_NGS
        End Select


        '(2013.06.06)要望番号2020 売上先は反映しない Start
        'drOutkaEdiL("SHIP_CD_L") = String.Concat(sDestPreCode, drRcvEdiDtl("TOKUI_CD").ToString)
        drOutkaEdiL("SHIP_CD_L") = String.Empty
        drOutkaEdiL("SHIP_CD_M") = String.Empty
        'drOutkaEdiL("SHIP_NM_L") = drRcvEdiDtl("TOKUI_NM")
        drOutkaEdiL("SHIP_NM_L") = String.Empty
        drOutkaEdiL("SHIP_NM_M") = String.Empty
        '(2013.06.06)要望番号2020 売上先は反映しない Start
        drOutkaEdiL("EDI_DEST_CD") = String.Concat(sDestPreCode, drRcvEdiDtl("NONYU_CD").ToString)
        drOutkaEdiL("DEST_CD") = String.Concat(sDestPreCode, drRcvEdiDtl("NONYU_CD").ToString)
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        ''要望番号1663 umano修正START
        'If (drRcvEdiDtl("NONYU_NM1").ToString & drRcvEdiDtl("NONYU_NM2").ToString).Length > 80 Then
        '    drOutkaEdiL("DEST_NM") = Me._Blc.LeftB(("NONYU_NM1").ToString & drRcvEdiDtl("NONYU_NM2").ToString, 80)
        'Else

        '    drOutkaEdiL("DEST_NM") = drRcvEdiDtl("NONYU_NM1").ToString & " " & drRcvEdiDtl("NONYU_NM2").ToString
        'End If
        '要望番号1663 umano修正END
        drOutkaEdiL("DEST_NM") = Me._Blc.LeftB(String.Concat(drRcvEdiDtl("NONYU_NM1").ToString, Space(1), _
                                                             drRcvEdiDtl("NONYU_NM2").ToString, Space(1), _
                                                             drRcvEdiDtl("NONYU_NM3").ToString), 80)

        '(2013.02.25)要望番号1889 新レイアウト切替 修正END

        If setDs.Tables("LMH030_M_DEST").Rows.Count = 1 Then
            '届先が１件の場合のみ
            Dim drDest As DataRow = setDs.Tables("LMH030_M_DEST").Rows(0)
            If drDest("MST_CNT").ToString = "1" Then
                drOutkaEdiL("DEST_ZIP") = drDest("ZIP")
                ...
                drOutkaEdiL("DEST_TEL") = drDest("TEL")
                drOutkaEdiL("DEST_FAX") = drDest("FAX")
                drOutkaEdiL("DEST_MAIL") = String.Empty
                drOutkaEdiL("DEST_JIS_CD") = drDest("JIS")
                drOutkaEdiL("SP_NHS_KB") = drDest("SP_NHS_KB")
                drOutkaEdiL("COA_YN") = Right(drDest("COA_YN").ToString, 1)
            End If
        End If

        drOutkaEdiL("CUST_ORD_NO") = drRcvEdiDtl("ORDER_NO")
        drOutkaEdiL("BUYER_ORD_NO") = drRcvEdiDtl("JUTYU_NO")           '買主注文番号（全体）

        drOutkaEdiL("UNSO_MOTO_KB") = "10"                              '10：日陸手配　固定
        ...
        ''注意事項
        'drOutkaEdiL("REMARK") = drRcvEdiDtl("NONYU_REMARK")
        'drOutkaEdiL("UNSO_ATT") = drRcvEdiDtl("OUTKA_REMARK")
        drOutkaEdiL("REMARK") = drRcvEdiDtl("OUTKA_REMARK")
        drOutkaEdiL("UNSO_ATT") = drRcvEdiDtl("NONYU_REMARK")
        ...
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        'drOutkaEdiL("FREE_C01") = drRcvEdiDtl("NRS_BR_CD")
        drOutkaEdiL("FREE_C01") = drRcvEdiDtl("BYK_BR_CD")
        '(2013.02.25)要望番号1889 新レイアウト切替 修正END
        drOutkaEdiL("FREE_C02") = drRcvEdiDtl("OUTKA_REQ_DATE")
        drOutkaEdiL("FREE_C03") = drRcvEdiDtl("BYK_OUTKA_NO")
        drOutkaEdiL("FREE_C04") = drRcvEdiDtl("DATA_KB")
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        'drOutkaEdiL("FREE_C05") = drRcvEdiDtl("OUTKA_DATE")
        drOutkaEdiL("FREE_C05") = drRcvEdiDtl("OUTKA_PLAN_DATE")
        '(2013.02.25)要望番号1889 新レイアウト切替 修正END
        drOutkaEdiL("FREE_C06") = drRcvEdiDtl("NONYU_DATE")
        drOutkaEdiL("FREE_C07") = drRcvEdiDtl("TOKUI_CD")
        drOutkaEdiL("FREE_C08") = drRcvEdiDtl("TOKUI_NM")
        drOutkaEdiL("FREE_C09") = drRcvEdiDtl("NONYU_CD")
        drOutkaEdiL("FREE_C10") = drRcvEdiDtl("NONYU_NM1")
        drOutkaEdiL("FREE_C11") = drRcvEdiDtl("NONYU_NM2")
        drOutkaEdiL("FREE_C12") = drRcvEdiDtl("ORDER_NO")
        drOutkaEdiL("FREE_C13") = drRcvEdiDtl("OUTKA_REMARK")
        drOutkaEdiL("FREE_C14") = drRcvEdiDtl("NONYU_REMARK")
        '(2013.02.25)要望番号1889 新レイアウト切替 修正START
        'drOutkaEdiL("FREE_C15") = String.Empty
        drOutkaEdiL("FREE_C15") = drRcvEdiDtl("NONYU_NM3")
        'drOutkaEdiL("FREE_C16") = String.Empty
        drOutkaEdiL("FREE_C16") = String.Concat(drRcvEdiDtl("NONYU_NM1"), drRcvEdiDtl("NONYU_NM2"), drRcvEdiDtl("NONYU_NM3"))
        '(2013.02.25)要望番号1889 新レイアウト切替 修正END
        drOutkaEdiL("FREE_C17") = String.Empty
        drOutkaEdiL("FREE_C18") = String.Empty
        drOutkaEdiL("FREE_C19") = String.Empty
        drOutkaEdiL("FREE_C20") = sCustCdL & sCustCdM
        ...
        drOutkaEdiL("FREE_C29") = "11"
        drOutkaEdiL("FREE_C30") = "02"
...
#Region "セミEDI時　商品マスタからCustCd等を取得する"
    ...
    Private Function GetCustCd(ByVal ds As DataSet _
        ...
        Select Case iMstGoodsCnt
            ...
            Case 0      '商品マスタ取得０件
                '荷主はビックケミーとする
                sCustCdL = CUST_CD_L_BYK
                sCustCdM = CUST_CD_M_BYK
...
#Region "セミEDI データセット設定(EDI管理番号(大・中))"
    ...
    Private Function GetEdiCtlNo(ByVal ds As DataSet _
        ...
        Dim dtRcvEdiHed As DataTable = ds.Tables("LMH030_OUTKAEDI_HED_BYK")
        Dim dtRcvEdiDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_BYK")
        Dim drRcvEdiDtl As DataRow = ds.Tables("LMH030_OUTKAEDI_DTL_BYK").Rows(0)
        Dim sNrsBrCd As String = ds.Tables("LMH030_OUTKAEDI_DTL_BYK").Rows(0).Item("NRS_BR_CD").ToString()
        ...
        '    Dim dtRcvHedDel As DataTable = ds.Tables("LMH030_DTL_BYK_CANCELOUT")
        '    Dim drRcvHedDel As DataRow = ds.Tables("LMH030_DTL_BYK_CANCELOUT").Rows(0)

        '    Dim dtRcvDtlDel As DataTable = ds.Tables("LMH030_DTL_BYK_CANCELOUT")
        '    Dim drRcvDtlDel As DataRow = ds.Tables("LMH030_DTL_BYK_CANCELOUT").Rows(0)
...
#Region "カラム項目の値・日付チェック"
    ...
    Public Function TorikomiValChk(ByVal dr As DataRow, ByVal ediCustIndex As String) As Boolean
        ...
        sMsg = "先方営業所(カラム1番目)["
        sNum = dr.Item("COLUMN_1").ToString().Trim()
        ...
        sMsg = "出荷依頼日(カラム2番目)["
        sDate = dr.Item("COLUMN_2").ToString()
        ...
        sMsg = "出荷日(カラム5番目)["
        sDate = dr.Item("COLUMN_5").ToString()
        sDate = Me._Blc.GetSlashEditDate(sDate)    'スラッシュ付日付に編集
        If IsDate(sDate) = True Then
        Else
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E445", New String() {String.Concat(sMsg, sDate, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
        ...
        sMsg = "納期(カラム6番目)["
        sDate = dr.Item("COLUMN_6").ToString()
        sDate = Me._Blc.GetSlashEditDate(sDate)    'スラッシュ付日付に編集
        If IsDate(sDate) = True Then
        Else
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E445", New String() {String.Concat(sMsg, sDate, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
        ...
        'sMsg = "容量(カラム18番目)["
        'sNum = dr.Item("COLUMN_18").ToString().Trim()
        'If String.IsNullOrEmpty(sNum) = True Then
        '    '空の場合はゼロをセット
        '    dr.Item("COLUMN_18") = 0
        'Else
        ...
        'sMsg = "個数(カラム19番目)["
        'sNum = dr.Item("COLUMN_19").ToString().Trim()
        'If String.IsNullOrEmpty(sNum) = True Then
        '    '空の場合はゼロをセット
        '    dr.Item("COLUMN_19") = 0
        'Else
        ...
        'sMsg = "数量(カラム20番目)["
        'sNum = dr.Item("COLUMN_20").ToString().Trim()
        'If String.IsNullOrEmpty(sNum) = True Then
        '    '空の場合はゼロをセット
        '    dr.Item("COLUMN_20") = 0
        'Else
        ...
        sMsg = "容量(カラム15番目)["
        sNum = dr.Item("COLUMN_15").ToString().Trim()
        If String.IsNullOrEmpty(sNum) = True Then
            '空の場合はゼロをセット
            dr.Item("COLUMN_15") = 0
        Else
        ...
        sMsg = "個数(カラム16番目)["
        sNum = dr.Item("COLUMN_16").ToString().Trim()
        If String.IsNullOrEmpty(sNum) = True Then
            '空の場合はゼロをセット
            dr.Item("COLUMN_16") = 0
        Else
        ...
        sMsg = "数量(カラム17番目)["
        sNum = dr.Item("COLUMN_17").ToString().Trim()
        If String.IsNullOrEmpty(sNum) = True Then
            '空の場合はゼロをセット
            dr.Item("COLUMN_17") = 0
        Else
...
#Region "画面取込(セミEDI)データセット＋更新処理"
    ...
    Private Function SemiEdiTorikomi(ByVal ds As DataSet) As DataSet
        ...
        'Dim dtRcvHed As DataTable = ds.Tables("LMH030_OUTKAEDI_HED_BYK")         'EDI受信Hed
        Dim dtRcvDtl As DataTable = ds.Tables("LMH030_OUTKAEDI_DTL_BYK")         'EDI受信Dtl
        Dim dtRcvDtlCancel As DataTable = ds.Tables("LMH030_DTL_BYK_CANCELOUT")  'EDI受信Hed
        ...
        For i As Integer = 0 To iSetDtlMax
            ...
            '---------------------------------------------------------------------------
            ds.Tables("LMH030_OUTKAEDI_DTL_BYK").Clear() '受信DTLをクリア
            ds = Me.SetSemiOutkaEdiRcv(ds, i)
            Dim drEdiRcvDtl As DataRow = ds.Tables("LMH030_OUTKAEDI_DTL_BYK").Rows(0)


            '---------------------------------------------------------------------------
            ' キー項目設定
            '---------------------------------------------------------------------------
            sNewKey = drEdiRcvDtl.Item("DATA_KB").ToString & "-" _
                    & drEdiRcvDtl.Item("OUTKA_PLAN_DATE").ToString & "-" & drEdiRcvDtl.Item("NONYU_DATE").ToString & "-" _
                    & drEdiRcvDtl.Item("TOKUI_CD").ToString & "-" & drEdiRcvDtl.Item("NONYU_CD").ToString & "-" _
                    & drEdiRcvDtl.Item("NONYU_REMARK").ToString
            ...
            'EDI受信データ存在フラグ,EDI出荷データ存在フラグを0にする(初期値)
            iFindRcvEdiFlg = 0
            iFindOutkaEdiFlg = 0
            ...
            Dim ediCustIndex As Integer = Convert.ToInt32(ds.Tables("LMH030_SEMIEDI_INFO").Rows(0).Item("EDI_CUST_INDEX"))
            Select Case ediCustIndex
                Case LMH030BLC.EdiCustIndex.BykChb00266_00
                    sCustCdM = CUST_CD_M_BYK

                Case LMH030BLC.EdiCustIndex.BykChb00266_01
                    sCustCdM = CUST_CD_M_TTT

                Case LMH030BLC.EdiCustIndex.BykChb00266_02
                    sCustCdM = CUST_CD_M_NGS
            End Select
            ...
            '---------------------------------------------------------------------------
            ' 削除フラグが１の場合、受注データNoを元に取消データの確認処理を行う
            '---------------------------------------------------------------------------
            If iDeleteFlg = 1 Then

                '受信DTL取消データ取得処理
                ds.Tables("LMH030_DTL_BYK_CANCELOUT").Clear()    '取得用DSをクリア
                ...
                If MyBase.GetResultCount > 0 Then
                    ...
                    Dim drRcvDtlCancel As DataRow = ds.Tables("LMH030_DTL_BYK_CANCELOUT").Rows(0)
            ...
            '別インスタンス
            Dim setDs As DataSet = ds.Copy()
            Dim setDtlDt As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_BYK")
            setDtlDt.Clear()
