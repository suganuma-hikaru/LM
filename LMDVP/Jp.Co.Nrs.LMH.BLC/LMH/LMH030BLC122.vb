...
'  EDI荷主ID　　　　:  122　　　 : ミマキエンジニアリング（121片山ナルコよりコピー）
'  作  成  者       :  ANNEN
' ==========================================================================
Imports Jp.Co.Nrs.LM.Const
Imports Jp.Co.Nrs.LM.DAC
Imports Jp.Co.Nrs.LM.Utility
Imports Jp.Co.Nrs.LM.DAC.LMH030DAC122

''' <summary>
''' LMH030BLCクラス
''' </summary>
''' <remarks></remarks>
Public Class LMH030BLC122
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH030DAC122 = New LMH030DAC122()
...
#Region "セミEDI時　データセット設定(EDI受信DTL)"
    ...
    Private Function SetSemiEdiRcvDtlDspCom(ByVal ds As DataSet, ByVal i As Integer) As DataSet
        ...
        rcvDtlDr = ds.Tables("LMH030_OUTKAEDI_DTL_MMK").NewRow()
        ...
        rcvDtlDr("OUTKA_CTL_NO") = "P00000000"
        rcvDtlDr("OUTKA_CTL_NO_CHU") = "000"
        rcvDtlDr("PRTFLG") = "0"

        ' 荷主固有データ
        rcvDtlDr("GYO_NO") = (i + 1).ToString                                                                                                           '（行番号）
        rcvDtlDr("SYUKKO_KIBOU_DATE") = Format(Convert.ToDateTime(toriDtlDr(GetColumnName(MimakiArrivalColumns.SYUKKO_KIBOU_DATE))), "yyyy/MM/dd")      '出庫希望日
        rcvDtlDr("PALETTE_NO") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.PALETTE_NO)).ToString().Trim(), 40)                                  'パレット番号
        rcvDtlDr("BOX_NO") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.BOX_NO)).ToString().Trim(), 40)                                          '箱番号
        rcvDtlDr("KAKUNIN") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.KAKUNIN)).ToString().Trim(), 10)                                        '確認
        rcvDtlDr("HINBAN") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.HINBAN)).ToString().Trim(), 20)                                          '品番
        rcvDtlDr("HINMEI") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.HINMEI)).ToString().Trim(), 60)                                          '品名
        rcvDtlDr("LOT_NO") = String.Empty                                                                                                               'ロット番号(取り込まない)
        rcvDtlDr("YUUKOU_KIGEN") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.YUUKOU_KIGEN)).ToString().Trim(), 10)                              '有効期限
        rcvDtlDr("ZAIKO_SUU") = Left(toriDtlDr(GetColumnName(MimakiArrivalColumns.ZAIKO_SUU)).ToString().Trim(), 9)                                     '在庫数
        ...
        'データセットに設定
        ds.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows.Add(rcvDtlDr)
...
#Region "セミEDI時　データセット設定(EDI出荷(中))"
    ...
    Private Function SetSemiOutkaEdiM(ByVal setDs As DataSet, ByVal mGoodsCnt As Integer) As DataSet
        ...
        Dim rcvDtlDr As DataRow = setDs.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows(0)
        ...
        outkaediMDr("CUST_GOODS_CD") = rcvDtlDr("HINBAN")

        outkaediMDr("NRS_GOODS_CD") = mGoodsDt.Rows(0).Item("GOODS_CD_NRS")
        outkaediMDr("GOODS_NM") = rcvDtlDr("HINMEI")
        outkaediMDr("RSV_NO") = String.Empty
        outkaediMDr("LOT_NO") = rcvDtlDr("LOT_NO")
        outkaediMDr("SERIAL_NO") = rcvDtlDr("BOX_NO")
        outkaediMDr("ALCTD_KB") = "01"
        outkaediMDr("OUTKA_PKG_NB") = "1"
        outkaediMDr("OUTKA_HASU") = "0"
        outkaediMDr("OUTKA_QT") = String.Empty
        outkaediMDr("OUTKA_TTL_NB") = "1"
        outkaediMDr("OUTKA_TTL_QT") = String.Empty
        outkaediMDr("KB_UT") = String.Empty
        outkaediMDr("QT_UT") = String.Empty
        outkaediMDr("PKG_NB") = mGoodsDt.Rows(0).Item("PKG_NB")
        outkaediMDr("PKG_UT") = mGoodsDt.Rows(0).Item("PKG_UT")
        outkaediMDr("ONDO_KB") = mGoodsDt.Rows(0).Item("ONDO_KB")
        outkaediMDr("UNSO_ONDO_KB") = mGoodsDt.Rows(0).Item("UNSO_ONDO_KB")
        outkaediMDr("IRIME") = mGoodsDt.Rows(0).Item("STD_IRIME_NB")
        outkaediMDr("IRIME_UT") = mGoodsDt.Rows(0).Item("STD_IRIME_UT")
        ...
        outkaediMDr("FREE_C01") = rcvDtlDr("GYO_NO")
        outkaediMDr("FREE_C02") = rcvDtlDr("BOX_NO")
        outkaediMDr("FREE_C03") = rcvDtlDr("LOT_NO")
        outkaediMDr("FREE_C04") = "20" & rcvDtlDr("YUUKOU_KIGEN").ToString
...
#Region "セミEDI時　データセット設定(EDI出荷(大))"
    ...
    Private Function SetSemiOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        Dim outkaPlanDate As String = Convert.ToDateTime(rcvDtlDr("SYUKKO_KIBOU_DATE")).ToString("yyyyMMdd")
        outkaediLDr("OUTKA_PLAN_DATE") = outkaPlanDate
        outkaediLDr("OUTKO_DATE") = outkaPlanDate
        outkaediLDr("ARR_PLAN_DATE") = outkaPlanDate
        outkaediLDr("ARR_PLAN_TIME") = String.Empty
        outkaediLDr("HOKOKU_DATE") = String.Empty
        outkaediLDr("TOUKI_HOKAN_YN") = "1"
        ...
        outkaediLDr("DEST_CD") = "999999999999999"
        outkaediLDr("DEST_NM") = "引取"
        outkaediLDr("DEST_ZIP") = String.Empty
        outkaediLDr("DEST_AD_1") = String.Empty
        outkaediLDr("DEST_AD_2") = String.Empty
        ...
        outkaediLDr("CUST_ORD_NO") = String.Empty
        outkaediLDr("BUYER_ORD_NO") = String.Empty
        outkaediLDr("UNSO_MOTO_KB") = "90"              '画面：手配区分：未定
        ...
        outkaediLDr("FREE_C01") = outkaPlanDate     '自由項目に何も設定していないと落ちるのでダミーとして登録する
...
#Region "セミEDI データセット設定(EDI管理番号(大・中))"
    ...
    Private Function GetEdiCtlNo(ByVal ds As DataSet, ByVal bSameKeyFlg As Boolean _
        ...
        Dim rcvDtldr As DataRow = ds.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows(0)
        Dim nrsBrCd As String = ds.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows(0).Item("NRS_BR_CD").ToString()
...
#Region "商品明細マスタ"
    ...
    Public Function TorikomiMstChk(ByVal dr As DataRow, ByVal ds As DataSet) As Boolean
        ...
        If iGoodsCount = 0 Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E493", New String() {"荷主商品コード", "商品マスタ", String.Concat("荷主商品コード：", sGoodsCd, " 商品名：", sGoodsNm)}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            Return bRet
        ElseIf iGoodsCount > 1 Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E494", New String() {"荷主商品コード", "商品マスタ", String.Concat("荷主商品コード：", sGoodsCd)}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            Return bRet
        End If
            ...
            Else
                ...
                For j As Integer = iRowCnt To max
                    ...
                    If (dr.Item("FILE_NAME_RCV").ToString().Trim()).Equals(dtSemiHed.Rows(i).Item("FILE_NAME_RCV").ToString().Trim()) = True Then
                        ...
                        '別インスタンス
                        Dim setDs As DataSet = ds.Copy()
                        Dim setDt As DataTable = setDs.Tables("LMH030_EDI_TORIKOMI_DTL")
                        Dim setSemiDt As DataTable = setDs.Tables("LMH030_SEMIEDI_INFO")
...
#Region "画面取込(セミEDI)データセット＋更新処理"
    ...
    Private Function SemiEdiTorikomi(ByVal ds As DataSet) As DataSet
        ...
        Dim beforBoxNo As String = String.Empty

        'ソート順変更(商品コード、シリアルNO)
        Dim dtSortDtl As DataTable
        Dim dv As DataView
        dtSortDtl = toriDtlDt.Clone()
        dv = New DataView(ds.Tables("LMH030_EDI_TORIKOMI_DTL"))
        dv.Sort() = "COLUMN_5 ASC , COLUMN_3 ASC"
        For Each drv As DataRowView In dv
            dtSortDtl.ImportRow(drv.Row)
        Next
        ds.Tables("LMH030_EDI_TORIKOMI_DTL").Clear()
        ds.Tables("LMH030_EDI_TORIKOMI_DTL").Merge(dtSortDtl)

        For i As Integer = 0 To max

            'セミEDI取込(共通)⇒受信DTLへのデータセット
            ds.Tables("LMH030_OUTKAEDI_DTL_MMK").Clear() '受信DTLをクリア
            ds = Me.SetSemiEdiRcvDtlDspCom(ds, i)

            Dim rcvDtlDr As DataRow = ds.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows(0)

            '箱番号が一回前のレコードと同じなら次の行へ
            If beforBoxNo.Equals(rcvDtlDr("BOX_NO").ToString) Then
                Continue For
            End If

            beforBoxNo = rcvDtlDr("BOX_NO").ToString

            'キー項目設定
            If i = 0 Then
                '0番目は必ずbSameKeyFlgはFlase
                bSameKeyFlg = False
                sOldKey = rcvDtlDr.Item("SYUKKO_KIBOU_DATE").ToString()
            Else
                '1番目以降はキーを比較
                sNewKey = rcvDtlDr.Item("SYUKKO_KIBOU_DATE").ToString()
            ...
            '別インスタンス
            Dim setDs As DataSet = ds.Copy()
            Dim setDt As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_MMK")
            setDt.Clear()
            ...
            If mGoodsCnt > 1 Then
                MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, _
                                       "E975", _
                                       New String() {String.Concat("商品コード[", setDs.Tables("LMH030_OUTKAEDI_DTL_MMK").Rows(0).Item("HINMOKU_NO").ToString, "]")}, _
