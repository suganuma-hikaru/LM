...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH010DAC612 = New LMH010DAC612()
...
#Region "データセット設定(入荷S)"
    ...
    Private Function SetDatasetInkaS(ByVal ds As DataSet) As DataSet
        ...
        For i As Integer = 0 To max
            ...
            inkaDr("GOODS_COND_KB_3") = ediDr("FREE_C01")
            inkaDr("LT_DATE") = ediDr("FREE_C02")
            inkaDr("SPD_KB") = "01"
            inkaDr("OFB_KB") = "01"
...
#Region "実績作成処理"
    ...
    Private Function JissekiSakusei(ByVal ds As DataSet) As DataSet
        ...
        '送信データ作成用情報取得
        ds = MyBase.CallDAC(Me._Dac, "SelectSendBah", ds)
        ...
        '送信データの登録
        ds = MyBase.CallDAC(Me._Dac, "InsertSendBah", ds)
