...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH030DAC117 = New LMH030DAC117()
...
#Region "実績作成処理"
    ...
    Private Function JissekiSakusei(ByVal ds As DataSet) As DataSet
        ...
        'アンファEDI実績の値設定(EDI受信TBLより)
        ds = MyBase.CallDAC(Me._Dac, "SelectAngfaEdiSend", ds)
        ...
        'アンファEDI実績データの作成
        ds = MyBase.CallDAC(Me._Dac, "InsertAngfaEdiSendData", ds)
