...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH030DAC121 = New LMH030DAC121()
        ...
        For i As Integer = 0 To max
            ...
            If String.IsNullOrEmpty(custGoodsCd) = False Then
                ...
                If Me.EdiMDefaultSet(ds, setDs, i, unsoData, rowNo, ediCtlNo) = False Then
                    ...
                    'ワーニングがある場合は戻り値=Falseでメソッドを終了する
                    Dim chkRowNo As Integer = Convert.ToInt32(rowNo)
                    If MyBase.IsMessageStoreExist(chkRowNo) = True Then
                        '整合性チェックでエラーがあった場合は処理終了
                        Return False
...
#Region "セミEDI時　データセット設定(EDI受信DTL)"
    ...
    Private Function SetSemiEdiRcvDtlDspCom(ByVal ds As DataSet, ByVal i As Integer) As DataSet
        ...
        rcvDtlDr = ds.Tables("LMH030_OUTKAEDI_DTL_NRK").NewRow()
        ...
        rcvDtlDr("OUTKA_CTL_NO") = "G00000000"
        rcvDtlDr("OUTKA_CTL_NO_CHU") = "000"
        rcvDtlDr("PRTFLG") = "0"

        rcvDtlDr("DENPYO_NO") = Me._Blc.LeftB(toriDtlDr("COLUMN_1").ToString().Trim(), 30)                          '伝票NO
        rcvDtlDr("KAKUTEI_SYUKKA_DATE") = Me._Blc.LeftB(Convert.ToDateTime(toriDtlDr("COLUMN_2").ToString().Trim()).ToString("yyyy/MM/dd"), 10)                '確定出荷日
        rcvDtlDr("HANBAI_KBN") = Me._Blc.LeftB(toriDtlDr("COLUMN_3").ToString().Trim(), 2)                          '販売区分
        rcvDtlDr("HINMOKU_NO") = Me._Blc.LeftB(toriDtlDr("COLUMN_4").ToString().Trim(), 20)                         '品目番号
        rcvDtlDr("TANKA") = Me._Blc.LeftB(toriDtlDr("COLUMN_5").ToString().Trim(), 20)                              '単価
        rcvDtlDr("HINMOKU_MEI") = Me._Blc.LeftB(toriDtlDr("COLUMN_6").ToString().Trim(), 60)                        '品目名
        rcvDtlDr("UNSOU_KAISYA_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_7").ToString().Trim(), 60)                  '運送会社名
        rcvDtlDr("STATUS") = Me._Blc.LeftB(toriDtlDr("COLUMN_8").ToString().Trim(), 10)                             'ステータス
        rcvDtlDr("UNSOU_KAISYA") = Me._Blc.LeftB(toriDtlDr("COLUMN_9").ToString().Trim(), 3)                        '運送会社
        rcvDtlDr("SITE") = Me._Blc.LeftB(toriDtlDr("COLUMN_10").ToString().Trim(), 10)                              'サイト
        rcvDtlDr("SOUKO") = Me._Blc.LeftB(toriDtlDr("COLUMN_11").ToString().Trim(), 10)                             '倉庫
        rcvDtlDr("HINMOKU_G") = Me._Blc.LeftB(toriDtlDr("COLUMN_12").ToString().Trim(), 10)                         '品目G
        rcvDtlDr("OUTKA_SUURYOU") = Me._Blc.LeftB(toriDtlDr("COLUMN_13").ToString().Trim(), 12)                     '出荷数量
        rcvDtlDr("HANBAI_UKETUKE_SYA") = Me._Blc.LeftB(toriDtlDr("COLUMN_14").ToString().Trim(), 20)                '販売受付者
        rcvDtlDr("URIAGE_SYUBETU") = Me._Blc.LeftB(toriDtlDr("COLUMN_15").ToString().Trim(), 10)                    '売上種別
        rcvDtlDr("HAISOU_SAKI_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_16").ToString().Trim(), 80)                  '配送先名
        rcvDtlDr("IDOU_SAKI_SITE") = Me._Blc.LeftB(toriDtlDr("COLUMN_17").ToString().Trim(), 10)                    '移動先サイト
        rcvDtlDr("IDOU_SAKI_SOUKO") = Me._Blc.LeftB(toriDtlDr("COLUMN_18").ToString().Trim(), 10)                   '移動先倉庫
        rcvDtlDr("KOKYAKU_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_19").ToString().Trim(), 60)                      '顧客名
        rcvDtlDr("SYOUMI_KINGAKU") = Me._Blc.LeftB(toriDtlDr("COLUMN_20").ToString().Trim(), 20)                    '賞味金額
        rcvDtlDr("LOT_NO") = Me._Blc.LeftB(toriDtlDr("COLUMN_21").ToString().Trim(), 40)                            'ロット番号
        If toriDtlDr("COLUMN_22").ToString().Trim.Equals(String.Empty) Then
            rcvDtlDr("KAKUTEI_INKA_DATE") = String.Empty
        Else
            rcvDtlDr("KAKUTEI_INKA_DATE") = Me._Blc.LeftB(Convert.ToDateTime(toriDtlDr("COLUMN_22").ToString().Trim()).ToString("yyyy/MM/dd"), 10)                 '確定入荷日
        End If
        rcvDtlDr("AREA_CD") = Me._Blc.LeftB(toriDtlDr("COLUMN_23").ToString().Trim(), 10)                           'エリアコード
        rcvDtlDr("SOUKO_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_24").ToString().Trim(), 60)                        '倉庫名称
        rcvDtlDr("ZAIKO_TANNI") = Me._Blc.LeftB(toriDtlDr("COLUMN_25").ToString().Trim(), 10)                       '在庫単位
        rcvDtlDr("HAISOUSAKI_ZIP_NO") = Me._Blc.LeftB(toriDtlDr("COLUMN_26").ToString().Trim(), 10)                 '配送先郵便番号
        rcvDtlDr("KOKYAKU_ID") = Me._Blc.LeftB(toriDtlDr("COLUMN_27").ToString().Trim(), 20)                        '顧客ID
        rcvDtlDr("HANBAI_SUURYOU") = Me._Blc.LeftB(toriDtlDr("COLUMN_28").ToString().Trim(), 12)                    '販売数量
        rcvDtlDr("SEIKYUU_SAKI_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_29").ToString().Trim(), 80)                 '請求先名
        rcvDtlDr("OUTKA_DATE2") = Me._Blc.LeftB(toriDtlDr("COLUMN_30").ToString().Trim(), 10)                       '出荷日
        rcvDtlDr("SEIKYUU_ID") = Me._Blc.LeftB(toriDtlDr("COLUMN_31").ToString().Trim(), 10)                        '請求ID
        rcvDtlDr("KAISYUU_SAKI_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_32").ToString().Trim(), 80)                 '回収先名
        rcvDtlDr("HAISOU_SAKI_RYAKUSYOU") = Me._Blc.LeftB(toriDtlDr("COLUMN_33").ToString().Trim(), 80)             '配送先略称
        rcvDtlDr("SEIKYUU_KINGAKU") = Me._Blc.LeftB(toriDtlDr("COLUMN_34").ToString().Trim(), 20)                   '請求金額
        rcvDtlDr("HANNBAI_TANNI") = Me._Blc.LeftB(toriDtlDr("COLUMN_35").ToString().Trim(), 10)                     '販売単位
        rcvDtlDr("DOKUGEKIBUTU_KBN") = Me._Blc.LeftB(toriDtlDr("COLUMN_36").ToString().Trim(), 10)                  '毒劇物区分
        rcvDtlDr("DOKUGEKIBUTU_KBN_NAME") = Me._Blc.LeftB(toriDtlDr("COLUMN_37").ToString().Trim(), 60)             '毒劇物区分名称
        rcvDtlDr("HAISOU_SAKI_ADDRESS") = Me._Blc.LeftB(toriDtlDr("COLUMN_38").ToString().Trim(), 60)               '配送先住所
        rcvDtlDr("HAISOU_SAKI_TEL_NO") = Me._Blc.LeftB(toriDtlDr("COLUMN_39").ToString().Trim(), 20)                '配送先電話番号
        rcvDtlDr("KAISYUU_SAKI_ID") = Me._Blc.LeftB(toriDtlDr("COLUMN_40").ToString().Trim(), 10)                   '回収先ID
        rcvDtlDr("MEISAI_TEXT") = Me._Blc.LeftB(toriDtlDr("COLUMN_41").ToString().Trim(), 100)                      '明細テキスト
        rcvDtlDr("HAISOU_SAKI_TODOUFUKEN") = Me._Blc.LeftB(toriDtlDr("COLUMN_42").ToString().Trim(), 40)            '配送先都道府県
        rcvDtlDr("HAISOU_SAKI_SHIKUCHOUSON") = Me._Blc.LeftB(toriDtlDr("COLUMN_43").ToString().Trim(), 40)          '配送先市区町村
        rcvDtlDr("GYOU_NO") = Me._Blc.LeftB(toriDtlDr("COLUMN_44").ToString().Trim(), 10)                           '行NO
        rcvDtlDr("HAISOU_SAKI_TANTOUSYA") = Me._Blc.LeftB(toriDtlDr("COLUMN_45").ToString().Trim(), 20)             '配送先担当者
        rcvDtlDr("GAIBU_TEKIYOU") = Me._Blc.LeftB(toriDtlDr("COLUMN_46").ToString().Trim(), 100)                    '外部適用
        rcvDtlDr("HAISOU_SAKI_BUSYO") = Me._Blc.LeftB(toriDtlDr("COLUMN_47").ToString().Trim(), 60)                 '配送先部署
        rcvDtlDr("HAISOU_SAKI_TATEMONO") = Me._Blc.LeftB(toriDtlDr("COLUMN_48").ToString().Trim(), 140)             '配送先建物
        rcvDtlDr("HAISOU_SAKI_FAX") = Me._Blc.LeftB(toriDtlDr("COLUMN_49").ToString().Trim(), 15)                   '配送先FAX
        rcvDtlDr("SAKUSEI_DATE") = Me._Blc.LeftB(toriDtlDr("COLUMN_50").ToString().Trim(), 16)                      '作成日
        rcvDtlDr("YOUKI_SYUBETU") = Me._Blc.LeftB(toriDtlDr("COLUMN_51").ToString().Trim(), 10)                     '容器種別
        rcvDtlDr("NAIBU_TEKIYOU") = Me._Blc.LeftB(toriDtlDr("COLUMN_52").ToString().Trim(), 100)                    '内部摘要
        rcvDtlDr("WMS_SYORI_STATUS") = Me._Blc.LeftB(toriDtlDr("COLUMN_53").ToString().Trim(), 10)                  'WMS処理ステータス
        rcvDtlDr("SAKUSEI_SYA") = Me._Blc.LeftB(toriDtlDr("COLUMN_54").ToString().Trim(), 20)                       '作成者
        rcvDtlDr("WMS_SYORI_NICHIJI") = Me._Blc.LeftB(toriDtlDr("COLUMN_55").ToString().Trim(), 16)                 'WMS処理日時
        rcvDtlDr("HARAIDASHI_STATUS") = Me._Blc.LeftB(toriDtlDr("COLUMN_56").ToString().Trim(), 10)                 '払出ステータス
        rcvDtlDr("GETUJI_SHIME_DATE") = Me._Blc.LeftB(toriDtlDr("COLUMN_57").ToString().Trim(), 10)                 '月次締め日

        rcvDtlDr("JISSEKI_SHORI_FLG") = "1"                                                                         '実績処理フラグ

        'データセットに設定
        ds.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows.Add(rcvDtlDr)
...
#Region "セミEDI時　データセット設定(EDI出荷(中))"
    ...
    Private Function SetSemiOutkaEdiM(ByVal setDs As DataSet, ByVal mGoodsCnt As Integer) As DataSet
        ...
        Dim rcvDtlDr As DataRow = setDs.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows(0)
        ...
        outkaediMDr("CUST_ORD_NO_DTL") = rcvDtlDr("DENPYO_NO")
        outkaediMDr("BUYER_ORD_NO_DTL") = String.Empty
        outkaediMDr("CUST_GOODS_CD") = rcvDtlDr("HINMOKU_NO")

        outkaediMDr("NRS_GOODS_CD") = mGoodsDt.Rows(0).Item("GOODS_CD_NRS")
        outkaediMDr("GOODS_NM") = rcvDtlDr("HINMOKU_MEI")
        Dim irime As Double = Convert.ToDouble(mGoodsDt.Rows(0).Item("STD_IRIME_NB").ToString)
        Dim suuryou As Double = Convert.ToDouble(rcvDtlDr("OUTKA_SUURYOU").ToString)
        outkaediMDr("IRIME") = irime
        ...
        Dim syukkaHousouKosuu As Double = 0
        syukkaHousouKosuu = Math.Floor(suuryou / irime)
        Dim hasuu As Double = suuryou Mod irime
        If hasuu <> 0 Then
            syukkaHousouKosuu += 1
        End If

        outkaediMDr("OUTKA_PKG_NB") = syukkaHousouKosuu
        outkaediMDr("OUTKA_HASU") = hasuu
        outkaediMDr("OUTKA_QT") = suuryou
        outkaediMDr("OUTKA_TTL_NB") = syukkaHousouKosuu
        outkaediMDr("OUTKA_TTL_QT") = suuryou
        outkaediMDr("KB_UT") = String.Empty
        outkaediMDr("QT_UT") = String.Empty
        outkaediMDr("PKG_NB") = mGoodsDt.Rows(0).Item("PKG_NB")
        ...
        outkaediMDr("FREE_C01") = String.Empty
        outkaediMDr("FREE_C02") = String.Empty
...
#Region "セミEDI時　データセット設定(EDI出荷(大))"
    ...
    Private Function SetSemiOutkaEdiL(ByVal setDs As DataSet) As DataSet
        ...
        Dim outkaPlanDate As String = Convert.ToDateTime(rcvDtlDr("KAKUTEI_SYUKKA_DATE")).ToString("yyyyMMdd")
        outkaediLDr("OUTKA_PLAN_DATE") = outkaPlanDate
        outkaediLDr("OUTKO_DATE") = outkaPlanDate
        outkaediLDr("ARR_PLAN_DATE") = Convert.ToDateTime(rcvDtlDr("KAKUTEI_INKA_DATE")).ToString("yyyyMMdd")
        ...
        outkaediLDr("EDI_DEST_CD") = String.Empty
        outkaediLDr("DEST_CD") = rcvDtlDr("KOKYAKU_ID")
        outkaediLDr("DEST_NM") = rcvDtlDr("HAISOU_SAKI_NAME")
        outkaediLDr("DEST_ZIP") = rcvDtlDr("HAISOUSAKI_ZIP_NO")
        outkaediLDr("DEST_AD_1") = rcvDtlDr("HAISOU_SAKI_TODOUFUKEN")
        outkaediLDr("DEST_AD_2") = rcvDtlDr("HAISOU_SAKI_SHIKUCHOUSON")
        outkaediLDr("DEST_AD_3") = rcvDtlDr("HAISOU_SAKI_ADDRESS")
        outkaediLDr("DEST_AD_4") = String.Empty
        outkaediLDr("DEST_AD_5") = String.Empty
        outkaediLDr("DEST_TEL") = rcvDtlDr("HAISOU_SAKI_TEL_NO")
        ...
        outkaediLDr("CUST_ORD_NO") = rcvDtlDr("DENPYO_NO")
        ...
        'YK/千葉の場合はお引取とする
        Dim unsouCd As String = rcvDtlDr("UNSOU_KAISYA").ToString
        Dim unsouNm As String = rcvDtlDr("UNSOU_KAISYA_NAME").ToString
        If unsouCd = "28" OrElse unsouNm = "YK/千葉" Then
            outkaediLDr("UNSO_CD") = "33"
            outkaediLDr("UNSO_NM") = "お引取"
            outkaediLDr("UNSO_BR_CD") = "00"
            outkaediLDr("UNSO_BR_NM") = "."
        Else
        ...
        outkaediLDr("REMARK") = rcvDtlDr("GAIBU_TEKIYOU").ToString.Replace(vbCr, String.Empty).Replace(vbLf, String.Empty)
        outkaediLDr("UNSO_ATT") = rcvDtlDr("MEISAI_TEXT").ToString.Replace(vbCr, String.Empty).Replace(vbLf, String.Empty)
        ...
        outkaediLDr("FREE_C01") = String.Empty
...
#Region "セミEDI データセット設定(EDI管理番号(大・中))"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function GetEdiCtlNo(ByVal ds As DataSet, ByVal bSameKeyFlg As Boolean _
        ...
        Dim rcvDtldr As DataRow = ds.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows(0)
        Dim nrsBrCd As String = ds.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows(0).Item("NRS_BR_CD").ToString()
...
#Region "画面取込(セミEDI)データセット＋更新処理"
    ...
    Private Function SemiEdiTorikomi(ByVal ds As DataSet) As DataSet
        ...
        For i As Integer = 0 To max
            ...
            ds.Tables("LMH030_OUTKAEDI_DTL_NRK").Clear() '受信DTLをクリア
            ...
            If i = 0 Then
                ...
                bSameKeyFlg = False
                sOldKey = rcvDtlDr.Item("DENPYO_NO").ToString()
            Else
                '1番目以降はキーを比較
                sNewKey = rcvDtlDr.Item("DENPYO_NO").ToString()
            ...
            '別インスタンス
            Dim setDs As DataSet = ds.Copy()
            Dim setDt As DataTable = setDs.Tables("LMH030_OUTKAEDI_DTL_NRK")
            setDt.Clear()
            ...
            '取得した件数が1件より多い場合、エラーメッセージ出力
            If mGoodsCnt > 1 Then
                MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, _
                                       "E975", _
                                       New String() {String.Concat("商品コード[", setDs.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows(0).Item("HINMOKU_NO").ToString, "]")}, _
            ...
            '取得した件数が0件の場合、エラーメッセージの出力
            If mGoodsCnt.Equals(0) Then
                MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, _
                                       "E769", _
                                       New String() {String.Concat("商品コード[", setDs.Tables("LMH030_OUTKAEDI_DTL_NRK").Rows(0).Item("HINMOKU_NO").ToString, "]")}, _
                                       toriDtlDt.Rows(i).Item("REC_NO").ToString(), _
            ...
            'EDI出荷(大) EXCELファイルの伝票番号(カラム１行目)が全行と差異がある場合は、新規追加
            If bSameKeyFlg = False Then
                ...
                If Convert.ToInt32(setDs.Tables("DATA_COUNT").Rows(0).Item("DATA_COUNT").ToString) > 0 Then
                    MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, _
                                           "E269", _
                                           New String() {String.Concat("伝票NO[", setDs.Tables("LMH030_OUTKAEDI_L").Rows(0).Item("CUST_ORD_NO").ToString, "]")}, _
                                           toriDtlDt.Rows(i).Item("REC_NO").ToString(), _
                                           LMH030BLC.EXCEL_COLTITLE, _
                                           String.Empty)
                    Return ds
...
#Region "カラム項目の値・日付チェック"
    ...
    Public Function TorikomiValChk(ByVal dr As DataRow, ByVal ediCustIndex As String) As Boolean
        ...
        Dim targetStr As String = dr.Item("COLUMN_1").ToString().Trim()
        '必須チェック
        If String.IsNullOrEmpty(targetStr) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E001", New String() {String.Concat("伝票NO(カラム1番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '半角チェック
        ElseIf IsHalfSize(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E004", New String() {String.Concat("伝票NO(カラム1番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 30).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("伝票NO(カラム1番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        '必須チェック
        If String.IsNullOrEmpty(targetStr) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E001", New String() {String.Concat("確定出荷日(カラム2番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '日付チェック
        ElseIf IsConvertDate(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E047", New String() {String.Concat("確定出荷日(カラム2番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        '必須チェック
        If String.IsNullOrEmpty(targetStr) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E001", New String() {String.Concat("品目番号(カラム4番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '半角チェック
        ElseIf IsHalfSize(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E004", New String() {String.Concat("品目番号(カラム4番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 30).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("品目番号(カラム4番目)[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        '必須チェック
        If String.IsNullOrEmpty(targetStr) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E001", New String() {String.Concat("出荷数量（カラム13番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 12).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("出荷数量（カラム13番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '数値チェック
        ElseIf IsConvertDbl(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E005", New String() {String.Concat("出荷数量（カラム13番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        '桁数チェック
        If CheckLength(targetStr, 80).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("配送先名（カラム16番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        If IsHalfSize(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E004", New String() {String.Concat("ロット番号（カラム21番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 40).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("ロット番号（カラム21番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If

        '確定入荷日（カラム22番目）

        targetStr = dr.Item("COLUMN_22").ToString().Trim()
        If Not targetStr.ToString.Equals(String.Empty) Then
            '設定されていたときは日付チェック
            If IsConvertDate(targetStr).Equals(False) Then
                MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E047", New String() {String.Concat("確定入荷日（カラム22番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
                bRet = False
            End If
        End If
        ...
        '半角チェック
        If IsHalfSize(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E004", New String() {String.Concat("配送先郵便番号（カラム26番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 10).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("配送先郵便番号（カラム26番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        '半角チェック
        If IsHalfSize(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E004", New String() {String.Concat("顧客ID（カラム27番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 20).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("顧客ID（カラム27番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If

        '配送先住所（カラム38番目）

        targetStr = dr.Item("COLUMN_38").ToString().Trim()
        '桁数チェック
        If CheckLength(targetStr, 60).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("配送先住所（カラム38番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If

        '配送先電話番号（カラム39番目）

        targetStr = dr.Item("COLUMN_39").ToString().Trim()
        '半角チェック
        If IsHalfSize(targetStr).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E004", New String() {String.Concat("配送先電話番号（カラム39番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
            '桁数チェック
        ElseIf CheckLength(targetStr, 20).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("配送先電話番号（カラム39番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        'Todo) 
        '明細テキストはEDI出荷テーブル（大）の配送時注意事項に設定される。
        '配送先注意事項の桁数枠は100桁だが、既に100桁を超えるデータが確認されているので
        '取り合えず桁数チェックを行わない（桁数を超えた文字列は設定時にカットされる）

        'targetStr = dr.Item("COLUMN_41").ToString().Trim()
        ''桁数チェック
        'If CheckLength(targetStr, 100).Equals(False) Then
        '    MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("明細テキスト（カラム41番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
        '    bRet = False
        'End If
        ...
        '桁数チェック
        If CheckLength(targetStr, 40).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("配送先都道府県（カラム42番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
        ...
        '桁数チェック
        If CheckLength(targetStr, 40).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("配送先市区町村（カラム43番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If

        '外部適用（カラム46番目）

        targetStr = dr.Item("COLUMN_46").ToString().Trim()
        '桁数チェック
        If CheckLength(targetStr, 100).Equals(False) Then
            MyBase.SetMessageStore(LMH030BLC.GUIDANCE_KBN, "E002", New String() {String.Concat("外部適用（カラム46番目）[", targetStr, "]")}, sRecNo, LMH030BLC.EXCEL_COLTITLE_SEMIEDI, sFileNm)
            bRet = False
        End If
...
#Region "チェック"
    ...
    ''' <remarks>引数に文字列を設定し、それが年月日として扱えるかの判別を行う</remarks>
    Private Function IsConvertDate(ByVal targetString As String) As Boolean
        Dim d As DateTime
        Return DateTime.TryParse(targetString, d)
    ...
    ''' <remarks></remarks>
    Private Function IsHalfSize(ByVal targetString As String) As Boolean
    ...
    Private Overloads Function CheckLength(ByVal targetString As String, ByVal length As Integer) As Boolean
        Return CheckLength(targetString, length, False)
    End Function
    ...
    ''' <returns>True=条件を満たしている False=条件を満たしていない</returns>
    ''' <remarks></remarks>
    Private Overloads Function CheckLength(ByVal targetString As String, ByVal length As Integer, ByVal EqualOrMax As Boolean) As Boolean
        If EqualOrMax.Equals(True) Then
