...
'  システム名       :  LM
'  サブシステム名   :  LMH       : EDI
'  プログラムID     :  LMH571    : 出荷EDI受信一覧表(大阪_浮間合成)
'  作  成  者       :  栗原光伸
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMH571DAC = New LMH571DAC()
...
#Region "Const"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const TABLE_NM_IN As String = "LMH571IN"

    ''' <summary>
    ''' OUTテーブル名
    ''' </summary>
    ''' <remarks></remarks>
    Private Const TABLE_NM_OUT As String = "LMH571OUT"
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = LMH571BLC.TABLE_NM_IN
        Dim tableNmOut As String = LMH571BLC.TABLE_NM_OUT
        Dim tableNmRpt As String = LMH571BLC.TABLE_NM_M_RPT
        ...
        workDtRpt = view.ToTable(True, LMH571BLC.NRS_BR_CD, LMH571BLC.PTN_ID, LMH571BLC.PTN_CD, LMH571BLC.RPT_ID)
        ...
        For Each dr As DataRow In ds.Tables(tableNmRpt).Rows
            ...
            'prtDs = comPrt.CallDataSet(ds.Tables(tableNmOut), dr.Item(LMH571BLC.RPT_ID).ToString())
            prtDs = comPrt.CallDataSet(dtOut, dr.Item(LMH571BLC.RPT_ID).ToString())
            '(2012.06.11) 要望番号1102 並び換えしたDateTableを設定 ---  END  ---

            '帳票ごとの編集があるなら行う。
            prtDs = Me.EditPrintDataSet(dr.Item(LMH571BLC.RPT_ID).ToString(), prtDs)

            '帳票CSV出力
            comPrt.StartPrint(Me, dr.Item(LMH571BLC.NRS_BR_CD).ToString(), _
                                dr.Item(LMH571BLC.PTN_ID).ToString(), _
                                dr.Item(LMH571BLC.PTN_CD).ToString(), _
                                dr.Item(LMH571BLC.RPT_ID).ToString(), _
    ...
    Private Function SelectMPrt(ByVal ds As DataSet, ByVal intbl As DataTable) As DataSet
        ...
        ds = MyBase.CallDAC(Me._Dac, LMH571BLC.ACTION_ID_SELECT_MPRT, ds)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Return MyBase.CallDAC(Me._Dac, LMH571BLC.ACTION_ID_SELECT_PRT_DATA, ds)
