...
'  システム名       :  LM
'  サブシステム名   :  LMG       : 請求
'  プログラムID     :  LMG560    : デュポン請求データ入力(登録リスト)
'  作  成  者       :  [shinohara]
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMG560DAC = New LMG560DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMG560IN"
        Dim tableNmOut As String = "LMG560OUT"
