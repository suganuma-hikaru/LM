...
'  プログラムID     :  LMG530BLC : 請求鑑取込ﾁｪｯｸﾘｽﾄ(保管荷役料)
'  作  成  者       :  [笈川]
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMG530DAC = New LMG530DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMG530IN"
        Dim tableNmOut As String = "LMG530OUT"
