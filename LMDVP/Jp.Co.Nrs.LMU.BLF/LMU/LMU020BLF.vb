...
Public Class LMU020BLF
    ...
    Private Function SelectDataList(ByVal ds As DataSet) As DataSet
        ...
        If Me.GetForceOparation = False Then
            ...
            'データ件数取得
            ds = Me.CallBLC(New LMU020BLC, "SelectDataCount", ds)
            'メッセージの判定
        ...
        '検索結果取得
        ds = Me.CallBLC(New LMU020BLC, "SelectDataList", ds)
    ...
    Private Function DeleteListData(ByVal ds As DataSet) As DataSet
        ...
        Dim blc As LMU020BLC = New LMU020BLC()
    ...
    Private Function chkDataListHaita(ByVal ds As DataSet) As DataSet
        ...
        '検索結果取得
        ds = Me.CallBLC(New LMU020BLC, "chkDataListHaita", ds)

        'DataSet初期化
        ds.Tables("LMU020IN").Clear()
        Return ds
                ...
                With ds.Tables("M_FILE").Rows(i)
                    ...
                    If String.IsNullOrEmpty(.Item("UPD_FLG").ToString) = False AndAlso _
                       ...
                       .Item("SYS_DEL_FLG").ToString.Equals("1") = False Then
                        ...
                        '[データ登録]
                        'M_FILE
                        Me.CallBLC(New LMU020BLC, "InsertData", dsTmp.Copy)
                        If Me.IsMessageExist = True Then
                            Return ds
                        End If
                    ...
                    ElseIf String.IsNullOrEmpty(.Item("UPD_FLG").ToString) = False AndAlso _
                        ...
                        '[データ論理削除]
                        'M_FILE
                        Me.CallBLC(New LMU020BLC, "DeleteData", dsTmp)
                        If Me.IsMessageExist = True Then
                            Return ds
                        End If
                    ...
                    ElseIf String.IsNullOrEmpty(.Item("UPD_FLG").ToString) = False AndAlso _
                        ...
                        '[データ更新]
                        'M_FILE
                        Me.CallBLC(New LMU020BLC, "UpdateData", dsTmp)
                        If Me.IsMessageExist = True Then
                            Return ds
                        End If
                    ...
                    '[データ更新]
                    'WK_WEB_ORDER_HED
                    If .Item("FILE_TYPE_KBN").ToString.Equals("L1") Then

                        Me.CallBLC(New LMU020BLC, "UpdateWebData", dsTmp)
