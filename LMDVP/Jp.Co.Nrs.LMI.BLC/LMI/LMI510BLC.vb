...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMI510DAC = New LMI510DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMI510IN"
        Dim tableNmOut As String = "LMI510OUT"
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables("LMI510OUT"), dr.Item("RPT_ID").ToString())
            ''帳票ごとの編集があるなら行う。
    ...
    '        Case "LMF511"
    '            'ソート対象データテーブル取得
    '            Dim outDt As DataTable = ds.Tables("LMI510OUT")
    '            'ソート条件設定
    ...
    '                rtnDs.Tables("LMI510OUT").ImportRow(row)
    '            Next
