...
'  システム名       :  LM
'  サブシステム名   :  LMF       : 特殊荷主機能
'  プログラムID     :  LMI670BLC : 売上仕入伝票(DIC鑑種別：B(横持料除く))
'  作  成  者       :  寺川
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMI671DAC = New LMI671DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        If dtOut.Rows.Count = 0 Then
            MyBase.SetMessageStore("00", "E078", New String() {"売上仕入伝票(LMI671)"})
            Return ds
        End If
