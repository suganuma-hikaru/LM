...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMI591DAC = New LMI591DAC()
...
#Region "Const"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const TABLE_NM_IN As String = "LMI591IN"

    ''' <summary>
    ''' OUTテーブル名
    ''' </summary>
    ''' <remarks></remarks>
    Private Const TABLE_NM_OUT As String = "LMI591OUT"
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = LMI591BLC.TABLE_NM_IN
        Dim tableNmOut As String = LMI591BLC.TABLE_NM_OUT
        Dim tableNmRpt As String = LMI591BLC.TABLE_NM_M_RPT
        ...
        workDtRpt = view.ToTable(True, LMI591BLC.NRS_BR_CD, LMI591BLC.PTN_ID, LMI591BLC.PTN_CD, LMI591BLC.RPT_ID)
        ...
        For Each dr As DataRow In ds.Tables(tableNmRpt).Rows
            ...
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables(tableNmOut), dr.Item(LMI591BLC.RPT_ID).ToString())

            '帳票ごとの編集があるなら行う。
            prtDs = Me.EditPrintDataSet(dr.Item(LMI591BLC.RPT_ID).ToString(), prtDs)

            '帳票CSV出力
            comPrt.StartPrint(Me, dr.Item(LMI591BLC.NRS_BR_CD).ToString(), _
                                dr.Item(LMI591BLC.PTN_ID).ToString(), _
                                dr.Item(LMI591BLC.PTN_CD).ToString(), _
                                dr.Item(LMI591BLC.RPT_ID).ToString(), _
    ...
    Private Function EditPrintDataSet(ByVal rptId As String, ByVal ds As DataSet) As DataSet
        ...
        Dim outDt As DataTable = ds.Tables("LMI591OUT") 'データ取得
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        ds = MyBase.CallDAC(Me._Dac, LMI591BLC.ACTION_ID_SELECT_MPRT, ds)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Dim rtnDs As DataSet = MyBase.CallDAC(Me._Dac, LMI591BLC.ACTION_ID_SELECT_PRT_DATA, ds)
