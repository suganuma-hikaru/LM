...
'  システム名       :  LM
'  サブシステム名   :  LMI       :特定荷主
'  プログラムID     :  LMI520BLC :コストデータ一覧(ダウ・ケミカル用)
'  作  成  者       :  篠原
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMI520DAC = New LMI520DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMI520IN"
        Dim tableNmOut As String = "LMI520OUT"
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables("LMI520OUT"), dr.Item("RPT_ID").ToString())
            ''帳票ごとの編集があるなら行う。
