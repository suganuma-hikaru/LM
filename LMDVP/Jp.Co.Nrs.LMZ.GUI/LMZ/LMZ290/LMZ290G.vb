...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ290F)
...
#Region "Form"
    ...
    ''' <remarks></remarks>
    Friend Sub UnsocoHeaderDataSet(ByVal drow As DataRow)

        With Me._Frm

            .txtUnsocoCd.TextValue = drow("UNSOCO_CD").ToString()
            .lblUnsocoNm.TextValue = drow("UNSOCO_NM").ToString()
            .txtUnsocoBrCd.TextValue = drow("UNSOCO_BR_CD").ToString()
            .lblUnsocoBrNm.TextValue = drow("UNSOCO_BR_NM").ToString()
...
#Region "Spread"
    ...
    Public Class sprDetailDef
        ...
        'スプレッド(タイトル列)の設定
        Public Shared DEF As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.DEF, " ", 20, True)
        Public Shared SHIHARAI_TARIFF_CD As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.SHIHARAI_TARIFF_CD, "タリフコード", 100, True)
        Public Shared SHIHARAI_TARIFF_REM As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.SHIHARAI_TARIFF_REM, "備考", 325, True)
        Public Shared TABLE_TP_NM As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.TABLE_TP_NM, "タリフタイプ", 265, True)
        Public Shared TABLE_TP As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.TABLE_TP, "タリフタイプ区分", 80, False)
        Public Shared STR_DATE As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.STR_DATE, "適用開始日", 90, True)
        Public Shared ROW_INDEX As SpreadColProperty = New SpreadColProperty(LMZ290C.SprColumnIndex.ROW_INDEX, "行番号", 10, False)
    ...
    Friend Sub InitSpread(ByVal drow As DataRow)
        ...
        With Me._Frm
            ...
            .sprDetail.ActiveSheet.FrozenColumnCount = LMZ290G.sprDetailDef.DEF.ColNo + 1
            Dim lbl As StyleInfo = LMSpreadUtility.GetLabelCell(.sprDetail, CellHorizontalAlignment.Left)

            '列設定
            .sprDetail.SetCellStyle(0, LMZ290G.sprDetailDef.SHIHARAI_TARIFF_CD.ColNo, LMSpreadUtility.GetTextCell(.sprDetail, InputControl.ALL_HANKAKU, 10, False))
            .sprDetail.SetCellStyle(0, LMZ290G.sprDetailDef.SHIHARAI_TARIFF_REM.ColNo, LMSpreadUtility.GetTextCell(.sprDetail, InputControl.ALL_MIX, 100, False))
            .sprDetail.SetCellStyle(0, LMZ290G.sprDetailDef.TABLE_TP_NM.ColNo, LMSpreadUtility.GetComboCellKbn(.sprDetail, "U011", False))
            .sprDetail.SetCellStyle(0, LMZ290G.sprDetailDef.TABLE_TP.ColNo, lbl)
            .sprDetail.SetCellStyle(0, LMZ290G.sprDetailDef.STR_DATE.ColNo, lbl)
            .sprDetail.SetCellStyle(0, LMZ290G.sprDetailDef.ROW_INDEX.ColNo, lbl)
    ...
    Friend Sub SetInitValue(ByVal drow As DataRow)
        ...
        With _Frm
            ...
            Dim unsocoCd As String = String.Empty
            Dim unsocoBrCd As String = String.Empty
            unsocoCd = drow("UNSOCO_CD").ToString()
            unsocoBrCd = drow("UNSOCO_BR_CD").ToString()

            .txtUnsocoCd.TextValue = unsocoCd
            .txtUnsocoBrCd.TextValue = unsocoBrCd

            If String.IsNullOrEmpty(unsocoCd) = False _
                AndAlso String.IsNullOrEmpty(unsocoBrCd) = True Then
                .txtUnsocoBrCd.TextValue = "00"
            End If
        ...
        With _Frm.sprDetail
            ...
            .SetCellValue(0, LMZ290G.sprDetailDef.SHIHARAI_TARIFF_CD.ColNo, drow("SHIHARAI_TARIFF_CD").ToString())
            .SetCellValue(0, LMZ290G.sprDetailDef.SHIHARAI_TARIFF_REM.ColNo, drow("SHIHARAI_TARIFF_REM").ToString())
            .SetCellValue(0, LMZ290G.sprDetailDef.TABLE_TP_NM.ColNo, drow("TABLE_TP").ToString())
            .SetCellValue(0, LMZ290G.sprDetailDef.TABLE_TP.ColNo, drow("TABLE_TP").ToString())
            '.SetCellValue(0, LMZ290G.sprDetailDef.STR_DATE.ColNo, drow("STR_DATE").ToString())
    ...
    Friend Sub SetSpread(ByVal dt As DataTable)
        ...
        With spr
            ...
            .SuspendLayout()
            '行数設定
            'Dim tbl As DataTable = dtOut.Tables(LMZ290C.TABLE_NM_OUT)
            ...
            For i As Integer = 1 To lngcnt
                ...
                .SetCellStyle(i, sprDetailDef.SHIHARAI_TARIFF_CD.ColNo, sLabel)
                .SetCellStyle(i, sprDetailDef.SHIHARAI_TARIFF_REM.ColNo, sLabel)
                ...
                .SetCellValue(i, sprDetailDef.SHIHARAI_TARIFF_CD.ColNo, dRow.Item("SHIHARAI_TARIFF_CD").ToString())
                .SetCellValue(i, sprDetailDef.SHIHARAI_TARIFF_REM.ColNo, dRow.Item("SHIHARAI_TARIFF_REM").ToString())
