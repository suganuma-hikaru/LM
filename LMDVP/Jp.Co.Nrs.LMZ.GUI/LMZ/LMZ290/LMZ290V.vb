...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ290F, ByVal v As LMZControlV _
                   , ByVal LMZConG As LMZControlG, ByVal g As LMZ290G)
...
#Region "Method"
    ...
    Private Function IsSingleCheck() As Boolean
        ...
        With Me._Frm
            ...
            '基準日
            .lblStrDate.ItemName = "基準日"
            .lblStrDate.IsHissuCheck = True
            If MyBase.IsValidateCheck(.lblStrDate) = False Then
                Return False
            End If
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            'タリフコード
            vCell.SetValidateCell(0, LMZ290G.sprDetailDef.SHIHARAI_TARIFF_CD.ColNo)
            ...
            '備考
            vCell.SetValidateCell(0, LMZ290G.sprDetailDef.SHIHARAI_TARIFF_REM.ColNo)
            vCell.ItemName = "備考"
            vCell.IsForbiddenWordsCheck = True
    ...
    Friend Function HeaderExist() As Boolean
        ...
        '    custCdM = "00"
        '    Me._Frm.txtUnsocoBrCd.TextValue = custCdM
        'End If
        ...
        With Me._Frm
            ...
            Select Case objNm
                ...
                Case .txtUnsocoCd.Name, .txtUnsocoBrCd.Name
                    ...
                    msg = New String() {String.Concat(unsocoNm, LMZControlC.CD, LMZControlC.L_NM) _
                                        , String.Concat(unsocoNm, LMZControlC.CD, LMZControlC.M_NM)}
