...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ310F, ByVal v As LMZControlV)
...
#Region "Method"
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            '支払先コード
            vCell.SetValidateCell(0, LMZ310G.sprDetailDef.SHIHARAITO_CD.ColNo)
            vCell.ItemName = "支払先コード"
            ...
            '支払先会社名
            vCell.SetValidateCell(0, LMZ310G.sprDetailDef.SHIHARAITO_NM.ColNo)
            vCell.ItemName = "支払先会社名"
            vCell.IsForbiddenWordsCheck = True
            ...
            '支払先部署名
            vCell.SetValidateCell(0, LMZ310G.sprDetailDef.SHIHARAITO_BUSYO_NM.ColNo)
            vCell.ItemName = "支払先部署名"
            vCell.IsForbiddenWordsCheck = True
            vCell.IsByteCheck = 60
            If MyBase.IsValidateCheck(vCell) = False Then
                Return False
            ...
            '担当者
            vCell.SetValidateCell(0, LMZ310G.sprDetailDef.OYA_PIC.ColNo)
            vCell.ItemName = "担当者"
            vCell.IsForbiddenWordsCheck = True
