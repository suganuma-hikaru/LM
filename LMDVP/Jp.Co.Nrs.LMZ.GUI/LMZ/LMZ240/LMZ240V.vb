...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ240F, ByVal v As LMZControlV _
                   , ByVal LMZConG As LMZControlG, ByVal g As LMZ240G)
...
#Region "Method"
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            'タリフコード
            vCell.SetValidateCell(0, LMZ240G.sprDetailDef.EXTC_TARIFF_CD.ColNo)
            ...
            '備考
            vCell.SetValidateCell(0, LMZ240G.sprDetailDef.EXTC_TARIFF_REM.ColNo)
            vCell.ItemName = "備考"
            vCell.IsForbiddenWordsCheck = True
