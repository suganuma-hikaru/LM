...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ240F)
...
#Region "Spread"
    ...
    Public Class sprDetailDef
        ...
        'スプレッド(タイトル列)の設定
        Public Shared DEF As SpreadColProperty = New SpreadColProperty(LMZ240C.SprColumnIndex.DEF, " ", 20, True)
        Public Shared EXTC_TARIFF_CD As SpreadColProperty = New SpreadColProperty(LMZ240C.SprColumnIndex.EXTC_TARIFF_CD, "タリフコード", 100, True)
        Public Shared EXTC_TARIFF_REM As SpreadColProperty = New SpreadColProperty(LMZ240C.SprColumnIndex.EXTC_TARIFF_REM, "備考", 395, True)
        Public Shared ROW_INDEX As SpreadColProperty = New SpreadColProperty(LMZ240C.SprColumnIndex.ROW_INDEX, "行番号", 10, False)
    ...
    Friend Sub InitSpread(ByVal drow As DataRow)
        ...
        With Me._Frm
            ...
            .sprDetail.ActiveSheet.FrozenColumnCount = LMZ240G.sprDetailDef.DEF.ColNo + 1

            '列設定
            .sprDetail.SetCellStyle(0, LMZ240G.sprDetailDef.EXTC_TARIFF_CD.ColNo, LMSpreadUtility.GetTextCell(.sprDetail, InputControl.ALL_HANKAKU, 10, False))
            .sprDetail.SetCellStyle(0, LMZ240G.sprDetailDef.EXTC_TARIFF_REM.ColNo, LMSpreadUtility.GetTextCell(.sprDetail, InputControl.ALL_MIX, 100, False))
            .sprDetail.SetCellStyle(0, LMZ240G.sprDetailDef.ROW_INDEX.ColNo, LMSpreadUtility.GetLabelCell(.sprDetail))
    ...
    Friend Sub SetInitValue(ByVal drow As DataRow)
        ...
        With _Frm.sprDetail
            ...
            .SetCellValue(0, LMZ240G.sprDetailDef.EXTC_TARIFF_CD.ColNo, drow("EXTC_TARIFF_CD").ToString())
            .SetCellValue(0, LMZ240G.sprDetailDef.EXTC_TARIFF_REM.ColNo, drow("EXTC_TARIFF_REM").ToString())
    ...
    Friend Sub SetSpread(ByVal dt As DataTable)
        ...
        With spr
            ...
            .SuspendLayout()
            '行数設定
            'Dim tbl As DataTable = dtOut.Tables(LMZ240C.TABLE_NM_OUT)
