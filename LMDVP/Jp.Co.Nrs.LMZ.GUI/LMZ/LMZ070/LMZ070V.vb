...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ070F, ByVal v As LMZControlV)
...
#Region "Method"
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            '市区町村名
            vCell.SetValidateCell(0, LMZ070G.sprDetailDef.SHI.ColNo)
            ...
            'JISコード
            vCell.SetValidateCell(0, LMZ070G.sprDetailDef.JIS_CD.ColNo)
