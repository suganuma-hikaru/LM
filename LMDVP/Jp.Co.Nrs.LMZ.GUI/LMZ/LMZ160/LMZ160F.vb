...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMZ160H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprDetail_CellDoubleClick(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprDriver.CellDoubleClick
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprDriver_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles sprDriver.KeyDown

        With Me.sprDriver.Sheets(0)
