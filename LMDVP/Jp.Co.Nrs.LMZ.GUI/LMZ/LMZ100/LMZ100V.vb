...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ100F, ByVal v As LMZControlV _
                   , ByVal LMZConG As LMZControlG, ByVal g As LMZ100G)
...
#Region "Method"
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            'タリフコード
            vCell.SetValidateCell(0, LMZ100G.sprDetailDef.YOKO_TARIFF_CD.ColNo)
            ...
            '備考
            vCell.SetValidateCell(0, LMZ100G.sprDetailDef.YOKO_REM.ColNo)
            vCell.ItemName = "備考"
            vCell.IsForbiddenWordsCheck = True
