...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ190F, ByVal v As LMZControlV)
...
#Region "Method"
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            '請求項目名
            vCell.SetValidateCell(0, LMZ190G.sprDetailDef.SEIQKMK_NM.ColNo)
            ...
            '備考
            vCell.SetValidateCell(0, LMZ190G.sprDetailDef.REMARK.ColNo)
            vCell.ItemName = "備考"
            vCell.IsForbiddenWordsCheck = True
            ...
            '項目コード
            vCell.SetValidateCell(0, LMZ190G.sprDetailDef.SEIQKMK_CD.ColNo)
            vCell.ItemName = "項目コード"
            vCell.IsForbiddenWordsCheck = True
            vCell.IsByteCheck = 2
            If MyBase.IsValidateCheck(vCell) = False Then
                Return False
