...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ320F)
...
#Region "Spread"
    ...
    Public Class sprDetailDef
        ...
        'スプレッド(タイトル列)の設定
        Public Shared DEF As SpreadColProperty = New SpreadColProperty(LMZ320C.SprColumnIndex.DEF, " ", 20, True)
        Public Shared YOKO_TARIFF_CD As SpreadColProperty = New SpreadColProperty(LMZ320C.SprColumnIndex.YOKO_TARIFF_CD, "タリフコード", 100, True)
        Public Shared CALC_KB_NM As SpreadColProperty = New SpreadColProperty(LMZ320C.SprColumnIndex.CALC_KB_NM, "計算方法", 80, True)
        Public Shared CALC_KB As SpreadColProperty = New SpreadColProperty(LMZ320C.SprColumnIndex.CALC_KB, "計算方法区分", 50, False)
        Public Shared YOKO_REM As SpreadColProperty = New SpreadColProperty(LMZ320C.SprColumnIndex.YOKO_REM, "備考", 300, True)
        Public Shared ROW_INDEX As SpreadColProperty = New SpreadColProperty(LMZ320C.SprColumnIndex.ROW_INDEX, "行番号", 10, False)
    ...
    Friend Sub InitSpread(ByVal drow As DataRow)
        ...
        With Me._Frm
            ...
            .sprDetail.ActiveSheet.FrozenColumnCount = LMZ320G.sprDetailDef.DEF.ColNo + 1

            '列設定
            .sprDetail.SetCellStyle(0, LMZ320G.sprDetailDef.YOKO_TARIFF_CD.ColNo, LMSpreadUtility.GetTextCell(.sprDetail, InputControl.ALL_HANKAKU, 10, False))
            .sprDetail.SetCellStyle(0, LMZ320G.sprDetailDef.CALC_KB_NM.ColNo, LMSpreadUtility.GetComboCellKbn(.sprDetail, "K012", False))
            .sprDetail.SetCellStyle(0, LMZ320G.sprDetailDef.CALC_KB.ColNo, LMSpreadUtility.GetLabelCell(.sprDetail, CellHorizontalAlignment.Left))
            .sprDetail.SetCellStyle(0, LMZ320G.sprDetailDef.YOKO_REM.ColNo, LMSpreadUtility.GetTextCell(.sprDetail, InputControl.ALL_MIX, 100, False))
            .sprDetail.SetCellStyle(0, LMZ320G.sprDetailDef.ROW_INDEX.ColNo, LMSpreadUtility.GetLabelCell(.sprDetail))
    ...
    Friend Sub SetInitValue(ByVal drow As DataRow)
        ...
        With _Frm.sprDetail
            .SetCellValue(0, LMZ320G.sprDetailDef.YOKO_TARIFF_CD.ColNo, drow("YOKO_TARIFF_CD").ToString())
            .SetCellValue(0, LMZ320G.sprDetailDef.CALC_KB_NM.ColNo, drow("CALC_KB").ToString())
            .SetCellValue(0, LMZ320G.sprDetailDef.CALC_KB.ColNo, drow("CALC_KB").ToString())
            .SetCellValue(0, LMZ320G.sprDetailDef.YOKO_REM.ColNo, drow("YOKO_REM").ToString())
        End With
    ...
    Friend Sub SetSpread(ByVal dt As DataTable)
        ...
        With spr
            ...
            .SuspendLayout()
            '行数設定
            'Dim tbl As DataTable = dtOut.Tables(LMZ320C.TABLE_NM_OUT)
