...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ230F, ByVal v As LMZControlV _
                   , ByVal LMZConG As LMZControlG, ByVal g As LMZ230G)
...
#Region "Method"
    ...
    Private Function IsSingleCheck() As Boolean
        ...
        With Me._Frm
            ...
            .cmbNrsBrCd.ItemName = .LmTitleLabel4.Text()
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            'タリフコード
            vCell.SetValidateCell(0, LMZ230G.sprDetailDef.UNCHIN_TARIFF_CD.ColNo)
            '2016.01.06 UMANO 英語化対応START
            'vCell.ItemName = "タリフコード"
            vCell.ItemName = LMZ230G.sprDetailDef.UNCHIN_TARIFF_CD.ColName
            '2016.01.06 UMANO 英語化対応END
            ...
            '備考
            vCell.SetValidateCell(0, LMZ230G.sprDetailDef.UNCHIN_TARIFF_REM.ColNo)
            '2016.01.06 UMANO 英語化対応START
            'vCell.ItemName = "備考"
            vCell.ItemName = LMZ230G.sprDetailDef.UNCHIN_TARIFF_REM.ColName
            '2016.01.06 UMANO 英語化対応END
            vCell.IsForbiddenWordsCheck = True
