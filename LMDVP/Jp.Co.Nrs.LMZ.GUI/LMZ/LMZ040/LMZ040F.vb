...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMZ040H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprDetail_CellDoubleClick(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprTanka.CellDoubleClick
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprTanka_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles sprTanka.KeyDown

        With Me.sprTanka.Sheets(0)
