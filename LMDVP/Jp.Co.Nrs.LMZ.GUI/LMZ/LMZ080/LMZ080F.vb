...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMZ080H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprDetail_CellDoubleClick(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprKyori.CellDoubleClick
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprKyori_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles sprKyori.KeyDown

        With Me.sprKyori.Sheets(0)
