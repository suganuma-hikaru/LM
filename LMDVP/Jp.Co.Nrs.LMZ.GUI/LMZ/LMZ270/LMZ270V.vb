...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMZ270F, ByVal v As LMZControlV)
...
#Region "Method"
    ...
    Private Function IsSingleCheck() As Boolean
        ...
        With Me._Frm
            ...
            If MyBase.IsValidateCheck(.cmbSub) = False Then
                Return False
            End If


            '用途区分
            .cmbSub.ItemName = "用途区分"
            .cmbSub.IsHissuCheck = True
            If MyBase.IsValidateCheck(.cmbSub) = False Then
                Return False
            End If
    ...
    Friend Function IsSpreadInputChk() As Boolean
        ...
        With Me._Frm
            ...
            '注意書
            vCell.SetValidateCell(0, LMZ270G.sprDetailDef.REMARK.ColNo)
            vCell.ItemName = "注意書"
