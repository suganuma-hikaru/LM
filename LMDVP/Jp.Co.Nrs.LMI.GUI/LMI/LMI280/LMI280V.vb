...
'  システム名       :  LM
'  サブシステム名   :  LMI     : 特定荷主機能
'  プログラムID     :  LMI280V : 最低荷役保証料・差額明細書印刷指示(日産物流)
'  作  成  者       :  中村好孝
' ==========================================================================
...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI280F, ByVal v As LMIControlV, ByVal g As LMIControlG)
...
#End Region
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsAuthorityChk(ByVal eventShubetsu As LMI280C.EventShubetsu) As Boolean
        ...
        Select Case eventShubetsu
            ...
            Case LMI280C.EventShubetsu.MASTEROPEN          'マスタ参照
            ...
            Case LMI280C.EventShubetsu.PRINT        '印刷
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMI280C.EventShubetsu.TOJIRU           '閉じる
                'すべての権限許可
                kengenFlg = True
...
#Region "フォーカス位置チェック"
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsFocusChk(ByVal objNm As String, ByVal actionType As LMI280C.EventShubetsu) As Boolean
        ...
        With Me._Frm
            ...
            If (ctl1 Is Nothing = True OrElse ctl1.ReadOnly = True) _
                ...
                Select Case actionType
                    ...
                    Case LMI280C.EventShubetsu.MASTEROPEN

                        Return Me.SetFocusErrMessage()

                    Case LMI280C.EventShubetsu.ENTER
