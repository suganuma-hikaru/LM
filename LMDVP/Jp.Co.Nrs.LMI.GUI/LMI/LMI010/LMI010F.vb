...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI010H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub cmbseqflg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmbCustNm.SelectedIndexChanged

        Me._Handler.ChangeCombo(Me, e)
