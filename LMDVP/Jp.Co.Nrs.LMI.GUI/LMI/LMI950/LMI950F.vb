...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI950H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMI950F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._H.LMI950F_KeyDown(Me, e)
    End Sub
