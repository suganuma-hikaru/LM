...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _H As LMI960H

    Public ProcessingBumon As String = LMI960C.CmbBumonItems.Soko
    Public WordsNyuShukka As String = LMI960C.WordsNyuShukka.ForSoko
    Public WordsShukkaTouroku As String = LMI960C.WordsShukkaTouroku.ForSoko
    Public WordsNyuShukkaTourokuZumi As String = LMI960C.JuchuStatusName.NyuShukkaTourokuZumi
...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI960H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMI960F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        Call Me._H.LMI960F_KeyDown(Me, e)
    ...
    ''' <param name="e"></param>
    Private Sub btnUnsoTouroku_Click(sender As Object, e As EventArgs) Handles btnUnsoTouroku.Click

        Call Me._H.btnUnsoTouroku_Click(Me)
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub btnIkkatsuChange_Click(sender As Object, e As EventArgs) Handles btnIkkatsuChange.Click

        Call Me._H.btnIkkatsuChange_Click(Me)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub cmbBumon_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbBumon.SelectedIndexChanged

        Call Me._H.cmbBumon_SelectedIndexChanged(Me)
    ...
    ''' <param name="sender">イベント発生オブジェクト</param>
    ''' <param name="e">イベント詳細情報</param>
    Private Sub cmbChangeItem_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbChangeItem.SelectedIndexChanged

        Call Me._H.cmbChangeItem_SelectedIndexChanged(Me)
    ...
    ''' <param name="sender">イベント発生オブジェクト</param>
    ''' <param name="e">イベント詳細情報</param>
    Private Sub cmbBashoKb_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbBashoKb.SelectedIndexChanged

        Call Me._H.cmbBashoKb_SelectedIndexChanged(Me)
