...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI430H)
...
#Region "Method"
    ...
    ''' <summary>
    ''' ファンクション4ボタン押下時およびファンクションキー4押下時のイベントです。
    ''' </summary>
    ''' <param name="sender">イベント発生オブジェクト</param>
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks>各イベントに対応するハンドラクラスのメソッドを呼び出してください。</remarks>
    ...
    ''' <summary>
    ''' Pauseボタン押下時およびPause押下時のイベントです。
    ''' </summary>
    ''' <param name="sender">イベント発生オブジェクト</param>
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks>各イベントに対応するハンドラクラスのメソッドを呼び出してください。</remarks>
    Private Sub PausePress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles FunctionKey.F10PressEvent

        Call Me._H.PausePress(Me, e)

    End Sub

    ''' <summary>
    ''' ファンクション11ボタン押下時およびファンクションキー11押下時のイベントです。
    ''' </summary>
    ''' <param name="sender">イベント発生オブジェクト</param>
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks>各イベントに対応するハンドラクラスのメソッドを呼び出してください。</remarks>
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMI430F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        Call Me._H.EnterKeyDown(Me, e)
