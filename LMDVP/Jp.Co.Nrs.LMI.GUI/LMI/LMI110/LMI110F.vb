...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI110H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMI110F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        If e.KeyCode.Equals(Keys.Enter) = False Then
            Exit Sub
        End If

        Call Me._Handler.LMI110FKeyDown(Me, e)
