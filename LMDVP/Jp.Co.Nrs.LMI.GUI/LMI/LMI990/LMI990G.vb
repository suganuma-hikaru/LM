...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI990F)
...
#Region "設定・制御"
    ...
    Friend Sub SetTabIndex()
        ...
        With Me._Frm
            ...
            .grpSakusei.TabIndex = LMI990C.CtlTabIndex.CMB_EIGYO
            .cmbEigyo.TabIndex = LMI990C.CtlTabIndex.CMB_EIGYO
            .txtFilePath.TabIndex = LMI990C.CtlTabIndex.TXT_FILE_PATH
            .imdSeikyuDate.TabIndex = LMI990C.CtlTabIndex.IMD_SEIKYU_DATE
    ...
    Friend Sub SetControl(ByVal data As String)
        ...
        With Me._Frm
            ...
            '取込ファイルパス
            .txtFilePath.TextValue = LMI990C.FILE_PATH

            '請求日
            Dim seikyuDate As Date = New Date(Date.Today.Year, Date.Today.Month, 1)
            seikyuDate = seikyuDate.AddDays(-1)
            .imdSeikyuDate.TextValue = seikyuDate.ToString("yyyyMMdd")
