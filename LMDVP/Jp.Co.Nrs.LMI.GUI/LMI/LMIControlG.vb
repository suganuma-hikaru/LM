...
'  システム名       :  LM
'  サブシステム名   :  LMI          : データ管理サブ
'  プログラムID     :  LMIControlG  : LMI画面 共通処理
'  作  成  者       :  [ito]
' ==========================================================================
...
#Region "コントロール"
    ...
    Friend Sub SetLockInputMan(ByVal ctl As Win.Interface.ILMEditableControl _
        ...
        Dim cleraData As LMIControlC.CLERA_DATA = LMIControlC.CLERA_DATA.ISNULL
        ...
        If lock = True AndAlso clearFlg = True Then
            ...
            Select Case cleraData
                ...
                Case LMIControlC.CLERA_DATA.IMTEXT

                    ctl.TextValue = String.Empty

                Case LMIControlC.CLERA_DATA.IMCOMB

                    cmb.SelectedValue = Nothing

                Case LMIControlC.CLERA_DATA.IMKBN_COMB

                    kbn.SelectedValue = Nothing

                Case LMIControlC.CLERA_DATA.IMNRS_COMB

                    nrs.SelectedValue = Nothing

                Case LMIControlC.CLERA_DATA.IMSOK_COMB

                    sok.SelectedValue = Nothing

                Case LMIControlC.CLERA_DATA.IMDATE

                    imd.Value = Nothing

                Case LMIControlC.CLERA_DATA.IMNUMBER
    ...
    Friend Sub SetDateFormat(ByVal ctl As LMImDate, Optional ByVal holidayFlg As Boolean = True)
        ...
        ctl.Format = DateFieldsBuilder.BuildFields(LMIControlC.DATE_YYYYMMDD)
        ctl.DisplayFormat = DateDisplayFieldsBuilder.BuildFields(LMIControlC.DATE_SLASH_YYYYMMDD)
