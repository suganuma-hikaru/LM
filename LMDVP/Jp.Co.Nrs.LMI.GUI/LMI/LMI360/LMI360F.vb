...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI360H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMI360F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    '''' <param name="e">イベント詳細情報</param>
    '''' <remarks>各イベントに対応するハンドラクラスのメソッドを呼び出してください。</remarks>
    'Private Sub btnJikko_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    '    Call Me._H.btnJikko_Click(Me)
