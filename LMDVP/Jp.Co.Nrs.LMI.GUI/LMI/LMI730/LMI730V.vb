...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI730F, ByVal v As LMFControlV, ByVal g As LMFControlG)
...
#Region "Method"
    ...
    Private Function IsSprChk() As Boolean
        ...
        Dim rtnResult As Boolean = Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                           , LMI730G.sprDetailDef.CUST_NM.ColNo _
                                                           , LMI730G.sprDetailDef.CUST_NM.ColName, 122)

        '伝票№
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.CUST_REF_NO.ColNo _
                                                          , LMI730G.sprDetailDef.CUST_REF_NO.ColName, 30)

        '請求先コード
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.SEIQTO_CD.ColNo _
                                                          , LMI730G.sprDetailDef.SEIQTO_CD.ColName, 7)

        '請求先名
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.SEIQTO_NM.ColNo _
                                                          , LMI730G.sprDetailDef.SEIQTO_NM.ColName, 60)

        '届先名
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.DEST_NM.ColNo _
                                                          , LMI730G.sprDetailDef.DEST_NM.ColName, 80)

        '運送会社(1次)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSO_NM.ColNo _
                                                          , LMI730G.sprDetailDef.UNSO_NM.ColName, 122)

        '運送会社(2次)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSOCO_NM.ColNo _
                                                          , LMI730G.sprDetailDef.UNSOCO_NM.ColName, 122)

        '在庫部課
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.ZBUKA_CD.ColNo _
                                                          , LMI730G.sprDetailDef.ZBUKA_CD.ColName, 7)

        '扱い部課
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.ABUKA_CD.ColNo _
                                                          , LMI730G.sprDetailDef.ABUKA_CD.ColName, 7)

        'まとめ
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.GROUP.ColNo _
                                                          , LMI730G.sprDetailDef.GROUP.ColName, 9)

        'まとめM
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.GROUP_M.ColNo _
                                                          , LMI730G.sprDetailDef.GROUP_M.ColName, 3)

        '運賃備考
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.REMARK.ColNo _
                                                          , LMI730G.sprDetailDef.REMARK.ColName, 100)

        '管理番号
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.KANRI_NO.ColNo _
                                                          , LMI730G.sprDetailDef.KANRI_NO.ColName, 9)

        '運送番号
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSO_NO.ColNo _
                                                          , LMI730G.sprDetailDef.UNSO_NO.ColName, 9)

        '運行番号
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.TRIP_NO.ColNo _
                                                          , LMI730G.sprDetailDef.TRIP_NO.ColName, 10)

        '集荷中継地
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.SHUKA_RELY_POINT.ColNo _
                                                          , LMI730G.sprDetailDef.SHUKA_RELY_POINT.ColName, 50)

        '配荷中継地
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.HAIKA_RELY_POINT.ColNo _
                                                          , LMI730G.sprDetailDef.HAIKA_RELY_POINT.ColName, 50)

        '運行番号(集荷)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.TRIP_NO_SHUKA.ColNo _
                                                          , LMI730G.sprDetailDef.TRIP_NO_SHUKA.ColName, 10)

        '運行番号(中継)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.TRIP_NO_CHUKEI.ColNo _
                                                          , LMI730G.sprDetailDef.TRIP_NO_CHUKEI.ColName, 10)

        '運行番号(配荷)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.TRIP_NO_HAIKA.ColNo _
                                                          , LMI730G.sprDetailDef.TRIP_NO_HAIKA.ColName, 10)

        '運送会社(集荷)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSOCO_SHUKA.ColNo _
                                                          , LMI730G.sprDetailDef.UNSOCO_SHUKA.ColName, 122)

        '運送会社(中継)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSOCO_CHUKEI.ColNo _
                                                          , LMI730G.sprDetailDef.UNSOCO_CHUKEI.ColName, 122)

        '運送会社(配荷)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSOCO_HAIKA.ColNo _
                                                          , LMI730G.sprDetailDef.UNSOCO_HAIKA.ColName, 122)

        '届先コード
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.DEST_CD.ColNo _
                                                          , LMI730G.sprDetailDef.DEST_CD.ColName, 15)

        '届先JIS
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.DEST_JIS_CD.ColNo _
                                                          , LMI730G.sprDetailDef.DEST_JIS_CD.ColName, 7)

        '運送会社コード(1次)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSO_CD.ColNo _
                                                          , LMI730G.sprDetailDef.UNSO_CD.ColName, 5)

        '運送会社支店コード(1次)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSO_BR_CD.ColNo _
                                                          , LMI730G.sprDetailDef.UNSO_BR_CD.ColName, 3)

        '運送会社コード(2次)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSOCO_CD.ColNo _
                                                          , LMI730G.sprDetailDef.UNSOCO_CD.ColName, 5)

        '運送会社支店コード(1次)
        rtnResult = rtnResult AndAlso Me._Vcon.IsKinsiByteChk(vCell, 0 _
                                                          , LMI730G.sprDetailDef.UNSOCO_BR_CD.ColNo _
                                                          , LMI730G.sprDetailDef.UNSOCO_BR_CD.ColName, 3)
    ...
    Friend Function IsSaveChk(ByVal arr As ArrayList) As Boolean
        ...
        'スペース除去
        Call Me.TrimHeaderSpaceTextValue(LMI730C.ActionType.SAVE)
        ...
        '選択上限チェック
        rtnResult = rtnResult AndAlso Me._Vcon.IsSelectLimitChk(cnt, LMI730C.IKKATU_LMI730)
    ...
    Private Function IsSaveInputCheck() As Boolean
        ...
        With Me._Frm
            ...
            '変更コード(大)
            .txtShuseiL.ItemName = String.Concat(LMI730C.HENKO, LMFControlC.CD, LMFControlC.L_NM)
            ...
            '変更コード(中)
            .txtShuseiM.ItemName = String.Concat(LMI730C.HENKO, LMFControlC.CD, LMFControlC.M_NM)
            .txtShuseiM.IsHissuCheck = LMI730C.SHUSEI_CUST.Equals(henko)
            ...
            '変更コード(小)
            .txtShuseiS.ItemName = String.Concat(LMI730C.HENKO, LMFControlC.CD, LMFControlC.S_NM)
            .txtShuseiS.IsHissuCheck = LMI730C.SHUSEI_CUST.Equals(henko)
            ...
            '変更コード(極小)
            .txtShuseiSS.ItemName = String.Concat(LMI730C.HENKO, LMFControlC.CD, LMFControlC.SS_NM)
            .txtShuseiSS.IsHissuCheck = LMI730C.SHUSEI_CUST.Equals(henko)
    ...
    Private Function IsGroupByChk(ByVal arr As ArrayList, ByVal max As Integer) As Boolean
        ...
        With Me._Frm.sprDetail.ActiveSheet
            ...
            If (LMI730C.ORDER_BY_CUSTTRIP).Equals(ORDERBY) = True OrElse _
                (LMI730C.ORDER_BY_DEST).Equals(ORDERBY) = True OrElse _
                (LMI730C.ORDER_BY_DESTJIS).Equals(ORDERBY) = True Then
                '出荷日の必須チェック
                Dim chkDate As String = Me.GetUnsoDate(rowNo)
                Dim chk As Boolean = Me._Vcon.IsDotiHissuChk(chkDate, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.SHUKKA.ColName))

                '請求先の必須チェック
                Dim seiq As String = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.SEIQTO_CD.ColNo))
                chk = chk AndAlso Me._Vcon.IsDotiHissuChk(seiq, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.SEIQTO_CD.ColName))

                'タリフの必須チェック
                Dim tariff As String = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TARIFF_CD.ColNo))
                chk = chk AndAlso Me._Vcon.IsDotiHissuChk(tariff, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.TARIFF_CD.ColName))

                '税区分の必須チェック
                Dim tax As String = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.ZEI.ColNo))
                chk = chk AndAlso Me._Vcon.IsDotiHissuChk(tariff, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.ZEI_KBN.ColName))
                ...
                Select Case orderBy
                    ...
                    Case LMI730C.ORDER_BY_CUSTTRIP

                        '荷主(大)コードの必須チェック
                        item1 = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.CUST_CD_L.ColNo))
                        chk = chk AndAlso Me._Vcon.IsDotiHissuChk(item1, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.CUST_CD.ColName))

                        '荷主(中)コードの必須チェック
                        item2 = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.CUST_CD_M.ColNo))
                        chk = chk AndAlso Me._Vcon.IsDotiHissuChk(item2, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.CUST_CD.ColName))

                        '運行番号の必須チェック
                        item3 = Me.GetTripNo(rowNo)

                        '運行番号の必須チェック
                        chk = chk AndAlso Me._Vcon.IsDotiHissuChk(item3, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.TRIP_NO.ColName))

                    Case LMI730C.ORDER_BY_DEST

                        '届先コードの必須チェック
                        item1 = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.DEST_CD.ColNo))
                        chk = chk AndAlso Me._Vcon.IsDotiHissuChk(item1, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.DEST_CD.ColName))

                    Case LMI730C.ORDER_BY_DESTJIS

                        '届先JISの必須チェック
                        item1 = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.DEST_JIS_CD.ColNo))
                        chk = chk AndAlso Me._Vcon.IsDotiHissuChk(item1, Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.DEST_JIS_CD.ColName))
                ...
                '割増タリフコードは空でもよい
                Dim extc As String = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.EXTC_TARIFF_CD.ColNo))

                'タリフ分類
                Dim tariffKbn As String = Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TARIFF_KBN.ColNo))

                Dim groupFlg As Boolean = True
                Dim tyukeiFlg As Boolean = LMFControlC.FLG_ON.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TYUKEI_HAISO_FLG.ColNo)))
                ...
                For i As Integer = 1 To max
                    ...
                    '請求先が違う場合、エラー
                    If seiq.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.SEIQTO_CD.ColNo))) = False Then
                        Return Me.SetErrMessageE239()
                    End If

                    'タリフが違う場合、エラー
                    If tariff.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TARIFF_CD.ColNo))) = False Then
                        Return Me.SetErrMessageE239()
                    End If

                    '税区分が違う場合、エラー
                    If tax.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.ZEI.ColNo))) = False Then
                        Return Me.SetErrMessageE239()
                    End If

                    '割増タリフコードが違う場合、エラー
                    If extc.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.EXTC_TARIFF_CD.ColNo))) = False Then
                        Return Me.SetErrMessageE239()
                    End If
                    ...
                    If Me.IsOrderByChk(rowNo, orderBy, item1, item2, item3) = False Then
                        ...
                        '荷主 / 運行以外は即エラー
                        If LMI730C.ORDER_BY_CUSTTRIP.Equals(orderBy) = False Then
                            Return Me.SetErrMessageE239()
                        End If
                    ...
                    '中継配送無のレコードがあるかを判定
                    tyukeiFlg = tyukeiFlg AndAlso LMFControlC.FLG_ON.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TYUKEI_HAISO_FLG.ColNo)))
            ...
            ElseIf (LMI730C.ORDER_BY_DIC).Equals(orderBy) = True Then
    ...
    Private Function GetUnsoDate(ByVal rowNo As Integer) As String
        ...
        With Me._Frm.sprDetail.ActiveSheet
            ...
            '締め日基準が入荷の場合
            If LMFControlC.CALC_NYUKA.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.UNTIN_CALCULATION_KB.ColNo))) = True Then

                GetUnsoDate = DateFormatUtility.DeleteSlash(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.NONYU.ColNo)))

            Else

                GetUnsoDate = DateFormatUtility.DeleteSlash(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.SHUKKA.ColNo)))
    ...
    Private Function GetTripNo(ByVal rowNo As Integer) As String()
        ...
        With Me._Frm.sprDetail.ActiveSheet
            ...
            '中継配送有の場合、運行番号(配荷)
            If LMFControlC.FLG_ON.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TYUKEI_HAISO_FLG.ColNo))) = True Then
                Return New String() {Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TRIP_NO_SHUKA.ColNo)) _
                                     , Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TRIP_NO_CHUKEI.ColNo)) _
                                     , Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TRIP_NO_HAIKA.ColNo)) _
                                     }
            End If

            Return New String() {Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.TRIP_NO.ColNo))}
        ...
        With Me._Frm.sprDetail.ActiveSheet
            ...
            Select Case orderBy
                ...
                Case LMI730C.ORDER_BY_CUSTTRIP
                    ...
                    '荷主(大)コードが違う場合、エラー
                    If item1.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.CUST_CD_L.ColNo))) = False Then
                        Return False
                    End If

                    '荷主(中)コードが違う場合、エラー
                    If item2.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.CUST_CD_M.ColNo))) = False Then
                        Return Me.SetErrMessageE239()
                    End If
                ...
                Case LMI730C.ORDER_BY_DEST
                    ...
                    '届先コードが違う場合、エラー
                    If item1.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.DEST_CD.ColNo))) = False Then
                        Return False
                    End If
                ...
                Case LMI730C.ORDER_BY_DESTJIS
                    ...
                    '届先JISが違う場合、エラー
                    If item1.Equals(Me._Gcon.GetCellValue(.Cells(rowNo, LMI730G.sprDetailDef.DEST_JIS_CD.ColNo))) = False Then
                        Return False
                    End If
    ...
    Private Function IsTripDotiChk(ByVal arr As ArrayList, ByVal max As Integer, ByVal value As String()) As Boolean
        ...
        '集荷番号でチェック
        If Me.IsTripDotiChk(arr, max, value(1), LMI730G.sprDetailDef.TRIP_NO_SHUKA.ColNo) = True Then
            Return True
        End If

        '中継番号でチェック
        Return Me.IsTripDotiChk(arr, max, value(2), LMI730G.sprDetailDef.TRIP_NO_CHUKEI.ColNo)
    ...
    Private Function IsGroupTariffKbn(ByVal tariffKbn As String, ByVal rowNo As Integer) As Boolean
        ...
        Dim chkData As String = Me._Gcon.GetCellValue(Me._Frm.sprDetail.ActiveSheet.Cells(rowNo, LMI730G.sprDetailDef.TARIFF_KBN.ColNo))
        ...
        With Me._Frm.sprDetail.ActiveSheet
            ...
            Select Case Me._Frm.cmbShusei.SelectedValue.ToString()
                ...
                Case LMI730C.SHUSEI_SEIQTO
                    ...
                    Dim seiqto As String = Me._Gcon.GetCellValue(.Cells(Convert.ToInt32(arr(0)), LMI730G.sprDetailDef.SEIQTO_CD.ColNo))
                    For i As Integer = 1 To max

                        If seiqto.Equals(Me._Gcon.GetCellValue(.Cells(Convert.ToInt32(arr(i)), LMI730G.sprDetailDef.SEIQTO_CD.ColNo))) = False Then
                            Return Me._Vcon.SetErrMessage("E227", New String() {Me._Vcon.SetRepMsgData(LMI730G.sprDetailDef.SEIQTO_CD.ColName)})
                        End If
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsFocusChk(ByVal objNm As String, ByVal actionType As LMI730C.ActionType) As Boolean

        'フォーカス位置がない場合、スルー
        If String.IsNullOrEmpty(objNm) = True Then
            'ポップ対象外の場合
            'マスタ参照の場合、エラーメッセージ設定
            If actionType.Equals(LMI730C.ActionType.MASTEROPEN) = True Then
        ...
        With Me._Frm
            ...
            Select Case objNm
                ...
                Case .txtShuseiL.Name
                    ...
                    txtCtl = Me.FocusCtl()
                    msg = New String() {String.Concat(LMI730C.HENKO, LMFControlC.L_NM) _
                                        , String.Concat(LMI730C.HENKO, LMFControlC.M_NM) _
                                        , String.Concat(LMI730C.HENKO, LMFControlC.S_NM) _
                                        , String.Concat(LMI730C.HENKO, LMFControlC.SS_NM) _
                                        }
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsAuthority(ByVal actionType As LMI730C.ActionType) As Boolean
        ...
        Select Case actionType
            ...
            Case LMI730C.ActionType.LOOPEDIT
            ...
            Case LMI730C.ActionType.KENSAKU
            ...
            Case LMI730C.ActionType.MASTEROPEN
            ...
            Case LMI730C.ActionType.DOUBLECLICK
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsBkChk(ByVal arr As ArrayList) As Boolean

        'スペース除去
        Call Me.TrimHeaderSpaceTextValue(LMI730C.ActionType.BACKUP)
    ...
    Private Sub TrimSpaceTextValue()
        ...
        'ヘッダ項目のスペース除去
        Call Me.TrimHeaderSpaceTextValue(LMI730C.ActionType.KENSAKU)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub TrimHeaderSpaceTextValue(ByVal actionType As LMI730C.ActionType)
