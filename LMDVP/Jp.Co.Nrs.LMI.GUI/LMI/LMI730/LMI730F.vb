...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI730H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMI730F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._H.LMI730F_KeyDown(Me, e)
    End Sub
