...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI470H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub LMI470F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Select Case controlNm
                ...
                Case "txtSeikyuCd" '請求先コード
                    ...
                    Else
                        Me.txtSeikyuCd.TextValue = String.Empty
                    End If
