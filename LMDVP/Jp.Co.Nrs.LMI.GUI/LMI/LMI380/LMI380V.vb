...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI380F, ByVal v As LMIControlV, ByVal g As LMI380G)
...
#Region "Method"
    ...
    Friend Function IsSingleCheck(ByVal eventShubetsu As LMI380C.EventShubetsu) As Boolean

        '【単項目チェック】
        With Me._Frm

            If .optOneNrsBr.Checked = True Then

                If LMI380C.EventShubetsu.JIKKO.Equals(eventShubetsu) = True Then
                    '営業所
                ...
                If .optOneCust.Checked = True Then
                    ...
                    If LMI380C.EventShubetsu.MASTER.Equals(eventShubetsu) = True Then
                        .txtCustCdL.ItemName() = "荷主コード(大)"
                        .txtCustCdL.IsForbiddenWordsCheck() = True
                        If MyBase.IsValidateCheck(.txtCustCdL) = False Then
                            Return False
            ...
            If .optOutkaPlanJisseki.Checked = True Then
    ...
    ''' </returns>
    ''' <remarks>チェックを行うプロパティをTrueに設定し、チェック用メソッドを呼び出します。</remarks>
    Friend Function IsKanrenCheck(ByVal eventShubetsu As LMI380C.EventShubetsu) As Boolean
            ...
            If .optOutkaPlanJisseki.Checked = True Then
                ...
                If String.IsNullOrEmpty(.imdOutkaDateFrom.TextValue) = False AndAlso String.IsNullOrEmpty(.imdOutkaDateTo.TextValue) = False Then
                    If Convert.ToInt32(.imdOutkaDateTo.TextValue) < Convert.ToInt32(.imdOutkaDateFrom.TextValue) Then
                        'FromよりToが過去日の場合エラー
                        Me.ShowMessage("E039", New String() {String.Concat(.lblTitleOutkaDate.Name, "To"), String.Concat(.lblTitleOutkaDate.Name, "From")})
    ...
    ''' <remarks></remarks>
    Friend Function IsAuthorityChk(ByVal eventShubetsu As LMI380C.EventShubetsu) As Boolean
        ...
        Select Case eventShubetsu
            ...
            Case LMI380C.EventShubetsu.CLOSE        '閉じる
                'すべての権限許可
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = True
