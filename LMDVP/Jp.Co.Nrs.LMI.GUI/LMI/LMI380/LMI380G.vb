...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI380F)
...
#Region "設定・制御"
    ...
    Friend Sub SetTabIndex()
        ...
        With Me._Frm
            ...
            .grpOutputTani.TabIndex = LMI380C.CtlTabIndex.GRPOUTPUTTANI
            .optOneNrsBr.TabIndex = LMI380C.CtlTabIndex.ONEEIGYO
            .optOneCust.TabIndex = LMI380C.CtlTabIndex.ONECUST
            .cmbEigyo.TabIndex = LMI380C.CtlTabIndex.CMBEIGYO
            .txtCustCdL.TabIndex = LMI380C.CtlTabIndex.TXTCUSTCDL
            .txtCustCdM.TabIndex = LMI380C.CtlTabIndex.TXTCUSTCDM
            .grpOutputTaisyo.TabIndex = LMI380C.CtlTabIndex.GRPOUTPUTTAISYO
            .optAllJisseki.TabIndex = LMI380C.CtlTabIndex.ALLJISSEKI
            .optOutkaPlanJisseki.TabIndex = LMI380C.CtlTabIndex.OUTKAPLANJISSEKI
            .imdOutkaDateFrom.TabIndex = LMI380C.CtlTabIndex.OUTKAPLANDATEFROM
            .imdOutkaDateTo.TabIndex = LMI380C.CtlTabIndex.OUTKAPLANDATETO
            .grpJikko.TabIndex = LMI380C.CtlTabIndex.GRPJIKKO
            .cmbJikko.TabIndex = LMI380C.CtlTabIndex.CMBJIKKO
            .btnJikko.TabIndex = LMI380C.CtlTabIndex.BTNJIKKO
    ...
    Friend Sub SetControl(ByVal sysDate As String)
        ...
        With Me._Frm
            ...
            Select Case Convert.ToString(.cmbEigyo.SelectedValue)
                ...
                Case LMI380C.NRS_GNM
                    .txtCustCdL.TextValue = LMI380C.DEF_CUST_CD_L_GNM
                    .txtCustCdM.TextValue = LMI380C.DEF_CUST_CD_M_GNM

                Case LMI380C.NRS_CBA
                    .txtCustCdL.TextValue = LMI380C.DEF_CUST_CD_L_CBA
                    .txtCustCdM.TextValue = LMI380C.DEF_CUST_CD_M_CBA
    ...
    Friend Sub SetControlsStatus()
        ...
        Me._Frm.imdOutkaDateFrom.Enabled = False
        Me._Frm.imdOutkaDateTo.Enabled = False

        If Me._Frm.optOneNrsBr.Checked = True Then

            Me._Frm.cmbEigyo.Enabled = True
            Me._Frm.txtCustCdL.Enabled = False
            Me._Frm.txtCustCdM.Enabled = False

        ElseIf Me._Frm.optOneCust.Checked = True Then

            Me._Frm.cmbEigyo.Enabled = True
            Me._Frm.txtCustCdL.Enabled = True
            Me._Frm.txtCustCdM.Enabled = True

        End If

        If Me._Frm.optOutkaPlanJisseki.Checked = True Then
