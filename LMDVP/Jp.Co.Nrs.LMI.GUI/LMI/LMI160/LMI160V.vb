...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI160F, ByVal v As LMIControlV, ByVal g As LMIControlG)
...
#Region "入力チェック"
    ...
    Private Function IsPrintCheck(ByVal Print As String) As Boolean
        ...
        With Me._Frm
            ...
            '日付From
            .imdNonyuDateFrom.ItemName = "納入日From"
            .imdNonyuDateFrom.IsHissuCheck = True
            If MyBase.IsValidateCheck(.imdNonyuDateFrom) = False Then
                Return False
            End If
            'フルバイトチェック
            If Me.IsInputDateFullByteChk(.imdNonyuDateFrom, .imdNonyuDateFrom.ItemName) = errorFlg Then
                Return errorFlg
            End If

            '日付To
            .imdNonyuDateTo.ItemName = "納入日To"
            .imdNonyuDateTo.IsHissuCheck = True
            If MyBase.IsValidateCheck(.imdNonyuDateTo) = False Then
                Return False
            End If

            'フルバイトチェック
            If Me.IsInputDateFullByteChk(.imdNonyuDateTo, .imdNonyuDateTo.ItemName) = errorFlg Then
                Return errorFlg
            End If
    ...
    Private Function IsPrintDateChk() As Boolean
        ...
        With Me._Frm
            ...
            '日付の大小チェック
            Dim dateFrom As String = .imdNonyuDateFrom.TextValue
            Dim dateTo As String = .imdNonyuDateTo.TextValue
...
#End Region
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsAuthorityChk(ByVal eventShubetsu As LMI160C.EventShubetsu) As Boolean
        ...
        Select Case eventShubetsu
            ...
            Case LMI160C.EventShubetsu.MASTEROPEN          'マスタ参照
            ...
            Case LMI160C.EventShubetsu.PRINT        '印刷
                '10:閲覧者、20:入力者（一般）、25:入力者（上級）、50:外部の場合エラー
                Select Case kengen
                    Case LMConst.AuthoKBN.VIEW      '10:閲覧者
                        kengenFlg = False
            ...
            Case LMI160C.EventShubetsu.TOJIRU           '閉じる
                'すべての権限許可
                kengenFlg = True
...
#Region "フォーカス位置チェック"
    ...
    ''' <returns>True:エラーなし,OK False:エラーあり</returns>
    ''' <remarks></remarks>
    Friend Function IsFocusChk(ByVal objNm As String, ByVal actionType As LMI160C.EventShubetsu) As Boolean
        ...
        With Me._Frm
            ...
            If (ctl1 Is Nothing = True OrElse ctl1.ReadOnly = True) _
                ...
                Select Case actionType
                    ...
                    Case LMI160C.EventShubetsu.MASTEROPEN

                        Return Me.SetFocusErrMessage()

                    Case LMI160C.EventShubetsu.ENTER
