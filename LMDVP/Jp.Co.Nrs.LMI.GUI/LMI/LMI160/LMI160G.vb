...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LMI160F)
...
#Region "設定・制御"
    ...
    Friend Sub SetTabIndex()
        ...
        With Me._Frm
            ...
            .cmbPrint.TabIndex = LMI160C.CtlTabIndex.Print
            .cmbBr.TabIndex = LMI160C.CtlTabIndex.Br
            .txtCustCdL.TabIndex = LMI160C.CtlTabIndex.CustCdL
            .lblCustNmL.TabIndex = LMI160C.CtlTabIndex.CustNmL
            .txtCustCdM.TabIndex = LMI160C.CtlTabIndex.CustCdM
            .lblCustNmM.TabIndex = LMI160C.CtlTabIndex.CustNmM
            .optNotKakutei.TabIndex = LMI160C.CtlTabIndex.optNotKakutei
            .optKakuteiZumi.TabIndex = LMI160C.CtlTabIndex.optKakuteiZumi
            .optAll.TabIndex = LMI160C.CtlTabIndex.optAll
            .imdNonyuDateFrom.TabIndex = LMI160C.CtlTabIndex.NonyuDateFrom
            .imdNonyuDateTo.TabIndex = LMI160C.CtlTabIndex.NonyuDateTo
...
#Region "コントロールの初期設定"
    ...
    Private Sub ClearControl()
        ...
        With Me._Frm
            ...
            .imdNonyuDateFrom.TextValue = String.Empty
            .imdNonyuDateTo.TextValue = String.Empty
    ...
    Friend Sub SetInput(ByVal data As String)
        With Me._Frm
            ...
            .imdNonyuDateFrom.TextValue = nowDate

            '当月の最終日取得
            .imdNonyuDateTo.TextValue = nextDate.AddMonths(1).AddDays(-1).ToString("yyyyMMdd")
        End With
