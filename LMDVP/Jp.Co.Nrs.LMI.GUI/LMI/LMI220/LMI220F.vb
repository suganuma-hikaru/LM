...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMI220H)
...
#End Region 'Method
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMI220F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._Handler.LMI220F_KeyDown(Me, e)
    End Sub
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub imdLastTestDate_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles imdLastTestDate.Leave
        Call Me._Handler.imdLastTestDate_Leave(Me, e)
    End Sub
