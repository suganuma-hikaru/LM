...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMF570DAC = New LMF570DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMF570IN"
        Dim tableNmOut As String = "LMF570OUT"
        ...
        'ソート実行
        Dim outDr As DataRow() = dtOut.Select(Nothing, "CUST_CD_L ASC, CUST_CD_M ASC, OUTKA_PLAN_DATE ASC, UNSO_CD ASC, UNSO_BR_CD ASC, DEST_AD ASC")
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する。
            'prtDs = comPrt.CallDataSet(ds.Tables("LMF570OUT"), dr.Item("RPT_ID").ToString())
