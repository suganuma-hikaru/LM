...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMF710DAC = New LMF710DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '定数
        Const TBL_NM_IN As String = "LMF710IN"
        Const TBL_NM_OUT As String = "LMF710OUT"
