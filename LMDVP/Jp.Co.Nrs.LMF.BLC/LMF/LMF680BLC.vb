...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMF680DAC = New LMF680DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMF680IN"
        Dim tableNmOut As String = "LMF680OUT"
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables("LMF680OUT"), dr.Item("RPT_ID").ToString())
