...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMF630DAC = New LMF630DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMF630IN"
        Dim tableNmOut As String = "LMF630OUT"
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables("LMF630OUT"), dr.Item("RPT_ID").ToString())
