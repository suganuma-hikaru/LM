...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMF610DAC = New LMF610DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMF610IN"
        Dim tableNmOut As String = "LMF610OUT"
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables("LMF610OUT"), dr.Item("RPT_ID").ToString())
            '帳票ごとの編集があるなら行う。
    ...
    Private Function EditPrintDataSet(ByVal prtId As String, ByVal ds As DataSet) As DataSet
        ...
        '20120901 checkList no matome
        ' 
        ' ''(2012.08.28) 要望番号1373 支払グループまとめ処理 --- START ----
        ' ''支払グループのまとめ編集
        ''Dim outDt As DataTable = ds.Tables("LMF610OUT")  'データ取得
        ...
        ''    '項目追加するたびにもれるのでやり方修正
        ''    ds.Tables("LMF610OUT").ImportRow(cloneRow)

        ''    'Dim wkNewRow As DataRow = ds.Tables("LMF610OUT").NewRow
        ...
        ''    'wkNewRow("SHIHARAI_TARIFF_REM") = cloneRow("SHIHARAI_TARIFF_REM")
        ...
        ''    'wkNewRow("AD_1_a") = cloneRow("AD_1_a")
        ...
        ''    'wkNewRow("SHIHARAI_GROUP_NO_M") = cloneRow("SHIHARAI_GROUP_NO_M")
        ''    'wkNewRow("UNSO_NO_M") = cloneRow("UNSO_NO_M")
        ''    'wkNewRow("MOTO_DATA_NM") = cloneRow("MOTO_DATA_NM")
        ...
        ''    'ds.Tables("LMF610OUT").Rows.Add(wkNewRow)
        ''Next
