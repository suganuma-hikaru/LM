...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMF560DAC = New LMF560DAC()
...
#Region "印刷"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMF560IN"
        Dim tableNmOut As String = "LMF560OUT"
        ...
        'ソート実行
        Dim outDr As DataRow() = dtOut.Select(Nothing, "CUST_CD_L ASC, CUST_CD_M ASC, ARR_PLAN_DATE ASC, UNSO_CD ASC,UNSO_BR_CD ASC, DEST_NM ASC")
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            '指定したレポートIDのデータを抽出する。
            'prtDs = comPrt.CallDataSet(ds.Tables("LMF560OUT"), dr.Item("RPT_ID").ToString())
