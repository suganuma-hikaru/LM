...
#Region "Constructor"
    ...
    Friend Sub New(ByRef handlerClass As LMBaseGUIHandler, ByRef frm As LME050F)
        ...
        'Validateクラスの設定
        Me._V = New LME050V(handlerClass, frm, Me._LMEconV)
...
#Region "設定・制御"
    ...
    Friend Sub SetTabIndex()
        ...
        With Me._Frm
            ...
            .frmAmount.TabIndex = LME050C.CtlTabIndex.FRMAMOUNT
            .frmCnt.TabIndex = LME050C.CtlTabIndex.FRMCNT
            .sprZaiko.TabIndex = LME050C.CtlTabIndex.SPRZAIKO
            .txtSerialNO.TabIndex = LME050C.CtlTabIndex.TXTSERIALNO
            .txtRsvNO.TabIndex = LME050C.CtlTabIndex.TXTRSVNO
            .txtLotNO.TabIndex = LME050C.CtlTabIndex.TXTLOTNO
            .numIrime.TabIndex = LME050C.CtlTabIndex.NUMIRIME
            .numSyukkaKosu.TabIndex = LME050C.CtlTabIndex.NUMSYUKKAKOSU
            .numSyukkaHasu.TabIndex = LME050C.CtlTabIndex.NUMSYUKKAHASU
            .numSyukkaSouAmt.TabIndex = LME050C.CtlTabIndex.NUMSYUKKASOUAMT
...
#Region "検索結果表示"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Friend Sub SetInitForm(ByVal frm As LME050F, ByVal prmDs As DataSet)

        Dim custNm As String = String.Empty
        Dim strSqlCust As String = String.Empty

        With prmDs.Tables(LME050C.TABLE_NM_IN)
            ...
            frm.lblCustNM_M.TextValue = .Rows(0)("CUST_NM_L").ToString()
            ...
            '個数の計算をする
            Dim calsumFlg As Boolean = Me.SetCalSum(LME050C.EventShubetsu.SYOKI)
...
#Region "Spread"
    ...
    Public Class sprZaiko
        ...
        'スプレッド(タイトル列)の設定
        Public Shared DEF As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.DEF, " ", 20, True)
        Public Shared LOT_NO As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.LOT_NO, "ロット№", 70, True)
        Public Shared IRIME As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.IRIME, "入目", 70, True)
        Public Shared TOU_NO As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.TOU_NO, "棟", 25, True)
        Public Shared SHITSU_NO As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.SHITSU_NO, "室", 25, True)
        Public Shared ZONE_CD As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.ZONE_CD, "ZONE", 55, True)
        Public Shared LOCA As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.LOCA, "ロケーション", 100, True)
        Public Shared HIKI_CNT As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.HIKI_CNT, "引当個数", 100, True)
        Public Shared HIKI_AMT As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.HIKI_AMT, "引当数量", 100, True)
        Public Shared HIKI_KANO_CNT As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.HIKI_KANO_CNT, "引当可能個数", 100, True)
        Public Shared ZAIKOHIKI_KANO_CNTHASU As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.HIKI_KANO_UT, " ", 40, True)
        Public Shared HIKI_KANO_AMT As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.HIKI_KANO_AMT, "引当可能数量", 100, True)
        Public Shared NAKAMI As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.NAKAMI, "状態 中身", 80, True)
        Public Shared GAIKAN As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.GAIKAN, "状態 外装", 80, True)
        Public Shared CUST_STATUS As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.CUST_STATUS, "状態 荷主", 80, True)
        Public Shared REMARK As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.REMARK, "備考小" & vbCrLf & "（社内）", 70, True)
        Public Shared INKO_DATE As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.INKO_DATE, "入荷日", 80, True)
        Public Shared OFB_KBN As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.OFB_KBN, "簿外品", 65, True)
        Public Shared SPD_KBN_S As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.SPD_KBN_S, "保留品", 65, True)
        Public Shared YOYAKU_NO As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.YOYAKU_NO, "予約番号", 80, False)
        Public Shared SERIAL_NO As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.SERIAL_NO, "シリアル№", 80, True)
        Public Shared GOODS_CRT_DATE As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.GOODS_CRT_DATE, "製造日", 80, True)
        Public Shared ALLOC_PRIORITY As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.ALLOC_PRIORITY, "割当優先", 80, True)
        Public Shared REMARK_OUT As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.REMARK_OUT, "備考小" & vbCrLf & "（社外）", 80, True)
        Public Shared LT_DATE As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.LT_DATE, "賞味有効期限", 80, True)
        Public Shared DEST_NM As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.DEST_NM, "届先名", 300, True)
        Public Shared PORA_ZAI_NB As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.PORA_ZAI_NB, "実予在庫個数", 120, True)
        Public Shared TAX_KB As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.TAX_KB, "課税区分", 70, True)                                    '課税区分
        Public Shared HIKIATE_ALERT_NM As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.HIKIATE_ALERT_NM, "引当注意品", 80, True)
        Public Shared ZAI_REC_NO As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.ZAI_REC_NO, "在庫" & vbCrLf & "レコード番号", 120, True)

        'invisible
        Public Shared NRS_BR_CD As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.NRS_BR_CD, "営業所コード", 1, False)
        Public Shared WH_CD As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.WH_CD, "倉庫コード", 1, False)
        Public Shared OUTKA_PLAN_DATE As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.OUTKA_PLAN_DATE, "出庫日", 1, False)
        Public Shared SMPL_FLG As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.SMPL_FLG, "小分けフラグ", 1, False)
        Public Shared GOODS_CD_NRS_FROM As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.GOODS_CD_NRS_FROM, "振替元商品キー", 1, False)
        Public Shared INKO_DATE_ZAI As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.INKO_DATE_ZAI, "入庫日", 1, False)
        Public Shared INKA_DATE_KANRI_KB As SpreadColProperty = New SpreadColProperty(LME050C.SprZaikoColumnIndex.INKA_DATE_KANRI_KB, "入庫日管理区分", 1, False)
    ...
    Friend Sub InitSpread()
        ...
        With Me._Frm
            ...
            '列数設定
            .sprZaiko.Sheets(0).ColumnCount = LME050C.SprZaikoColumnIndex.LAST

            '2015.10.15 英語化対応START
            'スプレッドの列設定（列名、列幅、列の表示・非表示）
            '.sprZaiko.SetColProperty(New LME050G.sprZaiko())
            .sprZaiko.SetColProperty(New LME050G.sprZaiko(), False)
            '2015.10.15 英語化対応END

            '列固定位置を設定します。(ロケーションで固定)
            .sprZaiko.Sheets(0).FrozenColumnCount = LME050G.sprZaiko.LOCA.ColNo + 1

            '列設定
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.LOT_NO.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX_IME_OFF, 40, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.IRIME.ColNo, LMSpreadUtility.GetNumberCell(.sprZaiko, 0, 999999999, True, 3))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.TOU_NO.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.HAN_NUM_ALPHA, 2, False))              '棟
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.SHITSU_NO.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.HAN_NUM_ALPHA, 2, False))           '室
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.ZONE_CD.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.HAN_NUM_ALPHA, 2, False))             'ゾーン
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.LOCA.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX_IME_OFF, 10, False))               'ロケーション
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.HIKI_CNT.ColNo, LMSpreadUtility.GetNumberCell(.sprZaiko, 0, 9999999999, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.HIKI_AMT.ColNo, LMSpreadUtility.GetNumberCell(.sprZaiko, 0, 999999999999, True, 3))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.HIKI_KANO_CNT.ColNo, LMSpreadUtility.GetNumberCell(.sprZaiko, 0, 9999999999, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.ZAIKOHIKI_KANO_CNTHASU.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX_IME_OFF, 31, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.HIKI_KANO_AMT.ColNo, LMSpreadUtility.GetNumberCell(.sprZaiko, 0, 999999999999, True, 3))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.NAKAMI.ColNo, LMSpreadUtility.GetComboCellKbn(.sprZaiko, LMKbnConst.KBN_S005, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.GAIKAN.ColNo, LMSpreadUtility.GetComboCellKbn(.sprZaiko, LMKbnConst.KBN_S006, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.CUST_STATUS.ColNo, Me.SetComboJyotai())
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.REMARK.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 100, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.INKO_DATE.ColNo, LMSpreadUtility.GetDateTimeCell(.sprZaiko, True))                                         '入庫日
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.OFB_KBN.ColNo, LMSpreadUtility.GetComboCellKbn(.sprZaiko, LMKbnConst.KBN_B002, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.SPD_KBN_S.ColNo, LMSpreadUtility.GetComboCellKbn(.sprZaiko, LMKbnConst.KBN_H003, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.YOYAKU_NO.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX_IME_OFF, 10, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.SERIAL_NO.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX_IME_OFF, 40, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.GOODS_CRT_DATE.ColNo, LMSpreadUtility.GetDateTimeCell(.sprZaiko, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.ALLOC_PRIORITY.ColNo, LMSpreadUtility.GetLabelCell(.sprZaiko, CellHorizontalAlignment.Left))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.REMARK_OUT.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 15, False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.LT_DATE.ColNo, LMSpreadUtility.GetDateTimeCell(.sprZaiko, True))                                   '賞味有効期限
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.DEST_NM.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX_IME_OFF, 80, False))    '届先名
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.PORA_ZAI_NB.ColNo, LMSpreadUtility.GetNumberCell(.sprZaiko, 0, 9999999999, True))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.TAX_KB.ColNo, LMSpreadUtility.GetComboCellKbn(.sprZaiko, "Z001", False))                           '課税区分
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.HIKIATE_ALERT_NM.ColNo, LMSpreadUtility.GetComboCellKbn(.sprZaiko, "U009", False))
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.ZAI_REC_NO.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 10, False))

            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.NRS_BR_CD.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 8, False))       '営業所コード
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.WH_CD.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 8, False))           '倉庫コード
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.OUTKA_PLAN_DATE.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 8, False)) '出庫日
            .sprZaiko.SetCellStyle(0, LME050G.sprZaiko.SMPL_FLG.ColNo, LMSpreadUtility.GetTextCell(.sprZaiko, InputControl.ALL_MIX, 2, False))        '小分けフラグ
    ...
    ''' <remarks></remarks>
    Friend Sub SetInitValue(ByVal frm As LME050F)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Friend Sub SetSpread(ByVal frm As LME050F, ByVal dt As DataTable, ByVal prmDs As DataSet)
        ...
        With spr
            ...
            For i As Integer = 1 To lngcnt
                ...
                .SetCellStyle(i, sprZaiko.HIKI_CNT.ColNo, LMSpreadUtility.GetNumberCell(spr, 0, 9999999999, False, 0, True, ","))         '引当個数
                ...
                .SetCellValue(i, sprZaiko.GOODS_CRT_DATE.ColNo, _
                ...
                .SetCellValue(i, sprZaiko.LT_DATE.ColNo, _
                ...
                .SetCellValue(i, sprZaiko.OUTKA_PLAN_DATE.ColNo, _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Friend Function SetCalSum(ByVal eventShubetsu As LME050C.EventShubetsu) As Boolean
        ...
        With Me._Frm
            ...
            If _V.IrimeCheck() = False Then
                Return False
            End If
            If (LME050C.EventShubetsu.CAL_KONSU).Equals(eventShubetsu) = True Then
                '梱数・端数変更時
            ...
            ElseIf (LME050C.EventShubetsu.CAL_SURYO).Equals(eventShubetsu) = True Then
                '数量変更時
                '個数計算
                '個数、梱数選択時
                kosu = 1
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Friend Sub SetHikiSum(ByVal eventShubetsu As LME050C.EventShubetsu)
        ...
        With Me._Frm
            ...
            '引当個数変更時
            If ("00").Equals(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.SMPL_FLG.ColNo)).ToString()) = True Then
                '小分け在庫以外の時
                suryo = Convert.ToDecimal( _
                        Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.HIKI_CNT.ColNo)).ToString()) _
                      * Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.IRIME.ColNo)).ToString()))
                suryo2 = Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.HIKI_KANO_AMT.ColNo)).ToString())
                If suryo > suryo2 Then
                    suryo = suryo2
                End If
            Else
                If ("0").Equals(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.HIKI_CNT.ColNo)).ToString()) = False Then
                    suryo = Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.HIKI_KANO_AMT.ColNo)).ToString())
                End If
            ...
            For i As Integer = 1 To max
                ...
                If Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(i, LME050G.sprZaiko.DEF.ColNo)).Equals(LMConst.FLG.ON) = True Then
                    '引当個数加算
                    kosu = kosu + _
                           Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(i, LME050G.sprZaiko.HIKI_CNT.ColNo)))

                    '引当数量加算
                    suryo = suryo + _
                            Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(i, LME050G.sprZaiko.HIKI_AMT.ColNo)))
                End If
    ...
    Friend Sub SetCheckOnOff()
        ...
        With Me._Frm
            ...
            kosu = Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.HIKI_CNT.ColNo)).ToString()
            suryo = Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(rowNo, LME050G.sprZaiko.HIKI_AMT.ColNo)).ToString()

            If (LME050G.sprZaiko.HIKI_CNT.ColNo).Equals(colNo) = True Then
                '引当個数にフォーカスが合っている場合
                If ("0").Equals(kosu) = False Then
                    .sprZaiko.SetCellValue(rowNo, sprZaiko.DEF.ColNo, "True")
                Else

                    If ("0").Equals(.numSyukkaKosu.TextValue) = False Then
            ...
            ElseIf (LME050G.sprZaiko.HIKI_AMT.ColNo).Equals(colNo) = True Then
                '引当数量にフォーカスが合っている場合
    ...
    Friend Sub SetAllZero()
        ...
        With Me._Frm
            Dim kosu As Decimal = Convert.ToDecimal(.numSyukkaSouCnt.Value) '作業個数
            ...
            Dim suryo As Decimal = Convert.ToDecimal(.numSyukkaSouAmt.Value) '作業数量
            ...
            For i As Integer = 0 To max
                kanoKosu = Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(Convert.ToInt32(list(i)), LME050G.sprZaiko.HIKI_KANO_CNT.ColNo)).ToString())
                kanoSuryo = Convert.ToDecimal(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(Convert.ToInt32(list(i)), LME050G.sprZaiko.HIKI_KANO_AMT.ColNo)).ToString())
                ...
                ElseIf endFlg = False AndAlso kanoKosu >= wkosu Then
                    ...
                    If ("00").Equals(Me._LMEconV.GetCellValue(.sprZaiko.ActiveSheet.Cells(Convert.ToInt32(list(i)), LME050G.sprZaiko.SMPL_FLG.ColNo)).ToString()) = True Then
                        '小分け以外の場合
                        '引当数量
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Function GetCachedGoods(ByVal frm As LME050F) As String
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Friend Sub SetCheckOnOffKeysAdd(ByVal frm As LME050F)
        ...
        With Me._Frm
            ...
            If (LME050G.sprZaiko.HIKI_CNT.ColNo).Equals(colNo) = True Then
                ...
                Dim chk As String = .sprZaiko.ActiveSheet.GetValue(rowNo, LME050G.sprZaiko.DEF.ColNo).ToString
