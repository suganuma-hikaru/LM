...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LME030H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LME030F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    ''' <summary>
    ''' スプレッド内データをクリックした時、発生するイベントです。
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprDetails_DoubleClick(ByVal sender As System.Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprDetails.CellDoubleClick

        If e.Row = 0 Then
            Exit Sub
        End If
        Call Me._H.sprDetails_DoubleClick(Me, e)
