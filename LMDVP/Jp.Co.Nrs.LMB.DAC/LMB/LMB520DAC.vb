...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                              " & vbNewLine _
          ...
          & "-- 依頼番号 Start 001763 UPD 2018/09/10                                      " & vbNewLine _
          & "--          ,CASE WHEN MSO.WH_KB = '01' THEN MSO.AD_1                    " & vbNewLine _
          & "--                ELSE MNB.AD_1 END               AS AD_1                " & vbNewLine _
          & "--          ,CASE WHEN MSO.WH_KB = '01' THEN MSO.AD_2                    " & vbNewLine _
          & "--                ELSE MNB.AD_2 END               AS AD_2                " & vbNewLine _
          & "          ,ISNULL(KBN_3.KBN_NM5,'')             AS AD_1                " & vbNewLine _
          & "          ,ISNULL(KBN_3.KBN_NM6,'') + ' ' + ISNULL(KBN_3.KBN_NM8,'') AS AD_2 " & vbNewLine _
          & "-- 依頼番号 EnD   001763 UPD 2018/09/10                                      " & vbNewLine _
          & "          ,MG.GOODS_CD_NRS                      AS GOODS_CD_NRS        " & vbNewLine _
          & "          ,MG.GOODS_NM_1                        AS GOODS_NM_1          " & vbNewLine _
          & "          ,INS.LOT_NO                           AS LOT_NO              " & vbNewLine _
          & "          ,CASE HIDE_SERIAL.SET_NAIYO                                  " & vbNewLine _
          & "                WHEN '1' THEN ''                                       " & vbNewLine _
          & "                ELSE INS.SERIAL_NO                                     " & vbNewLine _
          ...
          & "          --★LMB522 END                                               " & vbNewLine _
          & "           ,MNB.AD_1 AS NRS_BR_AD_1                                    " & vbNewLine _
          & "           ,MNB.AD_2 AS NRS_BR_AD_2                                    " & vbNewLine _
          & "          --(2012.03.17) LMB523：入荷報告書対応 -- START --            " & vbNewLine _
          & "          ,MG.GOODS_NM_2                        AS GOODS_NM_2          " & vbNewLine _
          & "          ,MG.GOODS_NM_3                        AS GOODS_NM_3          " & vbNewLine _
          & "          --(2012.03.17) LMB523：入荷報告書対応 --  END  --            " & vbNewLine _
          & "          --(2012.06.14) LMB524：入荷報告書対応 -- START --                          " & vbNewLine _
          ...
          & "          --(2012.06.14) LMB524：入荷報告書対応 --  END  --                          " & vbNewLine _
          & "          --(2012.09.17) LMB525：入荷報告書対応 -- START --            " & vbNewLine _
          & "          ,MSO.WH_NM                            AS WH_NM               " & vbNewLine _
          & "          ,MG.GOODS_CD_NRS                      AS GOODS_CD_NRS        " & vbNewLine _
          & "          --(2012.09.17) LMB525：入荷報告書対応 --  END  --            " & vbNewLine _
          & "--必要ならばSQL別にせよ          --(2012.09.17) LMB528：入荷報告書対応 -- START --            " & vbNewLine _
          & "--必要ならばSQL別にせよ          ,INS.REMARK                           AS REMARK              " & vbNewLine _
          & "--必要ならばSQL別にせよ          --(2012.09.17) LMB528：入荷報告書対応 --  END  --            " & vbNewLine _
          & "		   --(2012.10.23) 追記(記入漏れ)         --  START--            " & vbNewLine _
          & "          ,MG.GOODS_CD_CUST                     AS GOODS_CD_CUST       " & vbNewLine _
          & "		   --(2012.10.23) 追記(記入漏れ)         --  END  --            " & vbNewLine _
          & "          --(2012.10.23) LMB525：入荷報告書対応-- START  --            " & vbNewLine _
          & "          ,LEFT(MG.GOODS_CD_CUST,4)             AS GOODS_CD_CUST_4D    " & vbNewLine _
          & "          --(2012.10.23) LMB525：入荷報告書対応--  END  --             " & vbNewLine _
          & "          ,@KAKUIN_FLG                          AS KAKUIN_FLG  --ADD 2018/11/01  依頼番号 : 002747 " & vbNewLine
    ...
    Private Const SQL_SELECT_DATA2 As String = " SELECT                              " & vbNewLine _
          ...
          & "          ,LEFT(MG.GOODS_CD_CUST,4)             AS GOODS_CD_CUST_4D    " & vbNewLine _
          & "          --(2012.10.23) LMB525：入荷報告書対応--  END  --             " & vbNewLine _
          & "          ,@KAKUIN_FLG                          AS KAKUIN_FLG  --ADD 2018/11/01  依頼番号 : 002747 " & vbNewLine _
          & "--ADD Start 007414 2019/09/17                                            " & vbNewLine _
          ...
          & "          ,ISNULL(KBN_4.KBN_NM1,'')             AS ONDO_NM             " & vbNewLine _
          & "--ADD End   007414 2019/09/17                                          " & vbNewLine
    ...
    Private Const SQL_FROM As String = "FROM                                        " & vbNewLine _
          ...
          & " --(2012.03.06) Notes№778対応 削除レコードは非表示 -- STRAT --        " & vbNewLine _
          & "AND INM.SYS_DEL_FLG  = '0'                                             " & vbNewLine _
          & " --(2012.03.06) Notes№778対応 削除レコードは非表示 --  END  --        " & vbNewLine _
          & "--入荷S                                                                " & vbNewLine _
          ...
          & "AND MCR1.PTN_ID = '03'                                                 " & vbNewLine _
          ...
          & "AND MCR2.PTN_ID = '03'                                                 " & vbNewLine _
          & "--帳票パターン取得                                                     " & vbNewLine _
          ...
          & "          --【追】元データ区分を条件に追加 -- START --                 " & vbNewLine _
          & "          AND UNSO.MOTO_DATA_KB ='10'                                  " & vbNewLine _
          & "          --【修】元データ区分を条件に追加 --  END  --                 " & vbNewLine _
          & "          AND UNSO.SYS_DEL_FLG = '0'                                   " & vbNewLine _
          & "          --【追】届先マスタは使用しない為、コメントとする -- START -- " & vbNewLine _
          ...
          & "          --【修】届先マスタは使用しない為、コメントとする --  END  -- " & vbNewLine _
          & "          --★LMB522 END                                               " & vbNewLine _
          & "    	LEFT JOIN                                                       " & vbNewLine _
          & "    	     LM_MST..M_CUST_DETAILS HIDE_SERIAL                         " & vbNewLine _
          & "          ON HIDE_SERIAL.SUB_KB   = '0Z'                               " & vbNewLine _
          & "    	 AND HIDE_SERIAL.SET_NAIYO = '1'                                " & vbNewLine _
          & "    	 AND HIDE_SERIAL.NRS_BR_CD = CUST.NRS_BR_CD                     " & vbNewLine _
          & "    	 AND HIDE_SERIAL.CUST_CD   =                                    " & vbNewLine _
          & "    	    CASE WHEN HIDE_SERIAL.CUST_CLASS = '00'                     " & vbNewLine _
          & "    	         THEN CUST.CUST_CD_L                                    " & vbNewLine _
          & "    	         WHEN HIDE_SERIAL.CUST_CLASS = '01'                     " & vbNewLine _
          & "    	         THEN CUST.CUST_CD_L + CUST.CUST_CD_M                   " & vbNewLine _
          & "    		     WHEN HIDE_SERIAL.CUST_CLASS = '02'                     " & vbNewLine _
          & "    		     THEN CUST.CUST_CD_L + CUST.CUST_CD_M + CUST.CUST_CD_S  " & vbNewLine _
          & "    		     WHEN HIDE_SERIAL.CUST_CLASS = '03'                     " & vbNewLine _
          & "    		     THEN CUST.CUST_CD_L + CUST.CUST_CD_M + CUST.CUST_CD_S + CUST.CUST_CD_SS " & vbNewLine _
          & "            END                                                        " & vbNewLine _
          & "--ADD Start 2018/09/10 依頼番号 001763                                 " & vbNewLine _
          & "   --	ユーザーマスタ取得                                              " & vbNewLine _
          & "   LEFT JOIN LM_MST..S_USER SUSER                                      " & vbNewLine _
          & "     ON SUSER.USER_CD = @USER_CD                                       " & vbNewLine _
          & "   --(区分3 部署コード)                                                " & vbNewLine _
          & "   LEFT JOIN  LM_MST..Z_KBN KBN_3                                      " & vbNewLine _
          & "     ON  KBN_3.KBN_GROUP_CD = 'B007'                                   " & vbNewLine _
          & "    AND  KBN_3.KBN_CD      = SUSER.BUSYO_CD                            " & vbNewLine _
          & "--ADD End    2018/09/10 依頼番号 001763                                " & vbNewLine _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_FROM2 As String = "FROM                                        " & vbNewLine _
          & "--入荷L                                                                " & vbNewLine _
          & "$LM_TRN$..B_INKA_L INL                                                 " & vbNewLine _
          & "--入荷M                                                                " & vbNewLine _
          & "LEFT join $LM_TRN$..B_INKA_M INM                                       " & vbNewLine _
          ...
          & "    AND  KBN_3.KBN_CD      = SUSER.BUSYO_CD                            " & vbNewLine _
          & "--ADD End    2018/09/10 依頼番号 001763                                " & vbNewLine _
          & "--ゾーンマスタ ADD 2019/09/17 007414                                   " & vbNewLine _
          & "LEFT join $LM_MST$..M_ZONE MZ                                          " & vbNewLine _
          & "  ON  MZ.WH_CD      = INL.WH_CD                                        " & vbNewLine _
          & " AND  MZ.TOU_NO     = INS.TOU_NO                                       " & vbNewLine _
          & " AND  MZ.SITU_NO    = INS.SITU_NO                                      " & vbNewLine _
          & " AND  MZ.ZONE_CD    = INS.ZONE_CD                                      " & vbNewLine _
          & "--温度管理区分(区分1) ADD 2019/09/17 007414                            " & vbNewLine _
          & "LEFT JOIN  LM_MST..Z_KBN KBN_4                                         " & vbNewLine _
          & "  ON KBN_4.KBN_GROUP_CD = 'O002'                                       " & vbNewLine _
          & " AND KBN_4.KBN_CD       = MZ.ONDO_CTL_KB                               " & vbNewLine _
          & "   WHERE INL.NRS_BR_CD  = @NRS_BR_CD                                   " & vbNewLine _
          & "    AND INL.SYS_DEL_FLG  = '0'                                         " & vbNewLine _
          & "                                                                       " & vbNewLine
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_GROUP_BY As String = "GROUP BY  MR1.PTN_CD                    " & vbNewLine _
          ...
          & "           --(2012.03.17) LMB523：入荷報告書対応 --  END  --           " & vbNewLine _
          & "           --(2012.06.24) LMB524：出荷元表示対応 -- START --           " & vbNewLine _
          & "           ,EDIL.INKA_CTL_NO_L                                         " & vbNewLine _
          & "           ,DESTEDI.DEST_NM                                            " & vbNewLine _
          & "           ,DESTL.DEST_NM                                              " & vbNewLine _
          & "           --(2012.03.17) LMB523：出荷元表示対応 --  END  --           " & vbNewLine _
          & "           --(2012.09.17) LMB525：入荷報告書対応 -- START --           " & vbNewLine _
          & "           ,MSO.WH_NM                                                  " & vbNewLine _
          & "           ,MG.GOODS_CD_NRS                                            " & vbNewLine _
          & "           --(2012.03.17) LMB525：入荷報告書対応 --  END  --           " & vbNewLine _
          & "--必要ならばSQL別にせよ           --(2012.09.17) LMB528：入荷報告書対応 -- START --           " & vbNewLine _
          & "--必要ならばSQL別にせよ           ,INS.REMARK                                                 " & vbNewLine _
          & "--必要ならばSQL別にせよ           --(2012.03.17) LMB528：入荷報告書対応 --  END  --           " & vbNewLine _
          & "		  --(2012.10.23) 追記(記入漏れ)         --  START  --           " & vbNewLine _
          & "          ,MG.GOODS_CD_CUST                                            " & vbNewLine _
          & "		  --(2012.10.23) 追記(記入漏れ)         --  END    --           " & vbNewLine _
          & "--ADD Start 2018/09/10 依頼番号 001763                                 " & vbNewLine _
          & "            ,KBN_3.KBN_NM5                                             " & vbNewLine _
          & "            ,KBN_3.KBN_NM6                                             " & vbNewLine _
          & "            ,KBN_3.KBN_NM8                                             " & vbNewLine _
          & "--ADD End   2018/09/10 依頼番号 001763                                 " & vbNewLine
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_GROUP_BY2 As String = "GROUP BY  MR1.PTN_CD                    " & vbNewLine _
          & "           ,MR2.PTN_CD                                                 " & vbNewLine _
          & "           ,MR1.RPT_ID                                                 " & vbNewLine _
          & "           ,MR2.RPT_ID                                                 " & vbNewLine _
          & "           ,MR3.RPT_ID                                                 " & vbNewLine _
    ...
    Private Const SQL_ORDER_BY As String = "ORDER BY                                          " & vbNewLine _
                                         ...
                                         & "    ,INS.LT_DATE                                  " & vbNewLine _
                                         & "    ,KBN_1.KBN_NM1                                " & vbNewLine _
                                         & "    ,KBN_2.KBN_NM1                                " & vbNewLine

    ''' <summary>
    ''' 月次用ORDER BY（①入荷日、②管理番号）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_ORDER_BY_MONTH As String = "ORDER BY                                    " & vbNewLine _
                                         & "    --(2012.02.28)現行の並び順にに合わせる為、    " & vbNewLine _
                                         & "    --第1SORT KEYは商品KEYではなく商品名とする。  " & vbNewLine _
                                         & "     MG.GOODS_NM_1                                " & vbNewLine _
                                         & "    ,MG.GOODS_CD_NRS                              " & vbNewLine _
                                         & "    ,INL.INKA_DATE                                " & vbNewLine _
                                         & "    ,INS.LOT_NO                                   " & vbNewLine _
                                         & "    ,INS.IRIME                                    " & vbNewLine _
                                         & "    ,INL.OUTKA_FROM_ORD_NO_L                      " & vbNewLine

    ''' <summary>
    ''' LMB525用ORDER BY（①入荷日、②管理番号）
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_ORDER_BY_525 As String = "ORDER BY                                      " & vbNewLine _
                                         & "     INL.NRS_BR_CD                                " & vbNewLine _
                                         & "    ,INL.INKA_NO_L                                " & vbNewLine _
                                         & "    ,INL.INKA_DATE                                " & vbNewLine _
                                         & "    ,LEFT(MG.GOODS_CD_CUST,4)                     " & vbNewLine _
                                         & "    ,INM.INKA_NO_M                                " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMB520IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMB520DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMB520DAC.SQL_FROM_Mprt)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMB520DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Me._Row = inTbl.Rows(0)
        'ADD 2018/09/10
        Dim BUSYO_CD As String = MyBase.GetUserInfoValue("BUSYO_CD")

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
#If False Then   'ADD 2019/09/17 007414【LMS】入荷報告書_置場と温度区分を出力／DSP五協から依頼
        Me._StrSql.Append(LMB520DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMB520DAC.SQL_FROM)             'SQL構築(データ抽出用From句)

#Else
        Select Case ds.Tables("M_RPT").Rows(0).Item("RPT_ID").ToString
            Case "LMB519"
                Me._StrSql.Append(LMB520DAC.SQL_SELECT_DATA2)      'SQL構築(データ抽出用Select句)
                Me._StrSql.Append(LMB520DAC.SQL_FROM2)             'SQL構築(データ抽出用From句)
            Case Else
                Me._StrSql.Append(LMB520DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
                Me._StrSql.Append(LMB520DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
...
#End If
        ...
        'ADD 2018/09/10
        Dim sUSER_CD As String = MyBase.GetUserID()
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@USER_CD", sUSER_CD.ToString, DBDataType.CHAR))
        'ADD 2018/09/10 

#If True Then       'ADD 2018/11/01 依頼番号 : 002747   【LMS】入荷報告印刷_角印つけるつけないの選択機能
        Dim sKAKUIN_FLG As String = inTbl.Rows(0).Item("KAKUIN_FLG").ToString
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@KAKUIN_FLG", sKAKUIN_FLG.ToString, DBDataType.NVARCHAR))

#End If

#If False Then   'ADD 2019/09/17 007414【LMS】入荷報告書_置場と温度区分を出力／DSP五協から依頼
        Me._StrSql.Append(LMB520DAC.SQL_GROUP_BY)         'SQL構築(データ抽出用GROUP BY句)
#Else
        Select Case ds.Tables("M_RPT").Rows(0).Item("RPT_ID").ToString
            Case "LMB519"
                Me._StrSql.Append(LMB520DAC.SQL_GROUP_BY2)         'SQL構築(データ抽出用GROUP BY句)
            Case Else
                Me._StrSql.Append(LMB520DAC.SQL_GROUP_BY)         'SQL構築(データ抽出用GROUP BY句)
...
#End If
        ...
        Select Case ds.Tables("M_RPT").Rows(0).Item("RPT_ID").ToString
            Case "LMB522"
                Me._StrSql.Append(LMB520DAC.SQL_ORDER_BY_MONTH)         'SQL構築(データ抽出用ORDER BY句)
            Case "LMB525"
                Me._StrSql.Append(LMB520DAC.SQL_ORDER_BY_525)         'SQL構築(データ抽出用ORDER BY句)

            Case Else
                Me._StrSql.Append(LMB520DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        End Select
        'LMB522 END
        ...
        MyBase.Logger.WriteSQLLog("LMB520DAC", "SelectPrintData", cmd)
        ...
        map.Add("INKA_DATE_FROM", "INKA_DATE_FROM")
        map.Add("INKA_DATE_TO", "INKA_DATE_TO")
        map.Add("ORIG_CD_NM", "ORIG_CD_NM")
        map.Add("SURYO", "SURYO")
        map.Add("NRS_BR_AD_1", "NRS_BR_AD_1")
        map.Add("NRS_BR_AD_2", "NRS_BR_AD_2")
        map.Add("GOODS_NM_2", "GOODS_NM_2")     '【追加】(2012.03.17) LMB523:入荷報告書用 大阪DIC対応 
        map.Add("GOODS_NM_3", "GOODS_NM_3")     '【追加】(2012.03.17) LMB523:入荷報告書用 大阪DIC対応 
        map.Add("OUTKA_MOTO", "OUTKA_MOTO")     '【追加】(2012.06.14) 埼玉ロジコネット対応
        map.Add("WH_NM", "WH_NM")               '【追加】(2012.09.17) 千葉汎用対応
        'map.Add("REMARK", "REMARK")            '【追加】(2012.09.17) 千葉リマーク対応  (2012.10.29)今のところ不要によりコメント
        map.Add("GOODS_CD_CUST", "GOODS_CD_CUST")   '【追加】(2012.09.17) 千葉汎用対応
        map.Add("GOODS_CD_CUST_4D", "GOODS_CD_CUST_4D")   '【追加】(2012.09.17) 千葉汎用対応
        map.Add("KAKUIN_FLG", "KAKUIN_FLG")     '【追加】(2018.11.01) 依頼番号 : 002747  
#If True Then   'ADD 2019/09/17 007414【LMS】入荷報告書_置場と温度区分を出力／DSP五協から依頼
        If ds.Tables("M_RPT").Rows(0).Item("RPT_ID").ToString.Equals("LMB519") Then
...
#End If
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMB520OUT")
