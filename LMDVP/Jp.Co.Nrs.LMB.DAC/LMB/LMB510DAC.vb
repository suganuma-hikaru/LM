...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                          " & vbNewLine _
                            ...
                            & "          ,BASE2.UN            --ADD 2021/05/24 依頼番号 : ベトナム対応   " & vbNewLine _
                            & "          ,BASE2.CLASS_1       --ADD 2021/05/24 依頼番号 : ベトナム対応   " & vbNewLine _
                            & "          ,BASE2.CLASS_2       --ADD 2021/05/24 依頼番号 : ベトナム対応   " & vbNewLine _
                            & "          ,BASE2.CLASS_3       --ADD 2021/05/24 依頼番号 : ベトナム対応   " & vbNewLine _
                            & " FROM                                                            " & vbNewLine _
                            & "  (                                                              " & vbNewLine _
                            & " SELECT                                                          " & vbNewLine _
                            & " CASE WHEN MR2.PTN_CD IS NOT NULL THEN MR2.RPT_ID                " & vbNewLine _
                            ...
                            & "          ,ISNULL(MG.UN,'')                AS UN            --ADD 2021/05/24 依頼番号 : ベトナム対応    " & vbNewLine _
                            & "          ,ISNULL(MG.CLASS_1,'')           AS CLASS_1       --ADD 2021/05/24 依頼番号 : ベトナム対応    " & vbNewLine _
                            & "          ,ISNULL(MG.CLASS_2,'')           AS CLASS_2       --ADD 2021/05/24 依頼番号 : ベトナム対応    " & vbNewLine _
                            & "          ,ISNULL(MG.CLASS_3,'')           AS CLASS_3       --ADD 2021/05/24 依頼番号 : ベトナム対応    " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMB510DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMB510DAC.SQL_FROM_Mprt)             'SQL構築(データ抽出用From句)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMB510DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMB510DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMB510DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMB510DAC", "SelectPrintData", cmd)
        ...
        'ADD 2021/05/24 依頼番号 : ベトナム対応
        map.Add("UN", "UN")                      'ADD 2021/05/24 依頼番号 : ベトナム対応
        map.Add("CLASS_1", "CLASS_1")            'ADD 2021/05/24 依頼番号 : ベトナム対応
        map.Add("CLASS_2", "CLASS_2")            'ADD 2021/05/24 依頼番号 : ベトナム対応
        map.Add("CLASS_3", "CLASS_3")            'ADD 2021/05/24 依頼番号 : ベトナム対応
