...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                          " & vbNewLine _
                            ...
                            & "           ,ISNULL(BASE2.KONSU,0)        AS  KONSU               " & vbNewLine _
                            & "           ,ISNULL(BASE2.HASU,0)         AS  HASU                " & vbNewLine _
                            & "           ,ISNULL(BASE2.PKG_NB,0)       AS  PKG_NB              " & vbNewLine _
                            ...
                            & "          --(2018.10.15)要望番号002449 -- START --               " & vbNewLine _
                            & "          ,BASE2.TOUKI_HOKAN_YN          AS TOUKI_HOKAN_YN       " & vbNewLine _
                            & "          ,BASE2.HOKAN_YN                AS HOKAN_YN             " & vbNewLine _
                            & "          --(2018.10.15)要望番号002449 -- END   --               " & vbNewLine _
                            & "          ,BASE2.SHOBO_CD      --ADD 2019/03/29 依頼番号 : 005131【LMS】群馬入庫予定表_危険品区分を表示する   " & vbNewLine _
                            & "          ,BASE2.RUI           --ADD 2019/03/29 依頼番号 : 005131【LMS】群馬入庫予定表_危険品区分を表示する   " & vbNewLine _
                            & "          ,BASE2.HINMEI        --ADD 2019/03/29 依頼番号 : 005131【LMS】群馬入庫予定表_危険品区分を表示する   " & vbNewLine _
                            & "          ,BASE2.TANTO_NM                AS TANTO_NM             " & vbNewLine _
                            & "          ,@PGID                         AS PGID                 " & vbNewLine _
                            & " FROM                                                            " & vbNewLine _
                            & "  (                                                              " & vbNewLine _
                            & " SELECT                                                          " & vbNewLine _
                            & " CASE WHEN MR2.PTN_CD IS NOT NULL THEN MR2.RPT_ID                " & vbNewLine _
                            ...
                            & "          ,KBN_10.KBN_NM1                       AS ALLOC_PRIORITY      " & vbNewLine _
                            & "          ,KBN_11.KBN_NM1                       AS GOODS_COND_KB_1     " & vbNewLine _
                            & "          ,KBN_12.KBN_NM1                       AS GOODS_COND_KB_2     " & vbNewLine _
                            & "          ,MCC.JOTAI_NM                         AS GOODS_COND_KB_3     " & vbNewLine _
                            & "          ,KBN_14.KBN_NM1                       AS SPD_KB              " & vbNewLine _
                            & "          ,KBN_13.KBN_NM1                       AS OFB_KB              " & vbNewLine _
                            ...
                            & "          --(2013.04.26)要望番号2033 -- END   --                       " & vbNewLine _
                            & "          , ISNULL(SAGYO_L_1.SAGYO_CD, '')      AS SAGYO_CD_L01        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_L_2.SAGYO_CD, '')      AS SAGYO_CD_L02        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_L_3.SAGYO_CD, '')      AS SAGYO_CD_L03        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_L_4.SAGYO_CD, '')      AS SAGYO_CD_L04        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_L_5.SAGYO_CD, '')      AS SAGYO_CD_L05        " & vbNewLine _
                            & "          , ISNULL(SAGYO_M_1.SAGYO_CD, '')      AS SAGYO_CD_M01        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_M_2.SAGYO_CD, '')      AS SAGYO_CD_M02        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_M_3.SAGYO_CD, '')      AS SAGYO_CD_M03        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_M_4.SAGYO_CD, '')      AS SAGYO_CD_M04        " & vbNewLine _
                            & " 		 , ISNULL(SAGYO_M_5.SAGYO_CD, '')      AS SAGYO_CD_M05        " & vbNewLine _
                            & "          --(2018.10.15)要望番号002449 -- START --                     " & vbNewLine _
                            & "          ,KBN_16.KBN_NM1                       AS TOUKI_HOKAN_YN      " & vbNewLine _
                            & "          ,KBN_17.KBN_NM1                       AS HOKAN_YN            " & vbNewLine _
                            & "          --(2018.10.15)要望番号002449 -- END   --                     " & vbNewLine _
                            & "          ,MG.SHOBO_CD                     AS SHOBO_CD      --ADD 2019/03/29 依頼番号 : 005131【LMS】群馬入庫予定表_危険品区分を表示するN            " & vbNewLine _
                            & "          ,ISNULL(MS.RUI,'')               AS RUI           --ADD 2019/03/29 依頼番号 : 005131    " & vbNewLine _
                            & "          ,ISNULL(MS.HINMEI,'')            AS HINMEI        --ADD 2019/03/29 依頼番号 : 005131    " & vbNewLine _
                            & "          ,USR_PRT2.USER_NM                AS TANTO_NM                 " & vbNewLine
    ...
    Private Const SQL_FROM As String = "FROM                                                            " & vbNewLine _
                            ...
                            & "AND MCR1.PTN_ID = 'C6'                                                 " & vbNewLine _
                            ...
                            & "AND MCR2.PTN_ID = 'C6'                                                 " & vbNewLine _
                            & "--帳票パターン取得                                                     " & vbNewLine _
                            ...
                            & "   --ユーザーマスタ(印刷)2                                             " & vbNewLine _
                            & "   LEFT JOIN $LM_MST$..S_USER USR_PRT2                                 " & vbNewLine _
                            & "   ON  USR_PRT2.USER_CD     = CUST.TANTO_CD                            " & vbNewLine _
                            & "   --ユーザーマスタ                                                    " & vbNewLine _
                            ...
                            & "--(2018.10.15)要望番号002449 -- START --                               " & vbNewLine _
                            & "   --当期保管料負担有無(区分16)                                        " & vbNewLine _
                            & "   LEFT JOIN  $LM_MST$..Z_KBN KBN_16                                   " & vbNewLine _
                            & "   ON                                                                  " & vbNewLine _
                            & "    KBN_16.KBN_GROUP_CD = 'U009'                                       " & vbNewLine _
                            & "   AND                                                                 " & vbNewLine _
                            & "    KBN_16.KBN_CD      = INL.TOUKI_HOKAN_YN                            " & vbNewLine _
                            & "   --保管料有無(区分17)                                                " & vbNewLine _
                            & "   LEFT JOIN  $LM_MST$..Z_KBN KBN_17                                   " & vbNewLine _
                            & "   ON                                                                  " & vbNewLine _
                            & "    KBN_17.KBN_GROUP_CD = 'U009'                                       " & vbNewLine _
                            & "   AND                                                                 " & vbNewLine _
                            & "    KBN_17.KBN_CD      = INL.HOKAN_YN                                  " & vbNewLine _
                            & "--(2018.10.15)要望番号002449 -- END   --                               " & vbNewLine _
                            & "   --荷主明細マスタ                                                    " & vbNewLine _
                            ...
                            & "                      ON E.NRS_BR_CD     = BL.NRS_BR_CD                                                                       " & vbNewLine _
                            & "                     AND E.IOZS_KB       = '10'                                                                               " & vbNewLine _
                            & "                     AND E.SYS_DEL_FLG   = '0'                                                                                " & vbNewLine _
                            & "                     AND E.INOUTKA_NO_LM = CONCAT(BL.INKA_NO_L, '000')                                                        " & vbNewLine _
                            & "                   WHERE BL.SYS_DEL_FLG  = '0'                                                                                " & vbNewLine _
                            & "                     AND BL.INKA_NO_L    = @INKA_NO_L                                                                         " & vbNewLine _
                            & "                     AND BL.NRS_BR_CD    = @NRS_BR_CD                                                                         " & vbNewLine _
                            & "                 ) AS BASE                                                                                                    " & vbNewLine _
                            & "          WHERE BASE.NUM = 1) AS SAGYO_L_1                                                                                    " & vbNewLine _
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_L_1.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_L_1.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "   		                                                                                                                     " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_L_2.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_L_2.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "   AND SAGYO_L_3.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_L_4.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_L_4.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_L_5.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_L_5.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "                         $LM_TRN$..B_INKA_L AS  BL                                                                            " & vbNewLine _
                            & "                    LEFT JOIN                                                                                                 " & vbNewLine _
                            & "                         $LM_TRN$..B_INKA_M AS  BM                                                                            " & vbNewLine _
                            & "                      ON BM.NRS_BR_CD   = BL.NRS_BR_CD                                                                        " & vbNewLine _
                            & "                     AND BM.INKA_NO_L   = BL.INKA_NO_L                                                                        " & vbNewLine _
                            ...
                            & "                     AND E.SYS_DEL_FLG   = '0'                                                                                " & vbNewLine _
                            & "                     AND E.INOUTKA_NO_LM = CONCAT(BM.INKA_NO_L, BM.INKA_NO_M)                                                 " & vbNewLine _
                            & "                   WHERE BL.SYS_DEL_FLG  = '0'                                                                                " & vbNewLine _
                            & "                     AND BL.INKA_NO_L    = @INKA_NO_L                                                                         " & vbNewLine _
                            & "                     AND BL.NRS_BR_CD    = @NRS_BR_CD                                                                         " & vbNewLine _
                            & "                 ) AS BASE                                                                                                    " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_M_1.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_1.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_1.INKA_NO_M = INM.INKA_NO_M                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_M_2.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_2.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_2.INKA_NO_M = INM.INKA_NO_M                                                                                    " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            & "             , SAGYO_NM                                                                                                       " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_M_3.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_3.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_3.INKA_NO_M = INM.INKA_NO_M                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_M_4.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_4.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_4.INKA_NO_M = INM.INKA_NO_M                                                                                    " & vbNewLine _
                            & "                                                                                                                              " & vbNewLine _
                            & "  LEFT JOIN                                                                                                                   " & vbNewLine _
                            & "       (SELECT SAGYO_REC_NO                                                                                                   " & vbNewLine _
                            & "             , SAGYO_CD                                                                                                       " & vbNewLine _
                            ...
                            & "    ON                                                                                                                        " & vbNewLine _
                            & "       SAGYO_M_5.NRS_BR_CD = INM.NRS_BR_CD                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_5.INKA_NO_L = INM.INKA_NO_L                                                                                    " & vbNewLine _
                            & "   AND SAGYO_M_5.INKA_NO_M = INM.INKA_NO_M                                                                                    " & vbNewLine _
    ...
    Private Const SQL_ORDER_BY As String = "ORDER BY                                            " & vbNewLine _
                                         ...
                                         & "    ,BASE2.INKA_NO_S                                " & vbNewLine _
                                         & "    ,BASE2.SHOBO_CD    --ADD 2019/03/29 依頼番号 : 005131 " & vbNewLine _
                                         & "    ,BASE2.RUI         --ADD 2019/03/29 依頼番号 : 005131 " & vbNewLine _
                                         & "    ,BASE2.HINMEI      --ADD 2019/03/29 依頼番号 : 005131 " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMB550IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMB550DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMB550DAC.SQL_FROM_Mprt)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMB550DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMB550DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMB550DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMB550DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMB550DAC", "SelectPrintData", cmd)
        ...
        '(2018.10.15)要望番号002449対応 --- START ---
        map.Add("TOUKI_HOKAN_YN", "TOUKI_HOKAN_YN")
        map.Add("HOKAN_YN", "HOKAN_YN")
        '(2018.10.15)要望番号002449対応 --- END   ---
        map.Add("SHOBO_CD", "SHOBO_CD")        'ADD 2019/036/29 依頼番号 : 005131【LMS】群馬入庫予定表_危険品区分を表示する 
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMB550OUT")
    ...
    Private Sub SetConditionMasterSQL()
        ...
        With Me._Row
            ...
            '印刷元プログラムID
            whereStr = MyBase.GetPGID
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@PGID", whereStr, DBDataType.CHAR))
