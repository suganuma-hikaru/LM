...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                              							             " & vbNewLine _
                                                    ...
                                                    & "	    --入荷報告チェックリスト対応[20121130]開始							 			" & vbNewLine _
                                                    ...
                                                    & "			,INL.REMARK_OUT					      AS REMARK_OUT_L						" & vbNewLine _
                                                    & "	    --入荷報告チェックリスト対応[20121130]終了										" & vbNewLine
    ...
    Private Const SQL_FROM As String = "FROM                                        " & vbNewLine _
          ...
          & "AND MCR1.PTN_ID = 'B5'                                                 " & vbNewLine _
          ...
          & "AND MCR2.PTN_ID = 'B5'                                                 " & vbNewLine _
          & "--帳票パターン取得                                                     " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMB530IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMB530DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMB530DAC.SQL_FROM_Mprt)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMB530DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMB530DAC.SQL_SELECT_DATA)    'SQL構築(LMB562データ抽出用Select句)：追加文

        Me._StrSql.Append(LMB530DAC.SQL_FROM)                       'SQL構築(データ抽出用From句)

        Call Me.SetConditionMasterSQL()                             'SQL構築(条件設定)

        Me._StrSql.Append(LMB530DAC.SQL_GROUP_BY)           'SQL構築(データ抽出用GROUP BY句)

        Me._StrSql.Append(LMB530DAC.SQL_ORDER_BY)           'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMB530DAC", "SelectPrintData", cmd)
        ...
        map.Add("NB_UT", "NB_UT")
        '追加分開始
        map.Add("INKA_NO_M", "INKA_NO_M") '※1【注記】
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMB530OUT")
