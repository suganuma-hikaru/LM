...
#Region "SELECT句"
    ...
    Private Const SQL_SELECT_GRP As String = " SELECT                                                                                    " & vbNewLine _
                                            & "    MAIN1.RPT_ID                                                                              " & vbNewLine _
                                            & "    , MAIN1.SEIQ_GROUP_NO  AS SEIQ_GROUP_NO                                                   " & vbNewLine _
                                            & "    , MAIN1.SEIQTO_CD      AS SEIQTO_CD                                                       " & vbNewLine _
                                            & "    , MAIN1.SEIQTO_NM      AS SEIQTO_NM                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_CD_L      AS CUST_CD_L                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_CD_M      AS CUST_CD_M                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_CD_S      AS CUST_CD_S                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_CD_SS     AS CUST_CD_SS                                                      " & vbNewLine _
                                            & "    , MAIN1.CUST_NM_L      AS CUST_NM_L                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_NM_M      AS CUST_NM_M                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_NM_S      AS CUST_NM_S                                                       " & vbNewLine _
                                            & "    , MAIN1.CUST_NM_SS     AS CUST_NM_SS                                                      " & vbNewLine _
                                            & "    , MAIN1.T_DATE         AS T_DATE                                                          " & vbNewLine _
                                            & "    , MAIN1.NRS_BR_NM      AS NRS_BR_NM                                                       " & vbNewLine _
                                            & "    , MAIN1.MOTO_DATA_KB   AS MOTO_DATA_KB                                                    " & vbNewLine _
                                            & "    , MAIN1.OUTKA_PLAN_DATE  AS OUTKA_PLAN_DATE                                               " & vbNewLine _
                                            & "    , MAIN1.DEST_CD        AS DEST_CD                                                         " & vbNewLine _
                                            & "    , MAIN1.DEST_NM        AS DEST_NM                                                         " & vbNewLine _
                                            & "    , MAIN1.AD_1           AS AD_1                                                            " & vbNewLine _
                                            & "    , MAIN1.GOODS_NM       AS GOODS_NM                                                        " & vbNewLine _
                                            & "    , MAIN1.DECI_NG_NB     AS DECI_NG_NB                                                      " & vbNewLine _
                                            & "    , MAIN1.DECI_WT        AS DECI_WT                                                         " & vbNewLine _
                                            & "    , MAIN1.DECI_UNCHIN    AS DECI_UNCHIN                                                     " & vbNewLine _
                                            & "    , MAIN1.DECI_CITY_EXTC AS DECI_CITY_EXTC                                                  " & vbNewLine _
                                            & "    , MAIN1.DECI_WINT_EXTC AS DECI_WINT_EXTC                                                  " & vbNewLine _
                                            & "    , MAIN1.DECI_RELY_EXTC AS DECI_RELY_EXTC                                                  " & vbNewLine _
                                            & "    , MAIN1.DECI_TOLL      AS DECI_TOLL                                                       " & vbNewLine _
                                            & "    , MAIN1.DECI_INSU      AS DECI_INSU                                                       " & vbNewLine _
                                            & "    , MAIN1.REMARK         AS REMARK                                                          " & vbNewLine _
                                            & "    , MAIN1.CUST_COST_CD2   AS CUST_COST_CD2                                                  " & vbNewLine _
                                            & "    , MAIN1.SEARCH_KEY_1    AS SEARCH_KEY_1                                                   " & vbNewLine _
                                            & "    , MAIN1.SHI               AS SHI                                                          " & vbNewLine _
                                            & "    , MAIN1.SEIQ_KYORI     AS SEIQ_KYORI                                                      " & vbNewLine _
                                            & "    , MAIN1.GOODS_CD_CUST   AS GOODS_CD_CUST                                                  " & vbNewLine _
                                            & "    , MAIN1.SEIQ_PKG_UT    AS SEIQ_PKG_UT                                                     " & vbNewLine _
                                            & "    , MAIN1.SEIQ_TARIFF_CD AS SEIQ_TARIFF_CD                                                  " & vbNewLine _
                                            & "    , MAIN1.UNSO_NO_L        AS UNSO_NO_L                                                     " & vbNewLine _
                                            & "    , CASE WHEN SUBSTRING(MAIN1.DEST_CD,1,4) < '5624' THEN '000001'                           " & vbNewLine _
                                            & "    WHEN SUBSTRING(MAIN1.DEST_CD,1,4) > '5624' THEN '999999'                                  " & vbNewLine _
                                            & "    ELSE  SUBSTRING(DEST_CD,1,6) END AS DEST_GRP                                              " & vbNewLine _
                                            & "    , CASE WHEN SUBSTRING(MAIN1.DEST_CD,1,4) = '5624' THEN SUBSTRING(MAIN1.DEST_CD,5,2)       " & vbNewLine _
                                            & "    ELSE  '0' END AS DEST_GRP_M                                                               " & vbNewLine _
                                            & "FROM (                                                                                    " & vbNewLine
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                                   " & vbNewLine _
                                          ...
                                          & " , ''                    AS DEST_GRP                                                                              " & vbNewLine _
                                          & " , ''                    AS DEST_GRP_M                                                                            " & vbNewLine
...
#Region "FROM句"
    ...
    Private Const SQL_FROM As String = "FROM                                                               " & vbNewLine _
                                           ...
                                           & "AND MCR1.PTN_ID = 'AD'                                       " & vbNewLine _
                                           ...
                                           & "AND MCR2.PTN_ID = 'AD'                                       " & vbNewLine _
                                           & "--帳票パターン取得                                           " & vbNewLine _
...
#Region "ORDER BY"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_ORDER_BY As String = ") MAIN1                                 " & vbNewLine _
                                         & "ORDER BY                  " & vbNewLine _
                                         & "     MAIN1.MOTO_DATA_KB                  " & vbNewLine _
                                         & "    ,MAIN1.SEIQTO_CD                   " & vbNewLine _
                                         & "    ,MAIN1.CUST_CD_L                   " & vbNewLine _
                                         & "    ,MAIN1.CUST_CD_M                   " & vbNewLine _
                                         & "    ,MAIN1.CUST_CD_S                   " & vbNewLine _
                                         & "    ,CASE WHEN SUBSTRING(MAIN1.DEST_CD,1,4) < '5624' THEN '000001'          " & vbNewLine _
                                         & "          WHEN SUBSTRING(MAIN1.DEST_CD,1,4) > '5624' THEN '999999'          " & vbNewLine _
                                         & "          ELSE  SUBSTRING(DEST_CD,1,6) END                                  " & vbNewLine _
                                         & "    ,MAIN1.OUTKA_PLAN_DATE                                                  " & vbNewLine _
                                         & "    ,CASE WHEN SUBSTRING(MAIN1.DEST_CD,1,4) = '5624' THEN SUBSTRING(MAIN1.DEST_CD,5,2)       " & vbNewLine _
                                         & "          ELSE  '0' END                                                     " & vbNewLine _
                                         & "    ,MAIN1.DEST_CD                       " & vbNewLine _
                                         & "    ,MAIN1.SEIQ_GROUP_NO               " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMI600IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMI600DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI600DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMI600DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(SQL_SELECT_GRP)
        Me._StrSql.Append(LMI600DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI600DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMI600DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用OrderBy句)
        ...
        MyBase.Logger.WriteSQLLog("LMI600DAC", "SelectPrintData", cmd)
        ...
        map.Add("DEST_GRP", "DEST_GRP")
        map.Add("DEST_GRP_M", "DEST_GRP_M")


        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMI600OUT")
    ...
    Private Sub SetConditionMasterSQL()
        ...
        With Me._Row
            ...
            '確定種別
            Select Case Me._Row.Item("SEIQ_SYUBETU").ToString()
                Case MI_KAKUTEI
                    '確定のみ
            ...
            '帳票の種類によって条件を変更
            Select Case Me._Row.Item("PRINT_TYPE").ToString()
                Case SEQ_20_NOT950C
                    Me._StrSql.Append("	   AND SEIQTO.CLOSE_KB = '20'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND SEIQTO.SEIQTO_CD <> '950C'              ")
                    Me._StrSql.Append(vbNewLine)

                Case SEQ_20_950C_101
                    Me._StrSql.Append("	   AND SEIQTO.CLOSE_KB = '20'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND SEIQTO.SEIQTO_CD = '950C'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND UNSO.UNSO_CD = '101'              ")
                    Me._StrSql.Append(vbNewLine)

                Case SEQ_20_950C_NOT101_A0020
                    Me._StrSql.Append("	   AND SEIQTO.CLOSE_KB = '20'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND SEIQTO.SEIQTO_CD = '950C'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND UNSO.UNSO_CD <> '101'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND GOODS.SEARCH_KEY_1 = 'A0020'              ")
                    Me._StrSql.Append(vbNewLine)

                Case SEQ_20_950C_NOT101_A0021
                    Me._StrSql.Append("	   AND SEIQTO.CLOSE_KB = '20'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND SEIQTO.SEIQTO_CD = '950C'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND UNSO.UNSO_CD <> '101'              ")
                    Me._StrSql.Append(vbNewLine)
                    Me._StrSql.Append("	   AND GOODS.SEARCH_KEY_1 = 'A0021'              ")
                    Me._StrSql.Append(vbNewLine)

                Case SEQ_30
                    Me._StrSql.Append("	   AND SEIQTO.CLOSE_KB = '00'              ")
                    Me._StrSql.Append(vbNewLine)
