...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特定荷主機能
'  プログラムID     :  LMI662DAC : 請求鑑(DIC鑑種別：C以降標準)
'  作  成  者       :  yamanaka
' ==========================================================================
Imports System.Text
...
#Region "WHERE句"
    ...
    Private Const SQL_SELECT_WHERE As String = "WHERE                                " & vbNewLine _
                                             ...
                                             & "AND SEKY_MEI.KAGAMI_KB <> 'B'        " & vbNewLine _
...
#Region "印刷処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI662DAC.SQL_SELECT_MPRT)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI662DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI662DAC.SQL_SELECT_WHERE)     'SQL構築(データ抽出用Where句)
        ...
        MyBase.Logger.WriteSQLLog("LMI662DAC", "SelectMPRT", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI662DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI662DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI662DAC.SQL_SELECT_WHERE)     'SQL構築(データ抽出用Where句)
        Me._StrSql.Append(LMI662DAC.SQL_GROUP_BY)         'SQL構築(データ抽出用GroupBy句)
        Me._StrSql.Append(LMI662DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用OrderBy句)
        Call Me.SetSQLSelectWhere()                       'パラメータ設定
        ...
        MyBase.Logger.WriteSQLLog("LMI662DAC", "SelectPrintData", cmd)
