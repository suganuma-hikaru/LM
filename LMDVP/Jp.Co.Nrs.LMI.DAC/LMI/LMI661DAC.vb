...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特定荷主機能
'  プログラムID     :  LMI661DAC : 請求鑑(DIC鑑種別：B(横持料除く))
'  作  成  者       :  yamanaka
' ==========================================================================
Imports System.Text
...
#Region "SELECT句"
    ...
    Private Const SQL_SELECT_DATA As String = "SELECT                                                        " & vbNewLine _
                                            ...
                                            & ", SEKY_MEI.TAX                           AS TAX               " & vbNewLine _
...
#Region "WHERE句"
    ...
    Private Const SQL_SELECT_WHERE As String = "WHERE                                " & vbNewLine _
                                             & "    SEKY_MEI.KAGAMI_KB = 'B'         " & vbNewLine _
...
#Region "印刷処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI661DAC.SQL_SELECT_MPRT)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI661DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI661DAC.SQL_SELECT_WHERE)     'SQL構築(データ抽出用Where句)
        ...
        MyBase.Logger.WriteSQLLog("LMI661DAC", "SelectMPRT", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI661DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI661DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI661DAC.SQL_SELECT_WHERE)     'SQL構築(データ抽出用Where句)
        Me._StrSql.Append(LMI661DAC.SQL_GROUP_BY)         'SQL構築(データ抽出用GroupBy句)
        Me._StrSql.Append(LMI661DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用OrderBy句)
        Call Me.SetSQLSelectWhere()                       'パラメータ設定
        ...
        MyBase.Logger.WriteSQLLog("LMI661DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMI661OUT")
