...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特定荷主機能
'  プログラムID     :  LMI630DAC : 引取運賃明細チェックリスト
'  作  成  者       :  yamanaka
' ==========================================================================
Imports System.Text
...
#Region "FROM句"
    ...
    Private Const SQL_SELECT_FROM As String = "FROM                                        " & vbNewLine _
                                            ...
                                            & " AND MCR1.PTN_ID    = 'AK'                  " & vbNewLine _
                                            & "LEFT JOIN                                   " & vbNewLine _
...
#Region "印刷処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMI630IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMI630DAC.SQL_SELECT_MPRT)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI630DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMI630DAC", "SelectMPRT", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI630DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI630DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        Call Me.SetSQLSelectWhere()                       '条件設定(WHERE句)
        Me._StrSql.Append(LMI630DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用OrderBy句)
        ...
        MyBase.Logger.WriteSQLLog("LMI630DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMI630OUT")
