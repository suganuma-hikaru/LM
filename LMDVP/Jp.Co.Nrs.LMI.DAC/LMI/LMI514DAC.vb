...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特定荷主機能
'  プログラムID     :  LMI514DAC : 酢酸出荷依頼書(川本倉庫)(JNC)
'  作  成  者       :  
' ==========================================================================
Imports System.Text
...
#Region "印刷データ取得"
    ...
    Private Const SQL_SELECT_PRINT As String = "" _
            ...
            & "   KB1.KBN_NM1 AS DAIKO," & vbNewLine _
            & "   KB1.KBN_NM2 AS TANTO," & vbNewLine _
            & "   KB1.KBN_NM3 AS TEL," & vbNewLine _
            & "   KB1.KBN_NM4 AS FAX" & vbNewLine _
            & " FROM" & vbNewLine _
            ...
            & "   AND  KB1.KBN_GROUP_CD = 'J025'" & vbNewLine _
...
#Region "帳票パターン取得"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        Me._StrSql.Append(LMI514DAC.SQL_SELECT_MPRT)
...
#Region "印刷データ取得"
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQLの作成
        Me._StrSql = New StringBuilder()
        Me._StrSql.Append(LMI514DAC.SQL_SELECT_PRINT)
...
#Region "プリントフラグ更新"
    ...
    Private Function UpdatePrtFlg(ByVal ds As DataSet) As DataSet
        ...
        For dtIdx As Integer = 0 To ds.Tables(TABLE_NM.PRT_IN).Rows.Count - 1
            ...
            'SQLの作成
            Me._StrSql = New StringBuilder()
            Me._StrSql.Append(LMI514DAC.SQL_UPDATE_PRTFLG)
