...
#Region "編集処理"
    ...
    Private Function HaitaChk(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI513DAC.SQL_HAITA_CHK)
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "HaitaChk", cmd)
...
#Region "検索処理"
    ...
    Private Function SelectData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_COUNT)     'SQL構築(カウント用Select句)
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "SelectData", cmd)
    ...
    Private Function SelectListData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_FROM)      'SQL構築(データ抽出用From句)
        Me.SQLSelectWhere()                            'SQL構築(データ抽出用Where句)
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_ORDER_BY)  'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "SelectListData", cmd)
    ...
    Private Function ExcelMake(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMI513IN_TXT")
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "ExcelMake", cmd)
    ...
    Private Function SelectMSQLData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_COUNT)       'SQL構築(カウント用Select句)
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_FROM_CHECK)  'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI513DAC.SQL_SELECT_WHERE_CHECK) 'SQL構築(データ抽出用Where句)
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "SelectMSQLData", cmd)
...
#Region "変更処理"
    ...
    Private Function SaveData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "SaveData", cmd)
    ...
    Private Function DelRevSQL(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "DelRevSQL", cmd)
    ...
    Private Function SaveExcelData(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMI513DAC", "SaveExcelData", cmd)
    ...
    Private Sub SetInsertSQL(ByVal ds As DataTable, ByVal updateKeyword As String)
        ...
        'SQL作成
        Me._StrSql.Append(LMI513DAC.SQL_INSERT)     'SQL構築(INSERT文)
    ...
    Private Sub SetUpdateSQL(ByVal ds As DataTable, ByVal updateKeyword As String)
        ...
        'SQL作成
        Me._StrSql.Append(String.Concat(LMI513DAC.SQL_UPDATE, LMI513DAC.SQL_COM_UPDATE_CONDITION))     'SQL構築(UPDATE文)
    ...
    Private Sub SetUpdateExcelSQL(ByVal ds As DataTable, ByVal updateKeyword As String)
        ...
        'SQL作成
        Me._StrSql.Append(String.Concat(LMI513DAC.SQL_EXCEL_UPDATE, LMI513DAC.SQL_COM_UPDATE_CONDITION))     'SQL構築(UPDATE文)
    ...
    Private Sub SetDelRevSQL(ByVal ds As DataTable, ByVal updateKeyword As String)
        ...
        'SQL作成
        Me._StrSql.Append(String.Concat(LMI513DAC.SQL_DELREV, LMI513DAC.SQL_COM_UPDATE_CONDITION))     'SQL構築(UPDATE文)
