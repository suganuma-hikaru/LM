...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特殊荷主機能
'  プログラムID     :  LMI672DAC : 売上仕入伝票(DIC鑑種別：A+鑑種別B（横持料))
'  作  成  者       :  寺川
' ==========================================================================
Imports System.Text
...
#Region "印刷データ抽出用"
    ...
    Private Const SQL_SELECT As String = _
                    ...
                    & " , KAGAMI_KB              AS KAGAMI_KB                   " & vbNewLine _
                    & " FROM (                                                  " & vbNewLine
    ...
    Private Const SQL_SELECT_MAIN As String = _
                    ...
                    & ", DSM.YOKOMOCHI    AS YOKOMOCHI                          " & vbNewLine _
                    & ", DSM.KAGAMI_KB    AS KAGAMI_KB                          " & vbNewLine
    ...
    Private Const SQL_FROM As String = _
                    ...
                    & "  AND DSM.KAGAMI_KB    <> 'A'          --条件5(固定)     " & vbNewLine _
                    & "  AND DSM.KAGAMI_KB    <> 'B'          --条件6(固定)     " & vbNewLine
    ...
    Private Const SQL_GROUP_BY As String = _
                    ...
                    & " , MAIN.SKYU_DATE                                        " & vbNewLine _
                    & " , MAIN.KAGAMI_KB                                        " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI672DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI672DAC.SQL_FROM_MPrt)        'SQL構築(帳票種別用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMI672DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI672DAC.SQL_SELECT)         'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI672DAC.SQL_SELECT_MAIN)    'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI672DAC.SQL_FROM)           'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI672DAC.SQL_GROUP_BY)       'SQL構築(データ抽出用GroupBy句)
        ...
        MyBase.Logger.WriteSQLLog("LMI672DAC", "SelectPrintData", cmd)
