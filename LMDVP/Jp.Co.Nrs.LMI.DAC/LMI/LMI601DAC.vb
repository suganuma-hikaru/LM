...
#Region "SELECT句"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                                   " & vbNewLine _
                                          ...
                                          & " , UNSOM.UNSO_TTL_QT     AS UNSO_TTL_QT                                     " & vbNewLine _
                                          & " , UNSOM.BETU_WT         AS WT                                              " & vbNewLine _
                                          ...
                                          & " , UNSO.UNSO_NO_L        AS UNSO_NO_L                                       " & vbNewLine
...
#Region "FROM句"
    ...
    Private Const SQL_FROM As String = "FROM                                                               " & vbNewLine _
                                           ...
                                           & "AND MCR1.PTN_ID = 'AE'                                       " & vbNewLine _
                                           ...
                                           & "AND MCR2.PTN_ID = 'AE'                                       " & vbNewLine _
                                           & "--帳票パターン取得                                           " & vbNewLine _
                                           ...
                                           & "AND MR3.PTN_ID = 'AE'                                        " & vbNewLine _
                                           & "AND MR3.STANDARD_FLAG = '01'                                 " & vbNewLine _
                                           & "AND MR3.SYS_DEL_FLG = '0'                                    " & vbNewLine _
                                           & "	  WHERE UNCHIN.NRS_BR_CD   = @NRS_BR_CD                    " & vbNewLine _
                                           & "	  AND   UNCHIN.SYS_DEL_FLG = '0'                           " & vbNewLine _
                                           & " --(2012.10.12)要望番号1408 -- START --                      " & vbNewLine _
                                           & " -- AND   UNCHIN.DECI_UNCHIN <> 0                            " & vbNewLine _
                                           & "    AND   (UNCHIN.DECI_UNCHIN <> 0 OR                        " & vbNewLine _
                                           & "    (UNCHIN.SEIQ_GROUP_NO <> '' AND UNCHIN.DECI_UNCHIN = 0)) " & vbNewLine _
                                           & " --(2012.10.12)要望番号1408 --  END  --                      " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMI601IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMI601DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI601DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMI601DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI601DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI601DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMI601DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用OrderBy句)
        ...
        MyBase.Logger.WriteSQLLog("LMI601DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMI601OUT")
