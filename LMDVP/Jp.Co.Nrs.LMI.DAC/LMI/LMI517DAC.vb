...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特定荷主機能
'  プログラムID     :  LMI517DAC : イソブタノール依頼書(ｼﾝｺｰｹﾐ神戸)(JNC)
'  作  成  者       :  narita
' ==========================================================================
Imports System.Text
...
#Region "Const"
    ...
    Private Class TABLE_NM
        Public Const PRT_IN As String = "LMI517IN"
        Public Const PRT_OUT As String = "LMI517OUT"
...
#Region "印刷データ取得"
    ...
    Private Const SQL_SELECT_PRINT As String = "" _
            ...
            & " AND HED.OUTKA_DATE_A = @OUTKA_DATE_A" & vbNewLine _
...
#Region "帳票パターン取得"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        Me._StrSql.Append(LMI517DAC.SQL_SELECT_MPRT)
...
#Region "印刷データ取得"
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQLの作成
        Me._StrSql = New StringBuilder()
        Me._StrSql.Append(LMI517DAC.SQL_SELECT_PRINT)
    ...
    Private Sub SelectPrintDataSetCondition()
        ...
        With Me._Row
            ...
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@OUTKA_DATE_A", whereStr, DBDataType.CHAR))
...
#Region "プリントフラグ更新"
    ...
    Private Function UpdatePrtFlg(ByVal ds As DataSet) As DataSet
        ...
        For dtIdx As Integer = 0 To ds.Tables(TABLE_NM.PRT_IN).Rows.Count - 1
            ...
            'SQLの作成
            Me._StrSql = New StringBuilder()
            Me._StrSql.Append(LMI517DAC.SQL_UPDATE_PRTFLG)
