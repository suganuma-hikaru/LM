...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特殊荷主機能
'  プログラムID     :  LMI671DAC : 売上仕入伝票(DIC鑑種別：A+鑑種別B（横持料))
'  作  成  者       :  寺川
' ==========================================================================
Imports System.Text
...
#Region "印刷データ抽出用"
    ...
    Private Const SQL_FROM As String = _
                    ...
                    & "  AND DSM.KAGAMI_KB    = 'B'           --条件5(固定)     " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI671DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMI671DAC.SQL_FROM_MPrt)        'SQL構築(帳票種別用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMI671DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI671DAC.SQL_SELECT)         'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI671DAC.SQL_SELECT_MAIN)    'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMI671DAC.SQL_FROM)           'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMI671DAC.SQL_GROUP_BY)       'SQL構築(データ抽出用GroupBy句)
        ...
        MyBase.Logger.WriteSQLLog("LMI671DAC", "SelectPrintData", cmd)
