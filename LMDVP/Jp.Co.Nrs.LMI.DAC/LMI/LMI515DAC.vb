...
'  システム名       :  LM
'  サブシステム名   :  LMI       : 特定荷主機能
'  プログラムID     :  LMI515DAC : ファクシミリ連絡票(三菱ケミカル)(JNC)
'  作  成  者       :  narita
' ==========================================================================
Imports System.Text
...
#Region "Const"
    ...
    Private Class TABLE_NM
        Public Const PRT_IN As String = "LMI515IN"
        Public Const PRT_OUT As String = "LMI515OUT"
...
#Region "印刷データ取得"
    ...
    Private Const SQL_SELECT_PRINT As String = "" _
            ...
            & "   KB1.KBN_NM1 AS TANTO," & vbNewLine _
            & "   KB1.KBN_NM2 AS TEL," & vbNewLine _
            & "   KB1.KBN_NM3 AS FAX," & vbNewLine _
            ...
            & "   AND  KB1.KBN_GROUP_CD = 'J026'" & vbNewLine _
            & "   AND  KB1.KBN_CD = '01'" & vbNewLine
...
#Region "帳票パターン取得"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        Me._StrSql.Append(LMI515DAC.SQL_SELECT_MPRT)
...
#Region "印刷データ取得"
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQLの作成
        Me._StrSql = New StringBuilder()
        Me._StrSql.Append(LMI515DAC.SQL_SELECT_PRINT)
...
#Region "プリントフラグ更新"
    ...
    Private Function UpdatePrtFlg(ByVal ds As DataSet) As DataSet
        ...
        For dtIdx As Integer = 0 To ds.Tables(TABLE_NM.PRT_IN).Rows.Count - 1
            ...
            'SQLの作成
            Me._StrSql = New StringBuilder()
            Me._StrSql.Append(LMI515DAC.SQL_UPDATE_PRTFLG)
