...
#Region "検索処理 SQL"
    ...
    Private Const SQL_MPrt_FROM As String = "  FROM $LM_TRN$..F_UNCHIN_TRS UNCHIN                                " & vbNewLine _
                                          ...
                                          & "           AND MCR1.PTN_ID = 'A8'                                   " & vbNewLine _
                                          ...
                                          & "           AND MCR2.PTN_ID = 'A8'                                   " & vbNewLine _
                                          & "       --帳票パターン取得                                           " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrintPattern(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMI590IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMI590DAC.SQL_MPrt_SELECT)    'SQL構築(帳票種別用SELECT句)
        Me._StrSql.Append(LMI590DAC.SQL_MPrt_FROM)      'SQL構築(帳票種別用FROM句)
        ...
        MyBase.Logger.WriteSQLLog("LMI590DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMI590DAC.SQL_SELECT)      'SQL構築(印刷データ抽出用 SELECT句)
        Me._StrSql.Append(LMI590DAC.SQL_FROM)        'SQL構築(印刷データ抽出用 FROM句)
        Call Me.SetConditionMasterSQL()              'SQL構築(印刷データ抽出条件設定)
        Me._StrSql.Append(LMI590DAC.SQL_GROUP_BY)    'SQL構築(印刷データ抽出用 GROUP BY句)
        Me._StrSql.Append(LMI590DAC.SQL_ORDER_BY)    'SQL構築(印刷データ抽出用 ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMI590DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMI590OUT")
