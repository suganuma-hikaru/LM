...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMD540DAC = New LMD540DAC()
...
#Region "Const"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const ACTION_ID_SELECT_PRT_DATA As String = "SelectListRptDataLot"
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = LMD540BLC.TABLE_NM_IN
        Dim tableNmOut As String = LMD540BLC.TABLE_NM_OUT
        Dim tableNmRpt As String = LMD540BLC.TABLE_NM_M_RPT
        ...
        workDtRpt = view.ToTable(True, LMD540BLC.NRS_BR_CD, LMD540BLC.PTN_ID, LMD540BLC.PTN_CD, LMD540BLC.RPT_ID)
        ...
        For Each dr As DataRow In ds.Tables(tableNmRpt).Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables(tableNmOut), dr.Item(LMD540BLC.RPT_ID).ToString())
            '帳票ごとの編集があるなら行う。
            prtDs = Me.EditPrintDataSet(dr.Item(LMD540BLC.RPT_ID).ToString(), prtDs)
            '帳票CSV出力
            comPrt.StartPrint(Me, dr.Item(LMD540BLC.NRS_BR_CD).ToString(), _
                                dr.Item(LMD540BLC.PTN_ID).ToString(), _
                                dr.Item(LMD540BLC.PTN_CD).ToString(), _
                                dr.Item(LMD540BLC.RPT_ID).ToString(), _
    ...
    Private Function EditPrintDataSet(ByVal rptId As String, ByVal ds As DataSet) As DataSet
        ...
        Dim dt As DataTable = ds.Tables(LMD540BLC.TABLE_NM_OUT)
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        ds = MyBase.CallDAC(Me._Dac, LMD540BLC.ACTION_ID_SELECT_MPRT, ds)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Return MyBase.CallDAC(Me._Dac2, LMD540BLC.ACTION_ID_SELECT_PRT_DATA, ds)
