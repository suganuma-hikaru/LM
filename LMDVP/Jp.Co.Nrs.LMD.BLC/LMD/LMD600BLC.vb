...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMD600DAC = New LMD600DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = LMD600BLC.TABLE_NM_IN
        Dim tableNmOut As String = LMD600BLC.TABLE_NM_OUT
        Dim tableNmRpt As String = LMD600BLC.TABLE_NM_M_RPT
        ...
        workDtRpt = view.ToTable(True, LMD600BLC.NRS_BR_CD, LMD600BLC.PTN_ID, LMD600BLC.PTN_CD, LMD600BLC.RPT_ID)
        ...
        For Each dr As DataRow In ds.Tables(tableNmRpt).Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する。
            prtDs = comPrt.CallDataSet(ds.Tables(tableNmOut), dr.Item(LMD600BLC.RPT_ID).ToString())
            '帳票ごとの編集があるなら行う。
            prtDs = Me.EditPrintDataSet(dr.Item(LMD600BLC.RPT_ID).ToString(), prtDs)
            '帳票CSV出力
            comPrt.StartPrint(Me, dr.Item(LMD600BLC.NRS_BR_CD).ToString(), _
                                dr.Item(LMD600BLC.PTN_ID).ToString(), _
                                dr.Item(LMD600BLC.PTN_CD).ToString(), _
                                dr.Item(LMD600BLC.RPT_ID).ToString(), _
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        ds = MyBase.CallDAC(Me._Dac, LMD600BLC.ACTION_ID_SELECT_MPRT, ds)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Return MyBase.CallDAC(Me._Dac, LMD600BLC.ACTION_ID_SELECT_PRT_DATA, ds)
