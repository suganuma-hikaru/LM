...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMD510DAC = New LMD510DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMD510IN"
        Dim tableNmOut As String = "LMD510OUT"
    ...
    Private Function EditPrintDataSet(ByVal prtId As String, ByVal ds As DataSet) As DataSet
        ...
        Select Case prtId
            ...
            ''LMD510の場合は営業所コード、荷主コード(大)、倉庫コード、
            ''棟番号、室番号、ZONEコード、ロケーション、商品コード、ロット番号の順番でソートする
            'Case "LMD510"
            '    'ソート対象データテーブル取得
            '    Dim outDt As DataTable = ds.Tables("LMD510OUT")
            '    'ソート条件設定
            ...
            '        rtnDs.Tables("LMD510OUT").ImportRow(row)
            '    Next
