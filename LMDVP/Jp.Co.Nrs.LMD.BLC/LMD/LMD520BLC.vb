...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMD520DAC = New LMD520DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMD520IN"
        Dim tableNmOut As String = "LMD520OUT"
    ...
    Private Function EditPrintDataSet(ByVal prtId As String, ByVal ds As DataSet) As DataSet
        ...
        Select Case prtId
            'LMD520の場合は営業所コード、荷主コード(大)、倉庫コード、
            '棟番号、室番号、ZONEコード、ロケーション、商品コード、ロット番号の順番でソートする
            Case "LMD520"
                'ソート対象データテーブル取得
                Dim outDt As DataTable = ds.Tables("LMD520OUT")
                'ソート条件設定
                Dim sort As String = "NRS_BR_CD ASC, CUST_CD_L ASC, CUST_CD_M ASC, GOODS_CD_CUST ASC,SEARCH_KEY_1 ASC, LOT_NO ASC, SERIAL_NO ASC , IRIME ASC"
                'ソート実行
                ...
                For Each row As DataRow In dr
                    rtnDs.Tables("LMD520OUT").ImportRow(row)
                Next
