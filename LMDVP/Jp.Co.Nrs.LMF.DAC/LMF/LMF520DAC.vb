...
#Region "SELECT句"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                        " & vbNewLine _
                                          ...
                                          & "--★変更START 要望番号1014  2012/04/25(出力件数対策)　岸★             " & vbNewLine _
                                          & " , CASE WHEN CUST.CUST_NM_L IS NOT NULL THEN CUST.CUST_NM_L            " & vbNewLine _
                                          & "        WHEN CUST2.CUST_NM_L IS NOT NULL THEN CUST2.CUST_NM_L          " & vbNewLine _
                                          & "        ELSE ''                                                        " & vbNewLine _
                                          & "   END                   AS CUST_NM_L                                  " & vbNewLine _
                                          & " , CASE WHEN CUST.CUST_NM_M IS NOT NULL THEN CUST.CUST_NM_M            " & vbNewLine _
                                          & "        WHEN CUST2.CUST_NM_M IS NOT NULL THEN CUST2.CUST_NM_M          " & vbNewLine _
                                          & "        ELSE ''                                                        " & vbNewLine _
                                          & "   END                   AS CUST_NM_M                                  " & vbNewLine _
                                          & " , CASE WHEN CUST.CUST_NM_S IS NOT NULL THEN CUST.CUST_NM_S            " & vbNewLine _
                                          & "        WHEN CUST2.CUST_NM_S IS NOT NULL THEN CUST2.CUST_NM_S          " & vbNewLine _
                                          & "        ELSE ''                                                        " & vbNewLine _
                                          & "   END                   AS CUST_NM_S                                  " & vbNewLine _
                                          & " , CASE WHEN CUST.CUST_NM_SS IS NOT NULL THEN CUST.CUST_NM_SS          " & vbNewLine _
                                          & "        WHEN CUST2.CUST_NM_SS IS NOT NULL THEN CUST2.CUST_NM_SS        " & vbNewLine _
                                          & "        ELSE ''                                                        " & vbNewLine _
                                          ...
                                          & "--★変更END 要望番号1014  2012/04/25(出力件数対策)　岸★" & vbNewLine _
                                          ...
                                          & " ,ISNULL(GOODS.SEARCH_KEY_1,'')    AS SEARCH_KEY_1" & vbNewLine _
                                          & "--★変更END 要望番号1014  2012/04/25(出力件数対策)　岸★" & vbNewLine _
                                          ...
                                          & "--★変更START 要望番号1014  2012/04/25(出力件数対策)　篠原★" & vbNewLine _
                                          & "-- ,CASE                                                    " & vbNewLine _
                                          & "-- WHEN KBN.KBN_NM1=UNCHIN.SEIQ_TARIFF_CD THEN '1'          " & vbNewLine _
                                          & "-- ELSE '2'                                                 " & vbNewLine _
                                          & "-- END                    AS LINE_ZONE_KB                   " & vbNewLine _
                                          & " ,CASE                                                      " & vbNewLine _
                                          & " WHEN KBN.KBN_NM1 IS NOT NULL THEN KBN_NM2                  " & vbNewLine _
                                          & " ELSE '3'                                                   " & vbNewLine _
                                          & " END                    AS LINE_ZONE_KB                     " & vbNewLine _
                                          & "--★変更END 要望番号1014    2012/04/25(出力件数対策)　篠原★" & vbNewLine _
                                          & "-- ,GOODS.SEARCH_KEY_1 + '・' + UNCHIN.SEIQ_TARIFF_CD AS KEY_1" & vbNewLine _
                                          & " ,ISNULL(GOODS.SEARCH_KEY_1,'') + '・' + UNCHIN.SEIQ_TARIFF_CD AS KEY_1" & vbNewLine
...
#Region "FROM句"
    ...
    Private Const SQL_FROM As String = "FROM                                                         " & vbNewLine _
                                          ...
                                          & "--★変更START 要望番号1014  2012/04/25(出力件数対策)　岸★           " & vbNewLine _
                                            & "	 --荷主マスタ2                                  			  " & vbNewLine _
                                            & "	 LEFT JOIN $LM_MST$..M_CUST AS CUST2              			  " & vbNewLine _
                                            & "	 ON UNCHIN.CUST_CD_L=CUST2.CUST_CD_L              		  " & vbNewLine _
                                            & "	 AND UNCHIN.CUST_CD_M = CUST2.CUST_CD_M          			  " & vbNewLine _
                                            & "	 AND UNCHIN.NRS_BR_CD=CUST2.NRS_BR_CD              		  " & vbNewLine _
                                            & "	 AND UNCHIN.CUST_CD_S= CUST2.CUST_CD_S              		  " & vbNewLine _
                                            & "	 AND UNCHIN.CUST_CD_SS= CUST2.CUST_CD_SS          		  " & vbNewLine _
                                          & "--★変更END 要望番号1014  2012/04/25(出力件数対策)　岸★             " & vbNewLine _
                                            & "	 --営業所マスタ                                  		  " & vbNewLine _
                                            ...
                                            & "	ON KBN.KBN_GROUP_CD='R003'				                  " & vbNewLine _
                                            & "--★変更START 要望番号1014  2012/04/25(出力件数対策)　篠原★" & vbNewLine _
                                            & " AND KBN.KBN_NM1      = UNCHIN.SEIQ_TARIFF_CD               " & vbNewLine _
                                            & "--★変更END   要望番号1014  2012/04/25(出力件数対策)　篠原★" & vbNewLine _
                                            ...
                                            & "AND MCR1.PTN_ID = '42'                                      " & vbNewLine _
                                            ...
                                            & "AND MCR2.PTN_ID = '42'                                      " & vbNewLine _
                                            & "--帳票パターン取得                                          " & vbNewLine _
...
#Region "ORDER BY"
    ...
    Private Const SQL_ORDER_BY As String = "ORDER BY                                          " & vbNewLine _
                                         ...
                                         & "    ,LINE_ZONE_KB                                 " & vbNewLine _
                                         & "    ,KEY_1                                        " & vbNewLine _
                                         & "    ,UNSO.OUTKA_PLAN_DATE                         " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMF520IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMF520DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMF520DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMF520DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF520DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMF520DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMF520DAC.SQL_ORDER_BY)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMF520DAC", "SelectPrintData", cmd)
        ...
        map.Add("LINE_ZONE_KB", "LINE_ZONE_KB")
        map.Add("KEY", "KEY_1")

        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMF520OUT")
