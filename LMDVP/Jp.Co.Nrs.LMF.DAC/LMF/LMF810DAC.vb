...
#Region "SQL"
    ...
    Private Const SQL_GET_UNSOL As String = " SELECT                                                                " & vbNewLine _
                                          ...
                                          & " --★2013.03.19 / NOTES 1911 対応 開始                                 " & vbNewLine _
                                          & "    ,UNSOCO.TARE_YN                  AS UNSO_TARE_YN                   " & vbNewLine _
                                          & " --★2013.03.19 / NOTES 1911 対応 終了                                 " & vbNewLine _
                                          & "    ,CASE WHEN UNSOL.MOTO_DATA_KB = '20' THEN M03_02.JIS_CD                    " & vbNewLine _
                                          & "                                         ELSE ISNULL(M10_01.JIS,M10_04.JIS)    " & vbNewLine _
                                          & "     END                                        ORIG_JIS_CD                    " & vbNewLine _
                                          & "    ,CASE WHEN UNSOL.MOTO_DATA_KB = '10' THEN M03_01.JIS_CD                    " & vbNewLine _
                                          ...
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_TRN$..B_INKA_L B01_01                                         " & vbNewLine _
                                          & "     ON  B01_01.NRS_BR_CD   = UNSOL.NRS_BR_CD                          " & vbNewLine _
                                          & "     AND B01_01.INKA_NO_L  = UNSOL.INOUTKA_NO_L                        " & vbNewLine _
                                          & "     AND B01_01.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_TRN$..C_OUTKA_L C01_01                                        " & vbNewLine _
                                          & "     ON  C01_01.NRS_BR_CD   = UNSOL.NRS_BR_CD                          " & vbNewLine _
                                          & "     AND C01_01.OUTKA_NO_L  = UNSOL.INOUTKA_NO_L                       " & vbNewLine _
                                          & "     AND C01_01.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_MST$..M_SOKO M03_01                                           " & vbNewLine _
                                          & "     ON  M03_01.WH_CD       = B01_01.WH_CD                             " & vbNewLine _
                                          & "     AND M03_01.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_MST$..M_SOKO M03_02                                           " & vbNewLine _
                                          & "     ON  M03_02.WH_CD       = C01_01.WH_CD                             " & vbNewLine _
                                          & "     AND M03_02.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_MST$..M_DEST M10_01                                           " & vbNewLine _
                                          & "     ON  M10_01.NRS_BR_CD   = UNSOL.NRS_BR_CD                          " & vbNewLine _
                                          & "     AND M10_01.CUST_CD_L   = UNSOL.CUST_CD_L                          " & vbNewLine _
                                          & "     AND M10_01.DEST_CD     = UNSOL.ORIG_CD                            " & vbNewLine _
                                          & "     AND M10_01.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_MST$..M_DEST M10_02                                           " & vbNewLine _
                                          & "     ON  M10_02.NRS_BR_CD   = UNSOL.NRS_BR_CD                          " & vbNewLine _
                                          & "     AND M10_02.CUST_CD_L   = UNSOL.CUST_CD_L                          " & vbNewLine _
                                          & "     AND M10_02.DEST_CD     = UNSOL.DEST_CD                            " & vbNewLine _
                                          & "     AND M10_02.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_MST$..M_DEST M10_04                                           " & vbNewLine _
                                          & "     ON  M10_04.NRS_BR_CD   = UNSOL.NRS_BR_CD                          " & vbNewLine _
                                          & "     AND M10_04.CUST_CD_L   = 'ZZZZZ'                                  " & vbNewLine _
                                          & "     AND M10_04.DEST_CD     = UNSOL.ORIG_CD                            " & vbNewLine _
                                          & "     AND M10_04.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & "  LEFT OUTER JOIN                                                      " & vbNewLine _
                                          & "     $LM_MST$..M_DEST M10_05                                           " & vbNewLine _
                                          & "     ON  M10_05.NRS_BR_CD   = UNSOL.NRS_BR_CD                          " & vbNewLine _
                                          & "     AND M10_05.CUST_CD_L   = 'ZZZZZ'                                  " & vbNewLine _
                                          & "     AND M10_05.DEST_CD     = UNSOL.DEST_CD                            " & vbNewLine _
                                          & "     AND M10_05.SYS_DEL_FLG = '0'                                      " & vbNewLine _
                                          & " WHERE                                                                 " & vbNewLine _
                                          & "     UNSOL.UNSO_NO_L   = @UNSO_NO_L                                    " & vbNewLine _
                                          & " AND UNSOL.SYS_DEL_FLG = '0'                                           " & vbNewLine

    '2013.03.19 / NOTES1911 対応前 (バックログ)
    '" SELECT                                                                " & vbNewLine _
    '                                      & "     *                                                                 " & vbNewLine _
    '                                      & "    ,ISNULL(UNSOCO.SHIHARAITO_CD,'') AS SHIHARAITO_CD                  " & vbNewLine _
    '                                      & " FROM                                                                  " & vbNewLine _
    ...
    ''' <summary>
    ''' [F_SHIHARAI_TRS]請求グループ番号設定レコード件数取得用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_GET_GROUP_REC_COUNT As String = " SELECT                                                " & vbNewLine _
                                                    ...
                                                    & "     WHERE                                             " & vbNewLine _
                                                    & "         UNSO_NO_L      = @UNSO_NO_L                   " & vbNewLine _
                                                    & "     AND SHIHARAI_GROUP_NO <> ''                       " & vbNewLine _
                                                    & "     AND SYS_DEL_FLG    = '0'                          " & vbNewLine _
                                                    & " ) GRUP                                                " & vbNewLine _
                                                    & " ,                                                     " & vbNewLine _
                                                    & " (                                                     " & vbNewLine _
                                                    ...
                                                    & "     WHERE                                             " & vbNewLine _
                                                    & "         UNSO_NO_L       = @UNSO_NO_L                  " & vbNewLine _
                                                    & "     AND SHIHARAI_FIXED_FLAG = '01'                    " & vbNewLine _
                                                    & "     AND SYS_DEL_FLG     = '0'                         " & vbNewLine _
                                                    & " ) DECI                                                " & vbNewLine
    ...
    Private Const SQL_GET_GOODS_CUST As String = " SELECT                                                 " & vbNewLine _
                                               ...
                                               & "     INNER JOIN                                         " & vbNewLine _
                                               & "         $LM_TRN$..F_UNSO_L UNSOL                       " & vbNewLine _
                                               & "     ON  UNSOL.UNSO_NO_L = UNS.UNSO_NO_L                " & vbNewLine _
    ...
    ''' <summary>
    ''' [M_SHIHARAI_TARIFF]テーブルタイプ 取得用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_GET_TABLE_TYPE As String = " SELECT DISTINCT                          " & vbNewLine _
                                               & "     TABLE_TP                             " & vbNewLine _
                                               & " FROM                                     " & vbNewLine _
                                               & "     $LM_MST$..M_SHIHARAI_TARIFF          " & vbNewLine _
                                               & " WHERE                                    " & vbNewLine _
                                               & "     NRS_BR_CD        = @NRS_BR_CD        " & vbNewLine _
                                               & " AND SHIHARAI_TARIFF_CD = @SHIHARAI_TARIFF_CD " & vbNewLine _
                                               & " AND DATA_TP          = @DATA_TP          " & vbNewLine _
                                               & " AND SYS_DEL_FLG      = '0'               " & vbNewLine

    ''' <summary>
    ''' [M_YOKO_TARIFF_HD_SHIHARAI]横持ち運賃タリフヘッダ 取得用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_GET_YOKO_HD As String = " SELECT                                 " & vbNewLine _
                                            & "     *                                  " & vbNewLine _
                                            & " FROM                                   " & vbNewLine _
                                            & "     $LM_MST$..M_YOKO_TARIFF_HD_SHIHARAI " & vbNewLine _
                                            & " WHERE                                  " & vbNewLine _
                                            & "     NRS_BR_CD      = @NRS_BR_CD        " & vbNewLine _
...
#Region "SQL"
    ...
    ''' <summary>
    ''' [M_SHIHARAI_TARIFF]運賃タリフ 適用・距離情報取得用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_TARIFF_BASE As String = " SELECT                                               " & vbNewLine _
                                            & "     MAIN.*                                           " & vbNewLine _
                                            & " FROM                                                 " & vbNewLine _
                                            & "     $LM_MST$..M_SHIHARAI_TARIFF AS MAIN              " & vbNewLine _
                                            & "     INNER JOIN                                       " & vbNewLine _
                                            & "        (                                             " & vbNewLine _
                                            & "         SELECT                                       " & vbNewLine _
                                            ...
                                            & "            ,TABLE_TP                                 " & vbNewLine _
                                            & "        ) AS SUB                                      " & vbNewLine _
                                            & "     ON  MAIN.SHIHARAI_TARIFF_CD = SUB.SHIHARAI_TARIFF_CD " & vbNewLine _
    ...
    ''' <summary>
    ''' [M_SHIHARAI_TARIFF]運賃タリフ 重量情報取得用
    ''' </summary>
    ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' [M_SYUHAI_SET_SHIHARAI]集配料設定ファイル 情報取得用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_EXTC_SHUHAI As String = " SELECT                                    " & vbNewLine _
                                            & "     *                                     " & vbNewLine _
                                            & " FROM                                      " & vbNewLine _
                                            & "     $LM_MST$..M_SYUHAI_SET_SHIHARAI       " & vbNewLine _
                                            & " WHERE                                     " & vbNewLine _
                                            & "     NRS_BR_CD        = @NRS_BR_CD         " & vbNewLine _
                                            & " AND CUST_CD_L        = @CUST_CD_L         " & vbNewLine _
                                            & " AND SHIHARAI_TARIFF_CD = @SHIHARAI_TARIFF_CD " & vbNewLine _
    ...
    ''' <summary>
    ''' [M_EXTC_SHIHARAI]割増運賃マスタ 情報取得用
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_EXTC_SHIHARAI As String = " SELECT                                  " & vbNewLine _
                                            & "     *                                     " & vbNewLine _
                                            & " FROM                                      " & vbNewLine _
                                            & "     $LM_MST$..M_EXTC_SHIHARAI             " & vbNewLine _
                                            & " WHERE                                     " & vbNewLine _
                                            & "     NRS_BR_CD        = @NRS_BR_CD         " & vbNewLine _
    ...
    ''' <summary>
    ''' [M_YOKO_TARIFF_HD_SHIHARAI]横持ちタリフヘッダ 取得用
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Const SQL_YOKO_DTL As String = " SELECT                                  " & vbNewLine _
                                        ...
                                        & " FROM                                     " & vbNewLine _
                                        & "     $LM_MST$..M_YOKO_TARIFF_DTL_SHIHARAI " & vbNewLine _
                                        & " WHERE                                    " & vbNewLine _
                                        & "     NRS_BR_CD        = @NRS_BR_CD        " & vbNewLine _
                                        & " AND YOKO_TARIFF_CD   = @YOKO_TARIFF_CD   " & vbNewLine _
...
#Region "事前確認"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_GET_SHIHARAI_TARIFF_COUNT As String _
        = " SELECT                                               " & vbNewLine _
        ...
        & "        +                                             " & vbNewLine _
        & "        (SELECT count(*)                              " & vbNewLine _
        & "           FROM $LM_MST$..M_YOKO_TARIFF_HD_SHIHARAI   " & vbNewLine _
        & "          WHERE SYS_DEL_FLG = '0'                     " & vbNewLine _
        & "            AND NRS_BR_CD   =  @NRS_BR_CD)            " & vbNewLine _
        & "        AS SELECT_COUNT                               " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function GetUnsoL(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_UNSOL)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetUnsoL", cmd)
    ...
    Private Function GetUnsoM(ByVal ds As DataSet) As DataSet
        ...
        Select Case ds.Tables(TABLE_NM_IN).Rows(0).Item("UNSO_M_LV_KBN").ToString
            Case LVL_UNSOU
                Me._StrSql.Append(LMF810DAC.SQL_GET_UNSOM_ALL)
            Case LVL_TAKYU
                Me._StrSql.Append(LMF810DAC.SQL_GET_UNSOM_TAKKYU_GROUP)
        End Select
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetUnsoM", cmd)
    ...
    Private Function GetBpUNsoWt(ByVal ds As DataSet) As DataSet
        ...
        Select Case Me._Row.Item("MOTO_DATA_KB").ToString()
            ...
            Case LMF810DAC.INKA
                ...
                Return ds
                'Me._StrSql.Append(LMF810DAC.SQL_GET_BP_EDI_IN)

            Case LMF810DAC.OUTKA

                Me._StrSql.Append(LMF810DAC.SQL_GET_BP_EDI_OUT)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetBpUNsoWt", cmd)
    ...
    '2013.03.27 / NOTES 1911 ADD START
    ''' <summary>
    ...
    Private Function GetAlctd_Kb(ByVal ds As DataSet) As DataSet
        ...
        Me._StrSql.Append(LMF810DAC.SQL_GET_ALCTD)
    ...
    Private Function GetUnsoMGroup(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_UNSOM_GROUP)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetUnsoMGroup", cmd)
    ...
    Private Function GetSeiqGroupCount(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_GROUP_REC_COUNT)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetSeiqGroupCount", cmd)
    ...
    Private Function GetGoodsCustInfo(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_GOODS_CUST)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetGoodsCustInfo", cmd)
    ...
    Private Function GetGoodsCustInfoSecond(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_GOODS_CUST2)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetGoodsCustInfoSecond", cmd)
    ...
    Private Function GetKyoriDestMst(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_KYORI_DEST_MST)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetKyoriDestMst", cmd)
    ...
    Private Function GetKyoriKyoriMst(ByVal ds As DataSet) As DataSet
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetKyoriKyoriMst", cmd)
    ...
    Private Function GetTableType(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_TABLE_TYPE)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetTableType", cmd)
    ...
    Private Function GetYokoTariffHd(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_YOKO_HD)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetYokoTariffHd", cmd)
    ...
    Private Function GetUnsoMRevUnit(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_REV_UNIT)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetUnsoMRevUnit", cmd)
...
#Region "SQL文構築"
    ...
    Private Sub CreateSqlForRefKyoriMst()
        ...
        Me._StrSql.Append(LMF810DAC.SQL_GET_KYORI_MST_HDR)      '上部

        With Me._Row
            '元データ区分により発地・届先の参照先を切替える
            Select Case .Item("MOTO_DATA_KB").ToString
                Case LMF810DAC.MOTO_NYUKA
                    Me._StrSql.Append(LMF810DAC.SQL_GET_NYUKA_JIS)      'JIS取得（入荷）
                Case LMF810DAC.MOTO_SHUKA
                    Me._StrSql.Append(LMF810DAC.SQL_GET_SHUKA_JIS)      'JIS取得（出荷）
                Case LMF810DAC.MOTO_UNSOU
                    Me._StrSql.Append(LMF810DAC.SQL_GET_UNSOU_JIS)      'JIS取得（運送）
            End Select

            Me._StrSql.Append(LMF810DAC.SQL_GET_KYORI_MST_DTL)      '下部

            If LMF810DAC.MOTO_UNSOU.Equals(.Item("MOTO_DATA_KB").ToString) = True Then
                Me._StrSql.Append(LMF810DAC.SQL_GET_KYORI_MST_ORDER)      '順序（運送のときのみ）
            End If
...
#Region "パラメータ設定"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetParamGoodsCustSecond()
    ...
    ''' <summary>
    ''' パラメータ設定 [テーブルタイプ取得 M_SHIHARAI_TARIFF]
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetParamTableType()
        ...
        With Me._Row
            ...
            Select Case .Item("UNSO_ONDO_KB").ToString
                Case LMF810DAC.ONDO_TEION, LMF810DAC.ONDO_HOREI
                    Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATA_TP", LMF810DAC.DATA_TYPE_HOREI, DBDataType.CHAR))
                Case Else
                    Me._SqlPrmList.Add(MyBase.GetSqlParameter("@DATA_TP", LMF810DAC.DATA_TYPE_UNCHN, DBDataType.CHAR))
            End Select
    ...
    ''' <summary>
    ''' パラメータ設定 [横持ちタリフヘッダ取得 M_YOKO_TARIFF_HD_SHIHARAI]
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetParamYokoHd()
        ...
        With Me._Row
            ...
            'パラメータ設定
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", .Item("NRS_BR_CD").ToString(), DBDataType.CHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@YOKO_TARIFF_CD", .Item("SHIHARAI_TARIFF_CD").ToString(), DBDataType.CHAR))
...
#Region "検索処理"
    ...
    Private Function GetDestJis(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_MST_DEST_JIS)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetDestJis", cmd)
    ...
    Private Function GetTariffBase(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_TARIFF_BASE)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetTariffBase", cmd)
    ...
    Private Function GetTariffWeight(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_TARIFF_WEIGHT)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetTariffWeight", cmd)
    ...
    Private Function GetExtcShuhai(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_EXTC_SHUHAI)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetExtcShuhai", cmd)
    ...
    Private Function GetExtcShiharai(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_EXTC_SHIHARAI)

        'パラメータ設定
        Call Me.SetParamExtcShiharai()
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetExtcShiharai", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, TABLE_NM_CALC_E_SHIHARAI)
    ...
    Private Function GetYokoTariffHead(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_YOKO_HD)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetYokoTariffHead", cmd)
    ...
    Private Function GetYokoTariffDetail(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_YOKO_DTL)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetYokoTariffDetail", cmd)
    ...
    ''' <param name="ds">DataSet</param>
    ''' <returns>DataSet</returns>
    ''' <remarks>対象顧客が運賃レコード複数作成用の "特別荷主" であるか判断</remarks>
    Private Function GetAdjustCust(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_ADJUST_CUST)
        ...
        MyBase.Logger.WriteSQLLog("LMF810DAC", "GetAdjustCust", cmd)
    ...
    ''' <returns>DataSet</returns>
    ''' <remarks></remarks>
    Private Function GetShiharaiTariffCountByNrsBrCd(ByVal ds As DataSet) As DataSet

        'DataSetのIN情報を取得
        Dim inTable As DataTable = ds.Tables(TABLE_NM_IN)

        'INTableの条件rowの格納
        Me._Row = inTable.Rows(0)

        'SQL格納変数の初期化
        Me._StrSql = New StringBuilder()

        'SQL作成
        Me._StrSql.Append(LMF810DAC.SQL_GET_SHIHARAI_TARIFF_COUNT)

        'パラメータ設定
        Me.SetParamShiharaiInData()

        'SQL文のコンパイル
        Using cmd As SqlCommand = MyBase.CreateSqlCommand(Me.SetSchemaNm(Me._StrSql.ToString() _
            ...
            Using reader As SqlDataReader = MyBase.GetSelectResult(cmd)
                ...
                '処理件数の設定
                reader.Read()
                MyBase.SetResultCount(Convert.ToInt32(reader("SELECT_COUNT")))
...
#Region "パラメータ設定"
    ...
    ''' <summary>
    ''' パラメータ設定 [M_SHIHARAI_TARIFF] to Kyori
    ''' </summary>
    ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' パラメータ設定 [M_SHIHARAI_TARIFF] To Weight
    ''' </summary>
    ''' <param name="ds">DataSet</param>
    ''' <remarks></remarks>
    Private Sub SetParamTariffWeight(ByVal ds As DataSet)
        ...
        Me._SqlPrmList.Add(MyBase.GetSqlParameter("@SHIHARAI_TARIFF_CD", ds.Tables(TABLE_NM_CALC_KYORI).Rows(0).Item("SHIHARAI_TARIFF_CD").ToString(), DBDataType.NVARCHAR))
    ...
    ''' <summary>
    ''' パラメータ設定 [M_EXTC_SHIHARAI]
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetParamExtcShiharai()
        ...
        With Me._Row
            ...
            'パラメータ設定
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", .Item("NRS_BR_CD").ToString(), DBDataType.CHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@EXTC_TARIFF_CD", .Item("SHIHARAI_ETARIFF_CD").ToString(), DBDataType.CHAR))
            Me._SqlPrmList.Add(MyBase.GetSqlParameter("@JIS_CD", .Item("DEST_JIS").ToString(), DBDataType.CHAR))
    ...
    ''' <summary>
    ''' パラメータ設定 [M_YOKO_TARIFF_HD_SHIHARAI]
    ''' </summary>
    ''' <remarks></remarks>
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetParamShiharaiInData()
