...
#Region "SELECT句"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                                   " & vbNewLine _
                                          ...
                                          & ", (CASE WHEN UNCHIN.NRS_BR_CD = '50' AND UNCHIN.CUST_CD_L = '10001' AND UNCHIN.CUST_CD_M = '00' AND (UNCHIN.CUST_CD_S = '06' OR  UNCHIN.CUST_CD_S = '07') AND UNCHIN.CUST_CD_SS = '00' THEN    " & vbNewLine _
                                          & "        case                         " & vbNewLine _
                                          & "            when UNCHIN.CUST_CD_S = '06' and GOODS.GOODS_CD_CUST='IB_M1107SG' then '0'     " & vbNewLine _
                                          & "            when UNCHIN.CUST_CD_S = '07' and GOODS.GOODS_CD_CUST='IB_1111GDR' then '0'    " & vbNewLine _
                                          & "            when UNSO.DEST_CD = 'ZZZ10003' or UNSO.DEST_CD = 'TABF606L'  then '91'    " & vbNewLine _
                                          & "            else '2' end             " & vbNewLine _
                                          & "        ELSE '0' END) AS DIC_GRP                " & vbNewLine
...
#Region "FROM句"
    ...
    Private Const SQL_FROM As String = "FROM                                                              " & vbNewLine _
                                           ...
                                           & "AND MCR1.PTN_ID = 'A4'                                      " & vbNewLine _
                                           ...
                                           & "AND MCR2.PTN_ID = 'A4'                                      " & vbNewLine _
                                           & "--帳票パターン取得                                          " & vbNewLine _
...
#Region "ORDER BY"
    ...
    '(2012.09.26)要望番号：1471  --- START ---
    ''' <summary>
    ''' ORDER BY
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_ORDER_BY_LMF591 As String = " ORDER BY                        " & vbNewLine _
                                                & "       UNCHIN.CUST_CD_L      ASC " & vbNewLine _
                                                & "     , UNCHIN.CUST_CD_M      ASC " & vbNewLine _
                                                & "     , UNCHIN.CUST_CD_S      ASC " & vbNewLine _
                                                & "     , UNCHIN.CUST_CD_SS     ASC " & vbNewLine _
                                                ...
                                                & "     , GOODS.SEARCH_KEY_1    ASC " & vbNewLine _
                                                & "     , UNSO.OUTKA_PLAN_DATE  ASC " & vbNewLine _
                                                & "     , UNCHIN.UNSO_NO_L      ASC " & vbNewLine _
                                                & "     , UNCHIN.DECI_WT        ASC " & vbNewLine _
                                                & "     , UNCHIN.DECI_UNCHIN    ASC " & vbNewLine _
                                                & "     , GOODS.GOODS_CD_CUST   ASC " & vbNewLine
    '(2012.09.26)要望番号：1471  ---  END  ---

    ''' <summary>
    ''' ORDER BY
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_ORDER_BY_LMF592 As String = "ORDER BY                                 " & vbNewLine _
                                                 & "     UNCHIN.CUST_CD_L ASC               " & vbNewLine _
                                                 & "    ,UNCHIN.CUST_CD_M ASC               " & vbNewLine _
                                                 & "    ,UNCHIN.CUST_CD_S ASC               " & vbNewLine _
                                                 & "    ,(CASE WHEN UNCHIN.NRS_BR_CD = '50' AND UNCHIN.CUST_CD_L = '10001' AND UNCHIN.CUST_CD_M = '00' AND (UNCHIN.CUST_CD_S = '06' OR  UNCHIN.CUST_CD_S = '07') AND UNCHIN.CUST_CD_SS = '00' THEN    " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMF590IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMF590DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMF590DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMF590DAC.SQL_WHERE)            'SQL構築(データ抽出用Where句)
        ...
        MyBase.Logger.WriteSQLLog("LMF590DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMF590DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMF590DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMF590DAC.SQL_WHERE)            'SQL構築(データ抽出用Where句)
        ...
        'RPT_IDのチェック用
        Select Case rptId
            Case "LMF592"  '埼玉DIC用の場合
                Me._StrSql.Append(LMF590DAC.SQL_ORDER_BY_LMF592)

                '(2012.09.26)要望番号：1471  --- START ---
            Case "LMF591"  '群馬DIC用の場合
                Me._StrSql.Append(LMF590DAC.SQL_ORDER_BY_LMF591)
                '(2012.09.26)要望番号：1471  ---  END  ---

            Case Else
                Me._StrSql.Append(LMF590DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用OrderBy句)
        End Select
        ...
        MyBase.Logger.WriteSQLLog("LMF590DAC", "SelectPrintData", cmd)
        ...
        map.Add("DIC_GRP", "DIC_GRP")


        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMF590OUT")
