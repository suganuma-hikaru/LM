...
'  システム名       :  LM
'  サブシステム名   :  LMC       : 出荷管理
'  プログラムID     :  LMC540    : 送信案内書(YCC_サクラ)印刷
'  作  成  者       :  [SAGAWA]
' ==========================================================================
Imports System.Text
...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA1 As String = "SELECT                                                                       " & vbNewLine _
                                             ...
                                             & " ,''                      AS NO                                              " & vbNewLine _
                                             & " ,OUTL.NRS_BR_CD          AS NRS_BR_CD                                       " & vbNewLine _
                                             & " ,EDIL.FREE_C02           AS L_FREE_C02                                      " & vbNewLine _
                                             & " ,EDIL.FREE_C01           AS L_FREE_C01                                      " & vbNewLine _
                                             ...
                                             & ",CASE WHEN OUTL.DEST_KB = '01' THEN OUTL.DEST_AD_2 + ' ' + OUTL.DEST_AD_3    " & vbNewLine _
                                             & "      WHEN OUTL.DEST_KB = '02' THEN EDIL.DEST_AD_2 + ' ' + OUTL.DEST_AD_3    " & vbNewLine _
                                             & "      ELSE MDOUT.AD_2 + ' ' + OUTL.DEST_AD_3                                 " & vbNewLine _
                                             ...
                                             & " ,EDIM.FREE_C04           AS M_FREE_C04                                      " & vbNewLine _
                                             ...
                                             & " ,SFJ.DENTATU_NARR        AS DENTATU_NARR                                    " & vbNewLine _
    ...
    Private Const SQL_FROM As String = "FROM                                                               " & vbNewLine _
                                     ...
                                     & "--サクラEDI受信データ                                              " & vbNewLine _
                                     & "LEFT JOIN $LM_TRN$..H_OUTKAEDI_HED_SFJ SFJ                         " & vbNewLine _
                                     & "ON  SFJ.NRS_BR_CD = EDIL.NRS_BR_CD                                 " & vbNewLine _
                                     & "AND SFJ.OUTKA_CTL_NO = EDIL.OUTKA_CTL_NO                           " & vbNewLine _
                                     & "AND SFJ.EDI_CTL_NO = EDIL.EDI_CTL_NO                               " & vbNewLine _
                                     & "AND SFJ.SYS_DEL_FLG = '0'                                          " & vbNewLine _
                                     & "--商品M                                                            " & vbNewLine _
                                     ...
                                     & "AND MCR1.PTN_ID = '08'                                             " & vbNewLine _
                                     ...
                                     & "AND MCR2.PTN_ID = '08'                                             " & vbNewLine _
                                     ...
                                     & "AND MDOUT.SYS_DEL_FLG = '0'                                        " & vbNewLine
    ...
    '& "    ,MAIN.OUTKA_CTL_NO_CHU                                                   " & vbNewLine
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMC540IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMC540DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMC540DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMC540DAC.SQL_WHERE_MPrt)       'SQL構築(データ抽出用Where句)
        ...
        MyBase.Logger.WriteSQLLog("LMC540DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMC540DAC.SQL_SELECT_DATA1)        'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMC540DAC.SQL_FROM)                'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMC540DAC.SQL_WHERE1)              'SQL構築(データ抽出用Where句)
        Me._StrSql.Append(LMC540DAC.SQL_SELECT_DATA2)        'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMC540DAC.SQL_FROM)                'SQL構築(データ抽出用From句)
        Me._StrSql.Append(LMC540DAC.SQL_WHERE2)              'SQL構築(データ抽出用Where句)
        Me._StrSql.Append(LMC540DAC.SQL_ORDER_BY)            'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMC540DAC", "SelectPrintData", cmd)
        ...
        map.Add("DENTATU_NARR", "DENTATU_NARR")
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMC540OUT")
