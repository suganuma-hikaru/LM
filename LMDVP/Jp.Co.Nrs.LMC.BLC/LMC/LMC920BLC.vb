...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMC920DAC = New LMC920DAC()
...
#Region "CSVデータ取得処理"
    ...
    Private Function KangarooMagicCsv(ByVal ds As DataSet) As DataSet
        ...
        '出力対象データが0件の場合は終了
        If rtnDs.Tables("LMC920OUT").Rows.Count = 0 Then
            '処理終了メッセージの表示
    ...
    Private Function SelectKangarooMagicCsv(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim dt As DataTable = ds.Tables("LMC920IN")
        Dim outDt As DataTable = ds.Tables("LMC920OUT")
        Dim max As Integer = dt.Rows.Count - 1

        '別インスタンス
        Dim setDs As DataSet = ds.Copy()
        Dim inTbl As DataTable = setDs.Tables("LMC920IN")
        Dim setDt As DataTable = setDs.Tables("LMC920OUT")
