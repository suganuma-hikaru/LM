...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMC610DAC = New LMC610DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = LMC610BLC.TABLE_NM_IN
        Dim tableNmOut As String = LMC610BLC.TABLE_NM_OUT
        Dim tableNmRpt As String = LMC610BLC.TABLE_NM_M_RPT
        ...
        workDtRpt = view.ToTable(True, LMC610BLC.NRS_BR_CD, LMC610BLC.PTN_ID, LMC610BLC.PTN_CD, LMC610BLC.RPT_ID)
        ...
        For Each dr As DataRow In ds.Tables(tableNmRpt).Rows
            ...
            '帳票ごとの編集があるなら行う。
            prtDs = Me.EditPrintDataSet(dr.Item(LMC610BLC.RPT_ID).ToString(), prtDs)
            ...
            '帳票CSV出力
            comPrt.StartPrint(Me, dr.Item(LMC610BLC.NRS_BR_CD).ToString(), _
                                dr.Item(LMC610BLC.PTN_ID).ToString(), _
                                dr.Item(LMC610BLC.PTN_CD).ToString(), _
                                dr.Item(LMC610BLC.RPT_ID).ToString(), _
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        ds = MyBase.CallDAC(Me._Dac, LMC610BLC.ACTION_ID_SELECT_MPRT, ds)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Return MyBase.CallDAC(Me._Dac, LMC610BLC.ACTION_ID_SELECT_PRT_DATA, ds)
