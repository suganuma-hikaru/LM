...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMC540DAC = New LMC540DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMC540IN"
        Dim tableNmOut As String = "LMC540OUT"
    ...
    Private Function EditPrintDataSet(ByVal rptId As String, ByVal ds As DataSet) As DataSet
        ...
        '親商品毎に項番を振る
        '抽出データテーブル取得
        Dim outDt As DataTable = ds.Tables("LMC540OUT")
        '抽出データ数取得
