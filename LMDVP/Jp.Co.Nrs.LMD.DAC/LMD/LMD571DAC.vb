...
#Region "検索処理 SQL(SELECT句)"
    ...
    Private Const SQL_SELECT_DATA As String = "" _
                            ...
                            & " -- KBN_5.KBN_NM1                        AS BUSYO_NM                                                            " & vbNewLine

    ''' <summary>
    ''' 印刷データ抽出用(LMD586用) ---START---
    ''' </summary>
    ''' <remarks></remarks>
...
#Region "検索処理 SQL(FROM句)"
    ...
    Private Const SQL_FROM_MPrt As String = "FROM                                                                                                                  " & vbNewLine _
                                      ...
                                      & "MG.NRS_BR_CD = ZAITRS.NRS_BR_CD                                                                                         " & vbNewLine _
                                      ...
                                      & "ON  MCR1.NRS_BR_CD = ZAITRS.NRS_BR_CD                                                                                      " & vbNewLine _
                                      & "AND MCR1.CUST_CD_L = ZAITRS.CUST_CD_L                                                                                      " & vbNewLine _
                                      & "AND MCR1.CUST_CD_M = ZAITRS.CUST_CD_M                                                                                      " & vbNewLine _
                                      & "AND MCR1.PTN_ID = '32'                                                                                               " & vbNewLine _
                                      & "AND MCR1.CUST_CD_S = '00'                                                                                            " & vbNewLine _
                                      & "--帳票パターン取得                                                                                                   " & vbNewLine _
                                      & "LEFT JOIN $LM_MST$..M_RPT MR1                                                                                        " & vbNewLine _
                                      & "ON  MR1.NRS_BR_CD = ZAITRS.NRS_BR_CD                                                                                       " & vbNewLine _
                                      & "AND MR1.PTN_ID = MCR1.PTN_ID                                                                                         " & vbNewLine _
                                      & "AND MR1.PTN_CD = MCR1.PTN_CD                                                                                         " & vbNewLine _
                                      & "AND MR1.SYS_DEL_FLG = '0'                     " & vbNewLine _
                                      & "--商品Mの荷主での荷主帳票パターン取得                                                                                " & vbNewLine _
                                      & "LEFT JOIN $LM_MST$..M_CUST_RPT MCR2                                                                                  " & vbNewLine _
                                      & "ON  MCR2.NRS_BR_CD = ZAITRS.NRS_BR_CD                                                                                      " & vbNewLine _
                                      ...
                                      & "ON  MR2.NRS_BR_CD = ZAITRS.NRS_BR_CD                                                                                       " & vbNewLine _
    ...
    Private Const SQL_FROM As String = "FROM                                                                                                                                               " & vbNewLine _
                                    ...
                                    & "AND SEIQ.NRS_BR_CD = CUST.NRS_BR_CD                                                                                                                    " & vbNewLine _
                                    & "LEFT JOIN                                                                                                                                          " & vbNewLine _
                                    & "$LM_MST$..M_NRS_BR NRS ON                                                                                                                            " & vbNewLine _
                                    & "NRS.NRS_BR_CD = BASE10.NRS_BR_CDNRS_BR_CD                                                                                                                         " & vbNewLine _
                                    & "LEFT OUTER JOIN                                                                                                                                    " & vbNewLine _
                                    & "$LM_MST$..Z_KBN KBN_NRS ON                                                                                                                              " & vbNewLine _
                                    & "KBN_NRS.KBN_GROUP_CD = 'B044'                                                                                                                         " & vbNewLine _
                                    & "AND KBN_NRS.KBN_CD = BASE10.NRS_BR_CDNRS_BR_CD                                                                                                                    " & vbNewLine _
                                    & "LEFT OUTER JOIN                                                                                                                                    " & vbNewLine _
                                    & "$LM_MST$..M_CUSTCOND COND ON                                                                                                                         " & vbNewLine _
                                    & "COND.NRS_BR_CD = BASE10.NRS_BR_CDNRS_BR_CD                                                                                                                        " & vbNewLine _
                                    ...
                                    & "SOKO.NRS_BR_CD = ZAITRS.NRS_BR_CD                                                                                                                        " & vbNewLine _
                                    ...
                                    & "CUST_D.NRS_BR_CD   = BASE10.NRS_BR_CD                                                                                                                    " & vbNewLine _
                                    ...
                                    & "MCD.NRS_BR_CD   = BASE10.NRS_BR_CD                                                                                                                       " & vbNewLine _
                                    ...
                                    & "MCD2.NRS_BR_CD   = BASE10.NRS_BR_CD                                                                                                                       " & vbNewLine _
                                    ...
                                    & "--在庫の荷主での荷主帳票パターン取得                                                                                                                 " & vbNewLine _
                                    & "LEFT JOIN $LM_MST$..M_CUST_RPT MCR1                                                                                                                  " & vbNewLine _
                                    & "ON  MCR1.NRS_BR_CD = BASE10.NRS_BR_CD                                                                                                                    " & vbNewLine _
                                    & "AND MCR1.CUST_CD_L = BASE10.CUST_CD_L                                                                                                                    " & vbNewLine _
                                    & "AND MCR1.CUST_CD_M = BASE10.CUST_CD_M                                                                                                                    " & vbNewLine _
                                    & "AND MCR1.PTN_ID = '32'                                                                                                                             " & vbNewLine _
                                    & "AND MCR1.CUST_CD_S = '00'                                                                                                                          " & vbNewLine _
                                    & "--帳票パターン取得                                                                                                                                         " & vbNewLine _
                                    & "LEFT JOIN $LM_MST$..M_RPT MR1                                                                                                                        " & vbNewLine _
                                    ...
                                    & "--存在しない場合の帳票パターン取得                                                                                                                                 " & vbNewLine _
                                    & "LEFT JOIN $LM_MST$..M_RPT MR3                                                                                                                        " & vbNewLine _
                                    & "ON  MR3.NRS_BR_CD = BASE10.NRS_BR_CD                                                                                                                     " & vbNewLine _
                                    & "AND MR3.PTN_ID = '32'                                                                                                                              " & vbNewLine _
                                    & "AND MR3.STANDARD_FLAG = '01'                                                                                                                       " & vbNewLine _
...
#End Region
    ...
    '2012/10/17 START 在庫証明書 処理スピード向上
...
#Region "SQL_FROM_WK"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_FROM_WK As String = "FROM                                              " & vbNewLine _
                                    & "(                                                     " & vbNewLine _
                                    & "SELECT                                                " & vbNewLine _
                                    & "*                                                     " & vbNewLine _
                                    & "FROM                                                  " & vbNewLine _
                                    ...
                                    & "LEFT JOIN                                             " & vbNewLine _
                                    & "$LM_MST$..M_NRS_BR NRS ON                             " & vbNewLine _
                                    & "NRS.NRS_BR_CD = BASE10.NRS_BR_CD                            " & vbNewLine _
                                    & "LEFT OUTER JOIN                                                                                                                                    " & vbNewLine _
                                    & "$LM_MST$..Z_KBN KBN_NRS ON                                                                                                                              " & vbNewLine _
                                    & "KBN_NRS.KBN_GROUP_CD = 'B044'                                                                                                                         " & vbNewLine _
                                    & "AND KBN_NRS.KBN_CD = BASE10.NRS_BR_CD                                                                                                                    " & vbNewLine _
                                    & "LEFT OUTER JOIN                                       " & vbNewLine _
                                    & "$LM_MST$..M_CUSTCOND COND ON                          " & vbNewLine _
                                    & "COND.NRS_BR_CD = BASE10.NRS_BR_CD                           " & vbNewLine _
                                    & "AND COND.CUST_CD_L = BASE10.CUST_CD_L                 " & vbNewLine _
                                    & "AND COND.JOTAI_CD = ZAITRS.GOODS_COND_KB_3            " & vbNewLine _
                                    & "LEFT OUTER JOIN                                       " & vbNewLine _
                                    & "$LM_MST$..Z_KBN KBN2 ON                               " & vbNewLine _
                                    ...
                                    & "LEFT OUTER JOIN                                       " & vbNewLine _
                                    & "$LM_MST$..M_SOKO SOKO_2 ON                            " & vbNewLine _
                                    & "SOKO_2.NRS_BR_CD = SOKO.NRS_BR_CD                     " & vbNewLine _
                                    & "AND SOKO_2.WH_CD = SOKO.ZAIKO_WH_CD                   " & vbNewLine _
                                    & "--2018/03/08 001033 20180131【LMS】横浜BC帳票住所がYCCになっている対応 Annen add start   " & vbNewLine _
                                    & "LEFT JOIN                                                                                " & vbNewLine _
                                    ...
                                    & "KBN5.KBN_GROUP_CD = 'B002'                                           " & vbNewLine _
                                    & "AND KBN5.KBN_CD = ZAITRS.OFB_KB                                      " & vbNewLine _
                                    & "--(2012.12.18)要望番号1657対応 -- START --                           " & vbNewLine _
                                    & "LEFT OUTER JOIN                                                      " & vbNewLine _
                                    & "$LM_MST$..Z_KBN KBN6 ON                                              " & vbNewLine _
                                    & "KBN6.KBN_GROUP_CD = 'T021'                                           " & vbNewLine _
                                    & "AND KBN6.KBN_CD = ZAITRS.TOU_NO                                      " & vbNewLine _
                                    & "--(2012.12.18)要望番号1657対応 --  END  --                           " & vbNewLine _
                                    & "--在庫の荷主での荷主帳票パターン取得                                 " & vbNewLine _
                                    & "LEFT JOIN $LM_MST$..M_CUST_RPT MCR1                                  " & vbNewLine _
                                    & "ON  MCR1.NRS_BR_CD = BASE10.NRS_BR_CD                                      " & vbNewLine _
                                    & "AND MCR1.CUST_CD_L = BASE10.CUST_CD_L                                      " & vbNewLine _
...
#Region "SQL_DELETE_WK"

    ''' <summary>
    ''' ワークテーブルデータ削除
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_DELETE_WK As String = " DELETE FROM $LM_TRN$..D_WK_ZAI_PRT " & vbNewLine _
                                          & " WHERE NRS_BR_CD   = @NRS_BR_CD                     " & vbNewLine _
                                          & "   AND CUST_CD_L   = @CUST_CD_L                     " & vbNewLine _
...
#Region "SQL_INSERT_HED"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_HED As String = " INSERT INTO $LM_TRN$..D_WK_ZAI_PRT " & vbNewLine _
                                           & " (                                " & vbNewLine _
                                           & "     NRS_BR_CD                    " & vbNewLine _
                                           & "    ,CUST_CD_L                    " & vbNewLine _
                                           & "    ,CUST_CD_M                    " & vbNewLine _
...
#Region "SQL_INSERT_UNION_1"

    ''' <summary>
    ''' INSERT対象データ取得SQL
    ''' </summary>
    ''' <remarks></remarks>
    Private Const SQL_INSERT_UNION_1 As String = " --月末在庫履歴(D_ZAI_ZAN_JITSU)                                       " & vbNewLine _
                                               & " SELECT                                                                " & vbNewLine _
                                               & "    @NRS_BR_CD                        AS NRS_BR_CD                     " & vbNewLine _
                                               & "   ,@CUST_CD_L                        AS CUST_CD_L                     " & vbNewLine _
                                               & "   ,@CUST_CD_M                        AS CUST_CD_M                     " & vbNewLine _
                                               & "   ,@PRINT_FROM                       AS PRINT_FROM                    " & vbNewLine _
                                               & "   ,@ZAI_GETU                         AS ZAI_GETU                      " & vbNewLine _
                                               ...
                                               & "   ,ISNULL(ZAI2.LOT_NO, '')           AS LOT_NO                        " & vbNewLine _
                                               & "   ,ISNULL(ZAI2.SERIAL_NO, '')        AS SERIAL_NO                     " & vbNewLine _
                                               & "   ,SUM(ZAN.PORA_ZAI_NB)              AS PORA_ZAI_NB                   " & vbNewLine _
                                               & "   ,SUM(ZAN.PORA_ZAI_QT)              AS PORA_ZAI_QT                   " & vbNewLine _
                                               ...
                                               & "   ,'1'                               AS UNION_NO                      " & vbNewLine _
                                               & " FROM                                                                  " & vbNewLine _
                                               & "   (SELECT                                                             " & vbNewLine _
                                               & "     ZAN.NRS_BR_CD                                                     " & vbNewLine _
                                               & "    ,ZAN.ZAI_REC_NO                                                    " & vbNewLine _
                                               & "    ,ZAN.PORA_ZAI_NB                                                   " & vbNewLine _
                                               & "    ,ZAN.PORA_ZAI_QT                                                   " & vbNewLine _
                                               & "   FROM $LM_TRN$..D_ZAI_ZAN_JITSU ZAN                                  " & vbNewLine _
                                               & "   WHERE                                                               " & vbNewLine _
                                               & "       ZAN.SYS_DEL_FLG = '0'                                           " & vbNewLine _
                                               & "   AND ZAN.NRS_BR_CD = @NRS_BR_CD                                      " & vbNewLine _
                                               & "   AND ZAN.RIREKI_DATE <= @PRINT_FROM                                  " & vbNewLine _
                                               & "   AND ZAN.RIREKI_DATE >= CASE WHEN @GETU_FLG = '1' THEN @ZAI_GETU     " & vbNewLine _
                                               & "                               ELSE ZAN.RIREKI_DATE END                " & vbNewLine _
                                               & "   AND (ZAN.PORA_ZAI_NB <> 0 OR ZAN.PORA_ZAI_QT <> 0)                  " & vbNewLine _
                                               & "   ) ZAN                                                               " & vbNewLine _
                                               & " LEFT JOIN $LM_TRN$..D_ZAI_TRS ZAI2                                    " & vbNewLine _
                                               & "   ON ZAI2.SYS_DEL_FLG  = '0'                                          " & vbNewLine _
                                               ...
                                               & "  AND INL2.INKA_NO_L    = ZAI2.INKA_NO_L                               " & vbNewLine _
                                               & " LEFT JOIN $LM_MST$..M_GOODS MG                                        " & vbNewLine _
                                               & "   ON MG.NRS_BR_CD      = MG.NRS_BR_CD                                   " & vbNewLine _
                                               & "  AND ZAI2.GOODS_CD_NRS = MG.GOODS_CD_NRS                              " & vbNewLine _
                                               & " WHERE                                                                 " & vbNewLine _
                                               & "     ZAI2.CUST_CD_L = @CUST_CD_L                                       " & vbNewLine _
                                               & " AND ZAI2.CUST_CD_M = @CUST_CD_M                                       " & vbNewLine _
                                               & " AND INL2.INKA_STATE_KB !< '50'                                        " & vbNewLine _
                                               & "   GROUP BY                                                " & vbNewLine _
                                               & "     ZAN.ZAI_REC_NO                                        " & vbNewLine _
                                               & "    ,ZAI2.GOODS_CD_NRS                                     " & vbNewLine _
                                               & "    ,MG.GOODS_CD_CUST                                      " & vbNewLine _
                                               & "    ,ISNULL(ZAI2.LOT_NO, '')                               " & vbNewLine _
                                               & "    ,ISNULL(ZAI2.SERIAL_NO, '')                            " & vbNewLine
...
#Region "SQL_INSERT_UNION_2"
    ...
    Private Const SQL_INSERT_UNION_2 As String = "SELECT                                                                         " & vbNewLine _
                                               ...
                                               & "   ,ISNULL(INS1.LOT_NO, '')                                   AS LOT_NO        " & vbNewLine _
                                               & "   ,ISNULL(INS1.SERIAL_NO, '')                                AS SERIAL_NO     " & vbNewLine _
                                               & "   ,SUM((INS1.KONSU * MG1.PKG_NB) + INS1.HASU)                AS PORA_ZAI_NB   " & vbNewLine _
                                               & "   ,SUM(((INS1.KONSU * MG1.PKG_NB) + INS1.HASU) * INS1.IRIME) AS PORA_ZAI_QT   " & vbNewLine _
                                               & "   ,@SYS_ENT_DATE                                             AS SYS_ENT_DATE  " & vbNewLine _
                                               & "   ,@SYS_ENT_TIME                                             AS SYS_ENT_TIME  " & vbNewLine _
                                               & "   ,@SYS_ENT_PGID                                             AS SYS_ENT_PGID  " & vbNewLine _
                                               & "   ,@SYS_ENT_USER                                             AS SYS_ENT_USER  " & vbNewLine _
                                               ...
                                               & "(                                                                              " & vbNewLine _
                                               & "SELECT                                                                         " & vbNewLine _
                                               & "     INL1.NRS_BR_CD                                                            " & vbNewLine _
                                               & "   , INL1.INKA_NO_L                                                            " & vbNewLine _
                                               & "   , INL1.CUST_CD_L                                                            " & vbNewLine _
                                               & "   , INL1.CUST_CD_M                                                            " & vbNewLine _
                                               & "   , INL1.INKA_STATE_KB                                                        " & vbNewLine _
                                               & " FROM                                                                          " & vbNewLine _
                                               & "$LM_TRN$..B_INKA_L INL1                                                        " & vbNewLine _
                                               ...
                                               & "                                                                               " & vbNewLine _
                                               & "  AND INL1.INKA_DATE <= @PRINT_FROM                                            " & vbNewLine _
                                               & "  AND INL1.INKA_DATE >= CASE WHEN @GETU_FLG = '1' THEN @ZAI_GETU               " & vbNewLine _
                                               & "                             ELSE INL1.INKA_DATE END                           " & vbNewLine _
                                               & "AND (INL1.INKA_DATE > '00000000' OR INL1.INKA_STATE_KB < '50')                 " & vbNewLine _
                                               & ") INL1                                                                         " & vbNewLine _
                                               & "INNER JOIN $LM_TRN$..B_INKA_M INM1                                             " & vbNewLine _
                                               & "  ON INM1.SYS_DEL_FLG = '0'                                                    " & vbNewLine _
                                               & " AND INM1.NRS_BR_CD   = INL1.NRS_BR_CD                                             " & vbNewLine _
                                               & " AND INM1.INKA_NO_L   = INL1.INKA_NO_L                                         " & vbNewLine _
                                               & "INNER JOIN $LM_TRN$..B_INKA_S INS1                                             " & vbNewLine _
                                               & "  ON INS1.SYS_DEL_FLG = '0'                                                    " & vbNewLine _
                                               & " AND INS1.NRS_BR_CD   = INL1.NRS_BR_CD                                             " & vbNewLine _
                                               & " AND INS1.INKA_NO_L   = INL1.INKA_NO_L                                         " & vbNewLine _
                                               & " AND INS1.INKA_NO_M   = INM1.INKA_NO_M                                         " & vbNewLine _
                                               & "LEFT JOIN $LM_MST$..M_GOODS MG1                                                " & vbNewLine _
                                               & "  ON MG1.NRS_BR_CD    = INM1.NRS_BR_CD                                             " & vbNewLine _
                                               & " AND MG1.GOODS_CD_NRS = INM1.GOODS_CD_NRS                                      " & vbNewLine _
                                               & "WHERE                                                                          " & vbNewLine _
                                               & " (INL1.INKA_STATE_KB > '10' OR RTRIM(INS1.ZAI_REC_NO) <> '')                   " & vbNewLine _
                                               & "   GROUP BY                                                " & vbNewLine _
                                               & "     INS1.ZAI_REC_NO                                       " & vbNewLine _
                                               & "    ,INM1.GOODS_CD_NRS                                     " & vbNewLine _
                                               & "    ,MG1.GOODS_CD_CUST                                     " & vbNewLine _
                                               & "    ,ISNULL(INS1.LOT_NO, '')                               " & vbNewLine _
                                               & "    ,ISNULL(INS1.SERIAL_NO, '')                            " & vbNewLine
...
#Region "SQL_INSERT_UNION_3"
    ...
    Private Const SQL_INSERT_UNION_3 As String = "--在庫移動分を加減算(D_IDO_TRS)                                 " & vbNewLine _
                                               & "--移動後                                                        " & vbNewLine _
                                               & " SELECT                                                         " & vbNewLine _
                                               & "    @NRS_BR_CD                              AS NRS_BR_CD        " & vbNewLine _
                                               & "   ,@CUST_CD_L                              AS CUST_CD_L        " & vbNewLine _
                                               ...
                                               & "   ,ISNULL(ZAI3.LOT_NO, '')                 AS LOT_NO           " & vbNewLine _
                                               & "   ,ISNULL(ZAI3.SERIAL_NO, '')              AS SERIAL_NO        " & vbNewLine _
                                               & "   ,SUM(IDO1.N_PORA_ZAI_NB)                 AS PORA_ZAI_NB      " & vbNewLine _
                                               & "   ,SUM(IDO1.N_PORA_ZAI_NB * IDO1.ZAIK_IRIME)  AS PORA_ZAI_QT      " & vbNewLine _
                                               & "   ,@SYS_ENT_DATE                           AS SYS_ENT_DATE     " & vbNewLine _
                                               & "   ,@SYS_ENT_TIME                           AS SYS_ENT_TIME     " & vbNewLine _
                                               & "   ,@SYS_ENT_PGID                           AS SYS_ENT_PGID     " & vbNewLine _
                                               & "   ,@SYS_ENT_USER                           AS SYS_ENT_USER     " & vbNewLine _
                                               ...
                                               & "FROM                                                            " & vbNewLine _
                                               & "  ( SELECT                                                      " & vbNewLine _
                                               & "      IDO1.NRS_BR_CD                                            " & vbNewLine _
                                               & "     ,IDO1.N_ZAI_REC_NO                                         " & vbNewLine _
                                               & "     ,IDO1.O_ZAI_REC_NO                                         " & vbNewLine _
                                               & "     ,IDO1.N_PORA_ZAI_NB                                        " & vbNewLine _
                                               & "     ,IDO1.ZAIK_IRIME                                              " & vbNewLine _
                                               & "  FROM $LM_TRN$..D_IDO_TRS IDO1                                 " & vbNewLine _
                                               & "  WHERE                                                         " & vbNewLine _
                                               & "  IDO1.SYS_DEL_FLG = '0'                                        " & vbNewLine _
                                               & "  AND IDO1.NRS_BR_CD = @NRS_BR_CD                               " & vbNewLine _
                                               & "  AND IDO1.IDO_DATE <= @PRINT_FROM                              " & vbNewLine _
                                               & "  AND IDO1.IDO_DATE >= CASE WHEN @GETU_FLG = '1' THEN @ZAI_GETU " & vbNewLine _
                                               & "                            ELSE IDO1.IDO_DATE END              " & vbNewLine _
                                               & "  ) IDO1                                                        " & vbNewLine _
                                               & "LEFT JOIN $LM_TRN$..D_ZAI_TRS ZAI3                              " & vbNewLine _
                                               & "  ON ZAI3.SYS_DEL_FLG = '0'                                     " & vbNewLine _
                                               & " AND ZAI3.NRS_BR_CD   = IDO1.NRS_BR_CD                              " & vbNewLine _
                                               ...
                                               & "  ON ZAI3.NRS_BR_CD    = MG.NRS_BR_CD                             " & vbNewLine _
                                               & " AND ZAI3.GOODS_CD_NRS = MG.GOODS_CD_NRS                        " & vbNewLine _
                                               & "WHERE ZAI3.CUST_CD_L = @CUST_CD_L                               " & vbNewLine _
                                               & "  AND ZAI3.CUST_CD_M = @CUST_CD_M                               " & vbNewLine _
                                               & "   GROUP BY                                                " & vbNewLine _
                                               & "     IDO1.N_ZAI_REC_NO                                     " & vbNewLine _
                                               & "    ,ZAI3.GOODS_CD_NRS                                     " & vbNewLine _
                                               & "    ,MG.GOODS_CD_CUST                                      " & vbNewLine _
                                               & "    ,ISNULL(ZAI3.LOT_NO, '')                               " & vbNewLine _
                                               & "    ,ISNULL(ZAI3.SERIAL_NO, '')                            " & vbNewLine
...
#Region "SQL_INSERT_UNION_4"
    ...
    Private Const SQL_INSERT_UNION_4 As String = "--在庫移動分を加減算(D_IDO_TRS)                                 " & vbNewLine _
                                           & "--移動前                                                        " & vbNewLine _
                                           & "SELECT                                                          " & vbNewLine _
                                           & "    @NRS_BR_CD                              AS NRS_BR_CD        " & vbNewLine _
                                           & "   ,@CUST_CD_L                              AS CUST_CD_L        " & vbNewLine _
                                           ...
                                           & "   ,ISNULL(ZAI5.LOT_NO, '')                 AS LOT_NO           " & vbNewLine _
                                           & "   ,ISNULL(ZAI5.SERIAL_NO, '')              AS SERIAL_NO        " & vbNewLine _
                                           & "   ,SUM(IDO2.N_PORA_ZAI_NB * -1)                 AS PORA_ZAI_NB      " & vbNewLine _
                                           & "   ,SUM(IDO2.N_PORA_ZAI_NB * IDO2.ZAIK_IRIME * -1)  AS PORA_ZAI_QT      " & vbNewLine _
                                           & "   ,@SYS_ENT_DATE                           AS SYS_ENT_DATE     " & vbNewLine _
                                           & "   ,@SYS_ENT_TIME                           AS SYS_ENT_TIME     " & vbNewLine _
                                           & "   ,@SYS_ENT_PGID                           AS SYS_ENT_PGID     " & vbNewLine _
                                           & "   ,@SYS_ENT_USER                           AS SYS_ENT_USER     " & vbNewLine _
                                           ...
                                           & "FROM                                                            " & vbNewLine _
                                           & "  ( SELECT                                                      " & vbNewLine _
                                           & "      IDO2.NRS_BR_CD                                            " & vbNewLine _
                                           & "     ,IDO2.O_ZAI_REC_NO                                         " & vbNewLine _
                                           & "     ,IDO2.N_PORA_ZAI_NB                                        " & vbNewLine _
                                           & "     ,IDO2.ZAIK_IRIME                                              " & vbNewLine _
                                           & "  FROM $LM_TRN$..D_IDO_TRS IDO2                                 " & vbNewLine _
                                           & "  WHERE                                                         " & vbNewLine _
                                           & "  IDO2.SYS_DEL_FLG = '0'                                        " & vbNewLine _
                                           & "  AND IDO2.NRS_BR_CD = @NRS_BR_CD                               " & vbNewLine _
                                           & "  AND IDO2.IDO_DATE <= @PRINT_FROM                              " & vbNewLine _
                                           & "  AND IDO2.IDO_DATE >= CASE WHEN @GETU_FLG = '1' THEN @ZAI_GETU " & vbNewLine _
                                           & "                            ELSE IDO2.IDO_DATE END              " & vbNewLine _
                                           & "  )   IDO2                                                      " & vbNewLine _
                                           & "LEFT JOIN $LM_TRN$..D_ZAI_TRS ZAI5                              " & vbNewLine _
                                           & "  ON ZAI5.SYS_DEL_FLG = '0'                                     " & vbNewLine _
                                           & " AND ZAI5.NRS_BR_CD   = IDO2.NRS_BR_CD                              " & vbNewLine _
                                           ...
                                           & "  ON ZAI5.NRS_BR_CD    = MG.NRS_BR_CD                             " & vbNewLine _
                                           & " AND ZAI5.GOODS_CD_NRS = MG.GOODS_CD_NRS                        " & vbNewLine _
                                           & "WHERE ZAI5.CUST_CD_L = @CUST_CD_L                               " & vbNewLine _
                                           & "  AND ZAI5.CUST_CD_M = @CUST_CD_M                               " & vbNewLine _
                                           & "   GROUP BY                                                " & vbNewLine _
                                           & "     IDO2.O_ZAI_REC_NO                                     " & vbNewLine _
                                           & "    ,ZAI5.GOODS_CD_NRS                                     " & vbNewLine _
                                           & "    ,MG.GOODS_CD_CUST                                      " & vbNewLine _
                                           & "    ,ISNULL(ZAI5.LOT_NO, '')                               " & vbNewLine _
                                           & "    ,ISNULL(ZAI5.SERIAL_NO, '')                            " & vbNewLine
...
#Region "SQL_INSERT_UNION_5"
    ...
    Private Const SQL_INSERT_UNION_5 As String = "--出荷データ(C_OUTKA_S)                                                    " & vbNewLine _
                                           & "SELECT                                                                     " & vbNewLine _
                                           & "    BASE3.NRS_BR_CD                    AS NRS_BR_CD                        " & vbNewLine _
                                           & "   ,BASE3.CUST_CD_L                    AS CUST_CD_L                        " & vbNewLine _
                                           & "   ,BASE3.CUST_CD_M                    AS CUST_CD_M                        " & vbNewLine _
                                           & "   ,@PRINT_FROM                        AS PRINT_FROM                       " & vbNewLine _
                                           & "   ,@ZAI_GETU                          AS ZAI_GETU                         " & vbNewLine _
                                           & "   ,@GETU_FLG                          AS GETU_FLG                         " & vbNewLine _
                                           & "   ,BASE3.OUTKA_NO_L                   AS OUTKA_NO_L                       " & vbNewLine _
                                           & "   ,BASE3.OUTKA_NO_M                   AS OUTKA_NO_M                       " & vbNewLine _
                                           & "   ,BASE3.OUTKA_NO_S                   AS OUTKA_NO_S                       " & vbNewLine _
                                           & "   ,BASE3.CUST_NM_L                    AS CUST_NM_L                        " & vbNewLine _
                                           & "   ,BASE3.ZAI_REC_NO                   AS ZAI_REC_NO                       " & vbNewLine _
                                           & "   ,BASE3.GOODS_CD_NRS                 AS GOODS_CD_NRS                     " & vbNewLine _
                                           & "   ,BASE3.GOODS_CD_CUST                AS GOODS_CD_CUST                    " & vbNewLine _
                                           & "   ,BASE3.LOT_NO                       AS LOT_NO                           " & vbNewLine _
                                           & "   ,BASE3.SERIAL_NO                    AS SERIAL_NO                        " & vbNewLine _
                                           & "   ,BASE3.PORA_ZAI_NB                  AS PORA_ZAI_NB                      " & vbNewLine _
                                           & "   ,BASE3.PORA_ZAI_QT                  AS PORA_ZAI_QT                      " & vbNewLine _
                                           & "   ,@SYS_ENT_DATE                      AS SYS_ENT_DATE                     " & vbNewLine _
                                           & "   ,@SYS_ENT_TIME                      AS SYS_ENT_TIME                     " & vbNewLine _
                                           & "   ,@SYS_ENT_PGID                      AS SYS_ENT_PGID                     " & vbNewLine _
                                           & "   ,@SYS_ENT_USER                      AS SYS_ENT_USER                     " & vbNewLine _
                                           ...
                                           & "    ,ISNULL(OUTS.LOT_NO, '')           AS LOT_NO                           " & vbNewLine _
                                           & "    ,ISNULL(OUTS.SERIAL_NO, '')        AS SERIAL_NO                        " & vbNewLine _
                                           & "    ,SUM(OUTS.ALCTD_NB * -1)                AS PORA_ZAI_NB                      " & vbNewLine _
                                           & "    ,SUM(OUTS.ALCTD_QT * -1)                AS PORA_ZAI_QT                      " & vbNewLine _
                                           & "    ,@NRS_BR_CD                    AS NRS_BR_CD                        " & vbNewLine _
                                           & "   FROM                                                                    " & vbNewLine _
                                           & "    ( SELECT                                                               " & vbNewLine _
                                           ...
                                           & "    WHERE OUTL.OUTKA_STATE_KB !< '60'                                      " & vbNewLine _
                                           & "      AND OUTL.NRS_BR_CD = @NRS_BR_CD                                      " & vbNewLine _
                                           & "      AND OUTL.CUST_CD_L = @CUST_CD_L                                      " & vbNewLine _
                                           & "      AND OUTL.CUST_CD_M = @CUST_CD_M                                      " & vbNewLine _
                                           & "      AND OUTL.OUTKA_PLAN_DATE <= @PRINT_FROM                              " & vbNewLine _
                                           & "      AND OUTL.OUTKA_PLAN_DATE >= CASE WHEN @GETU_FLG = '1' THEN @ZAI_GETU " & vbNewLine _
                                           & "                                       ELSE OUTL.OUTKA_PLAN_DATE END       " & vbNewLine _
                                           & "      AND OUTL.SYS_DEL_FLG = '0'                                           " & vbNewLine _
                                           & "      ) OUTL                                                               " & vbNewLine _
                                           & "INNER JOIN $LM_TRN$..C_OUTKA_M OUTM                                        " & vbNewLine _
                                           & "  ON OUTM.NRS_BR_CD  = OUTL.NRS_BR_CD                                          " & vbNewLine _
                                           & " AND OUTM.OUTKA_NO_L = OUTL.OUTKA_NO_L                                     " & vbNewLine _
                                           & "INNER JOIN $LM_TRN$..C_OUTKA_S OUTS                                        " & vbNewLine _
                                           ...
                                           & "  ON OUTM.NRS_BR_CD    = MG.NRS_BR_CD                                        " & vbNewLine _
                                           & " AND OUTM.GOODS_CD_NRS = MG.GOODS_CD_NRS                                   " & vbNewLine _
                                           & "WHERE OUTM.SYS_DEL_FLG = '0'                                               " & vbNewLine _
                                           & "  AND OUTS.SYS_DEL_FLG = '0'                                               " & vbNewLine _
                                           & "  AND OUTM.ALCTD_KB <> '04'                                                " & vbNewLine _
                                           & "   GROUP BY                                               " & vbNewLine _
                                           & "     OUTS.ZAI_REC_NO                                      " & vbNewLine _
                                           & "    ,OUTM.GOODS_CD_NRS                                    " & vbNewLine _
                                           & "    ,MG.GOODS_CD_CUST                                     " & vbNewLine _
                                           & "    ,ISNULL(OUTS.LOT_NO, '')                              " & vbNewLine _
                                           & "    ,ISNULL(OUTS.SERIAL_NO, '')                           " & vbNewLine _
                                           & ") BASE3                                                                 " & vbNewLine

#End Region

#End Region
    '2012/10/17  END  在庫証明書 処理スピード向上
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMD571DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMD571DAC.SQL_FROM_MPrt)        'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMD571DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Select Case rptTbl.Rows(0).Item("RPT_ID").ToString()
            Case "LMD586", "LMD588"
                Me._StrSql.Append(LMD571DAC.SQL_SELECT_DATA_586)
            Case "LMD587"
                Me._StrSql.Append(LMD571DAC.SQL_SELECT_DATA_587)
            Case Else
                Me._StrSql.Append(LMD571DAC.SQL_SELECT_DATA)
        End Select

        'SQL構築(データ抽出用From句)
        '2012/10/17 START 在庫証明書 処理スピード向上
        'Me._StrSql.Append(LMD571DAC.SQL_FROM)             
        Me._StrSql.Append(LMD571DAC.SQL_FROM_WK)
        '2012/10/17 END 在庫証明書 処理スピード向上
        ...
        Select Case rptTbl.Rows(0).Item("RPT_ID").ToString()
            Case "LMD586", "LMD588"
                Me._StrSql.Append(LMD571DAC.SQL_GROUP_BY_586)
            Case "LMD587"
                Me._StrSql.Append(LMD571DAC.SQL_GROUP_BY_587)
            Case Else
                Me._StrSql.Append(LMD571DAC.SQL_GROUP_BY)
        End Select
        ...
        Select Case rptTbl.Rows(0).Item("RPT_ID").ToString()
            Case "LMD573"
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_573_01)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_573_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_573_03)
                End Select
            ...
            Case "LMD579"
                ...
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_579_01)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_579_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_579_03)
                End Select
            ...
            Case "LMD581"
                ...
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_581_01)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_581_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_581_03)
                End Select
            ...
            Case "LMD582"
                ...
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_582_01)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_582_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_582_03)
                End Select
            ...
            Case "LMD586", "LMD588"
                ...
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_586_01)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_586_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_586_03)
                End Select
            ...
            Case "LMD587"
                ...
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_587_01)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_587_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_587_03)
                End Select
            ...
            Case Else
                Select Case Me._Row.Item("SORT_KBN").ToString
                    Case "01"
                        '商品名順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY)
                    Case "02"
                        '商品コード順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_02)
                    Case "03"
                        '商品名・入庫日順
                        Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_03)
                End Select
        End Select
        ...
        ''---->要望番号:1057 対応Start 2012/05/23
        ''Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY)             'SQL構築(データ抽出用ORDER BY句)
        ...
        '    '商品コード順
        '    Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_02)       'SQL構築(データ抽出用ORDER BY句)

        'ElseIf Me._Row.Item("SORT_KBN").ToString = "03" Then
        '    '商品名・入庫日順
        '    Me._StrSql.Append(LMD571DAC.SQL_ORDER_BY_03)       'SQL構築(データ抽出用ORDER BY句)
        'End If
        '<----要望番号:1057 対応End   2012/05/23
        ...
        MyBase.Logger.WriteSQLLog("LMD571DAC", "SelectPrintData", cmd)
    ...
    Private Sub InsertPrintDataContorol(ByVal ds As DataSet)
        ...
        'データ登録
        Call Me.InsertPrintData(ds, String.Concat(SQL_INSERT_HED, SQL_INSERT_UNION_1))
    ...
    Private Sub InsertPrintData(ByVal ds As DataSet, ByVal strSql As String)
        ...
        MyBase.Logger.WriteSQLLog("LMD571DAC", "InsertPrintData", cmd)
    ...
    Private Sub DeletePrintData(ByVal ds As DataSet)
        ...
        'パラメータ設定
        Call Me.SetConditionMasterDeleteSQL()
        ...
        MyBase.Logger.WriteSQLLog("LMD571DAC", "DeletePrintData", cmd)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub SetConditionMasterDeleteSQL()
    ...
    Private Function SelectMCustDetailsData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMD571DAC.SQL_SELECT_MCUST_DETAILS)      'SQL構築(荷主明細マスタ設定値Select句)
        Call Me.SetConditionMasterSQL()                            '条件設定
        ...
        MyBase.Logger.WriteSQLLog("LMD571DAC", "SelectMCustDetailsData", cmd)
