...
#Region "制御用"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const CLASS_NM As String = "LMD540DAC"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const TABLE_NM_OUT As String = "LMD540OUT"
...
#Region "共通SQL"
  ...
  & "    GOODS.CUST_CD_SS     " & vbNewLine _
    ...
    Private Const SQL_SELECT_JOIN_ADD_ZAIKO As String = " --在庫TRS_O                                    " & vbNewLine _
                                                       ...
                                                       & " AND                                            " & vbNewLine _
                                                       & "  ZAITRS_N.DEST_CD_P = DEST.DEST_CD             " & vbNewLine _
    ...
    Private Const SQL_ORDER_BY As String = " ORDER BY " & vbNewLine _
                                         & "    NRS_BR_CD, CUST_CD_L, WH_CD, GOODS_CD_CUST, LOT_NO, IRIME, PLAN_DATE, SYUBETU, YOJITU  " & vbNewLine
...
#Region "出荷データ"
    ...
    Private Const SQL_SELECT_FROM_OUTKA As String = " --出荷M                                                                  " & vbNewLine _
                                                   ...
                                                   & "   UNSOL.UNSO_BR_CD = UNSOCO.UNSOCO_BR_CD                                 " & vbNewLine _
                                                   & " AND                                                                      " & vbNewLine _
                                                   & "   UNSOCO.SYS_DEL_FLG = '0'                                               " & vbNewLine _
                                                   & " --抽出条件                                                               " & vbNewLine _
                                                   & " WHERE                                                                    " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        Return Me.SelectListData(ds, LMD540DAC.TABLE_NM_M_RPT, LMD540DAC.SQL_SELECT_MPrt, LMD540DAC.SelectCondition.PTN1, str)
    ...
    Private Function SelectPrtData(ByVal ds As DataSet) As DataSet
        ...
        Dim ptn As LMD540DAC.SelectCondition = Nothing
        Dim tabFlg As String = ds.Tables(LMD540DAC.TABLE_NM_IN).Rows(0).Item("TAB_FLG").ToString

        Select Case tabFlg
            Case LMD540DAC.TAB_FLG_INOUT
                ptn = SelectCondition.PTN2
            Case LMD540DAC.TAB_FLG_ZAIKO
        ...
        ds = Me.SelectListData(ds, LMD540DAC.TABLE_NM_OUT, sql, ptn, str)
...
#Region "ユーティリティ"
    ...
    Private Function SelectListData(ByVal ds As DataSet, ByVal tblNm As String, ByVal sql As String, ByVal ptn As LMD540DAC.SelectCondition, ByVal str As String()) As DataSet

        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables(LMD540DAC.TABLE_NM_IN)
        ...
        MyBase.Logger.WriteSQLLog(LMD540DAC.CLASS_NM, System.Reflection.MethodBase.GetCurrentMethod.Name, cmd)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function CreateSql(ByVal ds As DataSet, ByVal ptn As LMD540DAC.SelectCondition) As String

        Dim sql As StringBuilder = New StringBuilder()
        Dim dr As DataRow = ds.Tables(LMD540DAC.TABLE_NM_IN).Rows(0)
        ...
        Select Case ptn
            ...
            Case SelectCondition.PTN2 '入出荷ごと
                ...
                sql.Append(LMD540DAC.SQL_SELECT_INOUT1)
                ...
                sql.Append(LMD540DAC.SQL_SELECT_INOUT2)
                sql.Append(Me.CreateWhereSql(ds, SelectWhereCondition.WHERE3))

                sql.Append(LMD540DAC.SQL_SELECT_INOUT3)
                sql.Append(Me.CreateWhereSql(ds, SelectWhereCondition.WHERE1))
            ...
            Case SelectCondition.PTN3 '在庫ごと
                ...
                sql.Append(LMD540DAC.SQL_SELECT_FIRST)
                sql.Append(LMD540DAC.SQL_SELECT_ZAIKO_MAIN1)
                sql.Append(LMD540DAC.SQL_SELECT_SAME_JOIN)
                sql.Append(LMD540DAC.SQL_SELECT_JOIN_ADD_ZAIKO)
                sql.Append(LMD540DAC.SQL_SELECT_ZAIKO_END1)

                sql.Append(LMD540DAC.SQL_SELECT_UNION)
                sql.Append(LMD540DAC.SQL_SELECT_FIRST)
                sql.Append(LMD540DAC.SQL_SELECT_ZAIKO_MAIN2)
                sql.Append(LMD540DAC.SQL_SELECT_SAME_JOIN)
                sql.Append(LMD540DAC.SQL_SELECT_JOIN_ADD)
                sql.Append(LMD540DAC.SQL_SELECT_FROM_INKA)

                sql.Append(LMD540DAC.SQL_SELECT_UNION)
                sql.Append(LMD540DAC.SQL_SELECT_FIRST)
                sql.Append(LMD540DAC.SQL_SELECT_ZAIKO_MAIN3)
                sql.Append(LMD540DAC.SQL_SELECT_SAME_JOIN)
                sql.Append(LMD540DAC.SQL_SELECT_JOIN_ADD)
                sql.Append(LMD540DAC.SQL_SELECT_FROM_OUTKA)
                sql.Append(Me.CreateWhereSql(ds, SelectWhereCondition.WHERE1))
                '出荷取消区分
                sql.Append(Me.CreateOutkaSysDel(sysdel))
                sql.Append(vbNewLine)
        ...
        sql.Append(LMD540DAC.SQL_ORDER_BY)
        Return sql.ToString()
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function CreateWhereSql(ByVal ds As DataSet, ByVal wherePtn As LMD540DAC.SelectWhereCondition) As String
        ...
        With dr
            ...
            Select Case wherePtn
                ...
                Case LMD540DAC.SelectWhereCondition.WHERE1
                ...
                Case LMD540DAC.SelectWhereCondition.WHERE2
                ...
                Case LMD540DAC.SelectWhereCondition.WHERE3
                ...
                Case LMD540DAC.SelectWhereCondition.WHERE4
...
#End Region 'ユーティリティ
    ...
    ''' <remarks></remarks>
    Private Sub SetSelectParam(ByVal prmList As ArrayList, ByVal dr As DataRow, ByVal ptn As LMD540DAC.SelectCondition)

        With dr

            'パラメータ設定
            prmList.Add(MyBase.GetSqlParameter("@NRS_BR_CD", .Item("NRS_BR_CD").ToString(), DBDataType.CHAR))
            prmList.Add(MyBase.GetSqlParameter("@PTN_ID", LMD540DAC.PTN_ID, DBDataType.CHAR))
            
            Select Case ptn

                Case LMD540DAC.SelectCondition.PTN1 '帳票パターン取得

                    prmList.Add(MyBase.GetSqlParameter("@GOODS_CD_NRS", .Item("GOODS_CD_NRS").ToString(), DBDataType.CHAR))

                Case LMD540DAC.SelectCondition.PTN2, LMD540DAC.SelectCondition.PTN3 '印刷データ取得
    ...
    ''' <param name="ptn">取得条件の切り替え</param>
    ''' <remarks></remarks>
    Private Sub SetSelectParam(ByVal cmd As SqlCommand, ByVal dr As DataRow, ByVal ptn As LMD540DAC.SelectCondition)
        ...
        With dr
            ...
            Me.GetSqlParameterData(cmd, "@PTN_ID", LMD540DAC.PTN_ID)
    ...
    Private Function SetZanData(ByVal ds As DataSet) As DataSet
        ...
        Dim dt As DataTable = ds.Tables(LMD540DAC.TABLE_NM_OUT)
