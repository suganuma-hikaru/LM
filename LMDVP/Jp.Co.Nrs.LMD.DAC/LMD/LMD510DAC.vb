...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMD510IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMD510DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMD510DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMD510DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        If ("LMD511").Equals(_rptRow.Item("RPT_ID").ToString) = False Then
            ...
            'SQL作成
            Me._StrSql.Append(LMD510DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
            Me._StrSql.Append(LMD510DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
            Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
            Me._StrSql.Append(LMD510DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        Else
            'SQL作成
            Me._StrSql.Append(LMD510DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
            Me._StrSql.Append(LMD510DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
            Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
            Me._StrSql.Append(LMD510DAC.SQL_ORDER_BY511)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMD510DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMD510OUT")
    ...
    Private Function SelectLangSet(ByVal ds As DataSet) As String
        ...
        MyBase.Logger.WriteSQLLog("LMD510DAC", "SelectLangset", cmd)
