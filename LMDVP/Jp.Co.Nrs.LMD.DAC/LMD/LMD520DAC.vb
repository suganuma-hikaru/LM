...
#Region "検索処理 SQL"
    ...
    Private Const SQL_SELECT_DATA As String = " SELECT                                                                                                                             " & vbNewLine _
                                            ...
                                            & " ,ZAITRS.ALLOC_CAN_NB                                     AS ALLOC_CAN_NB       " & vbNewLine
    ...
    Private Const SQL_FROM As String = "FROM                                                         " & vbNewLine _
                                      ...
                                      & "AND MCR1.PTN_ID = '22'                                      " & vbNewLine _
                                      ...
                                      & "AND MCR2.PTN_ID = '22'                                      " & vbNewLine _
                                      & "--帳票パターン取得                                          " & vbNewLine _
...
#Region "検索処理"
    ...
    Private Function SelectMPrt(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMD520IN")
        ...
        'SQL作成
        Me._StrSql.Append(LMD520DAC.SQL_SELECT_MPrt)      'SQL構築(帳票種別用Select句)
        Me._StrSql.Append(LMD520DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        ...
        MyBase.Logger.WriteSQLLog("LMD520DAC", "SelectMPrt", cmd)
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        'SQL作成
        Me._StrSql.Append(LMD520DAC.SQL_SELECT_DATA)      'SQL構築(データ抽出用Select句)
        Me._StrSql.Append(LMD520DAC.SQL_FROM)             'SQL構築(データ抽出用From句)
        Call Me.SetConditionMasterSQL()                   'SQL構築(条件設定)
        Me._StrSql.Append(LMD520DAC.SQL_ORDER_BY)         'SQL構築(データ抽出用ORDER BY句)
        ...
        MyBase.Logger.WriteSQLLog("LMD520DAC", "SelectPrintData", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMD520OUT")
    ...
    Private Function SelectLangSet(ByVal ds As DataSet) As String
        ...
        MyBase.Logger.WriteSQLLog("LMD520DAC", "SelectLangset", cmd)
