...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC810BLC = New LMC810BLC()
...
#Region "Method"
    ...
    Private Function UpdateOkakenCsv(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC810OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateOkakenCsvDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateOkakenCsvDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateOkakenCsv", ds)
