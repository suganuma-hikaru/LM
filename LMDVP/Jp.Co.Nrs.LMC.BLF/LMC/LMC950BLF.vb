...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC950BLC = New LMC950BLC()
...
#Region "Method"
    ...
    Private Function UpdateNiigataUnyuCsv(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC950OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateNiigataUnyuCsvDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateNiigataUnyuCsvDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateNiigataUnyuCsv", ds)
