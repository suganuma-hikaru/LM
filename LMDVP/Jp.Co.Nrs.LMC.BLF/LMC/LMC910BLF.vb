...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC910BLC = New LMC910BLC()
...
#Region "Method"
    ...
    Private Function UpdateSLineCsv(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC910OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateSLineCsvDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateSLineCsvDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateSLineCsv", ds)
