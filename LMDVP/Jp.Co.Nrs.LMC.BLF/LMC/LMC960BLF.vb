...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC960BLC = New LMC960BLC()
...
#Region "Method"
    ...
    Private Function UpdateToll(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC960OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateTollDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateTollDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateTollCsv", ds)
