...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC890BLC = New LMC890BLC()
...
#Region "Method"
    ...
    Private Function UpdateYamatoB2Csv(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC890OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateYamatoB2CsvDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateYamatoB2CsvDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateYamatoB2Csv", ds)
