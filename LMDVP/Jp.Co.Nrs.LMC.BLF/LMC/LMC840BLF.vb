...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC840BLC = New LMC840BLC()
...
#Region "Method"
    ...
    Private Function UpdateSigmaCsv(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC840OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateSigmaCsvDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateSigmaCsvDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateSigmaCsv", ds)
