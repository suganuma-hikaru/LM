...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMC850BLC = New LMC850BLC()
...
#Region "Method"
    ...
    Private Function UpdateMeitetuCsv(ByVal ds As DataSet) As DataSet
        ...
        Dim tableNm As String = "LMC850OUT"
        ...
        For i As Integer = 0 To max
            ...
            '更新処理
            If Me.UpdateMeitetuCsvDataAction(setDs) = False Then
                Continue For
            End If
    ...
    ''' <remarks></remarks>
    Private Function UpdateMeitetuCsvDataAction(ByVal ds As DataSet) As Boolean
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            If updDt.Rows.Count <> 0 Then
                ...
                'データの更新
                ds = MyBase.CallBLC(Me._Blc, "UpdateMeitetuCsv", ds)
