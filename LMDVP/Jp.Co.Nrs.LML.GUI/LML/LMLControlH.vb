...
'  システム名       :  LM
'  サブシステム名   :  LML          : 
'  プログラムID     :  LMLControlH  : LML画面 共通処理
'  作  成  者       :  [DAIKOKU]
' ==========================================================================
...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _ControlV As LMLControlV

    ''' <summary>
    ''' 共通クラス(G)
    ''' </summary>
    ''' <remarks></remarks>
    Private _ControlG As LMLControlG
...
#Region "Constructor"
    ...
    Friend Sub New(ByRef frm As Form, ByVal pgid As String)
        ...
        Me.SetPGID(pgid)
        Me._ControlV = New LMLControlV(New LM.Base.GUI.LMBaseGUIHandler(), frm)
        'Me._ControlG = New LMLControlG(MyBase.myh)
