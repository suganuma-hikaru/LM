...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMM140BLC = New LMM140BLC()
...
#Region "設定処理"
    ...
    Private Function InsertData(ByVal ds As DataSet) As DataSet
        ...
        Return Me.ScopeStartEnd(ds, "InsertZoneM", "CheckExistZoneM")
    ...
    Private Function UpdateData(ByVal ds As DataSet) As DataSet
        ...
        Return Me.ScopeStartEnd(ds, "UpdateZoneM")
    ...
    Private Function DeleteData(ByVal ds As DataSet) As DataSet
        ...
        Return Me.ScopeStartEnd(ds, "DeleteZoneM")
    ...
    Private Sub HaitaData(ByVal ds As DataSet)
        ...
        '排他チェック
        ds = MyBase.CallBLC(Me._Blc, "CheckHaitaZoneM", ds)
