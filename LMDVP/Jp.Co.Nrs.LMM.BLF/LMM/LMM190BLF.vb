...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Blc As LMM190BLC = New LMM190BLC()
...
#Region "設定処理"
    ...
    Private Function InsertData(ByVal ds As DataSet) As DataSet
        ...
        '存在チェック
        ds = MyBase.CallBLC(Me._Blc, "CheckExistKyoriM", ds)
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            'データの新規登録
            ds = MyBase.CallBLC(Me._Blc, "InsertKyoriM", ds)
    ...
    Private Function UpdateData(ByVal ds As DataSet) As DataSet
        ...
        Using scope As TransactionScope = MyBase.BeginTransaction()
            ...
            'データの更新
            ds = MyBase.CallBLC(Me._Blc, "UpdateKyoriM", ds)
    ...
    Private Function HaitaData(ByVal ds As DataSet) As DataSet
        ...
        '排他チェック
        Return MyBase.CallBLC(Me._Blc, "CheckHaitaKyoriM", ds)
    ...
    Private Function DeleteData(ByVal ds As DataSet) As DataSet
        ...
        '排他チェック
        ds = MyBase.CallBLC(Me._Blc, "CheckHaitaKyoriM", ds)

        'トランザクション開始
        Using scope As TransactionScope = MyBase.BeginTransaction()

            'データの更新
            ds = MyBase.CallBLC(Me._Blc, "DeleteKyoriM", ds)
