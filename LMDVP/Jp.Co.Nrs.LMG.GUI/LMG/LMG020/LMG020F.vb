...
'  プログラムID     :  LMG020F : 保管料/荷役料計算 [明細検索画面]
'  作  成  者       :  []
' ==========================================================================
...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMG020H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMG020F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprMeisai_CellClick(ByVal sender As System.Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprMeisai.CellDoubleClick
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnCustSet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCustSet.Click

        Call Me._Handler.btnCustSet_Click(Me, e)
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnSeqtoSet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSeqtoSet.Click

        Call Me._Handler.btnSeqtoSet_Click(Me, e)
