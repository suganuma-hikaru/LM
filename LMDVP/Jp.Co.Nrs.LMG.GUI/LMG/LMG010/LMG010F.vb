...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMG010H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMG010F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
#End Region
    ...
    Private Sub optSeikyuC_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optSeikyuH.CheckedChanged, optSeikyuGC.CheckedChanged, optSeikyuC.CheckedChanged

        Me._Handler.ChangedOpt(Me, e)
