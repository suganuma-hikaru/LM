...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMG040H)
...
#Region "Method"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub sprMeisaiCellDoubleClick(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.CellClickEventArgs) Handles sprMeisai.CellDoubleClick
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub LMG040F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

        If e.KeyCode.Equals(Keys.Enter) = False Then
            Exit Sub
        End If

        Call Me._Handler.LMG040FKeyDown(Me, e)
