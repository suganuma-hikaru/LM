...
Partial Class LMC040F
    ...
    Private Sub InitializeComponent()
        Dim sprZaiko_InputMapWhenFocusedNormal As FarPoint.Win.Spread.InputMap
        Dim sprZaiko_InputMapWhenAncestorOfFocusedNormal As FarPoint.Win.Spread.InputMap
        ...
        Me.frmShukaTani = New Jp.Co.Nrs.LM.GUI.Win.LMGroupBox()
        Me.optSample = New Jp.Co.Nrs.LM.GUI.Win.LMOptionButton()
        Me.optKowake = New Jp.Co.Nrs.LM.GUI.Win.LMOptionButton()
        Me.optAmt = New Jp.Co.Nrs.LM.GUI.Win.LMOptionButton()
        Me.optCnt = New Jp.Co.Nrs.LM.GUI.Win.LMOptionButton()
        ...
        Me.lblConsDate = New Jp.Co.Nrs.LM.GUI.Win.InputMan.LMImTextBox()
        Me.txtOutkaPlanDate = New Jp.Co.Nrs.LM.GUI.Win.InputMan.LMImTextBox()
        sprZaiko_InputMapWhenFocusedNormal = New FarPoint.Win.Spread.InputMap()
        sprZaiko_InputMapWhenFocusedNormal.Parent = New FarPoint.Win.Spread.InputMap()
        sprZaiko_InputMapWhenAncestorOfFocusedNormal = New FarPoint.Win.Spread.InputMap()
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent = New FarPoint.Win.Spread.InputMap()
        Me.pnlViewAria.SuspendLayout()
        CType(Me.sprZaiko, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.frmShukaTani.SuspendLayout()
        ...
        'pnlViewAria
        '
        Me.pnlViewAria.Controls.Add(Me.txtOutkaPlanDate)
        Me.pnlViewAria.Controls.Add(Me.lblConsDate)
        ...
        Me.pnlViewAria.Controls.Add(Me.frmShukaTani)
        ...
        Me.sprZaiko.UseGrouping = False
        Me.sprZaiko.WidthDef = 1250
        sprZaiko_InputMapWhenFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Insert, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Delete, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.X, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.V, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.C, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardCopy)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Back, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.StartEditing)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[Return], System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.StartEditing)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(Global.Microsoft.VisualBasic.ChrW(61)), FarPoint.Win.Spread.SpreadActions.StartEditingFormula)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.C, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardCopy)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.V, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardPasteAll)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.X, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardCut)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Insert, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardCopy)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Delete, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardCut)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Insert, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ClipboardPasteAll)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F4, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.ShowSubEditor)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Space, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.SelectRow)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Z, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.Undo)
        sprZaiko_InputMapWhenFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Y, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.Redo)
        Me.sprZaiko.SetInputMap(FarPoint.Win.Spread.InputMapMode.WhenFocused, FarPoint.Win.Spread.OperationMode.Normal, sprZaiko_InputMapWhenFocusedNormal)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Insert, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Delete, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F2, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F3, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F4, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F10, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.None)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Up, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToPreviousRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Down, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Left, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToPreviousColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Right, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Up, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToPreviousRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Down, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToNextRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Left, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToPreviousColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Right, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToNextColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Up, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToPreviousRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Down, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToNextRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Left, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToPreviousColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Right, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToNextColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Up, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToPreviousRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Down, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToNextRow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Left, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
        ...
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Right, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToNextColumnVisual)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.PageUp, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToPreviousPageOfRows)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[Next], System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextPageOfRows)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.PageUp, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToPreviousPageOfColumns)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[Next], CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToNextPageOfColumns)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.PageUp, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToPreviousPageOfRows)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[Next], CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToNextPageOfRows)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.PageUp, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
        ...
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[Next], CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToNextPageOfColumns)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Home, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToFirstColumn)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[End], System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToLastColumn)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Home, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToFirstCell)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[End], CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToLastCell)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Home, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToFirstColumn)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[End], CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToLastColumn)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Home, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToFirstCell)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[End], CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ExtendToLastCell)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Space, CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.SelectColumn)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Space, CType(((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.Shift) _
                    Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.SelectSheet)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Escape, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.CancelEditing)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.[Return], System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.StopEditing)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Tab, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.MoveToNextColumnWrap)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Tab, CType((System.Windows.Forms.Keys.Shift Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.MoveToPreviousColumnWrap)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F2, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.ClearCell)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F3, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.DateTimeNow)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.F4, System.Windows.Forms.Keys.None), FarPoint.Win.Spread.SpreadActions.ShowSubEditor)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Down, CType((System.Windows.Forms.Keys.Alt Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ComboShowList)
        sprZaiko_InputMapWhenAncestorOfFocusedNormal.Parent.Put(New FarPoint.Win.Spread.Keystroke(System.Windows.Forms.Keys.Up, CType((System.Windows.Forms.Keys.Alt Or System.Windows.Forms.Keys.None), System.Windows.Forms.Keys)), FarPoint.Win.Spread.SpreadActions.ComboShowList)
        Me.sprZaiko.SetInputMap(FarPoint.Win.Spread.InputMapMode.WhenAncestorOfFocused, FarPoint.Win.Spread.OperationMode.Normal, sprZaiko_InputMapWhenAncestorOfFocusedNormal)
        ...
        Me.lblGoods.Location = New System.Drawing.Point(11, 53)
        Me.lblGoods.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblGoods.Name = "lblGoods"
        Me.lblGoods.Size = New System.Drawing.Size(90, 13)
        Me.lblGoods.TabIndex = 41
        Me.lblGoods.Text = "商品"
        Me.lblGoods.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblGoods.TextValue = "商品"
        Me.lblGoods.WidthDef = 90
        '
        'lblReserveNO
        '
        ...
        Me.lblReserveNO.Location = New System.Drawing.Point(11, 75)
        Me.lblReserveNO.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblReserveNO.Name = "lblReserveNO"
        Me.lblReserveNO.Size = New System.Drawing.Size(90, 13)
        ...
        Me.lblLotNO.Location = New System.Drawing.Point(336, 75)
        Me.lblLotNO.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblLotNO.Name = "lblLotNO"
        Me.lblLotNO.Size = New System.Drawing.Size(90, 13)
        ...
        Me.lblSerialNO.Location = New System.Drawing.Point(745, 54)
        Me.lblSerialNO.Margin = New System.Windows.Forms.Padding(0)
        Me.lblSerialNO.MinimumSize = New System.Drawing.Size(100, 0)
        Me.lblSerialNO.Name = "lblSerialNO"
        Me.lblSerialNO.Size = New System.Drawing.Size(100, 13)
        ...
        Me.lblIrime.Location = New System.Drawing.Point(745, 75)
        Me.lblIrime.Margin = New System.Windows.Forms.Padding(0)
        Me.lblIrime.MinimumSize = New System.Drawing.Size(100, 0)
        Me.lblIrime.Name = "lblIrime"
        Me.lblIrime.Size = New System.Drawing.Size(100, 13)
        Me.lblIrime.TabIndex = 50
        Me.lblIrime.Text = "入目"
        Me.lblIrime.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblIrime.TextValue = "入目"
        Me.lblIrime.WidthDef = 100
        '
        'lblIrimeTani
        '
        ...
        'frmShukaTani
        '
        Me.frmShukaTani.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.frmShukaTani.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.frmShukaTani.BorderStyleDef = System.Windows.Forms.BorderStyle.None
        Me.frmShukaTani.Controls.Add(Me.optSample)
        Me.frmShukaTani.Controls.Add(Me.optKowake)
        Me.frmShukaTani.Controls.Add(Me.optAmt)
        Me.frmShukaTani.Controls.Add(Me.optCnt)
        Me.frmShukaTani.EnableStatus = False
        Me.frmShukaTani.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.frmShukaTani.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.frmShukaTani.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.frmShukaTani.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.frmShukaTani.HeightDef = 109
        Me.frmShukaTani.Location = New System.Drawing.Point(24, 96)
        Me.frmShukaTani.Name = "frmShukaTani"
        Me.frmShukaTani.Size = New System.Drawing.Size(114, 109)
        Me.frmShukaTani.TabIndex = 4
        Me.frmShukaTani.TabStop = False
        Me.frmShukaTani.Text = "出荷単位"
        Me.frmShukaTani.TextValue = "出荷単位"
        Me.frmShukaTani.WidthDef = 114
        '
        'optSample
        '
        Me.optSample.AutoSize = True
        Me.optSample.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optSample.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optSample.BorderStyleDef = System.Windows.Forms.BorderStyle.None
        Me.optSample.EnableStatus = True
        Me.optSample.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optSample.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optSample.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optSample.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optSample.HeightDef = 17
        Me.optSample.Location = New System.Drawing.Point(9, 88)
        Me.optSample.Name = "optSample"
        Me.optSample.Size = New System.Drawing.Size(81, 17)
        Me.optSample.TabIndex = 7
        Me.optSample.TabStop = True
        Me.optSample.TabStopSetting = True
        Me.optSample.Text = "サンプル"
        Me.optSample.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        Me.optSample.TextValue = "サンプル"
        Me.optSample.UseVisualStyleBackColor = True
        Me.optSample.WidthDef = 81
        '
        'optKowake
        '
        Me.optKowake.AutoSize = True
        Me.optKowake.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optKowake.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optKowake.BorderStyleDef = System.Windows.Forms.BorderStyle.None
        Me.optKowake.EnableStatus = True
        Me.optKowake.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optKowake.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optKowake.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optKowake.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optKowake.HeightDef = 17
        Me.optKowake.Location = New System.Drawing.Point(9, 65)
        Me.optKowake.Name = "optKowake"
        Me.optKowake.Size = New System.Drawing.Size(67, 17)
        Me.optKowake.TabIndex = 6
        Me.optKowake.TabStop = True
        Me.optKowake.TabStopSetting = True
        Me.optKowake.Text = "小分け"
        Me.optKowake.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        Me.optKowake.TextValue = "小分け"
        Me.optKowake.UseVisualStyleBackColor = True
        Me.optKowake.WidthDef = 67
        '
        'optAmt
        '
        Me.optAmt.AutoSize = True
        Me.optAmt.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optAmt.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optAmt.BorderStyleDef = System.Windows.Forms.BorderStyle.None
        Me.optAmt.EnableStatus = True
        Me.optAmt.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optAmt.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optAmt.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optAmt.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optAmt.HeightDef = 17
        Me.optAmt.Location = New System.Drawing.Point(9, 42)
        Me.optAmt.Name = "optAmt"
        Me.optAmt.Size = New System.Drawing.Size(53, 17)
        Me.optAmt.TabIndex = 5
        Me.optAmt.TabStop = True
        Me.optAmt.TabStopSetting = True
        Me.optAmt.Text = "数量"
        Me.optAmt.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        Me.optAmt.TextValue = "数量"
        Me.optAmt.UseVisualStyleBackColor = True
        Me.optAmt.WidthDef = 53
        '
        'optCnt
        '
        Me.optCnt.AutoSize = True
        Me.optCnt.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optCnt.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.optCnt.BorderStyleDef = System.Windows.Forms.BorderStyle.None
        Me.optCnt.EnableStatus = True
        Me.optCnt.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optCnt.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.optCnt.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optCnt.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.optCnt.HeightDef = 17
        Me.optCnt.Location = New System.Drawing.Point(9, 19)
        Me.optCnt.Name = "optCnt"
        Me.optCnt.Size = New System.Drawing.Size(53, 17)
        Me.optCnt.TabIndex = 4
        Me.optCnt.TabStop = True
        Me.optCnt.TabStopSetting = True
        Me.optCnt.Text = "個数"
        Me.optCnt.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        Me.optCnt.TextValue = "個数"
        Me.optCnt.UseVisualStyleBackColor = True
        Me.optCnt.WidthDef = 53
        '
        'lblEigyo
        '
        ...
        Me.lblEigyo.Location = New System.Drawing.Point(11, 12)
        Me.lblEigyo.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblEigyo.Name = "lblEigyo"
        Me.lblEigyo.Size = New System.Drawing.Size(90, 13)
        ...
        Me.lblCust.Location = New System.Drawing.Point(11, 33)
        Me.lblCust.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblCust.Name = "lblCust"
        Me.lblCust.Size = New System.Drawing.Size(90, 13)
        Me.lblCust.TabIndex = 185
        Me.lblCust.Text = "荷主"
        Me.lblCust.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblCust.TextValue = "荷主"
        Me.lblCust.WidthDef = 90
        '
        'lblCustNM_M
        '
        ...
        Me.frmCnt.Location = New System.Drawing.Point(144, 96)
        ...
        Me.lblSyukkaSouCnt.Location = New System.Drawing.Point(182, 65)
        Me.lblSyukkaSouCnt.Margin = New System.Windows.Forms.Padding(0)
        Me.lblSyukkaSouCnt.MinimumSize = New System.Drawing.Size(100, 0)
        Me.lblSyukkaSouCnt.Name = "lblSyukkaSouCnt"
        Me.lblSyukkaSouCnt.Size = New System.Drawing.Size(100, 13)
        Me.lblSyukkaSouCnt.TabIndex = 115
        Me.lblSyukkaSouCnt.Text = "出荷個数"
        Me.lblSyukkaSouCnt.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblSyukkaSouCnt.TextValue = "出荷個数"
        Me.lblSyukkaSouCnt.WidthDef = 100
        '
        'txtSyukkaHasu
        '
        ...
        Me.lblSyukkaHasu.Location = New System.Drawing.Point(182, 44)
        Me.lblSyukkaHasu.Margin = New System.Windows.Forms.Padding(0)
        Me.lblSyukkaHasu.MinimumSize = New System.Drawing.Size(100, 0)
        Me.lblSyukkaHasu.Name = "lblSyukkaHasu"
        Me.lblSyukkaHasu.Size = New System.Drawing.Size(100, 13)
        Me.lblSyukkaHasu.TabIndex = 214
        Me.lblSyukkaHasu.Text = "出荷端数"
        Me.lblSyukkaHasu.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblSyukkaHasu.TextValue = "出荷端数"
        Me.lblSyukkaHasu.WidthDef = 100
        '
        'lblHikiCntSum
        '
        ...
        Me.lblHikiCntSum.Location = New System.Drawing.Point(182, 86)
        Me.lblHikiCntSum.Margin = New System.Windows.Forms.Padding(0)
        Me.lblHikiCntSum.MinimumSize = New System.Drawing.Size(100, 0)
        Me.lblHikiCntSum.Name = "lblHikiCntSum"
        Me.lblHikiCntSum.Size = New System.Drawing.Size(100, 13)
        ...
        Me.lblHikiZanCnt.Location = New System.Drawing.Point(3, 65)
        Me.lblHikiZanCnt.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblHikiZanCnt.Name = "lblHikiZanCnt"
        Me.lblHikiZanCnt.Size = New System.Drawing.Size(90, 13)
        ...
        Me.lblSyukkaKosu.Location = New System.Drawing.Point(182, 22)
        Me.lblSyukkaKosu.Margin = New System.Windows.Forms.Padding(0)
        Me.lblSyukkaKosu.MinimumSize = New System.Drawing.Size(100, 0)
        Me.lblSyukkaKosu.Name = "lblSyukkaKosu"
        Me.lblSyukkaKosu.Size = New System.Drawing.Size(100, 13)
        ...
        Me.lblHikiSumiCnt.Location = New System.Drawing.Point(3, 44)
        Me.lblHikiSumiCnt.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblHikiSumiCnt.Name = "lblHikiSumiCnt"
        Me.lblHikiSumiCnt.Size = New System.Drawing.Size(90, 13)
        ...
        Me.lblIrisu.Location = New System.Drawing.Point(3, 22)
        Me.lblIrisu.MinimumSize = New System.Drawing.Size(90, 0)
        Me.lblIrisu.Name = "lblIrisu"
        Me.lblIrisu.Size = New System.Drawing.Size(90, 13)
        Me.lblIrisu.TabIndex = 109
        Me.lblIrisu.Text = "入数"
        Me.lblIrisu.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblIrisu.TextValue = "入数"
        Me.lblIrisu.WidthDef = 90
        '
        'numIrisu
        '
        ...
        Me.frmAmount.Location = New System.Drawing.Point(646, 96)
        ...
        Me.lblHikiAmtSum.Margin = New System.Windows.Forms.Padding(0)
        Me.lblHikiAmtSum.MinimumSize = New System.Drawing.Size(95, 0)
        Me.lblHikiAmtSum.Name = "lblHikiAmtSum"
        Me.lblHikiAmtSum.Size = New System.Drawing.Size(95, 13)
        ...
        Me.lblHikiZanAmt.Location = New System.Drawing.Point(6, 64)
        Me.lblHikiZanAmt.Margin = New System.Windows.Forms.Padding(0)
        Me.lblHikiZanAmt.MinimumSize = New System.Drawing.Size(95, 0)
        Me.lblHikiZanAmt.Name = "lblHikiZanAmt"
        Me.lblHikiZanAmt.Size = New System.Drawing.Size(95, 13)
        ...
        Me.lblSyukkaSouAmtl.Location = New System.Drawing.Point(6, 23)
        Me.lblSyukkaSouAmtl.Margin = New System.Windows.Forms.Padding(0)
        Me.lblSyukkaSouAmtl.MinimumSize = New System.Drawing.Size(95, 0)
        Me.lblSyukkaSouAmtl.Name = "lblSyukkaSouAmtl"
        Me.lblSyukkaSouAmtl.Size = New System.Drawing.Size(95, 13)
        Me.lblSyukkaSouAmtl.TabIndex = 122
        Me.lblSyukkaSouAmtl.Text = "出荷数量"
        Me.lblSyukkaSouAmtl.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.lblSyukkaSouAmtl.TextValue = "出荷数量"
        Me.lblSyukkaSouAmtl.WidthDef = 95
        '
        'numSyukkaSouAmt
        '
        Me.numSyukkaSouAmt.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(255, Byte), Integer), CType(CType(255, Byte), Integer))
        Me.numSyukkaSouAmt.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(255, Byte), Integer), CType(CType(255, Byte), Integer))
        ...
        Me.lblHikiSumiAmt.Location = New System.Drawing.Point(6, 43)
        Me.lblHikiSumiAmt.Margin = New System.Windows.Forms.Padding(0)
        Me.lblHikiSumiAmt.MinimumSize = New System.Drawing.Size(95, 0)
        Me.lblHikiSumiAmt.Name = "lblHikiSumiAmt"
        Me.lblHikiSumiAmt.Size = New System.Drawing.Size(95, 13)
        ...
        'lblConsDate
        '
        Me.lblConsDate.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.lblConsDate.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.lblConsDate.BorderStyleDef = System.Windows.Forms.BorderStyle.FixedSingle
        Me.lblConsDate.ContentAlignment = System.Drawing.ContentAlignment.MiddleLeft
        Me.lblConsDate.CountWrappedLine = False
        Me.lblConsDate.DisplayAlignment = GrapeCity.Win.Editors.DisplayAlignment.None
        Me.lblConsDate.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.lblConsDate.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.lblConsDate.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.lblConsDate.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.lblConsDate.GridLine = GrapeCity.Win.Editors.LineStyle.None
        Me.lblConsDate.HeightDef = 18
        Me.lblConsDate.HissuLabelBackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.lblConsDate.HissuLabelVisible = False
        Me.lblConsDate.InputType = Jp.Co.Nrs.Com.[Const].InputControl.ALL_MIX
        Me.lblConsDate.IsByteCheck = 20
        Me.lblConsDate.IsCalendarCheck = False
        Me.lblConsDate.IsDakutenCheck = False
        Me.lblConsDate.IsEisuCheck = False
        Me.lblConsDate.IsForbiddenWordsCheck = False
        Me.lblConsDate.IsFullByteCheck = 0
        Me.lblConsDate.IsHankakuCheck = False
        Me.lblConsDate.IsHissuCheck = False
        Me.lblConsDate.IsKanaCheck = False
        Me.lblConsDate.IsMiddleSpace = False
        Me.lblConsDate.IsNumericCheck = False
        Me.lblConsDate.IsSujiCheck = False
        Me.lblConsDate.IsZenkakuCheck = False
        Me.lblConsDate.ItemName = ""
        Me.lblConsDate.LineSpace = 0
        Me.lblConsDate.Location = New System.Drawing.Point(1026, 134)
        Me.lblConsDate.MaxLength = 20
        Me.lblConsDate.MaxLengthUnit = GrapeCity.Win.Editors.LengthUnit.[Char]
        Me.lblConsDate.MaxLineCount = 0
        Me.lblConsDate.Multiline = False
        Me.lblConsDate.Name = "lblConsDate"
        Me.lblConsDate.ReadOnly = True
        Me.lblConsDate.ScrollBarMode = GrapeCity.Win.Editors.ScrollBarMode.Fixed
        Me.lblConsDate.ScrollBars = System.Windows.Forms.ScrollBars.None
        Me.lblConsDate.Size = New System.Drawing.Size(167, 18)
        Me.lblConsDate.TabIndex = 276
        Me.lblConsDate.TabStop = False
        Me.lblConsDate.TabStopSetting = False
        Me.lblConsDate.Tag = ""
        Me.lblConsDate.TextValue = "X---10---XX---10---X"
        Me.lblConsDate.UseSystemPasswordChar = False
        Me.lblConsDate.Visible = False
        Me.lblConsDate.WidthDef = 167
        Me.lblConsDate.WrapMode = GrapeCity.Win.Editors.WrapMode.WordWrap
        '
        'txtOutkaPlanDate
        '
        Me.txtOutkaPlanDate.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.txtOutkaPlanDate.BackColorDef = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.txtOutkaPlanDate.BorderStyleDef = System.Windows.Forms.BorderStyle.FixedSingle
        Me.txtOutkaPlanDate.ContentAlignment = System.Drawing.ContentAlignment.MiddleLeft
        Me.txtOutkaPlanDate.CountWrappedLine = False
        Me.txtOutkaPlanDate.DisplayAlignment = GrapeCity.Win.Editors.DisplayAlignment.None
        Me.txtOutkaPlanDate.Font = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.txtOutkaPlanDate.FontDef = New System.Drawing.Font("ＭＳ ゴシック", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        Me.txtOutkaPlanDate.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.txtOutkaPlanDate.ForeColorDef = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.txtOutkaPlanDate.GridLine = GrapeCity.Win.Editors.LineStyle.None
        Me.txtOutkaPlanDate.HeightDef = 18
        Me.txtOutkaPlanDate.HissuLabelBackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(233, Byte), Integer), CType(CType(216, Byte), Integer))
        Me.txtOutkaPlanDate.HissuLabelVisible = False
        Me.txtOutkaPlanDate.InputType = Jp.Co.Nrs.Com.[Const].InputControl.ALL_MIX_IME_OFF
        Me.txtOutkaPlanDate.IsByteCheck = 10
        Me.txtOutkaPlanDate.IsCalendarCheck = False
        Me.txtOutkaPlanDate.IsDakutenCheck = False
        Me.txtOutkaPlanDate.IsEisuCheck = False
        Me.txtOutkaPlanDate.IsForbiddenWordsCheck = False
        Me.txtOutkaPlanDate.IsFullByteCheck = 0
        Me.txtOutkaPlanDate.IsHankakuCheck = False
        Me.txtOutkaPlanDate.IsHissuCheck = False
        Me.txtOutkaPlanDate.IsKanaCheck = False
        Me.txtOutkaPlanDate.IsMiddleSpace = False
        Me.txtOutkaPlanDate.IsNumericCheck = False
        Me.txtOutkaPlanDate.IsSujiCheck = False
        Me.txtOutkaPlanDate.IsZenkakuCheck = False
        Me.txtOutkaPlanDate.ItemName = ""
        Me.txtOutkaPlanDate.LineSpace = 0
        Me.txtOutkaPlanDate.Location = New System.Drawing.Point(1026, 189)
        Me.txtOutkaPlanDate.MaxLength = 10
        Me.txtOutkaPlanDate.MaxLengthUnit = GrapeCity.Win.Editors.LengthUnit.[Char]
        Me.txtOutkaPlanDate.MaxLineCount = 0
        Me.txtOutkaPlanDate.Multiline = False
        Me.txtOutkaPlanDate.Name = "txtOutkaPlanDate"
        Me.txtOutkaPlanDate.ReadOnly = True
        Me.txtOutkaPlanDate.ScrollBarMode = GrapeCity.Win.Editors.ScrollBarMode.Fixed
        Me.txtOutkaPlanDate.ScrollBars = System.Windows.Forms.ScrollBars.None
        Me.txtOutkaPlanDate.Size = New System.Drawing.Size(29, 18)
        Me.txtOutkaPlanDate.TabIndex = 277
        Me.txtOutkaPlanDate.TabStop = False
        Me.txtOutkaPlanDate.TabStopSetting = False
        Me.txtOutkaPlanDate.TextValue = ""
        Me.txtOutkaPlanDate.UseSystemPasswordChar = False
        Me.txtOutkaPlanDate.Visible = False
        Me.txtOutkaPlanDate.WidthDef = 29
        Me.txtOutkaPlanDate.WrapMode = GrapeCity.Win.Editors.WrapMode.WordWrap
        '
        'LMC040F
        '
        ...
        Me.frmShukaTani.ResumeLayout(False)
        Me.frmShukaTani.PerformLayout()
    ...
    Friend WithEvents frmShukaTani As Jp.Co.Nrs.LM.GUI.Win.LMGroupBox
    Friend WithEvents optSample As Jp.Co.Nrs.LM.GUI.Win.LMOptionButton
    Friend WithEvents optKowake As Jp.Co.Nrs.LM.GUI.Win.LMOptionButton
    Friend WithEvents optAmt As Jp.Co.Nrs.LM.GUI.Win.LMOptionButton
    Friend WithEvents optCnt As Jp.Co.Nrs.LM.GUI.Win.LMOptionButton
    ...
    Friend WithEvents lblConsDate As Jp.Co.Nrs.LM.GUI.Win.InputMan.LMImTextBox
    Friend WithEvents txtOutkaPlanDate As Jp.Co.Nrs.LM.GUI.Win.InputMan.LMImTextBox
