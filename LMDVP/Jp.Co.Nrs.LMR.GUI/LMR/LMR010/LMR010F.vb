...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMR010H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細</param>
    ''' <remarks></remarks>
    Private Sub LMR010F_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
