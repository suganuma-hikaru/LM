...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMN010H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub btnSetteiAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSettei.Click

        Call Me._Handler.ClickBtnSettei(Me, e)

    End Sub

    ''' <summary>
    ''' 実績取込/実績送信の実行ボタン押下のイベントです。
    ''' </summary>
    ''' <param name="sender">イベント発生オブジェクト</param>
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks>各イベントに対応するハンドラクラスのメソッドを呼び出してください。</remarks>
    Private Sub btnJissekiAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnJissekiAction.Click

        Call Me._Handler.JissekiAction(Me, e)
