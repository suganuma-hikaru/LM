...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMF040H)
...
#Region "Method"
    ...
    ''' <param name="e">イベント詳細情報</param>
    ''' <remarks></remarks>
    Private Sub LMF040F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Call Me._H.LMF040F_KeyDown(Me, e)
    End Sub
