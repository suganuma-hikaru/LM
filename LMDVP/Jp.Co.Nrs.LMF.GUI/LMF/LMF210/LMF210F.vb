...
#Region "Constructor"
    ...
    Public Sub New(ByVal handlerClass As LMF210H)
...
#Region "Method"
    ...
    End Sub
    Private Sub LMF210F_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        'KeyDownのイベントへ
