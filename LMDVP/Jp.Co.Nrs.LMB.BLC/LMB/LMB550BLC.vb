...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMB550DAC = New LMB550DAC()
...
#Region "印刷処理"
    ...
    Private Function DoPrint(ByVal ds As DataSet) As DataSet
        ...
        '元のデータ
        Dim tableNmIn As String = "LMB550IN"
        Dim tableNmOut As String = "LMB550OUT"
        ...
        For Each dr As DataRow In ds.Tables("M_RPT").Rows
            ...
            prtDs = New DataSet
            '指定したレポートIDのデータを抽出する
            prtDs = comPrt.CallDataSet(ds.Tables("LMB550OUT"), dr.Item("RPT_ID").ToString())
            '帳票ごとの編集があるなら行う。
    ...
    Private Function EditPrintDataSet(ByVal prtId As String, ByVal ds As DataSet) As DataSet
        ...
        '抽出データテーブル取得
        Dim outDt As DataTable = ds.Tables("LMB550OUT")
        '抽出データ数取得
        ...
        For i As Integer = 0 To max
            ...
            If konsu = 0 AndAlso hasu = 0 AndAlso pkg = 0 Then
                outDt.Rows(i).Item("KONSU") = 0
                outDt.Rows(i).Item("HASU") = 0
            ElseIf konsu = 0 AndAlso hasu > 0 AndAlso pkg > 0 AndAlso hasu >= pkg Then
            ...
            '追記
            'LMB550の場合はLOT_SP_KB　=　"01"で、LOT_NO　に『NO.』(NOドット)　が含まれない場合、
    ...
    Private Function SelectPrintData(ByVal ds As DataSet) As DataSet
        ...
        Select Case ds.Tables("LMB550IN").Rows(0).Item("NRS_BR_CD").ToString
            Case Else
