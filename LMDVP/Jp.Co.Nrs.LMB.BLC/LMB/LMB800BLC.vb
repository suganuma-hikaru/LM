...
#Region "Field"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _Dac As LMB800DAC = New LMB800DAC()
...
#Region "印刷データ取得処理"
    ...
    ''' <remarks></remarks>
    Private Function DoPrintGHS(ByVal ds As DataSet) As DataSet

        '元のデータ
        Dim tableNmIn As String = "LMB800IN"
        Dim tableNmOut As String = "LMB800OUT"
