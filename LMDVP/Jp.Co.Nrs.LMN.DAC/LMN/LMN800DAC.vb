...
#Region "荷主コードチェック"
    ...
    Private Function SelectSCMCustCd(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMN800CUST_INFO")
        ...
        MyBase.Logger.WriteSQLLog("LMN800DAC", "SelectSCMCustCd", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMN800CUST_LIST")
...
#Region "ファイルパス取得"
    ...
    Private Function SelectFilePath(ByVal ds As DataSet) As DataSet
        ...
        'DataSetのIN情報を取得
        Dim inTbl As DataTable = ds.Tables("LMN800CUST_LIST")
        ...
        Me._StrSql.Append(vbNewLine)
        Me._StrSql.Append("AND KBN_CD       = @KBN_CD                                    ")
        'SQLパラメータ初期化
        Me._SqlPrmList = New ArrayList()
        With Me._Row
            'パラメータ設定
        ...
        MyBase.Logger.WriteSQLLog("LMN800DAC", "SelectFilePath", cmd)
        ...
        ds = MyBase.SetSelectResultToDataSet(map, ds, reader, "LMN800FILEPATH_OUT")
