...
Public NotInheritable Class LMDummyStartupScreen

    'TODO: このフォームは、プロジェクト デザイナ ([プロジェクト] メニューの下の [プロパティ]) の [アプリケーション] タブを使用して、
    '  アプリケーションのスプラッシュ スクリーンとして簡単に設定することができます

    Private Sub LMDummyStartupScreen_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub LMDummyStartupScreen_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown

        ''============================

        AddHandler Application.ThreadException, AddressOf LMDummyStartupScreen.CatchAllException
        ...
        Dim handler As Jp.Co.Nrs.LM.GUI.DummyLauncherH = New Jp.Co.Nrs.LM.GUI.DummyLauncherH
        'Dim handler As Jp.Co.Nrs.LM.GUI.LMA010H = New Jp.Co.Nrs.LM.GUI.LMA010H
        ...
        handler.StartGUI(New Jp.Co.Nrs.LM.Base.LMFormData)
